...
.method private loadSoundAssets()V
    ...
    invoke-virtual {v3, v6}, Landroid/media/AudioManager;->setNavigationRepeatSoundEffectsEnabled(Z)V
    ...
    invoke-virtual {v3, v6}, Landroid/media/AudioManager;->setHomeSoundEffectEnabled(Z)V
    :try_end_3
...
.method private onLoadSoundEffects(Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/audio/SoundEffectsHelper;->logEvent(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/server/audio/SoundEffectsHelper;->mSoundPoolLoader:Lcom/android/server/audio/SoundEffectsHelper$SoundPoolLoader;

    invoke-virtual {p1, v1}, Lcom/android/server/audio/SoundEffectsHelper$SoundPoolLoader;->onComplete(Z)V
...
.method private sendMsg(IIILjava/lang/Object;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/audio/SoundEffectsHelper$SfxHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private startWorker()V
    ...
    invoke-virtual {v2}, Lcom/android/server/audio/SoundEffectsHelper$SfxWorker;->getName()Ljava/lang/String;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/audio/SoundEffectsHelper;->mSfxLogger:Lcom/android/server/audio/AudioEventLogger;

    invoke-virtual {p2, p1}, Lcom/android/server/audio/AudioEventLogger;->dump(Ljava/io/PrintWriter;)V
...
.method onPlaySoundEffect(II)V
    ...
    iget p2, p1, Lcom/android/server/audio/SoundEffectsHelper$Resource;->mSampleId:I
    ...
    const-string v1, "MediaPlayer IllegalArgumentException: "
