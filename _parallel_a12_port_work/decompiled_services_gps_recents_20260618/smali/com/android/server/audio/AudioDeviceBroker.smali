...
.field private static final MSG_IL_SAVE_PREF_DEVICES_FOR_CAPTURE_PRESET:I = 0x26

.field private static final MSG_IL_SAVE_PREF_DEVICES_FOR_STRATEGY:I = 0x21
...
.field private static final MSG_IL_SET_PREF_DEVICES_FOR_STRATEGY:I = 0x29

.field private static final MSG_I_BROADCAST_BT_CONNECTION_STATE:I = 0x3

.field private static final MSG_I_REMOVE_PREF_DEVICES_FOR_STRATEGY:I = 0x2a

.field private static final MSG_I_SAVE_CLEAR_PREF_DEVICES_FOR_CAPTURE_PRESET:I = 0x27

.field private static final MSG_I_SAVE_REMOVE_PREF_DEVICES_FOR_STRATEGY:I = 0x22

.field private static final MSG_I_SCO_AUDIO_STATE_CHANGED:I = 0x2d
...
.field private static final MSG_L_COMMUNICATION_ROUTE_CLIENT_DIED:I = 0x23

.field private static final MSG_L_HEARING_AID_DEVICE_CONNECTION_CHANGE_EXT:I = 0x1f

.field private static final MSG_L_SET_COMMUNICATION_ROUTE_FOR_CLIENT:I = 0x2b

.field private static final MSG_L_SET_WIRED_DEVICE_CONNECTION_STATE:I = 0x2

.field private static final MSG_L_UPDATE_COMMUNICATION_ROUTE:I = 0x28

.field private static final MSG_L_UPDATE_COMMUNICATION_ROUTE_CLIENT:I = 0x2c
...
.method static synthetic access$1300(Lcom/android/server/audio/AudioDeviceBroker;)I
    ...
    iget p0, p0, Lcom/android/server/audio/AudioDeviceBroker;->mCommunicationStrategyId:I
...
.method private addCommunicationRouteClient(Landroid/os/IBinder;ILandroid/media/AudioDeviceAttributes;)Lcom/android/server/audio/AudioDeviceBroker$CommunicationRouteClient;
    ...
    invoke-virtual {p1, p2, v0}, Ljava/util/LinkedList;->add(ILjava/lang/Object;)V
...
.method private checkMessagesMuteMusic(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/audio/AudioService;->setMusicMute(Z)V
...
.method private initCommunicationStrategyId()V
    ...
    invoke-virtual {v1, v2}, Landroid/media/audiopolicy/AudioProductStrategy;->getAudioAttributesForLegacyStreamType(I)Landroid/media/AudioAttributes;
...
.method private onSetForceUse(IIZLjava/lang/String;)V
    ...
    new-instance p3, Landroid/media/MediaMetrics$Item;
    ...
    invoke-direct {p3, v0}, Landroid/media/MediaMetrics$Item;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p3, v0, v1}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p3

    sget-object v0, Landroid/media/MediaMetrics$Property;->FORCE_USE_DUE_TO:Landroid/media/MediaMetrics$Key;

    invoke-virtual {p3, v0, p4}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p3

    sget-object p4, Landroid/media/MediaMetrics$Property;->FORCE_USE_MODE:Landroid/media/MediaMetrics$Key;

    invoke-static {p2}, Landroid/media/AudioSystem;->forceUseConfigToString(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p3, p4, v0}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p3

    invoke-virtual {p3}, Landroid/media/MediaMetrics$Item;->record()Z
...
.method private removeScheduledA2dpEvents(Landroid/bluetooth/BluetoothDevice;I)V
    .locals 8
    ...
    invoke-virtual {p2, v1, v0}, Lcom/android/server/audio/AudioDeviceBroker$BrokerHandler;->removeEqualMessages(ILjava/lang/Object;)V
    ...
    new-instance p2, Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;

    invoke-direct {p2, p1}, Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;-><init>(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-virtual {p1, v0, p2}, Lcom/android/server/audio/AudioDeviceBroker$BrokerHandler;->removeEqualMessages(ILjava/lang/Object;)V
...
.method private sendIILMsg(IIIILjava/lang/Object;I)V
    ...
    invoke-virtual {p6, p1, p3, p4, p5}, Lcom/android/server/audio/AudioDeviceBroker$BrokerHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v2, "mCommunicationStrategyId: "
...
.method hasScheduledA2dpSinkConnectionState(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {p1, v1, v0}, Lcom/android/server/audio/AudioDeviceBroker$BrokerHandler;->hasEqualMessages(ILjava/lang/Object;)Z
...
.method postBluetoothA2dpDeviceConfigChangeExt(Landroid/bluetooth/BluetoothDevice;IIZI)V
    ...
    :try_start_0
    iget-object p2, v6, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;->mDevice:Landroid/bluetooth/BluetoothDevice;

    iget p3, v6, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;->mProfile:I

    invoke-direct {p0, p2, p3}, Lcom/android/server/audio/AudioDeviceBroker;->removeScheduledA2dpEvents(Landroid/bluetooth/BluetoothDevice;I)V

    const/16 p2, 0x20

    const/4 p3, 0x2

    invoke-direct {p0, p2, p3, v6}, Lcom/android/server/audio/AudioDeviceBroker;->sendLMsgNoDelay(IILjava/lang/Object;)V
...
.method postReportNewRoutes(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/audio/AudioDeviceBroker;->sendMsgNoDelay(II)V
...
.method queueBluetoothA2dpDeviceConnectionStateSuppressNoisyIntent(Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;)V
    ...
    :try_start_0
    iget-object v1, p1, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;->mDevice:Landroid/bluetooth/BluetoothDevice;

    iget v2, p1, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;->mProfile:I

    invoke-direct {p0, v1, v2}, Lcom/android/server/audio/AudioDeviceBroker;->removeScheduledA2dpEvents(Landroid/bluetooth/BluetoothDevice;I)V

    nop

    iget v1, p1, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;->mState:I
    ...
    invoke-direct {p0, v1, v4, p1}, Lcom/android/server/audio/AudioDeviceBroker;->sendLMsgNoDelay(IILjava/lang/Object;)V
...
.method setBluetoothA2dpOnInt(ZZLjava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v1, p2, p3}, Lcom/android/server/audio/AudioDeviceBroker;->onSetForceUse(IIZLjava/lang/String;)V
...
.method setCommunicationRouteForClient(Landroid/os/IBinder;ILandroid/media/AudioDeviceAttributes;ILjava/lang/String;)V
    ...
    :cond_1
    invoke-direct {p0, p1, v3}, Lcom/android/server/audio/AudioDeviceBroker;->removeCommunicationRouteClient(Landroid/os/IBinder;Z)Lcom/android/server/audio/AudioDeviceBroker$CommunicationRouteClient;
    ...
    invoke-direct {p0, p1, p2, p5}, Lcom/android/server/audio/AudioDeviceBroker;->sendLMsgNoDelay(IILjava/lang/Object;)V
...
.method updateActiveCommunicationDevice()V
    ...
    invoke-static {v1}, Landroid/media/AudioSystem;->getDevicesForAttributes(Landroid/media/AudioAttributes;)Ljava/util/ArrayList;
