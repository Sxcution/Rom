...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$4900(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/SpatializerHelper;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/audio/SpatializerHelper;->init(Z)V

    iget-object p1, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$4800(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/audio/AudioService;->isSpatialAudioEnabled()Z

    move-result v0

    invoke-virtual {p1, v0}, Lcom/android/server/audio/SpatializerHelper;->setFeatureEnabled(Z)V

    iget-object p1, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-virtual {p1, v2}, Lcom/android/server/audio/AudioService;->monitorRoutingChanges(Z)V

    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$4600(Lcom/android/server/audio/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$4700(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/audio/SpatializerHelper;->onInitSensors()V
    ...
    invoke-virtual {p1}, Lcom/android/server/audio/SpatializerHelper;->onRoutingUpdated()V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioService;->dispatchMode(I)V
    ...
    check-cast p1, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;

    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioDeviceBroker;->queueBluetoothA2dpDeviceConnectionStateSuppressNoisyIntent(Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/audio/AudioService;->access$6100(Lcom/android/server/audio/AudioService;Ljava/util/List;)V
    ...
    invoke-virtual {v2, v3, v4, p1, v1}, Lcom/android/server/audio/AudioService;->onUpdateAudioMode(IILjava/lang/String;Z)V
    ...
    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$6400(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/audio/AudioService;->access$6300(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/audio/AudioService;->access$6200(Lcom/android/server/audio/AudioService;ILjava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/audio/AudioService;->access$3500(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->access$4500(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/PlaybackActivityMonitor;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/audio/PlaybackActivityMonitor;->isPlaybackActiveForUid(I)Z

    move-result v3

    invoke-virtual {p1, v3}, Lcom/android/server/audio/AudioService$SetModeDeathHandler;->setPlaybackActive(Z)V

    iget-object v3, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v3}, Lcom/android/server/audio/AudioService;->access$000(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/RecordingActivityMonitor;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/audio/RecordingActivityMonitor;->isRecordingActiveForUid(I)Z

    move-result v3

    invoke-virtual {p1, v3}, Lcom/android/server/audio/AudioService$SetModeDeathHandler;->setRecordingActive(Z)V
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Lcom/android/server/audio/AudioService;->onUpdateAudioMode(IILjava/lang/String;Z)V
    ...
    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$2800(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/SystemServerAdapter;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/audio/SystemServerAdapter;->sendMicrophoneMuteChangedIntent()V
    ...
    invoke-static {v0, p1}, Lcom/android/server/audio/AudioService;->access$5800(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {p1}, Lcom/android/server/audio/AudioService;->access$4300(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/SoundEffectsHelper;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/audio/SoundEffectsHelper;->unloadSoundEffects()V
    ...
    const-string v2, "Invalid force use FOR_MEDIA in AudioService from "
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/audio/AudioSystemAdapter;->setForceUse(II)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/SoundEffectsHelper;->loadSoundEffects(Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/audio/AudioService$LoadSoundEffectReply;->run(Z)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/audio/SoundEffectsHelper;->playSoundEffect(II)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/audio/AudioService$VolumeGroupState;->access$4100(Lcom/android/server/audio/AudioService$VolumeGroupState;I)V
