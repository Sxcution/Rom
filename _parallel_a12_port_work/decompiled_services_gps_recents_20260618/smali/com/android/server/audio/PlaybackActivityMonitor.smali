...
.method public fadeOutPlayers(Lcom/android/server/audio/FocusRequester;Lcom/android/server/audio/FocusRequester;)Z
    ...
    const-string/jumbo v1, "not fading out player "
    ...
    iget-object p1, p0, Lcom/android/server/audio/PlaybackActivityMonitor;->mFadingManager:Lcom/android/server/audio/FadeOutManager;

    invoke-virtual {p2}, Lcom/android/server/audio/FocusRequester;->getClientUid()I

    move-result p2

    invoke-virtual {p1, p2, v3}, Lcom/android/server/audio/FadeOutManager;->fadeOutUid(ILjava/util/ArrayList;)V
...
.method public playerEvent(IIII)V
    ...
    const-string/jumbo v1, "not starting piid:"
    ...
    :cond_6
    invoke-direct {p0, p4}, Lcom/android/server/audio/PlaybackActivityMonitor;->dispatchPlaybackChange(Z)V
...
.method public releasePlayer(II)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/audio/FadeOutManager;->removeReleased(Landroid/media/AudioPlaybackConfiguration;)V
...
.method public restoreVShapedPlayers(Lcom/android/server/audio/FocusRequester;)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/audio/FadeOutManager;->unfadeOutUid(ILjava/util/HashMap;)V
