...
.method private receiveMessage()[B
    ...
    invoke-static {v2, v1, v3, v0}, Landroid/system/Os;->read(Ljava/io/FileDescriptor;[BII)I
...
.method private sendMessage([B)V
    ...
    invoke-static {v2, v1, v3, v0}, Landroid/system/Os;->write(Ljava/io/FileDescriptor;[BII)I

    iget-object v0, p0, Lcom/android/server/clipboard/EmulatorClipboardMonitor;->mPipe:Ljava/io/FileDescriptor;

    array-length v1, p1

    invoke-static {v0, p1, v3, v1}, Landroid/system/Os;->write(Ljava/io/FileDescriptor;[BII)I
...
.method private setHostClipboardImpl(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/clipboard/EmulatorClipboardMonitor;->sendMessage([B)V
    :try_end_0
    ...
    const-string v0, "EmulatorClipboardMonitor"
...
.method public accept(Landroid/content/ClipData;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/clipboard/EmulatorClipboardMonitor;->setHostClipboardImpl(Ljava/lang/String;)V
...
.method public synthetic lambda$new$0$EmulatorClipboardMonitor(Ljava/util/function/Consumer;)V
    ...
    const-string v2, "host clipboard"
