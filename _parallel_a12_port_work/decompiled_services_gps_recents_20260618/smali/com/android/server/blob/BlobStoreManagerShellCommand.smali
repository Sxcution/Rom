...
.method private parseOptions(Ljava/io/PrintWriter;Lcom/android/server/blob/BlobStoreManagerShellCommand$ParsedArgs;)I
    ...
    :cond_1
    iget p1, p2, Lcom/android/server/blob/BlobStoreManagerShellCommand$ParsedArgs;->userId:I
    ...
    iput p1, p2, Lcom/android/server/blob/BlobStoreManagerShellCommand$ParsedArgs;->userId:I
...
.method private runClearAllBlobs(Ljava/io/PrintWriter;)I
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/blob/BlobStoreManagerShellCommand;->mService:Lcom/android/server/blob/BlobStoreManagerService;

    iget v0, v0, Lcom/android/server/blob/BlobStoreManagerShellCommand$ParsedArgs;->userId:I

    invoke-virtual {p1, v0}, Lcom/android/server/blob/BlobStoreManagerService;->runClearAllBlobs(I)V
...
.method private runClearAllSessions(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/blob/BlobStoreManagerService;->runClearAllSessions(I)V
...
.method private runDeleteBlob(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v1, v0}, Lcom/android/server/blob/BlobStoreManagerService;->deleteBlob(Landroid/app/blob/BlobHandle;I)V
...
.method private runIdleMaintenance(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1}, Lcom/android/server/blob/BlobStoreManagerService;->runIdleMaintenance()V
...
.method private runQueryBlobExistence(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v1, v2, v3, v0}, Lcom/android/server/blob/BlobStoreManagerService;->isBlobAvailable(JI)Z
