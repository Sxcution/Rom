...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/server/companion/CompanionDeviceManagerService$1;-><init>(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/content/Intent;)V

    iput-object v0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mServiceConnectors:Lcom/android/internal/infra/PerUser;

    new-instance p1, Lcom/android/server/companion/CompanionDeviceManagerService$2;

    invoke-direct {p1, p0}, Lcom/android/server/companion/CompanionDeviceManagerService$2;-><init>(Lcom/android/server/companion/CompanionDeviceManagerService;)V

    iput-object p1, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mDeviceListenerServiceConnectors:Lcom/android/internal/infra/PerUser;
...
.method static synthetic access$1900(Lcom/android/server/companion/CompanionDeviceManagerService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mLock:Ljava/lang/Object;
...
.method static synthetic access$2100(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mCachedAssociations:Landroid/util/SparseArray;
...
.method static synthetic access$2200(Lcom/android/server/companion/CompanionDeviceManagerService;)Lcom/android/internal/infra/PerUser;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mServiceConnectors:Lcom/android/internal/infra/PerUser;
...
.method static synthetic access$2300(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/os/Handler;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mMainHandler:Landroid/os/Handler;
...
.method static synthetic access$2500(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/bluetooth/BluetoothAdapter;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method static synthetic access$2600(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mDevicesLastNearby:Landroid/util/ArrayMap;
...
.method static synthetic access$3000(Lcom/android/server/companion/CompanionDeviceManagerService;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mCurrentlyConnectedDevices:Ljava/util/List;
...
.method private createDeviceListenerServiceConnector(Landroid/companion/Association;)Lcom/android/internal/infra/ServiceConnector;
    ...
    const-string v2, "Device presence listener package must have exactly one CompanionDeviceService, but "
    ...
    new-instance p1, Lcom/android/internal/infra/ServiceConnector$NoOp;

    invoke-direct {p1}, Lcom/android/internal/infra/ServiceConnector$NoOp;-><init>()V
    ...
    const-string v5, "android.permission.BIND_COMPANION_DEVICE_SERVICE"
    ...
    const-string p1, "Binding CompanionDeviceService must have android.permission.BIND_COMPANION_DEVICE_SERVICE permission."
    ...
    const-string v4, "Initializing CompanionDeviceService binding for "
    ...
    new-instance v1, Lcom/android/server/companion/CompanionDeviceManagerService$4;
    ...
    sget-object v10, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda16;->INSTANCE:Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda16;

    move-object v4, v1

    move-object v5, p0

    invoke-direct/range {v4 .. v10}, Lcom/android/server/companion/CompanionDeviceManagerService$4;-><init>(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/content/Context;Landroid/content/Intent;IILjava/util/function/Function;)V
...
.method private exemptFromAutoRevoke(Ljava/lang/String;I)V
    ...
    const-string v1, "Error while granting auto revoke exemption for "
...
.method private getAllAssociations()Ljava/util/Set;
    ...
    invoke-direct {p0, v4}, Lcom/android/server/companion/CompanionDeviceManagerService;->getAllAssociations(I)Ljava/util/Set;
...
.method private getAllAssociations(ILjava/lang/String;)Ljava/util/Set;
    ...
    new-instance v0, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda22;

    invoke-direct {v0, p2}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda22;-><init>(Ljava/lang/String;)V
...
.method private getAllAssociations(ILjava/lang/String;Ljava/lang/String;)Ljava/util/Set;
    ...
    new-instance v0, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda23;

    invoke-direct {v0, p2, p3}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda23;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private getAllAssociations(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v5}, Landroid/companion/Association;->getDeviceMacAddress()Ljava/lang/String;
...
.method private getStorageFileForUser(I)Landroid/util/AtomicFile;
    ...
    sget-object v1, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda17;->INSTANCE:Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda17;
...
.method static synthetic lambda$grantDeviceProfile$12(Landroid/companion/Association;Ljava/lang/Boolean;)V
    ...
    const-string v0, "Failed to grant device profile role "
...
.method static synthetic lambda$onAssociationPreRemove$3(Landroid/companion/Association;Ljava/lang/Boolean;)V
    ...
    const-string v0, "Failed to revoke device profile role "
...
.method static synthetic lambda$onDeviceNearby$16(Landroid/companion/Association;Landroid/companion/ICompanionDeviceService;)V
    ...
    invoke-interface {p1, p0}, Landroid/companion/ICompanionDeviceService;->onDeviceAppeared(Ljava/lang/String;)V
...
.method static synthetic lambda$persistAssociations$8(Ljava/util/Set;Ljava/io/FileOutputStream;)V
    ...
    new-instance p1, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda2;

    invoke-direct {p1, v1}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda2;-><init>(Lorg/xmlpull/v1/XmlSerializer;)V
...
.method private onDeviceDisappeared(Ljava/lang/String;)V
    ...
    const-string v5, "Sending onDeviceDisappeared to "
    ...
    new-instance v4, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda1;

    invoke-direct {v4, p1}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda1;-><init>(Ljava/lang/String;)V

    invoke-interface {v3, v4}, Lcom/android/internal/infra/ServiceConnector;->run(Lcom/android/internal/infra/ServiceConnector$VoidJob;)Z
...
.method private onDeviceNearby(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "onDeviceNearby(justAppeared, address = "
    ...
    invoke-virtual {v0}, Landroid/companion/Association;->isNotifyOnDeviceNearby()Z
    ...
    const-string v4, "Sending onDeviceAppeared to "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0}, Landroid/companion/Association;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/companion/CompanionDeviceManagerService;->getDeviceListenerServiceConnector(Landroid/companion/Association;)Lcom/android/internal/infra/ServiceConnector;

    move-result-object v3

    new-instance v4, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda0;

    invoke-direct {v4, v0}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda0;-><init>(Landroid/companion/Association;)V
...
.method private persistAssociations(Ljava/util/Set;I)V
    ...
    :try_start_0
    new-instance v0, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda10;

    invoke-direct {v0, p1}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda10;-><init>(Ljava/util/Set;)V

    invoke-virtual {p2, v0}, Landroid/util/AtomicFile;->write(Ljava/util/function/Consumer;)V
...
.method private readAllAssociations(I)Ljava/util/Set;
    ...
    const-string/jumbo v5, "notify_device_nearby"
    ...
    invoke-static {v5, v6, v7}, Lcom/android/server/companion/CompanionDeviceManagerService;->parseLongOrDefault(Ljava/lang/String;J)J
    ...
    :cond_3
    new-instance v5, Landroid/companion/Association;

    move-object v6, v5

    move v7, p1

    invoke-direct/range {v6 .. v13}, Landroid/companion/Association;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)V
    ...
    const-string v3, "Error while reading associations file"
...
.method private unbindDevicePresenceListener(Ljava/lang/String;I)V
    ...
    invoke-interface {p1}, Lcom/android/internal/infra/ServiceConnector;->unbind()V
...
.method private unscheduleTriggerDeviceDisappearedRunnable(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mMainHandler:Landroid/os/Handler;
...
.method private updateAssociations(Ljava/util/function/Function;I)V
    ...
    const-string v4, "Updating associations: "
    ...
    sget-object v2, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda4;
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/companion/CompanionDeviceManagerService;->updateAtm(ILjava/util/Set;)V
...
.method private updateAtm(ILjava/util/Set;)V
    ...
    invoke-virtual {v1}, Landroid/companion/Association;->getPackageName()Ljava/lang/String;
    ...
    :cond_2
    iget-object p2, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mAmInternal:Landroid/app/ActivityManagerInternal;
    ...
    invoke-virtual {p2, p1, v1}, Landroid/app/ActivityManagerInternal;->setCompanionAppUids(ILjava/util/Set;)V
...
.method private updateSpecialAccessPermissionAsSystem(Landroid/companion/Association;Landroid/content/pm/PackageInfo;)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/android/server/companion/CompanionDeviceManagerService;->exemptFromAutoRevoke(Ljava/lang/String;I)V

    iget-object p2, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mCurrentlyConnectedDevices:Ljava/util/List;
...
.method public synthetic lambda$onDeviceNearby$15$CompanionDeviceManagerService(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/companion/CompanionDeviceManagerService$TriggerDeviceDisappearedRunnable;
    ...
    new-instance p2, Lcom/android/server/companion/CompanionDeviceManagerService$TriggerDeviceDisappearedRunnable;

    invoke-direct {p2, p0, p1}, Lcom/android/server/companion/CompanionDeviceManagerService$TriggerDeviceDisappearedRunnable;-><init>(Lcom/android/server/companion/CompanionDeviceManagerService;Ljava/lang/String;)V
...
.method mayAssociateWithoutPrompt(Ljava/lang/String;I)Z
    ...
    const-string p1, " can not silently create associations due to no package found. Packages from OEM: "
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/companion/CompanionDeviceManagerService;->getAllAssociations(ILjava/lang/String;)Ljava/util/Set;

    move-result-object p2

    new-instance v1, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda18;

    invoke-direct {v1, v4, v5}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda18;-><init>(J)V

    invoke-static {p2, v1}, Lcom/android/internal/util/CollectionUtils;->filter(Ljava/util/Set;Ljava/util/function/Predicate;)Ljava/util/Set;
    ...
    const-string v1, "Too many associations. "
    ...
    iget-object v1, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/companion/CompanionDeviceManagerService;->getSameOemPackageCerts(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    const-string v4, " can not silently create associations. "

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, " has SHA256 certs from APK: "
...
.method maybeGrantAutoRevokeExemptions()V
    ...
    :try_start_0
    invoke-direct {p0, v6}, Lcom/android/server/companion/CompanionDeviceManagerService;->getAllAssociations(I)Ljava/util/Set;
    ...
    check-cast v11, Landroid/companion/Association;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-virtual {v11}, Landroid/companion/Association;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {p0, v13, v12}, Lcom/android/server/companion/CompanionDeviceManagerService;->exemptFromAutoRevoke(Ljava/lang/String;I)V
    :try_end_2
...
.method onAssociationPreRemove(Landroid/companion/Association;)V
    ...
    const-string p1, " - profile still present in "
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mRoleManager:Landroid/app/role/RoleManager;
    ...
    new-instance v8, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda8;

    invoke-direct {v8, p1}, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda8;-><init>(Landroid/companion/Association;)V
...
.method public onBootPhase(I)V
    ...
    iput-object p1, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    iget-object v1, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mBluetoothDeviceConnectedListener:Lcom/android/server/companion/CompanionDeviceManagerService$BluetoothDeviceConnectedListener;

    invoke-virtual {p1, v0, v1}, Landroid/bluetooth/BluetoothAdapter;->registerBluetoothConnectionCallback(Ljava/util/concurrent/Executor;Landroid/bluetooth/BluetoothAdapter$BluetoothConnectionCallback;)Z

    invoke-virtual {p0}, Lcom/android/server/companion/CompanionDeviceManagerService;->getContext()Landroid/content/Context;

    move-result-object p1

    iget-object v0, p0, Lcom/android/server/companion/CompanionDeviceManagerService;->mBleStateBroadcastReceiver:Lcom/android/server/companion/CompanionDeviceManagerService$BleStateBroadcastReceiver;

    iget-object v1, v0, Lcom/android/server/companion/CompanionDeviceManagerService$BleStateBroadcastReceiver;->mIntentFilter:Landroid/content/IntentFilter;
    ...
    const-string v0, "No BluetoothAdapter available"
...
.method onDeviceConnected(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/companion/CompanionDeviceManagerService;->getAllAssociations(I)Ljava/util/Set;
    ...
    invoke-virtual {v3}, Landroid/companion/Association;->getDeviceProfile()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Landroid/companion/Association;->getPackageName()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, " due to device connected: "
    ...
    invoke-direct {p0, v3}, Lcom/android/server/companion/CompanionDeviceManagerService;->grantDeviceProfile(Landroid/companion/Association;)V
...
.method public onUserUnlocking(Lcom/android/server/SystemService$TargetUser;)V
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, Lcom/android/server/companion/CompanionDeviceManagerService;->updateAtm(ILjava/util/Set;)V

    invoke-static {}, Lcom/android/internal/os/BackgroundThread;->getHandler()Landroid/os/Handler;

    move-result-object p1

    sget-object v0, Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda11;->INSTANCE:Lcom/android/server/companion/CompanionDeviceManagerService$$ExternalSyntheticLambda11;
...
.method startBleScan()V
    ...
    const-string/jumbo v1, "scanner == null (likely BLE isn\'t ON yet)"
