...
.method public getBrightness(Lcom/android/server/display/DisplayDevice;)F
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/display/PersistentDataStore;->getDisplayState(Ljava/lang/String;Z)Lcom/android/server/display/PersistentDataStore$DisplayState;
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/android/server/display/PersistentDataStore$DisplayState;->getBrightness()F
...
.method public getBrightnessConfigurationForDisplayLocked(Ljava/lang/String;I)Landroid/hardware/display/BrightnessConfiguration;
    ...
    check-cast p1, Lcom/android/server/display/PersistentDataStore$DisplayState;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Lcom/android/server/display/PersistentDataStore$DisplayState;->getBrightnessConfiguration(I)Landroid/hardware/display/BrightnessConfiguration;
...
.method public setBrightness(Lcom/android/server/display/DisplayDevice;F)Z
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/display/PersistentDataStore;->getDisplayState(Ljava/lang/String;Z)Lcom/android/server/display/PersistentDataStore$DisplayState;
...
.method public setBrightnessConfigurationForDisplayLocked(Landroid/hardware/display/BrightnessConfiguration;Lcom/android/server/display/DisplayDevice;ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p2, v1}, Lcom/android/server/display/PersistentDataStore;->getDisplayState(Ljava/lang/String;Z)Lcom/android/server/display/PersistentDataStore$DisplayState;
