...
.method setBacklight(FFFF)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/display/LocalDisplayAdapter$BacklightAdapter;->mBacklight:Lcom/android/server/lights/LogicalLight;

    if-eqz p1, :cond_3

    invoke-virtual {p1, p3}, Lcom/android/server/lights/LogicalLight;->setBrightness(F)V
    ...
    iget-object p2, p0, Lcom/android/server/display/LocalDisplayAdapter$BacklightAdapter;->mDisplayToken:Landroid/os/IBinder;

    invoke-virtual {p1, p2, p3}, Lcom/android/server/display/LocalDisplayAdapter$SurfaceControlProxy;->setDisplayBrightness(Landroid/os/IBinder;F)Z
