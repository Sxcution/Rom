...
.method public constructor <init>(Lcom/android/server/firewall/IntentFirewall$AMSInterface;Landroid/os/Handler;)V
    ...
    invoke-virtual {p2}, Lcom/android/server/firewall/IntentFirewall$RuleObserver;->startWatching()V
...
.method private readRules(Ljava/io/File;[Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;)V
    ...
    invoke-virtual {v1, v7}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->addFilter(Ljava/lang/Object;)V
...
.method private readRulesDir(Ljava/io/File;)V
    ...
    invoke-direct {p0, v3, v1}, Lcom/android/server/firewall/IntentFirewall;->readRules(Ljava/io/File;[Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;)V
...
.method public checkIntent(Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;Landroid/content/ComponentName;ILandroid/content/Intent;IILjava/lang/String;I)Z
    ...
    invoke-virtual {v0, v8, v9, v1, v1}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->queryIntent(Landroid/content/Intent;Ljava/lang/String;ZI)Ljava/util/List;
    ...
    invoke-virtual {v0, v11, v10}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->queryByComponent(Landroid/content/ComponentName;Ljava/util/List;)V
    ...
    check-cast v15, Lcom/android/server/firewall/IntentFirewall$Rule;
    ...
    invoke-virtual {v15}, Lcom/android/server/firewall/IntentFirewall$Rule;->getBlock()Z

    move-result v0

    or-int/2addr v13, v0

    invoke-virtual {v15}, Lcom/android/server/firewall/IntentFirewall$Rule;->getLog()Z
