...
.method public onCancellable(Landroid/os/ICancellationSignal;)V
    ...
    iget-object v0, p0, Lcom/android/server/autofill/RemoteFillService$1;->this$0:Lcom/android/server/autofill/RemoteFillService;

    invoke-static {v0, p1}, Lcom/android/server/autofill/RemoteFillService;->access$000(Lcom/android/server/autofill/RemoteFillService;Landroid/os/ICancellationSignal;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/android/server/autofill/RemoteFillService$1;->val$cancellationSink:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public onFailure(ILjava/lang/CharSequence;)V
    ...
    :goto_0
    iget-object p2, p0, Lcom/android/server/autofill/RemoteFillService$1;->val$fillRequest:Ljava/util/concurrent/CompletableFuture;
