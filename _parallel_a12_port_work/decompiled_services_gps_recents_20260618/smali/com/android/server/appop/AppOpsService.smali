...
.method private checkOperationUnchecked(IILjava/lang/String;Ljava/lang/String;Z)I
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/server/appop/AppOpsService;->isOpRestrictedLocked(IILjava/lang/String;Ljava/lang/String;Landroid/app/AppOpsManager$RestrictionBypass;Z)Z
    ...
    invoke-direct {p0, p2, p4}, Lcom/android/server/appop/AppOpsService;->getUidStateLocked(IZ)Lcom/android/server/appop/AppOpsService$UidState;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/appop/AppOpsService;->getOpLocked(IILjava/lang/String;Ljava/lang/String;ZLandroid/app/AppOpsManager$RestrictionBypass;Z)Lcom/android/server/appop/AppOpsService$Op;
    ...
    invoke-static {p2}, Lcom/android/server/appop/AppOpsService$Op;->access$400(Lcom/android/server/appop/AppOpsService$Op;)I
...
.method private collectAsyncNotedOp(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;Z)V
    ...
    :try_start_1
    invoke-direct {v7, v6, v0}, Lcom/android/server/appop/AppOpsService;->getAsyncNotedOpsKey(Ljava/lang/String;I)Landroid/util/Pair;
    ...
    invoke-direct/range {v17 .. v23}, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda15;-><init>(Landroid/app/AsyncNotedAppOp;[ZILjava/lang/String;ILjava/lang/String;)V
...
.method private collectUidOps(Lcom/android/server/appop/AppOpsService$UidState;[I)Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Lcom/android/server/appop/AppOpsService$UidState;->opModes:Landroid/util/SparseIntArray;
    ...
    invoke-direct {v3, v1, v4, v5}, Landroid/app/AppOpsManager$OpEntry;-><init>(IILjava/util/Map;)V
    ...
    invoke-direct {v3, v0, v4, v5}, Landroid/app/AppOpsManager$OpEntry;-><init>(IILjava/util/Map;)V
...
.method private commitUidPendingStateLocked(Lcom/android/server/appop/AppOpsService$UidState;)V
    ...
    :cond_6
    invoke-static {v0}, Lcom/android/server/appop/AppOpsService$Op;->access$400(Lcom/android/server/appop/AppOpsService$Op;)I
...
.method private dumpStatesLocked(Ljava/io/PrintWriter;JLcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;JLjava/text/SimpleDateFormat;Ljava/util/Date;Ljava/lang/String;)V
    ...
    iget-object v2, v2, Lcom/android/server/appop/AppOpsService$Op;->mAttributions:Landroid/util/ArrayMap;
    ...
    const-string v5, "Running start at: "
    ...
    const-string/jumbo v1, "startNesting="
...
.method private enforceGetAppOpsStatsPermissionIfNeeded(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v2, p2, v0, v1}, Landroid/content/Context;->enforcePermission(Ljava/lang/String;IILjava/lang/String;)V
...
.method private ensureHistoricalOpRequestIsValid(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;IJJI)V
    ...
    invoke-static {p10, p1}, Lcom/android/internal/util/Preconditions;->checkFlagsArgument(II)I
...
.method private finishProxyOperationImpl(ILandroid/content/AttributionSource;Z)Ljava/lang/Void;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/appop/AppOpsService;->isCallerAndAttributionTrusted(Landroid/content/AttributionSource;)Z
    ...
    :goto_0
    invoke-direct {p0, p2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingProxyUid(Landroid/content/AttributionSource;)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V

    invoke-static {v9}, Landroid/os/UserHandle;->getUserId(I)I

    move-result p2

    invoke-direct {p0, v6, p2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v6 .. v11}, Lcom/android/server/appop/AppOpsService;->finishOperationUnchecked(Landroid/os/IBinder;IILjava/lang/String;Ljava/lang/String;)V
...
.method private getBypassforPackage(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/app/AppOpsManager$RestrictionBypass;
    ...
    const-string v7, "android.permission.EXEMPT_FROM_AUDIO_RECORD_RESTRICTIONS"

    invoke-virtual {v5, v7, v6, p1}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I
...
.method private getOpLocked(IILjava/lang/String;Ljava/lang/String;ZLandroid/app/AppOpsManager$RestrictionBypass;Z)Lcom/android/server/appop/AppOpsService$Op;
    ...
    :cond_0
    invoke-direct {p0, p3, p1, p2, p7}, Lcom/android/server/appop/AppOpsService;->getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;
...
.method private getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;
    ...
    invoke-virtual {p1, p2, v6}, Lcom/android/server/appop/AppOpsService$Ops;->put(ILjava/lang/Object;)V
...
.method private getOpsLocked(ILjava/lang/String;Ljava/lang/String;ZLandroid/app/AppOpsManager$RestrictionBypass;Z)Lcom/android/server/appop/AppOpsService$Ops;
    ...
    invoke-direct {v1, p2, p1}, Lcom/android/server/appop/AppOpsService$Ops;-><init>(Ljava/lang/String;Lcom/android/server/appop/AppOpsService$UidState;)V
    ...
    iput-object p5, v1, Lcom/android/server/appop/AppOpsService$Ops;->bypass:Landroid/app/AppOpsManager$RestrictionBypass;

    :cond_5
    if-eqz p3, :cond_7

    iget-object p1, v1, Lcom/android/server/appop/AppOpsService$Ops;->knownAttributionTags:Landroid/util/ArraySet;

    invoke-virtual {p1, p3}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z

    if-eqz p4, :cond_6

    iget-object p1, v1, Lcom/android/server/appop/AppOpsService$Ops;->validAttributionTags:Landroid/util/ArraySet;
...
.method private getPackageNamesForSampling()Ljava/util/List;
    ...
    invoke-virtual {v1, v3, v4, v5, v6}, Landroid/content/pm/PackageManagerInternal;->getPackageInfo(Ljava/lang/String;III)Landroid/content/pm/PackageInfo;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/android/server/appop/AppOpsService;->isSamplingTarget(Landroid/content/pm/PackageInfo;)Z
...
.method private isCallerAndAttributionTrusted(Landroid/content/AttributionSource;)Z
    ...
    invoke-virtual {p1, v4, v0, v1, v3}, Landroid/content/Context;->checkPermission(Ljava/lang/String;IILandroid/os/IBinder;)I
...
.method private isOpRestrictedLocked(IILjava/lang/String;Ljava/lang/String;Landroid/app/AppOpsManager$RestrictionBypass;Z)Z
    .locals 14
...
.method private noteOperationImpl(IILjava/lang/String;Ljava/lang/String;ZLjava/lang/String;Z)Landroid/app/SyncNotedAppOp;
    ...
    invoke-direct {p0, p3, v3}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V
...
.method private noteOperationUnchecked(IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IZLjava/lang/String;Z)Landroid/app/SyncNotedAppOp;
    ...
    :try_start_0
    invoke-direct {v9, v0, v11, v1, v13}, Lcom/android/server/appop/AppOpsService;->verifyAndGetBypass(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$PackageVerificationResult;
    ...
    invoke-direct {v9, v7, v10, v0, v12}, Lcom/android/server/appop/AppOpsService;->getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;

    move-result-object v6

    invoke-static {v6, v6, v15}, Lcom/android/server/appop/AppOpsService$Op;->access$1600(Lcom/android/server/appop/AppOpsService$Op;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$AttributedOp;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/appop/AppOpsService;->isOpRestrictedLocked(IILjava/lang/String;Ljava/lang/String;Landroid/app/AppOpsManager$RestrictionBypass;Z)Z
    ...
    invoke-direct {v9, v14, v2, v0, v1}, Lcom/android/server/appop/AppOpsService;->getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;
...
.method private noteProxyOperationImpl(ILandroid/content/AttributionSource;ZLjava/lang/String;ZZ)Landroid/app/SyncNotedAppOp;
    ...
    invoke-direct {v12, v0}, Lcom/android/server/appop/AppOpsService;->verifyIncomingProxyUid(Landroid/content/AttributionSource;)V
    ...
    invoke-direct {v12, v10, v2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V

    invoke-static {v14}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v2

    invoke-direct {v12, v1, v2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V
    ...
    invoke-direct {v12, v0}, Lcom/android/server/appop/AppOpsService;->isCallerAndAttributionTrusted(Landroid/content/AttributionSource;)Z
...
.method private notifyOpActiveChanged(Landroid/util/ArraySet;IILjava/lang/String;Ljava/lang/String;ZII)V
    ...
    :try_start_1
    iget-object v6, v0, Lcom/android/server/appop/AppOpsService$ActiveCallback;->mCallback:Lcom/android/internal/app/IAppOpsActiveCallback;
    ...
    invoke-interface/range {v6 .. v13}, Lcom/android/internal/app/IAppOpsActiveCallback;->opActiveChanged(IILjava/lang/String;Ljava/lang/String;ZII)V
    :try_end_1
...
.method private notifyOpChecked(Landroid/util/ArraySet;IILjava/lang/String;Ljava/lang/String;II)V
    ...
    :try_start_1
    iget-object v6, v0, Lcom/android/server/appop/AppOpsService$NotedCallback;->mCallback:Lcom/android/internal/app/IAppOpsNotedCallback;
    ...
    invoke-interface/range {v6 .. v12}, Lcom/android/internal/app/IAppOpsNotedCallback;->opNoted(IILjava/lang/String;Ljava/lang/String;II)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private notifyOpStarted(Landroid/util/ArraySet;IILjava/lang/String;Ljava/lang/String;IIIII)V
    ...
    :try_start_1
    iget-object v6, v0, Lcom/android/server/appop/AppOpsService$StartedCallback;->mCallback:Lcom/android/internal/app/IAppOpsStartedCallback;
    ...
    invoke-interface/range {v6 .. v15}, Lcom/android/internal/app/IAppOpsStartedCallback;->opStarted(IILjava/lang/String;Ljava/lang/String;IIIII)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method static onShellCommand(Lcom/android/server/appop/AppOpsService$Shell;Ljava/lang/String;)I
    ...
    :cond_2
    iget-object v1, v0, Lcom/android/server/appop/AppOpsService$Shell;->packageName:Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v5, v4}, Lcom/android/server/appop/AppOpsService;->enforceManageAppOpsModes(III)V
    ...
    iget-object v3, v3, Lcom/android/server/appop/AppOpsService;->mHandler:Landroid/os/Handler;
    ...
    :goto_9
    invoke-interface {v3, v5, v9}, Lcom/android/internal/app/IAppOpsService;->getUidOps(I[I)Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/server/appop/AppOpsService$Shell;->packageName:Ljava/lang/String;

    invoke-interface {v3, v5, v6, v0, v1}, Lcom/android/internal/app/IAppOpsService;->setMode(IILjava/lang/String;I)V
...
.method private readAttributionOp(Landroid/util/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v13, v14, v11, v12}, Lcom/android/server/appop/AppOpsService$AttributedOp;->rejected(JII)V
...
.method private readOp(Landroid/util/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$UidState;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/android/server/appop/AppOpsService$Op;->access$402(Lcom/android/server/appop/AppOpsService$Op;I)I
    ...
    invoke-direct {p0, p1, v1, v2}, Lcom/android/server/appop/AppOpsService;->readAttributionOp(Landroid/util/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)V
    ...
    iput-object p1, p2, Lcom/android/server/appop/AppOpsService$UidState;->pkgOps:Landroid/util/ArrayMap;
    ...
    invoke-direct {p1, p3, p2}, Lcom/android/server/appop/AppOpsService$Ops;-><init>(Ljava/lang/String;Lcom/android/server/appop/AppOpsService$UidState;)V
    ...
    :cond_6
    iget p2, v1, Lcom/android/server/appop/AppOpsService$Op;->op:I

    invoke-virtual {p1, p2, v1}, Lcom/android/server/appop/AppOpsService$Ops;->put(ILjava/lang/Object;)V
...
.method private readUid(Landroid/util/TypedXmlPullParser;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/appop/AppOpsService;->readOp(Landroid/util/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$UidState;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/appop/AppOpsService$UidState;->evalForegroundOps(Landroid/util/SparseArray;)V
...
.method private resamplePackageAndAppOpLocked(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/appop/AppOpsService;->resampleAppOpForPackageLocked(Ljava/lang/String;Z)V
...
.method private setMode(IILjava/lang/String;ILcom/android/internal/app/IAppOpsCallback;)V
    ...
    invoke-direct {v9, v1, v2, v0}, Lcom/android/server/appop/AppOpsService;->enforceManageAppOpsModes(III)V
    ...
    invoke-direct {v9, v10, v1}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-direct {v9, v0, v10, v13}, Lcom/android/server/appop/AppOpsService;->verifyAndGetBypass(ILjava/lang/String;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$PackageVerificationResult;
    ...
    :try_start_1
    invoke-direct {v9, v0, v15}, Lcom/android/server/appop/AppOpsService;->getUidStateLocked(IZ)Lcom/android/server/appop/AppOpsService$UidState;
    ...
    invoke-static {v1, v11}, Lcom/android/server/appop/AppOpsService$Op;->access$402(Lcom/android/server/appop/AppOpsService$Op;I)I
    ...
    invoke-direct {v9, v1, v0, v10}, Lcom/android/server/appop/AppOpsService;->pruneOpLocked(Lcom/android/server/appop/AppOpsService$Op;ILjava/lang/String;)V
    ...
    :cond_6
    invoke-direct {v9, v12, v15, v0}, Lcom/android/server/appop/AppOpsService;->updateStartedOpModeForUidLocked(IZI)V
...
.method private setUidMode(IIILcom/android/internal/app/IAppOpsCallback;)V
    ...
    invoke-direct {p0, p2, v3, p3}, Lcom/android/server/appop/AppOpsService;->updatePermissionRevokedCompat(III)V
    ...
    :goto_2
    invoke-direct {p0, v3, p1, p2}, Lcom/android/server/appop/AppOpsService;->updateStartedOpModeForUidLocked(IZI)V
    ...
    invoke-direct {p0, v3, p2, v0, p4}, Lcom/android/server/appop/AppOpsService;->notifyOpChangedForAllPkgsInUid(IIZLcom/android/internal/app/IAppOpsCallback;)V
...
.method private setUserRestrictionNoCheck(IZLandroid/os/IBinder;ILandroid/os/PackageTagsList;)V
    ...
    sget-object v1, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda4;
...
.method private startOperationImpl(Landroid/os/IBinder;IILjava/lang/String;Ljava/lang/String;ZZLjava/lang/String;ZII)Landroid/app/SyncNotedAppOp;
    ...
    invoke-direct {v0, v3}, Lcom/android/server/appop/AppOpsService;->verifyIncomingUid(I)V

    invoke-direct {v0, v2}, Lcom/android/server/appop/AppOpsService;->verifyIncomingOp(I)V

    invoke-static/range {p3 .. p3}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v1

    invoke-direct {v0, v4, v1}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V
...
.method private startOperationUnchecked(Landroid/os/IBinder;IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IZZLjava/lang/String;ZIIZ)Landroid/app/SyncNotedAppOp;
    ...
    :try_start_0
    invoke-direct {v11, v0, v13, v1, v9}, Lcom/android/server/appop/AppOpsService;->verifyAndGetBypass(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$PackageVerificationResult;
    ...
    invoke-direct {v11, v7, v12, v0, v14}, Lcom/android/server/appop/AppOpsService;->getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;

    move-result-object v5

    invoke-static {v5, v5, v6}, Lcom/android/server/appop/AppOpsService$Op;->access$1600(Lcom/android/server/appop/AppOpsService$Op;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$AttributedOp;
    ...
    invoke-direct {v11, v15, v8}, Lcom/android/server/appop/AppOpsService;->shouldStartForMode(IZ)Z
    ...
    invoke-direct {v11, v15, v1, v0, v5}, Lcom/android/server/appop/AppOpsService;->getOpLocked(Lcom/android/server/appop/AppOpsService$Ops;IIZ)Lcom/android/server/appop/AppOpsService$Op;
...
.method private startProxyOperationImpl(ILandroid/content/AttributionSource;ZZLjava/lang/String;ZZIII)Landroid/app/SyncNotedAppOp;
    ...
    invoke-direct {v15, v0}, Lcom/android/server/appop/AppOpsService;->verifyIncomingProxyUid(Landroid/content/AttributionSource;)V
    ...
    invoke-direct {v15, v1, v3}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V

    invoke-static {v11}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v3

    invoke-direct {v15, v2, v3}, Lcom/android/server/appop/AppOpsService;->verifyIncomingPackage(Ljava/lang/String;I)V

    invoke-direct {v15, v0}, Lcom/android/server/appop/AppOpsService;->isCallerAndAttributionTrusted(Landroid/content/AttributionSource;)Z
    ...
    invoke-direct {v15, v1, v14}, Lcom/android/server/appop/AppOpsService;->shouldStartForMode(IZ)Z
    ...
    invoke-direct {v2, v1, v10}, Lcom/android/server/appop/AppOpsService;->shouldStartForMode(IZ)Z
...
.method private updateAppWidgetVisibility(Landroid/util/SparseArray;Z)V
    ...
    iget-boolean v4, v2, Lcom/android/server/appop/AppOpsService$UidState;->appWidgetVisible:Z

    if-eq v3, v4, :cond_0

    invoke-direct {p0, v2}, Lcom/android/server/appop/AppOpsService;->commitUidPendingStateLocked(Lcom/android/server/appop/AppOpsService$UidState;)V
...
.method private updateStartedOpModeForUidLocked(IZI)V
    ...
    check-cast p3, Lcom/android/server/appop/AppOpsService$UidState;

    if-eqz p3, :cond_7

    iget-object v0, p3, Lcom/android/server/appop/AppOpsService$UidState;->pkgOps:Landroid/util/ArrayMap;
    ...
    iget-object v3, p3, Lcom/android/server/appop/AppOpsService$UidState;->pkgOps:Landroid/util/ArrayMap;
    ...
    invoke-static {v3}, Lcom/android/server/appop/AppOpsService$Op;->access$400(Lcom/android/server/appop/AppOpsService$Op;)I
    ...
    check-cast v6, Lcom/android/server/appop/AppOpsService$AttributedOp;

    if-eqz p2, :cond_3

    invoke-virtual {v6}, Lcom/android/server/appop/AppOpsService$AttributedOp;->isRunning()Z

    move-result v7

    if-eqz v7, :cond_3

    invoke-virtual {v6}, Lcom/android/server/appop/AppOpsService$AttributedOp;->pause()V

    goto :goto_3

    :cond_3
    invoke-virtual {v6}, Lcom/android/server/appop/AppOpsService$AttributedOp;->isPaused()Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-virtual {v6}, Lcom/android/server/appop/AppOpsService$AttributedOp;->resume()V
...
.method private upgradeRunAnyInBackgroundLocked()V
    ...
    iget-object v2, v9, Lcom/android/server/appop/AppOpsService$UidState;->opModes:Landroid/util/SparseIntArray;
    ...
    invoke-virtual {v13, v11}, Lcom/android/server/appop/AppOpsService$Ops;->get(I)Ljava/lang/Object;
    ...
    invoke-static {v15, v0}, Lcom/android/server/appop/AppOpsService$Op;->access$402(Lcom/android/server/appop/AppOpsService$Op;I)I

    invoke-virtual {v13, v10, v15}, Lcom/android/server/appop/AppOpsService$Ops;->put(ILjava/lang/Object;)V
...
.method private verifyAndGetBypass(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/appop/AppOpsService$PackageVerificationResult;
    ...
    invoke-direct {p1, v1, v0}, Lcom/android/server/appop/AppOpsService$PackageVerificationResult;-><init>(Landroid/app/AppOpsManager$RestrictionBypass;Z)V
    ...
    iget-object p2, v2, Lcom/android/server/appop/AppOpsService$Ops;->bypass:Landroid/app/AppOpsManager$RestrictionBypass;

    iget-object p4, v2, Lcom/android/server/appop/AppOpsService$Ops;->validAttributionTags:Landroid/util/ArraySet;

    invoke-virtual {p4, p3}, Landroid/util/ArraySet;->contains(Ljava/lang/Object;)Z

    move-result p3

    invoke-direct {p1, p2, p3}, Lcom/android/server/appop/AppOpsService$PackageVerificationResult;-><init>(Landroid/app/AppOpsManager$RestrictionBypass;Z)V
    ...
    sget-object p2, Landroid/app/AppOpsManager$RestrictionBypass;->UNRESTRICTED:Landroid/app/AppOpsManager$RestrictionBypass;

    invoke-direct {p1, p2, v0}, Lcom/android/server/appop/AppOpsService$PackageVerificationResult;-><init>(Landroid/app/AppOpsManager$RestrictionBypass;Z)V

    return-object p1

    :cond_4
    const-string p3, " but it is not"
    ...
    invoke-direct {p0, v9, p3}, Lcom/android/server/appop/AppOpsService;->isAttributionInPackage(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Ljava/lang/String;)Z

    move-result v5

    invoke-interface {v9}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getUid()I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/appop/AppOpsService;->getBypassforPackage(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/app/AppOpsManager$RestrictionBypass;
    ...
    :goto_2
    invoke-direct {p0, v1, p3}, Lcom/android/server/appop/AppOpsService;->isAttributionInPackage(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Ljava/lang/String;)Z
    ...
    invoke-interface {p4, v8, v9, v2}, Lcom/android/internal/compat/IPlatformCompat;->isChangeEnabledByUid(JI)Z
    ...
    invoke-direct {p1, v10, v5}, Lcom/android/server/appop/AppOpsService$PackageVerificationResult;-><init>(Landroid/app/AppOpsManager$RestrictionBypass;Z)V
...
.method public collectRuntimeAppOpAccessMessage()Landroid/app/RuntimeAppOpAccessMessage;
    ...
    sget-object v2, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda16;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda16;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v7, v14}, Lcom/android/server/appop/AppOpsService$Shell;->access$2900(Ljava/lang/String;Ljava/io/PrintWriter;)I
    ...
    :try_start_1
    invoke-interface {v12, v3, v15, v2}, Landroid/content/pm/IPackageManager;->getPackageUid(Ljava/lang/String;II)I
    ...
    iget v3, v15, Lcom/android/server/appop/AppOpsService$ModeCallback;->mWatchingUid:I
    ...
    iget-object v3, v13, Lcom/android/server/appop/AppOpsService;->mOpModeWatchers:Landroid/util/SparseArray;
    ...
    invoke-virtual {v14, v4}, Ljava/io/PrintWriter;->print(I)V
    ...
    iget v7, v4, Lcom/android/server/appop/AppOpsService$ModeCallback;->mWatchingUid:I
    ...
    check-cast v15, Lcom/android/server/appop/AppOpsService$ActiveCallback;
    ...
    iget v2, v15, Lcom/android/server/appop/AppOpsService$ActiveCallback;->mWatchingUid:I
    ...
    check-cast v15, Lcom/android/server/appop/AppOpsService$StartedCallback;
    ...
    iget v7, v15, Lcom/android/server/appop/AppOpsService$StartedCallback;->mWatchingUid:I
    ...
    invoke-virtual {v4, v8}, Landroid/util/SparseIntArray;->indexOfKey(I)I
    ...
    invoke-virtual {v12, v8}, Lcom/android/server/appop/AppOpsService$Ops;->indexOfKey(I)I
    ...
    invoke-virtual {v12, v9}, Lcom/android/server/appop/AppOpsService$Ops;->valueAt(I)Ljava/lang/Object;
    ...
    iget-object v1, v9, Lcom/android/server/appop/AppOpsService$Ops;->packageName:Ljava/lang/String;
    ...
    invoke-virtual {v9, v4}, Lcom/android/server/appop/AppOpsService$Ops;->valueAt(I)Ljava/lang/Object;
    ...
    iget v1, v3, Lcom/android/server/appop/AppOpsService$Op;->op:I
    ...
    iget-object v2, v9, Lcom/android/server/appop/AppOpsService$Ops;->packageName:Ljava/lang/String;
    ...
    invoke-virtual {v9, v2}, Lcom/android/server/appop/AppOpsService$Ops;->get(I)Ljava/lang/Object;
...
.method public getHistoricalOps(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;IIJJILandroid/os/RemoteCallback;)V
    ...
    invoke-virtual {v1, v2}, Landroid/app/ActivityManagerInternal;->isUidCurrentlyInstrumented(I)Z
    ...
    invoke-virtual {v14, v6, v3, v7}, Landroid/content/pm/PackageManager;->getPackageUidAsUser(Ljava/lang/String;II)I
    ...
    invoke-direct {v1, v13}, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda12;-><init>(Landroid/os/RemoteCallback;)V
    ...
    invoke-virtual {v1, v4, v2, v3, v6}, Landroid/content/Context;->enforcePermission(Ljava/lang/String;IILjava/lang/String;)V
    ...
    :goto_5
    iget-object v14, v0, Lcom/android/server/appop/AppOpsService;->mHandler:Landroid/os/Handler;

    sget-object v1, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda0;
...
.method public getHistoricalOpsFromDiskRaw(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;IIJJILandroid/os/RemoteCallback;)V
    ...
    sget-object v1, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda1;
...
.method public getUidOps(I[I)Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/appop/AppOpsService;->collectUidOps(Lcom/android/server/appop/AppOpsService$UidState;[I)Ljava/util/ArrayList;
...
.method public isOperationActive(IILjava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {p2, p1}, Lcom/android/server/appop/AppOpsService$Ops;->get(I)Ljava/lang/Object;
...
.method public isProxying(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)Z
    ...
    :try_start_2
    invoke-virtual {p1, p4}, Landroid/app/AppOpsManager$OpEntry;->getLastProxyInfo(I)Landroid/app/AppOpsManager$OpEventProxyInfo;
    ...
    invoke-virtual {p1}, Landroid/app/AppOpsManager$OpEventProxyInfo;->getAttributionTag()Ljava/lang/String;
...
.method public synthetic lambda$systemReady$0$AppOpsService(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p1, p2, v3}, Landroid/net/Uri;->fromParts(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method readState()V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/appop/AppOpsService;->readPackage(Landroid/util/TypedXmlPullParser;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/appop/AppOpsService;->readUidOps(Landroid/util/TypedXmlPullParser;)V
...
.method public resetAllModes(ILjava/lang/String;)V
    ...
    invoke-static {v10, v8, v6, v0, v9}, Lcom/android/server/appop/AppOpsService;->addChange(Ljava/util/ArrayList;IILjava/lang/String;I)Ljava/util/ArrayList;
    ...
    :goto_6
    iget-object v0, v12, Lcom/android/server/appop/AppOpsService$UidState;->pkgOps:Landroid/util/ArrayMap;
    ...
    iget v0, v12, Lcom/android/server/appop/AppOpsService$UidState;->uid:I
    ...
    invoke-virtual {v8, v11}, Lcom/android/server/appop/AppOpsService$Ops;->valueAt(I)Ljava/lang/Object;
    ...
    invoke-direct {v7, v14}, Lcom/android/server/appop/AppOpsService;->shouldDeferResetOpToDpm(I)Z
    ...
    invoke-direct {v7, v14, v1, v4}, Lcom/android/server/appop/AppOpsService;->deferResetOpToDpm(ILjava/lang/String;I)V
    ...
    invoke-static {v15}, Lcom/android/server/appop/AppOpsService$Op;->access$400(Lcom/android/server/appop/AppOpsService$Op;)I

    move-result v14

    iget v5, v15, Lcom/android/server/appop/AppOpsService$Op;->op:I
    ...
    invoke-static {v15, v5}, Lcom/android/server/appop/AppOpsService$Op;->access$402(Lcom/android/server/appop/AppOpsService$Op;I)I

    nop

    nop

    iget-object v5, v15, Lcom/android/server/appop/AppOpsService$Op;->uidState:Lcom/android/server/appop/AppOpsService$UidState;
    ...
    invoke-static {v10, v6, v5, v9, v2}, Lcom/android/server/appop/AppOpsService;->addChange(Ljava/util/ArrayList;IILjava/lang/String;I)Ljava/util/ArrayList;

    move-result-object v10

    invoke-virtual {v1}, Lcom/android/server/appop/AppOpsService$Op;->removeAttributionsWithNoTime()V
    ...
    invoke-virtual {v8, v11}, Lcom/android/server/appop/AppOpsService$Ops;->removeAt(I)V
    ...
    iget v1, v12, Lcom/android/server/appop/AppOpsService$UidState;->uid:I
    ...
    invoke-virtual {v12, v0}, Lcom/android/server/appop/AppOpsService$UidState;->evalForegroundOps(Landroid/util/SparseArray;)V
    ...
    sget-object v2, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda6;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda6;
    ...
    iget v5, v1, Lcom/android/server/appop/AppOpsService$ChangeRec;->op:I
...
.method public setAudioRestriction(IIII[Ljava/lang/String;)V
    ...
    sget-object p3, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda8;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda8;
...
.method public shutdown()V
    ...
    invoke-virtual {v0}, Lcom/android/server/appop/HistoricalRegistry;->shutdown()V
...
.method public systemReady()V
    ...
    :goto_2
    new-instance v8, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda14;

    invoke-direct {v8, p0, v7, v6, v1}, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda14;-><init>(Lcom/android/server/appop/AppOpsService;Ljava/lang/String;Ljava/lang/String;I)V
...
.method public updateUidProcState(III)V
    ...
    iget v2, v0, Lcom/android/server/appop/AppOpsService$UidState;->state:I
    ...
    iget v1, v0, Lcom/android/server/appop/AppOpsService$UidState;->capability:I
    ...
    iget p3, v0, Lcom/android/server/appop/AppOpsService$UidState;->state:I
    ...
    sget-object v5, Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda10;->INSTANCE:Lcom/android/server/appop/AppOpsService$$ExternalSyntheticLambda10;
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/appop/AppOpsService$Ops;->valueAt(I)Ljava/lang/Object;
