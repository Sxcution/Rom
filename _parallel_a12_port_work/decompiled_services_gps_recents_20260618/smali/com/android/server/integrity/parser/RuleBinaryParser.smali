...
.method private parseAtomicFormula(Lcom/android/server/integrity/model/BitInputStream;)Landroid/content/integrity/AtomicFormula;
    ...
    new-instance v1, Landroid/content/integrity/AtomicFormula$BooleanAtomicFormula;

    invoke-direct {v1, v0, p1}, Landroid/content/integrity/AtomicFormula$BooleanAtomicFormula;-><init>(IZ)V
    ...
    invoke-direct {p1, v0, v1, v2, v3}, Landroid/content/integrity/AtomicFormula$LongAtomicFormula;-><init>(IIJ)V
    ...
    invoke-static {p1, v1, v2}, Lcom/android/server/integrity/parser/BinaryFileOperations;->getStringValue(Lcom/android/server/integrity/model/BitInputStream;IZ)Ljava/lang/String;

    move-result-object p1

    new-instance v1, Landroid/content/integrity/AtomicFormula$StringAtomicFormula;

    invoke-direct {v1, v0, p1, v2}, Landroid/content/integrity/AtomicFormula$StringAtomicFormula;-><init>(ILjava/lang/String;Z)V
...
.method private parseCompoundFormula(Lcom/android/server/integrity/model/BitInputStream;)Landroid/content/integrity/CompoundFormula;
    ...
    :cond_0
    new-instance p1, Landroid/content/integrity/CompoundFormula;

    invoke-direct {p1, v0, v1}, Landroid/content/integrity/CompoundFormula;-><init>(ILjava/util/List;)V
...
.method private parseFormula(Lcom/android/server/integrity/model/BitInputStream;)Landroid/content/integrity/IntegrityFormula;
    ...
    :pswitch_0
    new-instance p1, Landroid/content/integrity/InstallerAllowedByManifestFormula;

    invoke-direct {p1}, Landroid/content/integrity/InstallerAllowedByManifestFormula;-><init>()V
...
.method private parseIndexedRules(Lcom/android/server/integrity/parser/RandomAccessInputStream;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/integrity/parser/RuleBinaryParser;->parseRule(Lcom/android/server/integrity/model/BitInputStream;)Landroid/content/integrity/Rule;
...
.method private parseRule(Lcom/android/server/integrity/model/BitInputStream;)Landroid/content/integrity/Rule;
    ...
    invoke-direct {p1, v0, v1}, Landroid/content/integrity/Rule;-><init>(Landroid/content/integrity/IntegrityFormula;I)V
    ...
    const-string v0, "A rule must end with a \'1\' bit."
...
.method public parse(Lcom/android/server/integrity/parser/RandomAccessObject;Ljava/util/List;)Ljava/util/List;
    ...
    new-instance p2, Lcom/android/server/integrity/parser/RuleParseException;

    invoke-virtual {p1}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p2, v0, p1}, Lcom/android/server/integrity/parser/RuleParseException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
