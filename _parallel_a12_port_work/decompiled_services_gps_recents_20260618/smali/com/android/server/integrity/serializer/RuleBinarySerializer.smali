...
.method private serializeAtomicFormula(Landroid/content/integrity/AtomicFormula;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeStringValue(Ljava/lang/String;ZLcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeIntValue(ILcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeBooleanValue(ZLcom/android/server/integrity/model/BitOutputStream;)V
    ...
    const-string p2, "Null atomic formula can not be serialized"
...
.method private serializeCompoundFormula(Landroid/content/integrity/CompoundFormula;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    const-string p2, "Null compound formula can not be serialized"
...
.method private serializeFormula(Landroid/content/integrity/IntegrityFormula;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeAtomicFormula(Landroid/content/integrity/AtomicFormula;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeCompoundFormula(Landroid/content/integrity/CompoundFormula;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-virtual {p2, p1, p1}, Lcom/android/server/integrity/model/BitOutputStream;->setNext(II)V
...
.method private serializeIndexGroup(Ljava/util/LinkedHashMap;Lcom/android/server/integrity/model/BitOutputStream;Z)V
    ...
    invoke-direct {p0, v4, v1, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeStringValue(Ljava/lang/String;ZLcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-direct {p0, v3, p2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeIntValue(ILcom/android/server/integrity/model/BitOutputStream;)V
...
.method private serializeRule(Landroid/content/integrity/Rule;Lcom/android/server/integrity/model/BitOutputStream;)V
    ...
    const-string p2, "Null rule can not be serialized"
...
.method private serializeRuleFileMetadata(Ljava/util/Optional;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)V
    ...
    invoke-virtual {v0, p2, p1}, Lcom/android/server/integrity/model/BitOutputStream;->setNext(II)V
...
.method private serializeRuleList(Ljava/util/Map;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v6, v1}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeRule(Landroid/content/integrity/Rule;Lcom/android/server/integrity/model/BitOutputStream;)V
...
.method private serializeStringValue(Ljava/lang/String;ZLcom/android/server/integrity/model/BitOutputStream;)V
    ...
    invoke-virtual {p3, v0, p2}, Lcom/android/server/integrity/model/BitOutputStream;->setNext(II)V
    ...
    invoke-virtual {p3, v0, v2}, Lcom/android/server/integrity/model/BitOutputStream;->setNext(II)V
    ...
    const-string p2, "String value can not be null."
...
.method private verifySize(Ljava/util/Map;I)V
    ...
    sget-object v0, Lcom/android/server/integrity/serializer/RuleBinarySerializer$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/integrity/serializer/RuleBinarySerializer$$ExternalSyntheticLambda0;

    invoke-interface {p1, v0}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p1

    sget-object v0, Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda7;
    ...
    const-string v2, "Too many rules provided in the indexing group. Provided "
...
.method public serialize(Ljava/util/List;Ljava/util/Optional;Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->verifySize(Ljava/util/Map;I)V
    ...
    invoke-direct {p0, v3, v2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->verifySize(Ljava/util/Map;I)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->verifySize(Ljava/util/Map;I)V
    ...
    invoke-direct {p0, p2, v3}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeRuleFileMetadata(Ljava/util/Optional;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)V
    ...
    invoke-direct {p0, p2, v3}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeRuleList(Ljava/util/Map;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, p3, v3}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeRuleList(Ljava/util/Map;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeRuleList(Ljava/util/Map;Lcom/android/server/integrity/model/ByteTrackedOutputStream;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, p2, v1, v0}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeIndexGroup(Ljava/util/LinkedHashMap;Lcom/android/server/integrity/model/BitOutputStream;Z)V

    invoke-direct {p0, p3, v1, v0}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeIndexGroup(Ljava/util/LinkedHashMap;Lcom/android/server/integrity/model/BitOutputStream;Z)V

    invoke-direct {p0, p1, v1, v2}, Lcom/android/server/integrity/serializer/RuleBinarySerializer;->serializeIndexGroup(Ljava/util/LinkedHashMap;Lcom/android/server/integrity/model/BitOutputStream;Z)V
    ...
    const-string p4, "Too many rules provided: "
    ...
    const-string p2, "Null rules cannot be serialized."
    ...
    :goto_0
    new-instance p2, Lcom/android/server/integrity/serializer/RuleSerializeException;

    invoke-virtual {p1}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p2, p3, p1}, Lcom/android/server/integrity/serializer/RuleSerializeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public serialize(Ljava/util/List;Ljava/util/Optional;)[B
    ...
    invoke-direct {p2, v0, p1}, Lcom/android/server/integrity/serializer/RuleSerializeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
