...
.method private dumpRecentHistory(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v8, v7, v15}, Lcom/android/server/content/SyncManager$AuthoritySyncStats;-><init>(Ljava/lang/String;Lcom/android/server/content/SyncManager$1;)V
    ...
    invoke-direct {v8, v2, v15}, Lcom/android/server/content/SyncManager$AccountSyncStats;-><init>(Ljava/lang/String;Lcom/android/server/content/SyncManager$1;)V
    ...
    iget-wide v14, v4, Lcom/android/server/content/SyncManager$AccountSyncStats;->elapsedTime:J
...
.method private getUnusedJobIdH()I
    ...
    invoke-direct {p0, v4, v0}, Lcom/android/server/content/SyncManager;->isJobIdInUseLockedH(ILjava/util/List;)Z
...
.method private scheduleSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;IJZIIILjava/lang/String;)V
    ...
    invoke-direct {v0, v5, v15}, Lcom/android/server/content/SyncManager;->wasPackageEverLaunched(Ljava/lang/String;I)Z
    ...
    new-instance v2, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda3;
    ...
    invoke-static {v15, v0, v1, v14}, Lcom/android/server/content/SyncManager;->sendOnUnsyncableAccount(Landroid/content/Context;Landroid/content/pm/RegisteredServicesCache$ServiceInfo;ILcom/android/server/content/SyncManager$OnReadyCallback;)V
    ...
    invoke-direct {v15, v1, v8, v9}, Lcom/android/server/content/SyncManager;->postScheduleSyncMessage(Lcom/android/server/content/SyncOperation;J)V
    ...
    invoke-direct {v3, v1, v4, v5}, Lcom/android/server/content/SyncManager;->postScheduleSyncMessage(Lcom/android/server/content/SyncOperation;J)V
...
.method private scheduleSyncOperationH(Lcom/android/server/content/SyncOperation;J)V
    ...
    iget-boolean v8, v6, Lcom/android/server/content/SyncOperation;->isPeriodic:Z
    ...
    :cond_13
    iget-object v8, v6, Lcom/android/server/content/SyncOperation;->key:Ljava/lang/String;
    ...
    :cond_14
    iget v8, v6, Lcom/android/server/content/SyncOperation;->syncExemptionFlag:I
    ...
    invoke-direct {v0, v6, v8}, Lcom/android/server/content/SyncManager;->cancelJob(Lcom/android/server/content/SyncOperation;Ljava/lang/String;)V
    ...
    iput v7, v1, Lcom/android/server/content/SyncOperation;->syncExemptionFlag:I
    ...
    invoke-virtual {v6, v5}, Landroid/app/job/JobInfo$Builder;->setPriority(I)Landroid/app/job/JobInfo$Builder;
...
.method static sendOnUnsyncableAccount(Landroid/content/Context;Landroid/content/pm/RegisteredServicesCache$ServiceInfo;ILcom/android/server/content/SyncManager$OnReadyCallback;)V
    ...
    new-instance p2, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda4;

    invoke-direct {p2, p0, v0}, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda4;-><init>(Landroid/content/Context;Lcom/android/server/content/SyncManager$OnUnsyncableAccountCheck;)V
...
.method public computeSyncable(Landroid/accounts/Account;ILjava/lang/String;Z)I
    ...
    const-string p3, "Not scheduling job "
...
.method protected dumpSyncState(Ljava/io/PrintWriter;Lcom/android/server/content/SyncAdapterStateFetcher;)V
    ...
    :cond_5
    const-string/jumbo v6, "not known yet"
    ...
    invoke-virtual {v1, v12, v15}, Ljava/io/PrintWriter;->printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    ...
    invoke-direct {v12, v13}, Lcom/android/server/content/SyncManager$PrintTable;-><init>(I)V
    ...
    invoke-virtual {v12, v5, v5, v13}, Lcom/android/server/content/SyncManager$PrintTable;->set(II[Ljava/lang/Object;)V
    ...
    iget-object v13, v13, Landroid/content/pm/RegisteredServicesCache$ServiceInfo;->type:Ljava/lang/Object;

    check-cast v13, Landroid/content/SyncAdapterType;

    iget-object v13, v13, Landroid/content/SyncAdapterType;->authority:Ljava/lang/String;

    move-object/from16 v19, v4

    iget v4, v11, Landroid/accounts/AccountAndUser;->userId:I

    invoke-direct {v14, v3, v13, v4}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V

    invoke-virtual {v15, v14}, Lcom/android/server/content/SyncStorageEngine;->getCopyOfAuthorityWithSyncStatus(Lcom/android/server/content/SyncStorageEngine$EndPoint;)Landroid/util/Pair;
    ...
    new-instance v13, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda2;

    invoke-direct {v13, v2, v12}, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda2;-><init>(Ljava/lang/StringBuilder;Lcom/android/server/content/SyncManager$PrintTable;)V
    ...
    sget-object v2, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda11;->INSTANCE:Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda11;
    ...
    new-instance v14, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda10;

    invoke-direct {v14, v0}, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/content/SyncManager;)V
    ...
    invoke-direct {v11, v0}, Lcom/android/server/content/SyncManager$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/content/SyncManager;)V
    ...
    iget v4, v3, Landroid/content/SyncStatusInfo;->lastSuccessSource:I
    ...
    invoke-virtual {v12, v15, v2, v10}, Lcom/android/server/content/SyncManager$PrintTable;->set(II[Ljava/lang/Object;)V
    ...
    iget-wide v14, v3, Landroid/content/SyncStatusInfo;->lastFailureTime:J
    ...
    invoke-virtual {v12, v2, v4, v13}, Lcom/android/server/content/SyncManager$PrintTable;->set(II[Ljava/lang/Object;)V
...
.method public getPeriodicSyncs(Lcom/android/server/content/SyncStorageEngine$EndPoint;)Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/android/server/content/SyncOperation;->getClonedExtras()Landroid/os/Bundle;
...
.method public getSyncAdapterTypes(II)[Landroid/content/SyncAdapterType;
    ...
    new-array p1, p1, [Landroid/content/SyncAdapterType;
