...
.method private checkCredential()Z
    ...
    const-string v2, "Request throttled"
...
.method private getOldCredential()Lcom/android/internal/widget/LockscreenCredential;
    ...
    invoke-static {v1, v0}, Lcom/android/internal/widget/LockPatternUtils;->byteArrayToPattern([BB)Ljava/util/List;

    move-result-object v1

    invoke-static {v1, v0}, Lcom/android/internal/widget/LockscreenCredential;->createPattern(Ljava/util/List;B)Lcom/android/internal/widget/LockscreenCredential;
...
.method private isNewCredentialSufficient(Lcom/android/internal/widget/LockscreenCredential;)Z
    ...
    const-string v2, "New credential doesn\'t satisfy admin policies: "
...
.method private runSetResumeOnRebootProviderPackage()Z
    ...
    invoke-virtual {v1, v6, v4, v5, v3}, Landroid/content/Context;->enforcePermission(Ljava/lang/String;IILjava/lang/String;)V
