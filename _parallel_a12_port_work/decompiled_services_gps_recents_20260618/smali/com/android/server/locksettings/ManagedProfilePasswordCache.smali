...
.method public retrievePassword(I)Lcom/android/internal/widget/LockscreenCredential;
    ...
    invoke-virtual {v3, v5, p1, v6}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    :try_start_4
    invoke-static {p1}, Lcom/android/internal/widget/LockscreenCredential;->createManagedPassword([B)Lcom/android/internal/widget/LockscreenCredential;
    ...
    const-string v1, "ManagedProfilePasswordCache"

    const-string v3, "Cannot decrypt"

    invoke-static {v1, v3, p1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v1, "Device not unlocked for more than 7 days"
    ...
    const-string v3, "Cannot get key"
...
.method public storePassword(ILcom/android/internal/widget/LockscreenCredential;)V
    ...
    iget-object p2, p0, Lcom/android/server/locksettings/ManagedProfilePasswordCache;->mEncryptedPasswords:Landroid/util/SparseArray;
    ...
    :try_start_3
    const-string p2, "ManagedProfilePasswordCache"

    const-string v1, "Cannot encrypt"
