...
.method private clearRebootEscrowIfNeeded()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/locksettings/RebootEscrowManager$RebootEscrowEventLog;->addEntry(I)V
...
.method private generateEscrowKeyIfNeeded()Lcom/android/server/locksettings/RebootEscrowKey;
    ...
    const-string v2, "Could not generate reboot escrow key"
...
.method private onEscrowRestoreComplete(ZI)V
    ...
    iget-object p1, p0, Lcom/android/server/locksettings/RebootEscrowManager;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method private onGetRebootEscrowKeyFailed(Ljava/util/List;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/locksettings/RebootEscrowManager;->onEscrowRestoreComplete(ZI)V
...
.method private restoreRebootEscrowForUser(ILcom/android/server/locksettings/RebootEscrowKey;Ljavax/crypto/SecretKey;)Z
    ...
    const-string v1, "Could not load reboot escrow data for user "
...
.method armRebootEscrowIfNeeded()I
    ...
    const-string v3, "Expect reboot escrow provider "
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/locksettings/RebootEscrowManager;->mPendingRebootEscrowKey:Lcom/android/server/locksettings/RebootEscrowKey;
    ...
    :cond_5
    invoke-interface {v0, v6, v2}, Lcom/android/server/locksettings/RebootEscrowProviderInterface;->storeRebootEscrowKey(Lcom/android/server/locksettings/RebootEscrowKey;Ljavax/crypto/SecretKey;)Z
    ...
    iget-object v6, p0, Lcom/android/server/locksettings/RebootEscrowManager;->mInjector:Lcom/android/server/locksettings/RebootEscrowManager$Injector;

    invoke-virtual {v6}, Lcom/android/server/locksettings/RebootEscrowManager$Injector;->getBootCount()I

    move-result v6

    invoke-virtual {v0, v2, v6, v4}, Lcom/android/server/locksettings/LockSettingsStorage;->setInt(Ljava/lang/String;II)V
    ...
    invoke-virtual {v6}, Lcom/android/server/locksettings/RebootEscrowManager$Injector;->getCurrentTimeMillis()J

    move-result-wide v6

    invoke-virtual {v0, v2, v6, v7, v4}, Lcom/android/server/locksettings/LockSettingsStorage;->setLong(Ljava/lang/String;JI)V
    ...
    invoke-virtual {v6, v4}, Lcom/android/server/locksettings/RebootEscrowManager$Injector;->getVbmetaDigest(Z)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v0, v2, v6, v4}, Lcom/android/server/locksettings/LockSettingsStorage;->setString(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/server/locksettings/RebootEscrowManager$Injector;->getVbmetaDigest(Z)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v2, v3, v4}, Lcom/android/server/locksettings/LockSettingsStorage;->setString(Ljava/lang/String;Ljava/lang/String;I)V

    iget-object v0, p0, Lcom/android/server/locksettings/RebootEscrowManager;->mStorage:Lcom/android/server/locksettings/LockSettingsStorage;

    const-string/jumbo v2, "reboot_escrow_key_provider"

    invoke-virtual {v0, v2, v5, v4}, Lcom/android/server/locksettings/LockSettingsStorage;->setInt(Ljava/lang/String;II)V
...
.method callToRebootEscrowIfNeeded(IB[B)V
    ...
    const-string p1, "Not storing escrow data, RebootEscrowProvider is unavailable"
    ...
    const-string p1, "Could not generate escrow key"
    ...
    const-string p1, "Failed to generate encryption key from keystore."
    ...
    invoke-direct {p0, p1}, Lcom/android/server/locksettings/RebootEscrowManager;->setRebootEscrowReady(Z)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/locksettings/RebootEscrowManager;->setRebootEscrowReady(Z)V

    const-string p2, "Could not escrow reboot data"
...
.method loadRebootEscrowDataWithRetry(Landroid/os/Handler;ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0, v3, v1, p4}, Lcom/android/server/locksettings/LockSettingsStorage;->getInt(Ljava/lang/String;II)I
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/android/server/locksettings/RebootEscrowManager;->restoreRebootEscrowForUser(ILcom/android/server/locksettings/RebootEscrowKey;Ljavax/crypto/SecretKey;)Z
    ...
    invoke-direct {p0, p4, p2}, Lcom/android/server/locksettings/RebootEscrowManager;->onEscrowRestoreComplete(ZI)V
...
.method scheduleLoadRebootEscrowDataOrFail(Landroid/os/Handler;ILjava/util/List;Ljava/util/List;)V
    ...
    new-instance v8, Lcom/android/server/locksettings/RebootEscrowManager$$ExternalSyntheticLambda0;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/locksettings/RebootEscrowManager$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/locksettings/RebootEscrowManager;Landroid/os/Handler;ILjava/util/List;Ljava/util/List;)V
