...
.method constructor <init>(Lcom/android/server/connectivity/Vpn;Lcom/android/internal/net/VpnConfig;[Ljava/lang/String;[Ljava/lang/String;Lcom/android/internal/net/VpnProfile;)V
    ...
    iget-object v1, p0, Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;->mOuterInterface:Ljava/lang/String;
...
.method private bringup()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/connectivity/Vpn$Dependencies;->isInterfacePresent(Lcom/android/server/connectivity/Vpn;Ljava/lang/String;)Z
...
.method private checkAndFixupArguments(Ljava/net/InetAddress;)V
    ...
    const-string v0, "Invalid server argument for racoon"
    ...
    const-string v0, "Invalid server argument for mtpd"
    ...
    const-string v0, "Unexpected daemons order"
