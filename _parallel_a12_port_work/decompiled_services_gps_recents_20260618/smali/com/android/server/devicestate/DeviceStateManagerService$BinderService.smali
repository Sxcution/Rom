...
.method public cancelRequest(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/devicestate/DeviceStateManagerService;->getContext()Landroid/content/Context;

    move-result-object v1

    const-string v2, "android.permission.CONTROL_DEVICE_STATE"

    const-string v3, "Permission required to cancel device state, or the call must come from the top focused app."
    ...
    invoke-static {v3, v0, p1}, Lcom/android/server/devicestate/DeviceStateManagerService;->access$900(Lcom/android/server/devicestate/DeviceStateManagerService;ILandroid/os/IBinder;)V
    :try_end_0
    ...
    const-string v0, "Request token must not be null."
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/devicestate/DeviceStateManagerService;->access$1000(Lcom/android/server/devicestate/DeviceStateManagerService;Ljava/io/PrintWriter;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerCallback(Landroid/hardware/devicestate/IDeviceStateManagerCallback;)V
    ...
    const-string v0, "Device state callback must not be null."
...
.method public requestState(Landroid/os/IBinder;II)V
    ...
    const-string v3, "Permission required to request device state, or the call must come from the top focused app."
    ...
    invoke-static {v3, p2, p3, v0, p1}, Lcom/android/server/devicestate/DeviceStateManagerService;->access$800(Lcom/android/server/devicestate/DeviceStateManagerService;IIILandroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
