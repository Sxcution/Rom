...
.method private dumpInternal(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v1, "mEmergencyAffordanceNeeded="
    ...
    const-string v1, "mEmergencyCallCountryIsos="
...
.method private handleNetworkCountryChanged(Ljava/lang/String;I)V
    ...
    const-string p2, "Ignore empty countryIso report when APM is on."
...
.method private handleUpdateSimSubscriptionInfo()V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/emergency/EmergencyAffordanceService;->isoRequiresEmergencyAffordance(Ljava/lang/String;)Z
