...
.method public remoteViewStats(JZ)Lcom/android/server/notification/PulledStats;
    ...
    check-cast p2, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;

    iget v0, p2, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->numUndecoratedRemoteViews:I

    if-lez v0, :cond_0

    iget-object v0, p2, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->key:Ljava/lang/String;

    invoke-static {p2}, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->access$000(Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;)J

    move-result-wide v1

    invoke-virtual {p3, v0, v1, v2}, Lcom/android/server/notification/PulledStats;->addUndecoratedPackage(Ljava/lang/String;J)V
