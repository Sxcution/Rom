...
.method private getTrustAgentInfo(Landroid/util/TypedXmlPullParser;Ljava/lang/String;)Lcom/android/server/devicepolicy/ActiveAdmin$TrustAgentInfo;
    ...
    iput-object v2, v1, Lcom/android/server/devicepolicy/ActiveAdmin$TrustAgentInfo;->options:Landroid/os/PersistableBundle;
...
.method private readAttributeValues(Landroid/util/TypedXmlPullParser;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    const-string v2, "Expected tag %s but found %s"
...
.method private readPackageList(Landroid/util/TypedXmlPullParser;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {p1, v4, v7}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v2, v3}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method dump(Landroid/util/IndentingPrintWriter;)V
    ...
    const-string v0, "mEnrollmentSpecificId="
...
.method readFromXml(Landroid/util/TypedXmlPullParser;Z)V
    ...
    invoke-direct {p0, p1, v2, v1}, Lcom/android/server/devicepolicy/ActiveAdmin;->readAttributeValues(Landroid/util/TypedXmlPullParser;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/devicepolicy/ActiveAdmin;->getAllTrustAgentInfos(Landroid/util/TypedXmlPullParser;Ljava/lang/String;)Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/devicepolicy/ActiveAdmin;->readPackageList(Landroid/util/TypedXmlPullParser;Ljava/lang/String;)Ljava/util/List;
...
.method writeToXml(Landroid/util/TypedXmlSerializer;)V
    ...
    const-string/jumbo v3, "profile-max-time-off"

    invoke-virtual {p0, p1, v3, v0, v1}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Landroid/util/TypedXmlSerializer;Ljava/lang/String;J)V
    ...
    const-string/jumbo v3, "profile-off-deadline"
    ...
    invoke-virtual {p0, p1, v1, v0}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Landroid/util/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "password-complexity"
    ...
    const-string/jumbo v1, "nearby-notification-streaming-policy"
    ...
    const-string/jumbo v1, "nearby-app-streaming-policy"
    ...
    const-string/jumbo v1, "organization-id"

    invoke-virtual {p0, p1, v1, v0}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeTextToXml(Landroid/util/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "enrollment-specific-id"
    ...
    const-string/jumbo v1, "preferential-network-service-enabled"
