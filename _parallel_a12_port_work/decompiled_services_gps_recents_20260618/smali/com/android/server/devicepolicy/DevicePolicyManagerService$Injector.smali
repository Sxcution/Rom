...
.method public getPersonalAppsForSuspension(I)[Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/server/devicepolicy/PersonalAppsSuspensionHelper;->getPersonalAppsForSuspension()[Ljava/lang/String;
...
.method hasUserSetupCompleted(Lcom/android/server/devicepolicy/DevicePolicyData;)Z
    ...
    iget-boolean p1, p1, Lcom/android/server/devicepolicy/DevicePolicyData;->mUserSetupComplete:Z
...
.method public isChangeEnabled(JLjava/lang/String;I)Z
    ...
    invoke-static {p1, p2, p3, p4}, Landroid/app/compat/CompatChanges;->isChangeEnabled(JLjava/lang/String;Landroid/os/UserHandle;)Z
...
.method recoverySystemRebootWipeUserData(ZLjava/lang/String;ZZZZ)Z
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->setShutdown(Z)Lcom/android/server/devicepolicy/FactoryResetter$Builder;

    move-result-object p1

    invoke-virtual {p1, p3}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->setForce(Z)Lcom/android/server/devicepolicy/FactoryResetter$Builder;

    move-result-object p1

    invoke-virtual {p1, p4}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->setWipeEuicc(Z)Lcom/android/server/devicepolicy/FactoryResetter$Builder;

    move-result-object p1

    invoke-virtual {p1, p5}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->setWipeAdoptableStorage(Z)Lcom/android/server/devicepolicy/FactoryResetter$Builder;

    move-result-object p1

    invoke-virtual {p1, p6}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->setWipeFactoryResetProtection(Z)Lcom/android/server/devicepolicy/FactoryResetter$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/devicepolicy/FactoryResetter$Builder;->build()Lcom/android/server/devicepolicy/FactoryResetter;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/devicepolicy/FactoryResetter;->factoryReset()Z
