...
.method public constructor <init>(Lcom/android/internal/util/FileRotator;Landroid/net/NetworkStats$NonMonotonicObserver;Landroid/os/DropBoxManager;Ljava/lang/String;JZ)V
    ...
    const-string/jumbo p1, "missing NonMonotonicObserver"

    invoke-static {p2, p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p2, Landroid/net/NetworkStats$NonMonotonicObserver;

    iput-object p2, p0, Lcom/android/server/net/NetworkStatsRecorder;->mObserver:Landroid/net/NetworkStats$NonMonotonicObserver;

    const-string/jumbo p1, "missing DropBoxManager"

    invoke-static {p3, p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p3, Landroid/os/DropBoxManager;
    ...
    new-instance p2, Lcom/android/server/net/NetworkStatsCollection;

    invoke-direct {p2, p5, p6}, Lcom/android/server/net/NetworkStatsCollection;-><init>(J)V

    iput-object p2, p0, Lcom/android/server/net/NetworkStatsRecorder;->mSinceBoot:Lcom/android/server/net/NetworkStatsCollection;

    new-instance p2, Lcom/android/server/net/NetworkStatsRecorder$CombiningRewriter;

    invoke-direct {p2, p1}, Lcom/android/server/net/NetworkStatsRecorder$CombiningRewriter;-><init>(Lcom/android/server/net/NetworkStatsCollection;)V

    iput-object p2, p0, Lcom/android/server/net/NetworkStatsRecorder;->mPendingRewriter:Lcom/android/server/net/NetworkStatsRecorder$CombiningRewriter;
...
.method public dumpDebugLocked(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/android/server/net/NetworkStatsCollection;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
...
.method public recordSnapshotLocked(Landroid/net/NetworkStats;Ljava/util/Map;J)V
    ...
    invoke-virtual {v15, v14, v4}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;

    move-result-object v4

    invoke-virtual {v4}, Landroid/net/NetworkStats$Entry;->isNegative()Z
    ...
    iput-wide v5, v4, Landroid/net/NetworkStats$Entry;->rxBytes:J
    ...
    iput-wide v5, v4, Landroid/net/NetworkStats$Entry;->rxPackets:J
    ...
    iput-wide v5, v4, Landroid/net/NetworkStats$Entry;->txBytes:J
    ...
    iput-wide v5, v4, Landroid/net/NetworkStats$Entry;->txPackets:J

    iget-wide v5, v4, Landroid/net/NetworkStats$Entry;->operations:J

    invoke-static {v5, v6, v7, v8}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v5

    iput-wide v5, v4, Landroid/net/NetworkStats$Entry;->operations:J

    :cond_4
    iget-object v5, v4, Landroid/net/NetworkStats$Entry;->iface:Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v4}, Landroid/net/NetworkStats$Entry;->isEmpty()Z
    ...
    iget v7, v4, Landroid/net/NetworkStats$Entry;->uid:I

    iget v8, v4, Landroid/net/NetworkStats$Entry;->set:I

    iget v9, v4, Landroid/net/NetworkStats$Entry;->tag:I
