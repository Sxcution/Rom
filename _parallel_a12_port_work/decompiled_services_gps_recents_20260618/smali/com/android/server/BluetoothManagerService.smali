...
.method constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v7, "set feature flag HEARING_AID_SETTINGS to "
    ...
    const-string/jumbo v4, "settings_bluetooth_hearing_aid"

    invoke-static {p1, v4, v3}, Landroid/util/FeatureFlagUtils;->setEnabled(Landroid/content/Context;Ljava/lang/String;Z)V

    if-eqz v3, :cond_0

    iget-boolean v3, p0, Lcom/android/server/BluetoothManagerService;->mIsHearingAidProfileSupported:Z
    ...
    invoke-virtual {p1, v1, v2, v0}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    const-string v0, "Detected SystemUiUid: "
    ...
    :cond_5
    const-string p1, "Unable to resolve SystemUI\'s UID."

    invoke-static {v6, p1}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    :goto_0
    iput v1, p0, Lcom/android/server/BluetoothManagerService;->mSystemUiUid:I
...
.method static synthetic access$700(Lcom/android/server/BluetoothManagerService;)Lcom/android/server/BluetoothModeChangeHelper;
    ...
    iget-object p0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothModeChangeHelper:Lcom/android/server/BluetoothModeChangeHelper;
...
.method static synthetic access$800(Lcom/android/server/BluetoothManagerService;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/BluetoothManagerService;->mShutdownInProgress:Z
...
.method private addActiveLog(ILjava/lang/String;Z)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/internal/util/FrameworkStatsLog;->write_non_chained(IILjava/lang/String;IILjava/lang/String;)V
...
.method private bluetoothStateChangeHandler(II)V
    ...
    invoke-virtual {p0, v0, v3, v6, v7}, Lcom/android/server/BluetoothManagerService;->doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/BluetoothManagerService;->sendBrEdrDownCallback(Landroid/content/AttributionSource;)V
    ...
    const-string v1, "Sending State Change: "
    ...
    invoke-virtual {p1, v0, p2, v1, v2}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private checkBluetoothPermissions(Landroid/content/AttributionSource;Ljava/lang/String;Z)Z
    ...
    const-string p1, "checkBluetoothPermissions: bluetooth disallowed"
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/server/BluetoothManagerService;->checkPackage(ILjava/lang/String;)V
    ...
    const-string p1, "Not allowed for non-active and non system user"
    ...
    :cond_2
    iget-object p3, p0, Lcom/android/server/BluetoothManagerService;->mContext:Landroid/content/Context;

    invoke-static {p3, p1, p2}, Lcom/android/server/BluetoothManagerService;->checkConnectPermissionForDataDelivery(Landroid/content/Context;Landroid/content/AttributionSource;Ljava/lang/String;)Z
...
.method private static checkPermissionForDataDelivery(Landroid/content/Context;Ljava/lang/String;Landroid/content/AttributionSource;Ljava/lang/String;)Z
    ...
    const-string p1, " permission for "
    ...
    const-string p0, "BluetoothManagerService"
...
.method private continueFromBleOnState()V
    ...
    invoke-interface {v1, v2, v3}, Landroid/bluetooth/IBluetooth;->updateQuietModeStatus(ZLandroid/content/AttributionSource;)V
...
.method private dumpProto(Ljava/io/FileDescriptor;)V
    ...
    iget p1, p0, Lcom/android/server/BluetoothManagerService;->mState:I

    const-wide v1, 0x10500000002L

    invoke-virtual {v0, v1, v2, p1}, Landroid/util/proto/ProtoOutputStream;->write(JI)V
    ...
    invoke-virtual {v0, v1, v2, p1}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    iget-object p1, p0, Lcom/android/server/BluetoothManagerService;->mAddress:Ljava/lang/String;

    const-wide v1, 0x10900000004L

    invoke-virtual {v0, v1, v2, p1}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    iget-object p1, p0, Lcom/android/server/BluetoothManagerService;->mName:Ljava/lang/String;

    const-wide v1, 0x10900000005L

    invoke-virtual {v0, v1, v2, p1}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    iget-boolean p1, p0, Lcom/android/server/BluetoothManagerService;->mEnable:Z
    ...
    iget-object p1, p0, Lcom/android/server/BluetoothManagerService;->mActiveLogs:Ljava/util/LinkedList;
    ...
    check-cast v1, Lcom/android/server/BluetoothManagerService$ActiveLog;
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/BluetoothManagerService$ActiveLog;->dump(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget p1, p0, Lcom/android/server/BluetoothManagerService;->mCrashes:I
    ...
    iget-object p1, p0, Lcom/android/server/BluetoothManagerService;->mCrashTimestamps:Ljava/util/LinkedList;
    ...
    const-wide v2, 0x2030000000bL

    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v4

    invoke-virtual {v0, v2, v3, v4, v5}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V
    ...
    const-wide v2, 0x2090000000dL

    invoke-virtual {v1}, Lcom/android/server/BluetoothManagerService$ClientDeathRecipient;->getPackageName()Ljava/lang/String;
...
.method private static getEnableDisableReasonString(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string p0, "INIT_FLAGS_CHANGED"
...
.method private handleEnable(Z)V
    ...
    const-string p1, "binding Bluetooth service"
    ...
    invoke-interface {p1, v1, v2}, Landroid/bluetooth/IBluetooth;->enable(ZLandroid/content/AttributionSource;)Z
...
.method private sendBleStateChanged(II)V
    ...
    invoke-virtual {p1, v0, p2, v2, v1}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private sendBrEdrDownCallback(Landroid/content/AttributionSource;)V
    ...
    const-string p1, "Bluetooth handle is null"
    ...
    const-string v1, "Unable to disconnect all apps."
    ...
    :try_start_2
    const-string v1, "Call to onBrEdrDown() failed."
...
.method private storeNameAndAddress(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v0, p0, Lcom/android/server/BluetoothManagerService;->mUserId:I
...
.method private unbindAllBluetoothProfileServices()V
    ...
    :goto_1
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2300(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)V
...
.method public bindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)Z
    ...
    invoke-static {v4}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2000(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)Z
...
.method public disable(Landroid/content/AttributionSource;Z)Z
    ...
    const-string p2, "disable(): not disabling - bluetooth disallowed"
    ...
    iget-boolean v3, p0, Lcom/android/server/BluetoothManagerService;->mWirelessConsentRequired:Z

    if-eqz v3, :cond_2

    const-string v3, "android.bluetooth.adapter.action.REQUEST_DISABLE"

    invoke-direct {p0, v0, p1, v3}, Lcom/android/server/BluetoothManagerService;->startConsentUiIfNeeded(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/BluetoothManagerService;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public disableBle(Landroid/content/AttributionSource;Landroid/os/IBinder;)Z
    ...
    const-string p1, "disableBLE(): bluetooth disallowed"
    ...
    const-string p1, "disableBLE(): Already disabled"
    ...
    iget p2, p0, Lcom/android/server/BluetoothManagerService;->mState:I
    ...
    invoke-direct {p0, v3, v0, v2}, Lcom/android/server/BluetoothManagerService;->addActiveLog(ILjava/lang/String;Z)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v6, v0, Lcom/android/server/BluetoothManagerService;->mState:I
    ...
    iget-object v6, v0, Lcom/android/server/BluetoothManagerService;->mAddress:Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/android/server/BluetoothManagerService;->mName:Ljava/lang/String;
    ...
    iget-boolean v5, v0, Lcom/android/server/BluetoothManagerService;->mEnable:Z
    ...
    const-string v7, "  time since enabled: "
    ...
    :cond_2
    iget-object v4, v0, Lcom/android/server/BluetoothManagerService;->mActiveLogs:Ljava/util/LinkedList;
    ...
    iget v4, v0, Lcom/android/server/BluetoothManagerService;->mCrashes:I

    const/16 v7, 0x64

    if-ne v4, v7, :cond_6

    const-string v4, "(last 100)"

    invoke-virtual {v1, v4}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    :cond_6
    iget-object v4, v0, Lcom/android/server/BluetoothManagerService;->mCrashTimestamps:Ljava/util/LinkedList;
    ...
    invoke-static {v11, v12}, Lcom/android/server/BluetoothManagerService;->timeToLog(J)Ljava/lang/CharSequence;
    ...
    iget-object v4, v0, Lcom/android/server/BluetoothManagerService;->mBleApps:Ljava/util/Map;
    ...
    const-string v5, "  mQuietEnable:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, v0, Lcom/android/server/BluetoothManagerService;->mQuietEnable:Z
    ...
    const-string v5, "  mEnableExternal:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, v0, Lcom/android/server/BluetoothManagerService;->mEnableExternal:Z
    ...
    const-string v5, "  mQuietEnableExternal:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, v0, Lcom/android/server/BluetoothManagerService;->mQuietEnableExternal:Z
    ...
    :try_start_0
    invoke-interface {v0, v4, v2}, Landroid/os/IBinder;->dump(Ljava/io/FileDescriptor;[Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enable(Landroid/content/AttributionSource;)Z
    ...
    invoke-direct {p0, v1, v2, v0}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(ZILjava/lang/String;)V
...
.method public enableBle(Landroid/content/AttributionSource;Landroid/os/IBinder;)Z
    ...
    const-string p2, "enableBle(): bluetooth disallowed"
    ...
    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/BluetoothManagerService;->updateBleAppCount(Landroid/os/IBinder;ZLjava/lang/String;)I
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/BluetoothManagerService;->mReceiver:Landroid/content/BroadcastReceiver;

    monitor-enter p2

    :try_start_0
    invoke-direct {p0, v2, p1, v0, p1}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(ZILjava/lang/String;Z)V
    ...
    const-string v0, "enableBLE(): Bluetooth is already enabled or is turning on"
...
.method public enableNoAutoConnect(Landroid/content/AttributionSource;)Z
    ...
    invoke-direct {p0, v1, v1, v0}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(ZILjava/lang/String;)V
...
.method public getAddress(Landroid/content/AttributionSource;)Ljava/lang/String;
    ...
    const-string p1, "getAddress(): not allowed for non-active and non system user"
    ...
    :try_start_1
    const-string v0, "getAddress(): Unable to retrieve address remotely. Returning cached address"
...
.method public getName(Landroid/content/AttributionSource;)Ljava/lang/String;
    ...
    const-string p1, "getName(): not allowed for non-active and non system user"
    ...
    :try_start_1
    const-string v0, "getName(): Unable to retrieve name remotely. Returning cached name"
...
.method public getSystemConfigEnabledProfilesForPackage(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v0, "getSystemConfigEnabledProfilesForPackage(): not allowed for non-bluetooth"
...
.method public handleOnBootPhase()V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/BluetoothModeChangeHelper;-><init>(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothAirplaneModeListener:Lcom/android/server/BluetoothAirplaneModeListener;

    if-eqz v1, :cond_3

    invoke-virtual {v1, v0}, Lcom/android/server/BluetoothAirplaneModeListener;->start(Lcom/android/server/BluetoothModeChangeHelper;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/BluetoothDeviceConfigListener;-><init>(Lcom/android/server/BluetoothManagerService;Z)V
...
.method public onFactoryReset(Landroid/content/AttributionSource;)Z
    ...
    invoke-static {v0, v4}, Ljava/util/Set;->of(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-direct {p0, v5, v0, v3}, Lcom/android/server/BluetoothManagerService;->addActiveLog(ILjava/lang/String;Z)V

    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetooth:Landroid/bluetooth/IBluetooth;

    invoke-interface {v0, p1}, Landroid/bluetooth/IBluetooth;->onBrEdrDown(Landroid/content/AttributionSource;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-interface {v0, p1}, Landroid/bluetooth/IBluetooth;->disable(Landroid/content/AttributionSource;)Z
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v1, "Unable to shutdown Bluetooth"
...
.method public unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    :cond_0
    invoke-static {p1, p2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2100(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;Landroid/bluetooth/IBluetoothProfileServiceConnection;)V

    invoke-static {p1}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2200(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)Z
