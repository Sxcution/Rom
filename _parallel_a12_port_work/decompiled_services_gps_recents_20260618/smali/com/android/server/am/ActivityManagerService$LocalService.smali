...
.method public disconnectActivityFromServices(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/am/ActivityManagerService$LocalService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/am/ActivityManagerService$LocalService;Lcom/android/server/wm/ActivityServiceConnectionsHolder;)V
...
.method public getActivityPresentationInfo(Landroid/os/IBinder;)Landroid/content/pm/ActivityPresentationInfo;
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/wm/ActivityTaskManagerInternal;->getActivityName(Landroid/os/IBinder;)Landroid/content/ComponentName;
...
.method public getStorageMountMode(II)I
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/android/server/am/ProcessRecord;->getMountMode()I
...
.method public getUidCapability(I)I
    ...
    const-string/jumbo v3, "uid record for "
...
.method public hasRunningActivity(ILjava/lang/String;)Z
    ...
    invoke-virtual {v2, p1, v3}, Lcom/android/server/am/ProcessList;->searchEachLruProcessesLOSP(ZLjava/util/function/Function;)Ljava/lang/Object;
...
.method public hasRunningForegroundService(II)Z
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/am/ProcessList;->searchEachLruProcessesLOSP(ZLjava/util/function/Function;)Ljava/lang/Object;
...
.method public isUidCurrentlyInstrumented(I)Z
    ...
    iget-object v3, v3, Lcom/android/server/am/ActiveInstrumentation;->mTargetInfo:Landroid/content/pm/ApplicationInfo;
...
.method public synthetic lambda$disconnectActivityFromServices$1$ActivityManagerService$LocalService(Lcom/android/server/wm/ActivityServiceConnectionsHolder;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p2, v1, p1, v2}, Lcom/android/server/am/ActiveServices;->removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/wm/ActivityServiceConnectionsHolder;Z)V
...
.method public noteAlarmFinish(Landroid/app/PendingIntent;Landroid/os/WorkSource;ILjava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/am/ActivityManagerService;->noteAlarmFinish(Landroid/content/IIntentSender;Landroid/os/WorkSource;ILjava/lang/String;)V
...
.method public noteAlarmStart(Landroid/app/PendingIntent;Landroid/os/WorkSource;ILjava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/am/ActivityManagerService;->noteAlarmStart(Landroid/content/IIntentSender;Landroid/os/WorkSource;ILjava/lang/String;)V
...
.method public setDeviceIdleAllowlist([I[I)V
    ...
    iput-object p2, p1, Lcom/android/server/am/ActivityManagerService;->mDeviceIdleExceptIdleAllowlist:[I
...
.method public setHasOverlayUi(IZ)V
    ...
    const-string/jumbo p2, "updateOomAdj_uiVisibility"

    invoke-virtual {p1, v2, p2}, Lcom/android/server/am/ActivityManagerService;->updateOomAdjLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
...
.method public setPendingIntentAllowBgActivityStarts(Landroid/content/IIntentSender;Landroid/os/IBinder;I)V
    ...
    const-string/jumbo v0, "setPendingIntentAllowBgActivityStarts(): not a PendingIntentRecord: "
