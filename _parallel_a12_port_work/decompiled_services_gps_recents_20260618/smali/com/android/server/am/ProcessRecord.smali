...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)V
    ...
    iput-object v1, v8, Lcom/android/server/am/ProcessRecord;->mProcLock:Lcom/android/server/am/ActivityManagerGlobalLock;
    ...
    invoke-virtual {v1, v4}, Landroid/content/pm/PackageManagerInternal;->getProcessesForUid(I)Landroid/util/ArrayMap;
    ...
    iget-object v5, v1, Landroid/content/pm/ProcessInfo;->deniedPermissions:Landroid/util/ArraySet;

    if-nez v5, :cond_0

    iget v5, v1, Landroid/content/pm/ProcessInfo;->gwpAsanMode:I

    const/4 v6, -0x1

    if-ne v5, v6, :cond_0

    iget v5, v1, Landroid/content/pm/ProcessInfo;->memtagMode:I

    if-ne v5, v6, :cond_0

    iget v5, v1, Landroid/content/pm/ProcessInfo;->nativeHeapZeroInitialized:I
    ...
    :cond_1
    :goto_0
    iput-object v2, v8, Lcom/android/server/am/ProcessRecord;->processInfo:Landroid/content/pm/ProcessInfo;
...
.method static synthetic lambda$resetPackageList$1(Lcom/android/internal/app/procstats/ProcessState;Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;)V
    ...
    invoke-virtual {p0}, Lcom/android/internal/app/procstats/ProcessState;->makeInactive()V
...
.method public addPackage(Ljava/lang/String;JLcom/android/server/am/ProcessStatsService;)Z
    ...
    iget-object p2, p0, Lcom/android/server/am/ProcessRecord;->mPkgList:Lcom/android/server/am/PackageList;

    invoke-virtual {p2, p1, v2}, Lcom/android/server/am/PackageList;->put(Ljava/lang/String;Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;)Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;

    iget-object p1, v2, Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;->state:Lcom/android/internal/app/procstats/ProcessState;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v5, p0, Lcom/android/server/am/ProcessRecord;->mGids:[I
    ...
    const-string/jumbo v5, "processInfo:"
    ...
    const-string/jumbo v5, "mRequiredAbi="
    ...
    iget-object v5, p0, Lcom/android/server/am/ProcessRecord;->mInstructionSet:Ljava/lang/String;
    ...
    const-string/jumbo v5, "manageSpaceActivityName="
    ...
    iget-object v5, p0, Lcom/android/server/am/ProcessRecord;->mPkgList:Lcom/android/server/am/PackageList;

    invoke-virtual {v5, p1, p2}, Lcom/android/server/am/PackageList;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method killLocked(Ljava/lang/String;IIZ)V
    ...
    iget-object p4, p0, Lcom/android/server/am/ProcessRecord;->info:Landroid/content/pm/ApplicationInfo;
    ...
    :cond_0
    iget-object p4, p0, Lcom/android/server/am/ProcessRecord;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {p4, v0, v3, v4}, Lcom/android/server/am/ActivityManagerService;->reportUidInfoMessageLocked(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object p4, p4, Lcom/android/server/am/ActivityManagerService;->mProcessList:Lcom/android/server/am/ProcessList;

    invoke-virtual {p4, p0, p2, p3, p1}, Lcom/android/server/am/ProcessList;->noteAppKill(Lcom/android/server/am/ProcessRecord;IILjava/lang/String;)V
...
.method public makeActive(Landroid/app/IApplicationThread;Lcom/android/server/am/ProcessStatsService;)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/WindowProcessController;->setThread(Landroid/app/IApplicationThread;)V
...
.method onCleanupApplicationRecordLSP(Lcom/android/server/am/ProcessStatsService;ZZ)Z
    ...
    iget-object p1, p0, Lcom/android/server/am/ProcessRecord;->mProviders:Lcom/android/server/am/ProcessProviderRecord;

    invoke-virtual {p1, p2}, Lcom/android/server/am/ProcessProviderRecord;->onCleanupApplicationRecordLocked(Z)Z
...
.method public onStartActivity(IZLjava/lang/String;J)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/am/ProcessStateRecord;->forceProcessStateUpTo(I)V
