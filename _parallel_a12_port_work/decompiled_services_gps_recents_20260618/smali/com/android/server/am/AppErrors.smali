...
.method private crashApplicationInner(Lcom/android/server/am/ProcessRecord;Landroid/app/ApplicationErrorReport$CrashInfo;II)V
    ...
    invoke-virtual {v1, v12, v2, v9, v3}, Lcom/android/server/am/ProcessList;->noteAppKill(Lcom/android/server/am/ProcessRecord;IILjava/lang/String;)V
    ...
    :goto_2
    new-instance v8, Lcom/android/server/am/AppErrorResult;

    invoke-direct {v8}, Lcom/android/server/am/AppErrorResult;-><init>()V
    ...
    iget v7, v0, Lcom/android/server/am/AppErrorDialog$Data;->taskId:I
    ...
    invoke-virtual {v0, v7, v1}, Lcom/android/server/am/ActivityManagerService;->startActivityFromRecents(ILandroid/os/Bundle;)I
    :try_end_7
    ...
    invoke-virtual {v11, v12, v13, v14, v0}, Lcom/android/server/am/AppErrors;->createAppErrorIntentLOSP(Lcom/android/server/am/ProcessRecord;JLandroid/app/ApplicationErrorReport$CrashInfo;)Landroid/content/Intent;
    ...
    :try_end_10
    .catch Landroid/content/ActivityNotFoundException; {:try_start_10 .. :try_end_10} :catch_1
...
.method private createAppErrorReportLOSP(Lcom/android/server/am/ProcessRecord;JLandroid/app/ApplicationErrorReport$CrashInfo;)Landroid/app/ApplicationErrorReport;
    ...
    iput p1, v1, Landroid/app/ApplicationErrorReport;->type:I
    ...
    iput-object p1, v1, Landroid/app/ApplicationErrorReport;->anrInfo:Landroid/app/ApplicationErrorReport$AnrInfo;

    iget-object p1, v1, Landroid/app/ApplicationErrorReport;->anrInfo:Landroid/app/ApplicationErrorReport$AnrInfo;
    ...
    iput-object p2, p1, Landroid/app/ApplicationErrorReport$AnrInfo;->info:Ljava/lang/String;
...
.method private isProcOverCrashLimitLBp(Lcom/android/server/am/ProcessRecord;J)Z
    ...
    sget p2, Lcom/android/server/am/ActivityManagerConstants;->PROCESS_CRASH_COUNT_LIMIT:I
...
.method private killAppImmediateLSP(Lcom/android/server/am/ProcessRecord;IILjava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct/range {v1 .. v7}, Lcom/android/server/am/AppErrors;->handleAppCrashLSPB(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
    ...
    invoke-virtual {p1, p5, p2, p3, p4}, Lcom/android/server/am/ProcessRecord;->killLocked(Ljava/lang/String;IIZ)V
...
.method private makeAppCrashingLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/server/am/AppErrors;->handleAppCrashLSPB(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
...
.method private updateProcessCrashCountLBp(Ljava/lang/String;IJ)V
    ...
    :goto_1
    iget-object p4, p0, Lcom/android/server/am/AppErrors;->mProcessCrashCounts:Lcom/android/internal/app/ProcessMap;

    invoke-virtual {p4, p1, p2, p3}, Lcom/android/internal/app/ProcessMap;->put(Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/Object;
...
.method handleShowAnrUi(Landroid/os/Message;)V
    ...
    const-string v0, "handleShowAnrUi: proc is null"
    ...
    invoke-static {p1, v6, v0}, Lcom/android/internal/logging/MetricsLogger;->action(Landroid/content/Context;II)V
    ...
    invoke-virtual {p1, v3, v0}, Lcom/android/server/PackageWatchdog;->onPackageFailure(Ljava/util/List;I)V
...
.method handleShowAppErrorUi(Landroid/os/Message;)V
    ...
    iget-object v9, v0, Lcom/android/server/am/AppErrors;->mProcessCrashShowDialogTimes:Lcom/android/internal/app/ProcessMap;
    ...
    invoke-virtual {v9, v11, v12}, Lcom/android/internal/app/ProcessMap;->get(Ljava/lang/String;I)Ljava/lang/Object;
    ...
    :goto_5
    iget-object v13, v0, Lcom/android/server/am/AppErrors;->mAppsNotReportingCrashes:Landroid/util/ArraySet;
    ...
    sget v9, Lcom/android/server/am/ActivityManagerConstants;->MIN_CRASH_INTERVAL:I
    :try_end_4
...
.method scheduleAppCrashLocked(IILjava/lang/String;ILjava/lang/String;ZILandroid/os/Bundle;)V
    ...
    const-string p7, "crashApplication: nothing for uid="
