...
.method private canInteractWithAcrossProfilesPermission(IZIILjava/lang/String;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/am/UserController$Injector;->getContext()Landroid/content/Context;

    move-result-object p1

    const-string p2, "android.permission.INTERACT_ACROSS_PROFILES"

    invoke-static {p1, p2, p3, p4, p5}, Landroid/content/PermissionChecker;->checkPermissionForPreflight(Landroid/content/Context;Ljava/lang/String;IILjava/lang/String;)I
...
.method private finishUserUnlockedCompleted(Lcom/android/server/am/UserState;)V
    ...
    new-instance v7, Lcom/android/server/am/UserController$$ExternalSyntheticLambda10;

    invoke-direct {v7, v0, v1}, Lcom/android/server/am/UserController$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/am/UserController;Landroid/content/pm/UserInfo;)V
    ...
    new-instance v8, Lcom/android/server/am/UserController$$ExternalSyntheticLambda9;
...
.method private forceStopUser(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/am/UserController;->broadcastProfileAccessibleStateChanged(IILjava/lang/String;)V
...
.method private logUserJourneyInfo(Landroid/content/pm/UserInfo;Landroid/content/pm/UserInfo;I)V
    ...
    iget-wide v12, v7, Lcom/android/server/am/UserController$UserJourneySession;->mSessionId:J
    ...
    invoke-static/range {v11 .. v16}, Lcom/android/internal/util/FrameworkStatsLog;->write(IJIII)V
...
.method private logUserLifecycleEvent(III)V
    ...
    const-string v1, "UserLifecycleEvent "
...
.method private startUserInternal(IZLandroid/os/IProgressListener;Lcom/android/server/utils/TimingsTraceAndSlog;)Z
    ...
    if-nez v4, :cond_parallel_foreground_block

    invoke-virtual {v2}, Landroid/content/pm/UserInfo;->isParallel()Z

    move-result v4

    if-eqz v4, :cond_6

    :cond_parallel_foreground_block
    ...
    invoke-direct {v0, v5, v3, v1}, Lcom/android/server/am/UserController;->moveUserToForeground(Lcom/android/server/am/UserState;II)V
...
.method private stopSingleUserLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/UserController;->dispatchUserLocking(ILjava/util/List;)V
    ...
    new-instance p4, Lcom/android/server/am/UserController$$ExternalSyntheticLambda0;

    invoke-direct {p4, p3, p1}, Lcom/android/server/am/UserController$$ExternalSyntheticLambda0;-><init>(Landroid/app/IStopUserCallback;I)V
...
.method private stopUsersLU(IZZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
    ...
    :cond_7
    invoke-direct {p0, v3, p3, v5, v4}, Lcom/android/server/am/UserController;->stopSingleUserLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)V
...
.method private timeoutUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    invoke-virtual {p1, v2, p2, p3}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
...
.method private unlockUserCleared(I[B[BLandroid/os/IProgressListener;)Z
    ...
    invoke-static {v0, p3}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/UserController;->maybeUnlockUser(I)Z
...
.method private updateUserToLockLU(IZ)I
    ...
    const-string v2, "finishUserStopped, stopping user:"
    ...
    const-string v0, "finishUserStopped, user:"
...
.method continueUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    invoke-virtual {p1, v0, p3, v2}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
...
.method dispatchUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    :try_start_0
    iput-boolean v3, v14, Lcom/android/server/am/UserState;->switching:Z
    ...
    invoke-direct {v15, v12}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V
...
.method finishUserStopped(Lcom/android/server/am/UserState;Z)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/android/server/am/UserController;->forceStopUser(ILjava/lang/String;)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/am/UserController$Injector;->systemServiceManagerOnUserStopped(I)V

    iget-object p2, p0, Lcom/android/server/am/UserController;->mInjector:Lcom/android/server/am/UserController$Injector;

    invoke-virtual {p2, v0}, Lcom/android/server/am/UserController$Injector;->taskSupervisorRemoveUser(I)V
    ...
    iget-boolean p2, v1, Landroid/content/pm/UserInfo;->preCreated:Z
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/pm/UserManagerService;->removeUserEvenWhenDisallowed(I)Z
    ...
    :cond_8
    invoke-direct {p0, p1, v4}, Lcom/android/server/am/UserController;->dispatchUserLocking(ILjava/util/List;)V
...
.method finishUserUnlocked(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {v0, v2, v5, v6}, Lcom/android/server/am/UserController;->broadcastProfileAccessibleStateChanged(IILjava/lang/String;)V
    ...
    new-instance v4, Lcom/android/server/am/UserController$$ExternalSyntheticLambda12;

    invoke-direct {v4, v0, v1}, Lcom/android/server/am/UserController$$ExternalSyntheticLambda12;-><init>(Lcom/android/server/am/UserController;Lcom/android/server/am/UserState;)V

    invoke-virtual {v3, v2, v5, v4}, Lcom/android/server/am/UserController$Injector;->sendPreBootBroadcast(IZLjava/lang/Runnable;)V
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v0, v1, v3}, Lcom/android/server/am/UserController;->logUserJourneyInfo(Landroid/content/pm/UserInfo;Landroid/content/pm/UserInfo;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/UserController;->logAndClearSessionId(I)V
    ...
    invoke-direct {p0, v0, v4, v2}, Lcom/android/server/am/UserController;->logUserLifecycleEvent(III)V

    iget v0, p1, Landroid/os/Message;->arg1:I

    invoke-direct {p0, v0, v1, v3}, Lcom/android/server/am/UserController;->logUserLifecycleEvent(III)V
    ...
    invoke-direct {p0, p1, v3, v2}, Lcom/android/server/am/UserController;->logUserLifecycleEvent(III)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/SystemServiceManager;->onUserSwitching(II)V
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/server/am/UserController;->clearSessionId(II)V
...
.method public synthetic lambda$finishUserUnlockedCompleted$3$UserController(Landroid/content/pm/UserInfo;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/pm/UserManagerService;->makeInitialized(I)V
...
.method sendBootCompleted(Landroid/content/IIntentReceiver;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/am/UserController;->sendLockedBootCompletedBroadcast(Landroid/content/IIntentReceiver;I)V
...
.method setStopUserOnSwitch(I)V
    ...
    const-string v0, "You either need MANAGE_USERS or INTERACT_ACROSS_USERS permission to call setStopUserOnSwitch()"
...
.method startProfile(I)Z
    ...
    const-string v0, "You either need MANAGE_USERS or INTERACT_ACROSS_USERS_FULL permission to start a profile"
    ...
    const-string v2, "Cannot start disabled profile #"
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/am/UserController;->startUserNoChecks(IZLandroid/os/IProgressListener;)Z
...
.method stopProfile(I)Z
    ...
    const-string v0, "You either need MANAGE_USERS or INTERACT_ACROSS_USERS_FULL permission to stop a profile"
    ...
    :try_start_0
    invoke-direct/range {v1 .. v6}, Lcom/android/server/am/UserController;->stopUsersLU(IZZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method switchUser(I)Z
    ...
    :cond_1
    invoke-virtual {v1}, Landroid/content/pm/UserInfo;->isParallel()Z

    move-result v4

    if-eqz v4, :cond_parallel_switch_ok
    ...
    const-string p1, ": parallel users cannot be foreground"
