...
.method private addExitInfoLocked(Landroid/app/ApplicationExitInfo;)Landroid/app/ApplicationExitInfo;
    ...
    const-string v0, "Skipping saving the exit info due to ongoing loading from storage"
    ...
    invoke-direct {p0, v4, p1, v0}, Lcom/android/server/am/AppExitInfoTracker;->addExitInfoInnerLocked(Ljava/lang/String;ILandroid/app/ApplicationExitInfo;)V
...
.method private dumpHistoryProcessExitInfoLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/util/SparseArray;Landroid/icu/text/SimpleDateFormat;)V
    ...
    const-string v2, "  Historical Process Exit for uid="
    ...
    invoke-virtual {v1, p1, v2, p5}, Lcom/android/server/am/AppExitInfoTracker$AppExitInfoContainer;->dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;Landroid/icu/text/SimpleDateFormat;)V
...
.method static synthetic lambda$pruneAnrTracesIfNecessaryLocked$14(Landroid/util/ArraySet;Ljava/lang/String;Landroid/util/SparseArray;)Ljava/lang/Integer;
    ...
    invoke-direct {v1, p0}, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda7;-><init>(Landroid/util/ArraySet;)V
...
.method private pruneAnrTracesIfNecessaryLocked()V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/am/AppExitInfoTracker;->forEachPackageLocked(Ljava/util/function/BiFunction;)V
...
.method private removePackageLocked(Ljava/lang/String;IZI)V
    ...
    invoke-virtual {p3, v0}, Landroid/util/SparseArray;->removeAt(I)V
...
.method private scheduleChildProcDied(III)V
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private scheduleLogToStatsdLocked(Landroid/app/ApplicationExitInfo;Z)V
    ...
    invoke-virtual {p2, v0, p1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {p2, v0, p1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->hasMessages(ILjava/lang/Object;)Z
    ...
    invoke-virtual {p2, v0, p1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object p1

    sget-wide v0, Lcom/android/server/am/AppExitInfoTracker;->APP_EXIT_INFO_STATSD_LOG_DEBOUNCE:J

    invoke-virtual {p2, p1, v0, v1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private updateExistingExitInfoRecordLocked(Landroid/app/ApplicationExitInfo;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    :goto_1
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/AppExitInfoTracker;->scheduleLogToStatsdLocked(Landroid/app/ApplicationExitInfo;Z)V
...
.method private updateExitInfoIfNecessaryLocked(IILjava/lang/Integer;Ljava/lang/Integer;)Z
    ...
    new-instance v7, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda11;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda11;-><init>(Lcom/android/server/am/AppExitInfoTracker;ILjava/util/ArrayList;ILjava/lang/Integer;Ljava/lang/Integer;)V

    invoke-direct {p0, v7}, Lcom/android/server/am/AppExitInfoTracker;->forEachPackageLocked(Ljava/util/function/BiFunction;)V
...
.method clearHistoryProcessExitInfo(Ljava/lang/String;I)V
    ...
    :try_start_1
    invoke-direct {p0, p1, v1, v3, p2}, Lcom/android/server/am/AppExitInfoTracker;->removePackageLocked(Ljava/lang/String;IZI)V
...
.method dumpHistoryProcessExitInfo(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/AppExitInfoTracker;->forEachPackageLocked(Ljava/util/function/BiFunction;)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/am/AppExitInfoTracker;->dumpHistoryProcessExitInfoLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/util/SparseArray;Landroid/icu/text/SimpleDateFormat;)V
...
.method getExitInfo(Ljava/lang/String;IIILjava/util/ArrayList;)V
    ...
    invoke-virtual {p1, p3, p4, p5}, Lcom/android/server/am/AppExitInfoTracker$AppExitInfoContainer;->getExitInfoLocked(IILjava/util/ArrayList;)V
    ...
    invoke-direct {v3, p0, p2, p1, p3}, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/am/AppExitInfoTracker;ILjava/util/ArrayList;I)V

    invoke-direct {p0, v3}, Lcom/android/server/am/AppExitInfoTracker;->forEachPackageLocked(Ljava/util/function/BiFunction;)V

    sget-object p2, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda4;
...
.method handleLogAnrTrace(II[Ljava/lang/String;Ljava/io/File;JJ)V
    ...
    sget-object v1, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda18;->INSTANCE:Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda18;

    sget-object v4, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda14;->INSTANCE:Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda14;
...
.method handleNoteAppKillLocked(Landroid/app/ApplicationExitInfo;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/am/AppExitInfoTracker;->scheduleLogToStatsdLocked(Landroid/app/ApplicationExitInfo;Z)V
...
.method handleNoteProcessDiedLocked(Landroid/app/ApplicationExitInfo;)V
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/am/AppExitInfoTracker;->updateExistingExitInfoRecordLocked(Landroid/app/ApplicationExitInfo;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/android/server/am/AppExitInfoTracker;->updateExistingExitInfoRecordLocked(Landroid/app/ApplicationExitInfo;Ljava/lang/Integer;Ljava/lang/Integer;)V
...
.method public synthetic lambda$getExitInfo$3$AppExitInfoTracker(ILjava/util/ArrayList;ILjava/lang/String;Landroid/util/SparseArray;)Ljava/lang/Integer;
    ...
    invoke-virtual {p1, p4, p3}, Lcom/android/server/am/AppExitInfoTracker$AppExitInfoContainer;->toListLocked(Ljava/util/List;I)Ljava/util/List;
...
.method public synthetic lambda$updateExitInfoIfNecessaryLocked$2$AppExitInfoTracker(ILjava/util/ArrayList;ILjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/String;Landroid/util/SparseArray;)Ljava/lang/Integer;
    ...
    :cond_2
    invoke-direct {p0, p3, p4, p5}, Lcom/android/server/am/AppExitInfoTracker;->updateExistingExitInfoRecordLocked(Landroid/app/ApplicationExitInfo;Ljava/lang/Integer;Ljava/lang/Integer;)V
...
.method loadExistingProcessExitInfo()V
    ...
    invoke-direct {p0, v2, v3, v4}, Lcom/android/server/am/AppExitInfoTracker;->loadPackagesFromProto(Landroid/util/proto/ProtoInputStream;J)V
...
.method obtainRawRecord(Lcom/android/server/am/ProcessRecord;J)Landroid/app/ApplicationExitInfo;
    ...
    :goto_2
    invoke-virtual {v0, v2}, Landroid/app/ApplicationExitInfo;->setDefiningUid(I)V

    iget-object v2, p1, Lcom/android/server/am/ProcessRecord;->processName:Ljava/lang/String;

    invoke-virtual {v0, v2}, Landroid/app/ApplicationExitInfo;->setProcessName(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Landroid/app/ApplicationExitInfo;->setConnectionGroup(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/app/ApplicationExitInfo;->setPackageList([Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ProcessStateRecord;->getReportedProcState()I
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ProcessProfileRecord;->getLastRss()J
...
.method onPackageRemoved(Ljava/lang/String;IZ)V
    ...
    :goto_1
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/android/server/am/AppExitInfoTracker;->removePackageLocked(Ljava/lang/String;IZI)V
...
.method persistProcessExitInfo()V
    ...
    :try_start_2
    new-instance v7, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda9;

    invoke-direct {v7, v5}, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda9;-><init>(Landroid/util/proto/ProtoOutputStream;)V
...
.method scheduleLogAnrTrace(II[Ljava/lang/String;Ljava/io/File;JJ)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->sendMessage(Landroid/os/Message;)Z
...
.method scheduleNoteAppKill(Lcom/android/server/am/ProcessRecord;IILjava/lang/String;)V
    ...
    invoke-virtual {p2, p3, p1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method scheduleNoteProcessDied(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/am/AppExitInfoTracker$KillHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method setProcessStateSummary(II[B)V
    ...
    sget-object v5, Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda18;->INSTANCE:Lcom/android/server/am/AppExitInfoTracker$$ExternalSyntheticLambda18;
