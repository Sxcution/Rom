...
.method private fileDescriptorEventHandler(Ljava/io/FileDescriptor;I)I
    ...
    invoke-interface {p1}, Lcom/android/server/am/LmkdConnection$LmkdConnectionListener;->onDisconnect()V
...
.method private write(Ljava/nio/ByteBuffer;)Z
    ...
    invoke-virtual {v2, v3, v1, p1}, Ljava/io/OutputStream;->write([BII)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public connect()Z
    ...
    const-string v4, "Failed to communicate with lowmemorykiller, retry later"
    ...
    iget-object v1, p0, Lcom/android/server/am/LmkdConnection;->mLmkdSocketLock:Ljava/lang/Object;
