...
.method private writeJobsMapImpl(Ljava/util/List;)V
    ...
    invoke-static {v4}, Lcom/android/server/job/JobStore;->access$400(Lcom/android/server/job/JobStore;)Landroid/util/SystemConfigFileCommitEventLogger;
    ...
    invoke-virtual {v4, v5, v6}, Landroid/util/SystemConfigFileCommitEventLogger;->setStartTime(J)V

    new-instance v4, Ljava/io/ByteArrayOutputStream;

    invoke-direct {v4}, Ljava/io/ByteArrayOutputStream;-><init>()V

    new-instance v5, Lcom/android/internal/util/jobs/FastXmlSerializer;

    invoke-direct {v5}, Lcom/android/internal/util/jobs/FastXmlSerializer;-><init>()V
    ...
    invoke-direct {p0, v5, v10}, Lcom/android/server/job/JobStore$1;->addAttributesToJobTag(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/job/controllers/JobStatus;)V

    invoke-direct {p0, v5, v10}, Lcom/android/server/job/JobStore$1;->writeConstraintsToXml(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/job/controllers/JobStatus;)V

    invoke-direct {p0, v5, v10}, Lcom/android/server/job/JobStore$1;->writeExecutionCriteriaToXml(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, v11, v5}, Lcom/android/server/job/JobStore$1;->writeBundleToXml(Landroid/os/PersistableBundle;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-static {v10}, Lcom/android/server/job/JobStore;->access$500(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-static {p1}, Lcom/android/server/job/JobStore;->access$600(Lcom/android/server/job/JobStore;)Landroid/util/AtomicFile;
    ...
    invoke-static {p1}, Lcom/android/server/job/JobStore;->access$700(Lcom/android/server/job/JobStore;)Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;
    ...
    iput v7, p1, Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;->countSystemServerJobsSaved:I
    ...
    iput v7, v0, Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;->countSystemServerJobsSaved:I
...
.method public run()V
    ...
    invoke-static {v0}, Lcom/android/server/job/JobStore;->access$200(Lcom/android/server/job/JobStore;)V
    ...
    invoke-static {v1, v5}, Lcom/android/server/job/JobStore;->access$102(Lcom/android/server/job/JobStore;Z)Z
