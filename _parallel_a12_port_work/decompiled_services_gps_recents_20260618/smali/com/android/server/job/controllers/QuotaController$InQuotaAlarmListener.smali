...
.method private setNextAlarmLocked(J)V
    ...
    iget-wide v3, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->mTriggerTimeElapsed:J
    ...
    iput-wide p1, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->mTriggerTimeElapsed:J

    :cond_2
    goto :goto_0

    :cond_3
    iget-object p1, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->this$0:Lcom/android/server/job/controllers/QuotaController;

    invoke-static {p1}, Lcom/android/server/job/controllers/QuotaController;->access$3900(Lcom/android/server/job/controllers/QuotaController;)Landroid/app/AlarmManager;
...
.method addAlarmLocked(ILjava/lang/String;J)V
    ...
    iget-object p1, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->mAlarmQueue:Lcom/android/server/job/controllers/QuotaController$AlarmQueue;

    invoke-virtual {p1, v0}, Lcom/android/server/job/controllers/QuotaController$AlarmQueue;->remove(Lcom/android/server/job/controllers/QuotaController$Package;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/job/controllers/QuotaController$AlarmQueue;->offer(Ljava/lang/Object;)Z
...
.method dumpLocked(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-wide v0, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->mTriggerTimeElapsed:J
    ...
    invoke-virtual {v4, p1, v5, v6}, Lcom/android/server/job/controllers/QuotaController$Package;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
...
.method removeAlarmsLocked(I)V
    ...
    iget-object v3, p0, Lcom/android/server/job/controllers/QuotaController$InQuotaAlarmListener;->mAlarmQueue:Lcom/android/server/job/controllers/QuotaController$AlarmQueue;

    aget-object v4, v0, v1

    invoke-virtual {v3, v4}, Lcom/android/server/job/controllers/QuotaController$AlarmQueue;->remove(Ljava/lang/Object;)Z
