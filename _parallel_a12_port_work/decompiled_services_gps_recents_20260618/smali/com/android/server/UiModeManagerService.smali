...
.method protected constructor <init>(Landroid/content/Context;ZLcom/android/server/twilight/TwilightManager;Lcom/android/server/UiModeManagerService$Injector;)V
    ...
    new-instance p1, Lcom/android/server/UiModeManagerService$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0}, Lcom/android/server/UiModeManagerService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/UiModeManagerService;)V
...
.method private disableCarMode(IILjava/lang/String;)V
    ...
    invoke-direct {p0, p3, p2}, Lcom/android/server/UiModeManagerService;->notifyCarModeDisabled(ILjava/lang/String;)V
...
.method private enableCarMode(ILjava/lang/String;)V
    ...
    :cond_0
    sget-object p2, Lcom/android/server/UiModeManagerService;->TAG:Ljava/lang/String;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "enableCarMode: car mode at priority "
...
.method private enforceProjectionTypePermissions(I)V
    ...
    const-string v0, "android.permission.TOGGLE_AUTOMOTIVE_PROJECTION"

    const-string/jumbo v1, "toggleProjection"
...
.method private notifyCarModeDisabled(ILjava/lang/String;)V
    ...
    const-string v1, "android.permission.HANDLE_CAR_MODE_CHANGES"
...
.method private onProjectionStateChangedLocked(I)V
    ...
    invoke-direct {p0, v2, v4}, Lcom/android/server/UiModeManagerService;->populateWithRelevantActivePackageNames(ILjava/util/List;)I
...
.method private releaseProjectionUnchecked(ILjava/lang/String;)Z
    ...
    invoke-static {v5}, Lcom/android/server/UiModeManagerService$ProjectionHolder;->access$4700(Lcom/android/server/UiModeManagerService$ProjectionHolder;)V
...
.method private static toPackageNameList(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/android/server/UiModeManagerService$ProjectionHolder;->access$4000(Lcom/android/server/UiModeManagerService$ProjectionHolder;)Ljava/lang/String;
...
.method private updateConfigurationLocked()V
    ...
    :goto_1
    invoke-direct {p0, v4}, Lcom/android/server/UiModeManagerService;->updateComputedNightModeLocked(Z)V
    ...
    invoke-interface {v3, v1, v4}, Lcom/android/server/twilight/TwilightManager;->registerListener(Lcom/android/server/twilight/TwilightListener;Landroid/os/Handler;)V
...
.method private updateNightModeFromSettingsLocked(Landroid/content/Context;Landroid/content/res/Resources;I)Z
    ...
    invoke-static {v2, v4, p2, p3}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string v2, "dark_theme_custom_start_time"

    invoke-static {p2, v2, v4, v5, p3}, Landroid/provider/Settings$Secure;->getLongForUser(Landroid/content/ContentResolver;Ljava/lang/String;JI)J
...
.method public synthetic lambda$onStart$1$UiModeManagerService(Landroid/content/Context;Landroid/content/res/Resources;)V
    ...
    invoke-direct {p0, p1, p2, v1}, Lcom/android/server/UiModeManagerService;->updateNightModeFromSettingsLocked(Landroid/content/Context;Landroid/content/res/Resources;I)Z
...
.method public onStart()V
    ...
    invoke-direct {v2, p0, v0, v1}, Lcom/android/server/UiModeManagerService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/UiModeManagerService;Landroid/content/Context;Landroid/content/res/Resources;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/server/UiModeManagerService;->publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/UiModeManagerService;->publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
...
.method public onUserSwitching(Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$TargetUser;)V
    ...
    invoke-direct {p0, v0, v1, p2}, Lcom/android/server/UiModeManagerService;->updateNightModeFromSettingsLocked(Landroid/content/Context;Landroid/content/res/Resources;I)Z
...
.method setCarModeLocked(ZIILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p3, p4}, Lcom/android/server/UiModeManagerService;->updateNightModeFromSettingsLocked(Landroid/content/Context;Landroid/content/res/Resources;I)Z
