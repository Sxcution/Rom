...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/NetworkManagementService$Dependencies;)V
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/NetworkManagementService$NetdUnsolicitedEventListener;-><init>(Lcom/android/server/NetworkManagementService;Lcom/android/server/NetworkManagementService$1;)V
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/NetworkManagementService$LocalService;-><init>(Lcom/android/server/NetworkManagementService;Lcom/android/server/NetworkManagementService$1;)V
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/NetworkManagementService$NetdTetheringStatsProvider;-><init>(Lcom/android/server/NetworkManagementService;Lcom/android/server/NetworkManagementService$1;)V
...
.method private closeSocketsForFirewallChainLocked(ILjava/lang/String;)V
    ...
    invoke-interface {p1, v2, v5}, Landroid/net/INetd;->socketDestroy([Landroid/net/UidRangeParcel;[I)V
    :try_end_3
...
.method private getUidFirewallRulesLR(I)Landroid/util/SparseIntArray;
    ...
    :pswitch_0
    iget-object p1, p0, Lcom/android/server/NetworkManagementService;->mUidFirewallRestrictedRules:Landroid/util/SparseIntArray;
...
.method private notifyRouteChange(ZLandroid/net/RouteInfo;)V
    ...
    new-instance p1, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda1;

    invoke-direct {p1, p2}, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda1;-><init>(Landroid/net/RouteInfo;)V
    ...
    :cond_0
    new-instance p1, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda2;

    invoke-direct {p1, p2}, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda2;-><init>(Landroid/net/RouteInfo;)V
...
.method private prepareNativeDaemon()V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/NetworkManagementService;->getFirewallChainState(I)Z
...
.method public tetherInterface(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, v1}, Landroid/net/shared/NetdUtils;->tetherInterface(Landroid/net/INetd;Ljava/lang/String;Landroid/net/IpPrefix;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/ServiceSpecificException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public tetherLimitReached(Landroid/net/ITetheringStatsProvider;)V
    ...
    new-instance v1, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda11;

    invoke-direct {v1, p0}, Lcom/android/server/NetworkManagementService$$ExternalSyntheticLambda11;-><init>(Lcom/android/server/NetworkManagementService;)V
