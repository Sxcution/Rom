...
.method private handleCarMode()I
    ...
    :cond_2
    const-string v1, "Error: mode must be \'yes\', or \'no\'"
...
.method private handleCustomTime()I
    ...
    const-string v1, "command must be in [start|end]"
    ...
    invoke-static {v0}, Lcom/android/server/UiModeManagerService;->access$4900(Ljava/time/LocalTime;)J

    move-result-wide v3

    invoke-interface {v2, v3, v4}, Landroid/app/IUiModeManager;->setCustomNightModeEnd(J)V
    ...
    invoke-interface {v2, v3, v4}, Landroid/app/IUiModeManager;->setCustomNightModeStart(J)V
...
.method private handleNightMode()I
    ...
    :cond_1
    const-string v1, "Error: mode must be \'yes\', \'no\', or \'auto\', or \'custom\'"
