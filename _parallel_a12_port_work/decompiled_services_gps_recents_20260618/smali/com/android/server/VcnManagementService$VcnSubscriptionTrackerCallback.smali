...
.method public synthetic lambda$onNewSnapshot$0$VcnManagementService$VcnSubscriptionTrackerCallback(Landroid/os/ParcelUuid;Lcom/android/server/vcn/Vcn;)V
    ...
    invoke-static {p2, p1}, Lcom/android/server/VcnManagementService;->access$1400(Lcom/android/server/VcnManagementService;Landroid/os/ParcelUuid;)V

    iget-object p2, p0, Lcom/android/server/VcnManagementService$VcnSubscriptionTrackerCallback;->this$0:Lcom/android/server/VcnManagementService;

    const/4 v1, 0x1

    invoke-static {p2, p1, v1}, Lcom/android/server/VcnManagementService;->access$1500(Lcom/android/server/VcnManagementService;Landroid/os/ParcelUuid;I)V
...
.method public onNewSnapshot(Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;)V
    ...
    invoke-static {v5, v4, v3}, Lcom/android/server/VcnManagementService;->access$1000(Lcom/android/server/VcnManagementService;Landroid/os/ParcelUuid;Landroid/net/vcn/VcnConfig;)V
    ...
    invoke-static {v3}, Lcom/android/server/VcnManagementService;->access$1100(Lcom/android/server/VcnManagementService;)Landroid/os/Handler;
    ...
    invoke-static {v7}, Lcom/android/server/VcnManagementService;->access$1100(Lcom/android/server/VcnManagementService;)Landroid/os/Handler;
    ...
    invoke-static {p1, v1}, Lcom/android/server/VcnManagementService;->access$1200(Lcom/android/server/VcnManagementService;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;)Ljava/util/Map;
    ...
    invoke-static {v1, v2}, Lcom/android/server/VcnManagementService;->access$1200(Lcom/android/server/VcnManagementService;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lcom/android/server/VcnManagementService;->access$1300(Lcom/android/server/VcnManagementService;)V
