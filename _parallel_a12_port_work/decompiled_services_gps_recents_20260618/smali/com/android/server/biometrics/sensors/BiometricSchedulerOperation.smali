...
.method private doStart(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)Z
    ...
    invoke-interface {p1, v0, v1}, Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;->onClientFinished(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Z)V
    ...
    instance-of v0, p1, Lcom/android/server/biometrics/sensors/ErrorConsumer;
    ...
    invoke-interface {p1, v0, v2}, Lcom/android/server/biometrics/sensors/ErrorConsumer;->onError(II)V

    goto :goto_0

    :cond_0
    const-string/jumbo p1, "monitor cancelled but does not implement ErrorConsumer"
    ...
    invoke-interface {p1, v0, v2}, Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;->onClientFinished(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->start(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
...
.method private getWrappedCallback(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->mClientCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;
...
.method public cancel(Landroid/os/Handler;Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
    ...
    invoke-interface {v0, p2}, Lcom/android/server/biometrics/sensors/Interruptable;->cancelWithoutStarting(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V

    :goto_1
    iget-object p2, p0, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->mCancelWatchdog:Ljava/lang/Runnable;
