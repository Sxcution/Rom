.class Lcom/android/server/biometrics/sensors/face/custom/FaceRemovalClient;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/sensors/HalClientMonitor$LazyDaemon;Landroid/os/IBinder;Lcom/android/server/biometrics/sensors/ClientMonitorCallbackConverter;IILjava/lang/String;Lcom/android/server/biometrics/sensors/BiometricUtils;ILjava/util/Map;)V
    ...
    iput v1, v0, Lcom/android/server/biometrics/sensors/face/custom/FaceRemovalClient;->mBiometricId:I
...
.method protected startHalOperation()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/face/custom/FaceRemovalClient;->getFreshDaemon()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/internal/util/custom/faceunlock/IFaceService;

    iget v1, p0, Lcom/android/server/biometrics/sensors/face/custom/FaceRemovalClient;->mBiometricId:I

    invoke-interface {v0, v1}, Lcom/android/internal/util/custom/faceunlock/IFaceService;->remove(I)V
    :try_end_0
    ...
    iget-object v0, p0, Lcom/android/server/biometrics/sensors/face/custom/FaceRemovalClient;->mCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;
