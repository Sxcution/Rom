...
.method public onAuthenticationAcquired(I)V
    ...
    const-string v1, "Remote exception in onAuthenticationAcquired()"
...
.method public onAuthenticationError(ILjava/lang/CharSequence;)V
    ...
    iget-object p2, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper$1;->val$receiver:Landroid/hardware/fingerprint/IFingerprintServiceReceiver;

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onError(II)V
    ...
    invoke-interface {p2, v0, p1}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onError(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v0, "Remote exception in onAuthenticationError()"
...
.method public onAuthenticationSucceeded(Landroid/hardware/biometrics/BiometricPrompt$AuthenticationResult;)V
    ...
    iget v2, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper$1;->val$userId:I

    invoke-interface {v0, p1, v2, v1}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onAuthenticationSucceeded(Landroid/hardware/fingerprint/Fingerprint;IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v1, "Remote exception in onAuthenticationSucceeded()"
