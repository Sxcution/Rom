...
.method public addBiometricForUser(Landroid/content/Context;ILandroid/hardware/fingerprint/Fingerprint;)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->addBiometric(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;)V
...
.method public getBiometricsForUser(Landroid/content/Context;I)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->getBiometrics()Ljava/util/List;
...
.method public getUniqueName(Landroid/content/Context;I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->getUniqueName()Ljava/lang/String;
...
.method public isInvalidationInProgress(Landroid/content/Context;I)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->isInvalidationInProgress()Z
...
.method public removeBiometricForUser(Landroid/content/Context;II)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->removeBiometric(I)V
...
.method public renameBiometricForUser(Landroid/content/Context;IILjava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p3, p4}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->renameBiometric(ILjava/lang/CharSequence;)V
...
.method public setInvalidationInProgress(Landroid/content/Context;IZ)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintUserState;->setInvalidationInProgress(Z)V
