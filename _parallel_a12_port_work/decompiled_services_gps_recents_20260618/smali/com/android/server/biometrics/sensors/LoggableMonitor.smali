...
.method public constructor <init>(Landroid/content/Context;III)V
    ...
    iput-object p1, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mSensorManager:Landroid/hardware/SensorManager;
...
.method static synthetic access$000(Lcom/android/server/biometrics/sensors/LoggableMonitor;)Landroid/hardware/SensorManager;
    ...
    iget-object p0, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mSensorManager:Landroid/hardware/SensorManager;
...
.method private sanitizeLatency(J)J
    ...
    const-string p2, "Biometrics/LoggableMonitor"
...
.method private setLightSensorLoggingEnabled(Landroid/hardware/Sensor;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mLightSensorEnabled:Z

    iput v0, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mLastAmbientLux:F

    iget-object p1, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mSensorManager:Landroid/hardware/SensorManager;

    iget-object v0, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mLightSensorListener:Landroid/hardware/SensorEventListener;
...
.method protected final logOnAcquired(Landroid/content/Context;III)V
    ...
    iget-wide v0, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mFirstAcquireTimeMs:J
    ...
    iput-wide v0, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mFirstAcquireTimeMs:J
    ...
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/LoggableMonitor;->isCryptoOperation()Z

    move-result v4

    iget v5, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mStatsAction:I

    iget v6, p0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mStatsClient:I
...
.method protected final logOnAuthenticated(Landroid/content/Context;ZZIZ)V
    ...
    iget v4, v0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mStatsModality:I

    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/LoggableMonitor;->isCryptoOperation()Z

    move-result v5

    iget v7, v0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mStatsClient:I

    invoke-direct {p0, v1, v2}, Lcom/android/server/biometrics/sensors/LoggableMonitor;->sanitizeLatency(J)J
    ...
    invoke-static {p1, v2}, Lcom/android/server/biometrics/Utils;->isDebugEnabled(Landroid/content/Context;I)Z

    move-result v10

    const/4 v11, -0x1

    iget v12, v0, Lcom/android/server/biometrics/sensors/LoggableMonitor;->mLastAmbientLux:F
    ...
    invoke-static/range {v0 .. v11}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIIZIZIJZIF)V
...
.method protected final logOnError(Landroid/content/Context;III)V
    ...
    invoke-static {v3, v6}, Lcom/android/server/biometrics/Utils;->isDebugEnabled(Landroid/content/Context;I)Z
