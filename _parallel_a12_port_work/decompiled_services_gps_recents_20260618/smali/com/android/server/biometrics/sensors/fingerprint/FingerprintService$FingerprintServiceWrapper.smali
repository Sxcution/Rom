...
.method private addAidlProviders()V
    ...
    new-instance v12, Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;
...
.method private addHidlProviders(Ljava/util/List;)V
    ...
    invoke-static {v1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$700(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;
    ...
    invoke-static {v2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$600(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;
    ...
    invoke-static {v0, v1, v3, v2, v4}, Lcom/android/server/biometrics/sensors/fingerprint/hidl/Fingerprint21UdfpsMock;->newInstance(Landroid/content/Context;Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;Landroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;)Lcom/android/server/biometrics/sensors/fingerprint/hidl/Fingerprint21UdfpsMock;
    ...
    invoke-static {v0}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$700(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;

    move-result-object v2

    iget-object v0, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;

    invoke-static {v0}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1000(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Landroid/os/Handler;
...
.method private authenticateWithPrompt(JLandroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;ILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Z)J
    ...
    new-instance v2, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper$$ExternalSyntheticLambda0;

    invoke-direct {v2, p5}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper$$ExternalSyntheticLambda0;-><init>(Landroid/hardware/fingerprint/IFingerprintServiceReceiver;)V

    invoke-virtual {v1, v0, v3, v2}, Landroid/hardware/biometrics/BiometricPrompt$Builder;->setNegativeButton(Ljava/lang/CharSequence;Ljava/util/concurrent/Executor;Landroid/content/DialogInterface$OnClickListener;)Landroid/hardware/biometrics/BiometricPrompt$Builder;
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/biometrics/BiometricPrompt$Builder;->setAllowedSensorIds(Ljava/util/List;)Landroid/hardware/biometrics/BiometricPrompt$Builder;

    move-result-object v0

    invoke-virtual {v0, p6}, Landroid/hardware/biometrics/BiometricPrompt$Builder;->setIgnoreEnrollmentState(Z)Landroid/hardware/biometrics/BiometricPrompt$Builder;

    move-result-object p6

    invoke-virtual {p6}, Landroid/hardware/biometrics/BiometricPrompt$Builder;->build()Landroid/hardware/biometrics/BiometricPrompt;
...
.method public addAuthenticatorsRegisteredCallback(Landroid/hardware/fingerprint/IFingerprintAuthenticatorsRegisteredCallback;)V
    ...
    const-string v0, "addAuthenticatorsRegisteredCallback, callback is null"
    ...
    invoke-static {v1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1300(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/util/List;
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1400(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)V
    ...
    const-string v0, "addAuthenticatorsRegisteredCallback failed to register callback"
...
.method public authenticate(Landroid/os/IBinder;JIILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;Z)J
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$300(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;Ljava/lang/String;ZIII)Z
    ...
    invoke-static {v2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$400(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-static {v2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$200(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Landroid/util/Pair;
    ...
    invoke-static {v2, v6}, Lcom/android/server/biometrics/Utils;->checkPermission(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v7, v0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;

    invoke-static {v7, v1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$000(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;I)Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;
    ...
    invoke-static {v1, v8}, Lcom/android/server/biometrics/Utils;->isSettings(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public cancelAuthentication(Landroid/os/IBinder;Ljava/lang/String;J)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;

    invoke-static {p2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$200(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Landroid/util/Pair;
    ...
    invoke-interface {v0, p2, p1, p3, p4}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->cancelAuthentication(ILandroid/os/IBinder;J)V
...
.method public cancelAuthenticationFromService(ILandroid/os/IBinder;Ljava/lang/String;J)V
    ...
    invoke-virtual {p3}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->getContext()Landroid/content/Context;
    ...
    invoke-static {p3, p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$000(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;I)Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;
    ...
    :cond_0
    invoke-interface {p3, p1, p2, p4, p5}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->cancelAuthentication(ILandroid/os/IBinder;J)V
...
.method public cancelEnrollment(Landroid/os/IBinder;J)V
    ...
    const-string p2, "Null provider for cancelEnrollment"
    ...
    invoke-interface {v1, v0, p1, p2, p3}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->cancelEnrollment(ILandroid/os/IBinder;J)V
...
.method public cancelFingerprintDetect(Landroid/os/IBinder;Ljava/lang/String;J)V
    ...
    const-string p3, "cancelFingerprintDetect called from non-sysui package: "
    ...
    const-string p1, "Null provider for cancelFingerprintDetect"
...
.method public createTestSession(ILandroid/hardware/biometrics/ITestSessionCallback;Ljava/lang/String;)Landroid/hardware/biometrics/ITestSession;
    ...
    const-string p3, "Null provider for createTestSession, sensorId: "
...
.method public detectFingerprint(Landroid/os/IBinder;ILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;)J
    ...
    const-string p2, "detectFingerprint called from non-sysui package: "
    ...
    const-string p1, "detectFingerprint invoked when user is not encrypted or lockdown"
    ...
    const-string p1, "Null provider for detectFingerprint"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$500(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/util/List;
    ...
    invoke-interface {p3, v3, p2, v5}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->dumpProtoState(ILandroid/util/proto/ProtoOutputStream;Z)V
    ...
    invoke-static {p2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$500(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/util/List;
    ...
    invoke-interface {p3, v3, p1}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->dumpProtoMetrics(ILjava/io/FileDescriptor;)V
    ...
    invoke-static {v5}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$700(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;

    move-result-object v5

    invoke-virtual {v5}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;->getFingerprintState()I
...
.method public enroll(Landroid/os/IBinder;[BILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;I)J
    ...
    invoke-interface/range {v2 .. v9}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->scheduleEnroll(ILandroid/os/IBinder;[BILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;I)J
...
.method public generateChallenge(Landroid/os/IBinder;IILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;)V
    ...
    const-string p3, "No matching sensor for generateChallenge, sensorId: "
...
.method public getAuthenticatorId(II)J
    ...
    const-string p2, "Null provider for getAuthenticatorId"
...
.method public getLockoutModeForUser(II)I
    ...
    const-string p2, "Null provider for getLockoutModeForUser"
...
.method public getSensorProperties(ILjava/lang/String;)Landroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;
    ...
    const-string v1, "No matching sensor for getSensorProperties, sensorId: "
...
.method public getSensorPropertiesInternal(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->getContext()Landroid/content/Context;
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$100(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/util/List;
...
.method public hasEnrolledFingerprints(IILjava/lang/String;)Z
    ...
    const-string p2, "Null provider for hasEnrolledFingerprints, caller: "
...
.method public invalidateAuthenticatorId(IILandroid/hardware/biometrics/IInvalidationCallback;)V
    ...
    const-string p2, "Null provider for invalidateAuthenticatorId"
...
.method public isHardwareDetectedDeprecated(Ljava/lang/String;)Z
    ...
    const-string v5, "Null provider for isHardwareDetectedDeprecated, caller: "
    ...
    invoke-interface {p1, v0}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->isHardwareDetected(I)Z
...
.method public synthetic lambda$registerAuthenticators$1$FingerprintService$FingerprintServiceWrapper(Ljava/util/List;)V
    ...
    invoke-static {v5}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1500(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper;
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1100(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/lang/Object;
    ...
    invoke-static {p1, v0}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$1600(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;Landroid/hardware/fingerprint/IFingerprintStateListener;)V
...
.method public onPointerDown(IIIFF)V
    ...
    const-string p3, "No matching provider for onFingerDown, sensorId: "
...
.method public onPointerUp(I)V
    ...
    const-string v1, "No matching provider for onFingerUp, sensorId: "
...
.method public onUiReady(I)V
    ...
    const-string v1, "No matching provider for onUiReady, sensorId: "
...
.method public prepareForAuthentication(ILandroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricSensorReceiver;Ljava/lang/String;JIZ)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$000(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;I)Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;
...
.method public registerAuthenticators(Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService$FingerprintServiceWrapper;Ljava/util/List;)V
...
.method public remove(Landroid/os/IBinder;IILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;)V
    ...
    const-string p2, "Null provider for remove"
...
.method public removeAll(Landroid/os/IBinder;ILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Ljava/lang/String;)V
    ...
    invoke-static {p3}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$500(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Ljava/util/List;
...
.method public rename(IILjava/lang/String;)V
    ...
    const-string p2, "Null provider for rename"
    ...
    invoke-interface {v1, v0, p1, p2, p3}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->rename(IIILjava/lang/String;)V
...
.method public resetLockout(Landroid/os/IBinder;II[BLjava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->access$000(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;I)Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;
    ...
    const-string p2, "Null provider for resetLockout, caller: "
    ...
    :cond_0
    invoke-interface {p1, p2, p3, p4}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->scheduleResetLockout(II[B)V
...
.method public revokeChallenge(Landroid/os/IBinder;IILjava/lang/String;J)V
    ...
    const-string p3, "No matching sensor for revokeChallenge, sensorId: "
...
.method public startPreparedClient(II)V
    ...
    const-string p2, "Null provider for startPreparedClient"
