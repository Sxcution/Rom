...
.method public constructor <init>(Landroid/content/Context;Landroid/os/IBinder;Lcom/android/server/biometrics/sensors/ClientMonitorCallbackConverter;ILjava/lang/String;IIIII)V
    ...
    iput-boolean p8, p0, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->mAlreadyDone:Z

    new-instance p9, Lcom/android/server/biometrics/sensors/BaseClientMonitor$1;

    invoke-direct {p9, p0}, Lcom/android/server/biometrics/sensors/BaseClientMonitor$1;-><init>(Lcom/android/server/biometrics/sensors/BaseClientMonitor;)V

    iput-object p9, p0, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->mCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;

    sget p9, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->sCount:I

    add-int/lit8 p10, p9, 0x1

    sput p10, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->sCount:I

    iput p9, p0, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->mSequentialId:I
    ...
    iput-wide p9, p0, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->mRequestId:J
    ...
    :try_start_0
    invoke-interface {p2, p0, p8}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_0
    ...
    const-string p2, "Biometrics/ClientMonitor"
...
.method binderDiedInternal(Z)V
    ...
    const-string p1, "Binder died but client is finished, ignoring"
...
.method public destroy()V
    ...
    const-string v2, "Biometrics/ClientMonitor"
...
.method protected final setRequestId(J)V
    ...
    const-string/jumbo p2, "request id must be positive"
...
.method public start(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
    ...
    iput-object p1, p0, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->mCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;

    invoke-interface {p1, p0}, Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;->onClientStarted(Lcom/android/server/biometrics/sensors/BaseClientMonitor;)V
