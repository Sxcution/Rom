...
.method public synthetic lambda$onAuthenticationFailed$7$Sensor$HalSessionCallback()V
    ...
    invoke-direct {v1, v4, v5, v2, v3}, Landroid/hardware/face/Face;-><init>(Ljava/lang/CharSequence;IJ)V
...
.method public synthetic lambda$onAuthenticationFrame$2$Sensor$HalSessionCallback(Landroid/hardware/biometrics/face/AuthenticationFrame;)V
    ...
    const-string/jumbo v2, "onAuthenticationFrame for incompatible client: "
    ...
    const-string v2, "Received null authentication frame for client: "
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/biometrics/sensors/face/aidl/FaceAuthenticationClient;->onAuthenticationFrame(Landroid/hardware/face/FaceAuthenticationFrame;)V
...
.method public synthetic lambda$onAuthenticationSucceeded$6$Sensor$HalSessionCallback(ILandroid/hardware/keymaster/HardwareAuthToken;)V
    ...
    const-string/jumbo v1, "onAuthenticationSucceeded for non-authentication consumer: "
...
.method public synthetic lambda$onAuthenticatorIdInvalidated$17$Sensor$HalSessionCallback(J)V
    ...
    const-string/jumbo v1, "onAuthenticatorIdInvalidated for wrong consumer: "
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/biometrics/sensors/face/aidl/FaceInvalidationClient;->onAuthenticatorIdInvalidated(J)V
...
.method public synthetic lambda$onAuthenticatorIdRetrieved$16$Sensor$HalSessionCallback(J)V
    ...
    const-string/jumbo v1, "onAuthenticatorIdRetrieved for wrong consumer: "
...
.method public synthetic lambda$onChallengeGenerated$0$Sensor$HalSessionCallback(J)V
    ...
    const-string/jumbo v1, "onChallengeGenerated for wrong client: "
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lcom/android/server/biometrics/sensors/face/aidl/FaceGenerateChallengeClient;->onChallengeGenerated(IIJ)V
...
.method public synthetic lambda$onChallengeRevoked$1$Sensor$HalSessionCallback(J)V
    ...
    const-string/jumbo v1, "onChallengeRevoked for wrong client: "
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lcom/android/server/biometrics/sensors/face/aidl/FaceRevokeChallengeClient;->onChallengeRevoked(IIJ)V
...
.method public synthetic lambda$onEnrollmentFrame$3$Sensor$HalSessionCallback(Landroid/hardware/biometrics/face/EnrollmentFrame;)V
    ...
    const-string/jumbo v2, "onEnrollmentFrame for incompatible client: "
    ...
    const-string v2, "Received null enrollment frame for client: "
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/biometrics/sensors/face/aidl/FaceEnrollClient;->onEnrollmentFrame(Landroid/hardware/face/FaceEnrollFrame;)V
...
.method public synthetic lambda$onEnrollmentProgress$5$Sensor$HalSessionCallback(II)V
    ...
    const-string/jumbo v1, "onEnrollmentProgress for non-enroll client: "
    ...
    invoke-virtual {v0, v2, p2}, Lcom/android/server/biometrics/sensors/face/aidl/FaceEnrollClient;->onEnrollResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
...
.method public synthetic lambda$onEnrollmentsEnumerated$12$Sensor$HalSessionCallback([I)V
    ...
    const-string/jumbo v2, "onEnrollmentsEnumerated for non-enumerate consumer: "
...
.method public synthetic lambda$onError$4$Sensor$HalSessionCallback(BI)V
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback;->mCallback:Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback$Callback;

    invoke-interface {p1}, Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback$Callback;->onHardwareUnavailable()V
...
.method public synthetic lambda$onFeatureSet$14$Sensor$HalSessionCallback()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/biometrics/sensors/face/aidl/FaceSetFeatureClient;->onFeatureSet(Z)V
...
.method public synthetic lambda$onFeaturesRetrieved$13$Sensor$HalSessionCallback([B)V
    ...
    const-string/jumbo v2, "onFeaturesRetrieved for non-get feature consumer: "
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/biometrics/sensors/face/aidl/FaceGetFeatureClient;->onFeatureGet(Z[B)V
...
.method public synthetic lambda$onLockoutCleared$10$Sensor$HalSessionCallback()V
    ...
    iget-object v3, p0, Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback;->mLockoutResetDispatcher:Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;
...
.method public synthetic lambda$onLockoutTimed$8$Sensor$HalSessionCallback(J)V
    ...
    const-string/jumbo v1, "onLockoutTimed for non-lockout consumer: "
...
.method public onFeatureSet(B)V
    ...
    new-instance v0, Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0}, Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/biometrics/sensors/face/aidl/Sensor$HalSessionCallback;)V
