...
.method public sendAuthenticationResult(Z)V
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->access$000(Lcom/android/server/biometrics/sensors/AuthenticationClient;)Z
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->access$100(Lcom/android/server/biometrics/sensors/AuthenticationClient;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->getSensorId()I
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->getTargetUserId()I
    ...
    const-string v1, "Unable to notify listener"
    ...
    :cond_2
    const-string p1, "Client not listening"
