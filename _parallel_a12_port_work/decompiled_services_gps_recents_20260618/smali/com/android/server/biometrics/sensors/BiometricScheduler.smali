...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;)V
    .locals 8
    ...
    iput-boolean p1, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mCancel:Z
...
.method public cancelAuthenticationOrDetection(Landroid/os/IBinder;J)V
    ...
    iget-object p3, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mInternalCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;

    invoke-virtual {p1, p2, p3}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->cancel(Landroid/os/Handler;Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
...
.method public dumpProtoState(Z)[B
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mRecentOperations:Ljava/util/List;
...
.method public recordCrashState()V
    ...
    const-string v3, "Recorded crash state: "
...
.method public scheduleClientMonitor(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->cancel(Landroid/os/Handler;Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)V
...
.method protected startNextOperationIfIdle()V
    ...
    iget-boolean v1, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mCancel:Z

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->isFinished()Z
    ...
    const-string v2, "Not idle, cancelling current operation: "
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->start(Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;)Z
