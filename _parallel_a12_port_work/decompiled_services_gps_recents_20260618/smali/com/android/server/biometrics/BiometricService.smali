...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/BiometricService$Injector;)V
    ...
    new-instance p2, Lcom/android/server/biometrics/BiometricService$4;

    invoke-direct {p2, p0}, Lcom/android/server/biometrics/BiometricService$4;-><init>(Lcom/android/server/biometrics/BiometricService;)V

    const-class v0, Lcom/android/server/biometrics/BiometricService;

    invoke-virtual {v0}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1, p2, v0}, Landroid/app/IActivityManager;->registerUserSwitchObserver(Landroid/app/IUserSwitchObserver;Ljava/lang/String;)V
    :try_end_0
...
.method static synthetic access$1700(Lcom/android/server/biometrics/BiometricService;)Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object p0, p0, Lcom/android/server/biometrics/BiometricService;->mRequestCounter:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private authenticateInternal(Landroid/os/IBinder;JJILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/hardware/biometrics/PromptInfo;Lcom/android/server/biometrics/PreAuthInfo;)V
    ...
    iget-object v1, v0, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;
    ...
    iget-object v3, v0, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;
    ...
    iput-object v1, v0, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;
    ...
    iget-object v5, v0, Lcom/android/server/biometrics/BiometricService;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;

    iget-object v6, v0, Lcom/android/server/biometrics/BiometricService;->mSysuiReceiver:Landroid/hardware/biometrics/IBiometricSysuiReceiver;

    iget-object v7, v0, Lcom/android/server/biometrics/BiometricService;->mKeyStore:Landroid/security/KeyStore;

    iget-object v8, v0, Lcom/android/server/biometrics/BiometricService;->mRandom:Ljava/util/Random;

    iget-object v9, v0, Lcom/android/server/biometrics/BiometricService;->mClientDeathReceiver:Lcom/android/server/biometrics/AuthSession$ClientDeathReceiver;

    iget-object v10, v0, Lcom/android/server/biometrics/BiometricService;->mBiometricSensorReceiver:Landroid/hardware/biometrics/IBiometricSensorReceiver;
...
.method private handleAuthenticate(Landroid/os/IBinder;JJILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/hardware/biometrics/PromptInfo;)V
    ...
    new-instance v12, Lcom/android/server/biometrics/BiometricService$$ExternalSyntheticLambda1;
...
.method private handleAuthenticationSucceeded(I[B)V
    ...
    const-string p1, "handleAuthenticationSucceeded: AuthSession is null"
...
.method private handleAuthenticationTimedOut(IIII)V
    ...
    const-string p1, "handleAuthenticationTimedOut: AuthSession is null"
...
.method private handleCancelAuthentication(J)V
    ...
    const-string p1, "handleCancelAuthentication: AuthSession is null"
    ...
    const-string p1, " (ignoring cancellation)"
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lcom/android/server/biometrics/AuthSession;->onCancelAuthSession(Z)Z
    ...
    iput-object p1, p0, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;
...
.method private handleOnAcquired(III)V
    ...
    const-string/jumbo p2, "onAcquired: AuthSession is null"
...
.method private handleOnDismissed(I[B)V
    ...
    const-string p1, ", AuthSession is null"
...
.method private handleOnError(IIII)V
    ...
    const-string p1, "handleOnError: AuthSession is null"
...
.method private handleOnReadyForAuthentication(I)V
    ...
    const-string v0, "handleOnReadyForAuthentication: AuthSession is null"
...
.method private handleOnSystemEvent(I)V
    ...
    const-string p1, "handleOnSystemEvent: AuthSession is null"
...
.method private isStrongBiometric(I)Z
    ...
    invoke-static {p1, v0}, Lcom/android/server/biometrics/Utils;->isAtLeastStrength(II)Z
