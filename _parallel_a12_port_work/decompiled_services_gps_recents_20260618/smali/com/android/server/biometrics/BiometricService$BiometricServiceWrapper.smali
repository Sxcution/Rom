...
.method public authenticate(Landroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/hardware/biometrics/PromptInfo;)J
    ...
    iput-object p1, v2, Lcom/android/internal/os/SomeArgs;->arg6:Ljava/lang/Object;
    ...
    const-string p2, "Invalid authenticator configuration"
    ...
    const-string p2, "Unable to authenticate, one or more null arguments"
...
.method public canAuthenticate(Ljava/lang/String;III)I
    ...
    invoke-static {p3, p1, p2, p4}, Lcom/android/server/biometrics/BiometricService;->access$1800(Lcom/android/server/biometrics/BiometricService;Ljava/lang/String;II)Lcom/android/server/biometrics/PreAuthInfo;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/biometrics/PreAuthInfo;->getCanAuthenticateResult()I
...
.method public createTestSession(ILandroid/hardware/biometrics/ITestSessionCallback;Ljava/lang/String;)Landroid/hardware/biometrics/ITestSession;
    ...
    iget-object p1, v1, Lcom/android/server/biometrics/BiometricSensor;->impl:Landroid/hardware/biometrics/IBiometricAuthenticator;

    invoke-interface {p1, p2, p3}, Landroid/hardware/biometrics/IBiometricAuthenticator;->createTestSession(Landroid/hardware/biometrics/ITestSessionCallback;Ljava/lang/String;)Landroid/hardware/biometrics/ITestSession;
    ...
    const-string p3, "Unknown sensor for createTestSession: "
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/android/server/biometrics/BiometricService;->mCurrentAuthSession:Lcom/android/server/biometrics/AuthSession;
    ...
    check-cast p3, Lcom/android/server/biometrics/BiometricSensor;

    iget-object p3, p3, Lcom/android/server/biometrics/BiometricSensor;->impl:Landroid/hardware/biometrics/IBiometricAuthenticator;

    invoke-interface {p3, v0}, Landroid/hardware/biometrics/IBiometricAuthenticator;->dumpSensorServiceStateProto(Z)[B

    move-result-object p3

    const-wide v4, 0x20b00000001L

    invoke-virtual {p2, v4, v5, p3}, Landroid/util/proto/ProtoOutputStream;->write(J[B)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/biometrics/BiometricService;->access$2000(Lcom/android/server/biometrics/BiometricService;Ljava/io/PrintWriter;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getCurrentModality(Ljava/lang/String;III)I
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/PreAuthInfo;->getPreAuthenticateStatus()Landroid/util/Pair;
...
.method public getSensorProperties(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v2, p1}, Landroid/hardware/biometrics/IBiometricAuthenticator;->getSensorProperties(Ljava/lang/String;)Landroid/hardware/biometrics/SensorPropertiesInternal;

    move-result-object v2

    invoke-static {v2}, Landroid/hardware/biometrics/SensorPropertiesInternal;->from(Landroid/hardware/biometrics/SensorPropertiesInternal;)Landroid/hardware/biometrics/SensorPropertiesInternal;
...
.method public getSupportedModalities(I)I
    ...
    invoke-static {v3, p1}, Lcom/android/server/biometrics/Utils;->isAtLeastStrength(II)Z
    ...
    const-string v0, "Invalid authenticator configuration"
...
.method public hasEnrolledBiometrics(ILjava/lang/String;)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/hardware/biometrics/IBiometricAuthenticator;->hasEnrolledTemplates(ILjava/lang/String;)Z
...
.method public resetLockoutTimeBound(Landroid/os/IBinder;Ljava/lang/String;II[B)V
    ...
    const-string p2, " is does not meet the required strength to request resetLockout"
    ...
    :goto_1
    iget-boolean v3, v3, Landroid/hardware/biometrics/SensorPropertiesInternal;->resetLockoutRequiresHardwareAuthToken:Z
