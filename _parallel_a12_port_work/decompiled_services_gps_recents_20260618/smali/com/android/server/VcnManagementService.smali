...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/VcnManagementService$Dependencies;)V
    ...
    check-cast p2, Lcom/android/server/VcnManagementService$Dependencies;
    ...
    invoke-direct {v3, p0, v1}, Lcom/android/server/VcnManagementService$VcnSubscriptionTrackerCallback;-><init>(Lcom/android/server/VcnManagementService;Lcom/android/server/VcnManagementService$1;)V
    ...
    const-string v0, "/data/system/vcn/configs.xml"
    ...
    new-instance p2, Lcom/android/server/VcnManagementService$1;

    invoke-direct {p2, p0}, Lcom/android/server/VcnManagementService$1;-><init>(Lcom/android/server/VcnManagementService;)V

    iput-object p2, p0, Lcom/android/server/VcnManagementService;->mPkgChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method private enforceCallingUserAndCarrierPrivilege(Landroid/os/ParcelUuid;Ljava/lang/String;)V
    ...
    const-string p2, "Carrier privilege required for subscription group to set VCN Config"
...
.method private enforceManageTestNetworksForTestMode(Landroid/net/vcn/VcnConfig;)V
    ...
    const-string v1, "Test-mode require the MANAGE_TEST_NETWORKS permission"
...
.method private enforcePrimaryUser()V
    ...
    const-string v1, "VcnManagementService can only be used by callers running as the primary user"
    ...
    const-string v1, "Calling identity was System Server. Was Binder calling identity cleared?"
...
.method private getSubGroupForNetworkCapabilities(Landroid/net/NetworkCapabilities;)Landroid/os/ParcelUuid;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/VcnManagementService;->logWtf(Ljava/lang/String;)V
...
.method private isCallbackPermissioned(Lcom/android/server/VcnManagementService$VcnStatusCallbackInfo;Landroid/os/ParcelUuid;)Z
    ...
    invoke-virtual {v0, p2, p1}, Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;->packageHasPermissionsForSubscriptionGroup(Landroid/os/ParcelUuid;Ljava/lang/String;)Z
...
.method private writeConfigsToDiskLocked()V
    ...
    const-string v2, "Failed to save configs"
...
.method public clearVcnConfig(Landroid/os/ParcelUuid;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, p1}, Lcom/android/server/VcnManagementService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/VcnManagementService;Landroid/os/ParcelUuid;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    new-instance p3, Lcom/android/server/VcnManagementService$$ExternalSyntheticLambda13;

    invoke-direct {p3, p0, p1}, Lcom/android/server/VcnManagementService$$ExternalSyntheticLambda13;-><init>(Lcom/android/server/VcnManagementService;Lcom/android/internal/util/IndentingPrintWriter;)V

    sget-wide v0, Lcom/android/server/VcnManagementService;->DUMP_TIMEOUT_MILLIS:J

    invoke-virtual {p2, p3, v0, v1}, Landroid/os/Handler;->runWithScissors(Ljava/lang/Runnable;J)Z
...
.method public getUnderlyingNetworkPolicy(Landroid/net/NetworkCapabilities;Landroid/net/LinkProperties;)Landroid/net/vcn/VcnUnderlyingNetworkPolicy;
    ...
    const-string p2, "NetworkCapabilities must be for Test Network if using permission MANAGE_TEST_NETWORKS"
...
.method public synthetic lambda$getUnderlyingNetworkPolicy$8$VcnManagementService(Landroid/net/NetworkCapabilities;Landroid/net/LinkProperties;)Landroid/net/vcn/VcnUnderlyingNetworkPolicy;
    ...
    invoke-static {v2, v0}, Lcom/android/server/VcnManagementService$TrackingNetworkCallback;->access$2100(Lcom/android/server/VcnManagementService$TrackingNetworkCallback;Landroid/net/NetworkCapabilities;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/VcnManagementService;->logVdbg(Ljava/lang/String;)V
...
.method public synthetic lambda$new$0$VcnManagementService()V
    ...
    invoke-interface {v0, v2}, Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionTrackerCallback;->onNewSnapshot(Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/server/VcnManagementService;->logWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic lambda$notifyAllPermissionedStatusCallbacksLocked$3$VcnManagementService(Lcom/android/server/VcnManagementService$VcnStatusCallbackInfo;I)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/VcnManagementService;->logDbg(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic lambda$notifyAllPolicyListenersLocked$2$VcnManagementService(Lcom/android/server/VcnManagementService$PolicyListenerBinderDeath;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/VcnManagementService;->logDbg(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public registerVcnStatusCallback(Landroid/os/ParcelUuid;Landroid/net/vcn/IVcnStatusCallback;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v10, p1}, Lcom/android/server/VcnManagementService;->isCallbackPermissioned(Lcom/android/server/VcnManagementService$VcnStatusCallbackInfo;Landroid/os/ParcelUuid;)Z
    ...
    const-string p2, "Attempting to register a callback that is already in use"
...
.method public setVcnConfig(Landroid/os/ParcelUuid;Landroid/net/vcn/VcnConfig;Ljava/lang/String;)V
    ...
    new-instance p3, Lcom/android/server/VcnManagementService$$ExternalSyntheticLambda3;

    invoke-direct {p3, p0, p1, p2}, Lcom/android/server/VcnManagementService$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/VcnManagementService;Landroid/os/ParcelUuid;Landroid/net/vcn/VcnConfig;)V
    ...
    const-string p2, "Mismatched caller and VcnConfig creator"
...
.method public unregisterVcnStatusCallback(Landroid/net/vcn/IVcnStatusCallback;)V
    ...
    :try_start_1
    iget-object v3, p0, Lcom/android/server/VcnManagementService;->mRegisteredStatusCallbacks:Ljava/util/Map;

    invoke-interface {v3, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/android/server/VcnManagementService$VcnStatusCallbackInfo;
