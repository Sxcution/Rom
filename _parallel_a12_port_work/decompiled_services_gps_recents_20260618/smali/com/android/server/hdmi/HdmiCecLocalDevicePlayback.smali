...
.method constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    check-cast p1, Landroid/sysprop/HdmiProperties$playback_device_action_on_routing_control_values;

    iput-object p1, p0, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->mPlaybackDeviceActionOnRoutingControl:Landroid/sysprop/HdmiProperties$playback_device_action_on_routing_control_values;
...
.method protected handleSetMenuLanguage(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    const-string v2, "Can\'t handle <Set Menu Language> of "
    ...
    const-string v2, "Can\'t handle <Set Menu Language>"
...
.method protected onAddressAllocated(II)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->buildAndSendSetOsdName(I)V
...
.method protected onInitializeCecComplete(I)V
    ...
    new-instance p1, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback$2;

    invoke-direct {p1, p0}, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback$2;-><init>(Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;)V

    invoke-virtual {p0, p1}, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->oneTouchPlay(Landroid/hardware/hdmi/IHdmiControlCallback;)V
...
.method protected onStandby(ZI)V
    ...
    iget v0, p0, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->mAddress:I

    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildStandby(II)Lcom/android/server/hdmi/HdmiCecMessage;
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/hdmi/HdmiCecConfig;->getStringValue(Ljava/lang/String;)Ljava/lang/String;
