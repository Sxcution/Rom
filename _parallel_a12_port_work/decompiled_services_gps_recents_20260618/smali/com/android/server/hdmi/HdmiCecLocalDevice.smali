...
.method protected constructor <init>(Lcom/android/server/hdmi/HdmiControlService;I)V
    ...
    iput p2, p0, Lcom/android/server/hdmi/HdmiCecLocalDevice;->mAddress:I
...
.method private dispatchMessageToAction(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/hdmi/HdmiCecFeatureAction;->processCommand(Lcom/android/server/hdmi/HdmiCecMessage;)Z
...
.method protected disableDevice(ZLcom/android/server/hdmi/HdmiCecLocalDevice$PendingActionClearedCallback;)V
    ...
    new-instance p1, Lcom/android/server/hdmi/HdmiCecLocalDevice$3;

    invoke-direct {p1, p0, p2}, Lcom/android/server/hdmi/HdmiCecLocalDevice$3;-><init>(Lcom/android/server/hdmi/HdmiCecLocalDevice;Lcom/android/server/hdmi/HdmiCecLocalDevice$PendingActionClearedCallback;)V
    ...
    iget-object p1, p0, Lcom/android/server/hdmi/HdmiCecLocalDevice;->mHandler:Landroid/os/Handler;
...
.method protected dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v1, "mActiveRoutingPath: 0x%04x"
...
.method protected handleGiveDevicePowerStatus(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    invoke-virtual {v2}, Lcom/android/server/hdmi/HdmiControlService;->getPowerStatus()I

    move-result v2

    invoke-static {v1, p1, v2}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildReportPowerStatus(III)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method protected handleGiveDeviceVendorId(Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)I
    ...
    invoke-virtual {v1, v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->sendCecCommand(Lcom/android/server/hdmi/HdmiCecMessage;Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)V
...
.method protected handleVendorCommandWithId(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    const-string p1, "Wrong direct vendor command. Replying with <Feature Abort>"
...
.method protected reportFeatures()V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildReportFeatures(IILjava/util/List;ILjava/util/List;Ljava/util/List;)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method protected sendKeyEvent(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/hdmi/SendKeyAction;->processKeyEvent(IZ)V
    ...
    const-string v3, "Discard key event: "
...
.method sendUserControlPressedAndReleased(II)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildUserControlReleased(II)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method protected sendVolumeKeyEvent(IZ)V
    ...
    const-string v0, "Not a volume key: "
    ...
    const-string v3, "Discard volume key event: "
...
.method setActivePath(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->setActivePortId(I)V
...
.method setActiveSource(IILjava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/hdmi/HdmiControlService;->setLastInputForMhl(I)V
