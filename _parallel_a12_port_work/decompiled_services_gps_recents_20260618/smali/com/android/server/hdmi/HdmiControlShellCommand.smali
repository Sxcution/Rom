...
.method private cecSetting(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v3, v0, v1}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->setCecSettingStringValue(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0, v1}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->setCecSettingIntValue(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v0}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->getCecSettingIntValue(Ljava/lang/String;)I
    ...
    const-string v0, "Expected at least 1 argument (operation)."
...
.method private getResultString(I)Ljava/lang/String;
    ...
    :pswitch_2
    const-string p1, "Incorrect mode"
    ...
    :pswitch_4
    const-string p1, "Target not available"

    return-object p1

    :pswitch_5
    const-string p1, "Source not available"
...
.method private oneTouchPlay(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/hdmi/HdmiControlShellCommand;->receiveCallback(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/hdmi/HdmiControlShellCommand;->mCecResult:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private setArcMode(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v2}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->setArcMode(Z)V
    ...
    invoke-virtual {p1, v4}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->setArcMode(Z)V
...
.method private vendorCommand(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v5, v6, v2, v7}, Landroid/hardware/hdmi/IHdmiControlService$Stub;->sendVendorCommand(II[BZ)V
    ...
    const-string v0, "Expected 3 arguments."
...
.method public onCommand(Ljava/lang/String;)I
    ...
    const-string v1, "HdmiShellCommand"
