...
.method private announceHotplugEvent(IZ)V
    ...
    invoke-static {v1}, Lcom/android/server/hdmi/HdmiControlService$HotplugEventListenerRecord;->access$6000(Lcom/android/server/hdmi/HdmiControlService$HotplugEventListenerRecord;)Landroid/hardware/hdmi/IHdmiHotplugEventListener;
...
.method private invokeHdmiControlStatusChangeListenerLocked(Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/hdmi/HdmiControlService;->invokeHdmiControlStatusChangeListenerLocked(Ljava/util/Collection;I)V
...
.method private invokeHdmiControlStatusChangeListenerLocked(Ljava/util/Collection;IZ)V
    ...
    :try_start_0
    invoke-interface {v0, p2, p3}, Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;->onStatusChange(IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to report HdmiControlStatusChange: "
...
.method private onInitializeCecComplete(I)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/hdmi/HdmiControlService;->announceHdmiControlStatusChange(I)V
...
.method private onWakeUp(I)V
    ...
    const-string/jumbo v1, "wakeUpAction "
    ...
    :cond_1
    const-string p1, "Device does not support HDMI-CEC."
...
.method private removeCecSettingChangeListener(Ljava/lang/String;Landroid/hardware/hdmi/IHdmiCecSettingChangeListener;)V
    ...
    iget-object v1, p0, Lcom/android/server/hdmi/HdmiControlService;->mSettingChangeListener:Lcom/android/server/hdmi/HdmiCecConfig$SettingChangeListener;

    invoke-virtual {p2, p1, v1}, Lcom/android/server/hdmi/HdmiCecConfig;->removeChangeListener(Ljava/lang/String;Lcom/android/server/hdmi/HdmiCecConfig$SettingChangeListener;)V
...
.method private removeHdmiControlStatusChangeListener(Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;)V
    ...
    iget-object p1, p0, Lcom/android/server/hdmi/HdmiControlService;->mHdmiControlStatusChangeListenerRecords:Ljava/util/ArrayList;
...
.method changeInputForMhl(IZ)V
    ...
    new-instance v1, Lcom/android/server/hdmi/HdmiControlService$14;

    invoke-direct {v1, p0, p2}, Lcom/android/server/hdmi/HdmiControlService$14;-><init>(Lcom/android/server/hdmi/HdmiControlService;I)V
...
.method protected getActiveSource()Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-virtual {v2}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->getActivePortId()I

    move-result v2

    invoke-direct {v1, v0, v2}, Landroid/hardware/hdmi/HdmiDeviceInfo;-><init>(II)V
...
.method protected handleCecCommand(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    iget-object v2, p0, Lcom/android/server/hdmi/HdmiControlService;->mCecMessageBuffer:Lcom/android/server/hdmi/CecMessageBuffer;

    invoke-virtual {v2, p1}, Lcom/android/server/hdmi/CecMessageBuffer;->bufferMessage(Lcom/android/server/hdmi/HdmiCecMessage;)Z
...
.method protected oneTouchPlay(Landroid/hardware/hdmi/IHdmiControlCallback;)V
    ...
    const-string p1, "Local device is under address allocation. Save OTP callback for later process."
...
.method protected queryDisplayStatus(Landroid/hardware/hdmi/IHdmiControlCallback;)V
    ...
    const-string p1, "Local device is under address allocation. Queue display callback for later process."
...
.method protected readDeviceTypes()Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/hdmi/HdmiControlService$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/hdmi/HdmiControlService$$ExternalSyntheticLambda4;

    invoke-interface {v0, v1}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v0

    sget-object v1, Lcom/android/server/hdmi/HdmiControlService$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/hdmi/HdmiControlService$$ExternalSyntheticLambda5;
    ...
    const-string v3, "Error parsing ro.hdmi.device_type: "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v3, "ro.hdmi.device_type"
...
.method protected setAndBroadcastActiveSource(IIILjava/lang/String;)V
    ...
    invoke-virtual {p2}, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;->getDeviceInfo()Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-virtual {p2, v0, p1, p4}, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;->setActiveSource(IILjava/lang/String;)V
...
.method protected setAndBroadcastActiveSourceFromOneDeviceType(IILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3}, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->setActiveSource(IILjava/lang/String;)V
    ...
    invoke-virtual {v1, v0, p2, p3}, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;->setActiveSource(IILjava/lang/String;)V
...
.method setStandbyMode(Z)V
    ...
    new-instance p1, Lcom/android/server/hdmi/HdmiControlService$11;

    invoke-direct {p1, p0}, Lcom/android/server/hdmi/HdmiControlService$11;-><init>(Lcom/android/server/hdmi/HdmiControlService;)V
