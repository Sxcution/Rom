...
.method private computeInjectionAction(II)I
    ...
    :sswitch_0
    iget-object p1, p0, Lcom/android/server/accessibility/gestures/EventDispatcher;->mState:Lcom/android/server/accessibility/gestures/TouchState;

    invoke-virtual {p1}, Lcom/android/server/accessibility/gestures/TouchState;->getInjectedPointerDownCount()I
...
.method private computeInjectionDownEvent(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    ...
    iput v8, v4, Landroid/view/MotionEvent$PointerCoords;->y:F
...
.method public clickWithTouchEvents(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {v0, v3}, Lcom/android/server/accessibility/gestures/EventDispatcher;->computeClickLocation(Landroid/graphics/Point;)I
    ...
    invoke-direct {v0, v1, v2, v3, v5}, Lcom/android/server/accessibility/gestures/EventDispatcher;->sendActionDownAndUp(Landroid/view/MotionEvent;Landroid/view/MotionEvent;IZ)V
...
.method public longPressWithTouchEvents(Landroid/view/MotionEvent;I)Z
    ...
    iput v1, p0, Lcom/android/server/accessibility/gestures/EventDispatcher;->mLongPressingPointerDeltaX:I
...
.method sendAccessibilityEvent(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/accessibility/gestures/TouchState;->onInjectedAccessibilityEvent(I)V
...
.method sendDownForAllNotInjectedPointers(Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/accessibility/gestures/EventDispatcher;->computeInjectionAction(II)I
...
.method sendDownForAllNotInjectedPointersWithOriginalDown(Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, v8, v9}, Lcom/android/server/accessibility/gestures/EventDispatcher;->computeInjectionAction(II)I
...
.method sendMotionEvent(Landroid/view/MotionEvent;ILandroid/view/MotionEvent;II)V
    ...
    invoke-direct {p0, p4, p2, v1}, Lcom/android/server/accessibility/gestures/EventDispatcher;->offsetEvent(Landroid/view/MotionEvent;II)Landroid/view/MotionEvent;
    ...
    invoke-virtual {p2, p4}, Lcom/android/server/accessibility/gestures/TouchState;->onInjectedMotionEvent(Landroid/view/MotionEvent;)V
