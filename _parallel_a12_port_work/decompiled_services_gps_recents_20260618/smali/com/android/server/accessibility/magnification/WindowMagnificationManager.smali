...
.method disableWindowMagnification(IZLandroid/view/accessibility/MagnificationAnimationCallback;)V
    ...
    invoke-interface {p2, p1, p3}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$Callback;->onWindowMagnificationActivationState(IZ)V
...
.method getCenterX(I)F
    ...
    check-cast p1, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->getCenterX()F
...
.method getCenterY(I)F
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->getCenterY()F
...
.method public getScale(I)F
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->getScale()F
...
.method public isWindowMagnifierEnabled(I)Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->isEnabled()Z
...
.method moveWindowMagnification(IFF)V
    ...
    :cond_0
    invoke-virtual {p1, p2, p3}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->move(FF)V
...
.method persistScale(I)V
    ...
    new-instance v1, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0, p1}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/accessibility/magnification/WindowMagnificationManager;F)V
...
.method pointersInWindow(ILandroid/view/MotionEvent;)I
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->pointersInWindow(Landroid/view/MotionEvent;)I
...
.method public setConnection(Landroid/view/accessibility/IWindowMagnificationConnection;)V
    ...
    invoke-direct {p1, p0, v2}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$ConnectionCallback;-><init>(Lcom/android/server/accessibility/magnification/WindowMagnificationManager;Lcom/android/server/accessibility/magnification/WindowMagnificationManager$1;)V
...
.method public setScale(IF)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lcom/android/server/accessibility/magnification/WindowMagnificationManager$WindowMagnifier;->setScale(F)V
