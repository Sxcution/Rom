...
.method private blockingGetNtpTimeAndInject()V
    ...
    iget-object v0, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mNtpTime:Landroid/util/NtpTrustedTime;
    ...
    :try_start_0
    iput v13, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mInjectNtpTimeState:I

    iget-object v1, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mNtpTime:Landroid/util/NtpTrustedTime;
    ...
    :cond_2
    iget-object v11, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mHandler:Landroid/os/Handler;

    new-instance v12, Lcom/android/server/location/gnss/NtpTimeHelper$$ExternalSyntheticLambda2;

    move-object v1, v12

    move-object/from16 v2, p0

    invoke-direct/range {v1 .. v8}, Lcom/android/server/location/gnss/NtpTimeHelper$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/location/gnss/NtpTimeHelper;JJJ)V

    invoke-virtual {v11, v12}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    nop

    iget-object v1, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mNtpBackOff:Lcom/android/server/location/gnss/ExponentialBackOff;
    ...
    iget-boolean v5, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mOnDemandTimeInjection:Z
    ...
    :cond_4
    iget-boolean v1, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mOnDemandTimeInjection:Z
    ...
    :cond_5
    iget-object v0, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/location/gnss/NtpTimeHelper$$ExternalSyntheticLambda0;

    invoke-direct {v1, v9}, Lcom/android/server/location/gnss/NtpTimeHelper$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/location/gnss/NtpTimeHelper;)V
    ...
    iget-object v0, v9, Lcom/android/server/location/gnss/NtpTimeHelper;->mWakeLock:Landroid/os/PowerManager$WakeLock;
