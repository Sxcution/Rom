...
.method private adjustDeliveryTimeBasedOnBatterySaver(Lcom/android/server/alarm/Alarm;)Z
    ...
    invoke-virtual {v7, v0, v2, v4}, Lcom/android/server/alarm/AlarmManagerService$AppWakeupHistory;->getNthLastWakeupForPackage(Ljava/lang/String;II)J
...
.method private adjustDeliveryTimeBasedOnBucketLocked(Lcom/android/server/alarm/Alarm;)Z
    ...
    iget-wide v8, v2, Lcom/android/server/alarm/AlarmManagerService$Constants;->APP_STANDBY_RESTRICTED_WINDOW:J
    ...
    iget-wide v0, v0, Lcom/android/server/alarm/AlarmManagerService$Constants;->APP_STANDBY_RESTRICTED_WINDOW:J
    ...
    iget-wide v4, v2, Lcom/android/server/alarm/AlarmManagerService$Constants;->APP_STANDBY_WINDOW:J
...
.method private convertToElapsed(JI)J
    ...
    invoke-virtual {p3}, Lcom/android/server/alarm/AlarmManagerService$Injector;->getElapsedRealtime()J
...
.method private final getStatsLocked(ILjava/lang/String;)Lcom/android/server/alarm/AlarmManagerService$BroadcastStats;
    ...
    new-instance v1, Lcom/android/server/alarm/AlarmManagerService$BroadcastStats;

    invoke-direct {v1, p1, p2}, Lcom/android/server/alarm/AlarmManagerService$BroadcastStats;-><init>(ILjava/lang/String;)V
...
.method private final getStatsLocked(Landroid/app/PendingIntent;)Lcom/android/server/alarm/AlarmManagerService$BroadcastStats;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/alarm/AlarmManagerService;->getStatsLocked(ILjava/lang/String;)Lcom/android/server/alarm/AlarmManagerService$BroadcastStats;
...
.method private incrementAlarmCount(I)V
    ...
    iget-object p1, p0, Lcom/android/server/alarm/AlarmManagerService;->mAlarmsPerUid:Landroid/util/SparseIntArray;
...
.method private isBackgroundRestricted(Lcom/android/server/alarm/Alarm;)Z
    ...
    invoke-virtual {v2, p1, v0}, Lcom/android/server/AppStateTrackerImpl;->areAlarmsRestricted(ILjava/lang/String;)Z
...
.method private removeAlarmsInternalLocked(Ljava/util/function/Predicate;I)V
    ...
    iget-object v3, v5, Lcom/android/server/alarm/Alarm;->listener:Landroid/app/IAlarmListener;
    ...
    invoke-interface {v3, v6, v4}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    iget v4, v5, Lcom/android/server/alarm/Alarm;->uid:I
    ...
    invoke-direct {v3, v4, v6}, Lcom/android/internal/util/RingBuffer;-><init>(Ljava/lang/Class;I)V
    ...
    invoke-direct {v2, v0}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/alarm/AlarmManagerService;)V
    ...
    invoke-direct {v2, v0}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/alarm/AlarmManagerService;)V
...
.method private setImplLocked(IJJJJLandroid/app/PendingIntent;Landroid/app/IAlarmListener;Ljava/lang/String;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;ILjava/lang/String;Landroid/os/Bundle;I)V
    ...
    invoke-direct {v0, v3}, Lcom/android/server/alarm/AlarmManagerService;->incrementAlarmCount(I)V
...
.method private setLocked(IJ)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method private updateNextAlarmClockLocked()V
    ...
    invoke-direct {p0, v4, v3}, Lcom/android/server/alarm/AlarmManagerService;->updateNextAlarmInfoForUserLocked(ILandroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/alarm/AlarmManagerService;->updateNextAlarmInfoForUserLocked(ILandroid/app/AlarmManager$AlarmClockInfo;)V
...
.method private updateNextAlarmInfoForUserLocked(ILandroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;->removeMessages(I)V

    iget-object p1, p0, Lcom/android/server/alarm/AlarmManagerService;->mHandler:Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;

    invoke-virtual {p1, p2}, Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;->sendEmptyMessage(I)Z
...
.method calculateDeliveryPriorities(Ljava/util/ArrayList;)V
    ...
    iget v3, p0, Lcom/android/server/alarm/AlarmManagerService;->mCurrentSeq:I

    iput v3, v5, Lcom/android/server/alarm/AlarmManagerService$PriorityClass;->seq:I
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/alarm/AlarmManagerService;->decrementAlarmCount(II)V
...
.method dumpImpl(Landroid/util/IndentingPrintWriter;)V
    ...
    const-string v11, "mLastTimeChangeClockTime="
    ...
    const-string v11, "mLastTimeChangeRealtime="
    ...
    const-string v11, "mLastTickReceived="
...
.method getMinimumAllowedWindow(JJ)J
    ...
    iget-object p3, p0, Lcom/android/server/alarm/AlarmManagerService;->mConstants:Lcom/android/server/alarm/AlarmManagerService$Constants;

    iget-wide p3, p3, Lcom/android/server/alarm/AlarmManagerService$Constants;->MIN_WINDOW:J
...
.method getQuotaForBucketLocked(I)I
    ...
    iget-object v0, v0, Lcom/android/server/alarm/AlarmManagerService$Constants;->APP_STANDBY_QUOTAS:[I
...
.method handleChangesToExactAlarmDenyList(Landroid/util/ArraySet;Z)V
    ...
    invoke-virtual {v7, v3, v1, v6}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    :try_start_1
    invoke-virtual {p0, v7, v3}, Lcom/android/server/alarm/AlarmManagerService;->removeExactAlarmsOnPermissionRevokedLocked(ILjava/lang/String;)V
    ...
    :cond_4
    invoke-direct {p0, v3, v6}, Lcom/android/server/alarm/AlarmManagerService;->sendScheduleExactAlarmPermissionStateChangedBroadcast(Ljava/lang/String;I)V
...
.method hasScheduleExactAlarmInternal(Ljava/lang/String;I)Z
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, Lcom/android/server/alarm/AlarmManagerService;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;

    invoke-virtual {p1, v3, v0, v1}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
...
.method interactiveStateChangedLocked(Z)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/alarm/AlarmManagerService;)V

    invoke-virtual {p1, v0}, Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;->post(Ljava/lang/Runnable;)Z
...
.method isExemptFromExactAlarmPermission(I)Z
    ...
    invoke-interface {v0, p1}, Lcom/android/server/DeviceIdleInternal;->isAppOnWhitelist(I)Z
...
.method public synthetic lambda$refreshExactAlarmCandidates$5$AlarmManagerService(ILcom/android/server/alarm/Alarm;)Z
    ...
    :cond_0
    iget-object p1, p2, Lcom/android/server/alarm/Alarm;->packageName:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lcom/android/server/alarm/AlarmManagerService;->isExactAlarmChangeEnabled(Ljava/lang/String;I)Z
    ...
    :cond_1
    iget p1, p2, Lcom/android/server/alarm/Alarm;->uid:I
...
.method public synthetic lambda$removeForStoppedLocked$17$AlarmManagerService(ILcom/android/server/alarm/Alarm;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/app/ActivityManagerInternal;->isAppStartModeDisabled(ILjava/lang/String;)Z
...
.method public onBootPhase(I)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/alarm/AlarmManagerService$AppStandbyTracker;-><init>(Lcom/android/server/alarm/AlarmManagerService;Lcom/android/server/alarm/AlarmManagerService$1;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda22;-><init>(Lcom/android/server/alarm/AlarmManagerService;)V
...
.method public onStart()V
    ...
    iput-object v1, p0, Lcom/android/server/alarm/AlarmManagerService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/alarm/AlarmManagerService$Injector;->getSystemUiUid(Landroid/content/pm/PackageManagerInternal;)I

    move-result v1

    iput v1, p0, Lcom/android/server/alarm/AlarmManagerService;->mSystemUiUid:I
    ...
    invoke-virtual {v1}, Lcom/android/server/alarm/AlarmManagerService$Injector;->getAlarmWakeLock()Landroid/os/PowerManager$WakeLock;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/alarm/AlarmManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v1, p0, Lcom/android/server/alarm/AlarmManagerService;->mTimeTickIntent:Landroid/content/Intent;
    ...
    iput-object v1, p0, Lcom/android/server/alarm/AlarmManagerService;->mTimeTickTrigger:Landroid/app/IAlarmListener;
    ...
    invoke-virtual {v1}, Lcom/android/server/alarm/AlarmManagerService$AlarmThread;->start()V
...
.method public onUserStarting(Lcom/android/server/SystemService$TargetUser;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda12;-><init>(Lcom/android/server/alarm/AlarmManagerService;I)V
...
.method reevaluateRtcAlarms()V
    ...
    new-instance v3, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda2;

    invoke-direct {v3, p0}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/alarm/AlarmManagerService;)V
...
.method refreshExactAlarmCandidates()V
    ...
    const-string v7, " lost SCHEDULE_EXACT_ALARM on update"
    ...
    new-instance v5, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda19;

    invoke-direct {v5, p0, v2}, Lcom/android/server/alarm/AlarmManagerService$$ExternalSyntheticLambda19;-><init>(Lcom/android/server/alarm/AlarmManagerService;I)V

    const/4 v2, 0x2

    invoke-direct {p0, v5, v2}, Lcom/android/server/alarm/AlarmManagerService;->removeAlarmsInternalLocked(Ljava/util/function/Predicate;I)V
...
.method removeExactAlarmsOnPermissionRevokedLocked(ILjava/lang/String;)V
    ...
    iget-boolean p2, p2, Lcom/android/server/alarm/AlarmManagerService$Constants;->KILL_ON_SCHEDULE_EXACT_ALARM_REVOKED:Z
    ...
    const-string/jumbo v0, "schedule_exact_alarm revoked"

    invoke-static {p2, p1, v0}, Lcom/android/server/pm/permission/PermissionManagerService;->killUid(IILjava/lang/String;)V
...
.method removeForStoppedLocked(I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/alarm/AlarmManagerService;->removeAlarmsInternalLocked(Ljava/util/function/Predicate;I)V
...
.method removeUserLocked(I)V
    ...
    const-string v0, "Ignoring attempt to remove system-user state!"
...
.method reorderAlarmsBasedOnStandbyBuckets(Landroid/util/ArraySet;)Z
    ...
    iget-object v2, p0, Lcom/android/server/alarm/AlarmManagerService;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;
...
.method rescheduleKernelAlarmsLocked()V
    ...
    invoke-direct {p0, v2, v5, v6}, Lcom/android/server/alarm/AlarmManagerService;->setLocked(IJ)V
    ...
    invoke-direct {p0, v0, v7, v8}, Lcom/android/server/alarm/AlarmManagerService;->setLocked(IJ)V
...
.method sendPendingBackgroundAlarmsLocked(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/alarm/AlarmManagerService;->deliverPendingBackgroundAlarmsLocked(Ljava/util/ArrayList;J)V
...
.method setImpl(IJJJLandroid/app/PendingIntent;Landroid/app/IAlarmListener;Ljava/lang/String;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;ILjava/lang/String;Landroid/os/Bundle;I)V
    ...
    iget-wide v9, v9, Lcom/android/server/alarm/AlarmManagerService$Constants;->MIN_INTERVAL:J
    ...
    iget-wide v9, v1, Lcom/android/server/alarm/AlarmManagerService$Constants;->MAX_INTERVAL:J
    ...
    invoke-direct {v0, v3, v4, v2}, Lcom/android/server/alarm/AlarmManagerService;->convertToElapsed(JI)J
