...
.method constructor <init>(Lcom/android/server/alarm/AlarmManagerService;)V
    ...
    const-string/jumbo v0, "standby_quota_working"

    const-string/jumbo v1, "standby_quota_frequent"
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/alarm/AlarmManagerService$Constants;->APP_STANDBY_QUOTAS:[I

    array-length v1, v0

    if-ge p1, v1, :cond_0

    iget-object v1, p0, Lcom/android/server/alarm/AlarmManagerService$Constants;->DEFAULT_APP_STANDBY_QUOTAS:[I
...
.method private migrateAlarmsToNewStoreLocked()V
    ...
    iput-object v0, v1, Lcom/android/server/alarm/AlarmManagerService;->mAlarmStore:Lcom/android/server/alarm/AlarmStore;
    ...
    iget-object v0, v0, Lcom/android/server/alarm/AlarmManagerService;->mAlarmStore:Lcom/android/server/alarm/AlarmStore;

    iget-object v1, p0, Lcom/android/server/alarm/AlarmManagerService$Constants;->this$0:Lcom/android/server/alarm/AlarmManagerService;

    invoke-static {v1}, Lcom/android/server/alarm/AlarmManagerService;->access$100(Lcom/android/server/alarm/AlarmManagerService;)Ljava/lang/Runnable;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/android/server/alarm/AlarmStore;->setAlarmClockRemovalListener(Ljava/lang/Runnable;)V
...
.method private updateExactAlarmDenyList([Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v1}, Lcom/android/server/alarm/AlarmManagerService$AlarmHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public onPropertiesChanged(Landroid/provider/DeviceConfig$Properties;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/server/alarm/AlarmManagerService$Constants;->updateExactAlarmDenyList([Ljava/lang/String;)V
