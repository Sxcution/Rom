...
.method private checkAllCompatOverridesAreOverridable(Ljava/util/Collection;)V
    ...
    const-string v0, "Only change ids marked as Overridable can be overridden."
...
.method private killPackage(Ljava/lang/String;)V
    ...
    const-string v2, "Didn\'t find package "
    ...
    invoke-direct {p0, p1}, Lcom/android/server/compat/PlatformCompat;->killUid(I)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/compat/CompatConfig;->dumpConfig(Ljava/io/PrintWriter;)V
...
.method public isChangeEnabledByPackageName(JLjava/lang/String;I)Z
    ...
    iget-object p4, p0, Lcom/android/server/compat/PlatformCompat;->mCompatConfig:Lcom/android/server/compat/CompatConfig;

    invoke-virtual {p4, p1, p2, p3}, Lcom/android/server/compat/CompatConfig;->willChangeBeEnabled(JLjava/lang/String;)Z
...
.method public isChangeEnabledByUid(JI)Z
    ...
    :cond_2
    :goto_1
    iget-object p3, p0, Lcom/android/server/compat/PlatformCompat;->mCompatConfig:Lcom/android/server/compat/CompatConfig;

    invoke-virtual {p3, p1, p2}, Lcom/android/server/compat/CompatConfig;->defaultChangeIdValue(J)Z
...
.method public isChangeEnabledInternal(JLandroid/content/pm/ApplicationInfo;)Z
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3, v1}, Lcom/android/server/compat/PlatformCompat;->reportChangeInternal(JII)V
...
.method public reportChangeByPackageName(JLjava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/compat/PlatformCompat;->reportChangeInternal(JII)V
...
.method public resetReporting(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/compat/ChangeReporter;->resetReportedChanges(I)V
