...
.method private removeOverrideUnsafe(JLjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p3, v0}, Lcom/android/server/compat/CompatConfig;->removeOverrideUnsafe(Lcom/android/server/compat/CompatChange;Ljava/lang/String;Ljava/lang/Long;)Z
...
.method private removeOverrideUnsafe(Lcom/android/server/compat/CompatChange;Ljava/lang/String;Ljava/lang/Long;)Z
    ...
    invoke-virtual {p1, p2, v0, p3}, Lcom/android/server/compat/CompatChange;->removePackageOverride(Ljava/lang/String;Lcom/android/internal/compat/OverrideAllowedState;Ljava/lang/Long;)Z
...
.method declared-synchronized addOverride(JLjava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/compat/CompatConfig;->addOverrideUnsafe(JLjava/lang/String;Landroid/app/compat/PackageOverride;)Z
...
.method declared-synchronized addPackageOverrides(Lcom/android/internal/compat/CompatibilityOverrideConfig;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v2, v3, p2, v1}, Lcom/android/server/compat/CompatConfig;->addOverrideUnsafe(JLjava/lang/String;Landroid/app/compat/PackageOverride;)Z
...
.method defaultChangeIdValue(J)Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/compat/CompatChange;->defaultValue()Z
...
.method getAppConfig(Landroid/content/pm/ApplicationInfo;)Lcom/android/internal/compat/CompatibilityChangeConfig;
    ...
    invoke-direct {p1, v2}, Lcom/android/internal/compat/CompatibilityChangeConfig;-><init>(Landroid/compat/Compatibility$ChangeConfig;)V
...
.method initConfigFromLib(Ljava/io/File;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/compat/CompatConfig;->readConfig(Ljava/io/File;)V
...
.method isChangeEnabled(JLandroid/content/pm/ApplicationInfo;)Z
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/compat/CompatConfig;->mAndroidBuildClassifier:Lcom/android/internal/compat/AndroidBuildClassifier;

    invoke-virtual {p1, p3, p2}, Lcom/android/server/compat/CompatChange;->isEnabled(Landroid/content/pm/ApplicationInfo;Lcom/android/internal/compat/AndroidBuildClassifier;)Z
...
.method isDisabled(J)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/compat/CompatChange;->getDisabled()Z
...
.method isLoggingOnly(J)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/compat/CompatChange;->getLoggingOnly()Z
...
.method isOverridable(J)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/compat/CompatChange;->getOverridable()Z
...
.method public synthetic lambda$registerListener$1$CompatConfig(Ljava/util/concurrent/atomic/AtomicBoolean;JLjava/lang/Long;)Lcom/android/server/compat/CompatChange;
    ...
    new-instance p1, Lcom/android/server/compat/CompatChange;

    invoke-direct {p1, p2, p3}, Lcom/android/server/compat/CompatChange;-><init>(J)V
...
.method maxTargetSdkForChangeIdOptIn(J)I
    ...
    invoke-virtual {p1}, Lcom/android/server/compat/CompatChange;->getEnableSinceTargetSdk()I
...
.method registerListener(JLcom/android/server/compat/CompatChange$ChangeListener;)Z
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/compat/CompatChange;->registerListener(Lcom/android/server/compat/CompatChange$ChangeListener;)V
...
.method declared-synchronized removePackageOverrides(Lcom/android/internal/compat/CompatibilityOverridesToRemoveConfig;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2, p2}, Lcom/android/server/compat/CompatConfig;->removeOverrideUnsafe(JLjava/lang/String;)Z
...
.method saveOverrides()V
    ...
    const-string v4, "Could not create override config file: "
...
.method willChangeBeEnabled(JLjava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p1, p3}, Lcom/android/server/compat/CompatChange;->willBeEnabled(Ljava/lang/String;)Z
