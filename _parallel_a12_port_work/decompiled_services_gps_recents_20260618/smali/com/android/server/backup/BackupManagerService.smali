...
.method private activateBackupForUserLocked(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backup/BackupManagerService;->deleteFile(Ljava/io/File;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backup/BackupManagerService;->createFile(Ljava/io/File;)V
...
.method dumpWithoutCheckingPermission(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string p1, "  transportclients : dump information about transport clients"

    invoke-virtual {p2, p1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string p1, "  transportstats : dump transport statts"
...
.method public excludeKeysFromRestore(Ljava/lang/String;Ljava/util/List;)V
    ...
    const-string p2, "Returning from excludeKeysFromRestore as backup for user"
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/backup/UserBackupManagerService;->excludeKeysFromRestore(Ljava/lang/String;Ljava/util/List;)V
...
.method public getUserService(I)Lcom/android/server/backup/UserBackupManagerService;
    ...
    check-cast p1, Lcom/android/server/backup/UserBackupManagerService;
...
.method public hasBackupPassword()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/backup/UserBackupManagerService;->hasBackupPassword()Z
...
.method public setBackupPassword(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/backup/UserBackupManagerService;->setBackupPassword(Ljava/lang/String;Ljava/lang/String;)Z
