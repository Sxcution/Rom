...
.method private isCrashLoopFound()Z
    ...
    const-string v2, "framework_watchdog.fatal_count"

    aput-object v2, v0, v1

    const-string v2, "framework_watchdog.fatal_window.second"

    aput-object v2, v0, v5

    const-string/jumbo v2, "sysprops \'%s\' and \'%s\' should be set or unset together"
...
.method private readTimeoutHistory()[Ljava/lang/String;
    ...
    :cond_2
    const-string/jumbo v3, "ro.boottime.zygote"
...
.method private run()V
    ...
    iget-object v4, v7, Lcom/android/server/Watchdog;->mLock:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    sget-wide v5, Lcom/android/server/Watchdog;->CHECK_INTERVAL:J

    move v0, v8

    :goto_1
    iget-object v9, v7, Lcom/android/server/Watchdog;->mHandlerCheckers:Ljava/util/ArrayList;
    ...
    iget-object v6, v7, Lcom/android/server/Watchdog;->mInterestingJavaPids:Ljava/util/List;
    ...
    invoke-static {v1, v6}, Lcom/android/internal/util/FrameworkStatsLog;->write(ILjava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v2}, Lcom/android/internal/os/ProcessCpuTracker;->printCurrentState(J)Ljava/lang/String;
    ...
    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/StringBuffer;)Ljava/lang/StringBuilder;

    const/16 v1, 0x77

    invoke-direct {v7, v1}, Lcom/android/server/Watchdog;->doSysRq(C)V

    const/16 v1, 0x6c

    invoke-direct {v7, v1}, Lcom/android/server/Watchdog;->doSysRq(C)V

    new-instance v14, Lcom/android/server/Watchdog$1;
    ...
    :goto_7
    iget-object v1, v7, Lcom/android/server/Watchdog;->mLock:Ljava/lang/Object;
    ...
    invoke-interface {v0, v13}, Landroid/app/IActivityController;->systemNotResponding(Ljava/lang/String;)I
    ...
    const-string v1, "Activity controller requested to coninue to wait"
    ...
    invoke-static {v9}, Lcom/android/server/WatchdogDiagnostics;->diagnoseCheckers(Ljava/util/List;)V
