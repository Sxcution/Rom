...
.method private static queryInputMethod(Landroid/content/Context;ILandroid/content/ComponentName;)Landroid/view/inputmethod/InputMethodInfo;
    ...
    const-string/jumbo p0, "queryInputMethod invoked with null componentName"
    ...
    invoke-virtual {v2, p2, v3, p1}, Landroid/content/pm/PackageManager;->queryIntentServicesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-static {p1}, Lcom/android/server/inputmethod/MultiClientInputMethodManagerService;->resolveMultiClientImeService(Ljava/util/List;)Landroid/content/pm/ResolveInfo;

    move-result-object v2

    invoke-direct {p2, p0, v2}, Landroid/view/inputmethod/InputMethodInfo;-><init>(Landroid/content/Context;Landroid/content/pm/ResolveInfo;)V
    :try_end_0
    ...
    const-string v2, "Unable to load input method from services ("
...
.method static resolveMultiClientImeService(Ljava/util/List;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-static {p0}, Landroid/view/inputmethod/InputMethodInfo;->computeId(Landroid/content/pm/ResolveInfo;)Ljava/lang/String;
    ...
    const-string v0, " must have required"
    ...
    const-string v0, " must be pre-installed when Build.IS_DEBUGGABLE is false"
