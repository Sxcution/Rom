...
.method public debug(Landroid/os/NativeHandle;Ljava/util/ArrayList;)V
    ...
    :try_start_0
    iget-object p2, p0, Landroid/hardware/health/V2_1/IHealth$Proxy;->mRemote:Landroid/os/IHwBinder;
...
.method public getHealthConfig(Landroid/hardware/health/V2_1/IHealth$getHealthConfigCallback;)V
    ...
    new-instance v2, Landroid/hardware/health/V2_1/HealthConfig;

    invoke-direct {v2}, Landroid/hardware/health/V2_1/HealthConfig;-><init>()V

    invoke-virtual {v2, v1}, Landroid/hardware/health/V2_1/HealthConfig;->readFromParcel(Landroid/os/HwParcel;)V

    invoke-interface {p1, v0, v2}, Landroid/hardware/health/V2_1/IHealth$getHealthConfigCallback;->onValues(ILandroid/hardware/health/V2_1/HealthConfig;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getHealthInfo_2_1(Landroid/hardware/health/V2_1/IHealth$getHealthInfo_2_1Callback;)V
    ...
    new-instance v2, Landroid/hardware/health/V2_1/HealthInfo;

    invoke-direct {v2}, Landroid/hardware/health/V2_1/HealthInfo;-><init>()V

    invoke-virtual {v2, v1}, Landroid/hardware/health/V2_1/HealthInfo;->readFromParcel(Landroid/os/HwParcel;)V

    invoke-interface {p1, v0, v2}, Landroid/hardware/health/V2_1/IHealth$getHealthInfo_2_1Callback;->onValues(ILandroid/hardware/health/V2_1/HealthInfo;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerCallback(Landroid/hardware/health/V2_0/IHealthInfoCallback;)I
    ...
    :try_start_0
    iget-object v1, p0, Landroid/hardware/health/V2_1/IHealth$Proxy;->mRemote:Landroid/os/IHwBinder;
...
.method public shouldKeepScreenOn(Landroid/hardware/health/V2_1/IHealth$shouldKeepScreenOnCallback;)V
    ...
    invoke-interface {p1, v0, v2}, Landroid/hardware/health/V2_1/IHealth$shouldKeepScreenOnCallback;->onValues(IZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
