...
.method public delete(Ljava/lang/String;ZLandroid/net/ipmemorystore/OnDeleteStatusListener;)V
    ...
    invoke-direct {p1, p3}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda10;-><init>(Landroid/net/ipmemorystore/OnDeleteStatusListener;)V
...
.method public deleteCluster(Ljava/lang/String;ZLandroid/net/ipmemorystore/OnDeleteStatusListener;)V
    ...
    :cond_0
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda11;

    invoke-direct {p1, p3}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda11;-><init>(Landroid/net/ipmemorystore/OnDeleteStatusListener;)V
...
.method public findL2Key(Landroid/net/ipmemorystore/NetworkAttributes;Landroid/net/ipmemorystore/OnL2KeyResponseListener;)V
    ...
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;

    invoke-direct {p1, p2}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;-><init>(Landroid/net/ipmemorystore/OnL2KeyResponseListener;)V
...
.method public isSameNetwork(Ljava/lang/String;Ljava/lang/String;Landroid/net/ipmemorystore/OnSameL3NetworkResponseListener;)V
    ...
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda14;

    invoke-direct {p1, p3}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda14;-><init>(Landroid/net/ipmemorystore/OnSameL3NetworkResponseListener;)V
...
.method public retrieveBlob(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/ipmemorystore/OnBlobRetrievedListener;)V
    ...
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda9;

    invoke-direct {p1, p4}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda9;-><init>(Landroid/net/ipmemorystore/OnBlobRetrievedListener;)V
...
.method public retrieveNetworkAttributes(Ljava/lang/String;Landroid/net/ipmemorystore/OnNetworkAttributesRetrievedListener;)V
    ...
    invoke-direct {p1, p2}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda13;-><init>(Landroid/net/ipmemorystore/OnNetworkAttributesRetrievedListener;)V
...
.method public storeBlob(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/ipmemorystore/Blob;Landroid/net/ipmemorystore/OnStatusListener;)V
    ...
    :cond_0
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda15;

    invoke-direct {p1, p5}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda15;-><init>(Landroid/net/ipmemorystore/OnStatusListener;)V
...
.method public storeNetworkAttributes(Ljava/lang/String;Landroid/net/ipmemorystore/NetworkAttributes;Landroid/net/ipmemorystore/OnStatusListener;)V
    ...
    :cond_0
    new-instance p1, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda16;

    invoke-direct {p1, p3}, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda16;-><init>(Landroid/net/ipmemorystore/OnStatusListener;)V
