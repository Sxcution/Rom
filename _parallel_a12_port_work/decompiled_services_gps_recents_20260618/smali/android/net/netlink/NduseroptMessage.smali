...
.method constructor <init>(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)V
    ...
    iput v2, p0, Landroid/net/netlink/NduseroptMessage;->ifindex:I

    invoke-virtual {p2}, Ljava/nio/ByteBuffer;->get()B

    move-result v3

    iput-byte v3, p0, Landroid/net/netlink/NduseroptMessage;->icmp_type:B

    invoke-virtual {p2}, Ljava/nio/ByteBuffer;->get()B

    move-result v3

    iput-byte v3, p0, Landroid/net/netlink/NduseroptMessage;->icmp_code:B
    ...
    iput-object v4, p0, Landroid/net/netlink/NduseroptMessage;->option:Landroid/net/netlink/NdOption;
    :try_end_0
    ...
    invoke-static {p2, p1, v2}, Ljava/net/Inet6Address;->getByAddress(Ljava/lang/String;[BI)Ljava/net/Inet6Address;
