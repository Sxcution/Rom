...
.method constructor <init>(Lcom/android/server/soundtrigger/SoundTriggerService;Landroid/os/IBinder;)V
    ...
    const-string v0, "Failed to register death listener."
...
.method public getModelState(Landroid/os/ParcelUuid;)I
    ...
    :pswitch_0
    iget-object p1, p0, Lcom/android/server/soundtrigger/SoundTriggerService$SoundTriggerSessionStub;->mSoundTriggerHelper:Lcom/android/server/soundtrigger/SoundTriggerHelper;
    ...
    invoke-direct {v4, v3}, Lcom/android/server/soundtrigger/SoundTriggerLogger$StringEvent;-><init>(Ljava/lang/String;)V

    invoke-virtual {p1, v4}, Lcom/android/server/soundtrigger/SoundTriggerLogger;->log(Lcom/android/server/soundtrigger/SoundTriggerLogger$Event;)V
...
.method public getParameter(Landroid/os/ParcelUuid;I)I
    ...
    invoke-virtual {p1, v2, p2}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->getParameter(Ljava/util/UUID;I)I
    ...
    invoke-virtual {p2, v2}, Lcom/android/server/soundtrigger/SoundTriggerLogger;->log(Lcom/android/server/soundtrigger/SoundTriggerLogger$Event;)V

    new-instance p1, Ljava/lang/IllegalArgumentException;

    const-string p2, "sound model is not loaded"
...
.method public isRecognitionActive(Landroid/os/ParcelUuid;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->isRecognitionRequested(Ljava/util/UUID;)Z
...
.method public loadGenericSoundModel(Landroid/hardware/soundtrigger/SoundTrigger$GenericSoundModel;)I
    ...
    const-string v1, "Invalid sound model"
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/soundtrigger/SoundTriggerLogger;->log(Lcom/android/server/soundtrigger/SoundTriggerLogger$Event;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_2
...
.method public queryParameter(Landroid/os/ParcelUuid;I)Landroid/hardware/soundtrigger/SoundTrigger$ModelParamRange;
    ...
    invoke-virtual {p1, v2, p2}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->queryParameter(Ljava/util/UUID;I)Landroid/hardware/soundtrigger/SoundTrigger$ModelParamRange;
...
.method public setParameter(Landroid/os/ParcelUuid;II)I
    ...
    invoke-virtual {p1, v2, p2, p3}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->setParameter(Ljava/util/UUID;II)I
...
.method public startRecognition(Landroid/os/ParcelUuid;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;Z)I
    ...
    const-string v0, "startRecognition(): Null model in database for id: "
    ...
    iget-object p3, p0, Lcom/android/server/soundtrigger/SoundTriggerService$SoundTriggerSessionStub;->this$0:Lcom/android/server/soundtrigger/SoundTriggerService;

    invoke-static {p3}, Lcom/android/server/soundtrigger/SoundTriggerService;->access$200(Lcom/android/server/soundtrigger/SoundTriggerService;)Lcom/android/server/soundtrigger/SoundTriggerService$SoundModelStatTracker;
...
.method public startRecognitionForService(Landroid/os/ParcelUuid;Landroid/os/Bundle;Landroid/content/ComponentName;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;)I
    ...
    invoke-direct {p0, p3}, Lcom/android/server/soundtrigger/SoundTriggerService$SoundTriggerSessionStub;->enforceDetectionPermissions(Landroid/content/ComponentName;)V
    ...
    invoke-static {p2}, Lcom/android/server/soundtrigger/SoundTriggerService;->access$400(Lcom/android/server/soundtrigger/SoundTriggerService;)Ljava/lang/Object;
    ...
    const-string v3, "startRecognitionForService():"
    ...
    const-string v1, " is already running"
    ...
    const-string v1, "startRecognitionForService(): Failed to start model:"

    invoke-direct {p4, v1}, Lcom/android/server/soundtrigger/SoundTriggerLogger$StringEvent;-><init>(Ljava/lang/String;)V
    ...
    const-string p4, "startRecognitionForService(): Unknown model type"
...
.method public stopRecognitionForService(Landroid/os/ParcelUuid;)I
    ...
    const-string v4, "Failed to stop model: "
    ...
    const-string v5, "stopRecognitionForService(): Failed to stop model: "
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/soundtrigger/SoundTriggerService$SoundModelStatTracker;->onStop(Ljava/util/UUID;)V
    ...
    const-string v4, "stopRecognitionForService(): Unknown model type"

    invoke-direct {v2, v4}, Lcom/android/server/soundtrigger/SoundTriggerLogger$StringEvent;-><init>(Ljava/lang/String;)V
...
.method public unloadSoundModel(Landroid/os/ParcelUuid;)I
    ...
    const-string v3, "Failed to unload model"
    ...
    const-string v4, "unloadSoundModel(): Failed to unload model"
    ...
    const-string v4, "unloadSoundModel(): Unknown model type"
