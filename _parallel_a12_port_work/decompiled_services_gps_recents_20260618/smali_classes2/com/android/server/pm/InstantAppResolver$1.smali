...
.method onPhaseTwoResolved(Ljava/util/List;J)V
    ...
    iget-object v2, v0, Lcom/android/server/pm/InstantAppResolver$1;->val$requestObj:Landroid/content/pm/InstantAppRequest;

    iget-object v8, v2, Landroid/content/pm/InstantAppRequest;->hostDigestPrefixSecure:[I

    move-object v2, p1

    invoke-static/range {v2 .. v8}, Lcom/android/server/pm/InstantAppResolver;->access$000(Ljava/util/List;Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[I)Landroid/content/pm/AuxiliaryResolveInfo;
    ...
    invoke-static {v2, v5, v6, v3, v4}, Lcom/android/server/pm/InstantAppResolver;->access$100(IJLjava/lang/String;I)V
