...
.method constructor <init>(Landroid/content/Context;Ljava/util/function/Supplier;Lcom/android/server/pm/ApexManager;)V
    ...
    new-instance p1, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;-><init>(Lcom/android/server/pm/StagingManager;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/pm/StagingManager;->mPreRebootVerificationHandler:Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;
...
.method private checkDowngrade(Lcom/android/server/pm/StagingManager$StagedSession;Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/pm/PackageManagerServiceUtils;->isDowngradePermitted(IZ)Z
    ...
    invoke-direct {p1, v4, p2}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
...
.method private checkDuplicateApkInApex(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    invoke-direct {p1, v0, v1, v2}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private checkInstallationOfApkInApexSuccessful(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    const-string v4, "Failed to install apk-in-apex of "
    ...
    invoke-direct {p1, v2, v0}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
...
.method private checkRequiredVersionCode(Lcom/android/server/pm/StagingManager$StagedSession;Landroid/content/pm/PackageInfo;)V
    ...
    const-string p2, " does not match required. Active version: "
    ...
    invoke-direct {v2, v3, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
...
.method private ensureActiveApexSessionIsAborted(Lcom/android/server/pm/StagingManager$StagedSession;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/pm/ApexManager;->abortStagedSession(I)Z
...
.method private extractApexSessions(Lcom/android/server/pm/StagingManager$StagedSession;)Ljava/util/List;
    ...
    invoke-interface {v1}, Lcom/android/server/pm/StagingManager$StagedSession;->containsApexSession()Z
...
.method private getParentSessionOrSelf(Lcom/android/server/pm/StagingManager$StagedSession;)Lcom/android/server/pm/StagingManager$StagedSession;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/StagingManager;->getStagedSession(I)Lcom/android/server/pm/StagingManager$StagedSession;
...
.method private installApksInSession(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    const-string v2, "Failure to install APK staged session "
    ...
    invoke-direct {p1, v1, v0}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
...
.method private isApexSessionFinalized(Landroid/apex/ApexSessionInfo;)Z
    ...
    iget-boolean p1, p1, Landroid/apex/ApexSessionInfo;->isReverted:Z
...
.method private isRollback(Lcom/android/server/pm/StagingManager$StagedSession;)Z
    ...
    iget p1, p1, Landroid/content/pm/PackageInstaller$SessionParams;->installReason:I
...
.method private prepareForLoggingApexdRevert(Lcom/android/server/pm/StagingManager$StagedSession;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/pm/StagingManager;->mFailedPackageNames:Ljava/util/List;
...
.method private resumeSession(Lcom/android/server/pm/StagingManager$StagedSession;ZZ)V
    ...
    invoke-interface {p1, p3, p2}, Lcom/android/server/pm/StagingManager$StagedSession;->setSessionFailed(ILjava/lang/String;)V
    ...
    :try_start_0
    iget-object p3, p0, Lcom/android/server/pm/StagingManager;->mSuccessfulStagedSessionIds:Ljava/util/List;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/pm/ApexManager;->markStagedSessionSuccessful(I)V
...
.method private retrieveRollbackIdForCommitSession(I)I
    ...
    invoke-direct {v0, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(Ljava/lang/String;)V
...
.method private snapshotAndRestoreApkInApexUserData(Ljava/lang/String;[ILcom/android/server/rollback/RollbackManagerInternal;)V
    ...
    const-string p3, "Could not find package: "
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/pm/PackageSetting;->getCeDataInode(I)J

    move-result-wide v6

    const/4 v2, 0x1

    invoke-virtual {v0, p2, v2}, Lcom/android/server/pm/PackageSetting;->queryInstalledUsers([IZ)[I

    move-result-object p2

    invoke-static {v1, v0}, Lcom/android/server/pm/parsing/pkg/AndroidPackageUtils;->getSeInfo(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Lcom/android/server/pm/PackageSetting;)Ljava/lang/String;
...
.method private snapshotAndRestoreForApexSession(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    invoke-direct {p0, v5, v0, v2}, Lcom/android/server/pm/StagingManager;->snapshotAndRestoreApexUserData(Ljava/lang/String;[ILcom/android/server/rollback/RollbackManagerInternal;)V
    ...
    invoke-direct {p0, v8, v0, v2}, Lcom/android/server/pm/StagingManager;->snapshotAndRestoreApkInApexUserData(Ljava/lang/String;[ILcom/android/server/rollback/RollbackManagerInternal;)V
...
.method private submitSessionToApexService(Lcom/android/server/pm/StagingManager$StagedSession;I)Ljava/util/List;
    ...
    :try_start_0
    iget-object v8, p0, Lcom/android/server/pm/StagingManager;->mPackageParserSupplier:Ljava/util/function/Supplier;

    invoke-interface {v8}, Ljava/util/function/Supplier;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/android/server/pm/parsing/PackageParser2;
    :try_end_0
    ...
    invoke-virtual {v8, v9, v10, v4}, Lcom/android/server/pm/parsing/PackageParser2;->parsePackage(Ljava/io/File;IZ)Lcom/android/server/pm/parsing/pkg/ParsedPackage;

    move-result-object v9

    invoke-static {v9, v7, v10}, Landroid/content/pm/parsing/PackageInfoWithoutStateUtils;->generate(Landroid/content/pm/parsing/ParsingPackageRead;Landroid/apex/ApexInfo;I)Landroid/content/pm/PackageInfo;
    ...
    :try_start_2
    invoke-virtual {v8}, Lcom/android/server/pm/parsing/PackageParser2;->close()V
    :try_end_2
    ...
    invoke-virtual {v7, v8, v3}, Lcom/android/server/pm/ApexManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v7

    if-eqz v7, :cond_5

    invoke-direct {p0, p1, v7}, Lcom/android/server/pm/StagingManager;->checkRequiredVersionCode(Lcom/android/server/pm/StagingManager$StagedSession;Landroid/content/pm/PackageInfo;)V

    invoke-direct {p0, p1, v7, v9}, Lcom/android/server/pm/StagingManager;->checkDowngrade(Lcom/android/server/pm/StagingManager$StagedSession;Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;)V
    ...
    iget-object p2, v9, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;
    ...
    iget-object v0, v7, Landroid/apex/ApexInfo;->modulePath:Ljava/lang/String;
    ...
    invoke-direct {p2, v3, v0, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private validateApexSignature(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-virtual {v6, v3, v5}, Lcom/android/server/pm/ApexManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v7, v5}, Landroid/util/apk/ApkSignatureVerifier;->verify(Ljava/lang/String;I)Landroid/content/pm/PackageParser$SigningDetails;
    ...
    invoke-virtual {v4, v0, v5}, Landroid/content/pm/PackageParser$SigningDetails;->checkCapability(Landroid/content/pm/PackageParser$SigningDetails;I)Z
    ...
    invoke-virtual {v0, v4, v1}, Landroid/content/pm/PackageParser$SigningDetails;->checkCapability(Landroid/content/pm/PackageParser$SigningDetails;I)Z
    ...
    const-string v4, "APK-container signature of APEX package "
    ...
    invoke-direct {v0, v5, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v2, v5, v0, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v1, "Unknown apex package "
    ...
    invoke-direct {v3, v5, v0, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method abortCommittedSession(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    const-string v0, " has been abandoned already"
...
.method checkNonOverlappingWithStagedSessions(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    const-string v8, " is already staged"
    ...
    invoke-direct {p0, v6}, Lcom/android/server/pm/StagingManager;->ensureActiveApexSessionIsAborted(Lcom/android/server/pm/StagingManager$StagedSession;)Z
    ...
    const-string v10, "Session was failed by rollback session: "
    ...
    invoke-interface {v6, v8, v9}, Lcom/android/server/pm/StagingManager$StagedSession;->setSessionFailed(ILjava/lang/String;)V
    ...
    const-string v6, " is marked failed due to rollback session: "
    ...
    invoke-direct {p1, v1, v0, v7}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string p1, " has been staged already by session: "
    ...
    invoke-direct {v0, v1, p1, v7}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method onInstallationFailure(Lcom/android/server/pm/StagingManager$StagedSession;Lcom/android/server/pm/PackageManagerException;ZZ)V
    ...
    invoke-direct {p0, p2, p3, p4}, Lcom/android/server/pm/StagingManager;->abortCheckpoint(Ljava/lang/String;ZZ)V
...
.method restoreSessions(Ljava/util/List;Z)V
    ...
    invoke-interface {v0, v5, v1}, Lcom/android/server/pm/StagingManager$StagedSession;->setSessionFailed(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v12, v11}, Lcom/android/server/pm/StagingManager;->prepareForLoggingApexdRevert(Lcom/android/server/pm/StagingManager$StagedSession;Ljava/lang/String;)V
    ...
    invoke-interface {v12, v5, v11}, Lcom/android/server/pm/StagingManager$StagedSession;->setSessionFailed(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v0, v7, v8}, Lcom/android/server/pm/StagingManager;->abortCheckpoint(Ljava/lang/String;ZZ)V
    ...
    invoke-interface {v0}, Lcom/android/server/pm/StagingManager$StagedSession;->isSessionFailed()Z
    ...
    :try_start_1
    invoke-direct {v1, v6, v7, v8}, Lcom/android/server/pm/StagingManager;->resumeSession(Lcom/android/server/pm/StagingManager$StagedSession;ZZ)V
    :try_end_1
    ...
    invoke-static {v13, v0, v9}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-direct {v0, v5, v9}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V

    invoke-virtual {v1, v6, v0, v7, v8}, Lcom/android/server/pm/StagingManager;->onInstallationFailure(Lcom/android/server/pm/StagingManager$StagedSession;Lcom/android/server/pm/PackageManagerException;ZZ)V
    ...
    invoke-virtual {v1, v6, v9, v7, v8}, Lcom/android/server/pm/StagingManager;->onInstallationFailure(Lcom/android/server/pm/StagingManager$StagedSession;Lcom/android/server/pm/PackageManagerException;ZZ)V
