...
.method private collectDomainsInternal(Lcom/android/server/pm/parsing/pkg/AndroidPackage;ZZLjava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    invoke-virtual {v9}, Landroid/content/pm/parsing/component/ParsedActivity;->getIntents()Ljava/util/List;
    ...
    invoke-virtual {v12}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->getAutoVerify()Z
    ...
    invoke-virtual {v12, v13}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->hasCategory(Ljava/lang/String;)Z

    move-result v13

    if-eqz v13, :cond_6

    invoke-virtual {v12, v1}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->handlesWebUris(Z)Z
    ...
    invoke-virtual {v12, v14}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->getDataAuthority(I)Landroid/content/IntentFilter$AuthorityEntry;
    ...
    invoke-interface {v0, v7, v15}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private collectDomainsLegacy(Lcom/android/server/pm/parsing/pkg/AndroidPackage;ZZLjava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->needsVerification()Z
    ...
    invoke-virtual {v12, v5}, Landroid/content/pm/parsing/component/ParsedIntentInfo;->handlesWebUris(Z)Z
    ...
    invoke-interface {v4, v7, v15}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private isValidHost(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->mDomainMatcher:Ljava/util/regex/Matcher;
