...
.method public onHealthStatus(II)V
    ...
    invoke-static {p1}, Lcom/android/server/pm/PackageInstallerSession;->access$200(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-static {p1}, Lcom/android/server/pm/PackageInstallerSession;->access$3000(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-static {p1, p2}, Lcom/android/server/pm/PackageInstallerSession;->access$3002(Lcom/android/server/pm/PackageInstallerSession;Z)Z

    iget-object p1, p0, Lcom/android/server/pm/PackageInstallerSession$8;->this$0:Lcom/android/server/pm/PackageInstallerSession;

    const/16 p2, -0x14

    const-string v0, "Image is missing pages required for installation."

    invoke-static {p1, p2, v0}, Lcom/android/server/pm/PackageInstallerSession;->access$3500(Lcom/android/server/pm/PackageInstallerSession;ILjava/lang/String;)V
