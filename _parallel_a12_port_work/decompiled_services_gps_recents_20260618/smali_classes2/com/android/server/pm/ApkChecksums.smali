...
.method private static extractHashFromFS(Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/ApkChecksum;
    ...
    invoke-direct {v2, p0, v1, p1}, Landroid/content/pm/ApkChecksum;-><init>(Ljava/lang/String;I[B)V
    :try_end_0
...
.method private static extractHashFromV2V3Signature(Ljava/lang/String;Ljava/lang/String;I)Ljava/util/Map;
    ...
    :try_start_0
    invoke-static {p1, v1, v0}, Landroid/util/apk/ApkSignatureVerifier;->verifySignaturesInternal(Ljava/lang/String;IZ)Landroid/util/apk/ApkSignatureVerifier$SigningDetailsWithDigests;
    ...
    invoke-virtual {p1}, Landroid/content/pm/PackageParser$PackageParserException;->getCause()Ljava/lang/Throwable;
...
.method private static getApkChecksum(Ljava/io/File;I)[B
    ...
    invoke-virtual {p1, v4, v6, v5}, Ljava/security/MessageDigest;->update([BII)V
...
.method private static getInstallerChecksums(Ljava/lang/String;Ljava/io/File;ILjava/lang/String;[Ljava/security/cert/Certificate;Ljava/util/Map;Lcom/android/server/pm/ApkChecksums$Injector;)V
    ...
    :cond_7
    invoke-interface {p6}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getSigningDetails()Landroid/content/pm/PackageParser$SigningDetails;
    ...
    iget-object p6, p6, Landroid/content/pm/PackageParser$SigningDetails;->pastSigningCertificates:[Landroid/content/pm/Signature;
