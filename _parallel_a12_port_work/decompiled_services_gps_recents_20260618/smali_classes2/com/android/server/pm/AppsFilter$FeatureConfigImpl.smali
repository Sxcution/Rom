...
.method private updateEnabledState(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
    ...
    :goto_0
    iget-object p1, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mAppsFilter:Lcom/android/server/pm/AppsFilter;

    if-eqz p1, :cond_1

    invoke-static {p1}, Lcom/android/server/pm/AppsFilter;->access$200(Lcom/android/server/pm/AppsFilter;)V
...
.method public enableLogging(IZ)V
    ...
    iget-object p2, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mLoggingEnabled:Landroid/util/SparseBooleanArray;
    ...
    iput-object p2, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mLoggingEnabled:Landroid/util/SparseBooleanArray;
    ...
    iget-object p1, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mLoggingEnabled:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mLoggingEnabled:Landroid/util/SparseBooleanArray;
...
.method public synthetic lambda$onSystemReady$0$AppsFilter$FeatureConfigImpl(Landroid/provider/DeviceConfig$Properties;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mFeatureEnabled:Z
...
.method public onCompatChange(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mAppsFilter:Lcom/android/server/pm/AppsFilter;

    invoke-static {v0, p1}, Lcom/android/server/pm/AppsFilter;->access$100(Lcom/android/server/pm/AppsFilter;Ljava/lang/String;)V
...
.method public updatePackageState(Lcom/android/server/pm/PackageSetting;Z)V
    ...
    iget-object p2, p0, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->mDisabledPackages:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/AppsFilter$FeatureConfigImpl;->updateEnabledState(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
