...
.method private doAddFiles(ILjava/util/ArrayList;JZ)I
    ...
    invoke-direct {p0, p2, v9}, Lcom/android/server/pm/PackageManagerShellCommand;->processArgForStdin(Ljava/lang/String;Landroid/content/pm/PackageInstaller$Session;)I
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, p2, v9}, Lcom/android/server/pm/PackageManagerShellCommand;->processArgForLocalFile(Ljava/lang/String;Landroid/content/pm/PackageInstaller$Session;)V
    :try_end_2
    ...
    const-string p2, "Failure [failed to add file(s)]"
...
.method private doCreateSession(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;I)I
    ...
    invoke-interface {v0, p1, p2, v1, p3}, Landroid/content/pm/IPackageInstaller;->createSession(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;Ljava/lang/String;I)I
...
.method private doListPermissions(Ljava/util/ArrayList;ZZZII)V
    ...
    :goto_8
    invoke-direct {v0, v1}, Lcom/android/server/pm/PackageManagerShellCommand;->getResources(Landroid/content/pm/PackageItemInfo;)Landroid/content/res/Resources;
    ...
    invoke-direct {v0, v1, v3, v6}, Lcom/android/server/pm/PackageManagerShellCommand;->loadText(Landroid/content/pm/PackageItemInfo;ILjava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v6, v8}, Lcom/android/server/pm/PackageManagerShellCommand;->loadText(Landroid/content/pm/PackageItemInfo;ILjava/lang/CharSequence;)Ljava/lang/String;
...
.method private doRunInstall(Lcom/android/server/pm/PackageManagerShellCommand$InstallParams;)I
    ...
    const-string p1, "Error: must either specify a package size or an APK file"
    ...
    const-string p1, "Error: can\'t specify SPLIT(s) for APEX"
    ...
    const-string p1, "Error: can\'t specify SPLIT(s) along with STDIN"
    ...
    :cond_8
    invoke-direct {p0, p1, v7}, Lcom/android/server/pm/PackageManagerShellCommand;->setParamsSize(Lcom/android/server/pm/PackageManagerShellCommand$InstallParams;Ljava/util/List;)V
    ...
    iget-wide v8, v1, Landroid/content/pm/PackageInstaller$SessionParams;->sizeBytes:J

    move-object v5, p0

    move v6, v4

    invoke-direct/range {v5 .. v10}, Lcom/android/server/pm/PackageManagerShellCommand;->doAddFiles(ILjava/util/ArrayList;JZ)I
    ...
    :try_start_1
    invoke-direct {p0, v4, v3}, Lcom/android/server/pm/PackageManagerShellCommand;->doAbandonSession(IZ)I
    :try_end_1
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/server/pm/PackageManagerShellCommand;->doWriteSplits(ILjava/util/ArrayList;JZ)I
    ...
    :cond_b
    :try_start_4
    invoke-direct {p0, v4, v3}, Lcom/android/server/pm/PackageManagerShellCommand;->doCommitSession(IZ)I
    ...
    iget-wide v1, p1, Lcom/android/server/pm/PackageManagerShellCommand$InstallParams;->stagedReadyTimeoutMs:J
    ...
    invoke-direct {p0, v4, v1, v2, v0}, Lcom/android/server/pm/PackageManagerShellCommand;->doWaitForStagedSessionReady(IJLjava/io/PrintWriter;)I
...
.method private doWaitForStagedSessionReady(IJLjava/io/PrintWriter;)I
    ...
    const-string p3, "Failure [Unknown session "
    ...
    const-string p3, "Failure [Session "
    ...
    const-string p1, "Failure [failed to retrieve SessionInfo]"
    ...
    const-string v0, "Failure [timed out after "
    ...
    :cond_7
    const-string p1, "Success. Reboot device to apply staged session"
...
.method private doWriteSplit(ILjava/lang/String;JLjava/lang/String;Z)I
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/server/pm/PackageManagerShellCommand;->openFileForSystem(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method private isSystemExtApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1}, Landroid/content/pm/ApplicationInfo;->isSystemExt()Z
...
.method private printSessionList(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/List;Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;)V
    ...
    iget-boolean v2, p3, Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;->onlyReady:Z
    ...
    :cond_2
    invoke-static {p1, v1, p3}, Lcom/android/server/pm/PackageManagerShellCommand;->printSession(Ljava/io/PrintWriter;Landroid/content/pm/PackageInstaller$SessionInfo;Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;)V
    ...
    iget-boolean v2, p3, Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;->onlyParent:Z
    ...
    iget-boolean v3, p3, Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;->onlySessionId:Z

    if-eqz v3, :cond_3

    aget v3, v1, v2

    invoke-virtual {p1, v3}, Lcom/android/internal/util/IndentingPrintWriter;->println(I)V
    ...
    :cond_4
    invoke-static {p1, v3, p3}, Lcom/android/server/pm/PackageManagerShellCommand;->printSession(Ljava/io/PrintWriter;Landroid/content/pm/PackageInstaller$SessionInfo;Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;)V
...
.method private processArgForLocalFile(Ljava/lang/String;Landroid/content/pm/PackageInstaller$Session;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/PackageManagerShellCommand;->getFileStatSize(Ljava/io/File;)J
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/pm/PackageManagerShellCommand;->openFileForSystem(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_0
    invoke-static {p1}, Landroid/os/incremental/V4Signature;->readFrom(Landroid/os/ParcelFileDescriptor;)Landroid/os/incremental/V4Signature;

    move-result-object v1

    invoke-virtual {v1}, Landroid/os/incremental/V4Signature;->toByteArray()[B
    ...
    invoke-static {v2, v6, v1}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private processArgForStdin(Ljava/lang/String;Landroid/content/pm/PackageInstaller$Session;)I
    ...
    const-string v3, "V4 signature is invalid: "
    ...
    const-string v3, "Unable to parse file parameters: "
...
.method private removeUser(Landroid/os/IUserManager;I)I
    ...
    const-string p2, "Success: removed user"
...
.method private runGetHarmfulAppWarning()I
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
...
.method private runGrantRevokePermission(Z)I
    ...
    invoke-direct {p0, v1, v3, v5}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
    ...
    iget-object p1, p0, Lcom/android/server/pm/PackageManagerShellCommand;->mPermissionManager:Landroid/permission/PermissionManager;

    invoke-virtual {p1, v2, v4, v1}, Landroid/permission/PermissionManager;->grantRuntimePermission(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-virtual {p1, v2, v4, v1, v3}, Landroid/permission/PermissionManager;->revokeRuntimePermission(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;Ljava/lang/String;)V
...
.method private runInstallCommit()I
    ...
    :pswitch_0
    const-string v2, "--staged-ready-timeout"
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/pm/PackageManagerShellCommand;->doCommitSession(IZ)I
...
.method private runInstallExisting()I
    ...
    invoke-direct {p0, v2, v4, v5}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
    ...
    invoke-direct {v11, v3}, Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;-><init>(Lcom/android/server/pm/PackageManagerShellCommand$1;)V
...
.method private runListPackages(Z)I
    ...
    const-string v3, "runListPackages"

    move/from16 p1, v15

    const/4 v15, 0x0

    invoke-direct {v0, v5, v15, v3}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I

    move-result v3

    iget-object v5, v0, Lcom/android/server/pm/PackageManagerShellCommand;->mInterface:Landroid/content/pm/IPackageManager;

    invoke-interface {v5, v6, v3}, Landroid/content/pm/IPackageManager;->getInstalledPackages(II)Landroid/content/pm/ParceledListSlice;
    ...
    :cond_4
    iget-boolean v3, v6, Landroid/content/pm/PackageInfo;->isApex:Z
    ...
    iget-wide v4, v2, Landroid/content/pm/ApplicationInfo;->longVersionCode:J
    ...
    invoke-interface {v2, v4}, Landroid/content/pm/IPackageManager;->getInstallerPackageName(Ljava/lang/String;)Ljava/lang/String;
...
.method private runListStagedSessions()I
    ...
    invoke-direct {p0, v2, v1}, Lcom/android/server/pm/PackageManagerShellCommand;->setSessionFlag(Ljava/lang/String;Lcom/android/server/pm/PackageManagerShellCommand$SessionDump;)Z
...
.method private runLogVisibility()I
    ...
    invoke-virtual {v3, v0, v2}, Landroid/content/pm/PackageManagerInternal;->setVisibilityLogging(Ljava/lang/String;Z)V
...
.method private runRemoveSplits(Ljava/lang/String;Ljava/util/Collection;)I
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v2}, Lcom/android/server/pm/PackageManagerShellCommand;->doRemoveSplits(ILjava/util/Collection;Z)I
...
.method private runRollbackApp()I
    ...
    invoke-virtual {v6, v7, v4, v8}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-direct {v7, v8}, Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;-><init>(Lcom/android/server/pm/PackageManagerShellCommand$1;)V
    ...
    check-cast v6, Landroid/content/rollback/RollbackManager;

    nop

    invoke-virtual {v6}, Landroid/content/rollback/RollbackManager;->getAvailableRollbacks()Ljava/util/List;
    ...
    const-string v2, "No available rollbacks for: "
    ...
    invoke-virtual {v6, v3, v9, v10}, Landroid/content/rollback/RollbackManager;->commitRollback(ILjava/util/List;Landroid/content/IntentSender;)V
    ...
    const-string v6, "android.content.rollback.extra.STATUS"
    ...
    const-string v2, "android.content.rollback.extra.STATUS_MESSAGE"
    ...
    :cond_7
    invoke-virtual {v8}, Landroid/content/rollback/RollbackInfo;->isStaged()Z
...
.method private runSetDistractingRestriction()I
    ...
    invoke-direct {p0, v2, v6, v7}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
    ...
    invoke-interface {v6, v4, v3, v2}, Landroid/content/pm/IPackageManager;->setDistractingPackageRestrictionsAsUser([Ljava/lang/String;II)[Ljava/lang/String;
...
.method private runSetHarmfulAppWarning()I
    ...
    invoke-interface {v3, v1, v2, v0}, Landroid/content/pm/IPackageManager;->setHarmfulAppWarning(Ljava/lang/String;Ljava/lang/CharSequence;I)V
...
.method private runSetHomeActivity()I
    ...
    invoke-direct {p0, v2, v3, v5}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
...
.method private runSetSilentUpdatesPolicy()I
    ...
    const-string v2, "Error: Invalid value for \"--throttle-time\":"
    ...
    invoke-interface {v1, v2}, Landroid/content/pm/IPackageInstaller;->setAllowUnlimitedSilentUpdates(Ljava/lang/String;)V

    const-wide/16 v2, -0x1

    invoke-interface {v1, v2, v3}, Landroid/content/pm/IPackageInstaller;->setSilentUpdatesThrottleTime(J)V
    ...
    invoke-interface {v1, v5}, Landroid/content/pm/IPackageInstaller;->setAllowUnlimitedSilentUpdates(Ljava/lang/String;)V
...
.method private runSnapshotProfile()I
    ...
    invoke-interface {v3, v7, v9, v9}, Landroid/content/pm/IPackageManager;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {v13, v1}, Lcom/android/server/pm/PackageManagerShellCommand$SnapshotRuntimeProfileCallback;-><init>(Lcom/android/server/pm/PackageManagerShellCommand$1;)V
    ...
    invoke-static {v13}, Lcom/android/server/pm/PackageManagerShellCommand$SnapshotRuntimeProfileCallback;->access$300(Lcom/android/server/pm/PackageManagerShellCommand$SnapshotRuntimeProfileCallback;)I
    ...
    invoke-static {v13}, Lcom/android/server/pm/PackageManagerShellCommand$SnapshotRuntimeProfileCallback;->access$400(Lcom/android/server/pm/PackageManagerShellCommand$SnapshotRuntimeProfileCallback;)Landroid/os/ParcelFileDescriptor;
...
.method private runSuspend(Z)I
    ...
    invoke-direct {v0, v7, v6, v10}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
...
.method private runUninstall()I
    ...
    invoke-direct {v0, v7, v6}, Lcom/android/server/pm/PackageManagerShellCommand;->runRemoveSplits(Ljava/lang/String;Ljava/util/Collection;)I
    ...
    invoke-direct {v0, v4, v3, v2}, Lcom/android/server/pm/PackageManagerShellCommand;->translateUserId(IILjava/lang/String;)I
    ...
    invoke-interface {v5, v7, v6, v2}, Landroid/content/pm/IPackageManager;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
...
.method private setParamsSize(Lcom/android/server/pm/PackageManagerShellCommand$InstallParams;Ljava/util/List;)V
    ...
    invoke-virtual {v9, v8, v0}, Lcom/android/server/pm/PackageManagerShellCommand;->openFileForSystem(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v0, v11, v8, v3}, Landroid/content/pm/parsing/ApkLiteParseUtils;->parseApkLite(Landroid/content/pm/parsing/result/ParseInput;Ljava/io/FileDescriptor;Ljava/lang/String;I)Landroid/content/pm/parsing/result/ParseResult;
    ...
    new-instance v0, Landroid/content/pm/parsing/PackageLite;
    ...
    invoke-direct/range {v11 .. v21}, Landroid/content/pm/parsing/PackageLite;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/pm/parsing/ApkLite;[Ljava/lang/String;[Z[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[II)V

    iget-object v11, v1, Lcom/android/server/pm/PackageManagerShellCommand$InstallParams;->sessionParams:Landroid/content/pm/PackageInstaller$SessionParams;
    ...
    invoke-static {v0, v11, v12}, Lcom/android/internal/content/PackageHelper;->calculateInstalledSize(Landroid/content/pm/parsing/PackageLite;Ljava/lang/String;Ljava/io/FileDescriptor;)J
...
.method private uninstallSystemUpdates(Ljava/lang/String;)I
    ...
    invoke-interface {p1, v3, v1}, Landroid/content/pm/IPackageManager;->getInstalledApplications(II)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-interface {v5, p1, v3, v1}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {v12, v3}, Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;-><init>(Lcom/android/server/pm/PackageManagerShellCommand$1;)V
    ...
    iget v5, v11, Landroid/content/pm/ApplicationInfo;->versionCode:I
...
.method public onCommand(Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageManagerShellCommand;->uninstallSystemUpdates(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2, v6}, Lcom/android/server/pm/PackageManagerShellCommand;->displayPackageFilePath(Ljava/lang/String;I)I
...
.method public runCreateUser()I
    ...
    const-string v2, "Error: more than one user type was specified ("
    ...
    const-string v8, "Warning: name is ignored for pre-created users"
    ...
    :goto_2
    :try_start_0
    invoke-static {v10}, Landroid/os/UserManager;->isUserTypeRestricted(Ljava/lang/String;)Z
    ...
    :goto_3
    invoke-interface {v5, v4, v2}, Landroid/os/IUserManager;->createRestrictedProfileWithThrow(Ljava/lang/String;I)Landroid/content/pm/UserInfo;
    ...
    :goto_4
    invoke-interface {v8, v2, v7, v3}, Landroid/accounts/IAccountManager;->addSharedAccountsFromParentUser(IILjava/lang/String;)V
    ...
    invoke-interface {v5, v10}, Landroid/os/IUserManager;->preCreateUserWithThrow(Ljava/lang/String;)Landroid/content/pm/UserInfo;
    ...
    :cond_11
    invoke-interface {v5, v4, v10, v6}, Landroid/os/IUserManager;->createUserWithThrow(Ljava/lang/String;Ljava/lang/String;I)Landroid/content/pm/UserInfo;
...
.method public runRemoveUser()I
    ...
    const-string v3, "--set-ephemeral-if-in-use"
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/pm/PackageManagerShellCommand;->removeUserOrSetEphemeral(Landroid/os/IUserManager;I)I
    ...
    :cond_3
    invoke-direct {p0, v2, v0}, Lcom/android/server/pm/PackageManagerShellCommand;->removeUser(Landroid/os/IUserManager;I)I
