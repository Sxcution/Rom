...
.method constructor <init>(Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;)V
    ...
    iget-boolean p1, p1, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->mIsUpdatingMimeGroup:Z

    iput-boolean p1, p0, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->mIsUpdatingMimeGroup:Z
...
.method private updateFilter(Landroid/util/Pair;)Z
    ...
    invoke-direct {p0, v1, p1}, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->equalLists(Ljava/util/List;Ljava/util/List;)Z
...
.method public addFilter(Landroid/util/Pair;)V
    ...
    iget-object v1, p0, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->mMimeGroupToFilter:Landroid/util/ArrayMap;

    const-string v2, "      MimeGroup: "

    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->register_intent_filter(Ljava/lang/Object;Ljava/util/Iterator;Landroid/util/ArrayMap;Ljava/lang/String;)I
...
.method public updateMimeGroup(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iput-boolean v2, p0, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->mIsUpdatingMimeGroup:Z
    ...
    invoke-virtual {p0, p1, v4}, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->isPackageForFilter(Ljava/lang/String;Ljava/lang/Object;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v4}, Lcom/android/server/pm/ComponentResolver$MimeGroupsAwareIntentResolver;->updateFilter(Landroid/util/Pair;)Z
