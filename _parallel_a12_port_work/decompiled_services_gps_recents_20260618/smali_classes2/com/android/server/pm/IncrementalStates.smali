...
.method private updateProgressLocked(F)V
    ...
    iget-object p1, p0, Lcom/android/server/pm/IncrementalStates;->mLoadingState:Lcom/android/server/pm/IncrementalStates$LoadingState;

    invoke-virtual {p1, v0}, Lcom/android/server/pm/IncrementalStates$LoadingState;->setProgress(F)V

    iget-object p1, p0, Lcom/android/server/pm/IncrementalStates;->mLoadingState:Lcom/android/server/pm/IncrementalStates$LoadingState;

    invoke-virtual {p1}, Lcom/android/server/pm/IncrementalStates$LoadingState;->isLoading()Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/IncrementalStates$LoadingState;->adoptNewLoadingStateLocked(Z)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lcom/android/server/pm/IncrementalStates;->mLoadingState:Lcom/android/server/pm/IncrementalStates$LoadingState;

    iget-object v0, p0, Lcom/android/server/pm/IncrementalStates;->mLoadingState:Lcom/android/server/pm/IncrementalStates$LoadingState;

    invoke-virtual {p1, v0}, Lcom/android/server/pm/IncrementalStates$LoadingState;->equals(Ljava/lang/Object;)Z
...
.method public onCommit(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/pm/IncrementalStates;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {p0, v0}, Lcom/android/server/pm/IncrementalStates;->updateProgressLocked(F)V
