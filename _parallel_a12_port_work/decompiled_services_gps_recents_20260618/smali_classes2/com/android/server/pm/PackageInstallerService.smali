...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Ljava/util/function/Supplier;)V
    ...
    invoke-direct {v0, p2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;-><init>(Landroid/os/Looper;)V
    ...
    const-string v1, "package-session"
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageInstallerService;->mApexManager:Lcom/android/server/pm/ApexManager;

    new-instance p2, Lcom/android/server/pm/StagingManager;

    invoke-direct {p2, p1, p3}, Lcom/android/server/pm/StagingManager;-><init>(Landroid/content/Context;Ljava/util/function/Supplier;)V
...
.method private createSessionInternal(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    iget-object v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->dataLoaderParams:Landroid/content/pm/DataLoaderParams;
    ...
    :cond_1
    :goto_0
    iget v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installReason:I
    ...
    :cond_3
    :goto_1
    iget-object v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->appPackageName:Ljava/lang/String;
    ...
    iput-object v4, v13, Landroid/content/pm/PackageInstaller$SessionParams;->appPackageName:Ljava/lang/String;

    :cond_4
    iget-object v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->appLabel:Ljava/lang/String;
    ...
    iput-object v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->appLabel:Ljava/lang/String;

    iget-object v2, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installerPackageName:Ljava/lang/String;
    ...
    :cond_8
    iget v5, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I

    and-int/lit8 v5, v5, -0x21

    iput v5, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    invoke-virtual {v5, v11}, Lcom/android/server/pm/PackageManagerService;->isCallerVerifier(I)Z
    ...
    iget v5, v13, Landroid/content/pm/PackageInstaller$SessionParams;->originatingUid:I
    ...
    invoke-virtual {v5, v8}, Lcom/android/server/pm/PackageManagerService;->getPackagesForUid(I)[Ljava/lang/String;
    ...
    invoke-direct {v0, v11}, Lcom/android/server/pm/PackageInstallerService;->isCalledBySystemOrShell(I)Z
    ...
    :cond_d
    iget v8, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I

    const v9, -0x100001

    and-int/2addr v8, v9

    iput v8, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    iget-object v12, v0, Lcom/android/server/pm/PackageInstallerService;->mContext:Landroid/content/Context;

    const-string v14, "android.permission.INSTALL_PACKAGE_UPDATES"

    invoke-virtual {v12, v14}, Landroid/content/Context;->checkCallingOrSelfPermission(Ljava/lang/String;)I
    ...
    const-string v14, "android.permission.INSTALL_PACKAGES"
    ...
    :cond_12
    iget-boolean v12, v13, Landroid/content/pm/PackageInstaller$SessionParams;->isStaged:Z
    ...
    invoke-virtual {v12, v14, v15}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V

    :cond_13
    :goto_9
    if-eqz v8, :cond_1a

    iget-object v12, v0, Lcom/android/server/pm/PackageInstallerService;->mApexManager:Lcom/android/server/pm/ApexManager;

    invoke-virtual {v12}, Lcom/android/server/pm/ApexManager;->isApexSupported()Z

    move-result v12

    if-eqz v12, :cond_19

    iget-boolean v12, v13, Landroid/content/pm/PackageInstaller$SessionParams;->isMultiPackage:Z
    ...
    iget v12, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    iget-boolean v12, v0, Lcom/android/server/pm/PackageInstallerService;->mBypassNextAllowedApexUpdateCheck:Z
    ...
    iput v12, v13, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    invoke-virtual {v12, v11}, Lcom/android/server/pm/PackageManagerService;->getFlagsForUid(I)I
    ...
    iget-boolean v12, v0, Lcom/android/server/pm/PackageInstallerService;->mBypassNextStagedInstallerCheck:Z

    if-nez v12, :cond_1e

    invoke-direct {v0, v2}, Lcom/android/server/pm/PackageInstallerService;->isStagedInstallerAllowed(Ljava/lang/String;)Z
    ...
    iget-boolean v8, v13, Landroid/content/pm/PackageInstaller$SessionParams;->isMultiPackage:Z
    ...
    const-string v12, "android.permission.INSTALL_GRANT_RUNTIME_PERMISSIONS"

    invoke-virtual {v8, v12}, Landroid/content/Context;->checkCallingOrSelfPermission(Ljava/lang/String;)I
    ...
    iget-object v8, v13, Landroid/content/pm/PackageInstaller$SessionParams;->appIcon:Landroid/graphics/Bitmap;
    ...
    :cond_24
    iget v6, v13, Landroid/content/pm/PackageInstaller$SessionParams;->mode:I
    ...
    invoke-static {v6, v13}, Lcom/android/internal/content/PackageHelper;->fitsOnInternal(Landroid/content/Context;Landroid/content/pm/PackageInstaller$SessionParams;)Z
    ...
    invoke-static {v6, v13}, Lcom/android/internal/content/PackageHelper;->resolveInstallVolume(Landroid/content/Context;Landroid/content/pm/PackageInstaller$SessionParams;)Ljava/lang/String;
    ...
    invoke-static {v8, v11}, Lcom/android/server/pm/PackageInstallerService;->getSessionCount(Landroid/util/SparseArray;I)I
    ...
    :goto_12
    iget-object v8, v0, Lcom/android/server/pm/PackageInstallerService;->mHistoricalSessionsByInstaller:Landroid/util/SparseIntArray;
    ...
    iget-boolean v6, v13, Landroid/content/pm/PackageInstaller$SessionParams;->isMultiPackage:Z
    ...
    invoke-direct {v0, v14, v13}, Lcom/android/server/pm/PackageInstallerService;->buildSessionDir(ILandroid/content/pm/PackageInstaller$SessionParams;)Ljava/io/File;
    ...
    :cond_2b
    invoke-direct {v0, v14}, Lcom/android/server/pm/PackageInstallerService;->buildExternalStageCid(I)Ljava/lang/String;
    ...
    :goto_13
    iget-boolean v4, v13, Landroid/content/pm/PackageInstaller$SessionParams;->forceQueryableOverride:Z
    ...
    iput-boolean v7, v13, Landroid/content/pm/PackageInstaller$SessionParams;->forceQueryableOverride:Z

    :cond_2d
    move-object/from16 v3, p3

    invoke-static {v1, v5, v2, v3}, Lcom/android/server/pm/InstallSource;->create(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/pm/InstallSource;
    ...
    invoke-static {v1, v2, v4}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$100(Lcom/android/server/pm/PackageInstallerService$Callbacks;II)V
...
.method private getStagingDirsOnVolume(Ljava/lang/String;)Landroid/util/ArraySet;
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageInstallerService;->newArraySet([Ljava/lang/Object;)Landroid/util/ArraySet;
...
.method private readSessionsLocked()V
    ...
    invoke-virtual {v4, v3, v13}, Landroid/util/SparseBooleanArray;->put(IZ)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/pm/PackageInstallerSession;->onAfterSessionRead(Landroid/util/SparseArray;)V
...
.method private reconcileStagesLocked(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageInstallerService;->removeStagingDirs(Landroid/util/ArraySet;)V
...
.method private writeSessionsLocked()Z
    ...
    invoke-virtual {v8, v4, v9}, Lcom/android/server/pm/PackageInstallerSession;->write(Landroid/util/TypedXmlSerializer;Ljava/io/File;)V
...
.method public bypassNextAllowedApexUpdateCheck(Z)V
    ...
    const-string v0, "Caller not allowed to bypass allowed apex update check"
...
.method public bypassNextStagedInstallerCheck(Z)V
    ...
    const-string v0, "Caller not allowed to bypass staged installer check"
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    :cond_2
    invoke-virtual {v6, p1}, Lcom/android/server/pm/PackageInstallerSession;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v3, "Orphaned install sessions:"
    ...
    :cond_5
    const-string v2, "Finalized install sessions:"
...
.method public setAllowUnlimitedSilentUpdates(Ljava/lang/String;)V
    ...
    const-string v0, "Caller not allowed to unlimite silent updates"
...
.method public setSilentUpdatesThrottleTime(J)V
    ...
    const-string p2, "Caller not allowed to set silent updates throttle time"
...
.method public systemReady()V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/pm/PackageInstallerService;->mSettingsWriteRequest:Lcom/android/server/pm/utils/RequestThrottle;

    invoke-virtual {v1}, Lcom/android/server/pm/utils/RequestThrottle;->runNow()Z
