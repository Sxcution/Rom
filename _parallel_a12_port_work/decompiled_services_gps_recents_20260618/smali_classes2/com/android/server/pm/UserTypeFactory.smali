...
.method private static getDefaultBuilders()Landroid/util/ArrayMap;
    ...
    invoke-static {}, Lcom/android/server/pm/UserTypeFactory;->getDefaultTypeParallelDefault()Lcom/android/server/pm/UserTypeDetails$Builder;

    move-result-object v1

    const-string v2, "android.os.usertype.parallel.DEFAULT"

    invoke-virtual {v0, v2, v1}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {}, Lcom/android/server/pm/UserTypeFactory;->getDefaultTypeParallelShare()Lcom/android/server/pm/UserTypeDetails$Builder;

    move-result-object v1

    const-string v2, "android.os.usertype.parallel.SHARE"
...
.method private static getDefaultParallelRestrictions()Landroid/os/Bundle;
    .locals 3
...
.method private static getDefaultTypeParallelDefault()Lcom/android/server/pm/UserTypeDetails$Builder;
    .locals 4
    ...
    const-string v1, "android.os.usertype.parallel.DEFAULT"
    ...
    invoke-static {}, Lcom/android/server/pm/UserTypeFactory;->getDefaultParallelRestrictions()Landroid/os/Bundle;
...
.method private static getDefaultTypeParallelShare()Lcom/android/server/pm/UserTypeDetails$Builder;
    .locals 4
    ...
    const-string v1, "android.os.usertype.parallel.SHARE"
