...
.method static synthetic lambda$loadFromXml$4(Lcom/android/server/pm/ShortcutUser;IZLjava/io/File;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/ShortcutUser;->addLauncher(Lcom/android/server/pm/ShortcutLauncher;)V
...
.method public static loadFromXml(Lcom/android/server/pm/ShortcutService;Landroid/util/TypedXmlPullParser;IZ)Lcom/android/server/pm/ShortcutUser;
    ...
    invoke-direct {v0, v4}, Lcom/android/server/pm/ShortcutUser;->addLauncher(Lcom/android/server/pm/ShortcutLauncher;)V
    ...
    invoke-virtual {v4}, Lcom/android/server/pm/ShortcutPackage;->getPackageName()Ljava/lang/String;
...
.method private saveShortcutPackageItem(Landroid/util/TypedXmlSerializer;Lcom/android/server/pm/ShortcutPackageItem;Z)V
    ...
    invoke-virtual {p2, p1, p3}, Lcom/android/server/pm/ShortcutPackageItem;->saveToFile(Ljava/io/File;Z)V
...
.method public attemptToRestoreIfNeededAndSave(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;I)V
    ...
    sget-object p1, Lcom/android/server/pm/ShortcutUser$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/pm/ShortcutUser$$ExternalSyntheticLambda7;
...
.method public detectLocaleChange()V
    ...
    sget-object v0, Lcom/android/server/pm/ShortcutUser$$ExternalSyntheticLambda6;->INSTANCE:Lcom/android/server/pm/ShortcutUser$$ExternalSyntheticLambda6;
...
.method getAppSearch(Landroid/app/appsearch/AppSearchManager$SearchContext;)Lcom/android/internal/infra/AndroidFuture;
    ...
    const-string v1, "app search manager is null"
...
.method public saveToXml(Landroid/util/TypedXmlSerializer;Z)V
    ...
    invoke-direct {p0, p1, v5, p2}, Lcom/android/server/pm/ShortcutUser;->saveShortcutPackageItem(Landroid/util/TypedXmlSerializer;Lcom/android/server/pm/ShortcutPackageItem;Z)V
