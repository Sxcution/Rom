...
.method constructor <init>(Lcom/android/server/usage/AppStandbyController$Injector;)V
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/usage/AppStandbyController$DeviceStateReceiver;-><init>(Lcom/android/server/usage/AppStandbyController;Lcom/android/server/usage/AppStandbyController$1;)V
...
.method private checkAndUpdateStandbyState(Ljava/lang/String;IIJ)V
    ...
    invoke-direct {v0, v8, v1, v9}, Lcom/android/server/usage/AppStandbyController;->getAppMinBucket(Ljava/lang/String;II)I
    ...
    invoke-direct {v0, v2, v10, v11}, Lcom/android/server/usage/AppStandbyController;->predictionTimedOut(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;J)Z
    ...
    iget v3, v2, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->lastPredictedBucket:I
    ...
    :cond_7
    invoke-direct {v0, v8, v9, v10, v11}, Lcom/android/server/usage/AppStandbyController;->getBucketForLocked(Ljava/lang/String;IJ)I
    ...
    :goto_2
    iget-object v14, v0, Lcom/android/server/usage/AppStandbyController;->mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;

    invoke-virtual {v14, v10, v11}, Lcom/android/server/usage/AppIdleHistory;->getElapsedTime(J)J
    ...
    iget-wide v4, v2, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketActiveTimeoutTime:J
    ...
    iget-wide v4, v2, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketWorkingSetTimeoutTime:J
    ...
    :goto_4
    iget-wide v5, v2, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->lastRestrictAttemptElapsedTime:J
    ...
    iget-object v5, v0, Lcom/android/server/usage/AppStandbyController;->mInjector:Lcom/android/server/usage/AppStandbyController$Injector;

    invoke-virtual {v5}, Lcom/android/server/usage/AppStandbyController$Injector;->getAutoRestrictedBucketDelayMs()J
...
.method private evaluateSystemAppException(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/usage/AppStandbyController;->evaluateSystemAppException(Landroid/content/pm/PackageInfo;)Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private getAppMinBucket(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/usage/AppStandbyController;->getAppMinBucket(Ljava/lang/String;II)I
...
.method private getAppMinBucket(Ljava/lang/String;II)I
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/server/usage/AppStandbyController$Injector;->hasScheduleExactAlarm(Ljava/lang/String;I)Z
    ...
    :cond_c
    iget-object p2, p0, Lcom/android/server/usage/AppStandbyController;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method private informListeners(Ljava/lang/String;IIIZ)V
    ...
    check-cast v9, Lcom/android/server/usage/AppStandbyInternal$AppIdleStateChangeListener;
    ...
    invoke-virtual {v9, p1, p2}, Lcom/android/server/usage/AppStandbyInternal$AppIdleStateChangeListener;->onUserInteractionStarted(Ljava/lang/String;I)V
...
.method private loadHeadlessSystemAppCache()V
    ...
    invoke-virtual {v5, v6, v2, v7, v4}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private maybeInformListeners(Ljava/lang/String;IJIIZ)V
    ...
    invoke-virtual {p2, p3, p1}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private reportContentProviderUsage(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v12}, Landroid/content/ContentResolver;->getSyncAdapterPackagesForAuthorityAsUser(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v1, v12}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {v11, v2, v12}, Lcom/android/server/usage/AppStandbyController;->getCrossProfileTargets(Ljava/lang/String;I)Ljava/util/List;
    ...
    :try_start_1
    iget-wide v5, v11, Lcom/android/server/usage/AppStandbyController;->mSyncAdapterTimeoutMillis:J
    :try_end_1
...
.method private reportEventLocked(Ljava/lang/String;IJI)V
    ...
    invoke-direct {v8, v0}, Lcom/android/server/usage/AppStandbyController;->usageEventToSubReason(I)I
    ...
    invoke-virtual {v0, v2, v6, v12, v7}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    invoke-virtual {v0, v2, v9, v10}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-direct {v8, v12, v10, v11}, Lcom/android/server/usage/AppStandbyController;->notifyBatteryStats(Ljava/lang/String;IZ)V
...
.method private reportNoninteractiveUsageLocked(Ljava/lang/String;IIIJJ)V
    ...
    invoke-virtual {v4, v5, p2, v6, p1}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    invoke-virtual {v4, v5, v1, v2}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private setAppStandbyBucket(Ljava/lang/String;IIIJZ)V
    ...
    :cond_6
    iget v3, v4, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketingReason:I
    ...
    iget v14, v4, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketingReason:I
    ...
    :goto_3
    iget v5, v4, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->currentBucket:I
    ...
    iget v1, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketingReason:I
    ...
    :goto_4
    iget v2, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->currentBucket:I

    const/16 v4, 0x200

    if-ne v2, v15, :cond_e

    iget v2, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketingReason:I
    ...
    :cond_10
    iget-wide v1, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->lastUsedByUserElapsedTime:J
    ...
    invoke-virtual {v0, v3, v10, v4, v9}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v3

    invoke-virtual {v0, v3, v1, v2}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v4, v14, v2, v3, v5}, Lcom/android/server/usage/AppIdleHistory;->updateLastPrediction(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;JI)V
    ...
    iget-wide v4, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketActiveTimeoutTime:J
    ...
    iget-wide v5, v14, Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;->bucketWorkingSetTimeoutTime:J
    ...
    invoke-direct {v0, v9, v10, v11, v12}, Lcom/android/server/usage/AppStandbyController;->getBucketForLocked(Ljava/lang/String;IJ)I
...
.method public dumpState([Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/usage/AppStandbyController$Injector;->dump(Ljava/io/PrintWriter;)V
...
.method public getIdleUidsForUser(I)[I
    ...
    invoke-virtual {v0, v11, v12, v1}, Landroid/content/pm/PackageManagerInternal;->getInstalledApplications(III)Ljava/util/List;
    ...
    :cond_6
    invoke-virtual {v14, v11, v0}, Landroid/util/SparseBooleanArray;->setValueAt(IZ)V
...
.method public isAppIdleFiltered(Ljava/lang/String;IIJ)Z
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/usage/AppStandbyController;->mAppIdleLock:Ljava/lang/Object;
...
.method maybeUnrestrictBuggyApp(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, p1, p2, v5, v6}, Lcom/android/server/usage/AppIdleHistory;->getAppUsageHistory(Ljava/lang/String;IJ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
...
.method public onBootPhase(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;->post(Ljava/lang/Runnable;)Z
...
.method public onUsageEvent(ILandroid/app/usage/UsageEvents$Event;)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/usage/AppStandbyController;->getCrossProfileTargets(Ljava/lang/String;I)Ljava/util/List;
...
.method public restrictApp(Ljava/lang/String;III)V
    ...
    const-string p3, "Tried to restrict app "
    ...
    const-string p3, "Tried to restrict uninstalled app: "
...
.method public setAppStandbyBuckets(Ljava/util/List;III)V
    ...
    invoke-virtual {v0, v1, v2, v10}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
