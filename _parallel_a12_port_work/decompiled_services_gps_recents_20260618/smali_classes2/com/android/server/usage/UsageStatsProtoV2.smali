...
.method public static read(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-virtual {v2, p0}, Landroid/app/usage/EventList;->insert(Landroid/app/usage/UsageEvents$Event;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, v4, v5}, Lcom/android/server/usage/UsageStatsProtoV2;->parseUsageStats(Landroid/util/proto/ProtoInputStream;J)Landroid/app/usage/UsageStats;

    move-result-object p0

    invoke-virtual {v0, v2, v3}, Landroid/util/proto/ProtoInputStream;->end(J)V

    iget v2, p0, Landroid/app/usage/UsageStats;->mPackageToken:I
...
.method private static writeEvent(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/UsageEvents$Event;)V
    ...
    iget p3, p3, Landroid/app/usage/UsageEvents$Event;->mLocusIdToken:I
    ...
    iget p3, p3, Landroid/app/usage/UsageEvents$Event;->mNotificationChannelIdToken:I
    ...
    iget p3, p3, Landroid/app/usage/UsageEvents$Event;->mBucketAndReason:I
    ...
    iget p3, p3, Landroid/app/usage/UsageEvents$Event;->mShortcutIdToken:I
