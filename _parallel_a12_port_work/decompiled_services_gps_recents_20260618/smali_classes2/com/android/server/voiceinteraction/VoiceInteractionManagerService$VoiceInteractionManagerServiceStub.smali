...
.method private createSoundTriggerSessionForSelfIdentity(Landroid/os/IBinder;)Lcom/android/internal/app/IVoiceInteractionSoundTriggerSession;
    ...
    check-cast p1, Lcom/android/internal/app/IVoiceInteractionSoundTriggerSession;
...
.method private initForUserNoTracing(I)V
    ...
    :try_start_0
    invoke-interface {v4, v1, v7, p1}, Landroid/content/pm/IPackageManager;->getServiceInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ServiceInfo;
    ...
    invoke-interface {v4, v6, v7, p1}, Landroid/content/pm/IPackageManager;->getServiceInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ServiceInfo;
...
.method private queryInteractorServices(ILjava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v0, p2, v1, p1}, Landroid/content/pm/PackageManager;->queryIntentServicesAsUser(Landroid/content/Intent;II)Ljava/util/List;
...
.method private resetServicesIfNoRecognitionService(Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;->queryInteractorServices(ILjava/lang/String;)Ljava/util/List;
...
.method private setCurrentUserLocked(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/UserManagerInternal;->getUserInfo(I)Landroid/content/pm/UserInfo;

    move-result-object p1

    iget-object v0, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;->this$0:Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;

    invoke-static {v0, p1}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;->access$100(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;Landroid/content/pm/UserInfo;)Z
...
.method public createSoundTriggerSessionAsOriginator(Landroid/media/permission/Identity;Landroid/os/IBinder;)Lcom/android/internal/app/IVoiceInteractionSoundTriggerSession;
    ...
    invoke-direct {v0, p2, v1, p1}, Lcom/android/server/voiceinteraction/SoundTriggerSessionPermissionsDecorator;-><init>(Lcom/android/internal/app/IVoiceInteractionSoundTriggerSession;Landroid/content/Context;Landroid/media/permission/Identity;)V
    ...
    :cond_2
    :goto_1
    new-instance p1, Lcom/android/server/voiceinteraction/SoundTriggerSessionBinderProxy;

    invoke-direct {p1, v0}, Lcom/android/server/voiceinteraction/SoundTriggerSessionBinderProxy;-><init>(Lcom/android/internal/app/IVoiceInteractionSoundTriggerSession;)V
...
.method public deleteKeyphraseSoundModel(ILjava/lang/String;)I
    ...
    invoke-static {v3, p1}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub$SoundTriggerSession;->access$200(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub$SoundTriggerSession;I)I
...
.method findAvailInteractor(ILjava/lang/String;)Landroid/service/voice/VoiceInteractionServiceInfo;
    ...
    const-string v0, "no available voice interaction services found for user "
...
.method findAvailRecognizer(Ljava/lang/String;I)Landroid/content/ComponentName;
    ...
    const-string v0, "no available voice recognition services found for user "
    ...
    const-string v3, "No selectableAsDefault recognition services found for user "
    ...
    invoke-virtual {v4}, Lcom/android/server/voiceinteraction/RecognitionServiceInfo;->getServiceInfo()Landroid/content/pm/ServiceInfo;
    ...
    const-string p1, "more than one voice recognition service found, picking first"
...
.method public getEnrolledKeyphraseMetadata(Ljava/lang/String;Ljava/lang/String;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    new-instance p2, Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    invoke-direct {p2, v0, v3, p1, v4}, Landroid/hardware/soundtrigger/KeyphraseMetadata;-><init>(ILjava/lang/String;Ljava/util/Set;I)V
    :try_end_2
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string p2, "VoiceInteractionManager"
...
.method public setUiHints(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;->access$600(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;)Landroid/os/RemoteCallbackList;
...
.method switchImplementationIfNeededNoTracingLocked(Z)V
    ...
    iget-object v5, v0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;->mContext:Landroid/content/Context;
