...
.method private getTaskAnimationBackgroundColor()I
    ...
    iget v2, v1, Landroid/view/TaskTransitionSpec;->backgroundColor:I

    if-eqz v2, :cond_0

    iget v0, v1, Landroid/view/TaskTransitionSpec;->backgroundColor:I
...
.method private loadAnimation(Landroid/view/WindowManager$LayoutParams;IZZ)Landroid/view/animation/Animation;
    ...
    iget v15, v4, Landroid/view/DisplayInfo;->appWidth:I

    iget v13, v4, Landroid/view/DisplayInfo;->appHeight:I

    sget-boolean v5, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_APP_TRANSITIONS_ANIM_enabled:Z
    ...
    invoke-static {v7, v8, v6, v2, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_1
    new-instance v12, Landroid/graphics/Rect;

    invoke-direct {v12, v6, v6, v15, v13}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-virtual {v14, v12, v8, v10, v9}, Lcom/android/server/wm/WindowContainer;->getAnimationFrames(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    iget-boolean v4, v14, Lcom/android/server/wm/WindowContainer;->mLaunchTaskBehind:Z
    ...
    invoke-static {v2, v5, v3, v6, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    invoke-static {p1, v1}, Landroid/os/Debug;->getCallers(ILjava/lang/String;)Ljava/lang/String;
...
.method protected applyAnimationUnchecked(Landroid/view/WindowManager$LayoutParams;ZIZLjava/util/ArrayList;)V
    ...
    invoke-direct {p1, p0, p4}, Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;-><init>(Lcom/android/server/wm/WindowContainer;Lcom/android/server/wm/WindowContainer$1;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/WindowContainer;->getTaskAnimationBackgroundColor()I

    move-result p3

    invoke-static {p1, p3}, Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;->access$300(Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;I)V

    iget-object p3, p0, Lcom/android/server/wm/WindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object p3, p3, Lcom/android/server/wm/WindowManagerService;->mTaskTransitionSpec:Landroid/view/TaskTransitionSpec;
    ...
    iget-object p3, p3, Landroid/view/TaskTransitionSpec;->animationBoundInsets:Ljava/util/Set;

    invoke-static {p1, p3}, Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;->access$400(Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;Ljava/util/Set;)V

    :cond_3
    invoke-static {p1}, Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;->access$500(Lcom/android/server/wm/WindowContainer$AnimationRunnerBuilder;)Lcom/android/server/wm/WindowContainer$IAnimationStarter;
...
.method finishSync(Landroid/view/SurfaceControl$Transaction;Z)V
    ...
    invoke-static {v4, v5, v6, v2, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method forAllRootTasks(Ljava/util/function/Function;Z)Z
    ...
    invoke-virtual {v4, p1, p2}, Lcom/android/server/wm/WindowContainer;->forAllRootTasks(Ljava/util/function/Function;Z)Z
...
.method getAnimationAdapter(Landroid/view/WindowManager$LayoutParams;IZZ)Landroid/util/Pair;
    ...
    invoke-virtual {v3, v0, v5}, Landroid/graphics/Rect;->offsetTo(II)V
    ...
    :goto_1
    invoke-virtual {v0, v11}, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;->setMode(I)V
...
.method getItemFromRootTasks(Ljava/util/function/Function;Z)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/server/wm/WindowContainer;->getItemFromRootTasks(Ljava/util/function/Function;Z)Ljava/lang/Object;
...
.method getRequestedConfigurationOrientation(Z)I
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->getNaturalOrientation()I
...
.method getTopActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object p1, Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda5;
    ...
    :cond_0
    sget-object p1, Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda6;->INSTANCE:Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda6;
    ...
    sget-object p1, Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda7;
    ...
    :cond_2
    sget-object p1, Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda8;->INSTANCE:Lcom/android/server/wm/WindowContainer$$ExternalSyntheticLambda8;
...
.method initializeChangeTransition(Landroid/graphics/Rect;Landroid/view/SurfaceControl;)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/WindowContainer;->mTmpPoint:Landroid/graphics/Point;

    invoke-virtual {v0, v1, p1, v2, p2}, Lcom/android/server/wm/SurfaceFreezer;->freeze(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;Landroid/graphics/Point;Landroid/view/SurfaceControl;)V
...
.method final isAnimatingExcluding(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/WindowContainer;->isAnimating(II)Z
...
.method resetSurfacePositionForAnimationLeash(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowContainer;->mLastSurfacePosition:Landroid/graphics/Point;
...
.method setSyncGroup(Lcom/android/server/wm/BLASTSyncEngine$SyncGroup;)V
    ...
    const-string v0, "Can\'t sync on 2 engines simultaneously"
...
.method startAnimation(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/AnimationAdapter;ZILcom/android/server/wm/SurfaceAnimator$OnAnimationFinishedCallback;Ljava/lang/Runnable;Lcom/android/server/wm/AnimationAdapter;)V
    ...
    iget-object v8, v0, Lcom/android/server/wm/WindowContainer;->mSurfaceFreezer:Lcom/android/server/wm/SurfaceFreezer;
...
.method writeIdentifierToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    const-string v2, "WindowContainer"
