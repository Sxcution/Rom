...
.method onBackPressedOnTaskRoot(Lcom/android/server/wm/Task;)V
    ...
    invoke-interface {v0, p1}, Landroid/window/ITaskOrganizer;->onBackPressedOnTaskRoot(Landroid/app/ActivityManager$RunningTaskInfo;)V
    :try_end_0
    ...
    const-string v1, "Exception sending onBackPressedOnTaskRoot callback"
...
.method onTaskAppeared(Lcom/android/server/wm/Task;)V
    ...
    invoke-interface {v1, v0, p1}, Landroid/window/ITaskOrganizer;->onTaskAppeared(Landroid/app/ActivityManager$RunningTaskInfo;Landroid/view/SurfaceControl;)V
    :try_end_0
    ...
    const-string v1, "Exception sending onTaskAppeared callback"
...
.method onTaskInfoChanged(Lcom/android/server/wm/Task;Landroid/app/ActivityManager$RunningTaskInfo;)V
    ...
    :cond_2
    :try_start_0
    iget-object p1, p0, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerCallbacks;->mTaskOrganizer:Landroid/window/ITaskOrganizer;

    invoke-interface {p1, p2}, Landroid/window/ITaskOrganizer;->onTaskInfoChanged(Landroid/app/ActivityManager$RunningTaskInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v0, "Exception sending onTaskInfoChanged callback"
...
.method onTaskVanished(Lcom/android/server/wm/Task;)V
    ...
    const-string v1, "Exception sending onTaskVanished callback"
...
.method prepareLeash(Lcom/android/server/wm/Task;Ljava/lang/String;)Landroid/view/SurfaceControl;
    ...
    invoke-direct {v0, p1, p2}, Landroid/view/SurfaceControl;-><init>(Landroid/view/SurfaceControl;Ljava/lang/String;)V
