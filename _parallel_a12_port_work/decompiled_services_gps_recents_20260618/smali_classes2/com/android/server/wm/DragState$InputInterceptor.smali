...
.method constructor <init>(Lcom/android/server/wm/DragState;Landroid/view/Display;)V
    ...
    iput v0, p2, Landroid/view/InputWindowHandle;->layoutParamsFlags:I

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    const/16 v1, 0x7e0

    iput v1, p2, Landroid/view/InputWindowHandle;->layoutParamsType:I
    ...
    iput-wide v1, p2, Landroid/view/InputWindowHandle;->dispatchingTimeoutMillis:J
    ...
    iput-boolean v1, p2, Landroid/view/InputWindowHandle;->focusable:Z

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    iput-boolean v0, p2, Landroid/view/InputWindowHandle;->hasWallpaper:Z

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    iput-boolean v0, p2, Landroid/view/InputWindowHandle;->paused:Z
    ...
    iput v1, p2, Landroid/view/InputWindowHandle;->ownerPid:I
    ...
    iput v1, p2, Landroid/view/InputWindowHandle;->ownerUid:I

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    iput v0, p2, Landroid/view/InputWindowHandle;->inputFeatures:I

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p2, Landroid/view/InputWindowHandle;->scaleFactor:F
    ...
    iput v0, p2, Landroid/view/InputWindowHandle;->frameLeft:I

    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Landroid/view/InputWindowHandle;

    iput v0, p2, Landroid/view/InputWindowHandle;->frameTop:I
    ...
    iput v1, p2, Landroid/view/InputWindowHandle;->frameRight:I
    ...
    iput v1, p2, Landroid/view/InputWindowHandle;->frameBottom:I
    ...
    invoke-static {p2, v1, v0, v2, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_0
    iget-object p1, p1, Lcom/android/server/wm/DragState;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object p1, p1, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    sget-object p2, Lcom/android/server/wm/DragState$InputInterceptor$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/wm/DragState$InputInterceptor$$ExternalSyntheticLambda0;
