...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/WindowOrganizerController;->mTaskOrganizerController:Lcom/android/server/wm/TaskOrganizerController;

    iput-object p1, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mTaskOrganizerController:Lcom/android/server/wm/TaskOrganizerController;
...
.method static synthetic access$1800(Lcom/android/server/wm/ActivityTaskManagerService;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mPendingTempAllowlist:Landroid/util/SparseArray;
...
.method private canCloseSystemDialogs(II)Z
    ...
    :cond_4
    :try_start_3
    iget-object v1, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mAccessibilityServiceUids:[I
...
.method private checkCanCloseSystemDialogs(IILjava/lang/String;)Z
    ...
    const-string p3, "Permission Denial: android.intent.action.CLOSE_SYSTEM_DIALOGS broadcast from "
    ...
    const-string p3, ", dropping broadcast."
    ...
    const-string v1, "android.intent.action.CLOSE_SYSTEM_DIALOGS broadcast from "

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, " will require "
    ...
    const-string v0, " in future builds."
...
.method private dumpActivity(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/wm/ActivityRecord;[Ljava/lang/String;Z)V
    ...
    iget-object p4, p4, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
    ...
    :try_start_3
    invoke-virtual {p6}, Lcom/android/internal/os/TransferPipe;->close()V
    :try_end_3
...
.method private enforceCallerIsDream(Ljava/lang/String;)V
    ...
    const-string v2, "The dream activity can be started only when the device is dreaming and only by the active dream package."
...
.method private pendingAssistExtrasTimedOut(Lcom/android/server/wm/ActivityTaskManagerService$PendingAssistExtras;)V
    ...
    const-string v1, "receiverExtras"
...
.method private startActivityAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;IZ)I
    ...
    invoke-virtual {v1, p4, v2}, Lcom/android/server/wm/ActivityStartController;->obtainStarter(Landroid/content/Intent;Ljava/lang/String;)Lcom/android/server/wm/ActivityStarter;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/wm/ActivityStarter;->setUserId(I)Lcom/android/server/wm/ActivityStarter;
...
.method public addAppTask(Landroid/os/IBinder;Landroid/content/Intent;Landroid/app/ActivityManager$TaskDescription;Landroid/graphics/Bitmap;)I
    ...
    invoke-interface {p4, p1, v5, v6}, Landroid/content/pm/IPackageManager;->getActivityInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/RecentTasks;->addToBottom(Lcom/android/server/wm/Task;)Z

    move-result p2

    if-nez p2, :cond_4

    const-string p2, "addAppTask"

    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/Task;->removeChild(Lcom/android/server/wm/WindowContainer;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p3}, Landroid/app/ActivityManager$TaskDescription;->copyFrom(Landroid/app/ActivityManager$TaskDescription;)V
    ...
    iget p3, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mThumbnailHeight:I
    ...
    const-string p4, "Activity does not exist; token="
...
.method public cancelRecentsAnimation(Z)V
    ...
    invoke-virtual {v5, p1, v0}, Lcom/android/server/wm/WindowManagerService;->cancelRecentsAnimation(ILjava/lang/String;)V
...
.method collectGrants(Landroid/content/Intent;Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/uri/NeededUriGrants;
    ...
    invoke-interface {v0, p1, v1, v2, p2}, Lcom/android/server/uri/UriGrantsManagerInternal;->checkGrantUriPermissionFromIntent(Landroid/content/Intent;ILjava/lang/String;I)Lcom/android/server/uri/NeededUriGrants;
...
.method protected dumpActivity(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZZZ)Z
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/android/server/wm/RootWindowContainer;->getDumpActivities(Ljava/lang/String;ZZ)Ljava/util/ArrayList;
...
.method endLaunchPowerMode(I)V
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/wm/RootWindowContainer;->getChildAt(I)Lcom/android/server/wm/WindowContainer;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/ActivityTaskManagerService$H;->removeMessages(I)V
...
.method ensureConfigAndVisibilityAfterUpdate(Lcom/android/server/wm/ActivityRecord;I)Z
    ...
    invoke-virtual {v2, p1, p2, v0}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method enterPictureInPictureMode(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureParams;)Z
    ...
    invoke-virtual {p2, p1, v2, v0}, Lcom/android/server/wm/ActivityClientController;->dismissKeyguard(Landroid/os/IBinder;Lcom/android/internal/policy/IKeyguardDismissCallback;Ljava/lang/CharSequence;)V
...
.method public getAnrController(Landroid/content/pm/ApplicationInfo;)Landroid/app/AnrController;
    ...
    iget-object v3, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mAnrController:Ljava/util/List;
    ...
    invoke-interface {v7, v1, p1}, Landroid/app/AnrController;->getAnrDelayMillis(Ljava/lang/String;I)J
...
.method public getFocusedRootTaskInfo()Landroid/app/ActivityTaskManager$RootTaskInfo;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/wm/RootWindowContainer;->getRootTaskInfo(I)Landroid/app/ActivityTaskManager$RootTaskInfo;
...
.method public getTaskBounds(I)Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object p1, v4, Lcom/android/server/wm/Task;->mLastNonFullscreenBounds:Landroid/graphics/Rect;
...
.method public getTaskDescriptionIcon(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    if-eqz v0, :cond_skip_user_check
...
.method public initialize(Lcom/android/server/firewall/IntentFirewall;Lcom/android/server/am/PendingIntentController;Landroid/os/Looper;)V
    ...
    invoke-direct {p1, p2, p3, v0}, Lcom/android/server/wm/TaskChangeNotificationController;-><init>(Ljava/lang/Object;Lcom/android/server/wm/ActivityTaskSupervisor;Landroid/os/Handler;)V
...
.method public final isActivityStartAllowedOnDisplay(ILandroid/content/Intent;Ljava/lang/String;I)Z
    ...
    iget-object p4, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    invoke-virtual {p4, p1, v1, v0, p2}, Lcom/android/server/wm/ActivityTaskSupervisor;->canPlaceEntityOnDisplay(IIILandroid/content/pm/ActivityInfo;)Z
...
.method isGetTasksAllowed(Ljava/lang/String;II)Z
    ...
    invoke-virtual {p0, v3, p2, p3}, Lcom/android/server/wm/ActivityTaskManagerService;->checkGetTasksPermission(Ljava/lang/String;II)I
    ...
    const v8, -0x36ab9724    # -870029.75f
    ...
    invoke-static {v0, v8, v5, v4, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-static {v6, v7, v5, v4, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public synthetic lambda$enterPictureInPictureMode$3$ActivityTaskManagerService(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureParams;)V
    ...
    const-string v2, "Skip enterPictureInPictureMode, destroyed "
    ...
    invoke-virtual {p2}, Landroid/app/PictureInPictureParams;->getAspectRatio()F
    ...
    invoke-virtual {v2, p1, v3}, Lcom/android/server/wm/RootWindowContainer;->moveActivityToPinnedRootTask(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->getTask()Lcom/android/server/wm/Task;

    move-result-object v2

    invoke-virtual {v2, p2}, Lcom/android/server/wm/Task;->setPictureInPictureAspectRatio(F)V

    invoke-virtual {v2, v1}, Lcom/android/server/wm/Task;->setPictureInPictureActions(Ljava/util/List;)V

    invoke-virtual {v2}, Lcom/android/server/wm/Task;->getPausingActivity()Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v2, p1, v1, v1, p2}, Lcom/android/server/wm/Task;->schedulePauseActivity(Lcom/android/server/wm/ActivityRecord;ZZLjava/lang/String;)V
...
.method moveTaskToFrontLocked(Landroid/app/IApplicationThread;Ljava/lang/String;IILcom/android/server/wm/SafeActivityOptions;)V
    ...
    invoke-virtual {v3, v15, v7}, Lcom/android/server/wm/ActivityStartController;->obtainStarter(Landroid/content/Intent;Ljava/lang/String;)Lcom/android/server/wm/ActivityStarter;
    ...
    invoke-static {v3, v4, v10, v15, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public moveTaskToRootTask(IIZ)V
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/Task;->isActivityTypeStandardOrUndefined()Z
...
.method onImeWindowSetOnDisplayArea(ILcom/android/server/wm/DisplayArea;)V
    ...
    sget-boolean p2, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_CONFIGURATION_enabled:Z
    ...
    invoke-static {v0, v3, v4, v2, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p2, v1, v2, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public onPictureInPictureStateChanged(Landroid/app/PictureInPictureUiState;)V
    ...
    invoke-virtual {v1, v0, p1}, Lcom/android/server/wm/ActivityClientController;->onPictureInPictureStateChanged(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureUiState;)V
...
.method public onScreenAwakeChanged(Z)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/android/server/wm/ActivityTaskManagerService$H;->removeMessages(ILjava/lang/Object;)V

    iget-object p1, p0, Lcom/android/server/wm/ActivityTaskManagerService;->mH:Lcom/android/server/wm/ActivityTaskManagerService$H;

    invoke-virtual {p1, v1, v0}, Lcom/android/server/wm/ActivityTaskManagerService$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    const-wide/16 v1, 0x7d0

    invoke-virtual {p1, v0, v1, v2}, Lcom/android/server/wm/ActivityTaskManagerService$H;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public onSplashScreenViewCopyFinished(ILandroid/window/SplashScreenView$SplashScreenViewParcelable;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/Task;->getTopWaitSplashScreenActivity()Lcom/android/server/wm/ActivityRecord;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityRecord;->onCopySplashScreenFinish(Landroid/window/SplashScreenView$SplashScreenViewParcelable;)V
...
.method public releaseSomeActivities(Landroid/app/IApplicationThread;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/WindowProcessController;->releaseSomeActivities(Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public removeTask(I)Z
    ...
    invoke-virtual {p1, v3, v4, v4, v5}, Lcom/android/server/wm/ActivityTaskSupervisor;->removeTask(Lcom/android/server/wm/Task;ZZLjava/lang/String;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityTaskSupervisor;->removeRootTask(Lcom/android/server/wm/Task;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public reportAssistContextExtras(Landroid/os/IBinder;Landroid/os/Bundle;Landroid/app/assist/AssistStructure;Landroid/app/assist/AssistContent;Landroid/net/Uri;)V
    ...
    invoke-virtual {p4}, Lcom/android/server/wm/ActivityRecord;->isAttached()Z
...
.method public requestAssistDataForTask(Landroid/app/IAssistDataReceiver;ILjava/lang/String;)Z
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/wm/ActivityTaskManagerInternal;->getTopActivityForTask(I)Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;
...
.method public requestStartActivityPermissionToken(Landroid/os/IBinder;)Landroid/os/IBinder;
    ...
    sget-object p1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda17;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda17;
    ...
    sget-object p1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda16;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda16;
...
.method resolveActivityInfoForIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p2, p1, p3}, Landroid/app/ActivityManagerInternal;->getActivityInfoForUser(Landroid/content/pm/ActivityInfo;I)Landroid/content/pm/ActivityInfo;
...
.method public retrieveSettings(Landroid/content/ContentResolver;)V
    ...
    const-string v9, "debug.force_rtl"

    invoke-static {v1, v9, v4}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_3
    const-string v10, "force_resizable_activities"
    ...
    :goto_4
    const-string v11, "enable_non_resizable_multi_window"
    ...
    :goto_5
    iget-object v12, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mContext:Landroid/content/Context;
    ...
    iput-boolean v10, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mForceResizableActivities:Z

    iput-boolean v11, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mDevEnableNonResizableMultiWindow:Z

    iput v12, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsNonResizableMultiWindow:I

    iput v13, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mRespectsActivityMinWidthHeightMultiWindow:I

    iput v14, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mMinPercentageMultiWindowSupportHeight:F

    iput v4, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mMinPercentageMultiWindowSupportWidth:F

    iput v3, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mLargeScreenSmallestScreenWidthDp:I
    ...
    iput-boolean v7, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsSplitScreenMultiWindow:Z

    iput-boolean v6, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsPictureInPicture:Z

    iput-boolean v8, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsMultiDisplay:Z
...
.method public setFocusedRootTask(I)V
    ...
    const-string v5, "setFocusedRootTask: No task with id="
...
.method setFocusedTask(ILcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p1, v2, v1}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
...
.method setResumedActivityUncheckLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
    ...
    :goto_4
    invoke-static {v0, p1, p2}, Lcom/android/server/wm/EventLogTags;->writeWmSetResumedActivity(ILjava/lang/String;Ljava/lang/String;)V
...
.method public setRunningRemoteTransitionDelegate(Landroid/app/IApplicationThread;)V
    ...
    const-string v3, "Unable to find process for application "
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/wm/WindowProcessController;->addRemoteAnimationDelegate(Lcom/android/server/wm/WindowProcessController;)V
    ...
    const-string v3, "Can\'t call setRunningRemoteTransition from a process (pid="
    ...
    const-string v0, ") which isn\'t itself running a remote transition."
...
.method public final startActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;Landroid/os/IBinder;ZI)I
    ...
    :cond_2
    invoke-static {p2}, Lcom/android/server/wm/ActivityRecord;->isInAnyTask(Landroid/os/IBinder;)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object v0, p9, Lcom/android/server/wm/ActivityRecord;->launchedFromFeatureId:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityStarter;->setCallingFeatureId(Ljava/lang/String;)Lcom/android/server/wm/ActivityStarter;
    ...
    invoke-virtual {p1, p13}, Lcom/android/server/wm/ActivityStarter;->setUserId(I)Lcom/android/server/wm/ActivityStarter;
...
.method public final startActivityFromRecents(ILandroid/os/Bundle;)I
    ...
    invoke-virtual {v4, v0, v1, p1, p2}, Lcom/android/server/wm/ActivityTaskSupervisor;->startActivityFromRecents(IIILcom/android/server/wm/SafeActivityOptions;)I
...
.method public final startActivityWithConfig(Landroid/app/IApplicationThread;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    invoke-virtual {p1, p6}, Lcom/android/server/wm/ActivityStarter;->setResultTo(Landroid/os/IBinder;)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, p7}, Lcom/android/server/wm/ActivityStarter;->setResultWho(Ljava/lang/String;)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, p8}, Lcom/android/server/wm/ActivityStarter;->setRequestCode(I)Lcom/android/server/wm/ActivityStarter;
    ...
    invoke-virtual {p1, p10}, Lcom/android/server/wm/ActivityStarter;->setGlobalConfiguration(Landroid/content/res/Configuration;)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, p11}, Lcom/android/server/wm/ActivityStarter;->setActivityOptions(Landroid/os/Bundle;)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, p12}, Lcom/android/server/wm/ActivityStarter;->setUserId(I)Lcom/android/server/wm/ActivityStarter;
...
.method public startAssistantActivity(Ljava/lang/String;Ljava/lang/String;IILandroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;I)I
    ...
    invoke-virtual {p1, p7}, Lcom/android/server/wm/ActivityStarter;->setActivityOptions(Landroid/os/Bundle;)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, p3}, Lcom/android/server/wm/ActivityStarter;->setUserId(I)Lcom/android/server/wm/ActivityStarter;
...
.method public startDreamActivity(Landroid/content/Intent;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityStarter;->setActivityOptions(Landroid/os/Bundle;)Lcom/android/server/wm/ActivityStarter;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityStarter;->setRealCallingUid(I)Lcom/android/server/wm/ActivityStarter;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/android/server/wm/ActivityStarter;->setAllowBackgroundActivityStart(Z)Lcom/android/server/wm/ActivityStarter;
...
.method startLaunchPowerMode(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskManagerService$H;->removeMessages(I)V
    ...
    invoke-virtual {p1, v0, v1, v2}, Lcom/android/server/wm/ActivityTaskManagerService$H;->sendEmptyMessageDelayed(IJ)Z

    const-string p1, "ActivityTaskManager"

    const-string v0, "Temporarily retain top process state for launching app"
...
.method startLockTaskMode(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {v1, p1, p2, v0}, Lcom/android/server/wm/LockTaskController;->startLockTaskMode(Lcom/android/server/wm/Task;ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public startNextMatchingActivity(Landroid/os/IBinder;Landroid/content/Intent;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v2, v7}, Lcom/android/server/wm/ActivityStarter;->setCallingFeatureId(Ljava/lang/String;)Lcom/android/server/wm/ActivityStarter;
...
.method startProcessAsync(Lcom/android/server/wm/ActivityRecord;ZZLjava/lang/String;)V
    ...
    :cond_0
    sget-object v2, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda0;
...
.method updateActivityUsageStats(Lcom/android/server/wm/ActivityRecord;I)V
    ...
    :goto_0
    sget-object v1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda1;
    ...
    iget-object v6, p1, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
...
.method public updateAssetConfiguration(Ljava/util/List;Z)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/wm/WindowProcessController;->updateAssetConfiguration(I)V
...
.method public updateConfiguration(Landroid/content/res/Configuration;)Z
    ...
    const-string v1, "Skip updateConfiguration because mWindowManager isn\'t set"
    ...
    sget-object v1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda15;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda15;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/ActivityTaskManagerService$H;->sendMessage(Landroid/os/Message;)Z
...
.method updateGlobalConfigurationLocked(Landroid/content/res/Configuration;ZZI)I
    ...
    sget-object v7, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda19;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda19;
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/wm/ActivityTaskManagerService$H;->sendMessage(Landroid/os/Message;)Z
    ...
    sget-object v1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda5;
    ...
    :cond_8
    sget-object v1, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda4;
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/wm/RootWindowContainer;->onConfigurationChanged(Landroid/content/res/Configuration;)V
