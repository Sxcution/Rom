...
.method private reportImeDrawnForOrganizer(Lcom/android/server/wm/InsetsControlTarget;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/TaskOrganizerController;->reportImeDrawnOnTask(Lcom/android/server/wm/Task;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/ImeInsetsSourceProvider;->mImeRequester:Lcom/android/server/wm/InsetsControlTarget;
...
.method dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    iget-boolean p4, p0, Lcom/android/server/wm/ImeInsetsSourceProvider;->mIsImeLayoutDrawn:Z
...
.method getControl(Lcom/android/server/wm/InsetsControlTarget;)Landroid/view/InsetsSourceControl;
    ...
    invoke-virtual {v1, v3, v2, v2, v2}, Lcom/android/server/wm/WindowManagerService;->getTaskSnapshot(IIZZ)Landroid/window/TaskSnapshot;
    ...
    invoke-virtual {v1}, Landroid/window/TaskSnapshot;->hasImeSurface()Z
    ...
    :goto_1
    invoke-virtual {v0, v2}, Landroid/view/InsetsSourceControl;->setSkipAnimationOnce(Z)V
...
.method isReadyToShowIme()Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/ImeInsetsSourceProvider;->isImeFallbackTarget(Lcom/android/server/wm/InsetsControlTarget;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/ImeInsetsSourceProvider;->isImeInputTarget(Lcom/android/server/wm/InsetsControlTarget;)Z
...
.method scheduleShowImePostLayout(Lcom/android/server/wm/InsetsControlTarget;)V
    ...
    invoke-static {v0, v2, v1, p1, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3, v1, p1, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/ImeInsetsSourceProvider;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
