...
.method constructor <init>(Landroid/view/Display;Lcom/android/server/wm/RootWindowContainer;)V
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/android/server/wm/AppTransition;-><init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {v0, p2, p0}, Lcom/android/server/wm/PointerEventDispatcher;-><init>(Landroid/view/InputChannel;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/DisplayContent;->configureSurfaces(Landroid/view/SurfaceControl$Transaction;)V
...
.method private static addToGlobalAndConsumeLimit(Landroid/graphics/Region;Landroid/graphics/Region;Landroid/graphics/Rect;ILcom/android/server/wm/WindowState;I)I
    ...
    invoke-direct {v2, v0, p2, p1}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda38;-><init>([I[ILandroid/graphics/Region;)V
...
.method private adjustDisplaySizeRanges(Landroid/view/DisplayInfo;IIII)V
    ...
    iget p4, p1, Landroid/view/DisplayInfo;->smallestNominalAppWidth:I

    if-ge p3, p4, :cond_0

    iget p3, p2, Landroid/graphics/Point;->x:I

    iput p3, p1, Landroid/view/DisplayInfo;->smallestNominalAppWidth:I

    :cond_0
    iget p3, p2, Landroid/graphics/Point;->x:I

    iget p4, p1, Landroid/view/DisplayInfo;->largestNominalAppWidth:I

    if-le p3, p4, :cond_1

    iget p3, p2, Landroid/graphics/Point;->x:I

    iput p3, p1, Landroid/view/DisplayInfo;->largestNominalAppWidth:I

    :cond_1
    iget p3, p2, Landroid/graphics/Point;->y:I

    iget p4, p1, Landroid/view/DisplayInfo;->smallestNominalAppHeight:I

    if-ge p3, p4, :cond_2

    iget p3, p2, Landroid/graphics/Point;->y:I

    iput p3, p1, Landroid/view/DisplayInfo;->smallestNominalAppHeight:I

    :cond_2
    iget p3, p2, Landroid/graphics/Point;->y:I

    iget p4, p1, Landroid/view/DisplayInfo;->largestNominalAppHeight:I
...
.method private applyRotation(II)V
    ...
    invoke-direct {v0, v3, p1, p2, v1}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda15;-><init>(Landroid/view/SurfaceControl$Transaction;IIZ)V

    invoke-virtual {p0, v0, v2}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    new-instance p1, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda34;

    invoke-direct {p1, v1}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda34;-><init>(Z)V
...
.method private assignRelativeLayerForIme(Landroid/view/SurfaceControl$Transaction;Z)V
    ...
    sget-object v3, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda54;->INSTANCE:Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda54;

    invoke-virtual {v2, v3}, Lcom/android/server/wm/WindowToken;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v2, p1, v0, v1, p2}, Lcom/android/server/wm/DisplayContent$ImeContainer;->assignRelativeLayer(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;IZ)V
...
.method private calculateDisplayCutoutForRotationUncached(Landroid/view/DisplayCutout;I)Lcom/android/server/wm/utils/WmDisplayCutout;
    ...
    invoke-virtual {p1}, Landroid/view/DisplayCutout$CutoutPathParserInfo;->getDisplayWidth()I

    move-result v4

    invoke-virtual {p1}, Landroid/view/DisplayCutout$CutoutPathParserInfo;->getDisplayHeight()I

    move-result v5

    invoke-virtual {p1}, Landroid/view/DisplayCutout$CutoutPathParserInfo;->getDensity()F

    move-result v6

    invoke-virtual {p1}, Landroid/view/DisplayCutout$CutoutPathParserInfo;->getCutoutSpec()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {p1}, Landroid/view/DisplayCutout$CutoutPathParserInfo;->getScale()F
    ...
    invoke-direct/range {v3 .. v9}, Landroid/view/DisplayCutout$CutoutPathParserInfo;-><init>(IIFLjava/lang/String;IF)V

    nop

    invoke-static {v2, v0, v10}, Landroid/view/DisplayCutout;->constructDisplayCutout([Landroid/graphics/Rect;Landroid/graphics/Insets;Landroid/view/DisplayCutout$CutoutPathParserInfo;)Landroid/view/DisplayCutout;
...
.method private calculatePrivacyIndicatorBoundsForRotationUncached(Landroid/view/PrivacyIndicatorBounds;I)Landroid/view/PrivacyIndicatorBounds;
    ...
    invoke-direct {p1, v0, p2}, Landroid/view/PrivacyIndicatorBounds;-><init>([Landroid/graphics/Rect;I)V
...
.method private computeScreenAppConfiguration(Landroid/content/res/Configuration;IIIILandroid/view/DisplayCutout;)V
    ...
    invoke-virtual {v3, v1, v2, v4, v0}, Landroid/app/WindowConfiguration;->setAppBounds(IIII)V
    ...
    iget p6, p1, Landroid/content/res/Configuration;->screenWidthDp:I

    int-to-float p6, p6

    iget v1, p0, Lcom/android/server/wm/DisplayContent;->mCompatibleScreenScale:F

    div-float/2addr p6, v1

    float-to-int p6, p6

    iput p6, p1, Landroid/content/res/Configuration;->compatScreenWidthDp:I

    iget p6, p1, Landroid/content/res/Configuration;->screenHeightDp:I
    ...
    :cond_2
    :goto_1
    invoke-direct {p0, v0, p5, p2, p3}, Lcom/android/server/wm/DisplayContent;->computeCompatSmallestWidth(ZIII)I

    move-result p2

    iput p2, p1, Landroid/content/res/Configuration;->compatSmallestScreenWidthDp:I
...
.method private configureSurfaces(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iput-object v1, p0, Lcom/android/server/wm/DisplayContent;->mSurfaceControl:Landroid/view/SurfaceControl;
...
.method static synthetic lambda$calculateSystemGestureExclusion$36(Landroid/graphics/Region;Landroid/graphics/Region;Landroid/graphics/Region;[ILandroid/graphics/Region;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Region;Lcom/android/server/wm/WindowState;)V
    ...
    :cond_0
    invoke-virtual {v11, p1}, Lcom/android/server/wm/WindowState;->getEffectiveTouchableRegion(Landroid/graphics/Region;)V
    ...
    invoke-virtual {v8, p1}, Landroid/graphics/Region;->set(Landroid/graphics/Region;)Z
    ...
    invoke-virtual {v8, p1, v2}, Landroid/graphics/Region;->op(Landroid/graphics/Region;Landroid/graphics/Region$Op;)Z
...
.method static synthetic lambda$setExitingTokensHasVisible$31(ZLcom/android/server/wm/Task;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/Task;->mExitingActivities:Ljava/util/ArrayList;
    ...
    iput-boolean p0, v1, Lcom/android/server/wm/ActivityRecord;->hasVisible:Z
...
.method private performLayoutNoTrace(ZZ)V
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Ljava/util/function/Consumer;Z)V
...
.method private processTaskForTouchExcludeRegion(Lcom/android/server/wm/Task;Lcom/android/server/wm/Task;I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/TaskDisplayArea;->getBounds(Landroid/graphics/Rect;)V
...
.method private reduceConfigLayout(IIFIII)I
    ...
    invoke-static {p1, p4, p2}, Landroid/content/res/Configuration;->reduceScreenLayout(III)I
...
.method private setImeLayeringTargetInner(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent$ImeContainer;->getRootDisplayArea()Lcom/android/server/wm/RootDisplayArea;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/RootDisplayArea;->placeImeContainer(Lcom/android/server/wm/DisplayArea$Tokens;)V
    ...
    invoke-virtual {v2, v3}, Landroid/view/InsetsState;->getSourceOrDefaultVisibility(I)Z

    move-result v2

    invoke-virtual {p1, v0, v2}, Lcom/android/server/wm/InsetsStateController;->updateAboveInsetsState(Lcom/android/server/wm/WindowState;Z)V
...
.method private startFadeRotationAnimation(Z)Z
    ...
    invoke-direct {v1, p0}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda8;-><init>(Lcom/android/server/wm/DisplayContent;)V

    const-wide/16 v2, 0xfa

    invoke-virtual {p1, v1, v2, v3}, Lcom/android/server/wm/WindowManagerService$H;->postDelayed(Ljava/lang/Runnable;J)Z

    return v0

    :cond_0
    iget-object p1, p0, Lcom/android/server/wm/DisplayContent;->mFadeRotationAnimationController:Lcom/android/server/wm/FadeRotationAnimationController;

    if-nez p1, :cond_1

    new-instance p1, Lcom/android/server/wm/FadeRotationAnimationController;

    invoke-direct {p1, p0}, Lcom/android/server/wm/FadeRotationAnimationController;-><init>(Lcom/android/server/wm/DisplayContent;)V

    iput-object p1, p0, Lcom/android/server/wm/DisplayContent;->mFadeRotationAnimationController:Lcom/android/server/wm/FadeRotationAnimationController;

    invoke-virtual {p1}, Lcom/android/server/wm/FadeRotationAnimationController;->hide()V
...
.method private startFixedRotationTransform(Lcom/android/server/wm/WindowToken;I)V
    ...
    invoke-virtual {p1, v0, p2, v1}, Lcom/android/server/wm/WindowToken;->applyFixedRotationTransform(Landroid/view/DisplayInfo;Lcom/android/server/wm/DisplayFrames;Landroid/content/res/Configuration;)V
...
.method private startMirrorIfNeeded()V
    ...
    invoke-virtual {v0, v2, v4}, Landroid/hardware/display/DisplayManagerInternal;->setWindowTokenClientToMirror(ILandroid/os/IBinder;)V
    ...
    invoke-static {v0, v2, v1, v3, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/android/server/wm/DisplayContent;->mMirroredSurface:Landroid/view/SurfaceControl;
    ...
    iget-object v3, p0, Lcom/android/server/wm/DisplayContent;->mMirroredSurface:Landroid/view/SurfaceControl;

    iget-object v6, p0, Lcom/android/server/wm/DisplayContent;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-virtual {v1, v3, v6}, Landroid/view/SurfaceControl$Transaction;->reparent(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-virtual {p0, v1, v2, v5}, Lcom/android/server/wm/DisplayContent;->updateMirroredSurface(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;Landroid/graphics/Point;)V
...
.method private updateBaseDisplayMetricsIfNeeded()V
    ...
    iget-boolean v5, p0, Lcom/android/server/wm/DisplayContent;->mIgnoreDisplayCutout:Z
    ...
    iget-object v7, v7, Landroid/view/DisplayInfo;->roundedCorners:Landroid/view/RoundedCorners;
    ...
    iget-object v8, p0, Lcom/android/server/wm/DisplayContent;->mInitialRoundedCorners:Landroid/view/RoundedCorners;
    ...
    :cond_6
    iget-object v8, p0, Lcom/android/server/wm/DisplayContent;->mCurrentUniqueDisplayId:Ljava/lang/String;
    ...
    :goto_6
    iget-boolean v8, p0, Lcom/android/server/wm/DisplayContent;->mIsDensityForced:Z
    ...
    :goto_7
    invoke-virtual {p0, v2, v1, v8}, Lcom/android/server/wm/DisplayContent;->updateBaseDisplayMetrics(III)V
    ...
    iput-object v7, p0, Lcom/android/server/wm/DisplayContent;->mInitialRoundedCorners:Landroid/view/RoundedCorners;

    iput-object v6, p0, Lcom/android/server/wm/DisplayContent;->mCurrentUniqueDisplayId:Ljava/lang/String;
...
.method private updateDisplayAndOrientation(ILandroid/content/res/Configuration;)Landroid/view/DisplayInfo;
    ...
    iput v6, v1, Landroid/view/DisplayInfo;->rotation:I
    ...
    iput v11, v1, Landroid/view/DisplayInfo;->logicalHeight:I

    iget-object v1, v8, Lcom/android/server/wm/DisplayContent;->mDisplayInfo:Landroid/view/DisplayInfo;

    iget v2, v8, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    iput v0, v1, Landroid/view/DisplayInfo;->appHeight:I
    ...
    invoke-virtual {v0, v1, v2, v14}, Landroid/view/DisplayInfo;->getLogicalMetrics(Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;Landroid/content/res/Configuration;)V
    ...
    :cond_5
    iput-object v12, v0, Landroid/view/DisplayInfo;->displayCutout:Landroid/view/DisplayCutout;

    iget-object v0, v8, Lcom/android/server/wm/DisplayContent;->mDisplayInfo:Landroid/view/DisplayInfo;

    iput-object v13, v0, Landroid/view/DisplayInfo;->roundedCorners:Landroid/view/RoundedCorners;
    ...
    invoke-virtual {v0, v1, v14}, Landroid/hardware/display/DisplayManagerInternal;->setDisplayInfoOverrideFromWindowManager(ILandroid/view/DisplayInfo;)V

    iget-object v0, v8, Lcom/android/server/wm/DisplayContent;->mBaseDisplayRect:Landroid/graphics/Rect;

    invoke-virtual {v0, v9, v9, v10, v11}, Landroid/graphics/Rect;->set(IIII)V
...
.method private updateMirroring()V
    ...
    const-string v0, "Display %d has content (%b) so disable layer mirroring"
...
.method private updateOrientation(Z)Z
    ...
    invoke-virtual {v1, v0, p1}, Lcom/android/server/wm/DisplayRotation;->updateOrientation(IZ)Z
...
.method addShellRoot(Landroid/view/IWindow;I)Landroid/view/SurfaceControl;
    ...
    const-string v0, "DisplayContent.addShellRoot"

    invoke-direct {p2, p1, v0}, Landroid/view/SurfaceControl;-><init>(Landroid/view/SurfaceControl;Ljava/lang/String;)V
...
.method addWindowToken(Landroid/os/IBinder;Lcom/android/server/wm/WindowToken;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/DisplayArea$Tokens;->addChild(Lcom/android/server/wm/WindowToken;)V
...
.method adjustForImeIfNeeded()V
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/server/wm/PinnedTaskController;->setAdjustedForIme(ZI)V
...
.method applyMagnificationSpec(Landroid/view/MagnificationSpec;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/DisplayContent;->clearMagnificationSpec(Landroid/view/SurfaceControl$Transaction;)V
...
.method attachAndShowImeScreenshotOnTarget()V
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/wm/TaskSnapshotController;->snapshotImeFromAttachedTask(Lcom/android/server/wm/Task;)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/server/wm/DisplayContent;->createImeSurface(Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/wm/DisplayContent;->mImeScreenshot:Landroid/view/SurfaceControl;
...
.method calculateSystemGestureExclusion(Landroid/graphics/Region;Landroid/graphics/Region;)Z
    ...
    new-instance v9, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda14;
    ...
    invoke-virtual {v0, v11, v15}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Ljava/util/function/Consumer;Z)V
...
.method canAddToastWindowForUid(I)Z
    ...
    invoke-direct {v0, p1}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda50;-><init>(I)V
...
.method computeImeTarget(Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/DisplayContent;->setImeLayeringTargetInner(Lcom/android/server/wm/WindowState;)V
...
.method computeScreenConfiguration(Landroid/content/res/Configuration;I)Landroid/view/DisplayInfo;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/android/server/wm/DisplayContent;->computeScreenAppConfiguration(Landroid/content/res/Configuration;IIIILandroid/view/DisplayCutout;)V
    ...
    invoke-direct/range {v3 .. v10}, Lcom/android/server/wm/DisplayContent;->computeSizeRangesAndScreenLayout(Landroid/view/DisplayInfo;ZIIIFLandroid/content/res/Configuration;)V
...
.method computeScreenConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/wm/DisplayContent;->updateDisplayAndOrientation(ILandroid/content/res/Configuration;)Landroid/view/DisplayInfo;
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/DisplayContent;->getWindowingMode()I
    ...
    iget-object v9, v0, Landroid/view/DisplayInfo;->displayCutout:Landroid/view/DisplayCutout;

    move-object v3, p0

    move-object v4, p1

    invoke-direct/range {v3 .. v9}, Lcom/android/server/wm/DisplayContent;->computeScreenAppConfiguration(Landroid/content/res/Configuration;IIIILandroid/view/DisplayCutout;)V
    ...
    :cond_4
    iget-object v9, p0, Lcom/android/server/wm/DisplayContent;->mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    :goto_5
    iget-object v11, p0, Lcom/android/server/wm/DisplayContent;->mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mHardKeyboardAvailable:Z
...
.method createImeSurface(Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl;
    ...
    iget-object v1, v1, Lcom/android/server/wm/WindowManagerService;->mSurfaceControlFactory:Ljava/util/function/Function;
    ...
    const-string v2, "IME-snapshot-surface"
    ...
    const-string v3, "DisplayContent.attachAndShowImeScreenshotOnTarget"
    ...
    invoke-static {v1, p2, v3, v2}, Lcom/android/server/wm/InputMonitor;->setTrustedOverlayInputInfo(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;ILjava/lang/String;)V
    ...
    invoke-virtual {p2, v1, p1}, Landroid/view/SurfaceControl$Transaction;->setBuffer(Landroid/view/SurfaceControl;Landroid/graphics/GraphicBuffer;)Landroid/view/SurfaceControl$Transaction;

    iget-object p1, p0, Lcom/android/server/wm/DisplayContent;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    invoke-virtual {p2, p1, v2}, Landroid/view/SurfaceControl$Transaction;->setColorSpace(Landroid/view/SurfaceControl;Landroid/graphics/ColorSpace;)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-virtual {p2, v1, p1, v0}, Landroid/view/SurfaceControl$Transaction;->setRelativeLayer(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-virtual {p2, v1, p1, v0}, Landroid/view/SurfaceControl$Transaction;->setPosition(Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/TaskDisplayArea;->getRootSplitScreenPrimaryTask()Lcom/android/server/wm/Task;
    ...
    const-string v2, "rootSplitScreenPrimaryTask="
...
.method public dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    invoke-super {p0, p1, v0, v1, p4}, Lcom/android/server/wm/RootDisplayArea;->dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    invoke-virtual {v0, p1, v1, v2, p4}, Lcom/android/server/wm/ImeInsetsSourceProvider;->dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
...
.method fetchSurfaceSizeIfPresent()Landroid/graphics/Point;
    ...
    sget-object v2, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_LAYER_MIRRORING:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    const-string v0, "Provided surface for layer mirroring on display %d is not present, so do not update the surface"
...
.method finishFadeRotationAnimation(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/FadeRotationAnimationController;->show(Lcom/android/server/wm/WindowToken;)Z
...
.method getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    :pswitch_1
    iget-object p1, p0, Lcom/android/server/wm/DisplayContent;->mImeInputTarget:Lcom/android/server/wm/WindowState;
...
.method getInputMethodWindowVisibleHeight()I
    ...
    invoke-virtual {v3, v0}, Landroid/graphics/Rect;->inset(Landroid/graphics/Insets;)V
...
.method getOrientation()I
    ...
    invoke-static {v1, v10, v7, v0, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method getTouchableWinAtPointLocked(FF)Lcom/android/server/wm/WindowState;
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda52;-><init>(Lcom/android/server/wm/DisplayContent;II)V
...
.method handleActivitySizeCompatModeIfNeeded(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/DisplayContent;->mActiveSizeCompatActivities:Ljava/util/Set;
...
.method handleAnimatingStoppedAndTransition()V
    ...
    invoke-static {v0, v2, v3, v4, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method handleTopActivityLaunchingInDifferentOrientation(Lcom/android/server/wm/ActivityRecord;Z)Z
    ...
    invoke-static {p2}, Lcom/android/server/wm/DisplayContent$FixedRotationTransitionListener;->access$200(Lcom/android/server/wm/DisplayContent$FixedRotationTransitionListener;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/ActivityRecord;->notifyFixedRotationTransform(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/TaskDisplayArea;->matchParentBounds()Z
...
.method isUidPresent(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/DisplayContent;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
...
.method public synthetic lambda$new$3$DisplayContent(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/server/wm/WindowState;->isAnimating(II)Z
    ...
    :cond_b
    invoke-virtual {v1, v2}, Lcom/android/server/wm/ActivityRecord;->isDescendantOf(Lcom/android/server/wm/WindowContainer;)Z
...
.method public synthetic lambda$new$4$DisplayContent(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/ActivityRecord;->layoutLetterbox(Lcom/android/server/wm/WindowState;)V
...
.method public synthetic lambda$new$8$DisplayContent(Lcom/android/server/wm/WindowState;)V
    ...
    iput-boolean v1, v5, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->displayHasContent:Z
    ...
    iput-boolean v3, v1, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->syswin:Z
    ...
    iput v5, v1, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredRefreshRate:F

    :cond_5
    iget-object v1, p0, Lcom/android/server/wm/DisplayContent;->mTmpApplySurfaceChangesTransactionState:Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;

    iget-boolean v5, v1, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferMinimalPostProcessing:Z
    ...
    iput-boolean v5, v1, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferMinimalPostProcessing:Z
    ...
    iput v1, v5, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredModeId:I
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/RefreshRatePolicy;->getPreferredMinRefreshRate(Lcom/android/server/wm/WindowState;)F
    ...
    iput v1, v5, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredMinRefreshRate:F
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/RefreshRatePolicy;->getPreferredMaxRefreshRate(Lcom/android/server/wm/WindowState;)F

    move-result v1

    iget-object v5, p0, Lcom/android/server/wm/DisplayContent;->mTmpApplySurfaceChangesTransactionState:Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;

    iget v5, v5, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredMaxRefreshRate:F
    ...
    iput v1, v4, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredMaxRefreshRate:F
    ...
    invoke-static {v1, v4, v2, v5, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public synthetic lambda$removeExistingTokensIfPossible$32$DisplayContent(Lcom/android/server/wm/Task;)V
    ...
    iget-boolean v2, v1, Lcom/android/server/wm/ActivityRecord;->hasVisible:Z

    if-nez v2, :cond_1

    iget-object v2, p0, Lcom/android/server/wm/DisplayContent;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-boolean v2, v1, Lcom/android/server/wm/ActivityRecord;->mIsExiting:Z

    if-eqz v2, :cond_0

    invoke-virtual {v1}, Lcom/android/server/wm/ActivityRecord;->isEmpty()Z
...
.method public synthetic lambda$requestChangeTransitionIfNeeded$19$DisplayContent(J)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/WindowManagerService;->mLatencyTracker:Lcom/android/internal/util/LatencyTracker;
...
.method public synthetic lambda$shouldWaitForSystemDecorWindowsOnBoot$28$DisplayContent(Landroid/util/SparseBooleanArray;Lcom/android/server/wm/WindowState;)Z
    ...
    sget-boolean p1, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_BOOT_enabled:Z
...
.method migrateToNewSurfaceControl(Landroid/view/SurfaceControl$Transaction;)V
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/wm/DisplayContent;->mChildren:Lcom/android/server/wm/WindowList;
...
.method notifyInsetsChanged(Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/view/InsetsState;->setSourceVisible(IZ)V
...
.method okToAnimate(ZZ)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayPolicy;->isScreenOnFully()Z
...
.method okToDisplay(ZZ)Z
    ...
    invoke-interface {p1}, Lcom/android/server/policy/WindowManagerPolicy;->isScreenOn()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/DisplayContent;->mLastMirroredDisplayAreaBounds:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/android/server/wm/DisplayContent;->mTokenToMirror:Landroid/os/IBinder;

    invoke-virtual {p1, v1}, Lcom/android/server/wm/WindowContextListenerController;->getContainer(Landroid/os/IBinder;)Lcom/android/server/wm/WindowContainer;
    ...
    sget-boolean p1, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_LAYER_MIRRORING_enabled:Z
    ...
    sget-object p1, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_LAYER_MIRRORING:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    const-string v1, "Unable to retrieve window container to update layer mirroring for display %d"

    invoke-static {p1, v0, v2, v1, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_1
    return-void

    :cond_2
    sget-boolean v3, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_LAYER_MIRRORING_enabled:Z
    ...
    sget-object v5, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_LAYER_MIRRORING:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    const-string v3, "Display %d was already layer mirroring, so apply transformations if necessary"

    invoke-static {v5, v6, v2, v3, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/DisplayContent;->mLastMirroredDisplayAreaBounds:Landroid/graphics/Rect;
    ...
    const-string v1, "Going ahead with updating layer mirroring for display %d to new bounds %s and/or orientation %d."

    invoke-static {p1, v13, v7, v1, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, v3, v4}, Lcom/android/server/wm/DisplayContent;->updateMirroredSurface(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;Landroid/graphics/Point;)V
    ...
    const-string v1, "Unable to update layer mirroring for display %d to new bounds %s and/or orientation %d, since the surface is not available."

    invoke-static {p1, v4, v7, v1, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method onDescendantOrientationChanged(Lcom/android/server/wm/WindowContainer;)Z
    ...
    invoke-virtual {p0, v0, p1, v1, v3}, Lcom/android/server/wm/DisplayContent;->updateDisplayOverrideConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;)Z
...
.method onDisplayChanged()V
    ...
    sget-object v9, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_LAYER_MIRRORING:Lcom/android/internal/protolog/ProtoLogGroup;

    const v10, -0x12710f7e
    ...
    invoke-static {v9, v10, v11, v2, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public onRequestedOverrideConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput v1, p0, Lcom/android/server/wm/DisplayContent;->mCurrentOverrideConfigurationChanges:I
    ...
    invoke-virtual {p1, v0, p0}, Lcom/android/server/wm/WindowManagerService;->setNewDisplayOverrideConfiguration(Landroid/content/res/Configuration;Lcom/android/server/wm/DisplayContent;)V
...
.method performDisplayOverrideConfigUpdate(Landroid/content/res/Configuration;)I
    ...
    sget-object v0, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda3;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/DisplayContent;->requestChangeTransitionIfNeeded(I)V
...
.method reconfigureDisplayLocked()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wm/DisplayContent;->requestChangeTransitionIfNeeded(I)V
...
.method releaseSelfIfNeeded()V
    ...
    sget-object v0, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda39;->INSTANCE:Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda39;
...
.method removeExistingTokensIfPossible()V
    ...
    iget-boolean v2, v2, Lcom/android/server/wm/WindowToken;->hasVisible:Z
    ...
    invoke-static {v5, v6, v0, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method removeWindowToken(Landroid/os/IBinder;Z)Lcom/android/server/wm/WindowToken;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/WindowToken;->setExiting(Z)V
...
.method requestChangeTransitionIfNeeded(I)V
    ...
    new-instance v1, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda47;

    invoke-direct {v1, p0}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda47;-><init>(Lcom/android/server/wm/DisplayContent;)V

    invoke-virtual {v0, v2, v1}, Lcom/android/server/wm/TransitionController$TransitionMetricsReporter;->associate(Landroid/os/IBinder;Ljava/util/function/LongConsumer;)V
...
.method rotationForActivityInDifferentOrientation(Lcom/android/server/wm/ActivityRecord;)I
    ...
    invoke-virtual {v2, p1, v0}, Lcom/android/server/wm/DisplayRotation;->rotationForOrientation(II)I
...
.method screenshotDisplayLocked()Landroid/graphics/Bitmap;
    ...
    invoke-direct {v3, v0}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;-><init>(Landroid/os/IBinder;)V

    invoke-virtual {v3, v2}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setUseIdentityTransform(Z)Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;

    move-result-object v0

    invoke-virtual {v0}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->build()Landroid/view/SurfaceControl$DisplayCaptureArgs;

    move-result-object v0

    nop

    invoke-static {v0}, Landroid/view/SurfaceControl;->captureDisplay(Landroid/view/SurfaceControl$DisplayCaptureArgs;)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    :cond_2
    invoke-virtual {v0}, Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;->asBitmap()Landroid/graphics/Bitmap;
    ...
    const-string v2, "Failed to take screenshot"
...
.method setFixedRotationLaunchingAppUnchecked(Lcom/android/server/wm/ActivityRecord;I)V
    ...
    :goto_0
    invoke-direct {p0, p2}, Lcom/android/server/wm/DisplayContent;->startFadeRotationAnimation(Z)Z
...
.method setIgnoreOrientationRequest(Z)Z
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/DisplayContent;->mIgnoreOrientationRequest:Z
...
.method setImeInputTarget(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/DisplayContent$ImeContainer;->setCanScreenshot(Z)Z
...
.method setInsetProvider(ILcom/android/server/wm/WindowState;Lcom/android/internal/util/function/TriConsumer;Lcom/android/internal/util/function/TriConsumer;)V
    ...
    invoke-virtual {p1, p2, p3, p4}, Lcom/android/server/wm/InsetsSourceProvider;->setWindow(Lcom/android/server/wm/WindowState;Lcom/android/internal/util/function/TriConsumer;Lcom/android/internal/util/function/TriConsumer;)V
...
.method public setRotationAnimation(Lcom/android/server/wm/ScreenRotationAnimation;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayRotation;->getRotation()I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/DisplayContent;->startFadeRotationAnimation(Z)Z
...
.method shouldWaitForSystemDecorWindowsOnBoot()Z
    ...
    new-instance v4, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda53;

    invoke-direct {v4, p0, v0}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda53;-><init>(Lcom/android/server/wm/DisplayContent;Landroid/util/SparseBooleanArray;)V
    ...
    iget-boolean v8, v8, Lcom/android/server/wm/WindowManagerService;->mShowingBootMessages:Z
...
.method switchUser(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayPolicy;->switchUser()V
...
.method updateBaseDisplayMetrics(III)V
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayRect:Landroid/graphics/Rect;

    iget p3, p0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I

    const/4 v0, 0x0

    invoke-virtual {p2, v0, v0, p1, p3}, Landroid/graphics/Rect;->set(IIII)V
...
.method updateDisplayOverrideConfigurationLocked()Z
    ...
    sget-object v2, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda15;->INSTANCE:Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda15;
    ...
    iget-object v0, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mTmpUpdateConfigurationResult:Lcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;

    iget v0, v0, Lcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;->changes:I
...
.method updateDisplayOverrideConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;)Z
    ...
    iput-boolean p2, p4, Lcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;->activityRelaunched:Z
...
.method updateFocusedWindowLocked(IZI)Z
    ...
    invoke-direct {v2, v0}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda18;-><init>(Lcom/android/server/wm/DisplayContent;)V
...
.method updateImeControlTarget(Z)V
    ...
    new-instance v2, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda7;

    invoke-direct {v2, v0, p1}, Lcom/android/server/wm/DisplayContent$$ExternalSyntheticLambda7;-><init>(Landroid/os/IBinder;Z)V
...
.method updateImeInputAndControlTarget(Lcom/android/server/wm/WindowState;)V
    ...
    iput-boolean v1, p1, Lcom/android/server/wm/ActivityRecord;->mImeInsetsFrozenUntilStartInput:Z
...
.method updateImeParent()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/wm/DisplayContent;->assignRelativeLayerForIme(Landroid/view/SurfaceControl$Transaction;Z)V
...
.method updateLocation(Lcom/android/server/wm/WindowState;II)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMoved([I)V
...
.method updateMirroredSurface(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;Landroid/graphics/Point;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/DisplayContent;->mLastMirroredDisplayAreaBounds:Landroid/graphics/Rect;
...
.method updateOrientation(Landroid/content/res/Configuration;Lcom/android/server/wm/WindowContainer;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/DisplayRotation;->isWaitingForRemoteRotation()Z

    move-result p2

    if-nez p2, :cond_3

    iget-object p2, p0, Lcom/android/server/wm/DisplayContent;->mTransitionController:Lcom/android/server/wm/TransitionController;
...
.method updatePrivacyIndicatorBounds([Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wm/DisplayContent;->calculateRoundedCornersForRotation(I)Landroid/view/RoundedCorners;
    ...
    invoke-virtual {v0, p1, v1, v2, v3}, Lcom/android/server/wm/DisplayFrames;->onDisplayInfoUpdated(Landroid/view/DisplayInfo;Lcom/android/server/wm/utils/WmDisplayCutout;Landroid/view/RoundedCorners;Landroid/view/PrivacyIndicatorBounds;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/InsetsStateController;->onDisplayInfoUpdated(Z)V
...
.method updateTouchExcludeRegion()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/DisplayContent;->amendWindowTapExcludeRegion(Landroid/graphics/Region;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/DockedTaskDividerController;->getTouchRegion(Landroid/graphics/Rect;)V
...
.method waitForUnfreeze(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/FadeRotationAnimationController;->isHandledToken(Lcom/android/server/wm/WindowToken;)Z
