...
.method private addToControlMaps(Lcom/android/server/wm/InsetsControlTarget;IZ)V
    ...
    iget-object p3, p0, Lcom/android/server/wm/InsetsStateController;->mTypeFakeControlTargetMap:Landroid/util/SparseArray;
    ...
    :cond_0
    iget-object p3, p0, Lcom/android/server/wm/InsetsStateController;->mTypeControlTargetMap:Landroid/util/SparseArray;
...
.method private getInsetsForTarget(IIZLandroid/view/InsetsState;)Landroid/view/InsetsState;
    ...
    invoke-virtual {v0, p1}, Landroid/view/InsetsState;->removeSource(I)Z
    ...
    invoke-virtual {v0, v5}, Landroid/view/InsetsState;->removeSource(I)Z

    invoke-virtual {v0, v1}, Landroid/view/InsetsState;->removeSource(I)Z
    ...
    iget-object p1, p0, Lcom/android/server/wm/InsetsStateController;->mProviders:Landroid/util/ArrayMap;
    ...
    iget-object p4, p0, Lcom/android/server/wm/InsetsStateController;->mProviders:Landroid/util/ArrayMap;

    invoke-virtual {p4, p1}, Landroid/util/ArrayMap;->valueAt(I)Ljava/lang/Object;

    move-result-object p4

    check-cast p4, Lcom/android/server/wm/InsetsSourceProvider;
    ...
    invoke-direct {p1, p4}, Landroid/view/InsetsState;-><init>(Landroid/view/InsetsState;)V
...
.method static synthetic lambda$updateAboveInsetsState$3([ZLcom/android/server/wm/WindowState;Landroid/view/InsetsState;Ljava/util/ArrayList;Landroid/util/SparseArray;Lcom/android/server/wm/WindowState;)Z
    ...
    iget-object p0, p1, Lcom/android/server/wm/WindowState;->mAboveInsetsState:Landroid/view/InsetsState;

    invoke-virtual {p0, p2}, Landroid/view/InsetsState;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/view/InsetsState;->set(Landroid/view/InsetsState;)V
    ...
    :cond_2
    iget-object p0, p5, Lcom/android/server/wm/WindowState;->mProvidedInsetsSources:Landroid/util/SparseArray;
    ...
    invoke-virtual {p2, v1}, Landroid/view/InsetsState;->addSource(Landroid/view/InsetsSource;)V
    ...
    iget-object p2, p5, Lcom/android/server/wm/WindowState;->mAboveInsetsState:Landroid/view/InsetsState;
    ...
    iget-object p1, p5, Lcom/android/server/wm/WindowState;->mAboveInsetsState:Landroid/view/InsetsState;

    invoke-virtual {p4, p0}, Landroid/util/SparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Landroid/view/InsetsSource;
...
.method private removeFromControlMaps(Lcom/android/server/wm/InsetsControlTarget;IZ)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/InsetsStateController;->mTypeFakeControlTargetMap:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/wm/InsetsStateController;->mTypeControlTargetMap:Landroid/util/SparseArray;
...
.method public addProvidersToTransition()V
    ...
    :cond_0
    iget-object v1, v1, Lcom/android/server/wm/InsetsSourceProvider;->mWin:Lcom/android/server/wm/WindowState;
...
.method getInsetsForWindow(Lcom/android/server/wm/WindowState;)Landroid/view/InsetsState;
    ...
    iget-boolean v3, v3, Landroid/view/WindowManager$LayoutParams;->receiveInsetsIgnoringZOrder:Z
    ...
    :cond_3
    iget-object p1, p1, Lcom/android/server/wm/WindowState;->mAboveInsetsState:Landroid/view/InsetsState;

    :goto_1
    invoke-direct {p0, v0, v1, v2, p1}, Lcom/android/server/wm/InsetsStateController;->getInsetsForTarget(IIZLandroid/view/InsetsState;)Landroid/view/InsetsState;
...
.method getInsetsForWindowMetrics(Landroid/view/WindowManager$LayoutParams;)Landroid/view/InsetsState;
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowToken;->getWindowingMode()I
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowToken;->isAlwaysOnTop()Z
    ...
    invoke-direct {p0, v0, v2, v1, p1}, Lcom/android/server/wm/InsetsStateController;->getInsetsForTarget(IIZLandroid/view/InsetsState;)Landroid/view/InsetsState;
...
.method getSourceProvider(I)Lcom/android/server/wm/InsetsSourceProvider;
    ...
    invoke-direct {v1, p0}, Lcom/android/server/wm/InsetsStateController$$ExternalSyntheticLambda5;-><init>(Lcom/android/server/wm/InsetsStateController;)V
...
.method notifyControlRevoked(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/wm/InsetsStateController;->removeFromControlMaps(Lcom/android/server/wm/InsetsControlTarget;IZ)V
...
.method onBarControlTargetChanged(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsControlTarget;)V
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/wm/InsetsStateController;->onControlChanged(ILcom/android/server/wm/InsetsControlTarget;)V
...
.method onControlFakeTargetChanged(ILcom/android/server/wm/InsetsControlTarget;)V
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/wm/InsetsStateController;->removeFromControlMaps(Lcom/android/server/wm/InsetsControlTarget;IZ)V
    ...
    invoke-direct {p0, p2, p1, v1}, Lcom/android/server/wm/InsetsStateController;->addToControlMaps(Lcom/android/server/wm/InsetsControlTarget;IZ)V
...
.method updateAboveInsetsState(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-virtual {v4, v1, v3}, Landroid/view/InsetsState;->set(Landroid/view/InsetsState;I)V

    iget-object v6, p1, Lcom/android/server/wm/WindowState;->mProvidedInsetsSources:Landroid/util/SparseArray;
    ...
    new-instance v9, Lcom/android/server/wm/InsetsStateController$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {v8, v9, v0}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
    ...
    iget-object p2, p0, Lcom/android/server/wm/InsetsStateController;->mDispatchInsetsChanged:Ljava/util/function/Consumer;
