...
.method private unfreezeInner(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/SurfaceFreezer;->mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method freeze(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Rect;Landroid/graphics/Point;Landroid/view/SurfaceControl;)V
    ...
    invoke-interface {v0, p1, p3}, Lcom/android/server/wm/SurfaceFreezer$Freezable;->onAnimationLeashCreated(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
...
.method unfreeze(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/SurfaceFreezer;->mAnimatable:Lcom/android/server/wm/SurfaceFreezer$Freezable;

    invoke-interface {p1}, Lcom/android/server/wm/SurfaceFreezer$Freezable;->onUnfrozen()V
