...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput p1, p0, Lcom/android/server/wm/TaskSnapshotController;->mHighResTaskSnapshotScale:F
...
.method private createImeSnapshot(Lcom/android/server/wm/Task;I)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    invoke-static {p1, v0, v2, p2, v1}, Landroid/view/SurfaceControl;->captureLayersExcluding(Landroid/view/SurfaceControl;Landroid/graphics/Rect;FI[Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
...
.method private drawAppThemeSnapshot(Lcom/android/server/wm/Task;)Landroid/window/TaskSnapshot;
    ...
    invoke-static {v6, v13}, Lcom/android/server/wm/TaskSnapshotController;->getSystemBarInsets(Landroid/graphics/Rect;Landroid/view/InsetsState;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v15, v14}, Lcom/android/server/wm/TaskSnapshotSurface$SystemBarBackgroundPainter;->setInsets(Landroid/graphics/Rect;)V

    invoke-virtual {v15, v10, v2}, Lcom/android/server/wm/TaskSnapshotSurface$SystemBarBackgroundPainter;->drawDecors(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
...
.method getClosingTasks(Landroid/util/ArraySet;Landroid/util/ArraySet;)V
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/android/server/wm/Task;->isAnimatingByRecents()Z
...
.method getSnapshot(IIZZ)Landroid/window/TaskSnapshot;
    ...
    iget-object p4, p0, Lcom/android/server/wm/TaskSnapshotController;->mPersister:Lcom/android/server/wm/TaskSnapshotPersister;

    invoke-virtual {p4}, Lcom/android/server/wm/TaskSnapshotPersister;->enableLowResSnapshots()Z
    ...
    :goto_0
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/wm/TaskSnapshotCache;->getSnapshot(IIZZ)Landroid/window/TaskSnapshot;
...
.method prepareTaskSnapshot(Lcom/android/server/wm/Task;ILandroid/window/TaskSnapshot$Builder;)Z
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/Task;->getConfiguration()Landroid/content/res/Configuration;
    ...
    invoke-virtual {p3, p1}, Landroid/window/TaskSnapshot$Builder;->setAppearance(I)Landroid/window/TaskSnapshot$Builder;
...
.method recordTaskSnapshot(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {p2, v1, v2, v0}, Lcom/android/server/wm/TaskSnapshotPersister;->persistSnapshot(IILandroid/window/TaskSnapshot;)V
    ...
    const-string p2, "Invalid task snapshot dimensions "
...
.method snapshotForSleeping(I)V
    ...
    invoke-interface {p1, v0}, Lcom/android/server/policy/WindowManagerPolicy;->isKeyguardSecure(I)Z
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/wm/TaskSnapshotController;->snapshotTasks(Landroid/util/ArraySet;Z)V
...
.method snapshotTask(Lcom/android/server/wm/Task;I)Landroid/window/TaskSnapshot;
    ...
    invoke-virtual {v0, p2}, Landroid/window/TaskSnapshot$Builder;->setSnapshot(Landroid/hardware/HardwareBuffer;)Landroid/window/TaskSnapshot$Builder;
