...
.method constructor <init>(Landroid/content/res/Resources;Lcom/android/server/utils/DeviceConfigInterface;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/HighRefreshRateDenylist;->mListener:Lcom/android/server/wm/HighRefreshRateDenylist$OnPropertiesChangedListener;

    const-string v1, "display_manager"

    invoke-interface {p2, v1, p1, v0}, Lcom/android/server/utils/DeviceConfigInterface;->addOnPropertiesChangedListener(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/provider/DeviceConfig$OnPropertiesChangedListener;)V

    iget-object p1, p0, Lcom/android/server/wm/HighRefreshRateDenylist;->mDeviceConfig:Lcom/android/server/utils/DeviceConfigInterface;

    const-string p2, "high_refresh_rate_blacklist"

    invoke-interface {p1, v1, p2}, Lcom/android/server/utils/DeviceConfigInterface;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
