...
.method private handleMessageInner(Landroid/os/Message;)Z
    ...
    const-string v2, "Activity top resumed state loss timeout for "
    ...
    invoke-virtual {v0, v1, v4, v5, p1}, Lcom/android/server/wm/ActivityTaskManagerService;->logAppTooSlow(Lcom/android/server/wm/WindowProcessController;JLjava/lang/String;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleTopResumedStateReleased(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/RootWindowContainer;->startHomeOnEmptyDisplays(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/wm/ActivityTaskSupervisor;->access$100(Lcom/android/server/wm/ActivityTaskSupervisor;)Ljava/util/ArrayList;
    ...
    invoke-static {v1}, Lcom/android/server/wm/ActivityTaskSupervisor;->access$200(Lcom/android/server/wm/ActivityTaskSupervisor;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual {v0, v1, v2}, Lcom/android/server/wm/ActivityRecord;->updatePictureInPictureMode(Landroid/graphics/Rect;Z)V
    ...
    invoke-static {p1}, Lcom/android/server/wm/ActivityTaskSupervisor;->access$000(Lcom/android/server/wm/ActivityTaskSupervisor;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, p1}, Lcom/android/server/wm/ActivityTaskSupervisor;->access$400(Lcom/android/server/wm/ActivityTaskSupervisor;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-static {p1, v0, v2, v1}, Lcom/android/server/wm/ActivityTaskSupervisor;->access$300(Lcom/android/server/wm/ActivityTaskSupervisor;Lcom/android/server/wm/ActivityRecord;ZLjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->activityIdleFromMessage(Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->activityIdleFromMessage(Lcom/android/server/wm/ActivityRecord;Z)V
