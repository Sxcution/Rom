...
.method public shouldDeferAnimationFinish(Ljava/lang/Runnable;)Z
    ...
    iget-boolean p1, p0, Lcom/android/server/wm/NavBarFadeAnimationController$NavFadeAnimationAdapter;->mShow:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/android/server/wm/NavBarFadeAnimationController$NavFadeAnimationAdapter;->this$0:Lcom/android/server/wm/NavBarFadeAnimationController;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lcom/android/server/wm/NavBarFadeAnimationController;->fadeWindowToken(Z)V
