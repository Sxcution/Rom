...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayArea$Type;Ljava/lang/String;I)V
    ...
    iput-object p2, p0, Lcom/android/server/wm/DisplayArea;->mRemoteToken:Lcom/android/server/wm/WindowContainer$RemoteToken;
...
.method private findMinPositionForChildDisplayArea(Lcom/android/server/wm/DisplayArea;)I
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/wm/DisplayArea;->mChildren:Lcom/android/server/wm/WindowList;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    iget-boolean p3, p0, Lcom/android/server/wm/DisplayArea;->mIgnoreOrientationRequest:Z
    ...
    const-string v0, "mIgnoreOrientationRequest=true"
...
.method forAllTaskDisplayAreas(Ljava/util/function/Function;Z)Z
    ...
    invoke-virtual {v3, p1, p2}, Lcom/android/server/wm/DisplayArea;->forAllTaskDisplayAreas(Ljava/util/function/Function;Z)Z
...
.method getDisplayAreaInfo()Landroid/window/DisplayAreaInfo;
    ...
    iget v1, v1, Lcom/android/server/wm/DisplayContent;->mFeatureId:I
...
.method setIgnoreOrientationRequest(Z)Z
    ...
    iget-object p1, p0, Lcom/android/server/wm/DisplayArea;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
...
.method setOrganizer(Landroid/window/IDisplayAreaOrganizer;Z)V
    ...
    const-string p2, "Don\'t organize or trigger events for unavailable or untrusted display."
