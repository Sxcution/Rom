...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/DisplayPolicy;Lcom/android/server/wm/DisplayWindowSettings;Landroid/content/Context;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/DisplayRotation;->readRotation(I)I
    ...
    invoke-virtual {p2, p3}, Lcom/android/server/wm/DisplayRotation$OrientationListener;->setCurrentRotation(I)V
...
.method private continueRotation(ILandroid/window/WindowContainerTransaction;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/WindowManagerService$H;->removeCallbacks(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/TransitionController;->collect(Lcom/android/server/wm/WindowContainer;)V

    iget-object p1, p0, Lcom/android/server/wm/DisplayRotation;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    new-instance v1, Lcom/android/server/wm/DisplayRotation$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lcom/android/server/wm/DisplayRotation$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/DisplayRotation;)V

    invoke-virtual {p1, v1}, Lcom/android/server/wm/DisplayContent;->forAllTasks(Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/InsetsStateController;->addProvidersToTransition()V
    ...
    const-string p2, "Trying to rotate outside a transition"
    ...
    :try_start_3
    iget-object p2, p0, Lcom/android/server/wm/DisplayRotation;->mService:Lcom/android/server/wm/WindowManagerService;
...
.method private selectRotationAnimation()Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;
    ...
    iput v3, v0, Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;->mExit:I

    iget-object v0, p0, Lcom/android/server/wm/DisplayRotation;->mTmpRotationAnim:Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;

    iput v4, v0, Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;->mEnter:I
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/DisplayPolicy;->isTopLayoutFullscreen()Z
    ...
    iput v1, v0, Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;->mEnter:I
...
.method private startRemoteRotation(II)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/WindowManagerService$H;->removeCallbacks(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1, p2, v0, v1}, Lcom/android/server/wm/WindowManagerService$H;->postDelayed(Ljava/lang/Runnable;J)Z
    :try_end_0
...
.method private updateOrientationListenerLw()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayRotation$OrientationListener;->shouldStayEnabledWhileDreaming()Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/wm/DisplayRotation$OrientationListener;->enable(Z)V
...
.method private updateSettings()Z
    ...
    invoke-static {v0, v7, v8, v3}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method markForSeamlessRotation(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-static {p1, v0, p2, v1, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method prepareNormalRotationAnimation()V
    ...
    invoke-virtual {v1, v2, v0, v3}, Lcom/android/server/wm/WindowManagerService;->startFreezingDisplay(IILcom/android/server/wm/DisplayContent;)V
...
.method rotationForOrientation(II)I
    ...
    invoke-static {v6, v3, v4, v5, v11}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget v4, v0, Lcom/android/server/wm/DisplayRotation;->mUserRotationAngles:I
    ...
    :goto_7
    invoke-static {v3, v4, v11}, Lcom/android/internal/view/RotationPolicy;->isRotationAllowed(IIZ)Z
...
.method shouldRotateSeamlessly(IIZ)Z
    ...
    :cond_3
    iget-boolean p1, p0, Lcom/android/server/wm/DisplayRotation;->mAllowSeamlessRotationDespiteNavBarMoving:Z
    ...
    sget-object p2, Lcom/android/server/wm/DisplayRotation$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/wm/DisplayRotation$$ExternalSyntheticLambda2;

    invoke-virtual {p1, p2}, Lcom/android/server/wm/DisplayContent;->getWindow(Ljava/util/function/Predicate;)Lcom/android/server/wm/WindowState;
...
.method updateRotationUnchecked(Z)Z
    ...
    invoke-interface {v7, v5}, Lcom/android/server/policy/WindowManagerPolicy;->okToAnimate(Z)Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-virtual {v6}, Lcom/android/server/wm/RecentsAnimationController;->setCheckRotationAfterCleanup()V
    ...
    invoke-static {v5, v7, v13, v1, v14}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v6, v1}, Lcom/android/server/wm/DisplayRotation;->startRemoteRotation(II)V
...
.method validateRotationAnimation(IIZ)Z
    ...
    iget v2, p3, Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;->mExit:I

    if-ne p1, v2, :cond_1

    iget p1, p3, Lcom/android/server/wm/DisplayRotation$RotationAnimationPair;->mEnter:I
