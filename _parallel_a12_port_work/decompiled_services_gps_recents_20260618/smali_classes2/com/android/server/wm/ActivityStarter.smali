...
.method private addOrReparentStartingActivity(Lcom/android/server/wm/Task;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/WindowContainer;I)V
    ...
    invoke-virtual {p1, v0, v0}, Lcom/android/server/wm/Task;->topRunningActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-direct {p0, v3, v4, v0, p1}, Lcom/android/server/wm/ActivityStarter;->canEmbedActivity(Lcom/android/server/wm/TaskFragment;Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/Task;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/TaskFragment;->getChildCount()I

    move-result v1

    invoke-virtual {v0, p1, v1, p2}, Lcom/android/server/wm/ActivityRecord;->reparent(Lcom/android/server/wm/TaskFragment;ILjava/lang/String;)V
    ...
    invoke-virtual {p1, p2, v1}, Lcom/android/server/wm/TaskFragment;->addChild(Lcom/android/server/wm/WindowContainer;I)V
...
.method private adjustLaunchFlagsToDocumentMode(Lcom/android/server/wm/ActivityRecord;ZZI)I
    ...
    :pswitch_0
    iget p1, p0, Lcom/android/server/wm/ActivityStarter;->mLaunchMode:I
...
.method private complyActivityFlags(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/uri/NeededUriGrants;)V
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/wm/ActivityStarter;->deliverNewIntent(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/uri/NeededUriGrants;)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/wm/Task;->performClearTaskForReuseLocked(Lcom/android/server/wm/ActivityRecord;I)Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_e
    invoke-direct {p0, p2, p3}, Lcom/android/server/wm/ActivityStarter;->deliverNewIntent(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/uri/NeededUriGrants;)V
    ...
    invoke-direct {p0, p2, p3, v0, v3}, Lcom/android/server/wm/ActivityStarter;->getLaunchRootTask(Lcom/android/server/wm/ActivityRecord;ILcom/android/server/wm/Task;Landroid/app/ActivityOptions;)Lcom/android/server/wm/Task;
...
.method private computeTargetTask()Lcom/android/server/wm/Task;
    ...
    :cond_3
    const-string v2, "computeTargetTask"
...
.method private deliverToCurrentTopIfNeeded(Lcom/android/server/wm/Task;Lcom/android/server/uri/NeededUriGrants;)I
    ...
    invoke-virtual {p2, v0, v1, v2, p1}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleNonResizableTaskIfNeeded(Lcom/android/server/wm/Task;ILcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/Task;)V
...
.method private executeRequest(Lcom/android/server/wm/ActivityStarter$Request;)I
    ...
    iput-object v11, v13, Lcom/android/server/wm/ActivityStarter;->mLastStartActivityRecord:Lcom/android/server/wm/ActivityRecord;

    iget-object v0, v14, Lcom/android/server/wm/ActivityStarter$Request;->caller:Landroid/app/IApplicationThread;

    iget-object v12, v14, Lcom/android/server/wm/ActivityStarter$Request;->intent:Landroid/content/Intent;
    ...
    iget-object v11, v14, Lcom/android/server/wm/ActivityStarter$Request;->callingFeatureId:Ljava/lang/String;

    move-object/from16 v16, v11

    iget v11, v14, Lcom/android/server/wm/ActivityStarter$Request;->realCallingPid:I
    ...
    invoke-virtual {v12, v4, v4, v4, v15}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    :cond_7
    iget-object v1, v11, Lcom/android/server/wm/ActivityRecord;->resultTo:Lcom/android/server/wm/ActivityRecord;
    ...
    iput-object v15, v11, Lcom/android/server/wm/ActivityRecord;->resultTo:Lcom/android/server/wm/ActivityRecord;

    if-eqz v1, :cond_9

    invoke-virtual {v1, v11, v3, v5}, Lcom/android/server/wm/ActivityRecord;->removeResultsLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;I)V

    :cond_9
    iget v15, v11, Lcom/android/server/wm/ActivityRecord;->launchedFromUid:I

    if-ne v15, v10, :cond_a

    iget-object v15, v11, Lcom/android/server/wm/ActivityRecord;->launchedFromPackage:Ljava/lang/String;

    move-object/from16 v17, v1

    iget-object v1, v11, Lcom/android/server/wm/ActivityRecord;->launchedFromFeatureId:Ljava/lang/String;
    ...
    invoke-interface {v0, v4, v12, v9}, Landroid/content/pm/IPackageManager;->activitySupportsIntent(Landroid/content/ComponentName;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-interface {v4, v0, v12, v9}, Landroid/content/pm/IPackageManager;->activitySupportsIntent(Landroid/content/ComponentName;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v12, v10, v15}, Lcom/android/server/policy/PermissionPolicyInternal;->checkStartActivity(Landroid/content/Intent;ILjava/lang/String;)Z
    ...
    iget-boolean v4, v14, Lcom/android/server/wm/ActivityStarter$Request;->allowBackgroundActivityStart:Z
    :try_end_2
    ...
    invoke-virtual {v11, v12, v15, v10, v0}, Lcom/android/server/wm/SafeActivityOptions;->getOptions(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Lcom/android/server/wm/WindowProcessController;Lcom/android/server/wm/ActivityTaskSupervisor;)Landroid/app/ActivityOptions;
    ...
    iget-object v12, v1, Lcom/android/server/wm/ActivityStartInterceptor;->mIntent:Landroid/content/Intent;
    ...
    iget-object v4, v13, Lcom/android/server/wm/ActivityStarter;->mInterceptor:Lcom/android/server/wm/ActivityStartInterceptor;
    ...
    invoke-virtual {v0, v2, v15}, Landroid/content/pm/PackageManagerInternal;->isPermissionsReviewRequired(Ljava/lang/String;I)Z
    ...
    invoke-static {v5, v5, v3}, Lcom/android/server/wm/ActivityStarter;->computeResolveFilterUid(III)I
    ...
    invoke-virtual {v1, v2, v7, v4, v3}, Lcom/android/server/wm/ActivityTaskSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v2, v1, v0, v12, v3}, Lcom/android/server/wm/ActivityTaskSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromPid(I)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v2

    invoke-virtual {v2, v0}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromUid(I)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    invoke-virtual {v0, v11}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromPackage(Ljava/lang/String;)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    move-object/from16 v2, v24

    invoke-virtual {v0, v2}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromFeature(Ljava/lang/String;)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/android/server/wm/ActivityRecord$Builder;->setIntent(Landroid/content/Intent;)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/ActivityRecord$Builder;->setResultTo(Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    :goto_17
    invoke-virtual {v0, v10}, Lcom/android/server/wm/ActivityRecord$Builder;->setRootVoiceInteraction(Z)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    iget-object v0, v14, Lcom/android/server/wm/ActivityStarter$Request;->outActivity:[Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_28
    iget v0, v13, Lcom/android/server/wm/ActivityStarter;->mLastStartActivityResult:I
...
.method private getReusableTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/android/server/wm/RootWindowContainer;->findActivity(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Z)Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_7
    invoke-virtual {v0, v2, v4, v5}, Lcom/android/server/wm/RootWindowContainer;->findActivity(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Z)Lcom/android/server/wm/ActivityRecord;
...
.method private handleStartResult(Lcom/android/server/wm/ActivityRecord;I)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/ActivityRecord;->shouldUpdateConfigForDisplayChanged()Z
    ...
    invoke-virtual {v1, p2, v2, v0, v3}, Lcom/android/server/wm/RootWindowContainer;->ensureVisibilityAndConfig(Lcom/android/server/wm/ActivityRecord;IZZ)Z
    ...
    invoke-virtual {p2, v1, v0}, Lcom/android/server/wm/ActivityRecord;->finishIfPossible(Ljava/lang/String;Z)I
    ...
    const-string p2, "handleStartResult"

    invoke-virtual {p1, p2}, Lcom/android/server/wm/Task;->removeIfPossible(Ljava/lang/String;)V
...
.method private isAllowedToStart(Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/Task;)I
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/wm/ActivityRecord;->sendResult(ILjava/lang/String;IILandroid/content/Intent;Lcom/android/server/uri/NeededUriGrants;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/ActivityStarter;->mPreferredTaskDisplayArea:Lcom/android/server/wm/TaskDisplayArea;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/ActivityStarter;->handleBackgroundActivityAbort(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    iget p2, p0, Lcom/android/server/wm/ActivityStarter;->mCallingUid:I
    ...
    invoke-virtual {v5, p3, v1}, Lcom/android/server/wm/LockTaskController;->isLockTaskModeViolation(Lcom/android/server/wm/Task;Z)Z
    ...
    invoke-virtual {v1, v5}, Lcom/android/server/wm/LockTaskController;->isNewTaskLockTaskModeViolation(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-direct {p0, v1, p1, p2, p3}, Lcom/android/server/wm/ActivityStarter;->canEmbedActivity(Lcom/android/server/wm/TaskFragment;Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/Task;)Z
    ...
    const-string v0, "Permission denied: Cannot embed "
...
.method private isHomeApp(ILjava/lang/String;)Z
    ...
    iget-object p2, p2, Lcom/android/server/wm/ActivityTaskManagerService;->mHomeProcess:Lcom/android/server/wm/WindowProcessController;
...
.method private resolveToHeavyWeightSwitcherIfNeeded()I
    ...
    iget v7, v2, Lcom/android/server/wm/ActivityStarter$Request;->userId:I

    const/4 v8, 0x0

    iget-object v2, v0, Lcom/android/server/wm/ActivityStarter;->mRequest:Lcom/android/server/wm/ActivityStarter$Request;

    iget v2, v2, Lcom/android/server/wm/ActivityStarter$Request;->callingUid:I
    ...
    iget-object v10, v0, Lcom/android/server/wm/ActivityStarter;->mRequest:Lcom/android/server/wm/ActivityStarter$Request;

    iget v10, v10, Lcom/android/server/wm/ActivityStarter$Request;->filterCallingUid:I
    ...
    iget-object v2, v2, Lcom/android/server/wm/ActivityStarter$Request;->resolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {v2, v3, v0}, Landroid/app/ActivityManagerInternal;->getActivityInfoForUser(Landroid/content/pm/ActivityInfo;I)Landroid/content/pm/ActivityInfo;
...
.method private resumeTargetRootTaskIfNeeded()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/Task;->isFocusable()Z
...
.method private setInitialState(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;Lcom/android/server/wm/TaskFragment;ZILcom/android/server/wm/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Z)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/wm/RootWindowContainer;->anyTaskForId(I)Lcom/android/server/wm/Task;
    ...
    invoke-static {v1, v4}, Lcom/android/server/wm/TaskFragment;->fromTaskFragmentToken(Landroid/os/IBinder;Lcom/android/server/wm/ActivityTaskManagerService;)Lcom/android/server/wm/TaskFragment;
...
.method private setNewTask(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/ActivityRecord;->setTaskToAffiliateWith(Lcom/android/server/wm/Task;)V
...
.method private setTargetRootTaskIfNeeded(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v1, v11, v0, v9}, Lcom/android/server/wm/WindowContainer;->positionChildAt(ILcom/android/server/wm/WindowContainer;Z)V
    ...
    invoke-virtual {p1, v0, v9, v1, v2}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleNonResizableTaskIfNeeded(Lcom/android/server/wm/Task;ILcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/Task;)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/ActivityStarter;->mSourceRootTask:Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v0, p1, v11}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/WindowContainer;I)V
...
.method private startActivityUnchecked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/app/ActivityOptions;Lcom/android/server/wm/Task;Lcom/android/server/wm/TaskFragment;ZLcom/android/server/uri/NeededUriGrants;)I
    ...
    iget-object v3, v2, Lcom/android/server/wm/ActivityRecord;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/wm/Transition;->setRemoteTransition(Landroid/window/RemoteTransition;)V
    ...
    iget-object v0, v1, Lcom/android/server/wm/ActivityStarter;->mTargetRootTask:Lcom/android/server/wm/Task;
    ...
    :cond_4
    iget-object v0, v1, Lcom/android/server/wm/ActivityStarter;->mTargetTask:Lcom/android/server/wm/Task;
    ...
    invoke-direct {v1, v2, v14}, Lcom/android/server/wm/ActivityStarter;->handleStartResult(Lcom/android/server/wm/ActivityRecord;I)Lcom/android/server/wm/Task;
    ...
    iput-boolean v8, v12, Lcom/android/server/wm/ActivityTaskSupervisor;->mUserLeaving:Z

    if-nez v15, :cond_6

    if-eqz v6, :cond_f

    invoke-virtual {v6}, Lcom/android/server/wm/Transition;->abort()V

    goto :goto_8

    :cond_6
    iget-boolean v12, v1, Lcom/android/server/wm/ActivityStarter;->mAvoidMoveToFront:Z

    if-nez v12, :cond_7

    iget-boolean v12, v1, Lcom/android/server/wm/ActivityStarter;->mDoResume:Z
    ...
    iget v13, v2, Lcom/android/server/wm/ActivityRecord;->launchedFromUid:I
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/wm/TransitionController;->collectExistenceChange(Lcom/android/server/wm/WindowContainer;)V
    ...
    iget-object v6, v1, Lcom/android/server/wm/ActivityStarter;->mLastStartActivityRecord:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {v3, v6}, Lcom/android/server/wm/TransitionController;->setTransientLaunch(Lcom/android/server/wm/ActivityRecord;)V

    :cond_c
    if-eqz v4, :cond_d

    iget-object v5, v1, Lcom/android/server/wm/ActivityStarter;->mTargetTask:Lcom/android/server/wm/Task;

    invoke-virtual {v3, v4, v5, v7}, Lcom/android/server/wm/TransitionController;->requestStartTransition(Lcom/android/server/wm/Transition;Lcom/android/server/wm/Task;Landroid/window/RemoteTransition;)Lcom/android/server/wm/Transition;
    ...
    invoke-virtual {v3, v2, v8}, Lcom/android/server/wm/TransitionController;->setReady(Lcom/android/server/wm/WindowContainer;Z)V
    ...
    :cond_f
    :goto_8
    invoke-virtual {v1, v2, v14, v0}, Lcom/android/server/wm/ActivityStarter;->postStartActivityProcessing(Lcom/android/server/wm/ActivityRecord;ILcom/android/server/wm/Task;)V
    ...
    :cond_17
    iget-object v1, v1, Lcom/android/server/wm/ActivityStarter;->mTargetTask:Lcom/android/server/wm/Task;

    invoke-virtual {v3, v4, v1, v7}, Lcom/android/server/wm/TransitionController;->requestStartTransition(Lcom/android/server/wm/Transition;Lcom/android/server/wm/Task;Landroid/window/RemoteTransition;)Lcom/android/server/wm/Transition;
...
.method private waitResultIfNeeded(Landroid/app/WaitResult;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityMetricsLogger$LaunchingState;)I
    ...
    iget p1, p1, Landroid/app/WaitResult;->result:I
    ...
    iput-boolean p3, p1, Landroid/app/WaitResult;->timeout:Z

    iget-object p2, p2, Lcom/android/server/wm/ActivityRecord;->mActivityComponent:Landroid/content/ComponentName;

    iput-object p2, p1, Landroid/app/WaitResult;->who:Landroid/content/ComponentName;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v1, "mLastStartActivityRecord:"
    ...
    invoke-virtual {v1, p1, v3, v2}, Lcom/android/server/wm/ActivityRecord;->dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, p1, p2, v2}, Lcom/android/server/wm/ActivityRecord;->dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
...
.method execute()I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/wm/ActivityStarter;->executeRequest(Lcom/android/server/wm/ActivityStarter$Request;)I
    ...
    invoke-static {v3, v6, v5, v2, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v2, v3, v1}, Lcom/android/server/wm/ActivityStarter;->waitResultIfNeeded(Landroid/app/WaitResult;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityMetricsLogger$LaunchingState;)I
...
.method postStartActivityProcessing(Lcom/android/server/wm/ActivityRecord;ILcom/android/server/wm/Task;)V
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/wm/ActivityStarter;->mTargetTask:Lcom/android/server/wm/Task;
    ...
    iget-object p3, p0, Lcom/android/server/wm/ActivityStarter;->mReuseTask:Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/TaskDisplayArea;->getRootHomeTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v0, p1, p2, p3, v1}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyActivityRestartAttempt(Landroid/app/ActivityManager$RunningTaskInfo;ZZZ)V
...
.method recycleTask(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;Lcom/android/server/uri/NeededUriGrants;)I
    ...
    invoke-static {p3, p4, v2, v5, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_7
    iget-object p1, p0, Lcom/android/server/wm/ActivityStarter;->mTargetRootTask:Lcom/android/server/wm/Task;

    invoke-virtual {p1, v4}, Lcom/android/server/wm/Task;->moveToFront(Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/ActivityTaskManagerService;->mInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityTaskManagerInternal;->isDreaming()Z
...
.method shouldAbortBackgroundActivityStart(IILjava/lang/String;IILcom/android/server/wm/WindowProcessController;Lcom/android/server/am/PendingIntentRecord;ZLandroid/content/Intent;)Z
    ...
    :cond_0
    invoke-direct {v0, v3, v4}, Lcom/android/server/wm/ActivityStarter;->isHomeApp(ILjava/lang/String;)Z
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/wm/MirrorActiveUids;->getUidState(I)I

    move-result v10

    iget-object v11, v0, Lcom/android/server/wm/ActivityStarter;->mService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {v11, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->hasActiveVisibleWindow(I)Z
    ...
    iget-object v8, v8, Lcom/android/server/wm/ActivityTaskManagerService;->mActiveUids:Lcom/android/server/wm/MirrorActiveUids;

    invoke-virtual {v8, v3}, Lcom/android/server/wm/MirrorActiveUids;->hasNonAppVisibleWindow(I)Z
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/wm/MirrorActiveUids;->getUidState(I)I
    ...
    invoke-virtual {v13, v7}, Lcom/android/server/wm/ActivityTaskManagerService;->hasActiveVisibleWindow(I)Z
    ...
    invoke-virtual {v9, v5, v7}, Lcom/android/server/wm/ActivityTaskManagerService;->isAssociatedCompanionApp(II)Z
    ...
    invoke-static {v9, v1, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->checkPermission(Ljava/lang/String;II)I
    ...
    invoke-virtual {v9, v3}, Lcom/android/server/wm/RecentTasks;->isCallerRecents(I)Z
    ...
    invoke-virtual {v9, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->isDeviceOwner(I)Z
    ...
    invoke-virtual {v5, v9, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->isAssociatedCompanionApp(II)Z
    ...
    invoke-virtual {v5, v3, v1, v4}, Lcom/android/server/wm/ActivityTaskManagerService;->hasSystemAlertWindowPermission(IILjava/lang/String;)Z
    ...
    invoke-virtual {v1, v9, v7}, Lcom/android/server/wm/ActivityTaskManagerService;->getProcessController(II)Lcom/android/server/wm/WindowProcessController;
    ...
    invoke-virtual {v9, v6}, Lcom/android/server/wm/WindowProcessController;->areBackgroundActivityStartsAllowed(I)Z
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/wm/WindowProcessControllerMap;->getProcesses(I)Landroid/util/ArraySet;
    ...
    invoke-virtual {v1, v6}, Lcom/android/server/wm/WindowProcessController;->areBackgroundActivityStartsAllowed(I)Z
    ...
    const-string v5, "Background activity start [callingPackage: "
    ...
    const-string v5, "; appSwitchState: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, "; isCallingUidForeground: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v14}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, "; callingUidHasAnyVisibleWindow: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v11}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, "; callingUidProcState: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v5, Landroid/app/ActivityManager;

    const-string v6, "PROCESS_STATE_"

    invoke-static {v5, v6, v10}, Landroid/util/DebugUtils;->valueToString(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "; isCallingUidPersistentSystemProcess: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v15}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, "; realCallingUid: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, "; isRealCallingUidForeground: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v12}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, "; realCallingUidHasAnyVisibleWindow: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, "; realCallingUidProcState: "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v5, Landroid/app/ActivityManager;

    invoke-static {v5, v6, v8}, Landroid/util/DebugUtils;->valueToString(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "; isRealCallingUidPersistentSystemProcess: "
    ...
    const-string v5, "; allowBackgroundActivityStart: "
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/WindowProcessController;->hasActivityInVisibleTask()Z
...
.method startActivityInner(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/app/ActivityOptions;Lcom/android/server/wm/Task;Lcom/android/server/wm/TaskFragment;ZLcom/android/server/uri/NeededUriGrants;)I
    ...
    invoke-direct {p0}, Lcom/android/server/wm/ActivityStarter;->computeSourceRootTask()V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/ActivityStarter;->getReusableTask()Lcom/android/server/wm/Task;
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/server/wm/ActivityStarter;->computeTargetTask()Lcom/android/server/wm/Task;
    ...
    invoke-direct {p0, p1, v6, v2}, Lcom/android/server/wm/ActivityStarter;->computeLaunchParams(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;)V

    invoke-direct {p0, p1, v5, v2}, Lcom/android/server/wm/ActivityStarter;->isAllowedToStart(Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/Task;)I
    ...
    invoke-virtual {p0, v2, v8, v1, v13}, Lcom/android/server/wm/ActivityStarter;->recycleTask(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;Lcom/android/server/uri/NeededUriGrants;)I
    ...
    invoke-direct {p0, v1, v13}, Lcom/android/server/wm/ActivityStarter;->deliverToCurrentTopIfNeeded(Lcom/android/server/wm/Task;Lcom/android/server/uri/NeededUriGrants;)I
    ...
    invoke-direct {p0, v8, v9, v2, v10}, Lcom/android/server/wm/ActivityStarter;->getLaunchRootTask(Lcom/android/server/wm/ActivityRecord;ILcom/android/server/wm/Task;Landroid/app/ActivityOptions;)Lcom/android/server/wm/Task;
    ...
    :goto_3
    invoke-direct {p0, v8}, Lcom/android/server/wm/ActivityStarter;->setNewTask(Lcom/android/server/wm/Task;)V
    ...
    invoke-direct {p0, v2, v8}, Lcom/android/server/wm/ActivityStarter;->addOrReparentStartingActivity(Lcom/android/server/wm/Task;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v9, v2}, Lcom/android/server/wm/Task;->moveToFront(Ljava/lang/String;Lcom/android/server/wm/Task;)V
    ...
    iget-object v2, v2, Lcom/android/server/wm/ActivityTaskManagerService;->mInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;

    invoke-virtual {v2}, Lcom/android/server/wm/ActivityTaskManagerInternal;->isDreaming()Z
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/ActivityRecord;->getUriPermissionsLocked()Lcom/android/server/uri/UriPermissionOwner;

    move-result-object v8

    invoke-interface {v2, v13, v8}, Lcom/android/server/uri/UriGrantsManagerInternal;->grantUriPermissionUncheckedFromIntent(Lcom/android/server/uri/NeededUriGrants;Lcom/android/server/uri/UriPermissionOwner;)V
    ...
    iget-object v9, v11, Lcom/android/server/wm/ActivityStarter;->mStartActivity:Lcom/android/server/wm/ActivityRecord;

    iget v9, v9, Lcom/android/server/wm/ActivityRecord;->mUserId:I

    invoke-virtual {v2, v8, v4, v9}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    invoke-static {v8, v9}, Lcom/android/server/wm/EventLogTags;->writeWmCreateTask(II)V
    ...
    invoke-virtual {v8, v9, v2}, Lcom/android/server/wm/ActivityRecord;->logStartActivity(ILcom/android/server/wm/Task;)V
    ...
    invoke-virtual {v8, v4, v9}, Lcom/android/server/wm/RootWindowContainer;->startPowerModeLaunchIfNeeded(ZLcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual/range {p3 .. p9}, Lcom/android/server/wm/Task;->startActivityLocked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;ZZLandroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/Task;->isTopActivityFocusable()Z
    ...
    invoke-virtual {v0, v1, v3, v5, v6}, Lcom/android/server/wm/RootWindowContainer;->resumeFocusedTasksTopActivities(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Z)Z
    ...
    invoke-virtual {v0, v7, v4, v4}, Lcom/android/server/wm/Task;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/server/wm/RootWindowContainer;->updateUserRootTask(ILcom/android/server/wm/Task;)V

    iget-object v0, v11, Lcom/android/server/wm/ActivityStarter;->mSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    iget-object v0, v0, Lcom/android/server/wm/ActivityTaskSupervisor;->mRecentTasks:Lcom/android/server/wm/RecentTasks;

    invoke-virtual {v0, v2}, Lcom/android/server/wm/RecentTasks;->add(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {v0, v2, v1, v3, v5}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleNonResizableTaskIfNeeded(Lcom/android/server/wm/Task;ILcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/Task;)V
