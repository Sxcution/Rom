...
.method private getServiceInfo()Landroid/content/pm/ServiceInfo;
    ...
    const-string v0, "no external services package!"
    ...
    invoke-virtual {v0, v3, v6}, Landroid/content/pm/PackageManager;->resolveService(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
...
.method calculateDisplayHashBoundsLocked(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/WindowState;->getBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/DisplayHashController;->mTmpRectF:Landroid/graphics/RectF;
    ...
    invoke-virtual {p3, p1, v0, v1, v2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    :cond_3
    invoke-virtual {p2}, Lcom/android/server/wm/DisplayContent;->getBounds()Landroid/graphics/Rect;
...
.method generateDisplayHash(Landroid/view/SurfaceControl$LayerCaptureArgs$Builder;Landroid/graphics/Rect;Ljava/lang/String;ILandroid/os/RemoteCallback;)V
    ...
    invoke-direct {p0, p1, p2, p3, p5}, Lcom/android/server/wm/DisplayHashController;->generateDisplayHash(Landroid/hardware/HardwareBuffer;Landroid/graphics/Rect;Ljava/lang/String;Landroid/os/RemoteCallback;)V
...
.method public synthetic lambda$verifyDisplayHash$0$DisplayHashController(Landroid/view/displayhash/DisplayHash;Landroid/service/displayhash/IDisplayHashingService;Landroid/os/RemoteCallback;)V
    ...
    const-string p2, "Failed to invoke verifyDisplayHash command"
