...
.method public onInputEvent(Landroid/view/InputEvent;)V
    ...
    invoke-virtual {p0, p1, v3}, Lcom/android/server/wm/TaskPositioner$WindowPositionerEventReceiver;->finishInputEvent(Landroid/view/InputEvent;Z)V
    ...
    invoke-virtual {v5, v2, v4}, Lcom/android/server/wm/TaskPositioner;->notifyMoveLocked(FF)Z

    move-result v2

    iput-boolean v2, v5, Lcom/android/server/wm/TaskPositioner;->mDragEnded:Z

    iget-object v2, p0, Lcom/android/server/wm/TaskPositioner$WindowPositionerEventReceiver;->this$0:Lcom/android/server/wm/TaskPositioner;

    iget-object v2, v2, Lcom/android/server/wm/TaskPositioner;->mTask:Lcom/android/server/wm/Task;
    ...
    invoke-static {v1}, Lcom/android/server/wm/TaskPositioner;->access$100(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/wm/TaskPositioner$WindowPositionerEventReceiver;->this$0:Lcom/android/server/wm/TaskPositioner;

    invoke-static {v2}, Lcom/android/server/wm/TaskPositioner;->access$200(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v2, v6, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->resizeTask(ILandroid/graphics/Rect;I)Z
    ...
    invoke-static {v1}, Lcom/android/server/wm/TaskPositioner;->access$300(Lcom/android/server/wm/TaskPositioner;)Z
    ...
    invoke-static {v4}, Lcom/android/server/wm/TaskPositioner;->access$400(Lcom/android/server/wm/TaskPositioner;)V

    iget-object v4, p0, Lcom/android/server/wm/TaskPositioner$WindowPositionerEventReceiver;->this$0:Lcom/android/server/wm/TaskPositioner;

    iget-object v4, v4, Lcom/android/server/wm/TaskPositioner;->mTask:Lcom/android/server/wm/Task;
    ...
    invoke-static {v4}, Lcom/android/server/wm/TaskPositioner;->access$200(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;
