...
.method addWindow(Lcom/android/server/wm/WindowState;)V
    ...
    iput-boolean v3, p1, Lcom/android/server/wm/WindowManagerService;->mWindowsChanged:Z
...
.method applyFixedRotationTransform(Landroid/view/DisplayInfo;Lcom/android/server/wm/DisplayFrames;Landroid/content/res/Configuration;)V
    ...
    iget-object p3, p0, Lcom/android/server/wm/WindowToken;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowToken;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object p3, p3, Lcom/android/server/wm/WindowToken$FixedRotationTransformState;->mBarContentFrames:Landroid/util/SparseArray;

    invoke-virtual {p1, p2, p3}, Lcom/android/server/wm/DisplayPolicy;->simulateLayoutDisplay(Lcom/android/server/wm/DisplayFrames;Landroid/util/SparseArray;)V
...
.method assignLayer(Landroid/view/SurfaceControl$Transaction;I)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/WindowToken;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
...
.method createFixedRotationAdjustmentsIfNeeded()Landroid/view/DisplayAdjustments$FixedRotationAdjustments;
    ...
    invoke-direct {v1, v2, v3, v4, v0}, Landroid/view/DisplayAdjustments$FixedRotationAdjustments;-><init>(IIILandroid/view/DisplayCutout;)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/WindowToken;->mFixedRotationTransformState:Lcom/android/server/wm/WindowToken$FixedRotationTransformState;

    iget-object p2, p2, Lcom/android/server/wm/WindowToken$FixedRotationTransformState;->mRotatedOverrideConfiguration:Landroid/content/res/Configuration;
...
.method getFixedRotationBarContentFrame(I)Landroid/graphics/Rect;
    ...
    iget-object p1, v0, Lcom/android/server/wm/DisplayFrames;->mInsetsState:Landroid/view/InsetsState;
    ...
    :cond_3
    iget-object p1, v0, Lcom/android/server/wm/DisplayFrames;->mDisplayCutoutSafe:Landroid/graphics/Rect;
...
.method notifyFixedRotationTransform(Z)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/server/wm/WindowProcessControllerMap;->getProcess(I)Lcom/android/server/wm/WindowProcessController;
    ...
    invoke-static {v7, v3}, Landroid/app/servertransaction/FixedRotationAdjustmentsItem;->obtain(Landroid/os/IBinder;Landroid/view/DisplayAdjustments$FixedRotationAdjustments;)Landroid/app/servertransaction/FixedRotationAdjustmentsItem;
...
.method setExiting(Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wm/WindowToken;->isAnimating(I)Z
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/server/wm/WindowToken;->isAnimating(II)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityRecord;->setVisible(Z)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/DisplayContent;->mExitingTokens:Ljava/util/ArrayList;
...
.method setInsetsFrozen(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/server/wm/WindowToken;->forAllWindows(Ljava/util/function/Consumer;Z)V
