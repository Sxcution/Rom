...
.method private createCancelAnimationLocked()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/wm/DragState$$ExternalSyntheticLambda0;-><init>(Landroid/animation/ValueAnimator;)V
...
.method private createReturnAnimationLocked()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/wm/DragState$$ExternalSyntheticLambda1;-><init>(Landroid/animation/ValueAnimator;)V
...
.method private isValidDropTarget(Lcom/android/server/wm/WindowState;ZZ)Z
    ...
    iget p2, p0, Lcom/android/server/wm/DragState;->mSourceUserId:I
...
.method private sendDragStartedLocked(Lcom/android/server/wm/WindowState;FFZ)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/wm/DragState;->obtainDragEvent(IFFLandroid/content/ClipData;ZLcom/android/internal/view/IDragAndDropPermissions;)Landroid/view/DragEvent;
...
.method broadcastDragStartedLocked(FF)V
    ...
    new-instance v2, Lcom/android/server/wm/DragState$$ExternalSyntheticLambda2;

    invoke-direct {v2, p0, p1, p2, v0}, Lcom/android/server/wm/DragState$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/DragState;FFZ)V

    const/4 p1, 0x0

    invoke-virtual {v1, v2, p1}, Lcom/android/server/wm/RootWindowContainer;->forAllWindows(Ljava/util/function/Consumer;Z)V
...
.method closeLocked()V
    ...
    iget v13, v1, Lcom/android/server/wm/DragState;->mThumbOffsetX:F

    iget v14, v1, Lcom/android/server/wm/DragState;->mThumbOffsetY:F
    ...
    invoke-static/range {v10 .. v20}, Landroid/view/DragEvent;->obtain(IFFFFLjava/lang/Object;Landroid/content/ClipDescription;Landroid/content/ClipData;Landroid/view/SurfaceControl;Lcom/android/internal/view/IDragAndDropPermissions;Z)Landroid/view/DragEvent;
    ...
    invoke-virtual {v6, v0}, Landroid/view/SurfaceControl$Transaction;->remove(Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
    ...
    iget-boolean v6, v1, Lcom/android/server/wm/DragState;->mRelinquishDragSurface:Z

    if-nez v6, :cond_7

    iget-object v6, v1, Lcom/android/server/wm/DragState;->mTransaction:Landroid/view/SurfaceControl$Transaction;

    invoke-virtual {v6, v0, v4}, Landroid/view/SurfaceControl$Transaction;->reparent(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
    ...
    :cond_7
    iget-object v6, v1, Lcom/android/server/wm/DragState;->mDragDropController:Lcom/android/server/wm/DragDropController;

    const/4 v7, 0x3

    const-wide/16 v8, 0x1388

    invoke-virtual {v6, v7, v0, v8, v9}, Lcom/android/server/wm/DragDropController;->sendTimeoutMessage(ILjava/lang/Object;J)V
    ...
    iput v2, v1, Lcom/android/server/wm/DragState;->mThumbOffsetY:F

    iput v2, v1, Lcom/android/server/wm/DragState;->mThumbOffsetX:F
...
.method reportDropWindowLock(Landroid/os/IBinder;FF)Z
    ...
    const-string p3, "Drop outside a valid window "
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/server/wm/DragState;->obtainDragEvent(IFFLandroid/content/ClipData;ZLcom/android/internal/view/IDragAndDropPermissions;)Landroid/view/DragEvent;
...
.method updateDragSurfaceLocked(ZFF)V
    ...
    iget p2, p0, Lcom/android/server/wm/DragState;->mThumbOffsetY:F
