...
.method static synthetic access$000(Lcom/android/server/uwb/UwbServiceImpl;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/android/server/uwb/UwbServiceImpl;->mCallbacksMap:Ljava/util/Map;
...
.method static synthetic access$100(Lcom/android/server/uwb/UwbServiceImpl;)Lcom/android/server/uwb/UwbInjector;
    ...
    iget-object p0, p0, Lcom/android/server/uwb/UwbServiceImpl;->mUwbInjector:Lcom/android/server/uwb/UwbInjector;
...
.method private linkToVendorServiceDeath()V
    ...
    const-string v2, "Unable to link to vendor service death event."
...
.method public openRanging(Landroid/content/AttributionSource;Landroid/uwb/SessionHandle;Landroid/uwb/IUwbRangingCallbacks;Landroid/os/PersistableBundle;)V
    ...
    iget-object p3, p0, Lcom/android/server/uwb/UwbServiceImpl;->mCallbacksMap:Ljava/util/Map;
    ...
    invoke-interface {p3, p1, p2, v0, p4}, Landroid/uwb/IUwbAdapter;->openRanging(Landroid/content/AttributionSource;Landroid/uwb/SessionHandle;Landroid/uwb/IUwbRangingCallbacks;Landroid/os/PersistableBundle;)V
...
.method public declared-synchronized setEnabled(Z)V
    ...
    invoke-interface {p1, v0}, Landroid/uwb/IUwbAdapter;->setEnabled(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
