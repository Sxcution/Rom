...
.method static synthetic access$1600(Lcom/android/server/stats/pull/StatsPullAtomService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mProcessMemorySnapshotLock:Ljava/lang/Object;
...
.method static synthetic access$3800(Lcom/android/server/stats/pull/StatsPullAtomService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mDeviceCalculatedPowerBlameUidLock:Ljava/lang/Object;
...
.method static synthetic access$3900(Lcom/android/server/stats/pull/StatsPullAtomService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mDeviceCalculatedPowerBlameOtherLock:Ljava/lang/Object;
...
.method private addBytesTransferByTagAndMeteredAtoms(Lcom/android/server/stats/pull/netstats/NetworkStatsExt;Ljava/util/List;)V
    ...
    invoke-virtual {v4, v3, v1}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;

    const/16 v5, 0x2763

    iget v6, v1, Landroid/net/NetworkStats$Entry;->uid:I

    iget v4, v1, Landroid/net/NetworkStats$Entry;->metered:I
    ...
    iget-wide v9, v1, Landroid/net/NetworkStats$Entry;->rxBytes:J

    iget-wide v11, v1, Landroid/net/NetworkStats$Entry;->rxPackets:J

    iget-wide v13, v1, Landroid/net/NetworkStats$Entry;->txBytes:J
    ...
    invoke-static/range {v5 .. v16}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIZIJJJJ)Landroid/util/StatsEvent;
...
.method private addDataUsageBytesTransferAtoms(Lcom/android/server/stats/pull/netstats/NetworkStatsExt;Ljava/util/List;)V
    ...
    :goto_2
    iget-object v5, v0, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;->stats:Landroid/net/NetworkStats;
    ...
    invoke-virtual {v5, v3, v4}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;

    iget v7, v4, Landroid/net/NetworkStats$Entry;->set:I

    iget-wide v8, v4, Landroid/net/NetworkStats$Entry;->rxBytes:J

    iget-wide v10, v4, Landroid/net/NetworkStats$Entry;->rxPackets:J

    iget-wide v12, v4, Landroid/net/NetworkStats$Entry;->txBytes:J

    iget-wide v14, v4, Landroid/net/NetworkStats$Entry;->txPackets:J
    ...
    :cond_3
    iget v5, v0, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;->ratType:I
    ...
    iget-object v5, v5, Lcom/android/server/stats/pull/netstats/SubInfo;->mcc:Ljava/lang/String;
    ...
    iget-object v6, v6, Lcom/android/server/stats/pull/netstats/SubInfo;->mnc:Ljava/lang/String;
...
.method private addNetworkStats(ILjava/util/List;Lcom/android/server/stats/pull/netstats/NetworkStatsExt;)V
    ...
    invoke-virtual {v5, v4, v2}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;

    iget-boolean v5, v0, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;->slicedByFgbg:Z

    if-eqz v5, :cond_1

    iget v7, v2, Landroid/net/NetworkStats$Entry;->uid:I

    iget v5, v2, Landroid/net/NetworkStats$Entry;->set:I
    ...
    :goto_1
    iget-wide v9, v2, Landroid/net/NetworkStats$Entry;->rxBytes:J
    ...
    invoke-static/range {v6 .. v16}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIZJJJJ)Landroid/util/StatsEvent;
    ...
    invoke-static/range {v6 .. v15}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIJJJJ)Landroid/util/StatsEvent;
...
.method private collectNetworkStatsSnapshotForAtom(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/stats/pull/StatsPullAtomService;->getUidNetworkStatsSnapshotForTemplate(Landroid/net/NetworkTemplate;Z)Landroid/net/NetworkStats;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/stats/pull/StatsPullAtomService;->sliceNetworkStatsByUidTagAndMetered(Landroid/net/NetworkStats;)Landroid/net/NetworkStats;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/stats/pull/StatsPullAtomService;->getDataUsageBytesTransferSnapshotForSub(Lcom/android/server/stats/pull/netstats/SubInfo;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/stats/pull/StatsPullAtomService;->sliceNetworkStatsByUidAndFgbg(Landroid/net/NetworkStats;)Landroid/net/NetworkStats;
    ...
    invoke-direct {v3, p1, v4, v2}, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;-><init>(Landroid/net/NetworkStats;[IZ)V
    ...
    invoke-virtual {p1}, Landroid/net/NetworkStats;->groupedByUid()Landroid/net/NetworkStats;
    ...
    invoke-direct {v3, p1, v2, v1}, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;-><init>(Landroid/net/NetworkStats;[IZ)V
    ...
    invoke-direct {v3, p1, v4, v1}, Lcom/android/server/stats/pull/netstats/NetworkStatsExt;-><init>(Landroid/net/NetworkStats;[IZ)V
...
.method private estimateAppOpsSamplingRate()V
    ...
    new-instance v5, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda21;

    invoke-direct {v5, v2}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda21;-><init>(Ljava/util/concurrent/CompletableFuture;)V
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/android/server/stats/pull/StatsPullAtomService;->processHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;II)Ljava/util/List;
    ...
    iget-object v9, v5, Lcom/android/server/stats/pull/StatsPullAtomService$AppOpEntry;->mAttributionTag:Ljava/lang/String;
...
.method private getDataUsageBytesTransferSnapshotForOemManaged()Ljava/util/List;
    ...
    new-instance v14, Landroid/net/NetworkTemplate;
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/server/stats/pull/StatsPullAtomService;->getUidNetworkStatsSnapshotForTemplate(Landroid/net/NetworkTemplate;Z)Landroid/net/NetworkStats;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/stats/pull/StatsPullAtomService;->sliceNetworkStatsByUidTagAndMetered(Landroid/net/NetworkStats;)Landroid/net/NetworkStats;
...
.method private getDataUsageBytesTransferSnapshotForSub(Lcom/android/server/stats/pull/netstats/SubInfo;)Ljava/util/List;
    ...
    invoke-static {v6, v12, v7}, Landroid/net/NetworkTemplate;->buildTemplateMobileWithRatType(Ljava/lang/String;II)Landroid/net/NetworkTemplate;
    ...
    invoke-direct {v0, v6}, Lcom/android/server/stats/pull/StatsPullAtomService;->sliceNetworkStatsByFgbg(Landroid/net/NetworkStats;)Landroid/net/NetworkStats;
...
.method private getNetworkStatsSession(Z)Landroid/net/INetworkStatsSession;
    ...
    invoke-interface {v0, p1, v2}, Landroid/net/INetworkStatsService;->openSessionForUsageStats(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
    ...
    const-string v2, "Cannot get NetworkStats session"
...
.method private getUidNetworkStatsSnapshotForTemplate(Landroid/net/NetworkTemplate;Z)Landroid/net/NetworkStats;
    ...
    sget-wide v3, Lcom/android/server/stats/pull/StatsPullAtomService;->NETSTATS_UID_DEFAULT_BUCKET_DURATION_MS:J

    const-string v5, "netstats_uid_bucket_duration"
    ...
    :goto_0
    invoke-direct {p0, v4}, Lcom/android/server/stats/pull/StatsPullAtomService;->getNetworkStatsSession(Z)Landroid/net/INetworkStatsSession;
    ...
    invoke-interface/range {v5 .. v11}, Landroid/net/INetworkStatsSession;->getSummaryForAllUid(Landroid/net/NetworkTemplate;JJZ)Landroid/net/NetworkStats;
    ...
    const-string v2, "Pulling netstats for template="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string p1, " and includeTags="

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string p1, " causes error"
...
.method private getUidNetworkStatsSnapshotForTransport(I)Landroid/net/NetworkStats;
    ...
    invoke-static {p1, v0, v1}, Landroid/net/NetworkTemplate;->buildTemplateMobileWithRatType(Ljava/lang/String;II)Landroid/net/NetworkTemplate;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/stats/pull/StatsPullAtomService;->getUidNetworkStatsSnapshotForTemplate(Landroid/net/NetworkTemplate;Z)Landroid/net/NetworkStats;
...
.method private isAccessibilityFloatingMenuUser(Landroid/content/Context;I)Z
    ...
    invoke-static {p1, v2, p2}, Landroid/provider/Settings$Secure;->getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
...
.method private isAccessibilityShortcutUser(Landroid/content/Context;I)Z
    ...
    invoke-static {p1, v2, v3, p2}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method static synthetic lambda$pullHealthHalLocked$22(ILjava/util/List;ILandroid/hardware/health/V2_0/HealthInfo;)V
    ...
    const-string p3, "Invalid atomTag in healthHal puller: "
    ...
    :sswitch_0
    iget-object p2, p3, Landroid/hardware/health/V2_0/HealthInfo;->legacy:Landroid/hardware/health/V1_0/HealthInfo;

    iget p2, p2, Landroid/hardware/health/V1_0/HealthInfo;->batteryCycleCount:I
    ...
    iget p2, p2, Landroid/hardware/health/V1_0/HealthInfo;->batteryVoltage:I
    ...
    iget p2, p2, Landroid/hardware/health/V1_0/HealthInfo;->batteryFullCharge:I
    ...
    iget p2, p2, Landroid/hardware/health/V1_0/HealthInfo;->batteryChargeCounter:I

    nop

    :goto_0
    invoke-static {p0, p2}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(II)Landroid/util/StatsEvent;
...
.method static synthetic lambda$pullProcessDmabufMemory$19(Landroid/app/ProcessMemoryState;)I
    ...
    iget p0, p0, Landroid/app/ProcessMemoryState;->oomScore:I
...
.method static synthetic lambda$sliceNetworkStatsByFgbg$8(Landroid/net/NetworkStats$Entry;Landroid/net/NetworkStats$Entry;)V
    ...
    iget p1, p1, Landroid/net/NetworkStats$Entry;->set:I

    iput p1, p0, Landroid/net/NetworkStats$Entry;->set:I
...
.method static synthetic lambda$sliceNetworkStatsByUidTagAndMetered$10(Landroid/net/NetworkStats$Entry;Landroid/net/NetworkStats$Entry;)V
    ...
    iget p1, p1, Landroid/net/NetworkStats$Entry;->metered:I

    iput p1, p0, Landroid/net/NetworkStats$Entry;->metered:I
...
.method private processHistoricalOp(Landroid/app/AppOpsManager$HistoricalOp;Ljava/util/List;IILjava/lang/String;Ljava/lang/String;)V
    ...
    iget p1, v7, Lcom/android/server/stats/pull/StatsPullAtomService$AppOpEntry;->mHash:I
...
.method private processHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;II)Ljava/util/List;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/stats/pull/StatsPullAtomService;->processHistoricalOp(Landroid/app/AppOpsManager$HistoricalOp;Ljava/util/List;IILjava/lang/String;Ljava/lang/String;)V
...
.method private pullDataBytesTransferLocked(ILjava/util/List;)I
    ...
    new-instance v9, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda23;

    invoke-direct {v9, v7}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda23;-><init>(Lcom/android/server/stats/pull/netstats/NetworkStatsExt;)V
    ...
    invoke-virtual {v8}, Landroid/net/NetworkStats;->removeEmptyEntries()Landroid/net/NetworkStats;
    ...
    :sswitch_0
    invoke-direct {v0, v4, v2}, Lcom/android/server/stats/pull/StatsPullAtomService;->addOemDataUsageBytesTransferAtoms(Lcom/android/server/stats/pull/netstats/NetworkStatsExt;Ljava/util/List;)V
...
.method private pullNumBiometricsEnrolledLocked(IILjava/util/List;)I
    ...
    invoke-virtual {v1, v7}, Landroid/hardware/fingerprint/FingerprintManager;->getEnrolledFingerprints(I)Ljava/util/List;
    ...
    invoke-virtual {v2, v7}, Landroid/hardware/face/FaceManager;->getEnrolledFaces(I)Ljava/util/List;
    ...
    :goto_2
    invoke-static {p2, v7, v8}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(III)Landroid/util/StatsEvent;
...
.method private registerBinderCallsStats()V
    ...
    invoke-virtual {v1, v4, v0, v2, v3}, Landroid/app/StatsManager;->setPullAtomCallback(ILandroid/app/StatsManager$PullAtomMetadata;Ljava/util/concurrent/Executor;Landroid/app/StatsManager$StatsPullAtomCallback;)V
...
.method private sampleAppOps(Ljava/util/List;Ljava/util/List;II)I
    ...
    invoke-direct {v0, v1, v3, v4, v2}, Lcom/android/server/stats/pull/StatsPullAtomService;->sampleAppOps(Ljava/util/List;Ljava/util/List;II)I
...
.method public onBootPhase(I)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda14;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda15;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService;)V
...
.method parseKeystoreKeyCreationWithAuthInfo([Landroid/security/metrics/KeystoreAtom;Ljava/util/List;)I
    ...
    invoke-static {v5, v6, v7, v4, v3}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIIII)Landroid/util/StatsEvent;
...
.method parseKeystoreStorageStats([Landroid/security/metrics/KeystoreAtom;Ljava/util/List;)I
    ...
    iget v5, v3, Landroid/security/metrics/StorageStats;->storage_type:I

    iget v6, v3, Landroid/security/metrics/StorageStats;->size:I

    iget v3, v3, Landroid/security/metrics/StorageStats;->unused_size:I

    int-to-long v7, v3

    invoke-static {v4, v5, v6, v7, v8}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIIJ)Landroid/util/StatsEvent;
...
.method parseRkpErrorStats([Landroid/security/metrics/KeystoreAtom;Ljava/util/List;)I
    ...
    iget v4, v4, Landroid/security/metrics/RkpErrorStats;->rkpError:I
...
.method parseRkpPoolStats([Landroid/security/metrics/KeystoreAtom;Ljava/util/List;)I
    ...
    invoke-virtual {v3}, Landroid/security/metrics/KeystoreAtomPayload;->getRkpPoolStats()Landroid/security/metrics/RkpPoolStats;

    move-result-object v3

    const/16 v4, 0x2778

    iget v5, v3, Landroid/security/metrics/RkpPoolStats;->security_level:I

    iget v6, v3, Landroid/security/metrics/RkpPoolStats;->expiring:I

    iget v7, v3, Landroid/security/metrics/RkpPoolStats;->unassigned:I

    iget v8, v3, Landroid/security/metrics/RkpPoolStats;->attested:I

    iget v9, v3, Landroid/security/metrics/RkpPoolStats;->total:I
...
.method pullAccessibilityFloatingMenuStatsLocked(ILjava/util/List;)I
    ...
    invoke-direct {p0, v7, v5}, Lcom/android/server/stats/pull/StatsPullAtomService;->isAccessibilityFloatingMenuUser(Landroid/content/Context;I)Z
    ...
    const-string v0, "pulling accessibility floating menu stats failed at getUsers"
...
.method pullAccessibilityShortcutStatsLocked(ILjava/util/List;)I
    ...
    invoke-direct {v0, v8, v6}, Lcom/android/server/stats/pull/StatsPullAtomService;->isAccessibilityShortcutUser(Landroid/content/Context;I)Z
    ...
    invoke-direct {v0, v8}, Lcom/android/server/stats/pull/StatsPullAtomService;->convertToAccessibilityShortcutType(I)I
    ...
    invoke-direct {v0, v8}, Lcom/android/server/stats/pull/StatsPullAtomService;->countAccessibilityServices(Ljava/lang/String;)I
...
.method pullAppOpsLocked(ILjava/util/List;)I
    ...
    invoke-direct {p0, v3, p1, v4}, Lcom/android/server/stats/pull/StatsPullAtomService;->processHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;II)Ljava/util/List;

    move-result-object v3

    invoke-direct {p0, p2, v3, p1, v4}, Lcom/android/server/stats/pull/StatsPullAtomService;->sampleAppOps(Ljava/util/List;Ljava/util/List;II)I

    move-result p1

    if-eq p1, v4, :cond_0

    const-string p1, "Atom 10060 downsampled - too many dimensions"
...
.method pullAppSizeLocked(ILjava/util/List;)I
    ...
    const-string v0, "Unable to read diskstats cache file within pullAppSize"
...
.method pullAppsOnExternalStorageInfoLocked(ILjava/util/List;)I
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mStorageManager:Landroid/os/storage/StorageManager;

    iget-object v5, v3, Landroid/content/pm/ApplicationInfo;->storageUuid:Ljava/util/UUID;
...
.method pullAttributedAppOpsLocked(ILjava/util/List;)I
    ...
    new-instance v4, Lcom/android/server/stats/pull/StatsPullAtomService$3;

    invoke-direct {v4, p0}, Lcom/android/server/stats/pull/StatsPullAtomService$3;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService;)V
    ...
    invoke-direct {p0, v2, p1, v3}, Lcom/android/server/stats/pull/StatsPullAtomService;->processHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;II)Ljava/util/List;

    move-result-object v2

    iget v3, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mAppOpsSamplingRate:I

    invoke-direct {p0, p2, v2, p1, v3}, Lcom/android/server/stats/pull/StatsPullAtomService;->sampleAppOps(Ljava/util/List;Ljava/util/List;II)I
    ...
    const-string v2, "Could not read appops"
...
.method pullBinderCallsStatsExceptionsLocked(ILjava/util/List;)I
    ...
    const-string p2, "failed to get binderStats"
    ...
    invoke-static {p1, v2, v3, v4}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(ILjava/lang/String;J)Landroid/util/StatsEvent;
...
.method pullCategorySizeLocked(ILjava/util/List;)I
    ...
    const-string p2, "Unable to read diskstats cache file within pullCategorySize"
...
.method pullCooldownDeviceLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v7}, Landroid/os/CoolingDevice;->getType()I

    move-result v8

    invoke-virtual {v7}, Landroid/os/CoolingDevice;->getName()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v7}, Landroid/os/CoolingDevice;->getValue()J

    move-result-wide v10

    long-to-int v7, v10

    invoke-static {p1, v8, v9, v7}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;I)Landroid/util/StatsEvent;
    ...
    const-string p2, "Disconnected from thermal service. Cannot pull temperatures."
...
.method pullCpuCyclesPerThreadGroupCluster(ILjava/util/List;)I
    ...
    iget-object v0, p0, Lcom/android/server/stats/pull/StatsPullAtomService;->mSurfaceFlingerProcessCpuThreadReader:Lcom/android/internal/os/SelectedProcessCpuThreadReader;

    invoke-virtual {v0}, Lcom/android/internal/os/SelectedProcessCpuThreadReader;->readAbsolute()Lcom/android/internal/os/KernelSingleProcessCpuThreadReader$ProcessCpuUsage;
    ...
    iget-object v5, v0, Lcom/android/internal/os/KernelSingleProcessCpuThreadReader$ProcessCpuUsage;->threadCpuTimesMillis:[J
    ...
    invoke-static {p1, p2, v0, v3}, Lcom/android/server/stats/pull/StatsPullAtomService;->addCpuCyclesPerThreadGroupClusterAtoms(ILjava/util/List;I[J)V
...
.method pullCpuCyclesPerUidClusterLocked(ILjava/util/List;)I
    ...
    new-instance v10, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda8;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda8;-><init>(Landroid/util/SparseArray;I[I[J[D)V
...
.method pullCpuTimePerClusterFreqLocked(ILjava/util/List;)I
    ...
    invoke-static {p1, v5, v6, v7, v8}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIIJ)Landroid/util/StatsEvent;
...
.method pullCpuTimePerUidFreqLocked(ILjava/util/List;)I
    ...
    invoke-static {p1, v4, v6, v7, v8}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIIJ)Landroid/util/StatsEvent;
...
.method pullDangerousPermissionStateLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v14, v0, v1}, Landroid/content/pm/PackageManager;->getInstalledPackagesAsUser(II)Ljava/util/List;
    ...
    :try_start_1
    invoke-virtual {v14, v0, v6}, Landroid/content/pm/PackageManager;->getPermissionInfo(Ljava/lang/String;I)Landroid/content/pm/PermissionInfo;
    ...
    invoke-virtual {v14, v0, v6, v3}, Landroid/content/pm/PackageManager;->getPermissionFlags(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)I
...
.method pullDeviceCalculatedPowerBlameOtherLocked(ILjava/util/List;)I
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/stats/pull/StatsPullAtomService;->milliAmpHrsToNanoAmpSecs(D)J

    move-result-wide v3

    invoke-static {p1, v2, v3, v4}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIJ)Landroid/util/StatsEvent;
...
.method pullDeviceCalculatedPowerUseLocked(ILjava/util/List;)I
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/stats/pull/StatsPullAtomService;->milliAmpHrsToNanoAmpSecs(D)J
...
.method pullDiskStatsLocked(ILjava/util/List;)I
    ...
    :cond_5
    :try_start_5
    invoke-interface {v4}, Landroid/os/IStoraged;->getRecentPerf()I
    ...
    const-string v4, "storaged not found"
...
.method pullExternalStorageInfoLocked(ILjava/util/List;)I
    ...
    :goto_2
    iget-wide v3, v4, Landroid/os/storage/DiskInfo;->size:J

    invoke-static {p1, v5, v2, v3, v4}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IIIJ)Landroid/util/StatsEvent;
...
.method pullKernelWakelockLocked(ILjava/util/List;)I
    ...
    iget v5, v1, Lcom/android/internal/os/KernelWakelockStats$Entry;->mCount:I

    iget v6, v1, Lcom/android/internal/os/KernelWakelockStats$Entry;->mVersion:I

    iget-wide v7, v1, Lcom/android/internal/os/KernelWakelockStats$Entry;->mTotalTime:J

    move v3, p1

    invoke-static/range {v3 .. v8}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(ILjava/lang/String;IIJ)Landroid/util/StatsEvent;
...
.method pullKeystoreAtoms(ILjava/util/List;)I
    ...
    const-string p1, "Keystore service is null"
    ...
    :try_start_b
    const-string p2, "pulling keystore metrics failed"
    ...
    :try_start_c
    const-string p2, "Disconnected from keystore service. Cannot pull."
...
.method pullModemActivityInfoLocked(ILjava/util/List;)I
    ...
    invoke-direct {v7, v0, v4}, Lcom/android/server/stats/pull/StatsPullAtomService$2;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService;Ljava/util/concurrent/CompletableFuture;)V
...
.method pullNotificationRemoteViewsLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v5, v6, v7, v11}, Ljava/util/concurrent/TimeUnit;->convert(JLjava/util/concurrent/TimeUnit;)J
    ...
    :cond_1
    :try_start_1
    invoke-static {p1, p2, v11}, Lcom/android/server/stats/pull/StatsPullAtomService;->unpackStreamedData(ILjava/util/List;Ljava/util/List;)V
    :try_end_1
...
.method pullProcessDmabufMemory(ILjava/util/List;)I
    ...
    :cond_1
    iget v2, v1, Landroid/app/ProcessMemoryState;->pid:I

    invoke-static {v2}, Lcom/android/internal/os/DmabufInfoReader;->getProcessStats(I)Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;

    move-result-object v2

    if-eqz v2, :cond_0

    iget v3, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->retainedBuffersCount:I

    if-gtz v3, :cond_2

    iget v3, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->mappedBuffersCount:I
    ...
    :cond_2
    iget v5, v1, Landroid/app/ProcessMemoryState;->uid:I

    iget-object v6, v1, Landroid/app/ProcessMemoryState;->processName:Ljava/lang/String;

    iget v7, v1, Landroid/app/ProcessMemoryState;->oomScore:I

    iget v8, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->retainedSizeKb:I

    iget v9, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->retainedBuffersCount:I

    iget v10, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->mappedSizeKb:I

    iget v11, v2, Lcom/android/internal/os/DmabufInfoReader$ProcessDmabuf;->mappedBuffersCount:I

    move v4, p1

    invoke-static/range {v4 .. v11}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;IIIII)Landroid/util/StatsEvent;
...
.method pullProcessMemoryHighWaterMarkLocked(ILjava/util/List;)I
    ...
    iget v2, v5, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->rssHighWaterMarkInKilobytes:I
    ...
    :cond_3
    const-string p1, "sys.rss_hwm_reset.on"
...
.method pullProcessMemorySnapshotLocked(ILjava/util/List;)I
    ...
    invoke-static {v3}, Lcom/android/server/stats/pull/ProcfsMemoryUtil;->readMemorySnapshotFromProcfs(I)Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;
    ...
    iget v7, v2, Landroid/app/ProcessMemoryState;->pid:I
    ...
    iget v10, v3, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->anonRssInKilobytes:I

    iget v11, v3, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->swapInKilobytes:I

    iget v2, v3, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->anonRssInKilobytes:I
    ...
    invoke-static/range {v4 .. v12}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;IIIIII)Landroid/util/StatsEvent;
    ...
    invoke-direct {v2, v1}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda20;-><init>(Landroid/util/SparseArray;)V
    ...
    :cond_2
    iget v5, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->uid:I
    ...
    iget v9, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->rssInKilobytes:I

    iget v10, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->anonRssInKilobytes:I

    iget v11, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->swapInKilobytes:I

    iget v12, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->anonRssInKilobytes:I

    iget v4, v4, Lcom/android/server/stats/pull/ProcfsMemoryUtil$MemorySnapshot;->swapInKilobytes:I
...
.method pullRoleHolderLocked(ILjava/util/List;)I
    ...
    invoke-interface {v4, v8}, Lcom/android/role/RoleManagerLocal;->getRolesAndHolders(I)Ljava/util/Map;
    ...
    :try_start_1
    invoke-virtual {v3, v12, v6, v8}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v14, v13, v12, v11}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;Ljava/lang/String;)Landroid/util/StatsEvent;
...
.method pullRuntimeAppOpAccessMessageLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v3}, Landroid/app/AppOpsManager;->collectRuntimeAppOpAccessMessage()Landroid/app/RuntimeAppOpAccessMessage;
    ...
    const-string p1, "No runtime appop access message collected"
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getUid()I

    move-result v6

    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getPackageName()Ljava/lang/String;

    move-result-object v7

    const-string v8, ""

    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getAttributionTag()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getMessage()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getSamplingStrategy()I

    move-result v11

    invoke-virtual {v3}, Landroid/app/RuntimeAppOpAccessMessage;->getOp()Ljava/lang/String;
    ...
    invoke-static/range {v5 .. v12}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)Landroid/util/StatsEvent;
    ...
    :try_start_2
    const-string p2, "Could not read runtime appop access message"
...
.method pullSettingsStatsLocked(ILjava/util/List;)I
    ...
    const-string v0, "failed to pullSettingsStats"
...
.method pullTemperatureLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v7}, Landroid/os/Temperature;->getStatus()I

    move-result v7

    invoke-static {p1, v8, v9, v10, v7}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IILjava/lang/String;II)Landroid/util/StatsEvent;
...
.method pullTimeZoneDetectorStateLocked(ILjava/util/List;)I
    ...
    invoke-virtual {v0}, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;->isUserLocationEnabled()Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/stats/pull/StatsPullAtomService;->convertToMetricsDetectionMode(I)I
    ...
    invoke-virtual {v0}, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;->getLatestManualSuggestionProtoBytes()[B

    move-result-object v11

    invoke-virtual {v0}, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;->getLatestTelephonySuggestionProtoBytes()[B

    move-result-object v12

    invoke-virtual {v0}, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;->getLatestGeolocationSuggestionProtoBytes()[B

    move-result-object v13

    move v3, p1

    invoke-static/range {v3 .. v13}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(IZZZZZII[B[B[B)Landroid/util/StatsEvent;
...
.method pullWifiActivityInfoLocked(ILjava/util/List;)I
    ...
    invoke-direct {v6, v0}, Lcom/android/server/stats/pull/StatsPullAtomService$1;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService;)V

    new-instance v0, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda1;

    invoke-direct {v0, v4}, Lcom/android/server/stats/pull/StatsPullAtomService$$ExternalSyntheticLambda1;-><init>(Landroid/os/SynchronousResultReceiver;)V
...
.method registerEventListeners()V
    ...
    :try_start_0
    new-instance v2, Lcom/android/server/stats/pull/StatsPullAtomService$ThermalEventListener;

    invoke-direct {v2, v4}, Lcom/android/server/stats/pull/StatsPullAtomService$ThermalEventListener;-><init>(Lcom/android/server/stats/pull/StatsPullAtomService$1;)V

    invoke-interface {v1, v2}, Landroid/os/IThermalService;->registerThermalEventListener(Landroid/os/IThermalEventListener;)Z

    const-string v1, "register thermal listener successfully"
