...
.method deletePackageData(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/people/data/PackageData;->onDestroy()V
...
.method getBackupPayload()[B
    ...
    sget-object v1, Lcom/android/server/people/data/UserData;->TAG:Ljava/lang/String;

    const-string v2, "Failed to write conversations to backup payload."
    ...
    const-string v2, "Failed to write conversations end token to backup payload."
...
.method restore([B)V
    ...
    const-string v1, "Failed to restore conversations from backup payload."
