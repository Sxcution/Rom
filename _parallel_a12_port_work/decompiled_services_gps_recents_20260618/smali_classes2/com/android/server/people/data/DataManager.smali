...
.method private cleanupCachedShortcuts(II)V
    ...
    sget-object v3, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda14;->INSTANCE:Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda14;
    ...
    invoke-direct {p0, v3, p1, v4}, Lcom/android/server/people/data/DataManager;->hasActiveNotifications(Ljava/lang/String;ILjava/lang/String;)Z
...
.method private cleanupUser(I)V
    ...
    invoke-virtual {v2}, Lcom/android/server/people/data/DataManager$NotificationListener;->unregisterAsSystemService()V
    :try_end_1
    ...
    invoke-static {v1, p1}, Lcom/android/server/people/data/DataMaintenanceService;->cancelJob(Landroid/content/Context;I)V
...
.method private getConversationChannel(Landroid/content/pm/ShortcutInfo;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
    ...
    invoke-virtual {v6, v3, v7, v5}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    invoke-direct {p0, v3, v5, v4}, Lcom/android/server/people/data/DataManager;->hasActiveNotifications(Ljava/lang/String;ILjava/lang/String;)Z
...
.method private getConversationChannel(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
    ...
    invoke-direct {p0, p1, p4}, Lcom/android/server/people/data/DataManager;->getConversationChannel(Landroid/content/pm/ShortcutInfo;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
...
.method private getConversationInfoOrThrow(Lcom/android/server/people/data/ConversationStore;Ljava/lang/String;)Lcom/android/server/people/data/ConversationInfo;
    ...
    const-string p2, "Conversation does not exist"
...
.method private getConversationStoreOrThrow(Ljava/lang/String;I)Lcom/android/server/people/data/ConversationStore;
    ...
    const-string v1, "No conversations exist for package "
    ...
    const-string v1, "No settings exist for package "
...
.method private getPackageIfConversationExists(Landroid/service/notification/StatusBarNotification;Ljava/util/function/Consumer;)Lcom/android/server/people/data/PackageData;
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/people/data/ConversationStore;->getConversation(Ljava/lang/String;)Lcom/android/server/people/data/ConversationInfo;
...
.method private getUnlockedUserData(I)Lcom/android/server/people/data/UserData;
    ...
    invoke-virtual {p1}, Lcom/android/server/people/data/UserData;->isUnlocked()Z
...
.method private hasActiveNotifications(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    check-cast p2, Lcom/android/server/people/data/DataManager$NotificationListener;

    if-eqz p2, :cond_0

    invoke-virtual {p2, p1, p3}, Lcom/android/server/people/data/DataManager$NotificationListener;->hasActiveNotifications(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private pruneUninstalledPackageData(Lcom/android/server/people/data/UserData;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/people/data/UserData;->deletePackageData(Ljava/lang/String;)V
...
.method private setupUser(I)V
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/server/people/data/UserData;->loadUserData()V

    invoke-direct {p0, v0}, Lcom/android/server/people/data/DataManager;->updateDefaultDialer(Lcom/android/server/people/data/UserData;)V

    invoke-direct {p0, v0}, Lcom/android/server/people/data/DataManager;->updateDefaultSmsApp(Lcom/android/server/people/data/UserData;)V
    ...
    new-instance v3, Lcom/android/server/people/data/DataManager$UsageStatsQueryRunnable;

    const/4 v9, 0x0

    invoke-direct {v3, p0, p1, v9}, Lcom/android/server/people/data/DataManager$UsageStatsQueryRunnable;-><init>(Lcom/android/server/people/data/DataManager;ILcom/android/server/people/data/DataManager$1;)V
    ...
    new-instance v4, Lcom/android/server/people/data/DataManager$PerUserBroadcastReceiver;

    invoke-direct {v4, p0, p1, v9}, Lcom/android/server/people/data/DataManager$PerUserBroadcastReceiver;-><init>(Lcom/android/server/people/data/DataManager;ILcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-direct {v0, p0, v2, v9}, Lcom/android/server/people/data/DataManager$ContactsContentObserver;-><init>(Lcom/android/server/people/data/DataManager;Landroid/os/Handler;Lcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-virtual {v2, v3, v4, v0, p1}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    new-instance v0, Lcom/android/server/people/data/DataManager$NotificationListener;

    invoke-direct {v0, p0, p1, v9}, Lcom/android/server/people/data/DataManager$NotificationListener;-><init>(Lcom/android/server/people/data/DataManager;ILcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-virtual {v0, v2, v3, p1}, Lcom/android/server/people/data/DataManager$NotificationListener;->registerAsSystemService(Landroid/content/Context;Landroid/content/ComponentName;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {v0, p0, v9}, Lcom/android/server/people/data/DataManager$PerUserPackageMonitor;-><init>(Lcom/android/server/people/data/DataManager;Lcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-virtual {v0, v2, v9, v3, v4}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Landroid/os/UserHandle;Z)V
    ...
    invoke-direct {v0, p0, v2, v9}, Lcom/android/server/people/data/DataManager$CallLogContentObserver;-><init>(Lcom/android/server/people/data/DataManager;Landroid/os/Handler;Lcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-direct {v0, p0, v2, v9}, Lcom/android/server/people/data/DataManager$MmsSmsContentObserver;-><init>(Lcom/android/server/people/data/DataManager;Landroid/os/Handler;Lcom/android/server/people/data/DataManager$1;)V
    ...
    invoke-virtual {v0, v2, v5, v3, v5}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
...
.method private updateConversationStoreThenNotifyListeners(Lcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/ConversationInfo;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p3, p4, p1, p2}, Lcom/android/server/people/data/DataManager;->getConversationChannel(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
...
.method private updateDefaultDialer(Lcom/android/server/people/data/UserData;)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lcom/android/server/people/data/UserData;->setDefaultDialer(Ljava/lang/String;)V
...
.method private updateDefaultSmsApp(Lcom/android/server/people/data/UserData;)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lcom/android/server/people/data/UserData;->setDefaultSmsApp(Ljava/lang/String;)V
...
.method addOrUpdateConversationInfo(Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/android/server/people/data/DataManager;->updateConversationStoreThenNotifyListeners(Lcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/ConversationInfo;Landroid/content/pm/ShortcutInfo;)V
...
.method public addOrUpdateStatus(Ljava/lang/String;ILjava/lang/String;Landroid/app/people/ConversationStatus;)V
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lcom/android/server/people/data/DataManager;->updateConversationStoreThenNotifyListeners(Lcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/ConversationInfo;Ljava/lang/String;I)V
...
.method public clearStatus(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, p3, p1, p2}, Lcom/android/server/people/data/DataManager;->updateConversationStoreThenNotifyListeners(Lcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/ConversationInfo;Ljava/lang/String;I)V
...
.method public getBackupPayload(I)[B
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/people/data/UserData;->getBackupPayload()[B
...
.method public getConversation(Ljava/lang/String;ILjava/lang/String;)Landroid/app/people/ConversationChannel;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/server/people/data/DataManager;->getConversationChannel(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
...
.method getConversationInfo(Ljava/lang/String;ILjava/lang/String;)Lcom/android/server/people/data/ConversationInfo;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/people/data/UserData;->getPackageData(Ljava/lang/String;)Lcom/android/server/people/data/PackageData;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1, p3}, Lcom/android/server/people/data/PackageData;->getConversationInfo(Ljava/lang/String;)Lcom/android/server/people/data/ConversationInfo;
...
.method getNotificationListenerServiceForTesting(I)Lcom/android/server/people/data/DataManager$NotificationListener;
    ...
    check-cast p1, Lcom/android/server/people/data/DataManager$NotificationListener;
...
.method getPackageMonitorForTesting(I)Lcom/android/internal/content/PackageMonitor;
    ...
    check-cast p1, Lcom/android/internal/content/PackageMonitor;
...
.method public getShortcut(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/people/data/DataManager;->getShortcuts(Ljava/lang/String;ILjava/util/List;)Ljava/util/List;
...
.method public getStatuses(Ljava/lang/String;ILjava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/people/data/DataManager;->getConversationInfoOrThrow(Lcom/android/server/people/data/ConversationStore;Ljava/lang/String;)Lcom/android/server/people/data/ConversationInfo;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/android/server/people/data/DataManager;->getStatuses(Lcom/android/server/people/data/ConversationInfo;)Ljava/util/List;
...
.method public synthetic lambda$getRecentConversations$2$DataManager(Lcom/android/server/people/data/PackageData;Ljava/util/List;Lcom/android/server/people/data/ConversationInfo;)V
    ...
    invoke-direct {p0, v1, p1, v0, p3}, Lcom/android/server/people/data/DataManager;->getConversationChannel(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/people/data/ConversationInfo;)Landroid/app/people/ConversationChannel;
...
.method public synthetic lambda$notifyConversationsListeners$14$DataManager(Ljava/util/List;)V
    ...
    check-cast v1, Lcom/android/server/people/PeopleService$ConversationsListener;

    invoke-interface {v1, p1}, Lcom/android/server/people/PeopleService$ConversationsListener;->onConversationsUpdate(Ljava/util/List;)V
    :try_end_2
...
.method public synthetic lambda$pruneDataForUser$8$DataManager(Landroid/os/CancellationSignal;ILcom/android/server/people/data/PackageData;)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/people/data/DataManager;->cleanupCachedShortcuts(II)V
...
.method public synthetic lambda$pruneExpiredConversationStatuses$6$DataManager(JLcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/PackageData;Lcom/android/server/people/data/ConversationInfo;)V
    ...
    invoke-direct {p0, p3, p1, p2, p4}, Lcom/android/server/people/data/DataManager;->updateConversationStoreThenNotifyListeners(Lcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/ConversationInfo;Ljava/lang/String;I)V
...
.method public synthetic lambda$pruneExpiredConversationStatuses$7$DataManager(JLcom/android/server/people/data/PackageData;)V
    ...
    new-instance v6, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda5;
...
.method public synthetic lambda$pruneOldRecentConversations$5$DataManager(JILcom/android/server/people/data/PackageData;)V
    ...
    new-instance v10, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda6;
    ...
    iget-object p1, p0, Lcom/android/server/people/data/DataManager;->mContext:Landroid/content/Context;
...
.method public reportShareTargetEvent(Landroid/app/prediction/AppTargetEvent;Landroid/content/IntentFilter;)V
    ...
    invoke-virtual {v0, v2, p1}, Lcom/android/server/people/data/EventStore;->getOrCreateEventHistory(ILjava/lang/String;)Lcom/android/server/people/data/EventHistoryImpl;
    ...
    invoke-direct {v0, v1, v2, p2}, Lcom/android/server/people/data/Event;-><init>(JI)V

    invoke-virtual {p1, v0}, Lcom/android/server/people/data/EventHistoryImpl;->addEvent(Lcom/android/server/people/data/Event;)V
...
.method public restore(I[B)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lcom/android/server/people/data/UserData;->restore([B)V
