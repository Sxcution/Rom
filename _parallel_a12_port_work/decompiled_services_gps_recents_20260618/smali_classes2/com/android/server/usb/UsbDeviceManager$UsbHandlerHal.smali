...
.method constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/usb/UsbDeviceManager;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbPermissionManager;)V
    ...
    iput p3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;->mUsbSpeed:I

    const/16 p3, 0xa

    iput p3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;->mCurrentGadgetHalVersion:I
...
.method private setUsbConfig(JZ)V
    ...
    const-string p2, "setUsbConfig mGadgetProxy is null"
    ...
    iget-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;->mConnected:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v1, "mGadgetProxy is null"
    ...
    iput v0, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;->mCurrentGadgetHalVersion:I
    ...
    const-string v1, "reset Usb Gadget mGadgetProxy is null"
    ...
    :try_start_5
    invoke-static {p1}, Landroid/hardware/usb/gadget/V1_1/IUsbGadget;->castFrom(Landroid/os/IHwInterface;)Landroid/hardware/usb/gadget/V1_1/IUsbGadget;

    move-result-object p1

    invoke-interface {p1}, Landroid/hardware/usb/gadget/V1_1/IUsbGadget;->reset()I
    :try_end_5
    ...
    const-string v2, "reset Usb Gadget failed"
    ...
    iget-wide v2, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;->mCurrentFunctions:J
...
.method protected setEnabledFunctions(JZ)V
    ...
    const-string p2, "Could not set unsupported function for the GadgetHal"
