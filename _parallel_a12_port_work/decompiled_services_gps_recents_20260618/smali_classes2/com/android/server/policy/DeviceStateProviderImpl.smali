...
.method private constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/policy/DeviceStateProviderImpl$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/policy/DeviceStateProviderImpl$$ExternalSyntheticLambda2;
...
.method static createFromConfig(Landroid/content/Context;Lcom/android/server/policy/DeviceStateProviderImpl$ReadableConfig;)Lcom/android/server/policy/DeviceStateProviderImpl;
    ...
    :pswitch_0
    const-string v11, "FLAG_CANCEL_STICKY_REQUESTS"
...
.method private setStateConditions(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v0, v15, v2}, Lcom/android/server/policy/DeviceStateProviderImpl;->findSensor(Ljava/lang/String;Ljava/lang/String;)Landroid/hardware/Sensor;
...
.method notifyDeviceStateChangedIfNeeded()V
    ...
    invoke-interface {v0, v1}, Lcom/android/server/devicestate/DeviceStateProvider$Listener;->onStateChanged(I)V
...
.method public setListener(Lcom/android/server/devicestate/DeviceStateProvider$Listener;)V
    ...
    const-string v1, "Provider already has a listener set."
