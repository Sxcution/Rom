...
.method cancel(Landroid/speech/IRecognitionListener;Z)V
    ...
    sget-object p2, Lcom/android/server/speech/RemoteSpeechRecognitionService;->TAG:Ljava/lang/String;

    const-string v1, "#cancel called with an unexpected listener"

    invoke-static {p2, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    const/4 p2, 0x5

    invoke-static {p1, p2}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->tryRespondWithError(Landroid/speech/IRecognitionListener;I)V
    ...
    new-instance v1, Lcom/android/server/speech/RemoteSpeechRecognitionService$$ExternalSyntheticLambda1;

    invoke-direct {v1, p1, p2}, Lcom/android/server/speech/RemoteSpeechRecognitionService$$ExternalSyntheticLambda1;-><init>(Landroid/speech/IRecognitionListener;Z)V

    invoke-virtual {p0, v1}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->run(Lcom/android/internal/infra/ServiceConnector$VoidJob;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->run(Lcom/android/internal/infra/ServiceConnector$VoidJob;)Z
...
.method protected onServiceConnectionStatusChanged(Landroid/speech/IRecognitionService;Z)V
    ...
    const-string v0, "Connection to speech recognition service lost, but no #startListening has been invoked yet."
...
.method startListening(Landroid/content/Intent;Landroid/speech/IRecognitionListener;Landroid/content/AttributionSource;)V
    ...
    const-string p2, "#startListening called with no preceding #setListening - ignoring"
    ...
    invoke-static {p2, p1}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->tryRespondWithError(Landroid/speech/IRecognitionListener;I)V
    ...
    const-string p3, "#startListening called while listening is in progress."
    ...
    new-instance p2, Lcom/android/server/speech/RemoteSpeechRecognitionService$$ExternalSyntheticLambda0;

    invoke-direct {p2, p1, v1, p3}, Lcom/android/server/speech/RemoteSpeechRecognitionService$$ExternalSyntheticLambda0;-><init>(Landroid/content/Intent;Lcom/android/server/speech/RemoteSpeechRecognitionService$DelegatingListener;Landroid/content/AttributionSource;)V

    invoke-virtual {p0, p2}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->run(Lcom/android/internal/infra/ServiceConnector$VoidJob;)Z
...
.method stopListening(Landroid/speech/IRecognitionListener;)V
    ...
    const-string v1, "#stopListening called while listening isn\'t in progress, ignoring."
    ...
    invoke-direct {v1, p1}, Lcom/android/server/speech/RemoteSpeechRecognitionService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/speech/RemoteSpeechRecognitionService$DelegatingListener;)V
