...
.method static synthetic access$000(Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;)Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    iget-object p0, p0, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
...
.method private componentMapsToRecognitionService(Landroid/content/ComponentName;)Z
    ...
    const-string v2, "serviceComponent is not RecognitionService: "
...
.method private createService(ILandroid/content/ComponentName;)Lcom/android/server/speech/RemoteSpeechRecognitionService;
    ...
    invoke-direct {v3, p2}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda3;-><init>(Landroid/content/ComponentName;)V
    ...
    iget-object p1, p0, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;

    check-cast p1, Lcom/android/server/speech/SpeechRecognitionManagerService;

    iget-boolean p1, p1, Lcom/android/server/speech/SpeechRecognitionManagerService;->debug:Z
    ...
    const-string v3, "Reused existing connection to "
    ...
    sget-object v3, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda2;
    ...
    const-string v3, "Creating a new connection to "
...
.method private getOnDeviceComponentNameLocked()Landroid/content/ComponentName;
    ...
    iget-boolean v0, v0, Lcom/android/server/speech/SpeechRecognitionManagerService;->verbose:Z
...
.method createSessionLocked(Landroid/content/ComponentName;Landroid/os/IBinder;ZLandroid/speech/IRecognitionServiceManagerCallback;)V
    ...
    const-string p2, "Service component is undefined, responding with error."
    ...
    invoke-direct {p0, v4, p1}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->createService(ILandroid/content/ComponentName;)Lcom/android/server/speech/RemoteSpeechRecognitionService;
    ...
    invoke-virtual {v3}, Lcom/android/server/speech/RemoteSpeechRecognitionService;->connect()Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct {p0, v4, v3, v1}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->handleClientDeath(ILcom/android/server/speech/RemoteSpeechRecognitionService;Z)V
...
.method public synthetic lambda$createSessionLocked$1$SpeechRecognitionManagerServiceImpl(Landroid/speech/IRecognitionServiceManagerCallback;Lcom/android/server/speech/RemoteSpeechRecognitionService;ILandroid/os/IBinder;Landroid/os/IBinder$DeathRecipient;Landroid/speech/IRecognitionService;)V
    ...
    sget-object p3, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->TAG:Ljava/lang/String;

    const-string p4, "Error creating a speech recognition session"
