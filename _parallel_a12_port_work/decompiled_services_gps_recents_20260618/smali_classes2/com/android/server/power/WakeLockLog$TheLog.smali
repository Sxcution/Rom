...
.method private readEntryAt(IJLcom/android/server/power/WakeLockLog$LogEntry;)Lcom/android/server/power/WakeLockLog$LogEntry;
    ...
    iget-object v0, p0, Lcom/android/server/power/WakeLockLog$TheLog;->mReadWriteTempBuffer:[B

    invoke-virtual {p1, v0, p2, p3, p4}, Lcom/android/server/power/WakeLockLog$EntryByteTranslator;->fromBytes([BJLcom/android/server/power/WakeLockLog$LogEntry;)Lcom/android/server/power/WakeLockLog$LogEntry;
...
.method private removeTagIndex(I)V
    ...
    const-string v1, "Entry is unreadable - Unexpected @ "
...
.method private writeEntryAt(ILcom/android/server/power/WakeLockLog$LogEntry;J)V
    ...
    invoke-direct {p0, p1, p3, p2}, Lcom/android/server/power/WakeLockLog$TheLog;->writeBytesAt(I[BI)V
...
.method addEntry(Lcom/android/server/power/WakeLockLog$LogEntry;)V
    ...
    iget-object v0, p1, Lcom/android/server/power/WakeLockLog$LogEntry;->tag:Lcom/android/server/power/WakeLockLog$TagData;

    iget-wide v1, p1, Lcom/android/server/power/WakeLockLog$LogEntry;->time:J

    invoke-static {v0, v1, v2}, Lcom/android/server/power/WakeLockLog$TagDatabase;->updateTagTime(Lcom/android/server/power/WakeLockLog$TagData;J)V
    ...
    const-string v1, "Log entry size is out of expected range: "
