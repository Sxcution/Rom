...
.method private sendUserActivity(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/FaceDownDetector;->userActivity(I)V

    iget-object p1, p0, Lcom/android/server/power/Notifier;->mScreenUndimDetector:Lcom/android/server/power/ScreenUndimDetector;

    invoke-virtual {p1}, Lcom/android/server/power/ScreenUndimDetector;->userActivity()V
...
.method public synthetic lambda$handleLateInteractiveChange$2$Notifier(I)V
    ...
    invoke-interface {p1, v0}, Lcom/android/server/policy/WindowManagerPolicy;->finishedWakingUp(I)V
...
.method public synthetic lambda$handleLateInteractiveChange$3$Notifier(II)V
    ...
    iget p2, p0, Lcom/android/server/power/Notifier;->mInteractiveChangeReason:I

    invoke-interface {p1, p2}, Lcom/android/server/policy/WindowManagerPolicy;->finishedGoingToSleep(I)V
...
.method public onLongPartialWakeLockFinish(Ljava/lang/String;ILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-static {p2, p3, p1, p4, v0}, Lcom/android/internal/util/FrameworkStatsLog;->write(ILandroid/os/WorkSource;Ljava/lang/String;Ljava/lang/String;I)V
...
.method public onScreenPolicyUpdate(I)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/power/Notifier$NotifierHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public onUserActivity(II)V
    ...
    :goto_0
    iget-object p2, p0, Lcom/android/server/power/Notifier;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/power/Notifier$NotifierHandler;->obtainMessage(I)Landroid/os/Message;
...
.method public onWakeLockAcquired(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-virtual {p5, p6, p4, p3}, Landroid/app/AppOpsManager;->startOpNoThrow(IILjava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    :goto_2
    iget-object p3, p0, Lcom/android/server/power/Notifier;->mWakeLockLog:Lcom/android/server/power/WakeLockLog;

    invoke-virtual {p3, p2, p4, p1}, Lcom/android/server/power/WakeLockLog;->onWakeLockAcquired(Ljava/lang/String;II)V
...
.method public onWakeLockReleased(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_1
    iget-object p1, p0, Lcom/android/server/power/Notifier;->mWakeLockLog:Lcom/android/server/power/WakeLockLog;

    invoke-virtual {p1, p2, p4}, Lcom/android/server/power/WakeLockLog;->onWakeLockReleased(Ljava/lang/String;I)V
...
.method public onWakeUp(ILjava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-virtual {p2, p3, p5, p4}, Landroid/app/AppOpsManager;->noteOpNoThrow(IILjava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onWakefulnessChangeStarted(IIJ)V
    ...
    :goto_1
    invoke-static {p1, v2}, Lcom/android/internal/util/FrameworkStatsLog;->write(II)V
