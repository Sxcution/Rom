...
.method constructor <init>(ILcom/android/server/vibrator/VibratorController$OnVibrationCompleteListener;Lcom/android/server/vibrator/VibratorController$NativeWrapper;)V
    ...
    iput-object p2, p0, Lcom/android/server/vibrator/VibratorController;->mVibratorInfoBuilder:Landroid/os/VibratorInfo$Builder;

    const/high16 p1, 0x43480000    # 200.0f

    invoke-virtual {p3, p1, p2}, Lcom/android/server/vibrator/VibratorController$NativeWrapper;->getInfo(FLandroid/os/VibratorInfo$Builder;)Z

    move-result p1

    iput-boolean p1, p0, Lcom/android/server/vibrator/VibratorController;->mVibratorInfoLoaded:Z

    invoke-virtual {p2}, Landroid/os/VibratorInfo$Builder;->build()Landroid/os/VibratorInfo;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/vibrator/VibratorController;->mVibratorInfo:Landroid/os/VibratorInfo;
...
.method private notifyStateListenerLocked(Landroid/os/IVibratorStateListener;)V
    ...
    const-string v1, "Vibrator state listener failed to call"
...
.method public updateAlwaysOn(ILandroid/os/vibrator/PrebakedSegment;)V
    ...
    :try_start_0
    iget-object p2, p0, Lcom/android/server/vibrator/VibratorController;->mNativeWrapper:Lcom/android/server/vibrator/VibratorController$NativeWrapper;

    int-to-long v1, p1

    invoke-virtual {p2, v1, v2}, Lcom/android/server/vibrator/VibratorController$NativeWrapper;->alwaysOnDisable(J)V
