...
.method constructor <init>(ILjava/io/File;IILjava/lang/String;[ILandroid/util/SparseIntArray;)V
    ...
    :goto_1
    iput-object p6, p0, Lcom/android/server/rollback/Rollback;->mPackageSessionIds:[I

    invoke-static {p7}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    check-cast p7, Landroid/util/SparseIntArray;

    iput-object p7, p0, Lcom/android/server/rollback/Rollback;->mExtensionVersions:Landroid/util/SparseIntArray;
...
.method constructor <init>(Landroid/content/rollback/RollbackInfo;Ljava/io/File;Ljava/time/Instant;IILjava/lang/String;ZILjava/lang/String;Landroid/util/SparseIntArray;)V
    ...
    check-cast p10, Landroid/util/SparseIntArray;
...
.method commit(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Landroid/content/IntentSender;)V
    ...
    invoke-static {v2, v3, v0, v1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->sendFailure(Landroid/content/Context;Landroid/content/IntentSender;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/PackageInstaller$SessionParams;->setRequestDowngrade(Z)V
    ...
    invoke-virtual {v0, v8}, Landroid/content/pm/PackageInstaller$SessionParams;->setInstallReason(I)V
    ...
    invoke-virtual {v0}, Landroid/content/rollback/PackageRollbackInfo;->isApkInApex()Z
    ...
    iget-object v14, v1, Lcom/android/server/rollback/Rollback;->mInstallerPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v6, v14}, Landroid/content/pm/PackageManager;->getInstallerPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    invoke-virtual {v7, v13}, Landroid/content/pm/PackageInstaller;->createSession(Landroid/content/pm/PackageInstaller$SessionParams;)I

    move-result v13

    invoke-virtual {v7, v13}, Landroid/content/pm/PackageInstaller;->openSession(I)Landroid/content/pm/PackageInstaller$Session;
    ...
    invoke-static {v1, v14}, Lcom/android/server/rollback/RollbackStore;->getPackageCodePaths(Lcom/android/server/rollback/Rollback;Ljava/lang/String;)[Ljava/io/File;
    ...
    const-string v5, "Backup copy of package: "
    ...
    const-string v0, " is inaccessible"
    ...
    invoke-virtual {v15, v0}, Landroid/content/pm/PackageInstaller$Session;->stageViaHardLink(Ljava/lang/String;)V
    :try_end_3
    ...
    :cond_c
    invoke-virtual {v10, v13}, Landroid/content/pm/PackageInstaller$Session;->addChildSessionId(I)V
    ...
    :cond_d
    invoke-static {v11}, Lcom/android/server/RescueParty;->resetDeviceConfigForPackages(Ljava/util/List;)V
    ...
    invoke-direct {v4, v0}, Lcom/android/server/rollback/LocalIntentReceiver;-><init>(Ljava/util/function/Consumer;)V

    const/4 v0, 0x3

    const-string v5, ""

    invoke-virtual {v1, v0, v5}, Lcom/android/server/rollback/Rollback;->setState(ILjava/lang/String;)V

    iget-object v0, v1, Lcom/android/server/rollback/Rollback;->info:Landroid/content/rollback/RollbackInfo;

    invoke-virtual {v0, v9}, Landroid/content/rollback/RollbackInfo;->setCommittedSessionId(I)V
    ...
    invoke-static {v2, v3, v1, v0}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->sendFailure(Landroid/content/Context;Landroid/content/IntentSender;ILjava/lang/String;)V
...
.method public synthetic lambda$commit$0$Rollback(Landroid/content/Intent;Landroid/content/Context;Landroid/content/IntentSender;Ljava/util/List;)V
    ...
    invoke-virtual {p4, v0}, Landroid/content/rollback/RollbackInfo;->setCommittedSessionId(I)V
    ...
    invoke-static {p2, p3, p4, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->sendFailure(Landroid/content/Context;Landroid/content/IntentSender;ILjava/lang/String;)V
    ...
    const-string p1, "android.content.rollback.extra.STATUS"
    ...
    const-string v0, "android.permission.MANAGE_ROLLBACKS"

    invoke-virtual {p2, p1, p4, v0}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;)V
