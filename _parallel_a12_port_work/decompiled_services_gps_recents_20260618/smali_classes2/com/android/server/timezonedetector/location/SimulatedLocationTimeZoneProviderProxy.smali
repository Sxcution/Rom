...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/timezonedetector/location/ThreadingDomain;)V
    ...
    new-instance p1, Lcom/android/server/timezonedetector/ReferenceWithHistory;

    const/16 p2, 0x32

    invoke-direct {p1, p2}, Lcom/android/server/timezonedetector/ReferenceWithHistory;-><init>(I)V

    iput-object p1, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mLastEvent:Lcom/android/server/timezonedetector/ReferenceWithHistory;
...
.method private static createTimeZoneProviderEventFromTestCommand(Lcom/android/server/timezonedetector/location/TestCommand;)Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;
    ...
    const-string v0, "Error: Unknown command name %s"
    ...
    new-instance v0, Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;

    invoke-direct {v0}, Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;-><init>()V

    invoke-static {p0}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object p0

    invoke-virtual {v0, p0}, Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;->setTimeZoneIds(Ljava/util/List;)Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;->setElapsedRealtimeMillis(J)Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;

    move-result-object p0

    invoke-virtual {p0}, Landroid/service/timezone/TimeZoneProviderSuggestion$Builder;->build()Landroid/service/timezone/TimeZoneProviderSuggestion;

    move-result-object p0

    invoke-static {p0}, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->createSuggestionEvent(Landroid/service/timezone/TimeZoneProviderSuggestion;)Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;
    ...
    const-string v0, "No tz arg found"
    ...
    :pswitch_2
    const-string p0, "Simulated failure"

    invoke-static {p0}, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->createPermanentFailureEvent(Ljava/lang/String;)Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;
...
.method public dump(Landroid/util/IndentingPrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mSharedLock:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    const-string v0, "{SimulatedLocationTimeZoneProviderProxy}"
    ...
    iget-object v1, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mRequest:Lcom/android/server/timezonedetector/location/TimeZoneProviderRequest;
    ...
    const-string v0, "Last event history:"

    invoke-virtual {p1, v0}, Landroid/util/IndentingPrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mLastEvent:Lcom/android/server/timezonedetector/ReferenceWithHistory;
...
.method handleTestCommand(Lcom/android/server/timezonedetector/location/TestCommand;Landroid/os/RemoteCallback;)V
    ...
    const-string p1, " is testing an invalid case: updates are off. mRequest="

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object p1, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mRequest:Lcom/android/server/timezonedetector/location/TimeZoneProviderRequest;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->handleTimeZoneProviderEvent(Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;)V
    ...
    iget-object p1, p0, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;->mThreadingDomain:Lcom/android/server/timezonedetector/location/ThreadingDomain;

    new-instance v2, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0}, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;)V

    invoke-virtual {p1, v2}, Lcom/android/server/timezonedetector/location/ThreadingDomain;->post(Ljava/lang/Runnable;)V
    ...
    new-instance v2, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0}, Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/timezonedetector/location/SimulatedLocationTimeZoneProviderProxy;)V
