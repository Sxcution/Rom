...
.method constructor <init>(Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderMetricsLogger;Lcom/android/server/timezonedetector/location/ThreadingDomain;Ljava/lang/String;Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderProxy;)V
    ...
    check-cast p4, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderProxy;
...
.method private handleOnProviderBound()V
    ...
    const-string v1, ": No state change required, provider is terminated."
    ...
    const-string v1, ": Provider is stopped."
    ...
    const-string v1, ": Provider is started."
...
.method private handleProviderLost(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/server/timezonedetector/location/BinderLocationTimeZoneProvider;->mProviderName:Ljava/lang/String;
    ...
    const-string p1, ": No state change required, provider is terminated."
    ...
    const-string p1, ": No state change required, provider is stopped."
    ...
    invoke-virtual {v1, v2, v3, v4, p1}, Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;->newState(ILcom/android/server/timezonedetector/location/TimeZoneProviderEvent;Lcom/android/server/timezonedetector/ConfigurationInternal;Ljava/lang/String;)Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;

    move-result-object p1

    const/4 v1, 0x1

    invoke-virtual {p0, p1, v1}, Lcom/android/server/timezonedetector/location/BinderLocationTimeZoneProvider;->setCurrentState(Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;Z)V
...
.method onStartUpdates(Ljava/time/Duration;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderProxy;->setRequest(Lcom/android/server/timezonedetector/location/TimeZoneProviderRequest;)V
