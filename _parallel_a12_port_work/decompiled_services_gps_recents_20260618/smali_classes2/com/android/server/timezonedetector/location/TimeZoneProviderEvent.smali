...
.method public static createPermanentFailureEvent(Ljava/lang/String;)Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;-><init>(ILandroid/service/timezone/TimeZoneProviderSuggestion;Ljava/lang/String;)V
...
.method public static createSuggestionEvent(Landroid/service/timezone/TimeZoneProviderSuggestion;)Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;
    ...
    check-cast p0, Landroid/service/timezone/TimeZoneProviderSuggestion;

    const/4 v1, 0x2

    const/4 v2, 0x0

    invoke-direct {v0, v1, p0, v2}, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;-><init>(ILandroid/service/timezone/TimeZoneProviderSuggestion;Ljava/lang/String;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    check-cast p1, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;

    iget v2, p0, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mType:I

    iget v3, p1, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mType:I

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mSuggestion:Landroid/service/timezone/TimeZoneProviderSuggestion;

    iget-object v3, p1, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mSuggestion:Landroid/service/timezone/TimeZoneProviderSuggestion;
    ...
    iget-object v2, p0, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mFailureCause:Ljava/lang/String;

    iget-object p1, p1, Lcom/android/server/timezonedetector/location/TimeZoneProviderEvent;->mFailureCause:Ljava/lang/String;
