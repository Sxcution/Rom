...
.method constructor <init>(Lcom/android/server/timezonedetector/location/ThreadingDomain;Lcom/android/server/timezonedetector/ServiceConfigAccessor;Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;)V
    ...
    iput-object p2, p0, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;->mServiceConfigAccessor:Lcom/android/server/timezonedetector/ServiceConfigAccessor;

    const-class p1, Lcom/android/server/timezonedetector/TimeZoneDetectorInternal;

    invoke-static {p1}, Lcom/android/server/LocalServices;->getService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/android/server/timezonedetector/TimeZoneDetectorInternal;

    iput-object p1, p0, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;->mTimeZoneDetectorInternal:Lcom/android/server/timezonedetector/TimeZoneDetectorInternal;

    new-instance p2, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0, p3}, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;)V

    iput-object p2, p0, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;->mConfigurationChangeListener:Lcom/android/server/timezonedetector/ConfigurationChangeListener;

    invoke-interface {p1, p2}, Lcom/android/server/timezonedetector/TimeZoneDetectorInternal;->addConfigurationListener(Lcom/android/server/timezonedetector/ConfigurationChangeListener;)V
