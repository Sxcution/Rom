...
.method private continueUpgradeLocked(IJ)V
    ...
    const-string p1, "Failed to write the tokens mappings file."
...
.method private deserializeIntervalStats([BI)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-static {p1, v0, p2, v1}, Lcom/android/server/usage/UsageStatsDatabase;->readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;ILcom/android/server/usage/PackagesTokenData;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private pruneStats(Ljava/util/HashMap;Lcom/android/server/usage/IntervalStats;)Z
    ...
    iget-object v0, p2, Lcom/android/server/usage/IntervalStats;->packageStats:Landroid/util/ArrayMap;
    ...
    iget-object v3, p2, Lcom/android/server/usage/IntervalStats;->packageStats:Landroid/util/ArrayMap;
    ...
    iget-object v0, p2, Lcom/android/server/usage/IntervalStats;->packageStatsObfuscated:Landroid/util/SparseArray;
    ...
    iget-object v3, p2, Lcom/android/server/usage/IntervalStats;->events:Landroid/app/usage/EventList;
...
.method private static readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;ILcom/android/server/usage/PackagesTokenData;)Z
    ...
    const-string v0, "Unable to read interval stats from proto."
...
.method private writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    iget p2, p0, Lcom/android/server/usage/UsageStatsDatabase;->mCurrentVersion:I
...
.method public checkinDailyFiles(Lcom/android/server/usage/UsageStatsDatabase$CheckinAction;)Z
    ...
    invoke-direct {p0, v8, v5}, Lcom/android/server/usage/UsageStatsDatabase;->readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-virtual {v1, v4, p1}, Landroid/app/usage/TimeSparseArray;->setValueAt(ILjava/lang/Object;)V
...
.method public getBackupPayload(Ljava/lang/String;I)[B
    ...
    invoke-direct {p0, p1, v6, p2}, Lcom/android/server/usage/UsageStatsDatabase;->writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
    ...
    invoke-direct {p0, p1, v1, p2}, Lcom/android/server/usage/UsageStatsDatabase;->writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v0, "Failed to write data to output stream"
...
.method onPackageRemoved(Ljava/lang/String;J)I
    ...
    const-string v1, "Unable to update package mappings on disk after removing token "
...
.method prunePackagesDataOnUpgrade(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/server/usage/UsageStatsDatabase;->pruneStats(Ljava/util/HashMap;Lcom/android/server/usage/IntervalStats;)Z
...
.method pruneUninstalledPackagesData()Z
    ...
    const-string v6, "Failed to prune data from: "
...
.method public queryUsageStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    check-cast p5, Landroid/util/AtomicFile;
    ...
    :try_start_1
    invoke-direct {p0, p5, v2}, Lcom/android/server/usage/UsageStatsDatabase;->readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-interface {p6, v2, v3, p4}, Lcom/android/server/usage/UsageStatsDatabase$StatCombiner;->combine(Lcom/android/server/usage/IntervalStats;ZLjava/util/List;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v2, v5, p5}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
