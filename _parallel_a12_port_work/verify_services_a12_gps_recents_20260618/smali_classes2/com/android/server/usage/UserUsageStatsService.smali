...
.method private queryStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    invoke-virtual {p2, v7}, Lcom/android/server/usage/UsageStatsDatabase;->filterStats(Lcom/android/server/usage/IntervalStats;)V
...
.method dumpFile(Lcom/android/internal/util/IndentingPrintWriter;[Ljava/lang/String;)V
    ...
    const-string p2, "the specified filename does not exist."
    ...
    :cond_5
    :goto_1
    const-string p2, "the specified interval does not exist."
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;)V
    ...
    iget v12, p1, Landroid/app/usage/UsageEvents$Event;->mInstanceId:I

    move-object v6, v13

    invoke-virtual/range {v6 .. v12}, Lcom/android/server/usage/IntervalStats;->update(Ljava/lang/String;Ljava/lang/String;JII)V

    if-eqz v1, :cond_7

    iget-object v6, p1, Landroid/app/usage/UsageEvents$Event;->mPackage:Ljava/lang/String;

    invoke-virtual {v13, v6}, Lcom/android/server/usage/IntervalStats;->incrementAppLaunchCount(Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v6, v7}, Lcom/android/server/usage/IntervalStats;->updateKeyguardHidden(J)V
    ...
    invoke-virtual {v13, v6, v7}, Lcom/android/server/usage/IntervalStats;->updateKeyguardShown(J)V
    ...
    invoke-virtual {v13, v6, v7}, Lcom/android/server/usage/IntervalStats;->updateScreenNonInteractive(J)V
    ...
    invoke-virtual {v13, v6, v7}, Lcom/android/server/usage/IntervalStats;->updateScreenInteractive(J)V
    ...
    iget-object v7, p1, Landroid/app/usage/UsageEvents$Event;->mContentType:Ljava/lang/String;

    iget-object v8, p1, Landroid/app/usage/UsageEvents$Event;->mAction:Ljava/lang/String;

    invoke-virtual {v13, v6, v7, v8}, Lcom/android/server/usage/IntervalStats;->updateChooserCounts(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v6, p1, Landroid/app/usage/UsageEvents$Event;->mContentAnnotations:[Ljava/lang/String;
    ...
    invoke-virtual {v13, v10, v9, v11}, Lcom/android/server/usage/IntervalStats;->updateChooserCounts(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v3, v6, v7}, Lcom/android/server/usage/IntervalStats;->updateConfigurationStats(Landroid/content/res/Configuration;J)V
...
.method updatePackageMappingsLocked(Ljava/util/HashMap;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/usage/UsageStatsDatabase;->writeMappingsLocked()V
    :try_end_0
    ...
    const-string v0, "Unable to write updated package mappings file on service initialization."
