...
.method public acquireHardware(ILandroid/media/tv/ITvInputHardwareCallback;Landroid/media/tv/TvInputInfo;IILjava/lang/String;I)Landroid/media/tv/ITvInputHardware;
    ...
    iget-object v7, v0, Lcom/android/server/tv/TvInputHardwareManager;->mLock:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    iget-object v3, v0, Lcom/android/server/tv/TvInputHardwareManager;->mConnections:Landroid/util/SparseArray;
    ...
    check-cast v8, Lcom/android/server/tv/TvInputHardwareManager$Connection;
    ...
    :cond_0
    new-instance v6, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;

    invoke-direct {v6}, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;-><init>()V

    move-object v4, p6

    iput-object v4, v6, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;->tvInputSessionId:Ljava/lang/String;

    move/from16 v4, p7

    iput v4, v6, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;->useCase:I

    invoke-virtual {v8}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getResourceClientProfileLocked()Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    ...
    invoke-virtual {v2, v6, v4}, Landroid/media/tv/tunerresourcemanager/TunerResourceManager;->isHigherPriority(Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;)Z
    ...
    invoke-virtual {v8}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getHardwareInfoLocked()Landroid/media/tv/TvInputHardwareInfo;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->resetLocked(Lcom/android/server/tv/TvInputHardwareManager$TvInputHardwareImpl;Landroid/media/tv/ITvInputHardwareCallback;Landroid/media/tv/TvInputInfo;Ljava/lang/Integer;Ljava/lang/Integer;Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;)V

    invoke-virtual {v8}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getHardwareLocked()Landroid/media/tv/ITvInputHardware;
...
.method public onStreamConfigurationChanged(I[Landroid/media/tv/TvStreamConfig;I)V
    ...
    const-string v1, "StreamConfigurationChanged: Cannot find a connection with "
    ...
    iget-object p3, p0, Lcom/android/server/tv/TvInputHardwareManager;->mHandler:Landroid/os/Handler;

    invoke-static {v1}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->access$600(Lcom/android/server/tv/TvInputHardwareManager$Connection;)I

    move-result v2

    invoke-virtual {p3, v4, v2, v5, p1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string p3, "error in onStreamConfigurationChanged"
...
.method public releaseHardware(ILandroid/media/tv/ITvInputHardware;II)V
    ...
    invoke-interface {p1}, Landroid/media/tv/ITvInputHardwareCallback;->asBinder()Landroid/os/IBinder;

    move-result-object p1

    const/4 p2, 0x0

    invoke-interface {p1, v2, p2}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
