...
.method dumpLocked(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-wide v0, p0, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmListener;->mTriggerTimeElapsed:J
    ...
    check-cast v4, Lcom/android/server/utils/quota/Uptc;

    const-wide v5, 0x10b00000001L

    invoke-virtual {v4, p1, v5, v6}, Lcom/android/server/utils/quota/Uptc;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
...
.method public synthetic lambda$onAlarm$0$QuotaTracker$InQuotaAlarmListener(Landroid/util/Pair;)V
    ...
    invoke-virtual {v0, v1, v2, p1}, Lcom/android/server/utils/quota/QuotaTracker;->maybeUpdateQuotaStatus(ILjava/lang/String;Ljava/lang/String;)V
...
.method removeAlarmLocked(Lcom/android/server/utils/quota/Uptc;)V
    ...
    iget-object p1, p0, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmListener;->mAlarmQueue:Lcom/android/server/utils/quota/QuotaTracker$AlarmQueue;

    invoke-virtual {p1}, Lcom/android/server/utils/quota/QuotaTracker$AlarmQueue;->size()I

    move-result p1

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmListener;->this$0:Lcom/android/server/utils/quota/QuotaTracker;

    invoke-virtual {p1, p0}, Lcom/android/server/utils/quota/QuotaTracker;->cancelAlarm(Landroid/app/AlarmManager$OnAlarmListener;)V
...
.method removeAlarmsLocked(I)V
    ...
    iget v4, v4, Lcom/android/server/utils/quota/Uptc;->userId:I

    if-ne p1, v4, :cond_0

    iget-object v3, p0, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmListener;->mAlarmQueue:Lcom/android/server/utils/quota/QuotaTracker$AlarmQueue;

    aget-object v4, v0, v1

    invoke-virtual {v3, v4}, Lcom/android/server/utils/quota/QuotaTracker$AlarmQueue;->remove(Ljava/lang/Object;)Z
...
.method removeAlarmsLocked(ILjava/lang/String;)V
    ...
    iget v5, v4, Lcom/android/server/utils/quota/Uptc;->userId:I

    if-ne p1, v5, :cond_0

    iget-object v4, v4, Lcom/android/server/utils/quota/Uptc;->packageName:Ljava/lang/String;
