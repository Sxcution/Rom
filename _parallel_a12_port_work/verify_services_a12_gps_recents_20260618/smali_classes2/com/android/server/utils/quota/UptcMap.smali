...
.method private getTagAtIndex(III)Ljava/lang/String;
    ...
    invoke-virtual {p1, p3}, Landroid/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
...
.method public delete(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p3, p0, Lcom/android/server/utils/quota/UptcMap;->mData:Landroid/util/SparseArrayMap;

    invoke-virtual {p3, p1, p2}, Landroid/util/SparseArrayMap;->delete(ILjava/lang/Object;)Ljava/lang/Object;
...
.method public forEach(Lcom/android/server/utils/quota/UptcMap$UptcDataConsumer;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/utils/quota/UptcMap;->getUserIdAtIndex(I)I
    ...
    invoke-direct {p0, v2, v5}, Lcom/android/server/utils/quota/UptcMap;->getPackageNameAtIndex(II)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v5, v8}, Lcom/android/server/utils/quota/UptcMap;->getTagAtIndex(III)Ljava/lang/String;
