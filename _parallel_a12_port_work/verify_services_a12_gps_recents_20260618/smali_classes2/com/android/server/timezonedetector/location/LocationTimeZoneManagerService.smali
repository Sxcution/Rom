...
.method constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/server/timezonedetector/location/HandlerThreadingDomain;

    invoke-direct {v1, v0}, Lcom/android/server/timezonedetector/location/HandlerThreadingDomain;-><init>(Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mThreadingDomain:Lcom/android/server/timezonedetector/location/ThreadingDomain;

    invoke-virtual {v1}, Lcom/android/server/timezonedetector/location/ThreadingDomain;->getLockObject()Ljava/lang/Object;
    ...
    iput-object p1, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mServiceConfigAccessor:Lcom/android/server/timezonedetector/ServiceConfigAccessor;
...
.method private startInternal(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mThreadingDomain:Lcom/android/server/timezonedetector/location/ThreadingDomain;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lcom/android/server/timezonedetector/location/ThreadingDomain;->postAndWait(Ljava/lang/Runnable;J)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/timezonedetector/location/ThreadingDomain;->post(Ljava/lang/Runnable;)V
...
.method private startOnDomainThread()V
    ...
    new-instance v1, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;

    iget-object v2, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mThreadingDomain:Lcom/android/server/timezonedetector/location/ThreadingDomain;
    ...
    invoke-direct {v1, v2, v4, v3}, Lcom/android/server/timezonedetector/location/ControllerEnvironmentImpl;-><init>(Lcom/android/server/timezonedetector/location/ThreadingDomain;Lcom/android/server/timezonedetector/ServiceConfigAccessor;Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;)V

    new-instance v2, Lcom/android/server/timezonedetector/location/ControllerCallbackImpl;

    iget-object v4, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mThreadingDomain:Lcom/android/server/timezonedetector/location/ThreadingDomain;

    invoke-direct {v2, v4}, Lcom/android/server/timezonedetector/location/ControllerCallbackImpl;-><init>(Lcom/android/server/timezonedetector/location/ThreadingDomain;)V

    invoke-virtual {v3, v1, v2}, Lcom/android/server/timezonedetector/location/ControllerImpl;->initialize(Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController$Environment;Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController$Callback;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->mLocationTimeZoneDetectorController:Lcom/android/server/timezonedetector/location/ControllerImpl;
    ...
    :cond_1
    invoke-virtual {v0, p1, p3}, Lcom/android/server/timezonedetector/location/ControllerImpl;->dump(Landroid/util/IndentingPrintWriter;[Ljava/lang/String;)V
...
.method handleProviderTestCommand(ILcom/android/server/timezonedetector/location/TestCommand;)Landroid/os/Bundle;
    ...
    :try_start_0
    sget-wide p1, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->BLOCKING_OP_WAIT_DURATION_MILLIS:J
    ...
    const-string p2, "Command did not complete in time"
...
.method onSystemThirdPartyAppsCanStart()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->startInternal(Z)V
