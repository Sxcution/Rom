...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/timezonedetector/ServiceConfigAccessor;)V
    ...
    iput-object v1, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mCr:Landroid/content/ContentResolver;
    ...
    iput-object v1, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mUserManager:Landroid/os/UserManager;
    ...
    iput-object p1, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mLocationManager:Landroid/location/LocationManager;
    ...
    new-instance p3, Lcom/android/server/timezonedetector/EnvironmentImpl$1;

    invoke-direct {p3, p0}, Lcom/android/server/timezonedetector/EnvironmentImpl$1;-><init>(Lcom/android/server/timezonedetector/EnvironmentImpl;)V

    const/4 v1, 0x0

    invoke-virtual {v0, p3, p1, v1, p2}, Landroid/content/Context;->registerReceiverForAllUsers(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    const-string p3, "auto_time_zone"

    invoke-static {p3}, Landroid/provider/Settings$Global;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p3

    new-instance v0, Lcom/android/server/timezonedetector/EnvironmentImpl$2;

    invoke-direct {v0, p0, p2}, Lcom/android/server/timezonedetector/EnvironmentImpl$2;-><init>(Lcom/android/server/timezonedetector/EnvironmentImpl;Landroid/os/Handler;)V
    ...
    new-instance v0, Lcom/android/server/timezonedetector/EnvironmentImpl$3;

    invoke-direct {v0, p0, p2}, Lcom/android/server/timezonedetector/EnvironmentImpl$3;-><init>(Lcom/android/server/timezonedetector/EnvironmentImpl;Landroid/os/Handler;)V

    const/4 p2, -0x1

    invoke-virtual {p1, p3, v1, v0, p2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
...
.method private isGeoDetectionEnabled(I)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/timezonedetector/ServiceConfigAccessor;->isGeoDetectionEnabledForUsersByDefault()Z

    move-result v0

    iget-object v1, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mCr:Landroid/content/ContentResolver;
...
.method private isUserConfigAllowed(I)Z
    ...
    iget-object v0, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mUserManager:Landroid/os/UserManager;
...
.method public getConfigurationInternal(I)Lcom/android/server/timezonedetector/ConfigurationInternal;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/timezonedetector/ConfigurationInternal$Builder;->setGeoDetectionEnabled(Z)Lcom/android/server/timezonedetector/ConfigurationInternal$Builder;
...
.method public setConfigChangeListener(Lcom/android/server/timezonedetector/ConfigurationChangeListener;)V
    ...
    iput-object p1, p0, Lcom/android/server/timezonedetector/EnvironmentImpl;->mConfigChangeListener:Lcom/android/server/timezonedetector/ConfigurationChangeListener;
...
.method public storeConfiguration(ILandroid/app/time/TimeZoneConfiguration;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/timezonedetector/EnvironmentImpl;->setGeoDetectionEnabledIfRequired(IZ)V
