...
.method private calculateNewState(Landroid/content/om/OverlayInfo;Lcom/android/server/pm/parsing/pkg/AndroidPackage;II)I
    ...
    invoke-virtual {p2, p1, p3}, Lcom/android/server/om/OverlayManagerSettings;->getEnabled(Landroid/content/om/OverlayIdentifier;I)Z
...
.method private registerFabricatedOverlay(Landroid/os/FabricatedOverlayInfo;I)Ljava/util/Set;
    ...
    const-string v1, "non-fabricated overlay with name \'"

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, v0, Landroid/content/om/OverlayInfo;->overlayName:Ljava/lang/String;

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v1, "\' already present in \'"
    ...
    invoke-direct {p1, p2}, Lcom/android/server/om/OverlayManagerServiceImpl$OperationFailedException;-><init>(Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0, p1, v0}, Lcom/android/server/om/OverlayManagerServiceImpl;->mustReinitializeOverlay(Landroid/os/FabricatedOverlayInfo;Landroid/content/om/OverlayInfo;)Z
    ...
    invoke-direct {p0, v0, p2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
    ...
    invoke-direct {p1, v0, p2}, Lcom/android/server/om/PackageAndUser;-><init>(Ljava/lang/String;I)V
    ...
    new-instance p2, Lcom/android/server/om/OverlayManagerServiceImpl$OperationFailedException;

    const-string v0, "failed to update settings"

    invoke-direct {p2, v0, p1}, Lcom/android/server/om/OverlayManagerServiceImpl$OperationFailedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private updateOverlaysForTarget(Ljava/lang/String;II)Ljava/util/Set;
    ...
    :cond_1
    new-instance p3, Lcom/android/server/om/PackageAndUser;

    invoke-direct {p3, p1, p2}, Lcom/android/server/om/PackageAndUser;-><init>(Ljava/lang/String;I)V
...
.method private updatePackageOverlays(Lcom/android/server/pm/parsing/pkg/AndroidPackage;II)Ljava/util/Set;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->getPackageConfiguredPriority(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)I
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/server/om/OverlayManagerServiceImpl;->mustReinitializeOverlay(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Landroid/content/om/OverlayInfo;)Z
    ...
    invoke-interface {p1}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getOverlayCategory()Ljava/lang/String;
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, v3, p2, p3}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
    ...
    iget-object p3, v3, Landroid/content/om/OverlayInfo;->targetPackageName:Ljava/lang/String;

    invoke-direct {p1, p3, p2}, Lcom/android/server/om/PackageAndUser;-><init>(Ljava/lang/String;I)V
    ...
    const-string p3, "failed to update settings"

    invoke-direct {p2, p3, p1}, Lcom/android/server/om/OverlayManagerServiceImpl$OperationFailedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->removeIdmapIfPossible(Landroid/content/om/OverlayInfo;)V

    iget-object p1, p0, Lcom/android/server/om/OverlayManagerServiceImpl;->mSettings:Lcom/android/server/om/OverlayManagerSettings;

    invoke-virtual {p1, v0, p2}, Lcom/android/server/om/OverlayManagerSettings;->remove(Landroid/content/om/OverlayIdentifier;I)Z
    ...
    invoke-interface {v5}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getOverlayCategory()Ljava/lang/String;
    ...
    invoke-interface {v5}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getBaseApkPath()Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/om/OverlayManagerServiceImpl;->isPackageConfiguredMutable(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Z
    ...
    invoke-direct {p0, v9, v1, p2, p3}, Lcom/android/server/om/OverlayManagerServiceImpl;->calculateNewState(Landroid/content/om/OverlayInfo;Lcom/android/server/pm/parsing/pkg/AndroidPackage;II)I
    ...
    invoke-virtual {p1, v0, p2, p3}, Lcom/android/server/om/OverlayManagerSettings;->setState(Landroid/content/om/OverlayIdentifier;II)Z
...
.method dump(Ljava/io/PrintWriter;Lcom/android/server/om/DumpState;)V
    ...
    invoke-virtual {p2}, Lcom/android/server/om/OverlayManagerSettings;->getAllIdentifiersAndBaseCodePaths()Ljava/util/Set;
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/om/IdmapManager;->dumpIdmap(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/om/IdmapManager;->idmapExists(Landroid/content/om/OverlayInfo;)Z

    move-result v0

    if-nez v0, :cond_3

    const-string v0, "<missing idmap>"
...
.method getEnabledOverlayPaths(Ljava/lang/String;I)Landroid/content/pm/overlay/OverlayPaths;
    ...
    new-instance p2, Landroid/content/pm/overlay/OverlayPaths$Builder;

    invoke-direct {p2}, Landroid/content/pm/overlay/OverlayPaths$Builder;-><init>()V
    ...
    invoke-virtual {p2, v2}, Landroid/content/pm/overlay/OverlayPaths$Builder;->addNonApkPath(Ljava/lang/String;)Landroid/content/pm/overlay/OverlayPaths$Builder;
    ...
    invoke-virtual {p2, v2}, Landroid/content/pm/overlay/OverlayPaths$Builder;->addApkPath(Ljava/lang/String;)Landroid/content/pm/overlay/OverlayPaths$Builder;
    ...
    :cond_2
    invoke-virtual {p2}, Landroid/content/pm/overlay/OverlayPaths$Builder;->build()Landroid/content/pm/overlay/OverlayPaths;
...
.method registerFabricatedOverlay(Landroid/os/FabricatedOverlayInternal;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/server/om/OverlayManagerServiceImpl;->registerFabricatedOverlay(Landroid/os/FabricatedOverlayInfo;I)Ljava/util/Set;
    ...
    const-string v0, "failed to create fabricated overlay"

    invoke-direct {p1, v0}, Lcom/android/server/om/OverlayManagerServiceImpl$OperationFailedException;-><init>(Ljava/lang/String;)V
    ...
    const-string v0, "overlay name can only consist of alphanumeric characters, \'_\', and \'.\'"
...
.method setEnabled(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Set;
    ...
    invoke-direct {p0, v0, p3, p2}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
    ...
    invoke-direct {p1, p2, p3}, Lcom/android/server/om/PackageAndUser;-><init>(Ljava/lang/String;I)V
    ...
    const-string p2, "cannot enable immutable overlay packages in runtime"
...
.method setEnabledExclusive(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Optional;
    ...
    invoke-direct {p0, v5, p3, v2}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
...
.method setHighestPriority(Landroid/content/om/OverlayIdentifier;I)Ljava/util/Set;
    ...
    const-string p2, "cannot change priority of an immutable overlay package at runtime"
...
.method updateOverlaysForUser(I)Landroid/util/ArraySet;
    ...
    new-instance v2, Lcom/android/server/om/OverlayManagerServiceImpl$$ExternalSyntheticLambda1;

    invoke-direct {v2, v1}, Lcom/android/server/om/OverlayManagerServiceImpl$$ExternalSyntheticLambda1;-><init>(Landroid/util/ArrayMap;)V

    invoke-direct {p0, v2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->removeOverlaysForUser(Ljava/util/function/Predicate;I)Ljava/util/Set;
    ...
    :try_start_0
    invoke-direct {p0, v8, p1, v3}, Lcom/android/server/om/OverlayManagerServiceImpl;->updatePackageOverlays(Lcom/android/server/pm/parsing/pkg/AndroidPackage;II)Ljava/util/Set;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/om/OverlayManagerServiceImpl;->getFabricatedOverlayInfos()Ljava/util/List;
    ...
    :try_start_1
    invoke-direct {p0, v2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->registerFabricatedOverlay(Landroid/os/FabricatedOverlayInfo;I)Ljava/util/Set;
    ...
    invoke-direct {p0, v10, p1, v3}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateState(Landroid/content/om/CriticalOverlayInfo;II)Z
    ...
    :cond_7
    invoke-direct {p0}, Lcom/android/server/om/OverlayManagerServiceImpl;->cleanStaleResourceCache()V
