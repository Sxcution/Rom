...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v8, v0, v6}, Lcom/android/server/om/OverlayManagerService$PackageReceiver;-><init>(Lcom/android/server/om/OverlayManagerService;Lcom/android/server/om/OverlayManagerService$1;)V
    ...
    invoke-direct {v14, v0, v6}, Lcom/android/server/om/OverlayManagerService$UserReceiver;-><init>(Lcom/android/server/om/OverlayManagerService;Lcom/android/server/om/OverlayManagerService$1;)V
    ...
    new-instance v6, Lcom/android/server/om/OverlayManagerService$$ExternalSyntheticLambda3;

    invoke-direct {v6, v4}, Lcom/android/server/om/OverlayManagerService$$ExternalSyntheticLambda3;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4}, Lcom/android/server/om/OverlayManagerService;->onSwitchUser(I)V

    const-string v4, "overlay"

    invoke-virtual {v0, v4, v1}, Lcom/android/server/om/OverlayManagerService;->publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V
...
.method private static getDefaultOverlayPackages()[Ljava/lang/String;
    ...
    const-string v0, "ro.boot.vendor.overlay.theme"
...
.method private initIfNeeded()V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/om/OverlayManagerService;->updatePackageManagerLocked(Ljava/util/Set;)Landroid/util/SparseArray;
...
.method private persistSettingsLocked()V
    ...
    const-string v2, "failed to persist overlay state"
...
.method private updateActivityManager(Ljava/util/List;I)V
    ...
    const-string v0, "updateActivityManager remote exception"
...
.method private updatePackageManagerLocked(Ljava/util/Set;)Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4, v3}, Lcom/android/server/om/OverlayManagerService;->updatePackageManagerLocked(Ljava/util/Collection;I)Ljava/util/List;
...
.method private updatePackageManagerLocked(Ljava/util/Collection;I)Ljava/util/List;
    ...
    check-cast v6, Landroid/content/pm/overlay/OverlayPaths;

    invoke-virtual {v2, p2, v5, v6, v4}, Landroid/content/pm/PackageManagerInternal;->setEnabledOverlayPackages(ILjava/lang/String;Landroid/content/pm/overlay/OverlayPaths;Ljava/util/Set;)Z
...
.method private updateTargetPackagesLocked(Ljava/util/Set;)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/om/OverlayManagerService;->updatePackageManagerLocked(Ljava/util/Collection;I)Ljava/util/List;
    ...
    new-instance v6, Lcom/android/server/om/OverlayManagerService$$ExternalSyntheticLambda2;

    invoke-direct {v6, p0, v4, v3, v2}, Lcom/android/server/om/OverlayManagerService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/om/OverlayManagerService;Ljava/util/List;ILandroid/util/ArraySet;)V
...
.method public onUserSwitching(Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$TargetUser;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/om/OverlayManagerService;->onSwitchUser(I)V
