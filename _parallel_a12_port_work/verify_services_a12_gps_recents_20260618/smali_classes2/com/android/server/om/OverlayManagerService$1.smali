...
.method private enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-static {v1}, Lcom/android/server/om/OverlayManagerService;->access$900(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/om/OverlayActorEnforcer;

    move-result-object v1

    invoke-virtual {v1, v0, p2, p1, p3}, Lcom/android/server/om/OverlayActorEnforcer;->enforceActor(Landroid/content/om/OverlayInfo;Ljava/lang/String;II)V
    ...
    const-string v0, "Unable to retrieve overlay information for "
...
.method private executeAllRequests(Landroid/content/om/OverlayManagerTransaction;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/om/OverlayManagerService$1;->executeRequest(Landroid/content/om/OverlayManagerTransaction$Request;)Ljava/util/Set;
    ...
    invoke-static {p1, v1}, Lcom/android/server/om/OverlayManagerService;->access$600(Lcom/android/server/om/OverlayManagerService;Ljava/util/Set;)V
    :try_end_1
...
.method private executeRequest(Landroid/content/om/OverlayManagerTransaction$Request;)Ljava/util/Set;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v0, v1, v6}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-static {v4}, Lcom/android/server/om/OverlayManagerService;->access$400(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/om/OverlayManagerService$PackageManagerHelperImpl;
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->unregisterFabricatedOverlay(Landroid/content/om/OverlayIdentifier;)Ljava/util/Set;
    ...
    const-string v2, "no fabricated overlay attached to request"
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->registerFabricatedOverlay(Landroid/os/FabricatedOverlayInternal;)Ljava/util/Set;
    ...
    invoke-virtual {v2, p1, v3, v6}, Lcom/android/server/om/OverlayManagerServiceImpl;->setEnabled(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Set;
    ...
    invoke-virtual {v4, v5, v2, v6}, Lcom/android/server/om/OverlayManagerServiceImpl;->setEnabled(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Set;
    ...
    invoke-virtual {v3, p1, v6}, Lcom/android/server/om/OverlayManagerServiceImpl;->setHighestPriority(Landroid/content/om/OverlayIdentifier;I)Ljava/util/Set;

    move-result-object p1

    invoke-static {v2, p1}, Lcom/android/internal/util/CollectionUtils;->addAll(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/Set;

    move-result-object p1

    invoke-static {p1}, Lcom/android/internal/util/CollectionUtils;->emptyIfNull(Ljava/util/Set;)Ljava/util/Set;
    ...
    const-string v0, "Non-root shell cannot fabricate overlays"
...
.method public commit(Landroid/content/om/OverlayManagerTransaction;)V
    ...
    invoke-static {v4}, Lcom/android/server/om/OverlayManagerService;->access$800(Lcom/android/server/om/OverlayManagerService;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :sswitch_9
    const-string v1, "targetoverlayablename"
    ...
    invoke-static {p3}, Lcom/android/server/om/OverlayManagerService;->access$300(Lcom/android/server/om/OverlayManagerService;)Ljava/lang/Object;
...
.method public getOverlayInfoByIdentifier(Landroid/content/om/OverlayIdentifier;I)Landroid/content/om/OverlayInfo;
    ...
    invoke-virtual {v3, p1, p2}, Lcom/android/server/om/OverlayManagerServiceImpl;->getOverlayInfo(Landroid/content/om/OverlayIdentifier;I)Landroid/content/om/OverlayInfo;
...
.method public invalidateCachesForOverlay(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p2, "invalidateCachesForOverlay"

    invoke-direct {p0, v0, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-virtual {v3, v0, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->removeIdmapForOverlay(Landroid/content/om/OverlayIdentifier;I)V
    :try_end_1
    ...
    const-string v5, "invalidate caches for overlay \'"
...
.method public setEnabled(Ljava/lang/String;ZI)Z
    ...
    invoke-direct {p0, p3, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p3, "setEnabled"

    invoke-direct {p0, v3, p3, p1}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v3, p2, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->setEnabled(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Set;

    move-result-object p1

    invoke-static {v6, p1}, Lcom/android/server/om/OverlayManagerService;->access$600(Lcom/android/server/om/OverlayManagerService;Ljava/util/Set;)V
    :try_end_2
...
.method public setEnabledExclusive(Ljava/lang/String;ZI)Z
    ...
    const-string p1, "setEnabledExclusive"

    invoke-direct {p0, p3, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p3, "setEnabledExclusive"

    invoke-direct {p0, p2, p3, p1}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    new-instance v5, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda0;

    invoke-direct {v5, p2}, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/om/OverlayManagerService;)V
...
.method public setEnabledExclusiveInCategory(Ljava/lang/String;I)Z
    ...
    const-string p1, "setEnabledExclusiveInCategory"

    invoke-direct {p0, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p2, "setEnabledExclusiveInCategory"

    invoke-direct {p0, v3, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    new-instance v6, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda1;

    invoke-direct {v6, v3}, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/om/OverlayManagerService;)V
...
.method public setHighestPriority(Ljava/lang/String;I)Z
    ...
    const-string p1, "setHighestPriority"

    invoke-direct {p0, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p2, "setHighestPriority"
    ...
    invoke-virtual {v7, v3, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->setHighestPriority(Landroid/content/om/OverlayIdentifier;I)Ljava/util/Set;
...
.method public setLowestPriority(Ljava/lang/String;I)Z
    ...
    const-string p1, "setLowestPriority"

    invoke-direct {p0, p2, p1}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p1

    const-string p2, "setLowestPriority"
    ...
    new-instance v6, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda2;

    invoke-direct {v6, v3}, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/om/OverlayManagerService;)V
...
.method public setPriority(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p3, p2}, Lcom/android/server/om/OverlayManagerService$1;->handleIncomingUser(ILjava/lang/String;)I

    move-result p2

    const-string p3, "setPriority"

    invoke-direct {p0, v3, p3, p2}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-direct {v3, p2}, Lcom/android/server/om/OverlayManagerService$1$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/om/OverlayManagerService;)V
