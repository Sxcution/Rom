...
.method public onFinished(IZ)V
    ...
    invoke-virtual {p1}, Lcom/android/server/rollback/Rollback;->isStaged()Z
    ...
    invoke-virtual {p1}, Lcom/android/server/rollback/Rollback;->notifySessionWithSuccess()Z
    ...
    invoke-static {p2, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->access$1400(Lcom/android/server/rollback/RollbackManagerServiceImpl;Lcom/android/server/rollback/Rollback;)Z
    ...
    invoke-static {p2, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->access$1500(Lcom/android/server/rollback/RollbackManagerServiceImpl;Lcom/android/server/rollback/Rollback;)V
    ...
    invoke-virtual {p2}, Lcom/android/server/rollback/Rollback;->isEnabling()Z
    ...
    iget-object v2, p2, Lcom/android/server/rollback/Rollback;->info:Landroid/content/rollback/RollbackInfo;
    ...
    invoke-static {v0}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->access$600(Lcom/android/server/rollback/RollbackManagerServiceImpl;)Ljava/util/List;
    ...
    invoke-static {v0, p2, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->access$700(Lcom/android/server/rollback/RollbackManagerServiceImpl;Lcom/android/server/rollback/Rollback;Ljava/lang/String;)V
