...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    invoke-static {p1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$100(Lcom/android/server/timedetector/GnssTimeUpdateService;)Landroid/location/LocationManagerInternal;
    ...
    invoke-static {v0, p1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$200(Lcom/android/server/timedetector/GnssTimeUpdateService;Landroid/location/LocationTime;)V
    ...
    invoke-static {p1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$400(Lcom/android/server/timedetector/GnssTimeUpdateService;)Landroid/location/LocationManager;

    move-result-object p1

    iget-object v0, p0, Lcom/android/server/timedetector/GnssTimeUpdateService$1;->this$0:Lcom/android/server/timedetector/GnssTimeUpdateService;

    invoke-static {v0}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$300(Lcom/android/server/timedetector/GnssTimeUpdateService;)Landroid/location/LocationListener;
    ...
    invoke-static {p1, v0}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$302(Lcom/android/server/timedetector/GnssTimeUpdateService;Landroid/location/LocationListener;)Landroid/location/LocationListener;
    ...
    invoke-static {p1, v0}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$502(Lcom/android/server/timedetector/GnssTimeUpdateService;Landroid/app/AlarmManager$OnAlarmListener;)Landroid/app/AlarmManager$OnAlarmListener;
    ...
    invoke-static {p1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$700(Lcom/android/server/timedetector/GnssTimeUpdateService;)Landroid/app/AlarmManager;
    ...
    invoke-static {p1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->access$500(Lcom/android/server/timedetector/GnssTimeUpdateService;)Landroid/app/AlarmManager$OnAlarmListener;
