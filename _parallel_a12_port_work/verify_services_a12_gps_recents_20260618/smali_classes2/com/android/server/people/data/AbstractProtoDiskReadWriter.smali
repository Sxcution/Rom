...
.method private parseFile(Ljava/io/File;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v0}, Lcom/android/server/people/data/AbstractProtoDiskReadWriter$ProtoStreamReader;->read(Landroid/util/proto/ProtoInputStream;)Ljava/lang/Object;
    ...
    const-string v1, "Failed to parse protobuf file."
...
.method private triggerScheduledFlushEarly()V
    ...
    const-string v2, "Failed to save data immediately."
...
.method read(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/people/data/AbstractProtoDiskReadWriter;->parseFile(Ljava/io/File;)Ljava/lang/Object;
...
.method writeTo(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v1, p2}, Lcom/android/server/people/data/AbstractProtoDiskReadWriter$ProtoStreamWriter;->write(Landroid/util/proto/ProtoOutputStream;Ljava/lang/Object;)V
    ...
    sget-object p2, Lcom/android/server/people/data/AbstractProtoDiskReadWriter;->TAG:Ljava/lang/String;

    const-string v0, "Failed to write to protobuf file."
