...
.method private addEvent(Ljava/lang/String;JI)Z
    ...
    iget-object v0, p0, Lcom/android/server/people/data/MmsQueryHelper;->mEventConsumer:Ljava/util/function/BiConsumer;
...
.method private getMmsAddress(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :try_start_0
    const-string p1, "MmsQueryHelper"

    const-string p2, "Cursor is null when querying MMS address table."
    ...
    :cond_7
    iget-object p1, p0, Lcom/android/server/people/data/MmsQueryHelper;->mCurrentCountryIso:Ljava/lang/String;

    invoke-static {v2, p1}, Landroid/telephony/PhoneNumberUtils;->formatNumberToE164(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private validateEvent(Ljava/lang/String;JI)Z
    ...
    sget-object p1, Lcom/android/server/people/data/MmsQueryHelper;->MSG_BOX_TO_EVENT_TYPE:Landroid/util/SparseIntArray;
...
.method querySince(J)Z
    ...
    const-string v1, "Cursor is null when querying MMS table."
    ...
    invoke-direct {p0, v3, v6}, Lcom/android/server/people/data/MmsQueryHelper;->getMmsAddress(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-direct {p0, v3, v4, v5, v6}, Lcom/android/server/people/data/MmsQueryHelper;->addEvent(Ljava/lang/String;JI)Z
