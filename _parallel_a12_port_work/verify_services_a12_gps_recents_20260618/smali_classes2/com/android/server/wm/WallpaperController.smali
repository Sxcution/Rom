...
.method private updateWallpaperOffsetLocked(Lcom/android/server/wm/WindowState;Z)V
    ...
    iget p1, v0, Lcom/android/server/wm/WindowState;->mWallpaperYStep:F
...
.method private updateWallpaperWindowsTarget(Lcom/android/server/wm/WallpaperController$FindWallpaperTargetResult;)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/server/wm/DisplayContent;->getWindow(Ljava/util/function/Predicate;)Lcom/android/server/wm/WindowState;
    ...
    invoke-static {v4, v6, v5, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v1, v3, v5, v4, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method adjustWallpaperWindows()V
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/server/wm/WallpaperController;->sendWindowWallpaperCommand(Ljava/lang/String;IIILandroid/os/Bundle;Z)V
...
.method public synthetic lambda$new$0$WallpaperController(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-interface {v5}, Lcom/android/server/policy/WindowManagerPolicy;->isKeyguardUnoccluding()Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/wm/WallpaperController$FindWallpaperTargetResult;->setIsWallpaperTargetForLetterbox(Z)V
...
.method screenshotWallpaperLocked()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v3}, Landroid/view/SurfaceControl;->captureLayers(Landroid/view/SurfaceControl;Landroid/graphics/Rect;F)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
...
.method updateWallpaperOffset(Lcom/android/server/wm/WindowState;Z)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/WallpaperController;->zoomOutToScale(F)F
    ...
    iget v6, p1, Lcom/android/server/wm/WindowState;->mWallpaperZoomOut:F
...
.method wallpaperTransitionReady()Z
    ...
    invoke-virtual {v0, v2, p0}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5, v6}, Lcom/android/server/wm/WindowManagerService$H;->sendMessageDelayed(Landroid/os/Message;J)Z
