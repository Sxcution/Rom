...
.method public onAppTransitionCancelledLocked(Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->continueUpdateOrientationForDiffOrienLaunchingApp()V
...
.method public onAppTransitionFinishedLocked(Landroid/os/IBinder;)V
    ...
    invoke-static {v0}, Lcom/android/server/wm/DisplayContent;->access$400(Lcom/android/server/wm/DisplayContent;)Lcom/android/server/wm/ActivityRecord;

    move-result-object v0

    if-nez v0, :cond_2

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->finishFixedRotationTransform()V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/ActivityRecord;->hasFixedRotationTransform(Lcom/android/server/wm/WindowToken;)Z
    ...
    invoke-static {p1}, Lcom/android/server/wm/DisplayContent;->access$400(Lcom/android/server/wm/DisplayContent;)Lcom/android/server/wm/ActivityRecord;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->hasAnimatingFixedRotationTransition()Z
    ...
    :cond_4
    invoke-virtual {p1}, Lcom/android/server/wm/Task;->isAppTransitioning()Z
...
.method onFinishRecentsAnimation()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/wm/DisplayContent;->setFixedRotationLaunchingAppUnchecked(Lcom/android/server/wm/ActivityRecord;)V
