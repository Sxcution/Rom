...
.method static applyStartingWindowAnimation(Lcom/android/server/wm/WindowContainer;)Landroid/view/SurfaceControl;
    ...
    iget-object p0, v0, Lcom/android/server/wm/TaskOrganizerController$StartingWindowAnimationAdaptor;->mAnimationLeash:Landroid/view/SurfaceControl;
...
.method private dispatchTaskInfoChanged(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerCallbacks;->onTaskInfoChanged(Lcom/android/server/wm/Task;Landroid/app/ActivityManager$RunningTaskInfo;)V
...
.method addStartingWindow(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;ILandroid/window/TaskSnapshot;)Z
    ...
    :try_start_0
    iget-object p2, p2, Lcom/android/server/wm/ActivityRecord;->token:Landroid/os/IBinder;

    invoke-interface {v0, p1, p2}, Landroid/window/ITaskOrganizer;->addStartingWindow(Landroid/window/StartingWindowInfo;Landroid/os/IBinder;)V
    :try_end_0
    ...
    const-string p3, "Exception sending onTaskStart callback"
...
.method copySplashScreenView(Lcom/android/server/wm/Task;)Z
    ...
    invoke-interface {v0, p1}, Landroid/window/ITaskOrganizer;->copySplashScreenView(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method createRootTask(Lcom/android/server/wm/DisplayContent;ILandroid/os/IBinder;)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/wm/Task$Builder;->setIntent(Landroid/content/Intent;)Lcom/android/server/wm/Task$Builder;

    move-result-object p2

    invoke-virtual {p2, v2}, Lcom/android/server/wm/Task$Builder;->setCreatedByOrganizer(Z)Lcom/android/server/wm/Task$Builder;

    move-result-object p2

    invoke-virtual {p2, v2}, Lcom/android/server/wm/Task$Builder;->setDeferTaskAppear(Z)Lcom/android/server/wm/Task$Builder;

    move-result-object p2

    invoke-virtual {p2, p3}, Lcom/android/server/wm/Task$Builder;->setLaunchCookie(Landroid/os/IBinder;)Lcom/android/server/wm/Task$Builder;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/Task$Builder;->setParent(Lcom/android/server/wm/WindowContainer;)Lcom/android/server/wm/Task$Builder;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/Task;->setDeferTaskAppear(Z)V
...
.method public createRootTask(IILandroid/os/IBinder;)V
    ...
    sget-boolean p2, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_WINDOW_ORGANIZER_enabled:Z

    if-eqz p2, :cond_0

    int-to-long p1, p1

    sget-object p3, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_WINDOW_ORGANIZER:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    invoke-static {p3, v3, v5, v4, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->e(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public deleteRootTask(Landroid/window/WindowContainerToken;)Z
    ...
    :cond_1
    :try_start_3
    iget-boolean v4, p1, Lcom/android/server/wm/Task;->mCreatedByOrganizer:Z
    ...
    invoke-static {v4, v10, v11, v12, v13}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_2
    const-string v3, "deleteRootTask"

    invoke-virtual {p1, v5, v3}, Lcom/android/server/wm/Task;->remove(ZLjava/lang/String;)V
    ...
    const-string v5, "Attempt to delete task not created by organizer task="
...
.method dispatchPendingEvents()V
    ...
    invoke-static {v2}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;->access$900(Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;)Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerCallbacks;
    ...
    invoke-direct {p0, v3, v2}, Lcom/android/server/wm/TaskOrganizerController;->dispatchTaskInfoChanged(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerCallbacks;->onTaskVanished(Lcom/android/server/wm/Task;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;->access$1000(Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;->access$1100(Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;)I
    ...
    invoke-static {v5}, Landroid/app/WindowConfiguration;->windowingModeToString(I)Ljava/lang/String;
...
.method public getChildTasks(Landroid/window/WindowContainerToken;[I)Ljava/util/List;
    ...
    const-string v5, "Can\'t get children of "
    ...
    :cond_1
    :try_start_3
    iget-boolean v3, p1, Lcom/android/server/wm/Task;->mCreatedByOrganizer:Z
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/wm/Task;->getChildAt(I)Lcom/android/server/wm/WindowContainer;
    ...
    invoke-static {p2, v6}, Lcom/android/internal/util/ArrayUtils;->contains([II)Z
...
.method public getImeTarget(I)Landroid/window/WindowContainerToken;
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/wm/DisplayContent;->getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    iget-object p1, p1, Lcom/android/server/wm/Task;->mRemoteToken:Lcom/android/server/wm/WindowContainer$RemoteToken;
...
.method public getRootTasks(I[I)Ljava/util/List;
    ...
    invoke-direct {v4, p2, p1}, Lcom/android/server/wm/TaskOrganizerController$$ExternalSyntheticLambda3;-><init>([ILjava/util/ArrayList;)V
...
.method public synthetic lambda$registerTaskOrganizer$1$TaskOrganizerController(Landroid/window/ITaskOrganizer;ILjava/util/ArrayList;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/TaskOrganizerController;->mService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    new-instance v0, Lcom/android/server/wm/TaskOrganizerController$$ExternalSyntheticLambda2;

    invoke-direct {v0, p1, p3}, Lcom/android/server/wm/TaskOrganizerController$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;Ljava/util/ArrayList;)V

    invoke-virtual {p2, v0}, Lcom/android/server/wm/RootWindowContainer;->forAllTasks(Ljava/util/function/Consumer;)V
...
.method public synthetic lambda$unregisterTaskOrganizer$2$TaskOrganizerController(Landroid/window/ITaskOrganizer;I)V
    ...
    invoke-static {p2, v3, v4, v5, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public onAppSplashScreenViewRemoved(Lcom/android/server/wm/Task;)V
    ...
    invoke-interface {v0, p1}, Landroid/window/ITaskOrganizer;->onAppSplashScreenViewRemoved(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v1, "Exception sending onAppSplashScreenViewRemoved callback"
...
.method onTaskAppeared(Landroid/window/ITaskOrganizer;Lcom/android/server/wm/Task;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;->access$700(Lcom/android/server/wm/TaskOrganizerController$TaskOrganizerState;Lcom/android/server/wm/Task;)Z
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/wm/TaskOrganizerController;->getPendingTaskEvent(Lcom/android/server/wm/Task;I)Lcom/android/server/wm/TaskOrganizerController$PendingTaskEvent;
...
.method public registerTaskOrganizer(Landroid/window/ITaskOrganizer;)Landroid/content/pm/ParceledListSlice;
    ...
    iget-object p1, p1, Lcom/android/server/wm/TransitionController;->mRunningLock:Lcom/android/server/wm/TransitionController$Lock;

    const-wide/16 v5, 0x3e8

    invoke-virtual {p1, v5, v6, v4}, Lcom/android/server/wm/TransitionController$Lock;->runWhenIdle(JLjava/lang/Runnable;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lcom/android/server/wm/TaskOrganizerController;->mGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;
...
.method removeStartingWindow(Lcom/android/server/wm/Task;Z)V
    ...
    iput v2, v1, Landroid/window/StartingWindowRemovalInfo;->taskId:I

    iput-boolean p2, v1, Landroid/window/StartingWindowRemovalInfo;->playRevealAnimation:Z
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/wm/DisplayContent;->mayImeShowOnLaunchingActivity(Lcom/android/server/wm/ActivityRecord;)Z

    move-result v3

    iput-boolean v3, v1, Landroid/window/StartingWindowRemovalInfo;->deferRemoveForIme:Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityRecord;->findMainWindow(Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-static {p1}, Lcom/android/server/wm/TaskOrganizerController;->applyStartingWindowAnimation(Lcom/android/server/wm/WindowContainer;)Landroid/view/SurfaceControl;

    move-result-object v2

    iput-object v2, v1, Landroid/window/StartingWindowRemovalInfo;->windowAnimationLeash:Landroid/view/SurfaceControl;

    invoke-virtual {p1}, Lcom/android/server/wm/WindowState;->getRelativeFrame()Landroid/graphics/Rect;

    move-result-object p1

    iput-object p1, v1, Landroid/window/StartingWindowRemovalInfo;->mainFrame:Landroid/graphics/Rect;

    iget-object p1, v1, Landroid/window/StartingWindowRemovalInfo;->windowAnimationLeash:Landroid/view/SurfaceControl;

    iget-object v2, v1, Landroid/window/StartingWindowRemovalInfo;->mainFrame:Landroid/graphics/Rect;

    iget v2, v2, Landroid/graphics/Rect;->left:I

    int-to-float v2, v2

    iget-object v3, v1, Landroid/window/StartingWindowRemovalInfo;->mainFrame:Landroid/graphics/Rect;
    ...
    const-string v0, "Exception sending onStartTaskFinished callback"
...
.method reportImeDrawnOnTask(Lcom/android/server/wm/Task;)V
    ...
    invoke-interface {v0, p1}, Landroid/window/ITaskOrganizer;->onImeDrawnOnTask(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v1, "Exception sending onImeDrawnOnTask callback"
...
.method public restartTaskTopActivityProcessIfVisible(Landroid/window/WindowContainerToken;)V
    ...
    const-string v3, "Could not resolve window from token"
    ...
    const-string v3, "Could not resolve task from token"
...
.method public setInterceptBackPressedOnTaskRoot(Landroid/window/WindowContainerToken;Z)V
    ...
    :try_start_3
    iget-object p2, p0, Lcom/android/server/wm/TaskOrganizerController;->mInterceptBackPressedOnRootTasks:Ljava/util/HashSet;
...
.method public unregisterTaskOrganizer(Landroid/window/ITaskOrganizer;)V
    ...
    invoke-virtual {p1, v4, v5, v3}, Lcom/android/server/wm/TransitionController$Lock;->runWhenIdle(JLjava/lang/Runnable;)V
