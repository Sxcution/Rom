...
.method private canGetLaunchedFrom()Z
    ...
    invoke-virtual {v1, v5, v0}, Landroid/content/pm/PackageManagerInternal;->getKnownPackageNames(II)[Ljava/lang/String;
...
.method private ensureValidPictureInPictureActivityParams(Ljava/lang/String;Landroid/os/IBinder;Landroid/app/PictureInPictureParams;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p2, v1, v2}, Lcom/android/server/wm/WindowManagerService;->isValidPictureInPictureAspectRatio(Lcom/android/server/wm/DisplayContent;F)Z
    ...
    iget-object p3, p0, Lcom/android/server/wm/ActivityClientController;->mContext:Landroid/content/Context;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lcom/android/server/wm/ActivityClientController;->mContext:Landroid/content/Context;

    invoke-static {p1}, Landroid/app/ActivityTaskManager;->getMaxNumPictureInPictureActions(Landroid/content/Context;)I
...
.method private isLauncherActivity(Landroid/content/ComponentName;)Z
    ...
    const-string v2, "Failed to query intent activities"
...
.method public activityDestroyed(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityRecord;->destroyed(Ljava/lang/String;)V
    :try_end_1
...
.method public activityIdle(Landroid/os/IBinder;Landroid/content/res/Configuration;Z)V
    ...
    :cond_0
    :try_start_2
    iget-object v5, p0, Lcom/android/server/wm/ActivityClientController;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    const/4 v6, 0x0

    invoke-virtual {v5, p1, v6, v6, p2}, Lcom/android/server/wm/ActivityTaskSupervisor;->activityIdleInternal(Lcom/android/server/wm/ActivityRecord;ZZLandroid/content/res/Configuration;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowProcessController;->clearProfilerIfNeeded()V
...
.method public activityPaused(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityRecord;->activityPaused(Z)V
...
.method public convertFromTranslucent(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityRecord;->setOccludesParent(Z)Z
...
.method public convertToTranslucent(Landroid/os/IBinder;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/wm/Task;->getActivityBelow(Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/wm/ActivityRecord;
...
.method public enterPictureInPictureMode(Landroid/os/IBinder;Landroid/app/PictureInPictureParams;)Z
    ...
    invoke-virtual {v3, p1, p2}, Lcom/android/server/wm/ActivityTaskManagerService;->enterPictureInPictureMode(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureParams;)Z
...
.method public finishActivity(Landroid/os/IBinder;ILandroid/content/Intent;I)Z
    ...
    :cond_1
    :goto_0
    iget-object v4, v1, Lcom/android/server/wm/ActivityClientController;->mGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/server/wm/ActivityTaskManagerService;->collectGrants(Landroid/content/Intent;Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/uri/NeededUriGrants;

    move-result-object v4

    iget-object v8, v1, Lcom/android/server/wm/ActivityClientController;->mGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/wm/LockTaskController;->activityBlockedFromFinish(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {v0, v12, v11}, Lcom/android/server/wm/Task;->topRunningActivity(Landroid/os/IBinder;I)Lcom/android/server/wm/ActivityRecord;
    ...
    :try_start_5
    iget-object v11, v1, Lcom/android/server/wm/ActivityClientController;->mService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    invoke-interface {v11, v0}, Landroid/app/IActivityController;->activityResuming(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v11, v12}, Lcom/android/server/wm/WindowProcessController;->setLastActivityFinishTimeIfNeeded(J)V
    ...
    :cond_a
    :goto_3
    iget-object v1, v1, Lcom/android/server/wm/ActivityClientController;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    const-string v2, "finish-activity"

    invoke-virtual {v1, v6, v10, v0, v2}, Lcom/android/server/wm/ActivityTaskSupervisor;->removeTask(Lcom/android/server/wm/Task;ZZLjava/lang/String;)V
...
.method public finishActivityAffinity(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/wm/LockTaskController;->activityBlockedFromFinish(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-direct {v4, p1}, Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/wm/ActivityRecord;)V

    const/4 v5, 0x1

    invoke-virtual {v3, v4, p1, v5, v5}, Lcom/android/server/wm/Task;->forAllActivities(Ljava/util/function/Function;Lcom/android/server/wm/WindowContainer;ZZ)Z
...
.method public finishSubActivity(Landroid/os/IBinder;Ljava/lang/String;I)V
    ...
    new-instance v4, Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda0;

    invoke-direct {v4, p1, p2, p3}, Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;I)V

    const/4 p1, 0x1

    invoke-virtual {v3, v4, p1}, Lcom/android/server/wm/Task;->forAllActivities(Ljava/util/function/Consumer;Z)V
...
.method public getActivityTokenBelow(Landroid/os/IBinder;)Landroid/os/IBinder;
    ...
    sget-object v5, Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda2;

    const/4 v6, 0x0

    const/4 v7, 0x1

    invoke-virtual {v4, v5, p1, v6, v7}, Lcom/android/server/wm/Task;->getActivity(Ljava/util/function/Predicate;Lcom/android/server/wm/WindowContainer;ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object p1, v4, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord$Token;->asBinder()Landroid/os/IBinder;
...
.method public invalidateHomeTaskSnapshot(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/TaskSnapshotController;->removeSnapshotCache(I)V
...
.method public moveActivityTaskToBack(Landroid/os/IBinder;Z)Z
    ...
    invoke-virtual {v4, p2}, Lcom/android/server/wm/RootWindowContainer;->anyTaskForId(I)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/Task;->moveTaskToBack(Lcom/android/server/wm/Task;)Z
...
.method public navigateUpTo(Landroid/os/IBinder;Landroid/content/Intent;ILandroid/content/Intent;)Z
    ...
    iget-object p1, p0, Lcom/android/server/wm/ActivityClientController;->mGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;
...
.method onPictureInPictureStateChanged(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureUiState;)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/wm/ClientLifecycleManager;->scheduleTransaction(Landroid/app/servertransaction/ClientTransaction;)V
    :try_end_0
    ...
    const-string v1, "Failed to send pip state transaction item: "
    ...
    const-string p2, "Activity is not in PIP mode"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string p2, "ActivityClientController"
...
.method public overridePendingTransition(Landroid/os/IBinder;Ljava/lang/String;II)V
    ...
    iget-boolean v10, p1, Lcom/android/server/wm/ActivityRecord;->mOverrideTaskTransition:Z
    ...
    invoke-virtual/range {v4 .. v10}, Lcom/android/server/wm/AppTransition;->overridePendingAppTransition(Ljava/lang/String;IILandroid/os/IRemoteCallback;Landroid/os/IRemoteCallback;Z)V

    iget-object v3, p1, Lcom/android/server/wm/ActivityRecord;->mTransitionController:Lcom/android/server/wm/TransitionController;

    iget-boolean p1, p1, Lcom/android/server/wm/ActivityRecord;->mOverrideTaskTransition:Z

    invoke-static {p2, p3, p4, p1}, Landroid/window/TransitionInfo$AnimationOptions;->makeCustomAnimOptions(Ljava/lang/String;IIZ)Landroid/window/TransitionInfo$AnimationOptions;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {v3, p1, p2, p2}, Lcom/android/server/wm/TransitionController;->setOverrideAnimation(Landroid/window/TransitionInfo$AnimationOptions;Landroid/os/IRemoteCallback;Landroid/os/IRemoteCallback;)V
...
.method public releaseActivityInstance(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityRecord;->destroyImmediately(Ljava/lang/String;)Z
...
.method requestPictureInPictureMode(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/server/wm/ActivityTaskManagerService;->enterPictureInPictureMode(Lcom/android/server/wm/ActivityRecord;Landroid/app/PictureInPictureParams;)Z
    ...
    const-string v0, "Requested PIP on an activity that doesn\'t support it"
    ...
    const-string v0, "Activity is already in PIP mode"
...
.method public setDisablePreviewScreenshots(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityRecord;->setDisablePreviewScreenshots(Z)V
...
.method public setImmersive(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/ActivityTaskManagerService;->applyUpdateLockStateLocked(Lcom/android/server/wm/ActivityRecord;)V
...
.method public setPictureInPictureParams(Landroid/os/IBinder;Landroid/app/PictureInPictureParams;)V
    ...
    invoke-virtual {p2, v3}, Lcom/android/server/wm/Task;->setPictureInPictureAspectRatio(F)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/Task;->setPictureInPictureActions(Ljava/util/List;)V
...
.method public setVrMode(Landroid/os/IBinder;ZLandroid/content/ComponentName;)I
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/ActivityTaskManagerService;->applyUpdateVrModeLocked(Lcom/android/server/wm/ActivityRecord;)V
...
.method public shouldUpRecreateTask(Landroid/os/IBinder;Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/server/wm/Task;->shouldUpRecreateTaskLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)Z
...
.method public showAssistFromActivity(Landroid/os/IBinder;Landroid/os/Bundle;)Z
    ...
    const-string v5, "showAssistFromActivity failed: caller "
...
.method public startLockTaskModeByToken(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/wm/ActivityTaskManagerService;->startLockTaskMode(Lcom/android/server/wm/Task;Z)V
...
.method public toggleFreeformWindowingMode(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p1, v5}, Lcom/android/server/wm/Task;->setWindowingMode(I)V
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/WindowContainer;->inFreeformWindowingMode()Z
    ...
    const-string v3, "This activity is currently not freeform-enabled"
    ...
    const-string v3, "toggleFreeformWindowingMode: the activity doesn\'t have a root task"
