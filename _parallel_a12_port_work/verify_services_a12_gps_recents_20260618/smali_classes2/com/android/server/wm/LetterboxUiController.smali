...
.method private getInsetsStateCornerRadius(Landroid/view/InsetsState;I)I
    ...
    invoke-virtual {p1, p2}, Landroid/view/RoundedCorners;->getRoundedCorner(I)Landroid/view/RoundedCorner;
...
.method private getLetterboxBackgroundColor()Landroid/graphics/Color;
    ...
    const-string v3, "Unexpected letterbox background type: "
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/LetterboxConfiguration;->getLetterboxBackgroundColor()Landroid/graphics/Color;
...
.method private getLetterboxReasonString(Lcom/android/server/wm/WindowState;)Ljava/lang/String;
    ...
    const-string p1, "SIZE_COMPAT_MODE"
    ...
    const-string p1, "FIXED_ORIENTATION"
    ...
    const-string p1, "DISPLAY_CUTOUT"
...
.method private getRoundedCorners(Landroid/view/InsetsState;)I
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/LetterboxConfiguration;->getLetterboxActivityCornersRadius()I
...
.method private updateRoundedCorners(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/ActivityRecord;->inSizeCompatMode()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/ActivityRecord;->getSizeCompatScale()F
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/LetterboxUiController;->getRoundedCorners(Landroid/view/InsetsState;)I

    move-result p1

    int-to-float p1, p1

    invoke-virtual {v1, v0, p1}, Landroid/view/SurfaceControl$Transaction;->setCornerRadius(Landroid/view/SurfaceControl;F)Landroid/view/SurfaceControl$Transaction;
...
.method private updateWallpaperForLetterbox(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->requestUpdateWallpaperIfNeeded()V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/LetterboxUiController;->getRoundedCorners(Landroid/view/InsetsState;)I
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/ActivityRecord;->getParent()Lcom/android/server/wm/WindowContainer;

    move-result-object p2

    invoke-virtual {p2}, Lcom/android/server/wm/WindowContainer;->getConfiguration()Landroid/content/res/Configuration;
...
.method getFixedOrientationLetterboxAspectRatio(Landroid/content/res/Configuration;)F
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/LetterboxConfiguration;->getFixedOrientationLetterboxAspectRatio()F
...
.method getHorizontalPositionMultiplier(Landroid/content/res/Configuration;)F
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/LetterboxConfiguration;->getHorizontalMultiplierForReachability()F
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/LetterboxConfiguration;->getLetterboxHorizontalPositionMultiplier()F
...
.method layoutLetterbox(Lcom/android/server/wm/WindowState;)V
    ...
    new-instance v2, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda2;

    invoke-direct {v2, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/LetterboxUiController;)V
    ...
    invoke-direct {v4, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/wm/LetterboxUiController;)V

    new-instance v5, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda5;

    invoke-direct {v5, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda5;-><init>(Lcom/android/server/wm/LetterboxUiController;)V

    new-instance v6, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda1;

    invoke-direct {v6, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/wm/LetterboxUiController;)V
    ...
    new-instance v8, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda3;

    invoke-direct {v8, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/wm/LetterboxUiController;)V

    new-instance v9, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda0;

    invoke-direct {v9, p0}, Lcom/android/server/wm/LetterboxUiController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/LetterboxUiController;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/ActivityRecord;->getPosition(Landroid/graphics/Point;)V

    iget-object p1, p0, Lcom/android/server/wm/LetterboxUiController;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->getFixedRotationTransformDisplayBounds()Landroid/graphics/Rect;
