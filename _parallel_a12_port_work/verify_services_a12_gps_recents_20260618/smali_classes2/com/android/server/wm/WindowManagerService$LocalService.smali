...
.method public getCompatibleMagnificationSpecForWindow(Landroid/os/IBinder;)Landroid/view/MagnificationSpec;
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/wm/AccessibilityController;->getMagnificationSpecForWindow(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
...
.method public getKeyInterceptionInfoFromToken(Landroid/os/IBinder;)Lcom/android/internal/policy/KeyInterceptionInfo;
    ...
    check-cast p1, Lcom/android/internal/policy/KeyInterceptionInfo;
...
.method public hideIme(Landroid/os/IBinder;I)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/DisplayContent;->getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    invoke-interface {p1, v3, v5}, Lcom/android/server/wm/InsetsControlTarget;->hideInsets(IZ)V
    ...
    invoke-virtual {p1, v6}, Lcom/android/server/wm/ImeInsetsSourceProvider;->setImeShowing(Z)V
...
.method public isInputMethodClientFocus(III)Z
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/WindowState;->canBeImeTarget()Z
...
.method public onToggleImeRequested(ZLandroid/os/IBinder;Landroid/os/IBinder;I)Lcom/android/server/wm/WindowManagerInternal$ImeTargetInfo;
    ...
    invoke-virtual {p4, v1}, Lcom/android/server/wm/DisplayContent;->getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    invoke-virtual {p4, v2}, Lcom/android/server/wm/DisplayContent;->getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    invoke-virtual {p4}, Lcom/android/server/wm/DisplayContent;->onShowImeRequested()V
    ...
    new-instance p1, Lcom/android/server/wm/WindowManagerInternal$ImeTargetInfo;

    invoke-direct {p1, p2, p3, v1, v2}, Lcom/android/server/wm/WindowManagerInternal$ImeTargetInfo;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setAccessibilityIdToSurfaceMetadata(Landroid/os/IBinder;I)V
    ...
    const-string p2, "Cannot find window which accessibility connection is added to"
    ...
    invoke-static {v1}, Lcom/android/server/wm/WindowManagerService;->access$2000(Lcom/android/server/wm/WindowManagerService;)Landroid/view/SurfaceControl$Transaction;

    move-result-object v1

    iget-object p1, p1, Lcom/android/server/wm/WindowState;->mSurfaceControl:Landroid/view/SurfaceControl;

    const/4 v2, 0x5

    invoke-virtual {v1, p1, v2, p2}, Landroid/view/SurfaceControl$Transaction;->setMetadata(Landroid/view/SurfaceControl;II)Landroid/view/SurfaceControl$Transaction;
...
.method public showImePostLayout(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/ImeInsetsSourceProvider;->scheduleShowImePostLayout(Lcom/android/server/wm/InsetsControlTarget;)V
...
.method public updateInputMethodTargetWindow(Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/wm/DisplayContent;->updateImeInputAndControlTarget(Lcom/android/server/wm/WindowState;)V
...
.method public waitForAllWindowsDrawn(Ljava/lang/Runnable;JI)V
    ...
    invoke-virtual {v2, v3, p4}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(ILjava/lang/Object;)V
