...
.method constructor <init>(Landroid/view/InsetsSource;Lcom/android/server/wm/InsetsStateController;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p2, p3, v3, v1, v2}, Landroid/view/InsetsSourceControl;-><init>(ILandroid/view/SurfaceControl;Landroid/graphics/Point;Landroid/graphics/Insets;)V
...
.method private getWindowFrameSurfacePosition()Landroid/graphics/Point;
    ...
    invoke-virtual {v2, v3, v0, v1}, Lcom/android/server/wm/WindowState;->transformFrameToSurfacePosition(IILandroid/graphics/Point;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/InsetsSourceProvider;->mFakeControlTarget:Lcom/android/server/wm/InsetsControlTarget;
...
.method dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    invoke-static {p4}, Lcom/android/server/wm/InsetsSourceProvider$ControlAdapter;->access$000(Lcom/android/server/wm/InsetsSourceProvider$ControlAdapter;)Landroid/view/SurfaceControl;
...
.method getControl(Lcom/android/server/wm/InsetsControlTarget;)Landroid/view/InsetsSourceControl;
    ...
    invoke-direct {p1, v0, v1, v2, v3}, Landroid/view/InsetsSourceControl;-><init>(ILandroid/view/SurfaceControl;Landroid/graphics/Point;Landroid/graphics/Insets;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/InsetsSourceProvider;->mFakeControl:Landroid/view/InsetsSourceControl;
...
.method onPostLayout()V
    ...
    invoke-virtual {v3, v4, v0}, Landroid/view/InsetsSourceControl;->setSurfacePosition(II)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowFrames;->didFrameSizeChange()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowState;->okToDisplay()Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/InsetsStateController;->notifyControlChanged(Lcom/android/server/wm/InsetsControlTarget;)V
...
.method setClientVisible(Z)V
    ...
    iget-boolean p1, p1, Lcom/android/server/wm/DisplayContent;->mLayoutAndAssignWindowLayersScheduled:Z
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/wm/WindowManagerService$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method setWindow(Lcom/android/server/wm/WindowState;Lcom/android/internal/util/function/TriConsumer;Lcom/android/internal/util/function/TriConsumer;)V
    ...
    :cond_3
    iget-object p1, p1, Lcom/android/server/wm/WindowState;->mProvidedInsetsSources:Landroid/util/SparseArray;
...
.method updateControlForTarget(Lcom/android/server/wm/InsetsControlTarget;Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent;->getSyncTransaction()Landroid/view/SurfaceControl$Transaction;
    ...
    iget-object v6, p0, Lcom/android/server/wm/InsetsSourceProvider;->mWin:Lcom/android/server/wm/WindowState;

    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->getBounds()Landroid/graphics/Rect;

    move-result-object v6

    invoke-virtual {v4, v6, v5}, Landroid/view/InsetsSource;->calculateInsets(Landroid/graphics/Rect;Z)Landroid/graphics/Insets;
    ...
    invoke-static {v2, v3, v0, v1, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
