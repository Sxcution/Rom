...
# instance fields
.field private mButtonBrightnessOverride:F
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput v1, p0, Lcom/android/server/wm/RootWindowContainer;->mButtonBrightnessOverride:F
    ...
    iput-object p1, p0, Lcom/android/server/wm/RootWindowContainer;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    iput-object p0, p1, Lcom/android/server/wm/ActivityTaskSupervisor;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;

    new-instance p1, Lcom/android/server/wm/ActivityTaskManagerService$SleepTokenAcquirerImpl;
    ...
    invoke-direct {p1, v0, v1}, Lcom/android/server/wm/ActivityTaskManagerService$SleepTokenAcquirerImpl;-><init>(Lcom/android/server/wm/ActivityTaskManagerService;Ljava/lang/String;)V

    iput-object p1, p0, Lcom/android/server/wm/RootWindowContainer;->mDisplayOffTokenAcquirer:Lcom/android/server/wm/ActivityTaskManagerInternal$SleepTokenAcquirer;
...
.method private applySurfaceChangesTransaction()V
    ...
    invoke-virtual {v2, v1, v0, v3, v4}, Lcom/android/server/wm/EmulatorDisplayOverlay;->positionSurface(IIILandroid/view/SurfaceControl$Transaction;)V
...
.method private calculateDefaultMinimalSizeOfResizeableTasks()V
    ...
    iput v0, p0, Lcom/android/server/wm/RootWindowContainer;->mDefaultMinSizeOfResizeableTaskDp:I
...
.method private checkAppTransitionReady(Lcom/android/server/wm/WindowSurfacePlacer;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent;->isAppTransitioning()Z
...
.method private getRootTask(III)Lcom/android/server/wm/Task;
    ...
    :cond_0
    invoke-virtual {p3, p1, p2}, Lcom/android/server/wm/DisplayContent;->getRootTask(II)Lcom/android/server/wm/Task;
...
.method private getRootTaskInfo(Lcom/android/server/wm/Task;)Landroid/app/ActivityTaskManager$RootTaskInfo;
    ...
    sget-object v3, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda4;
...
.method private isValidLaunchRootTask(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;I)Z
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/ActivityRecord;->supportsSplitScreenWindowingModeInDisplayArea(Lcom/android/server/wm/TaskDisplayArea;)Z
...
.method static synthetic lambda$getDumpActivities$39(IZLjava/util/ArrayList;Ljava/lang/String;Lcom/android/server/wm/Task;)Ljava/lang/Boolean;
    ...
    invoke-virtual {p4, p1}, Lcom/android/server/wm/Task;->shouldBeVisible(Lcom/android/server/wm/ActivityRecord;)Z
...
.method private shouldCloseAssistant(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)Z
    ...
    iget-boolean p1, p1, Lcom/android/server/wm/WindowManagerService;->mAssistantOnTopOfDream:Z
...
.method private startActivityForAttachedApplicationIfNeeded(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/WindowProcessController;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    iget-object p3, p3, Lcom/android/server/wm/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    iput-object p1, p0, Lcom/android/server/wm/RootWindowContainer;->mTmpRemoteException:Landroid/os/RemoteException;
...
.method allPausedActivitiesComplete()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda44;-><init>([Z)V

    invoke-virtual {p0, v0}, Lcom/android/server/wm/RootWindowContainer;->forAllLeafTasks(Ljava/util/function/Function;)Z
...
.method allResumedActivitiesIdle()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/Task;->hasActivity()Z
    ...
    invoke-static {v2, v3, v1, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method anyTaskForId(IILandroid/app/ActivityOptions;Z)Lcom/android/server/wm/Task;
    ...
    const-string p2, "Should not specify activity options for non-restore lookup"
    ...
    invoke-virtual {p0, v1, p3, v9, p4}, Lcom/android/server/wm/RootWindowContainer;->getLaunchRootTask(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;Z)Lcom/android/server/wm/Task;
    ...
    :cond_7
    iget-object p2, p0, Lcom/android/server/wm/RootWindowContainer;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    invoke-virtual {p2, p1, p3, p4}, Lcom/android/server/wm/ActivityTaskSupervisor;->restoreRecentTaskLocked(Lcom/android/server/wm/Task;Landroid/app/ActivityOptions;Z)Z
...
.method attachApplication(Lcom/android/server/wm/WindowProcessController;)Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/RootWindowContainer;->mTmpBoolean:Z
    ...
    invoke-direct {v4, p0, p1}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda20;-><init>(Lcom/android/server/wm/RootWindowContainer;Lcom/android/server/wm/WindowProcessController;)V

    invoke-virtual {v3, v4}, Lcom/android/server/wm/DisplayContent;->forAllRootTasks(Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {p0, v3, v1, v1}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method clearOtherAppTimeTrackers(Lcom/android/server/am/AppTimeTracker;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/RootWindowContainer;->forAllActivities(Ljava/util/function/Consumer;)V
...
.method createSleepToken(Ljava/lang/String;I)Lcom/android/server/wm/RootWindowContainer$SleepToken;
    ...
    const-string v0, "Create the same sleep token twice: "
...
.method dumpActivities(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ZZLjava/lang/String;)Z
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/wm/RootWindowContainer;->getChildAt(I)Lcom/android/server/wm/WindowContainer;
    ...
    new-instance v12, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda33;
    ...
    invoke-virtual {v11, v12}, Lcom/android/server/wm/DisplayContent;->forAllRootTasks(Ljava/util/function/Consumer;)V

    new-instance v1, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda34;

    move-object/from16 v12, p5

    invoke-direct {v1, v15, v13, v12, v9}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda34;-><init>([ZLjava/io/PrintWriter;Ljava/lang/String;[Z)V

    invoke-virtual {v11, v1}, Lcom/android/server/wm/DisplayContent;->forAllTaskDisplayAreas(Ljava/util/function/Consumer;)V
    ...
    new-instance v11, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda6;

    invoke-direct {v11, v13}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda6;-><init>(Ljava/io/PrintWriter;)V
    ...
    aput-boolean v1, v15, v16

    aget-boolean v12, v15, v16
    ...
    new-instance v10, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda7;

    invoke-direct {v10, v13}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda7;-><init>(Ljava/io/PrintWriter;)V
...
.method public dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    iget p4, p0, Lcom/android/server/wm/RootWindowContainer;->mDefaultMinSizeOfResizeableTaskDp:I
...
.method ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZZ)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/wm/RootWindowContainer;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;
...
.method ensureVisibilityAndConfig(Lcom/android/server/wm/ActivityRecord;IZZ)Z
    ...
    invoke-virtual {v2, p2, p1, v1}, Lcom/android/server/wm/DisplayContent;->updateOrientation(Landroid/content/res/Configuration;Lcom/android/server/wm/WindowContainer;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v2, p2, p1, p4, v0}, Lcom/android/server/wm/DisplayContent;->updateDisplayOverrideConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/wm/ActivityRecord;ZLcom/android/server/wm/ActivityTaskManagerService$UpdateConfigurationResult;)Z
...
.method findActivity(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Z)Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v3, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda3;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/RootWindowContainer;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
...
.method findTask(ILjava/lang/String;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Lcom/android/server/wm/TaskDisplayArea;)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object p1, p1, Lcom/android/server/wm/RootWindowContainer$FindTaskResult;->mIdealRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-direct {p2, p0, p5}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda42;-><init>(Lcom/android/server/wm/RootWindowContainer;Lcom/android/server/wm/TaskDisplayArea;)V

    invoke-virtual {p0, p2}, Lcom/android/server/wm/RootWindowContainer;->getItemFromTaskDisplayAreas(Ljava/util/function/Function;)Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lcom/android/internal/protolog/ProtoLogGroup;->isEnabled()Z
    ...
    invoke-static {p2, p3, v1, v2, p4}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method getAllRootTaskInfos(I)Ljava/util/ArrayList;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda23;-><init>(Lcom/android/server/wm/RootWindowContainer;Ljava/util/ArrayList;)V

    invoke-virtual {p0, p1}, Lcom/android/server/wm/RootWindowContainer;->forAllRootTasks(Ljava/util/function/Consumer;)V
    ...
    :cond_1
    new-instance v1, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda24;

    invoke-direct {v1, p0, v0}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda24;-><init>(Lcom/android/server/wm/RootWindowContainer;Ljava/util/ArrayList;)V

    invoke-virtual {p1, v1}, Lcom/android/server/wm/DisplayContent;->forAllRootTasks(Ljava/util/function/Consumer;)V
...
.method getDisplayContentOrCreate(I)Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/server/wm/RootWindowContainer;->addChild(Lcom/android/server/wm/WindowContainer;I)V
...
.method getDisplayUiContext(I)Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->getDisplayUiContext()Landroid/content/Context;
...
.method getDumpActivities(Ljava/lang/String;ZZ)Ljava/util/ArrayList;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/Task;->getDumpActivitiesLocked(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p3, p2, v0, p1}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda40;-><init>(IZLjava/util/ArrayList;Ljava/lang/String;)V
...
.method getLaunchRootTask(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;Lcom/android/server/wm/Task;ZLcom/android/server/wm/LaunchParamsController$LaunchParams;III)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v14, v2}, Landroid/app/ActivityOptions;->setLaunchTaskId(I)V

    const/4 v7, 0x2

    move/from16 v11, p5

    invoke-virtual {v6, v3, v7, v14, v11}, Lcom/android/server/wm/RootWindowContainer;->anyTaskForId(IILandroid/app/ActivityOptions;Z)Lcom/android/server/wm/Task;

    move-result-object v7

    invoke-virtual {v14, v3}, Landroid/app/ActivityOptions;->setLaunchTaskId(I)V
    ...
    iget-object v3, v12, Lcom/android/server/wm/LaunchParamsController$LaunchParams;->mPreferredTaskDisplayArea:Lcom/android/server/wm/TaskDisplayArea;

    if-eqz v3, :cond_5

    iget-object v5, v12, Lcom/android/server/wm/LaunchParamsController$LaunchParams;->mPreferredTaskDisplayArea:Lcom/android/server/wm/TaskDisplayArea;
    ...
    iget-object v3, v6, Lcom/android/server/wm/RootWindowContainer;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    iget-object v4, v15, Lcom/android/server/wm/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v3, v2, v0, v1, v4}, Lcom/android/server/wm/ActivityTaskSupervisor;->canPlaceEntityOnDisplay(IIILandroid/content/pm/ActivityInfo;)Z
    ...
    invoke-direct {v6, v15, v2}, Lcom/android/server/wm/RootWindowContainer;->canLaunchOnDisplay(Lcom/android/server/wm/ActivityRecord;I)Z
    ...
    invoke-direct {v6, v1, v8}, Lcom/android/server/wm/RootWindowContainer;->canLaunchOnDisplay(Lcom/android/server/wm/ActivityRecord;I)Z
    ...
    invoke-virtual {v7, v1, v2, v3, v5}, Lcom/android/server/wm/TaskDisplayArea;->resolveWindowingMode(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;I)I
    ...
    :goto_6
    invoke-virtual {v0, v8, v5}, Lcom/android/server/wm/Task;->isCompatible(II)Z

    move-result v9

    if-nez v9, :cond_12

    iget-boolean v9, v0, Lcom/android/server/wm/Task;->mCreatedByOrganizer:Z
    ...
    invoke-direct {v6, v1, v0}, Lcom/android/server/wm/RootWindowContainer;->canLaunchOnDisplay(Lcom/android/server/wm/ActivityRecord;I)Z
    ...
    invoke-virtual {v0, v1, v2, v3, v5}, Lcom/android/server/wm/TaskDisplayArea;->resolveWindowingMode(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;I)I
...
.method getRootTaskInfo(I)Landroid/app/ActivityTaskManager$RootTaskInfo;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/RootWindowContainer;->getRootTaskInfo(Lcom/android/server/wm/Task;)Landroid/app/ActivityTaskManager$RootTaskInfo;
...
.method getTopResumedActivity()Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_1
    sget-object v0, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda46;->INSTANCE:Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda46;

    invoke-virtual {p0, v0}, Lcom/android/server/wm/RootWindowContainer;->getItemFromTaskDisplayAreas(Ljava/util/function/Function;)Ljava/lang/Object;
...
.method getValidLaunchRootTaskInTaskDisplayArea(Lcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;Landroid/app/ActivityOptions;Lcom/android/server/wm/LaunchParamsController$LaunchParams;)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p2, p1, v0}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/TaskDisplayArea;Z)V
    ...
    invoke-virtual {p1, p5, p2, p3, v2}, Lcom/android/server/wm/TaskDisplayArea;->validateWindowingMode(ILcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;I)I

    move-result p3

    nop

    new-instance p5, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda50;

    invoke-direct {p5, p0, p2, p3}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda50;-><init>(Lcom/android/server/wm/RootWindowContainer;Lcom/android/server/wm/ActivityRecord;I)V

    invoke-virtual {p1, p5}, Lcom/android/server/wm/TaskDisplayArea;->getRootTask(Ljava/util/function/Predicate;)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {p0, p5}, Lcom/android/server/wm/RootWindowContainer;->getDisplayContent(I)Lcom/android/server/wm/DisplayContent;

    move-result-object p5

    invoke-virtual {p5}, Lcom/android/server/wm/DisplayContent;->getDefaultTaskDisplayArea()Lcom/android/server/wm/TaskDisplayArea;
    ...
    :goto_3
    invoke-virtual {p1, p3, p2, v0, p4}, Lcom/android/server/wm/TaskDisplayArea;->createRootTask(IIZLandroid/app/ActivityOptions;)Lcom/android/server/wm/Task;
...
.method handleNotObscuredLocked(Lcom/android/server/wm/WindowState;ZZ)Z
    ...
    :cond_2
    iget-object v3, v0, Lcom/android/server/wm/RootWindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget v4, v0, Lcom/android/server/wm/RootWindowContainer;->mButtonBrightnessOverride:F
    ...
    iput v4, v0, Lcom/android/server/wm/RootWindowContainer;->mButtonBrightnessOverride:F
    ...
    iget-object v1, v0, Lcom/android/server/wm/RootWindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method public synthetic lambda$applySleepTokens$21$RootWindowContainer(ZLcom/android/server/wm/DisplayContent;Lcom/android/server/wm/Task;)V
    ...
    :cond_0
    sget-object p1, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda37;->INSTANCE:Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda37;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/KeyguardController;->isKeyguardOrAodShowing(I)Z
...
.method public synthetic lambda$attachApplication$15$RootWindowContainer(Lcom/android/server/wm/WindowProcessController;Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/Task;->forAllActivities(Ljava/util/function/Function;)Z
...
.method public synthetic lambda$lockAllProfileTasks$37$RootWindowContainer(ILcom/android/server/wm/Task;)V
    ...
    invoke-direct {v0, p1}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda47;-><init>(I)V
    ...
    invoke-virtual {v0, p2, p1}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyTaskProfileLocked(II)V
...
.method public synthetic lambda$rankTaskLayers$28$RootWindowContainer(Lcom/android/server/wm/Task;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda15;-><init>(Lcom/android/server/wm/RootWindowContainer;)V
...
.method lockAllProfileTasks(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/server/wm/RootWindowContainer;->forAllLeafTasks(Ljava/util/function/Consumer;Z)V
...
.method moveActivityToPinnedRootTask(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v5}, Lcom/android/server/wm/Task$Builder;-><init>(Lcom/android/server/wm/ActivityTaskManagerService;)V

    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->getActivityType()I

    move-result v5

    invoke-virtual {v2, v5}, Lcom/android/server/wm/Task$Builder;->setActivityType(I)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    invoke-virtual {v2, v4}, Lcom/android/server/wm/Task$Builder;->setOnTop(Z)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    iget-object v5, p1, Lcom/android/server/wm/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v2, v5}, Lcom/android/server/wm/Task$Builder;->setActivityInfo(Landroid/content/pm/ActivityInfo;)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    invoke-virtual {v2, v0}, Lcom/android/server/wm/Task$Builder;->setParent(Lcom/android/server/wm/WindowContainer;)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    iget-object v5, p1, Lcom/android/server/wm/ActivityRecord;->intent:Landroid/content/Intent;

    invoke-virtual {v2, v5}, Lcom/android/server/wm/Task$Builder;->setIntent(Landroid/content/Intent;)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    invoke-virtual {v2, v4}, Lcom/android/server/wm/Task$Builder;->setDeferTaskAppear(Z)Lcom/android/server/wm/Task$Builder;

    move-result-object v2

    invoke-virtual {v2, v4}, Lcom/android/server/wm/Task$Builder;->setHasBeenVisible(Z)Lcom/android/server/wm/Task$Builder;
    ...
    iget-object v5, v1, Lcom/android/server/wm/Task;->mLastNonFullscreenBounds:Landroid/graphics/Rect;

    invoke-virtual {v2, v5}, Lcom/android/server/wm/Task;->setLastNonFullscreenBounds(Landroid/graphics/Rect;)V

    invoke-virtual {v1}, Lcom/android/server/wm/Task;->getBounds()Landroid/graphics/Rect;

    move-result-object v5

    invoke-virtual {v2, v5}, Lcom/android/server/wm/Task;->setBounds(Landroid/graphics/Rect;)I

    iget-object v5, v1, Lcom/android/server/wm/Task;->mLastRecentsAnimationTransaction:Landroid/window/PictureInPictureSurfaceTransaction;

    if-eqz v5, :cond_3

    iget-object v5, v1, Lcom/android/server/wm/Task;->mLastRecentsAnimationTransaction:Landroid/window/PictureInPictureSurfaceTransaction;

    iget-object v6, v1, Lcom/android/server/wm/Task;->mLastRecentsAnimationOverlay:Landroid/view/SurfaceControl;

    invoke-virtual {v2, v5, v6}, Lcom/android/server/wm/Task;->setLastRecentsAnimationTransaction(Landroid/window/PictureInPictureSurfaceTransaction;Landroid/view/SurfaceControl;)V

    invoke-virtual {v1, v3}, Lcom/android/server/wm/Task;->clearLastRecentsAnimationTransaction(Z)V

    :cond_3
    const v5, 0x7fffffff

    invoke-virtual {p1, v2, v5, p2}, Lcom/android/server/wm/ActivityRecord;->reparent(Lcom/android/server/wm/TaskFragment;ILjava/lang/String;)V
    ...
    invoke-virtual {p2, v5}, Lcom/android/server/wm/ActivityRecord;->isState(Lcom/android/server/wm/ActivityRecord$State;)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/wm/AppTransition;->containsTransitRequest(I)Z
    ...
    iput-boolean v4, p2, Lcom/android/server/wm/ActivityRecord;->mRequestForceTransition:Z
    ...
    invoke-virtual {v1, v0, v4}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/TaskDisplayArea;Z)V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/android/server/wm/TransitionController;->requestTransitionIfNeeded(ILcom/android/server/wm/WindowContainer;)Lcom/android/server/wm/Transition;

    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityRecord;->setWindowingMode(I)V

    iput-boolean v4, p1, Lcom/android/server/wm/ActivityRecord;->mWaitForEnteringPinnedMode:Z

    const/4 p2, 0x2

    invoke-virtual {v1, p2}, Lcom/android/server/wm/Task;->setWindowingMode(I)V

    invoke-virtual {v1, v3}, Lcom/android/server/wm/Task;->setDeferTaskAppear(Z)V
    ...
    invoke-virtual {p0, p2, v3, v3}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method moveRootTaskToDisplay(IIZ)V
    ...
    const-string v0, "moveRootTaskToDisplay: Unknown displayId="
...
.method moveRootTaskToTaskDisplayArea(ILcom/android/server/wm/TaskDisplayArea;Z)V
    ...
    const-string v0, " to its current taskDisplayArea="
    ...
    const-string v0, "moveRootTaskToTaskDisplayArea: Unknown taskDisplayArea="
    ...
    const-string p3, " is not attached to any task display area."
    ...
    const-string v0, "moveRootTaskToTaskDisplayArea: Unknown rootTaskId="
...
.method notifyActivityPipModeChanged(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/RootWindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method public onDisplayAdded(I)V
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/server/wm/RootWindowContainer;->startSystemDecorations(Lcom/android/server/wm/DisplayContent;)V
...
.method public onDisplayChanged(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->onDisplayChanged()V
...
.method public onDisplayRemoved(I)V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->remove()V
...
.method performSurfacePlacementNoTrace()V
    ...
    iput v4, p0, Lcom/android/server/wm/RootWindowContainer;->mButtonBrightnessOverride:F
    ...
    invoke-virtual {v0, v6, v3}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
    ...
    invoke-static {v5, v8, v2, v1, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput v3, v0, Lcom/android/server/wm/WindowManagerService;->mWindowsFreezingScreen:I

    iget-object v0, p0, Lcom/android/server/wm/RootWindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object v2, p0, Lcom/android/server/wm/RootWindowContainer;->mLastWindowFreezeSource:Ljava/lang/Object;
    ...
    invoke-virtual {v8, v2}, Lcom/android/server/wm/WallpaperController;->isWallpaperTarget(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/DisplayContent;->removeExistingTokensIfPossible()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/RootWindowContainer;->mHoldScreen:Lcom/android/server/wm/Session;
    ...
    iget v0, p0, Lcom/android/server/wm/RootWindowContainer;->mButtonBrightnessOverride:F
    ...
    :goto_7
    iget v5, p0, Lcom/android/server/wm/RootWindowContainer;->mScreenBrightnessOverride:F
    ...
    invoke-virtual {v4, v3, v0, v3}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-virtual {v0, v7, v2, v3}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    iget-wide v4, p0, Lcom/android/server/wm/RootWindowContainer;->mUserActivityTimeout:J
    ...
    invoke-virtual {v0, v6, v2}, Landroid/os/PowerManagerInternal;->setPowerMode(IZ)V
    ...
    invoke-static {v0, v2, v3, v1, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-object v2, v1, Lcom/android/server/wm/WindowManagerService;->mPendingRemoveTmp:[Lcom/android/server/wm/WindowState;
    ...
    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mPendingRemoveTmp:[Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v2, v7}, Lcom/android/server/wm/DisplayContent;->assignWindowLayers(Z)V
    ...
    :cond_1f
    sget-object v0, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda36;->INSTANCE:Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda36;
...
.method putTasksToSleep(ZZ)Z
    ...
    invoke-direct {v0, p1, v1, p2}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda32;-><init>(Z[ZZ)V
...
.method reclaimSomeSurfaceMemory(Lcom/android/server/wm/WindowStateAnimator;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, v5, v6}, Lcom/android/server/wm/EventLogTags;->writeWmNoSurfaceMemory(Ljava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v10, v1, Lcom/android/server/wm/RootWindowContainer;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    invoke-direct {v14, v1, v11}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda19;-><init>(Lcom/android/server/wm/RootWindowContainer;Landroid/util/SparseIntArray;)V
    ...
    invoke-virtual {v11, v15}, Landroid/util/SparseIntArray;->keyAt(I)I
    ...
    :try_start_2
    invoke-interface {v0, v14, v15, v8}, Landroid/app/IActivityManager;->killPids([ILjava/lang/String;Z)Z
    ...
    invoke-static {v3, v4, v11, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method removeSleepToken(Lcom/android/server/wm/RootWindowContainer$SleepToken;)V
    ...
    const-string v4, "Remove sleep token for non-existing display: "
...
.method resolveSecondaryHomeActivity(ILcom/android/server/wm/TaskDisplayArea;)Landroid/util/Pair;
    ...
    const-string p2, "resolveSecondaryHomeActivity: Should not be default task container"
...
.method resumeFocusedTasksTopActivities(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Z)Z
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/wm/Task;->resumeTopActivityUncheckedLocked(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    invoke-virtual {p0, v2, v6, v5}, Lcom/android/server/wm/RootWindowContainer;->resumeHomeActivity(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;Lcom/android/server/wm/TaskDisplayArea;)Z
...
.method scheduleDestroyAllActivities(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/RootWindowContainer;->mDestroyAllActivitiesRunnable:Ljava/lang/Runnable;

    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskManagerService$H;->post(Ljava/lang/Runnable;)Z
...
.method setWindowManager(Lcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-virtual {p0, v3, v2}, Lcom/android/server/wm/RootWindowContainer;->addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    invoke-virtual {p0, v1, p1, v0}, Lcom/android/server/wm/RootWindowContainer;->positionChildAt(ILcom/android/server/wm/WindowContainer;Z)V
...
.method shouldPlaceSecondaryHomeOnDisplayArea(Lcom/android/server/wm/TaskDisplayArea;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->isRemoved()Z
    ...
    const-string v0, "shouldPlaceSecondaryHomeOnDisplay: Should not be on default task container"
...
.method startHomeOnDisplay(ILjava/lang/String;IZZ)Z
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/Task;->getDisplayId()I
    ...
    new-instance v7, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda10;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/wm/RootWindowContainer;ILjava/lang/String;ZZ)V

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    invoke-virtual {p3, v7, p1}, Lcom/android/server/wm/DisplayContent;->reduceOnAllTaskDisplayAreas(Ljava/util/function/BiFunction;Ljava/lang/Object;)Ljava/lang/Object;
...
.method startHomeOnTaskDisplayArea(ILjava/lang/String;Lcom/android/server/wm/TaskDisplayArea;ZZ)Z
    ...
    invoke-virtual {p2, v0, v1, p1, p3}, Lcom/android/server/wm/ActivityStartController;->startHomeActivity(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/String;Lcom/android/server/wm/TaskDisplayArea;)V
...
.method startPowerModeLaunchIfNeeded(ZLcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-direct {v3, p1, v2, p2}, Lcom/android/server/wm/RootWindowContainer$$ExternalSyntheticLambda35;-><init>([Z[ZLcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskManagerService;->startLaunchPowerMode(I)V
...
.method switchUser(ILcom/android/server/am/UserState;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/TaskDisplayArea;->onSplitScreenModeDismissed()V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/wm/RootWindowContainer;->forAllRootTasks(Ljava/util/function/Consumer;)V
...
.method updateFocusedWindowLocked(IZ)Z
    ...
    invoke-static {v0, v3, v1, v4, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
