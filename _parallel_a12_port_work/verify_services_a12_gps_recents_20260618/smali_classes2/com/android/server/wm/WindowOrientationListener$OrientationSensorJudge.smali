...
.method private finalizeRotation(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowOrientationListener;->onProposedRotationChanged(I)V
...
.method private scheduleRotationEvaluationIfNecessaryLocked(J)V
    ...
    const-string p1, "scheduleRotationEvaluationLocked: ignoring, user is still touching the screen."
    ...
    const-string p1, "scheduleRotationEvaluationLocked: ignoring, already past the next possible time of rotation."
    ...
    const-string p1, "scheduleRotationEvaluationLocked: ignoring, an evaluation is already scheduled or is unnecessary."
...
.method public dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget p2, p0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->mLastRotationResolution:I
...
.method public onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->rotationToLogEnum(I)I
    ...
    iget-object p1, v0, Lcom/android/server/wm/WindowProcessController;->mInfo:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {p1}, Lcom/android/server/wm/WindowOrientationListener;->access$200(Lcom/android/server/wm/WindowOrientationListener;)I
    ...
    :cond_6
    invoke-direct {p0, v5}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->finalizeRotation(I)V
...
.method public onTouchEndLocked(J)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->scheduleRotationEvaluationIfNecessaryLocked(J)V
