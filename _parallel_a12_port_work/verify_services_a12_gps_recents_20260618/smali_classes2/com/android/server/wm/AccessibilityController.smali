...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/AccessibilityController;->mAccessibilityTracing:Lcom/android/server/wm/AccessibilityController$AccessibilityControllerInternalImpl;
...
.method private updateWindowObserverOfEmbeddedDisplay(ILcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/AccessibilityController$WindowsForAccessibilityObserver;->notifyDisplayReparented(I)V

    invoke-virtual {p2, p1}, Lcom/android/server/wm/AccessibilityController$WindowsForAccessibilityObserver;->addEmbeddedDisplay(I)V
...
.method drawMagnifiedRegionBorderIfNeeded(ILandroid/view/SurfaceControl$Transaction;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->drawMagnifiedRegionBorderIfNeeded(Landroid/view/SurfaceControl$Transaction;)V
...
.method getMagnificationRegion(ILandroid/graphics/Region;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->getMagnificationRegion(Landroid/graphics/Region;)V
...
.method getMagnificationSpecForWindow(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->getMagnificationSpecForWindow(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
...
.method handleWindowObserverOfEmbeddedDisplay(ILcom/android/server/wm/WindowState;I)V
    ...
    :cond_1
    iget-object p3, p0, Lcom/android/server/wm/AccessibilityController;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object p3, p3, Lcom/android/server/wm/WindowManagerService;->mH:Lcom/android/server/wm/WindowManagerService$H;

    sget-object v0, Lcom/android/server/wm/AccessibilityController$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/wm/AccessibilityController$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {p3, p1}, Lcom/android/server/wm/WindowManagerService$H;->sendMessage(Landroid/os/Message;)Z
...
.method onDisplaySizeChanged(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/AccessibilityController$WindowsForAccessibilityObserver;->scheduleComputeChangedWindows()V
...
.method onImeSurfaceShownChanged(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->onImeSurfaceShownChanged(Z)V
...
.method onRectangleOnScreenRequested(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->onRectangleOnScreenRequested(Landroid/graphics/Rect;)V
...
.method setForceShowMagnifiableBounds(IZ)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;->setForceShowMagnifiableBounds(Z)V
...
.method setMagnificationCallbacks(ILcom/android/server/wm/WindowManagerInternal$MagnificationCallbacks;)Z
    ...
    invoke-direct {v4, v5, v2, v3, p2}, Lcom/android/server/wm/AccessibilityController$DisplayMagnifier;-><init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;Landroid/view/Display;Lcom/android/server/wm/WindowManagerInternal$MagnificationCallbacks;)V
...
.method setWindowsForAccessibilityCallback(ILcom/android/server/wm/WindowManagerInternal$WindowsForAccessibilityCallback;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/AccessibilityController;->handleWindowObserverOfEmbeddedDisplay(ILcom/android/server/wm/WindowState;)V
    ...
    invoke-direct {v0, v1, p1, p2}, Lcom/android/server/wm/AccessibilityController$WindowsForAccessibilityObserver;-><init>(Lcom/android/server/wm/WindowManagerService;ILcom/android/server/wm/WindowManagerInternal$WindowsForAccessibilityCallback;)V
    ...
    :cond_8
    :goto_1
    invoke-direct {p0, p2}, Lcom/android/server/wm/AccessibilityController;->removeObserversForEmbeddedChildDisplays(Lcom/android/server/wm/AccessibilityController$WindowsForAccessibilityObserver;)V
