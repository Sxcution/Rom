...
.method constructor <init>(Landroid/view/IWindow;Lcom/android/server/wm/DisplayContent;I)V
    ...
    const-string p3, " is not an acceptable shell root layer."
    ...
    iget-object v2, p2, Lcom/android/server/wm/DisplayContent;->mWmService:Lcom/android/server/wm/WindowManagerService;

    invoke-interface {p1}, Landroid/view/IWindow;->asBinder()Landroid/os/IBinder;

    move-result-object p1

    iget v3, p0, Lcom/android/server/wm/ShellRoot;->mWindowType:I

    invoke-direct {p3, v2, p1, v3}, Lcom/android/server/wm/WindowToken$Builder;-><init>(Lcom/android/server/wm/WindowManagerService;Landroid/os/IBinder;I)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/wm/WindowToken$Builder;->setPersistOnEmpty(Z)Lcom/android/server/wm/WindowToken$Builder;

    move-result-object p1

    invoke-virtual {p1, p3}, Lcom/android/server/wm/WindowToken$Builder;->setOwnerCanManageAppTokens(Z)Lcom/android/server/wm/WindowToken$Builder;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/WindowToken;->makeChildSurface(Lcom/android/server/wm/WindowContainer;)Landroid/view/SurfaceControl$Builder;
    ...
    iget-object p2, p0, Lcom/android/server/wm/ShellRoot;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    const-string v2, "Unable to add shell root layer "
...
.method setAccessibilityWindow(Landroid/view/IWindow;)V
    ...
    :try_start_0
    new-instance p1, Lcom/android/server/wm/ShellRoot$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0}, Lcom/android/server/wm/ShellRoot$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/ShellRoot;)V
...
.method startAnimation(Landroid/view/animation/Animation;)V
    ...
    invoke-virtual {p1, v1, v0, v3, v2}, Lcom/android/server/wm/WindowToken;->startAnimation(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/AnimationAdapter;ZI)V
