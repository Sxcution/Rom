...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/profcollect/ProfcollectForwardingService$AppLaunchObserver;-><init>(Lcom/android/server/profcollect/ProfcollectForwardingService;Lcom/android/server/profcollect/ProfcollectForwardingService$1;)V
    ...
    const-string v0, "only one service instance allowed"
...
.method private connectNativeService()Z
    ...
    const-string v2, "Failed to connect profcollectd binder service."
...
.method private registerAppLaunchObserver()V
    ...
    iget-object v1, p0, Lcom/android/server/profcollect/ProfcollectForwardingService;->mAppLaunchObserver:Lcom/android/server/profcollect/ProfcollectForwardingService$AppLaunchObserver;
...
.method private traceOnAppStart(Ljava/lang/String;)V
    ...
    :try_start_0
    sget-boolean v1, Lcom/android/server/profcollect/ProfcollectForwardingService;->DEBUG:Z
    ...
    const-string v2, "Tracing on app launch event: "
    ...
    invoke-interface {p1, v1}, Lcom/android/server/profcollect/IProfCollectd;->trace_once(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public synthetic lambda$packProfileReport$0$ProfcollectForwardingService()V
    ...
    new-array v9, v8, [Ljava/nio/file/LinkOption;

    invoke-static {v6, v9}, Ljava/nio/file/Files;->exists(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z

    move-result v6

    if-nez v6, :cond_0

    const-string v1, "Destination directory does not exist, abort upload."
    ...
    const-string v3, "EXTRA_DESTINATION"

    const-string v6, "PROFCOLLECT"
    ...
    const-string v3, "EXTRA_PROFILE_PATH"
    ...
    invoke-virtual {v3, v2, v8}, Landroid/content/pm/PackageManager;->queryBroadcastReceivers(Landroid/content/Intent;I)Ljava/util/List;
    ...
    invoke-interface {v3, v5, v4}, Lcom/android/server/profcollect/IProfCollectd;->copy_report_to_bb(ILjava/lang/String;)V

    invoke-virtual {v1, v2}, Landroid/content/Context;->sendBroadcast(Landroid/content/Intent;)V

    iget-object v1, p0, Lcom/android/server/profcollect/ProfcollectForwardingService;->mIProfcollect:Lcom/android/server/profcollect/IProfCollectd;

    invoke-interface {v1, v4}, Lcom/android/server/profcollect/IProfCollectd;->delete_report(Ljava/lang/String;)V

    goto :goto_1

    :cond_2
    :goto_0
    const-string v1, "No one to receive upload intent, abort upload."
...
.method public onBootPhase(I)V
    ...
    invoke-static {p1}, Lcom/android/server/profcollect/ProfcollectForwardingService$ProfcollectBGJobService;->schedule(Landroid/content/Context;)V
