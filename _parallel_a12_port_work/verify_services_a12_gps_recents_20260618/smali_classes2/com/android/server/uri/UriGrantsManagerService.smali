...
.method private checkGrantUriPermissionFromIntentUnlocked(ILjava/lang/String;Landroid/content/Intent;ILcom/android/server/uri/NeededUriGrants;I)Lcom/android/server/uri/NeededUriGrants;
    ...
    invoke-virtual {v2, v7, v3, v12}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
...
.method private checkGrantUriPermissionUnlocked(ILjava/lang/String;Lcom/android/server/uri/GrantUri;II)I
    ...
    invoke-direct {v0, v2, v4, v5, v7}, Lcom/android/server/uri/UriGrantsManagerService;->getProviderInfo(Ljava/lang/String;III)Landroid/content/pm/ProviderInfo;
    ...
    invoke-virtual {v2, v1, v5, v4}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    invoke-direct {v0, v10, v8, v11, v9}, Lcom/android/server/uri/UriGrantsManagerService;->checkHoldingPermissionsUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    :cond_18
    :goto_9
    invoke-direct {v0, v10, v8, v7, v9}, Lcom/android/server/uri/UriGrantsManagerService;->checkHoldingPermissionsUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    :try_start_0
    invoke-direct {v0, v8, v7, v9}, Lcom/android/server/uri/UriGrantsManagerService;->checkUriPermissionLocked(Lcom/android/server/uri/GrantUri;II)Z
...
.method private checkHoldingPermissionsInternalUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;IIZ)Z
    ...
    invoke-direct {v0, v14, v3}, Lcom/android/server/uri/UriGrantsManagerService;->checkUidPermission(Ljava/lang/String;I)I
...
.method private checkHoldingPermissionsUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/uri/UriGrantsManagerService;->checkHoldingPermissionsInternalUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;IIZ)Z
...
.method private getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    invoke-virtual {v0, p1, p3, p2}, Landroid/content/pm/PackageManagerInternal;->resolveContentProvider(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
...
.method private getProviderInfo(Ljava/lang/String;III)Landroid/content/pm/ProviderInfo;
    ...
    invoke-virtual {v0, p1, p3, p2, p4}, Landroid/content/pm/PackageManagerInternal;->resolveContentProvider(Ljava/lang/String;III)Landroid/content/pm/ProviderInfo;
...
.method private grantUriPermissionUnchecked(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;)V
    ...
    const-string p1, "UriGrantsManagerService"
    ...
    invoke-direct {p0, v2, p2, p1, p3}, Lcom/android/server/uri/UriGrantsManagerService;->findOrCreateUriPermissionLocked(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/content/pm/PackageManagerInternal;->grantImplicitAccess(ILandroid/content/Intent;IIZ)V
...
.method private maybePrunePersistedUriGrantsLocked(I)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/server/uri/UriGrantsManagerService;->removeUriPermissionIfNeededLocked(Lcom/android/server/uri/UriPermission;)V
...
.method private readGrantedUriPermissionsLocked()V
    ...
    invoke-direct {v0, v14, v8, v5}, Lcom/android/server/uri/UriGrantsManagerService;->getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    :try_start_3
    iget-object v14, v5, Landroid/content/pm/ProviderInfo;->packageName:Ljava/lang/String;
    ...
    iget-object v14, v0, Lcom/android/server/uri/UriGrantsManagerService;->mPmInternal:Landroid/content/pm/PackageManagerInternal;

    move-wide/from16 v18, v3

    const/16 v3, 0x2000

    invoke-virtual {v14, v11, v3, v10}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    :goto_2
    invoke-direct {v4, v8, v12, v14}, Lcom/android/server/uri/GrantUri;-><init>(ILandroid/net/Uri;I)V

    invoke-direct {v0, v9, v11, v3, v4}, Lcom/android/server/uri/UriGrantsManagerService;->findOrCreateUriPermissionLocked(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;

    move-result-object v4

    invoke-virtual {v4, v15, v1, v2}, Lcom/android/server/uri/UriPermission;->initPersistedModes(IJ)V
...
.method private revokeUriPermission(Ljava/lang/String;ILcom/android/server/uri/GrantUri;I)V
    ...
    :cond_0
    invoke-direct {p0, v0, p3, p2, p4}, Lcom/android/server/uri/UriGrantsManagerService;->checkHoldingPermissionsUnlocked(Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    :try_start_0
    invoke-direct/range {v0 .. v5}, Lcom/android/server/uri/UriGrantsManagerService;->revokeUriPermissionLocked(Ljava/lang/String;ILcom/android/server/uri/GrantUri;IZ)V
...
.method private revokeUriPermissionLocked(Ljava/lang/String;ILcom/android/server/uri/GrantUri;IZ)V
    ...
    iget v4, v4, Lcom/android/server/uri/GrantUri;->sourceUserId:I

    iget v5, p3, Lcom/android/server/uri/GrantUri;->sourceUserId:I
...
.method private writeGrantedUriPermissionsLocked()V
    ...
    invoke-interface {v1, v3, v5, v6, v7}, Landroid/util/TypedXmlSerializer;->attributeLong(Ljava/lang/String;Ljava/lang/String;J)Lorg/xmlpull/v1/XmlSerializer;
...
.method public releasePersistableUriPermission(Landroid/net/Uri;ILjava/lang/String;I)V
    ...
    invoke-direct {v3, p4, p1, v0}, Lcom/android/server/uri/GrantUri;-><init>(ILandroid/net/Uri;I)V
    ...
    invoke-direct {p0, p4}, Lcom/android/server/uri/UriGrantsManagerService;->removeUriPermissionIfNeededLocked(Lcom/android/server/uri/UriPermission;)V
...
.method public takePersistableUriPermission(Landroid/net/Uri;ILjava/lang/String;I)V
    ...
    invoke-direct {v2, p4, p1, v0}, Lcom/android/server/uri/GrantUri;-><init>(ILandroid/net/Uri;I)V
    ...
    invoke-direct {p0, p3, v3}, Lcom/android/server/uri/UriGrantsManagerService;->findUriPermissionLocked(ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
    ...
    iget v4, v2, Lcom/android/server/uri/UriPermission;->persistableModeFlags:I
    ...
    :cond_6
    invoke-direct {p0, p3}, Lcom/android/server/uri/UriGrantsManagerService;->maybePrunePersistedUriGrantsLocked(I)Z
