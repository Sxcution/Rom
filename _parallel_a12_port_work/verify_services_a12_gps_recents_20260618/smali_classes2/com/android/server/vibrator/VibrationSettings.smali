...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;II)V
    ...
    new-instance p1, Lcom/android/server/vibrator/VibrationSettings$SettingsObserver;

    invoke-direct {p1, p0, p2}, Lcom/android/server/vibrator/VibrationSettings$SettingsObserver;-><init>(Lcom/android/server/vibrator/VibrationSettings;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mSettingObserver:Lcom/android/server/vibrator/VibrationSettings$SettingsObserver;
    ...
    new-instance p1, Lcom/android/server/vibrator/VibrationSettings$UserObserver;

    invoke-direct {p1, p0}, Lcom/android/server/vibrator/VibrationSettings$UserObserver;-><init>(Lcom/android/server/vibrator/VibrationSettings;)V

    iput-object p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mUserReceiver:Lcom/android/server/vibrator/VibrationSettings$UserObserver;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vibrator/VibrationSettings;->createEffectFromResource(I)Landroid/os/VibrationEffect;

    move-result-object p1

    sget-object p2, Lcom/android/server/vibrator/VibrationSettings;->DOUBLE_CLICK_EFFECT_FALLBACK_TIMINGS:[J
    ...
    invoke-direct {p0, p3}, Lcom/android/server/vibrator/VibrationSettings;->createEffectFromResource(I)Landroid/os/VibrationEffect;

    move-result-object p3

    const p4, 0x1070026

    invoke-direct {p0, p4}, Lcom/android/server/vibrator/VibrationSettings;->createEffectFromResource(I)Landroid/os/VibrationEffect;
    ...
    iput-object v0, p0, Lcom/android/server/vibrator/VibrationSettings;->mFallbackEffects:Landroid/util/SparseArray;
...
.method static synthetic access$100(Lcom/android/server/vibrator/VibrationSettings;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/vibrator/VibrationSettings;->mLowPowerMode:Z
...
.method private createEffectFromResource(I)Landroid/os/VibrationEffect;
    ...
    invoke-static {p1}, Lcom/android/server/vibrator/VibrationSettings;->createEffectFromTimings([J)Landroid/os/VibrationEffect;
...
.method private notifyListeners()V
    ...
    check-cast v1, Lcom/android/server/vibrator/VibrationSettings$OnVibratorSettingsChanged;

    invoke-interface {v1}, Lcom/android/server/vibrator/VibrationSettings$OnVibratorSettingsChanged;->onChange()V
...
.method public getCurrentIntensity(I)I
    ...
    iget p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mRingIntensity:I
    ...
    iget p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mNotificationIntensity:I
    ...
    iget p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mHapticFeedbackIntensity:I
...
.method public getDefaultIntensity(I)I
    ...
    iget-object p1, p0, Lcom/android/server/vibrator/VibrationSettings;->mVibrator:Landroid/os/Vibrator;

    invoke-virtual {p1}, Landroid/os/Vibrator;->getDefaultRingVibrationIntensity()I
    ...
    invoke-virtual {p1}, Landroid/os/Vibrator;->getDefaultNotificationVibrationIntensity()I
    ...
    invoke-virtual {p1}, Landroid/os/Vibrator;->getDefaultHapticFeedbackIntensity()I
...
.method public onSystemReady()V
    ...
    iget-object v1, p0, Lcom/android/server/vibrator/VibrationSettings;->mUserReceiver:Lcom/android/server/vibrator/VibrationSettings$UserObserver;
...
.method public shouldVibrateForRingerMode(I)Z
    ...
    iget-boolean v3, p0, Lcom/android/server/vibrator/VibrationSettings;->mVibrateWhenRinging:Z
    ...
    :cond_3
    iget-boolean v3, p0, Lcom/android/server/vibrator/VibrationSettings;->mApplyRampingRinger:Z
