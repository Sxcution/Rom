...
.method private addOneShotToComposition(Landroid/os/VibrationEffect$Composition;)V
    ...
    invoke-virtual {p1, v0, v1}, Landroid/os/VibrationEffect$Composition;->addEffect(Landroid/os/VibrationEffect;I)Landroid/os/VibrationEffect$Composition;
...
.method private addWaveformToComposition(Landroid/os/VibrationEffect$Composition;)V
    ...
    invoke-virtual {v3, v4, v9, v10}, Landroid/os/VibrationEffect$WaveformBuilder;->addRamp(FFI)Landroid/os/VibrationEffect$WaveformBuilder;
    ...
    invoke-virtual {v3, v4, v9, v10}, Landroid/os/VibrationEffect$WaveformBuilder;->addStep(FFI)Landroid/os/VibrationEffect$WaveformBuilder;
    ...
    :cond_a
    invoke-virtual {v3, v2}, Landroid/os/VibrationEffect$WaveformBuilder;->build(I)Landroid/os/VibrationEffect;

    move-result-object v0

    invoke-virtual {p1, v0, v6}, Landroid/os/VibrationEffect$Composition;->addEffect(Landroid/os/VibrationEffect;I)Landroid/os/VibrationEffect$Composition;
...
.method private createVibrationAttributes(Lcom/android/server/vibrator/VibratorManagerService$VibratorManagerShellCommand$CommonOptions;)Landroid/os/VibrationAttributes;
    ...
    iget-boolean p1, p1, Lcom/android/server/vibrator/VibratorManagerService$VibratorManagerShellCommand$CommonOptions;->force:Z
    ...
    invoke-virtual {v0, p1, v1}, Landroid/os/VibrationAttributes$Builder;->setFlags(II)Landroid/os/VibrationAttributes$Builder;
