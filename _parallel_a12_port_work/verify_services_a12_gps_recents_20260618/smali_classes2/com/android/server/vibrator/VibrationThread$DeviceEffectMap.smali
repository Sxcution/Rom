...
.method constructor <init>(Lcom/android/server/vibrator/VibrationThread;Landroid/os/CombinedVibration$Mono;)V
    ...
    iget-object v3, p0, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->mVibratorEffects:Landroid/util/SparseArray;

    check-cast v2, Landroid/os/VibrationEffect$Composed;

    invoke-virtual {v3, v1, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v2, p0, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->mVibratorIds:[I
    ...
    iput-wide p1, p0, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->mRequiredSyncCapabilities:J
...
.method constructor <init>(Lcom/android/server/vibrator/VibrationThread;Landroid/os/CombinedVibration$Stereo;)V
    ...
    iget-object p1, p0, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->mVibratorIds:[I

    iget-object p2, p0, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->mVibratorEffects:Landroid/util/SparseArray;
...
.method private calculateRequiredSyncCapabilities(Landroid/util/SparseArray;)J
    ...
    invoke-direct {p0, v1, v2, v9, v10}, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->requireMixedTriggerCapability(JJ)Z
    ...
    :cond_4
    invoke-direct {p0, v1, v2, v7, v8}, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->requireMixedTriggerCapability(JJ)Z
    ...
    :cond_5
    invoke-direct {p0, v1, v2, v5, v6}, Lcom/android/server/vibrator/VibrationThread$DeviceEffectMap;->requireMixedTriggerCapability(JJ)Z
