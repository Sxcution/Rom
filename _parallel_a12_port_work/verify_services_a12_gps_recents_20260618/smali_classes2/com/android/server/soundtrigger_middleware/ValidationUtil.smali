...
.method static validateModel(Landroid/media/soundtrigger_middleware/SoundModel;I)V
    ...
    iget-object p1, p0, Landroid/media/soundtrigger_middleware/SoundModel;->uuid:Ljava/lang/String;

    invoke-static {p1}, Lcom/android/server/soundtrigger_middleware/ValidationUtil;->validateUuid(Ljava/lang/String;)V

    iget-object p1, p0, Landroid/media/soundtrigger_middleware/SoundModel;->vendorUuid:Ljava/lang/String;

    invoke-static {p1}, Lcom/android/server/soundtrigger_middleware/ValidationUtil;->validateUuid(Ljava/lang/String;)V

    iget p1, p0, Landroid/media/soundtrigger_middleware/SoundModel;->dataSize:I

    if-lez p1, :cond_0

    iget-object p0, p0, Landroid/media/soundtrigger_middleware/SoundModel;->data:Landroid/os/ParcelFileDescriptor;
...
.method static validatePhraseModel(Landroid/media/soundtrigger_middleware/PhraseSoundModel;)V
    ...
    iget v3, v2, Landroid/media/soundtrigger_middleware/Phrase;->recognitionModes:I

    and-int/lit8 v3, v3, -0x10

    if-nez v3, :cond_0

    iget-object v3, v2, Landroid/media/soundtrigger_middleware/Phrase;->users:[I

    invoke-static {v3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v3, v2, Landroid/media/soundtrigger_middleware/Phrase;->locale:Ljava/lang/String;

    invoke-static {v3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v2, v2, Landroid/media/soundtrigger_middleware/Phrase;->text:Ljava/lang/String;
...
.method static validateRecognitionConfig(Landroid/media/soundtrigger_middleware/RecognitionConfig;)V
    ...
    iget-object v4, v4, Landroid/media/soundtrigger_middleware/PhraseRecognitionExtra;->levels:[Landroid/media/soundtrigger_middleware/ConfidenceLevel;
    ...
    iget v10, v9, Landroid/media/soundtrigger_middleware/ConfidenceLevel;->levelPercent:I

    if-ltz v10, :cond_0

    iget v9, v9, Landroid/media/soundtrigger_middleware/ConfidenceLevel;->levelPercent:I
    ...
    :cond_4
    iget-object p0, p0, Landroid/media/soundtrigger_middleware/RecognitionConfig;->data:[B
