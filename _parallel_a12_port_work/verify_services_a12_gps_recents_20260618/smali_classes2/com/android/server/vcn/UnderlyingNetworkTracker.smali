...
.method private constructor <init>(Lcom/android/server/vcn/VcnContext;Landroid/os/ParcelUuid;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkTrackerCallback;Lcom/android/server/vcn/UnderlyingNetworkTracker$Dependencies;)V
    ...
    check-cast p1, Lcom/android/server/vcn/VcnContext;

    iput-object p1, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mVcnContext:Lcom/android/server/vcn/VcnContext;

    const-string v1, "Missing subscriptionGroup"

    invoke-static {p2, v1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p2, Landroid/os/ParcelUuid;

    iput-object p2, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mSubscriptionGroup:Landroid/os/ParcelUuid;

    const-string v1, "Missing snapshot"

    invoke-static {p3, v1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p3, Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;

    iput-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mLastSnapshot:Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;

    const-string p3, "Missing cb"

    invoke-static {p4, p3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p4, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkTrackerCallback;

    iput-object p4, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCb:Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkTrackerCallback;

    const-string p3, "Missing deps"

    invoke-static {p5, p3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast p5, Lcom/android/server/vcn/UnderlyingNetworkTracker$Dependencies;

    iput-object p5, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mDeps:Lcom/android/server/vcn/UnderlyingNetworkTracker$Dependencies;
    ...
    iput-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mHandler:Landroid/os/Handler;
    ...
    iput-object p4, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    iget-object p1, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mLastSnapshot:Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;

    invoke-virtual {p1, p2}, Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;->getAllSubIdsInGroup(Landroid/os/ParcelUuid;)Ljava/util/Set;
    ...
    iget-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mVcnContext:Lcom/android/server/vcn/VcnContext;

    invoke-virtual {p3}, Lcom/android/server/vcn/VcnContext;->getContext()Landroid/content/Context;

    move-result-object p3

    const-class p4, Landroid/telephony/CarrierConfigManager;
    ...
    invoke-virtual {p3, p2}, Landroid/telephony/CarrierConfigManager;->getConfigForSubId(I)Landroid/os/PersistableBundle;

    move-result-object p3

    if-eqz p3, :cond_0

    iput-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCarrierConfig:Landroid/os/PersistableBundle;

    iget-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mLastSnapshot:Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;
    ...
    invoke-static {p3, p2}, Lcom/android/server/vcn/UnderlyingNetworkTracker;->isOpportunistic(Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Ljava/util/Set;)Z
...
.method static synthetic access$300(Lcom/android/server/vcn/UnderlyingNetworkTracker;)Landroid/os/ParcelUuid;
    ...
    iget-object p0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mSubscriptionGroup:Landroid/os/ParcelUuid;
...
.method static synthetic access$400(Lcom/android/server/vcn/UnderlyingNetworkTracker;)Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;
    ...
    iget-object p0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mLastSnapshot:Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;
...
.method static synthetic access$500(Lcom/android/server/vcn/UnderlyingNetworkTracker;)Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;
    ...
    iget-object p0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCurrentRecord:Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;
...
.method static synthetic access$600(Lcom/android/server/vcn/UnderlyingNetworkTracker;)Landroid/os/PersistableBundle;
    ...
    iget-object p0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCarrierConfig:Landroid/os/PersistableBundle;
...
.method private reevaluateNetworks()V
    ...
    check-cast v0, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;
    ...
    :cond_2
    iput-object v0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCurrentRecord:Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;

    iget-object v1, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mCb:Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkTrackerCallback;

    invoke-interface {v1, v0}, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkTrackerCallback;->onSelectedUnderlyingNetworkChanged(Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;)V
...
.method private registerOrUpdateNetworkRequests()V
    ...
    iget-object v9, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mHandler:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker;->mConnectivityManager:Landroid/net/ConnectivityManager;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    check-cast v2, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;
