...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/IPackageManager;Lcom/android/server/pm/PackageDexOptimizer;Lcom/android/server/pm/Installer;Ljava/lang/Object;)V
    ...
    new-instance p3, Lcom/android/server/pm/dex/DynamicCodeLogger;

    invoke-direct {p3, p2, p4}, Lcom/android/server/pm/dex/DynamicCodeLogger;-><init>(Landroid/content/pm/IPackageManager;Lcom/android/server/pm/Installer;)V
...
.method private getDexPackage(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)Lcom/android/server/pm/dex/DexManager$DexSearchResult;
    ...
    invoke-static {v2}, Lcom/android/server/pm/dex/DexManager$PackageCodeLocations;->access$200(Lcom/android/server/pm/dex/DexManager$PackageCodeLocations;)Ljava/lang/String;
...
.method private getPackageDexOptimizer(Lcom/android/server/pm/dex/DexoptOptions;)Lcom/android/server/pm/PackageDexOptimizer;
    ...
    invoke-direct {p1, v0}, Lcom/android/server/pm/PackageDexOptimizer$ForcedUpdatePackageDexOptimizer;-><init>(Lcom/android/server/pm/PackageDexOptimizer;)V
...
.method private isSystemServerDexPathSupportedForOdex(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, p1}, Landroid/content/pm/PackagePartitions$SystemPartition;->containsPath(Ljava/lang/String;)Z
...
.method public deleteOptimizedFiles(Lcom/android/server/pm/dex/ArtPackageInfo;)J
    ...
    const-string v7, "Failed deleting oat files for "
...
.method public dexoptSecondaryDex(Lcom/android/server/pm/dex/DexoptOptions;)Z
    ...
    const-string p1, "System server jars should be optimized with dexoptSystemServer"
    ...
    invoke-interface {v9, v3, v1, v10}, Landroid/content/pm/IPackageManager;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
...
.method public dexoptSystemServer(Lcom/android/server/pm/dex/DexoptOptions;)I
    ...
    const-string v3, "Non system server package used when trying to dexopt system server:"
    ...
    const-string p1, "No dex files recorded for system server"
...
.method public getCompilationReasonForInstallScenario(I)I
    ...
    const-string v0, "Invalid installation scenario"
...
.method public getPackageUseInfoOrDefault(Ljava/lang/String;)Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    ...
    invoke-direct {v0, p1}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;-><init>(Ljava/lang/String;)V
