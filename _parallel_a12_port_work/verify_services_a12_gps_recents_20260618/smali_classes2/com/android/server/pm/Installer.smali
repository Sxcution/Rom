...
.method public createAppData(Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;I)J
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/pm/Installer;->createAppData(Landroid/os/CreateAppDataArgs;)Landroid/os/CreateAppDataResult;

    move-result-object p1

    iget p2, p1, Landroid/os/CreateAppDataResult;->exceptionCode:I

    if-nez p2, :cond_0

    iget-wide p1, p1, Landroid/os/CreateAppDataResult;->ceDataInode:J

    return-wide p1

    :cond_0
    new-instance p2, Lcom/android/server/pm/Installer$InstallerException;

    iget-object p1, p1, Landroid/os/CreateAppDataResult;->exceptionMessage:Ljava/lang/String;

    invoke-direct {p2, p1}, Lcom/android/server/pm/Installer$InstallerException;-><init>(Ljava/lang/String;)V
