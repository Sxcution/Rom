...
.method private handlePreRebootVerification_Apex(Lcom/android/server/pm/StagingManager$StagedSession;I)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/pm/StagingManager;->access$1000(Lcom/android/server/pm/StagingManager;Lcom/android/server/pm/StagingManager$StagedSession;I)Ljava/util/List;
    ...
    invoke-static {v2, v3}, Lcom/android/server/pm/StagingManager;->access$1100(Lcom/android/server/pm/StagingManager;Landroid/content/pm/PackageInfo;)V
    :try_end_0
    ...
    invoke-virtual {v0, p2}, Landroid/content/pm/PackageManagerInternal;->pruneCachedApksInApex(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->onPreRebootVerificationFailure(Lcom/android/server/pm/StagingManager$StagedSession;ILjava/lang/String;)V
...
.method private handlePreRebootVerification_End(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    invoke-static {v0}, Lcom/android/server/pm/StagingManager;->access$1200(Lcom/android/server/pm/StagingManager;)Lcom/android/server/pm/ApexManager;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/ApexManager;->markStagedSessionReady(I)V
    :try_end_1
    ...
    invoke-interface {p1, v1, v0}, Lcom/android/server/pm/StagingManager$StagedSession;->setSessionFailed(ILjava/lang/String;)V
...
.method private handlePreRebootVerification_Start(Lcom/android/server/pm/StagingManager$StagedSession;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/pm/StagingManager;->access$900(Lcom/android/server/pm/StagingManager;I)I
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->onPreRebootVerificationFailure(Lcom/android/server/pm/StagingManager$StagedSession;ILjava/lang/String;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_0
    invoke-direct {p0, v1}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->handlePreRebootVerification_End(Lcom/android/server/pm/StagingManager$StagedSession;)V

    goto :goto_0

    :pswitch_1
    invoke-direct {p0, v1}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->handlePreRebootVerification_Apk(Lcom/android/server/pm/StagingManager$StagedSession;)V

    goto :goto_0

    :pswitch_2
    invoke-direct {p0, v1, v0}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->handlePreRebootVerification_Apex(Lcom/android/server/pm/StagingManager$StagedSession;I)V

    goto :goto_0

    :pswitch_3
    invoke-direct {p0, v1}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->handlePreRebootVerification_Start(Lcom/android/server/pm/StagingManager$StagedSession;)V
    :try_end_0
    ...
    const-string v2, "Pre-reboot verification failed due to unhandled exception"
    ...
    const-string v3, "Pre-reboot verification failed due to unhandled exception: "
    ...
    invoke-direct {p0, v1, v0, p1}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->onPreRebootVerificationFailure(Lcom/android/server/pm/StagingManager$StagedSession;ILjava/lang/String;)V
    ...
    :cond_1
    :goto_2
    invoke-direct {p0, v1}, Lcom/android/server/pm/StagingManager$PreRebootVerificationHandler;->onPreRebootVerificationComplete(Lcom/android/server/pm/StagingManager$StagedSession;)V
