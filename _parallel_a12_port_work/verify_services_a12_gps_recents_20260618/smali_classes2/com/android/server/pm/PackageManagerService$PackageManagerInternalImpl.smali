...
.method private getKnownPackageNamesInternal(II)[Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mRecentsPackage:Ljava/lang/String;

    aput-object p2, p1, v0

    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl;->filterOnlySystemPackages([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object p1, p1, Lcom/android/server/pm/PackageManagerService;->mRetailDemoPackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mRetailDemoPackage:Ljava/lang/String;
    ...
    :pswitch_3
    const-string p1, "com.android.companiondevicemanager"
    ...
    invoke-virtual {p2}, Lcom/android/server/pm/PackageManagerService;->getOverlayConfigSignaturePackageName()Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mAppPredictionServicePackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mIncidentReportApproverPackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mConfiguratorPackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mDocumenterPackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mDefaultTextClassifierPackage:Ljava/lang/String;

    aput-object p2, p1, v0

    iget-object p2, p0, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mSystemTextClassifierPackageName:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/pm/PackageManagerService;->access$2200(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/DefaultAppProvider;

    move-result-object v1

    invoke-virtual {v1, p2}, Lcom/android/server/pm/DefaultAppProvider;->getDefaultBrowser(I)Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mRequiredInstallerPackage:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/server/pm/PackageManagerService;->mSetupWizardPackage:Ljava/lang/String;
...
.method public canAccessComponent(ILandroid/content/ComponentName;I)Z
    ...
    invoke-static/range {v3 .. v8}, Lcom/android/server/pm/PackageManagerService;->access$11900(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageSetting;ILandroid/content/ComponentName;II)Z
...
.method public compileLayouts(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/pm/dex/ArtManagerService;->compileLayouts(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Z
...
.method public getCeDataInode(Ljava/lang/String;I)J
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/pm/PackageSetting;->getCeDataInode(I)J
...
.method public getIncrementalStatesInfo(Ljava/lang/String;II)Landroid/content/pm/IncrementalStatesInfo;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/pm/PackageSetting;->getIncrementalStates()Landroid/content/pm/IncrementalStatesInfo;
...
.method public getOverlayPackages(I)Ljava/util/List;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl;->getPackageSetting(Ljava/lang/String;)Lcom/android/server/pm/PackageSetting;

    move-result-object v3

    const/4 v5, 0x0

    invoke-static {v4, v3, v5, p1}, Lcom/android/server/pm/PackageManagerService;->access$10900(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageSetting;II)Landroid/content/pm/PackageInfo;
...
.method public getPackageList(Landroid/content/pm/PackageManagerInternal$PackageListObserver;)Lcom/android/server/pm/PackageList;
    ...
    invoke-direct {v1, v2, p1}, Lcom/android/server/pm/PackageList;-><init>(Ljava/util/List;Landroid/content/pm/PackageManagerInternal$PackageListObserver;)V

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl;->this$0:Lcom/android/server/pm/PackageManagerService;

    invoke-static {p1}, Lcom/android/server/pm/PackageManagerService;->access$9600(Lcom/android/server/pm/PackageManagerService;)Landroid/util/ArraySet;
...
.method public getSuspendedDialogInfo(Ljava/lang/String;Ljava/lang/String;I)Landroid/content/pm/SuspendDialogInfo;
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/pm/PackageSetting;->readUserState(I)Landroid/content/pm/PackageUserState;

    move-result-object p1

    iget-boolean p3, p1, Landroid/content/pm/PackageUserState;->suspended:Z

    if-eqz p3, :cond_1

    iget-object p1, p1, Landroid/content/pm/PackageUserState;->suspendParams:Landroid/util/ArrayMap;
    ...
    iget-object v1, p1, Landroid/content/pm/PackageUserState$SuspendParams;->dialogInfo:Landroid/content/pm/SuspendDialogInfo;
...
.method public getSuspendedPackageLauncherExtras(Ljava/lang/String;I)Landroid/os/Bundle;
    ...
    iget-boolean p2, p1, Landroid/content/pm/PackageUserState;->suspended:Z
    ...
    iget-object v3, v2, Landroid/content/pm/PackageUserState$SuspendParams;->launcherExtras:Landroid/os/PersistableBundle;

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroid/content/pm/PackageUserState$SuspendParams;->launcherExtras:Landroid/os/PersistableBundle;
...
.method public grantImplicitAccess(ILandroid/content/Intent;IIZ)V
    ...
    invoke-static {v3, v1, p1, p4}, Lcom/android/server/pm/PackageManagerService;->access$10700(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;II)Z
    ...
    invoke-static {p5}, Lcom/android/server/pm/PackageManagerService;->access$1500(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/InstantAppRegistry;
    ...
    invoke-virtual {p5, p1, p2, p3, p4}, Lcom/android/server/pm/InstantAppRegistry;->grantInstantAccessLPw(ILandroid/content/Intent;II)Z
    ...
    invoke-virtual {p1, v2, p4}, Lcom/android/server/pm/AppsFilter;->grantImplicitAccess(II)Z
...
.method public isCallerInstallerOfRecord(Lcom/android/server/pm/parsing/pkg/AndroidPackage;I)Z
    ...
    iget-object p1, p1, Lcom/android/server/pm/PackageSetting;->installSource:Lcom/android/server/pm/InstallSource;
...
.method public isPackagePersistent(Ljava/lang/String;)Z
    ...
    invoke-interface {p1}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->isPersistent()Z
...
.method public isPlatformSigned(Ljava/lang/String;)Z
    ...
    iget-object v2, v2, Lcom/android/server/pm/PackageManagerService;->mPlatformPackage:Lcom/android/server/pm/parsing/pkg/AndroidPackage;
    ...
    iget-object v1, v1, Lcom/android/server/pm/PackageManagerService;->mPlatformPackage:Lcom/android/server/pm/parsing/pkg/AndroidPackage;
...
.method public pruneCachedApksInApex(Ljava/util/List;)V
    ...
    invoke-static {v5}, Lcom/android/server/pm/PackageManagerService;->access$2100(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/ApexManager;
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/pm/ApexManager;->getApksInApex(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v8}, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl;->getPackage(Ljava/lang/String;)Lcom/android/server/pm/parsing/pkg/AndroidPackage;

    move-result-object v8

    new-instance v9, Ljava/io/File;

    invoke-interface {v8}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getPath()Ljava/lang/String;

    move-result-object v8

    invoke-direct {v9, v8}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v9}, Lcom/android/server/pm/parsing/PackageCacher;->cleanCachedResult(Ljava/io/File;)V
...
.method public registerInstalledLoadingProgressCallback(Ljava/lang/String;Landroid/content/pm/PackageManagerInternal$InstalledLoadingProgressCallback;I)Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/pm/PackageSetting;->isPackageLoading()Z
    ...
    const-string p1, "Failed registering loading progress callback. Package is fully loaded."
    ...
    const-string p1, "Failed registering loading progress callback. Incremental is not enabled"
    ...
    invoke-static {p3}, Lcom/android/server/pm/PackageManagerService;->access$7000(Lcom/android/server/pm/PackageManagerService;)Landroid/os/incremental/IncrementalManager;
    ...
    invoke-virtual {p3, p1, p2}, Landroid/os/incremental/IncrementalManager;->registerLoadingProgressCallback(Ljava/lang/String;Landroid/content/pm/IPackageLoadingProgressCallback;)Z
...
.method public removeNonSystemPackageSuspensions(Ljava/lang/String;I)V
    ...
    sget-object p1, Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/pm/PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda2;

    invoke-virtual {v0, v1, p1, p2}, Lcom/android/server/pm/PackageManagerService;->removeSuspensionsBySuspendingPackage([Ljava/lang/String;Ljava/util/function/Predicate;I)V
...
.method public requestChecksums(Ljava/lang/String;ZIILjava/util/List;Landroid/content/pm/IOnChecksumsReadyListener;ILjava/util/concurrent/Executor;Landroid/os/Handler;)V
    ...
    invoke-static/range {v0 .. v9}, Lcom/android/server/pm/PackageManagerService;->access$12700(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ZIILjava/util/List;Landroid/content/pm/IOnChecksumsReadyListener;ILjava/util/concurrent/Executor;Landroid/os/Handler;)V
...
.method public requestInstantAppResolutionPhaseTwo(Landroid/content/pm/AuxiliaryResolveInfo;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLandroid/os/Bundle;I)V
    ...
    invoke-static/range {v0 .. v8}, Lcom/android/server/pm/PackageManagerService;->access$10600(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/AuxiliaryResolveInfo;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLandroid/os/Bundle;I)V
...
.method public setEnabledOverlayPackages(ILjava/lang/String;Landroid/content/pm/overlay/OverlayPaths;Ljava/util/Set;)Z
    ...
    :cond_0
    invoke-interface {v1}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getLibraryNames()Ljava/util/List;
    ...
    invoke-static {v6, v5, v7, v8}, Lcom/android/server/pm/PackageManagerService;->access$11000(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;J)Landroid/content/pm/SharedLibraryInfo;
    ...
    invoke-static {v7, v6, v2, v8, p1}, Lcom/android/server/pm/PackageManagerService;->access$11100(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/SharedLibraryInfo;III)Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v8, v5, p3, p1}, Lcom/android/server/pm/PackageSetting;->setOverlayPathsForLibrary(Ljava/lang/String;Landroid/content/pm/overlay/OverlayPaths;I)Z
    ...
    invoke-virtual {v1, p3, p1}, Lcom/android/server/pm/PackageSetting;->setOverlayPaths(Landroid/content/pm/overlay/OverlayPaths;I)Z
    ...
    const-string p4, "failed to find package "
...
.method public setVisibilityLogging(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/AppsFilter;->getFeatureConfig()Lcom/android/server/pm/AppsFilter$FeatureConfig;

    move-result-object p1

    iget v0, v1, Lcom/android/server/pm/PackageSetting;->appId:I

    invoke-interface {p1, v0, p2}, Lcom/android/server/pm/AppsFilter$FeatureConfig;->enableLogging(IZ)V
...
.method public uninstallApex(Ljava/lang/String;JILandroid/content/IntentSender;I)V
    ...
    invoke-static {p4}, Lcom/android/server/pm/PackageManagerService;->access$2100(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/ApexManager;

    move-result-object p4

    const/4 p6, 0x1

    invoke-virtual {p4, p1, p6}, Lcom/android/server/pm/ApexManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    const-string p6, " is not equal to "
    ...
    invoke-virtual {v6, p1, p6, p2}, Lcom/android/server/pm/PackageInstallerService$PackageDeleteObserverAdapter;->onPackageDeleted(Ljava/lang/String;ILjava/lang/String;)V
...
.method public writeSettings(Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/PackageManagerService;->scheduleWriteSettingsLocked()V
