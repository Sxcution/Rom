...
.method public onSessionActiveChanged(Lcom/android/server/pm/PackageInstallerSession;Z)V
    ...
    invoke-static {v0, v1, p1, p2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$500(Lcom/android/server/pm/PackageInstallerService$Callbacks;IIZ)V
...
.method public onSessionBadgingChanged(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$300(Lcom/android/server/pm/PackageInstallerService$Callbacks;II)V

    iget-object p1, p0, Lcom/android/server/pm/PackageInstallerService$InternalCallback;->this$0:Lcom/android/server/pm/PackageInstallerService;

    invoke-static {p1}, Lcom/android/server/pm/PackageInstallerService;->access$400(Lcom/android/server/pm/PackageInstallerService;)Lcom/android/server/pm/utils/RequestThrottle;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/server/pm/utils/RequestThrottle;->schedule()V
...
.method public onSessionProgressChanged(Lcom/android/server/pm/PackageInstallerSession;F)V
    ...
    invoke-static {v0, v1, p1, p2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$600(Lcom/android/server/pm/PackageInstallerService$Callbacks;IIF)V
...
.method public onSessionSealedBlocking(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/utils/RequestThrottle;->runNow()Z
...
.method public onStagedSessionChanged(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/pm/PackageManagerService;->sendSessionUpdatedBroadcast(Landroid/content/pm/PackageInstaller$SessionInfo;I)V
