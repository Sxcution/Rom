...
.method private prepareUserDataLI(Ljava/lang/String;IIIZ)V
    ...
    iget-object p1, p0, Lcom/android/server/pm/UserDataPreparer;->mContext:Landroid/content/Context;

    const-string p2, "prepareUserData failed for system user"

    invoke-static {p1, p2}, Landroid/os/RecoverySystem;->rebootPromptAndWipeUserData(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_1
    ...
    const-string p3, "error rebooting into recovery"
