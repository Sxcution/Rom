...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mIPackageManager:Landroid/content/pm/IPackageManager;
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mUserManagerInternal:Lcom/android/server/pm/UserManagerInternal;
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mUsageStatsManagerInternal:Landroid/app/usage/UsageStatsManagerInternal;
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    check-cast v6, Landroid/app/IUriGrantsManager;

    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mUriGrantsManager:Landroid/app/IUriGrantsManager;
    ...
    check-cast v6, Lcom/android/server/uri/UriGrantsManagerInternal;

    invoke-static {v6}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    check-cast v6, Lcom/android/server/uri/UriGrantsManagerInternal;

    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mUriGrantsManagerInternal:Lcom/android/server/uri/UriGrantsManagerInternal;

    const-string v8, "ShortcutService"

    invoke-interface {v6, v8}, Lcom/android/server/uri/UriGrantsManagerInternal;->newUriPermissionOwner(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v6

    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mUriPermissionOwner:Landroid/os/IBinder;

    const-class v6, Landroid/app/role/RoleManager;

    invoke-virtual {v14, v6}, Landroid/content/Context;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mRoleManager:Landroid/app/role/RoleManager;

    new-instance v6, Lcom/android/server/pm/ShortcutRequestPinProcessor;

    invoke-direct {v6, v0, v1}, Lcom/android/server/pm/ShortcutRequestPinProcessor;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/lang/Object;)V

    iput-object v6, v0, Lcom/android/server/pm/ShortcutService;->mShortcutRequestPinProcessor:Lcom/android/server/pm/ShortcutRequestPinProcessor;
    ...
    const-string v6, "shortcut_appsearch_integration"

    invoke-static {v1, v6, v2}, Landroid/provider/DeviceConfig;->getBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v9, v1}, Landroid/content/IntentFilter;->setPriority(I)V
    ...
    invoke-virtual {v0, v4, v1}, Lcom/android/server/pm/ShortcutService;->injectRegisterUidObserver(Landroid/app/IUidObserver;I)V
...
.method private createQuery(ZZZZ)Ljava/lang/String;
    ...
    const-string p1, "(flags:CaN OR flags:CaB OR flags:CaPT)"
...
.method private fixUpIncomingShortcutInfo(Landroid/content/pm/ShortcutInfo;ZZ)V
    ...
    invoke-virtual {p1, p2}, Landroid/content/pm/ShortcutInfo;->replaceFlags(I)V
...
.method private getShortcutsWithQueryLocked(Ljava/lang/String;IILjava/lang/String;Ljava/util/function/Predicate;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-virtual {p1, v0, p4, p5, p3}, Lcom/android/server/pm/ShortcutPackage;->findAll(Ljava/util/List;Ljava/lang/String;Ljava/util/function/Predicate;I)V
...
.method private notifyShortcutChangeCallbacks(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
    ...
    new-instance p3, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda7;
...
.method private prepareChangedShortcuts(Landroid/util/ArraySet;Landroid/util/ArraySet;Ljava/util/List;Lcom/android/server/pm/ShortcutPackage;)Ljava/util/List;
    ...
    new-instance p1, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda37;

    invoke-direct {p1, v0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda37;-><init>(Landroid/util/ArraySet;)V
    ...
    new-instance p2, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda38;

    invoke-direct {p2, v0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda38;-><init>(Landroid/util/ArraySet;)V

    const/4 p3, 0x4

    invoke-virtual {p4, p1, v0, p2, p3}, Lcom/android/server/pm/ShortcutPackage;->findAllByIds(Ljava/util/List;Ljava/util/Collection;Ljava/util/function/Predicate;I)V
...
.method private prepareChangedShortcuts(Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/android/server/pm/ShortcutPackage;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/ShortcutService;->addShortcutIdsToSet(Landroid/util/ArraySet;Ljava/util/List;)V

    invoke-direct {p0, v0, p1, p3, p4}, Lcom/android/server/pm/ShortcutService;->prepareChangedShortcuts(Landroid/util/ArraySet;Landroid/util/ArraySet;Ljava/util/List;Lcom/android/server/pm/ShortcutPackage;)Ljava/util/List;
...
.method private requestPinItem(Ljava/lang/String;ILandroid/content/pm/ShortcutInfo;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;Landroid/content/IntentSender;II)Z
    ...
    invoke-virtual {p8, v0}, Lcom/android/server/pm/ShortcutPackage;->isShortcutExistsAndInvisibleToPublisher(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p8, p3}, Lcom/android/server/pm/ShortcutPackage;->updateInvisibleShortcutForPinRequestWith(Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-virtual {p0, p7, p2, p8, v0}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method private saveUserInternalLocked(ILjava/io/OutputStream;Z)V
    ...
    invoke-virtual {p1, v0, p3}, Lcom/android/server/pm/ShortcutUser;->saveToXml(Landroid/util/TypedXmlSerializer;Z)V
...
.method private verifyCaller(Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)Z
    ...
    invoke-virtual {p3, p1}, Lcom/android/internal/infra/AndroidFuture;->completeExceptionally(Ljava/lang/Throwable;)Z
...
.method public addDynamicShortcuts(Ljava/lang/String;Landroid/content/pm/ParceledListSlice;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct {p0, p1, p3, v7}, Lcom/android/server/pm/ShortcutService;->verifyCaller(Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)Z
    ...
    new-instance v8, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda9;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda9;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V

    invoke-virtual {p0, v8}, Lcom/android/server/pm/ShortcutService;->injectPostToHandlerIfAppSearch(Ljava/lang/Runnable;)V
...
.method cleanUpPackageLocked(Ljava/lang/String;IIZ)V
    ...
    new-instance v4, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda27;

    invoke-direct {v4, p1, p3}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda27;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v1, v4}, Lcom/android/server/pm/ShortcutUser;->forAllLaunchers(Ljava/util/function/Consumer;)V

    sget-object v4, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda30;->INSTANCE:Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda30;
...
.method public createShortcutResultIntent(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct {p0, p1, p3, v6}, Lcom/android/server/pm/ShortcutService;->verifyCaller(Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda12;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ShortcutInfo;Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)V
...
.method public disableShortcuts(Ljava/lang/String;Ljava/util/List;Ljava/lang/CharSequence;II)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct {p0, p1, p5, v8}, Lcom/android/server/pm/ShortcutService;->verifyCaller(Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda19;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/util/List;ILjava/lang/String;Ljava/lang/CharSequence;ILcom/android/internal/infra/AndroidFuture;)V
...
.method public enableShortcuts(Ljava/lang/String;Ljava/util/List;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda16;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
...
.method public getShareTargets(Ljava/lang/String;Landroid/content/IntentFilter;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/pm/ShortcutService;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    nop

    new-instance p1, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda2;

    invoke-direct {p1, p0, p3, p2, v0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/pm/ShortcutService;ILandroid/content/IntentFilter;Lcom/android/internal/infra/AndroidFuture;)V

    invoke-virtual {p0, p1}, Lcom/android/server/pm/ShortcutService;->injectPostToHandlerIfAppSearch(Ljava/lang/Runnable;)V
...
.method public getShortcuts(Ljava/lang/String;II)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/pm/ShortcutService;IILcom/android/internal/infra/AndroidFuture;Ljava/lang/String;)V
...
.method handleOnDefaultLauncherChanged(I)V
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/pm/ShortcutUser;->setCachedLauncher(Ljava/lang/String;)V
...
.method injectSendIntentSender(Landroid/content/IntentSender;Landroid/content/Intent;)V
    ...
    const-string v0, "sendIntent failed()."
...
.method injectUserDataPath(I)Ljava/io/File;
    ...
    const-string v1, "shortcut_service"
...
.method public isSharingShortcut(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/content/IntentFilter;)Z
    ...
    invoke-direct {p0, p2, v0}, Lcom/android/server/pm/ShortcutService;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p6}, Lcom/android/server/pm/ShortcutPackage;->getMatchingShareTargets(Landroid/content/IntentFilter;)Ljava/util/List;
    ...
    invoke-virtual {v0}, Landroid/content/pm/ShortcutManager$ShareShortcutInfo;->getShortcutInfo()Landroid/content/pm/ShortcutInfo;
...
.method public synthetic lambda$addDynamicShortcuts$8$ShortcutService(Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/pm/ShortcutService;->verifyShortcutInfoPackages(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v2, p1, v3}, Lcom/android/server/pm/ShortcutPackage;->ensureImmutableShortcutsNotIncluded(Ljava/util/List;Z)V

    invoke-virtual {v2, p1}, Lcom/android/server/pm/ShortcutPackage;->ensureNoBitmapIconIfShortcutIsLongLived(Ljava/util/List;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/ShortcutService;->fillInDefaultActivity(Ljava/util/List;)V

    invoke-virtual {v2, p1, v3}, Lcom/android/server/pm/ShortcutPackage;->enforceShortcutCountsBeforeOperation(Ljava/util/List;I)V

    invoke-virtual {v2}, Lcom/android/server/pm/ShortcutPackage;->clearAllImplicitRanks()V

    invoke-direct {p0, p1}, Lcom/android/server/pm/ShortcutService;->assignImplicitRanks(Ljava/util/List;)V

    invoke-virtual {v2, p4}, Lcom/android/server/pm/ShortcutPackage;->tryApiCall(Z)Z
    ...
    invoke-virtual {p5, p1}, Lcom/android/internal/infra/AndroidFuture;->complete(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v7, v4}, Lcom/android/server/pm/ShortcutService;->fixUpIncomingShortcutInfo(Landroid/content/pm/ShortcutInfo;Z)V

    invoke-virtual {v7}, Landroid/content/pm/ShortcutInfo;->setRankChanged()V

    invoke-virtual {v2, v7}, Lcom/android/server/pm/ShortcutPackage;->addOrReplaceDynamicShortcut(Landroid/content/pm/ShortcutInfo;)Z
    ...
    :try_start_2
    invoke-virtual {p0, p2, p3, v6, p4}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {p5, p1}, Lcom/android/internal/infra/AndroidFuture;->completeExceptionally(Ljava/lang/Throwable;)Z
...
.method public synthetic lambda$applyRestore$36$ShortcutService(ILcom/android/internal/infra/AndroidFuture;[B)V
    ...
    :try_start_2
    invoke-direct {p0, p1, v1, p3}, Lcom/android/server/pm/ShortcutService;->loadUserInternal(ILjava/io/InputStream;Z)Lcom/android/server/pm/ShortcutUser;
    ...
    const-string v3, "restore-2.txt"

    new-instance v4, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda22;

    invoke-direct {v4, p0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda22;-><init>(Lcom/android/server/pm/ShortcutService;)V
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/pm/ShortcutUser;->mergeRestoredFile(Lcom/android/server/pm/ShortcutUser;)V

    iget-object p3, p0, Lcom/android/server/pm/ShortcutService;->mShortcutDumpFiles:Lcom/android/server/pm/ShortcutDumpFiles;

    const-string v1, "restore-3.txt"

    new-instance v3, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda22;

    invoke-direct {v3, p0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda22;-><init>(Lcom/android/server/pm/ShortcutService;)V

    invoke-virtual {p3, v1, v3}, Lcom/android/server/pm/ShortcutDumpFiles;->save(Ljava/lang/String;Ljava/util/function/Consumer;)Z

    const-wide/16 v3, 0x0

    invoke-direct {p0, p1, v3, v4}, Lcom/android/server/pm/ShortcutService;->rescanUpdatedPackagesLocked(IJ)V
    ...
    invoke-direct {v3, p0}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda21;-><init>(Lcom/android/server/pm/ShortcutService;)V
    ...
    invoke-static {p3, v1, p1}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public synthetic lambda$createShortcutResultIntent$11$ShortcutService(Landroid/content/pm/ShortcutInfo;Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-virtual {v0, p1, p3}, Lcom/android/server/pm/ShortcutRequestPinProcessor;->createShortcutResultIntent(Landroid/content/pm/ShortcutInfo;I)Landroid/content/Intent;
    ...
    invoke-virtual {p4, p1}, Lcom/android/internal/infra/AndroidFuture;->completeExceptionally(Ljava/lang/Throwable;)Z
...
.method public synthetic lambda$disableShortcuts$12$ShortcutService(Ljava/util/List;ILjava/lang/String;Ljava/lang/CharSequence;ILcom/android/internal/infra/AndroidFuture;)V
    ...
    :try_start_0
    const-string v5, "shortcutIds must be provided"
    ...
    iget-object v5, v0, Lcom/android/server/pm/ShortcutService;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v3, v2}, Lcom/android/server/pm/ShortcutService;->getPackageShortcutsForPublisherLocked(Ljava/lang/String;I)Lcom/android/server/pm/ShortcutPackage;

    move-result-object v13

    const/4 v14, 0x1

    invoke-virtual {v13, v1, v14}, Lcom/android/server/pm/ShortcutPackage;->ensureImmutableShortcutsNotIncludedWithIds(Ljava/util/List;Z)V
    ...
    invoke-virtual {v13, v9}, Lcom/android/server/pm/ShortcutPackage;->isShortcutExistsAndVisibleToPublisher(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v6 .. v12}, Lcom/android/server/pm/ShortcutPackage;->disableWithId(Ljava/lang/String;Ljava/lang/String;IZZI)Landroid/content/pm/ShortcutInfo;
    ...
    :goto_2
    invoke-virtual {v13, v15}, Lcom/android/server/pm/ShortcutPackage;->findShortcutById(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    :try_start_2
    invoke-virtual {v0, v3, v2, v14, v15}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method public synthetic lambda$enableShortcuts$13$ShortcutService(Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/pm/ShortcutPackage;->ensureImmutableShortcutsNotIncludedWithIds(Ljava/util/List;Z)V
    ...
    invoke-virtual {v1, v6}, Lcom/android/server/pm/ShortcutPackage;->isShortcutExistsAndVisibleToPublisher(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {v1, v6}, Lcom/android/server/pm/ShortcutPackage;->enableWithId(Ljava/lang/String;)V
    ...
    :cond_1
    invoke-virtual {v1, v6}, Lcom/android/server/pm/ShortcutPackage;->findShortcutById(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    :try_start_2
    invoke-virtual {p0, p3, p2, v5, v4}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V

    invoke-virtual {p0}, Lcom/android/server/pm/ShortcutService;->verifyStates()V

    invoke-virtual {p4, v4}, Lcom/android/internal/infra/AndroidFuture;->complete(Ljava/lang/Object;)Z
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
...
.method public synthetic lambda$getShareTargets$21$ShortcutService(ILandroid/content/IntentFilter;Lcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-direct {v2, v1, p2}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda28;-><init>(Ljava/util/List;Landroid/content/IntentFilter;)V

    invoke-virtual {p1, v2}, Lcom/android/server/pm/ShortcutUser;->forAllPackages(Ljava/util/function/Consumer;)V

    new-instance p1, Landroid/content/pm/ParceledListSlice;

    invoke-direct {p1, v1}, Landroid/content/pm/ParceledListSlice;-><init>(Ljava/util/List;)V

    invoke-virtual {p3, p1}, Lcom/android/internal/infra/AndroidFuture;->complete(Ljava/lang/Object;)Z
...
.method public synthetic lambda$getShortcuts$19$ShortcutService(IILcom/android/internal/infra/AndroidFuture;Ljava/lang/String;)V
    ...
    const-string v6, "(disabledReason:0 OR disabledReason:1 OR disabledReason:2 OR disabledReason:3) "

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-direct {p0, v1, v4, v5, v2}, Lcom/android/server/pm/ShortcutService;->createQuery(ZZZZ)Ljava/lang/String;
    ...
    new-instance v9, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda36;

    invoke-direct {v9, p2}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda36;-><init>(I)V
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/pm/ShortcutService;->getShortcutsWithQueryLocked(Ljava/lang/String;IILjava/lang/String;Ljava/util/function/Predicate;)Landroid/content/pm/ParceledListSlice;
...
.method public synthetic lambda$notifyShortcutChangeCallbacks$3$ShortcutService(ILjava/util/List;Ljava/lang/String;Landroid/os/UserHandle;Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/android/server/pm/ShortcutService;->mShortcutChangeCallbacks:Ljava/util/ArrayList;
    ...
    check-cast v1, Landroid/content/pm/LauncherApps$ShortcutChangeCallback;

    invoke-interface {v1, p3, p2, p4}, Landroid/content/pm/LauncherApps$ShortcutChangeCallback;->onShortcutsAddedOrUpdated(Ljava/lang/String;Ljava/util/List;Landroid/os/UserHandle;)V
    ...
    invoke-interface {v1, p3, p5, p4}, Landroid/content/pm/LauncherApps$ShortcutChangeCallback;->onShortcutsRemoved(Ljava/lang/String;Ljava/util/List;Landroid/os/UserHandle;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
...
.method public synthetic lambda$onApplicationActive$23$ShortcutService(ILcom/android/internal/infra/AndroidFuture;Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/android/server/pm/ShortcutPackage;->resetRateLimitingForCommandLineNoSaving()V
...
.method public synthetic lambda$pushDynamicShortcut$9$ShortcutService(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;ILcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/pm/ShortcutService;->fillInDefaultActivity(Ljava/util/List;)V
    ...
    invoke-direct {p0, p2, v4}, Lcom/android/server/pm/ShortcutService;->fixUpIncomingShortcutInfo(Landroid/content/pm/ShortcutInfo;Z)V
    ...
    invoke-virtual {p4, v5}, Lcom/android/internal/infra/AndroidFuture;->complete(Ljava/lang/Object;)Z
    ...
    :try_start_2
    invoke-virtual {p0, p1, p3, v0, v3}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V

    invoke-virtual {p2}, Landroid/content/pm/ShortcutInfo;->getId()Ljava/lang/String;

    move-result-object p2

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/pm/ShortcutService;->reportShortcutUsedInternal(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public synthetic lambda$queryActivities$30$ShortcutService(ILandroid/content/pm/ResolveInfo;)Z
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/pm/ShortcutService;->isEnabled(Landroid/content/pm/ActivityInfo;I)Z
...
.method public synthetic lambda$removeAllDynamicShortcuts$16$ShortcutService(ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
    ...
    const-string v3, "((disabledReason:0 OR disabledReason:1 OR disabledReason:2 OR disabledReason:3) flags:Dyn ((flags:CaN OR flags:CaB OR flags:CaPT) OR flags:Pin))"

    sget-object v4, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda41;->INSTANCE:Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda41;

    const/4 v5, 0x4

    invoke-virtual {v2, v0, v3, v4, v5}, Lcom/android/server/pm/ShortcutPackage;->findAll(Ljava/util/List;Ljava/lang/String;Ljava/util/function/Predicate;I)V

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/android/server/pm/ShortcutPackage;->deleteAllDynamicShortcuts(Z)Ljava/util/List;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v0, v4, v3, v2}, Lcom/android/server/pm/ShortcutService;->prepareChangedShortcuts(Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/android/server/pm/ShortcutPackage;)Ljava/util/List;
    ...
    :try_start_2
    invoke-virtual {p0, p2, p1, v0, v3}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method public synthetic lambda$removeDynamicShortcuts$14$ShortcutService(Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-static {v7}, Lcom/android/internal/util/Preconditions;->checkStringNotEmpty(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v7

    check-cast v7, Ljava/lang/String;

    invoke-virtual {v1, v7}, Lcom/android/server/pm/ShortcutPackage;->isShortcutExistsAndVisibleToPublisher(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {v1, v7, v2}, Lcom/android/server/pm/ShortcutPackage;->deleteDynamicWithId(Ljava/lang/String;Z)Landroid/content/pm/ShortcutInfo;
    ...
    :cond_1
    invoke-virtual {v1, v7}, Lcom/android/server/pm/ShortcutPackage;->findShortcutById(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    :try_start_2
    invoke-virtual {p0, p3, p2, v5, v6}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method public synthetic lambda$removeLongLivedShortcuts$17$ShortcutService(Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
    ...
    :cond_0
    invoke-virtual {v1, v7, v2}, Lcom/android/server/pm/ShortcutPackage;->deleteLongLivedWithId(Ljava/lang/String;Z)Landroid/content/pm/ShortcutInfo;
...
.method public synthetic lambda$reportShortcutUsed$22$ShortcutService(Ljava/lang/String;Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)V
    ...
    const-string v1, "reportShortcutUsed: package %s doesn\'t have shortcut %s"
...
.method public synthetic lambda$setDynamicShortcuts$5$ShortcutService(Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-virtual {v2, p1, v4}, Lcom/android/server/pm/ShortcutPackage;->enforceShortcutCountsBeforeOperation(Ljava/util/List;I)V
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/server/pm/ShortcutService;->fixUpIncomingShortcutInfo(Landroid/content/pm/ShortcutInfo;Z)V
    ...
    const-string v5, "((disabledReason:0 OR disabledReason:1 OR disabledReason:2 OR disabledReason:3) flags:Dyn ((flags:CaN OR flags:CaB OR flags:CaPT) OR flags:Pin))"

    sget-object v6, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda42;->INSTANCE:Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda42;

    const/4 v7, 0x4

    invoke-virtual {v2, p4, v5, v6, v7}, Lcom/android/server/pm/ShortcutPackage;->findAll(Ljava/util/List;Ljava/lang/String;Ljava/util/function/Predicate;I)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/server/pm/ShortcutPackage;->addOrReplaceDynamicShortcut(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-direct {p0, p4, p1, v5, v2}, Lcom/android/server/pm/ShortcutService;->prepareChangedShortcuts(Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/android/server/pm/ShortcutPackage;)Ljava/util/List;
    ...
    :try_start_2
    invoke-virtual {p0, p2, p3, p1, v5}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method public synthetic lambda$updateShortcuts$7$ShortcutService(Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-virtual {v4, p1, v2}, Lcom/android/server/pm/ShortcutPackage;->ensureImmutableShortcutsNotIncluded(Ljava/util/List;Z)V

    invoke-virtual {v4, p1}, Lcom/android/server/pm/ShortcutPackage;->ensureNoBitmapIconIfShortcutIsLongLived(Ljava/util/List;)V

    const/4 v5, 0x2

    invoke-virtual {v4, p1, v5}, Lcom/android/server/pm/ShortcutPackage;->enforceShortcutCountsBeforeOperation(Ljava/util/List;I)V
    ...
    invoke-direct {p0, v6, v2}, Lcom/android/server/pm/ShortcutService;->fixUpIncomingShortcutInfo(Landroid/content/pm/ShortcutInfo;Z)V

    invoke-virtual {v6}, Landroid/content/pm/ShortcutInfo;->getId()Ljava/lang/String;

    move-result-object v7

    new-instance v8, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda23;

    invoke-direct {v8, p0, v6, v1}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda23;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ShortcutInfo;Ljava/util/List;)V

    invoke-virtual {v4, v7, p4, v8}, Lcom/android/server/pm/ShortcutPackage;->mutateShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Ljava/util/function/Consumer;)V
    ...
    :cond_2
    invoke-virtual {p0, p2, p3, v1, p4}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V
...
.method public pushDynamicShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda14;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;Landroid/content/pm/ShortcutInfo;ILcom/android/internal/infra/AndroidFuture;)V
...
.method queryActivities(Landroid/content/Intent;IZ)Ljava/util/List;
    ...
    new-instance v0, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda39;

    invoke-direct {v0, p0, p2}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda39;-><init>(Lcom/android/server/pm/ShortcutService;I)V
...
.method public removeDynamicShortcuts(Ljava/lang/String;Ljava/util/List;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda17;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
...
.method public removeLongLivedShortcuts(Ljava/lang/String;Ljava/util/List;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda18;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/util/List;ILjava/lang/String;Lcom/android/internal/infra/AndroidFuture;)V
...
.method public reportShortcutUsed(Ljava/lang/String;Ljava/lang/String;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda15;-><init>(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;Ljava/lang/String;ILcom/android/internal/infra/AndroidFuture;)V
...
.method public requestPinShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    new-instance v10, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda13;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda13;-><init>(Lcom/android/server/pm/ShortcutService;Lcom/android/internal/infra/AndroidFuture;Ljava/lang/String;ILandroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;II)V

    invoke-virtual {p0, v10}, Lcom/android/server/pm/ShortcutService;->injectPostToHandlerIfAppSearch(Ljava/lang/Runnable;)V
...
.method saveIconAndFixUpShortcutLocked(Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-virtual {p1, v2}, Landroid/content/pm/ShortcutInfo;->setIconUri(Ljava/lang/String;)V
...
.method public setDynamicShortcuts(Ljava/lang/String;Landroid/content/pm/ParceledListSlice;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    new-instance v8, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda10;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V
...
.method updatePackageShortcutForTest(Ljava/lang/String;Ljava/lang/String;ILjava/util/function/Consumer;)V
    ...
    invoke-virtual {p1, p2, p3, p4}, Lcom/android/server/pm/ShortcutPackage;->mutateShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Ljava/util/function/Consumer;)V
...
.method public updateShortcuts(Ljava/lang/String;Landroid/content/pm/ParceledListSlice;I)Lcom/android/internal/infra/AndroidFuture;
    ...
    new-instance v8, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda11;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/ShortcutService$$ExternalSyntheticLambda11;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ParceledListSlice;Ljava/lang/String;IZLcom/android/internal/infra/AndroidFuture;)V
