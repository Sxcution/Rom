...
.method constructor <init>(Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;)V
    ...
    iget p1, p1, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->mFlags:I

    iput p1, p0, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->mFlags:I
...
.method addService(Landroid/content/pm/parsing/component/ParsedService;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->addFilter(Landroid/util/Pair;)V
...
.method protected allowFilterResult(Landroid/util/Pair;Ljava/util/List;)Z
    ...
    invoke-virtual {v3}, Landroid/content/pm/parsing/component/ParsedService;->getPackageName()Ljava/lang/String;
...
.method protected dumpFilter(Ljava/io/PrintWriter;Ljava/lang/String;Landroid/util/Pair;)V
    ...
    invoke-static {p1, p2, v1}, Landroid/content/ComponentName;->printShortString(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected dumpFilterLabel(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/Object;I)V
    ...
    check-cast p2, Landroid/content/pm/parsing/component/ParsedService;

    invoke-virtual {p2}, Landroid/content/pm/parsing/component/ParsedService;->getPackageName()Ljava/lang/String;

    move-result-object p2

    iget-object p3, p3, Landroid/util/Pair;->first:Ljava/lang/Object;

    check-cast p3, Landroid/content/pm/parsing/component/ParsedService;

    invoke-virtual {p3}, Landroid/content/pm/parsing/component/ParsedService;->getClassName()Ljava/lang/String;
...
.method protected newResult(Landroid/util/Pair;II)Landroid/content/pm/ResolveInfo;
    ...
    :cond_4
    iget v2, p0, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->mFlags:I
    ...
    iput-object p3, v0, Landroid/content/pm/ResolveInfo;->serviceInfo:Landroid/content/pm/ServiceInfo;
...
.method queryIntentForPackage(Landroid/content/Intent;Ljava/lang/String;ILjava/util/List;I)Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->newArray(I)[Landroid/util/Pair;
...
.method removeService(Landroid/content/pm/parsing/component/ParsedService;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;->removeFilter(Ljava/lang/Object;)V
