...
.method private readUserState(Lcom/android/server/pm/SettingsXml$ReadSection;Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;)V
    ...
    invoke-virtual {p2, v0, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->addUserState(II)V
...
.method private readUserStates(Lcom/android/server/pm/SettingsXml$ReadSection;)V
    ...
    invoke-interface {p1}, Lcom/android/server/pm/SettingsXml$ChildSection;->getName()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->readUserState(Lcom/android/server/pm/SettingsXml$ReadSection;Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;)V
...
.method public add(Ljava/lang/String;II)V
    ...
    invoke-virtual {p1, p2, p3}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->addUserState(II)V
...
.method public add(Ljava/lang/String;Landroid/content/pm/IntentFilterVerificationInfo;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->setInfo(Landroid/content/pm/IntentFilterVerificationInfo;)V
...
.method public getUserState(Ljava/lang/String;I)I
    ...
    check-cast p1, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->getUserState(I)I
...
.method public getUserStates(Ljava/lang/String;)Landroid/util/SparseIntArray;
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->getUserStates()Landroid/util/SparseIntArray;
...
.method public readSettings(Landroid/util/TypedXmlPullParser;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->readUserStates(Lcom/android/server/pm/SettingsXml$ReadSection;)V
...
.method public remove(Ljava/lang/String;)Landroid/content/pm/IntentFilterVerificationInfo;
    ...
    invoke-virtual {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->isAttached()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->markAttached()V

    invoke-virtual {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings$LegacyState;->getInfo()Landroid/content/pm/IntentFilterVerificationInfo;
