...
.method private constructor <init>(Lcom/android/server/audio/AudioService;Landroid/media/audiopolicy/AudioVolumeGroup;)V
    ...
    const-string p2, " has neither valid attributes nor valid stream types assigned"
...
.method private setVolumeIndexInt(III)V
    ...
    invoke-static {p3}, Lcom/android/server/audio/AudioService;->access$2500(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    :cond_1
    :goto_0
    iget-object p3, p0, Lcom/android/server/audio/AudioService$VolumeGroupState;->mAudioAttributes:Landroid/media/AudioAttributes;

    invoke-static {p3, p1, p2}, Landroid/media/AudioSystem;->setVolumeIndexForAttributes(Landroid/media/AudioAttributes;II)I
...
.method public applyAllVolumes()V
    ...
    :cond_1
    invoke-direct {p0, v6, v5, v2}, Lcom/android/server/audio/AudioService$VolumeGroupState;->setVolumeIndexInt(III)V
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->access$2500(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    :cond_4
    invoke-direct {p0, v1, v6, v2}, Lcom/android/server/audio/AudioService$VolumeGroupState;->setVolumeIndexInt(III)V
...
.method public getIndex(I)I
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/AudioService$VolumeGroupState;->mIndexMap:Landroid/util/SparseIntArray;
...
.method public getSettingNameForDevice(I)Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/audio/AudioService$VolumeGroupState;->mAudioVolumeGroup:Landroid/media/audiopolicy/AudioVolumeGroup;
...
.method public readSettings()V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/audio/AudioService$VolumeGroupState;->getValidIndex(I)I
