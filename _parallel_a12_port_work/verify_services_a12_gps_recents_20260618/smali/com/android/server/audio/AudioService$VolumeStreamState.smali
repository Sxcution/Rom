...
.method private constructor <init>(Lcom/android/server/audio/AudioService;Ljava/lang/String;I)V
    ...
    invoke-static {p3, v0, p2}, Landroid/media/AudioSystem;->initStreamVolume(III)I
    ...
    invoke-virtual {v1, p2, v2}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(ILjava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {v1, v2}, Lcom/android/server/audio/AudioService;->access$3700(Lcom/android/server/audio/AudioService;I)I
...
.method private getValidIndex(IZ)I
    ...
    invoke-static {p2}, Lcom/android/server/audio/AudioService;->access$2400(Lcom/android/server/audio/AudioService;)Z
...
.method public applyAllVolumes()V
    ...
    invoke-static {v4}, Lcom/android/server/audio/AudioService;->access$3200(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v4, v3}, Lcom/android/server/audio/AudioService;->access$3300(Lcom/android/server/audio/AudioService;I)Z
...
.method public getMinIndex(Z)I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/audio/AudioService$VolumeStreamState;->mIndexMinNoPerm:I
...
.method public mute(Z)Z
    ...
    invoke-static {p1, v0}, Lcom/android/server/audio/AudioService;->access$3500(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
...
.method public observeDevicesForStream_syncVSS(Z)I
    ...
    iget v5, p0, Lcom/android/server/audio/AudioService$VolumeStreamState;->mObservedDevices:I
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/audio/AudioService;->postObserveDevicesForAllStreams(I)V
    ...
    invoke-static {v1, v5, v0}, Lcom/android/server/EventLogTags;->writeStreamDevicesChanged(III)V
...
.method public readSettings()V
    ...
    invoke-direct {p0, v6, v4}, Lcom/android/server/audio/AudioService$VolumeStreamState;->getValidIndex(IZ)I
...
.method public setAllIndexes(Lcom/android/server/audio/AudioService$VolumeStreamState;Ljava/lang/String;)V
    ...
    invoke-static {v4, v3, v0, v5}, Lcom/android/server/audio/AudioService;->access$3400(Lcom/android/server/audio/AudioService;III)I
...
.method public setIndex(IILjava/lang/String;Z)Z
    ...
    invoke-static {v8, p1, v9, v7}, Lcom/android/server/audio/AudioService;->access$3400(Lcom/android/server/audio/AudioService;III)I
    ...
    invoke-static {p1, p2}, Lcom/android/server/audio/AudioService;->access$3500(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
