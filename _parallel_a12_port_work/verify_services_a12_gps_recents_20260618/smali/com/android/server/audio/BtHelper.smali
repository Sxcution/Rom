...
.method private handleBtScoActiveDeviceChange(Landroid/bluetooth/BluetoothDevice;Z)Z
    ...
    invoke-virtual {v4, p2, v5, v6, p1}, Lcom/android/server/audio/AudioDeviceBroker;->handleDeviceConnection(ZILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v9, p2, v8, v10, p1}, Lcom/android/server/audio/AudioDeviceBroker;->handleDeviceConnection(ZILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v5, p2, v1, v2, p1}, Lcom/android/server/audio/AudioDeviceBroker;->handleDeviceConnection(ZILjava/lang/String;Ljava/lang/String;)Z
...
.method static isTwsPlusSwitch(Landroid/bluetooth/BluetoothDevice;Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/audio/BtHelper;->mBluetoothA2dpActiveDevice:Landroid/bluetooth/BluetoothDevice;

    const-string p1, "AS.BtHelper"

    if-nez p0, :cond_1

    const-string p0, "Not a TwsPlusSwitch as previous active device was null"
...
.method private requestScoState(II)Z
    ...
    :pswitch_3
    const-string/jumbo p1, "requestScoState: already in ACTIVE mode, simply return"
    ...
    invoke-direct {p0, p2}, Lcom/android/server/audio/BtHelper;->getAnonymizedAddress(Landroid/bluetooth/BluetoothDevice;)Ljava/lang/String;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean p2, p0, Lcom/android/server/audio/BtHelper;->mAvrcpAbsVolSupported:Z
...
.method declared-synchronized onA2dpProfileConnected(Landroid/bluetooth/BluetoothA2dp;)V
    ...
    invoke-virtual {p1, v6}, Lcom/android/server/audio/AudioDeviceBroker;->queueBluetoothA2dpDeviceConnectionStateSuppressNoisyIntent(Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method declared-synchronized onHeadsetProfileConnected(Landroid/bluetooth/BluetoothHeadset;)V
    ...
    invoke-static {p1, v0, v2}, Lcom/android/server/audio/BtHelper;->disconnectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-static {p1, v0, v2}, Lcom/android/server/audio/BtHelper;->connectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
...
.method declared-synchronized startBluetoothSco(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/audio/BtHelper;->requestScoState(II)Z
...
.method declared-synchronized stopBluetoothSco(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/audio/BtHelper;->requestScoState(II)Z
