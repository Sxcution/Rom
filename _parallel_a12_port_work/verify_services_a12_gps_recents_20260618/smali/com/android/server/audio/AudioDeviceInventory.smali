...
.method private checkSendBecomingNoisyIntentInt(III)I
    ...
    const-string/jumbo p3, "not sending NOISY: state="
    ...
    sget-object p1, Landroid/media/MediaMetrics$Property;->DELAY_MS:Landroid/media/MediaMetrics$Key;
    ...
    invoke-virtual {p2, v1}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
...
.method private configureHdmiPlugIntent(Landroid/content/Intent;I)V
    ...
    sget-object v3, Lcom/android/server/audio/AudioDeviceInventory$$ExternalSyntheticLambda13;->INSTANCE:Lcom/android/server/audio/AudioDeviceInventory$$ExternalSyntheticLambda13;
...
.method private dispatchDevicesRoleForCapturePreset(IILjava/util/List;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/AudioDeviceInventory;->mDevRoleCapturePresetDispatchers:Landroid/os/RemoteCallbackList;
...
.method private dispatchPreferredDevice(ILjava/util/List;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/AudioDeviceInventory;->mPrefDevDispatchers:Landroid/os/RemoteCallbackList;
...
.method private makeA2dpDeviceAvailable(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v2, p3}, Lcom/android/server/audio/AudioEventLogger;->log(Lcom/android/server/audio/AudioEventLogger$Event;)V
    ...
    const-string v4, "A2DP device addr="
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    invoke-direct {p3, v0, p2, p1, p4}, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
...
.method private makeA2dpDeviceUnavailableLater(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, v1, p2}, Lcom/android/server/audio/AudioDeviceBroker;->setA2dpTimeout(Ljava/lang/String;II)V
...
.method private makeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    const-string p2, "A2DP device made unavailable, was not used"
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/audio/AudioDeviceInventory;->setCurrentAudioRouteNameIfPossible(Ljava/lang/String;Z)V
...
.method private makeHearingAidDeviceAvailable(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2, v3}, Lcom/android/server/audio/AudioDeviceInventory;->setCurrentAudioRouteNameIfPossible(Ljava/lang/String;Z)V

    new-instance p4, Landroid/media/MediaMetrics$Item;

    const-string v1, "audio.device.makeHearingAidDeviceAvailable"

    invoke-direct {p4, v1}, Landroid/media/MediaMetrics$Item;-><init>(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p4, v1, p1}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p1

    sget-object p4, Landroid/media/MediaMetrics$Property;->DEVICE:Landroid/media/MediaMetrics$Key;

    invoke-static {v0}, Landroid/media/AudioSystem;->getDeviceName(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, p4, v0}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p1

    sget-object p4, Landroid/media/MediaMetrics$Property;->NAME:Landroid/media/MediaMetrics$Key;

    invoke-virtual {p1, p4, p2}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p1

    sget-object p2, Landroid/media/MediaMetrics$Property;->STREAM_TYPE:Landroid/media/MediaMetrics$Key;
...
.method private makeHearingAidDeviceUnavailable(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {v0, v2, p1}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object p1

    sget-object v0, Landroid/media/MediaMetrics$Property;->DEVICE:Landroid/media/MediaMetrics$Key;
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v2}, Landroid/media/AudioSystem;->getDeviceConnectionState(ILjava/lang/String;)I
    ...
    invoke-virtual {p3, v0}, Lcom/android/server/audio/AudioDeviceBroker;->broadcastStickyIntentToCurrentProfileGroup(Landroid/content/Intent;)V
    :try_end_0
...
.method private setCurrentAudioRouteNameIfPossible(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/audio/AudioDeviceBroker;->postReportNewRoutes(Z)V
...
.method private updateAudioRoutes(II)V
    ...
    :goto_1
    iget-object p2, p0, Lcom/android/server/audio/AudioDeviceInventory;->mCurAudioRoutes:Landroid/media/AudioRoutesInfo;

    iget p2, p2, Landroid/media/AudioRoutesInfo;->mainType:I

    if-eq p1, p2, :cond_2

    iget-object p2, p0, Lcom/android/server/audio/AudioDeviceInventory;->mCurAudioRoutes:Landroid/media/AudioRoutesInfo;

    iput p1, p2, Landroid/media/AudioRoutesInfo;->mainType:I

    iget-object p1, p0, Lcom/android/server/audio/AudioDeviceInventory;->mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    invoke-virtual {p1, v0}, Lcom/android/server/audio/AudioDeviceBroker;->postReportNewRoutes(Z)V
...
.method clearPreferredDevicesForCapturePresetSync(I)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioDeviceBroker;->postSaveClearPreferredDevicesForCapturePreset(I)V
...
.method disconnectA2dp()V
    ...
    invoke-direct {v3, p0, v2}, Lcom/android/server/audio/AudioDeviceInventory$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/audio/AudioDeviceInventory;I)V
...
.method disconnectHearingAid()V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/audio/AudioDeviceInventory$$ExternalSyntheticLambda9;-><init>(Lcom/android/server/audio/AudioDeviceInventory;)V
...
.method handleBluetoothA2dpActiveDeviceChangeExt(Landroid/bluetooth/BluetoothDevice;IIZI)V
    ...
    new-instance v7, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;-><init>(Landroid/bluetooth/BluetoothDevice;IIZI)V

    invoke-virtual {v0, v7}, Lcom/android/server/audio/AudioDeviceBroker;->queueBluetoothA2dpDeviceConnectionStateSuppressNoisyIntent(Lcom/android/server/audio/AudioDeviceBroker$BtDeviceConnectionInfo;)V
    ...
    iget-object p2, p2, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->mDeviceAddress:Ljava/lang/String;
...
.method handleDeviceConnection(ZILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v10, v1, v0}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;
    ...
    invoke-direct {v2, v7, v9, v8, v14}, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/audio/AudioDeviceBroker;->postAccessoryPlugMediaUnmute(I)V
    ...
    const-string v4, "handleDeviceConnection() failed, deviceKey="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v4, ", deviceSpec="
...
.method public synthetic lambda$onRestoreDevices$5$AudioDeviceInventory(Ljava/lang/Integer;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, v1, p2}, Lcom/android/server/audio/AudioSystemAdapter;->setDevicesRoleForStrategy(IILjava/util/List;)I
...
.method onBluetoothA2dpActiveDeviceChange(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    const-string/jumbo v7, "onBluetoothA2dpActiveDeviceChange addr="
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/audio/AudioDeviceBroker;->hasScheduledA2dpSinkConnectionState(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-direct {p2, v1}, Lcom/android/server/audio/AudioEventLogger$StringEvent;-><init>(Ljava/lang/String;)V
    ...
    const-string p2, "A2dp config change ignored"
    ...
    invoke-static {v4, v3}, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->access$000(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p2, "null DeviceInfo"
    ...
    invoke-virtual {v0, v7, v3}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object v7

    sget-object v9, Landroid/media/MediaMetrics$Property;->ENCODING:Landroid/media/MediaMetrics$Key;

    invoke-static {p1}, Landroid/media/AudioSystem;->audioFormatToString(I)Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v7, v9, v10}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;

    move-result-object v7

    sget-object v9, Landroid/media/MediaMetrics$Property;->INDEX:Landroid/media/MediaMetrics$Key;
    ...
    iget-object v10, v6, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->mDeviceName:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/android/server/audio/AudioDeviceInventory;->mApmConnectedDevices:Landroid/util/ArrayMap;

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v6

    invoke-virtual {p2, v6, v5}, Landroid/util/ArrayMap;->replace(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v9, v1, v4, v5}, Lcom/android/server/audio/AudioDeviceBroker;->postSetVolumeIndexOnDevice(IIILjava/lang/String;)V
    ...
    iget p2, v6, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->mDeviceCodecFormat:I

    if-eq p2, p1, :cond_5

    iput p1, v6, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->mDeviceCodecFormat:I

    iget-object p2, p0, Lcom/android/server/audio/AudioDeviceInventory;->mConnectedDevices:Ljava/util/LinkedHashMap;

    invoke-virtual {p2, v5, v6}, Ljava/util/LinkedHashMap;->replace(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v4, v3, v1, p1}, Lcom/android/server/audio/AudioSystemAdapter;->handleDeviceConfigChange(ILjava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    invoke-virtual {p1, v9}, Lcom/android/server/audio/AudioDeviceBroker;->getDeviceForStream(I)I
...
.method public onSetA2dpSinkConnectionState(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    const-string v4, "audio.device.a2dp"
    ...
    sget-object v4, Landroid/media/MediaMetrics$Property;->ENCODING:Landroid/media/MediaMetrics$Key;
    ...
    sget-object v4, Landroid/media/MediaMetrics$Property;->INDEX:Landroid/media/MediaMetrics$Key;
    ...
    invoke-static {v6, v4}, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->access$000(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2, v4, v1, v6, v5}, Lcom/android/server/audio/AudioDeviceBroker;->postSetVolumeIndexOnDevice(IIILjava/lang/String;)V
...
.method onSetA2dpSourceConnectionState(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    const-string v4, "audio.device.onSetA2dpSourceConnectionState"

    invoke-direct {v3, v4}, Landroid/media/MediaMetrics$Item;-><init>(Ljava/lang/String;)V

    sget-object v4, Landroid/media/MediaMetrics$Property;->ADDRESS:Landroid/media/MediaMetrics$Key;

    invoke-virtual {v3, v4, p1}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;
...
.method onSetWiredDeviceConnectionState(Lcom/android/server/audio/AudioDeviceInventory$WiredDeviceConnectionState;)V
    ...
    const-string v2, "change of connection state failed"

    invoke-virtual {v0, p1, v2}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;
    ...
    invoke-direct {p0, v2, p1}, Lcom/android/server/audio/AudioDeviceInventory;->updateAudioRoutes(II)V
...
.method removePreferredDevicesForStrategySync(I)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioDeviceBroker;->postSaveRemovePreferredDevicesForStrategy(I)V
...
.method public setBluetoothA2dpDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;IIZII)V
    ...
    invoke-static {v2, p4}, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->access$000(ILjava/lang/String;)Ljava/lang/String;
    ...
    check-cast p4, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;

    if-eqz p4, :cond_4

    iget p4, p4, Lcom/android/server/audio/AudioDeviceInventory$DeviceInfo;->mDeviceCodecFormat:I
    ...
    const-string p2, "invalid null DeviceInfo in setBluetoothA2dpDeviceConnectionState"
    ...
    invoke-virtual {p1, p2, p5, v3}, Lcom/android/server/audio/AudioDeviceBroker;->postA2dpSinkConnection(ILcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    invoke-virtual {p1, p2, p5, v3}, Lcom/android/server/audio/AudioDeviceBroker;->postA2dpSourceConnection(ILcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
...
.method setBluetoothHearingAidDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;IZI)I
    ...
    :try_start_0
    invoke-direct {p0, v4, p3, p4}, Lcom/android/server/audio/AudioDeviceInventory;->checkSendBecomingNoisyIntentInt(III)I
    ...
    invoke-virtual {p4, p2, p1, p3}, Lcom/android/server/audio/AudioDeviceBroker;->postSetHearingAidConnectionState(ILandroid/bluetooth/BluetoothDevice;I)V

    if-ne p2, v2, :cond_2

    iget-object p1, p0, Lcom/android/server/audio/AudioDeviceInventory;->mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    const-string p2, "HEARING_AID set to CONNECTED"

    invoke-virtual {p1, v1, v3, p2}, Lcom/android/server/audio/AudioDeviceBroker;->setForceUse_Async(IILjava/lang/String;)V
...
.method setPreferredDevicesForCapturePresetSync(ILjava/util/List;)I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/audio/AudioDeviceBroker;->postSaveSetPreferredDevicesForCapturePreset(ILjava/util/List;)V
...
.method setPreferredDevicesForStrategySync(ILjava/util/List;)I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/audio/AudioDeviceBroker;->postSaveSetPreferredDevicesForStrategy(ILjava/util/List;)V
