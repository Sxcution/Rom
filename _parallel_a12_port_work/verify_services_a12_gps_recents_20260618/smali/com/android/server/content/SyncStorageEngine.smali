...
.method private constructor <init>(Landroid/content/Context;Ljava/io/File;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/content/SyncStorageEngine;->maybeDeleteLegacyPendingInfoLocked(Ljava/io/File;)V
...
.method private parseAuthority(Landroid/util/TypedXmlPullParser;ILcom/android/server/content/SyncStorageEngine$AccountAuthorityValidator;)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    invoke-direct {v1, v0, v2, v3}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateAuthorityLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;IZ)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    :goto_5
    iput v9, v6, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->syncable:I
...
.method private parseExtra(Landroid/util/TypedXmlPullParser;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v2, p1}, Landroid/accounts/Account;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private parseLastEventInfoLocked(Landroid/util/proto/ProtoInputStream;)Landroid/util/Pair;
    ...
    invoke-virtual {p1, v1, v2}, Landroid/util/proto/ProtoInputStream;->readLong(J)J
...
.method private readAccountInfoLocked()V
    ...
    invoke-direct {v1, v0, v12, v7}, Lcom/android/server/content/SyncStorageEngine;->parseAuthority(Landroid/util/TypedXmlPullParser;ILcom/android/server/content/SyncStorageEngine$AccountAuthorityValidator;)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    iget v15, v14, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->ident:I
    ...
    invoke-direct {v1, v0}, Lcom/android/server/content/SyncStorageEngine;->parseListenForTickles(Landroid/util/TypedXmlPullParser;)V
    ...
    invoke-direct {v1, v0, v14}, Lcom/android/server/content/SyncStorageEngine;->parsePeriodicSync(Landroid/util/TypedXmlPullParser;Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;)Landroid/content/PeriodicSync;
    ...
    invoke-direct {v1, v0, v5}, Lcom/android/server/content/SyncStorageEngine;->parseExtra(Landroid/util/TypedXmlPullParser;Landroid/os/Bundle;)V
...
.method private readStatsParcelLocked(Ljava/io/File;)V
    ...
    const-string p1, "No initial statistics"
...
.method private readStatusParcelLocked(Ljava/io/File;)V
    ...
    const-string p1, "No initial status"
...
.method private writeAccountInfoLocked()V
    ...
    invoke-interface {v5, v3, v7}, Landroid/util/TypedXmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V

    const-string v7, "http://xmlpull.org/v1/doc/features.html#indent-output"

    invoke-interface {v5, v7, v6}, Landroid/util/TypedXmlSerializer;->setFeature(Ljava/lang/String;Z)V
...
.method private writeStatusInfoLocked(Ljava/io/OutputStream;)V
    ...
    invoke-direct {p0, v0, v8}, Lcom/android/server/content/SyncStorageEngine;->writeStatusStatsLocked(Landroid/util/proto/ProtoOutputStream;Landroid/content/SyncStatusInfo$Stats;)V
...
.method public getDayStatistics()[Lcom/android/server/content/SyncStorageEngine$DayStats;
    ...
    new-array v3, v2, [Lcom/android/server/content/SyncStorageEngine$DayStats;
...
.method reportChange(II)V
    ...
    const-string/jumbo v1, "reportChange "
...
.method public setBackoff(Lcom/android/server/content/SyncStorageEngine$EndPoint;JJ)V
    ...
    const-string/jumbo v3, "setBackoff: "
...
.method public setSyncAutomatically(Landroid/accounts/Account;ILjava/lang/String;ZIII)V
    ...
    const-string/jumbo v7, "setSyncAutomatically:  provider "
    ...
    const-string v7, "Set sync auto account="
    ...
    invoke-direct {p0, v6, v7, v8}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateAuthorityLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;IZ)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    iget v8, v6, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->syncable:I

    if-ne v8, v4, :cond_3

    iput v7, v6, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->syncable:I
...
.method public stopSyncEvent(JJLjava/lang/String;JJI)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/content/SyncStorageEngine$MyHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/content/SyncStorageEngine$MyHandler;->obtainMessage(I)Landroid/os/Message;
...
.method writeStatisticsLocked()V
    ...
    :try_start_1
    invoke-direct {p0, v1}, Lcom/android/server/content/SyncStorageEngine;->writeDayStatsLocked(Ljava/io/OutputStream;)V
...
.method writeStatusLocked()V
    ...
    :try_start_1
    invoke-direct {p0, v1}, Lcom/android/server/content/SyncStorageEngine;->writeStatusInfoLocked(Ljava/io/OutputStream;)V
