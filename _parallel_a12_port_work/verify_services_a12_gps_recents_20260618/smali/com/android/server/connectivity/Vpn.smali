...
.method protected constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/connectivity/Vpn$Dependencies;Landroid/os/INetworkManagementService;Landroid/net/INetd;ILcom/android/server/connectivity/VpnProfileStore;Lcom/android/server/connectivity/Vpn$SystemServices;Lcom/android/server/connectivity/Vpn$Ikev2SessionCreator;)V
    ...
    invoke-direct {p0, p3, p6}, Lcom/android/server/connectivity/Vpn;->getAppUid(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p3}, Lcom/android/server/connectivity/Vpn;->doesPackageTargetAtLeastQ(Ljava/lang/String;)Z
...
.method private agentConnect()V
    ...
    new-instance v11, Lcom/android/server/connectivity/Vpn$1;
...
.method private canHaveRestrictedProfile(I)Z
    ...
    invoke-virtual {p1}, Landroid/os/UserManager;->canHaveRestrictedProfile()Z
...
.method private makeKeystoreEngineGrantString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {v1, v2, p1, v0}, Landroid/security/KeyStore2;->grant(Landroid/system/keystore2/KeyDescriptor;II)Landroid/system/keystore2/KeyDescriptor;
...
.method private makeLinkProperties()Landroid/net/LinkProperties;
    ...
    invoke-direct {v0, v6, v5, v5, v3}, Landroid/net/RouteInfo;-><init>(Landroid/net/IpPrefix;Ljava/net/InetAddress;Ljava/lang/String;I)V
    ...
    invoke-virtual {v2, v0}, Landroid/net/LinkProperties;->setMtu(I)V
...
.method private setAlwaysOnPackageInternal(Ljava/lang/String;ZLjava/util/List;)Z
    ...
    const-string p2, "Not setting always-on vpn, invalid allowed package: "
...
.method private setVpnForcedLocked(Z)V
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/server/connectivity/Vpn;->setAllowOnlyVpnForUids(ZLjava/util/Collection;)Z
...
.method private declared-synchronized startVpnProfilePrivileged(Lcom/android/internal/net/VpnProfile;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/connectivity/Vpn;->mConfig:Lcom/android/internal/net/VpnConfig;

    const/4 v0, 0x1

    iput-boolean v0, p2, Lcom/android/internal/net/VpnConfig;->legacy:Z

    iget-object p2, p0, Lcom/android/server/connectivity/Vpn;->mConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v1, p1, Lcom/android/internal/net/VpnProfile;->name:Ljava/lang/String;

    iput-object v1, p2, Lcom/android/internal/net/VpnConfig;->session:Ljava/lang/String;

    iget-object p2, p0, Lcom/android/server/connectivity/Vpn;->mConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v1, p1, Lcom/android/internal/net/VpnProfile;->key:Ljava/lang/String;

    iput-object v1, p2, Lcom/android/internal/net/VpnConfig;->user:Ljava/lang/String;

    iget-object p2, p0, Lcom/android/server/connectivity/Vpn;->mConfig:Lcom/android/internal/net/VpnConfig;

    iput-boolean v0, p2, Lcom/android/internal/net/VpnConfig;->isMetered:Z
    ...
    iget-boolean v0, p1, Lcom/android/internal/net/VpnProfile;->isMetered:Z
    ...
    iput-wide v0, p2, Lcom/android/internal/net/VpnConfig;->startTime:J

    iget-object p2, p0, Lcom/android/server/connectivity/Vpn;->mConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v0, p1, Lcom/android/internal/net/VpnProfile;->proxy:Landroid/net/ProxyInfo;

    iput-object v0, p2, Lcom/android/internal/net/VpnConfig;->proxyInfo:Landroid/net/ProxyInfo;

    iget p2, p1, Lcom/android/internal/net/VpnProfile;->type:I
    ...
    :pswitch_0
    new-instance p2, Lcom/android/server/connectivity/Vpn$IkeV2VpnRunner;
    ...
    invoke-direct {p2, p0, p1}, Lcom/android/server/connectivity/Vpn$IkeV2VpnRunner;-><init>(Lcom/android/server/connectivity/Vpn;Landroid/net/Ikev2VpnProfile;)V

    iput-object p2, p0, Lcom/android/server/connectivity/Vpn;->mVpnRunner:Lcom/android/server/connectivity/Vpn$VpnRunner;

    invoke-virtual {p2}, Lcom/android/server/connectivity/Vpn$VpnRunner;->start()V

    goto :goto_2

    :goto_1
    const-string v0, "Invalid platform VPN type"
...
.method private updateAlwaysOnNotification(Landroid/net/NetworkInfo$DetailedState;)V
    ...
    invoke-virtual {v4, v6, v5, p1}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private updateLinkPropertiesInPlaceIfPossible(Landroid/net/NetworkAgent;Lcom/android/internal/net/VpnConfig;)Z
    ...
    :cond_2
    :goto_0
    const-string p1, "Handover not possible due to changes to allowed/denied apps"
...
.method addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v2, p4, v0}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V
    ...
    invoke-direct {p2, p3, p4}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V
...
.method public declared-synchronized establish(Lcom/android/internal/net/VpnConfig;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {v9, p0, v2}, Lcom/android/server/connectivity/Vpn$Connection;-><init>(Lcom/android/server/connectivity/Vpn;Lcom/android/server/connectivity/Vpn$1;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/connectivity/Vpn;->updateLinkPropertiesInPlaceIfPossible(Landroid/net/NetworkAgent;Lcom/android/internal/net/VpnConfig;)Z
    ...
    iget-boolean v2, p1, Lcom/android/internal/net/VpnConfig;->blocking:Z

    invoke-static {v0, v2}, Llibcore/io/IoUtils;->setBlocking(Ljava/io/FileDescriptor;Z)V
    :try_end_6
...
.method getVpnProfilePrivileged(Ljava/lang/String;)Lcom/android/internal/net/VpnProfile;
    ...
    const-string v0, "getVpnProfilePrivileged called as non-System UID "
...
.method public isAlwaysOnPackageSupported(Ljava/lang/String;)Z
    ...
    const-string v2, "android.net.VpnService.SUPPORTS_ALWAYS_ON"
...
.method public synthetic lambda$enforceNotRestrictedUser$2$Vpn()V
    ...
    const-string v1, "Restricted users cannot configure VPNs"
...
.method public synthetic lambda$startVpnProfile$5$Vpn(Ljava/lang/String;)V
    ...
    const-string v2, "No profile found for "
...
.method public declared-synchronized provisionVpnProfile(Ljava/lang/String;Lcom/android/internal/net/VpnProfile;)Z
    ...
    new-instance v0, Lcom/android/server/connectivity/Vpn$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/server/connectivity/Vpn$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/connectivity/Vpn;Ljava/lang/String;[B)V
...
.method public setPackageAuthorization(Ljava/lang/String;I)Z
    ...
    :goto_3
    :try_start_1
    const-string p2, "Unrecognized VPN type while granting authorization"

    invoke-static {v7, p2}, Landroid/util/Log;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v5, "Failed to set app ops for package "
    ...
    invoke-static {v7, p1, p2}, Landroid/util/Log;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public startAlwaysOnVpn()Z
    ...
    invoke-direct {p0, v0, v9}, Lcom/android/server/connectivity/Vpn;->startVpnProfilePrivileged(Lcom/android/internal/net/VpnProfile;Ljava/lang/String;)V
    :try_end_1
...
.method public startLegacyVpnPrivileged(Lcom/android/internal/net/VpnProfile;Landroid/net/Network;Landroid/net/LinkProperties;)V
    ...
    iget-object v10, v1, Lcom/android/internal/net/VpnProfile;->ipsecUserCert:Ljava/lang/String;

    invoke-virtual {v4, v10}, Ljava/security/KeyStore;->getCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {v0, v4, v10}, Lcom/android/server/connectivity/Vpn;->getCaCertificateFromKeystoreAsPem(Ljava/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v13}, Lcom/android/server/connectivity/Vpn;->startVpnProfilePrivileged(Lcom/android/internal/net/VpnProfile;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v6}, Lcom/android/server/connectivity/Vpn;->makeKeystoreEngineGrantString(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "xauthpsk"
    ...
    iget-object v12, v1, Lcom/android/internal/net/VpnProfile;->server:Ljava/lang/String;

    aput-object v12, v3, v21

    aput-object v16, v3, v20

    iget-object v12, v1, Lcom/android/internal/net/VpnProfile;->l2tpSecret:Ljava/lang/String;

    aput-object v12, v3, v19

    aput-object v11, v3, v18

    iget-object v11, v1, Lcom/android/internal/net/VpnProfile;->username:Ljava/lang/String;

    aput-object v11, v3, v15

    aput-object v10, v3, v17

    iget-object v10, v1, Lcom/android/internal/net/VpnProfile;->password:Ljava/lang/String;
    ...
    :cond_9
    invoke-direct {v0, v3, v4, v5, v1}, Lcom/android/server/connectivity/Vpn;->startLegacyVpn(Lcom/android/internal/net/VpnConfig;[Ljava/lang/String;[Ljava/lang/String;Lcom/android/internal/net/VpnProfile;)V
...
.method protected updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
    ...
    const-string p2, "VPN can only go to CONNECTING state when the agent is null."
...
.method validateRequiredFeatures(Lcom/android/internal/net/VpnProfile;)V
    ...
    const-string v0, "Ikev2VpnProfile(s) requires PackageManager.FEATURE_IPSEC_TUNNELS"
