...
.method public addOnProjectionStateChangedListener(Landroid/app/IOnProjectionStateChangedListener;I)V
    ...
    :try_start_1
    invoke-interface {p1, p2, v1}, Landroid/app/IOnProjectionStateChangedListener;->onProjectionStateChanged(ILjava/util/List;)V
    :try_end_1
    ...
    const-string p2, "Failed a call to onProjectionStateChanged() during listener registration."
...
.method public disableCarModeByCallingPackage(ILjava/lang/String;)V
    ...
    const-string p2, "disableCarMode while UI mode is locked"
    ...
    invoke-static {v5}, Lcom/android/server/UiModeManagerService;->access$2000(Lcom/android/server/UiModeManagerService;)Ljava/util/Map;
    ...
    invoke-direct {v6, p2}, Lcom/android/server/UiModeManagerService$12$$ExternalSyntheticLambda2;-><init>(Ljava/lang/String;)V
    ...
    sget-object v6, Lcom/android/server/UiModeManagerService$12$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/UiModeManagerService$12$$ExternalSyntheticLambda1;
    ...
    invoke-virtual {v6, v2, v0, v5, p2}, Lcom/android/server/UiModeManagerService;->setCarModeLocked(ZIILjava/lang/String;)V
    ...
    invoke-virtual {p2, v2, p1}, Lcom/android/server/UiModeManagerService;->updateLocked(II)V
...
.method public enableCarMode(IILjava/lang/String;)V
    ...
    const-string p2, "enableCarMode while UI mode is locked"
    ...
    const-string p2, "Enabling car mode with a priority requires permission ENTER_CAR_MODE_PRIORITIZED"
    ...
    invoke-virtual {p2, p1, p3}, Lcom/android/server/UiModeManagerService;->updateLocked(II)V
...
.method public requestProjection(Landroid/os/IBinder;ILjava/lang/String;)Z
    ...
    invoke-static {v5}, Lcom/android/server/UiModeManagerService$ProjectionHolder;->access$4000(Lcom/android/server/UiModeManagerService$ProjectionHolder;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lcom/android/server/UiModeManagerService$ProjectionHolder;->access$4200(Lcom/android/server/UiModeManagerService$ProjectionHolder;)Z
    ...
    invoke-static {p1, p2}, Lcom/android/server/UiModeManagerService;->access$4300(Lcom/android/server/UiModeManagerService;I)V
...
.method public setApplicationNightMode(I)V
    ...
    invoke-static {v0}, Lcom/android/server/UiModeManagerService;->access$2400(Lcom/android/server/UiModeManagerService;)Lcom/android/server/wm/ActivityTaskManagerInternal;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/server/wm/ActivityTaskManagerInternal;->createPackageConfigurationUpdater()Lcom/android/server/wm/ActivityTaskManagerInternal$PackageConfigurationUpdater;

    move-result-object v0

    invoke-interface {v0, p1}, Lcom/android/server/wm/ActivityTaskManagerInternal$PackageConfigurationUpdater;->setNightMode(I)Lcom/android/server/wm/ActivityTaskManagerInternal$PackageConfigurationUpdater;

    invoke-interface {v0}, Lcom/android/server/wm/ActivityTaskManagerInternal$PackageConfigurationUpdater;->commit()V
...
.method public setCustomNightModeEnd(J)V
    ...
    const-string p2, "Set custom time end, requires MODIFY_DAY_NIGHT_MODE permission"
    ...
    invoke-static {p2, p1}, Lcom/android/server/UiModeManagerService;->access$3502(Lcom/android/server/UiModeManagerService;Ljava/time/LocalTime;)Ljava/time/LocalTime;

    iget-object p1, p0, Lcom/android/server/UiModeManagerService$12;->this$0:Lcom/android/server/UiModeManagerService;

    invoke-static {p1, v0}, Lcom/android/server/UiModeManagerService;->access$3400(Lcom/android/server/UiModeManagerService;I)V
    :try_end_1
    ...
    invoke-static {p1}, Lcom/android/server/UiModeManagerService;->access$700(Lcom/android/server/UiModeManagerService;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public setCustomNightModeStart(J)V
    ...
    const-string p2, "Set custom time start, requires MODIFY_DAY_NIGHT_MODE permission"
    ...
    invoke-static {p2, p1}, Lcom/android/server/UiModeManagerService;->access$3302(Lcom/android/server/UiModeManagerService;Ljava/time/LocalTime;)Ljava/time/LocalTime;

    iget-object p1, p0, Lcom/android/server/UiModeManagerService$12;->this$0:Lcom/android/server/UiModeManagerService;

    invoke-static {p1, v0}, Lcom/android/server/UiModeManagerService;->access$2300(Lcom/android/server/UiModeManagerService;I)V
...
.method public setNightMode(I)V
    ...
    invoke-static {p1}, Lcom/android/server/UiModeManagerService;->access$2200(Lcom/android/server/UiModeManagerService;)Z
    ...
    invoke-static {p1}, Lcom/android/server/UiModeManagerService;->access$500(Lcom/android/server/UiModeManagerService;)Z
...
.method public setNightModeActivated(Z)Z
    ...
    const-string v0, "Target user is not current user, INTERACT_ACROSS_USERS permission is required"
    ...
    invoke-static {p1, v4}, Lcom/android/server/UiModeManagerService;->access$402(Lcom/android/server/UiModeManagerService;I)I
    ...
    invoke-static {p1, v5}, Lcom/android/server/UiModeManagerService;->access$402(Lcom/android/server/UiModeManagerService;I)I
    ...
    :cond_5
    invoke-static {v4, v1}, Lcom/android/server/UiModeManagerService;->access$2802(Lcom/android/server/UiModeManagerService;Z)Z
    ...
    invoke-static {p1, v1}, Lcom/android/server/UiModeManagerService;->access$3002(Lcom/android/server/UiModeManagerService;I)I
    ...
    invoke-static {p1, v1}, Lcom/android/server/UiModeManagerService;->access$3100(Lcom/android/server/UiModeManagerService;I)V

    :cond_6
    :goto_1
    iget-object p1, p0, Lcom/android/server/UiModeManagerService$12;->this$0:Lcom/android/server/UiModeManagerService;

    invoke-static {p1}, Lcom/android/server/UiModeManagerService;->access$1700(Lcom/android/server/UiModeManagerService;)V

    iget-object p1, p0, Lcom/android/server/UiModeManagerService$12;->this$0:Lcom/android/server/UiModeManagerService;

    invoke-static {p1}, Lcom/android/server/UiModeManagerService;->access$3200(Lcom/android/server/UiModeManagerService;)V
    ...
    invoke-static {p1, v1}, Lcom/android/server/UiModeManagerService;->access$2300(Lcom/android/server/UiModeManagerService;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
