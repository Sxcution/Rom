...
.method private constructor <init>(Landroid/app/job/JobInfo;ILjava/lang/String;IILjava/lang/String;IJJJJII)V
    ...
    iput-object v3, v1, Lcom/android/server/job/controllers/JobStatus;->sourceTag:Ljava/lang/String;
    ...
    iput v3, v1, Lcom/android/server/job/controllers/JobStatus;->numFailures:I
    ...
    invoke-direct {v1, v5}, Lcom/android/server/job/controllers/JobStatus;->addDynamicConstraints(I)V
    ...
    invoke-direct {v1, v0}, Lcom/android/server/job/controllers/JobStatus;->addDynamicConstraints(I)V

    goto :goto_6

    :cond_9
    iput-boolean v12, v1, Lcom/android/server/job/controllers/JobStatus;->mReadyDynamicSatisfied:Z

    :goto_6
    move-wide/from16 v5, p12

    iput-wide v5, v1, Lcom/android/server/job/controllers/JobStatus;->mLastSuccessfulRunTime:J

    move-wide/from16 v5, p14

    iput-wide v5, v1, Lcom/android/server/job/controllers/JobStatus;->mLastFailedRunTime:J
    ...
    invoke-direct {v5, v2}, Landroid/net/NetworkRequest$Builder;-><init>(Landroid/net/NetworkRequest;)V
    ...
    invoke-virtual {v5, v2}, Landroid/net/NetworkRequest$Builder;->setUids(Ljava/util/Set;)Landroid/net/NetworkRequest$Builder;
...
.method private dumpJobWorkItem(Landroid/util/IndentingPrintWriter;Landroid/app/job/JobWorkItem;I)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/job/GrantedUriPermissions;->dump(Ljava/io/PrintWriter;)V
...
.method private dumpJobWorkItem(Landroid/util/proto/ProtoOutputStream;JLandroid/app/job/JobWorkItem;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/content/Intent;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
...
.method private readinessStatusWithConstraint(IZ)Z
    ...
    :sswitch_2
    iget-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyWithinQuota:Z
    ...
    :sswitch_3
    iget-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyWithinExpeditedQuota:Z
    ...
    :sswitch_5
    iput-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyDeadlineSatisfied:Z

    goto :goto_4

    :sswitch_6
    iput-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyNotDozing:Z

    goto :goto_4

    :sswitch_7
    iput-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyWithinQuota:Z

    goto :goto_4

    :sswitch_8
    iput-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyWithinExpeditedQuota:Z

    goto :goto_4

    :sswitch_9
    iput-boolean v3, p0, Lcom/android/server/job/controllers/JobStatus;->mReadyNotRestrictedInBg:Z
...
.method public dump(Landroid/util/IndentingPrintWriter;ZJ)V
    ...
    iget-boolean v0, v8, Lcom/android/server/job/controllers/JobStatus;->mReadyWithinExpeditedQuota:Z
    ...
    invoke-direct {p0, p1, v2, v0}, Lcom/android/server/job/controllers/JobStatus;->dumpJobWorkItem(Landroid/util/IndentingPrintWriter;Landroid/app/job/JobWorkItem;I)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/android/server/job/controllers/JobStatus;->dumpJobWorkItem(Landroid/util/IndentingPrintWriter;Landroid/app/job/JobWorkItem;I)V
...
.method public dump(Landroid/util/proto/ProtoOutputStream;JZJ)V
    ...
    iget-boolean v5, v0, Lcom/android/server/job/controllers/JobStatus;->dozeWhitelisted:Z
    ...
    invoke-direct {v0, v1, v6, v7, v8}, Lcom/android/server/job/controllers/JobStatus;->dumpJobWorkItem(Landroid/util/proto/ProtoOutputStream;JLandroid/app/job/JobWorkItem;)V
