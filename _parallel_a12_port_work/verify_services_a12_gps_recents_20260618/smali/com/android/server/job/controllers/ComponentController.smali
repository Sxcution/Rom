...
.method private getServiceInfoLocked(Lcom/android/server/job/controllers/JobStatus;)Landroid/content/pm/ServiceInfo;
    ...
    iget-object p1, p0, Lcom/android/server/job/controllers/ComponentController;->mServiceInfoCache:Landroid/util/SparseArrayMap;

    invoke-virtual {p1, v1, v0}, Landroid/util/SparseArrayMap;->get(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/job/controllers/ComponentController;->mService:Lcom/android/server/job/JobSchedulerService;
    ...
    invoke-virtual {v2, v1, v0, p1}, Landroid/util/SparseArrayMap;->add(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private updateComponentStatesLocked(Ljava/util/function/Predicate;)V
    ...
    iget-boolean p1, p1, Lcom/android/server/job/controllers/ComponentController$ComponentStateUpdateFunctor;->mChanged:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/android/server/job/controllers/ComponentController;->mStateChangedListener:Lcom/android/server/job/StateChangedListener;
...
.method public onAppRemovedLocked(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/job/controllers/ComponentController;->clearComponentsForPackageLocked(ILjava/lang/String;)V
