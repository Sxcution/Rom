...
.method public constructor <init>(Lcom/android/server/job/JobSchedulerService;)V
    ...
    new-instance p1, Lcom/android/server/job/controllers/ConnectivityController$ChargingTracker;

    invoke-direct {p1, p0}, Lcom/android/server/job/controllers/ConnectivityController$ChargingTracker;-><init>(Lcom/android/server/job/controllers/ConnectivityController;)V

    iput-object p1, p0, Lcom/android/server/job/controllers/ConnectivityController;->mChargingTracker:Lcom/android/server/job/controllers/ConnectivityController$ChargingTracker;

    invoke-virtual {p1}, Lcom/android/server/job/controllers/ConnectivityController$ChargingTracker;->startTracking()V
...
.method private getNetworkLocked(Lcom/android/server/job/controllers/JobStatus;)Landroid/net/Network;
    ...
    iget v2, v2, Lcom/android/server/job/controllers/ConnectivityController$UidStats;->basePriority:I
    ...
    iget-boolean v2, p1, Lcom/android/server/job/controllers/JobStatus;->startedAsExpeditedJob:Z
    ...
    const-string v3, "Using BG bypass for "
    ...
    const-string v3, "Using EJ bypass for "
    ...
    const-string v3, "Using FG bypass for "
...
.method private getUidStats(ILjava/lang/String;Z)Lcom/android/server/job/controllers/ConnectivityController$UidStats;
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/server/job/controllers/ConnectivityController$UidStats;-><init>(ILcom/android/server/job/controllers/ConnectivityController$1;)V
...
.method private isInsane(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    :cond_0
    iget-object v0, v0, Lcom/android/server/job/controllers/ConnectivityController;->mService:Lcom/android/server/job/JobSchedulerService;

    move-object/from16 v1, p1

    invoke-virtual {v0, v1}, Lcom/android/server/job/JobSchedulerService;->getMaxJobExecutionTimeMs(Lcom/android/server/job/controllers/JobStatus;)J
    ...
    const-string v15, "JobScheduler.Connectivity"
    ...
    invoke-virtual {v0, v8, v9}, Landroid/util/DataUnit;->toBytes(J)J
...
.method private static isRelaxedSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    invoke-static {p1}, Lcom/android/server/job/controllers/ConnectivityController;->copyCapabilities(Landroid/net/NetworkRequest;)Landroid/net/NetworkCapabilities$Builder;

    move-result-object p1

    const/16 v1, 0xb

    invoke-virtual {p1, v1}, Landroid/net/NetworkCapabilities$Builder;->removeCapability(I)Landroid/net/NetworkCapabilities$Builder;
...
.method private maybeAdjustRegisteredCallbacksLocked()V
    ...
    invoke-virtual {p0, v7, v8}, Lcom/android/server/job/controllers/ConnectivityController;->wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z
    ...
    invoke-direct {p0, v4, v2, v3}, Lcom/android/server/job/controllers/ConnectivityController;->unregisterDefaultNetworkCallbackLocked(IJ)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;->access$200(Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;I)V
    ...
    iget-object v0, p0, Lcom/android/server/job/controllers/ConnectivityController;->mStateChangedListener:Lcom/android/server/job/StateChangedListener;
...
.method private maybeRegisterDefaultNetworkCallbackLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/job/controllers/ConnectivityController;->getUidStats(ILjava/lang/String;Z)Lcom/android/server/job/controllers/ConnectivityController$UidStats;
...
.method private registerPendingUidCallbacksLocked()V
    ...
    invoke-direct {v3, p0, v4}, Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;-><init>(Lcom/android/server/job/controllers/ConnectivityController;Lcom/android/server/job/controllers/ConnectivityController$1;)V

    :cond_1
    iget v4, v2, Lcom/android/server/job/controllers/ConnectivityController$UidStats;->uid:I

    invoke-static {v3, v4}, Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;->access$200(Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;I)V
...
.method private unregisterDefaultNetworkCallbackLocked(IJ)Z
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/server/job/controllers/ConnectivityController;->updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;JLandroid/net/Network;Landroid/net/NetworkCapabilities;)Z
...
.method private updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, v5}, Lcom/android/server/job/controllers/ConnectivityController;->getNetworkCapabilities(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
...
.method private updateTrackedJobsLocked(ILandroid/net/Network;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/job/controllers/ConnectivityController;->updateTrackedJobsLocked(Landroid/util/ArraySet;Landroid/net/Network;)Z
...
.method private updateTrackedJobsLocked(Landroid/util/ArraySet;Landroid/net/Network;)Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/job/controllers/ConnectivityController;->getNetworkLocked(Lcom/android/server/job/controllers/JobStatus;)Landroid/net/Network;

    move-result-object v6

    invoke-direct {p0, v6}, Lcom/android/server/job/controllers/ConnectivityController;->getNetworkCapabilities(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/job/controllers/ConnectivityController;->updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;JLandroid/net/Network;Landroid/net/NetworkCapabilities;)Z
...
.method public dumpControllerStateLocked(Landroid/util/IndentingPrintWriter;Ljava/util/function/Predicate;)V
    ...
    invoke-static {v5, p1}, Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;->access$1300(Lcom/android/server/job/controllers/ConnectivityController$UidDefaultNetworkCallback;Landroid/util/IndentingPrintWriter;)V
    ...
    invoke-static {v5, p1, v0, v1}, Lcom/android/server/job/controllers/ConnectivityController$UidStats;->access$1400(Lcom/android/server/job/controllers/ConnectivityController$UidStats;Landroid/util/IndentingPrintWriter;J)V
...
.method maybeRevokeStandbyExceptionLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    const-string/jumbo p1, "maybeRevokeStandbyExceptionLocked found null jobs array even though a standby exception has been requested."
    ...
    const-string/jumbo v0, "maybeRevokeStandbyExceptionLocked not revoking because there are still "
...
.method public maybeStartTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/android/server/job/controllers/ConnectivityController;->getUidStats(ILjava/lang/String;Z)Lcom/android/server/job/controllers/ConnectivityController$UidStats;
...
.method public maybeStopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Z)V
    ...
    invoke-direct {p0, p2, p3, v0}, Lcom/android/server/job/controllers/ConnectivityController;->getUidStats(ILjava/lang/String;Z)Lcom/android/server/job/controllers/ConnectivityController$UidStats;
...
.method public onAppRemovedLocked(Ljava/lang/String;I)V
    ...
    iget-object p1, p0, Lcom/android/server/job/controllers/ConnectivityController;->mService:Lcom/android/server/job/JobSchedulerService;
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/android/server/job/controllers/ConnectivityController;->unregisterDefaultNetworkCallbackLocked(IJ)Z
...
.method public onUidPriorityChangedLocked(II)V
    ...
    iput p2, p1, Lcom/android/server/job/controllers/ConnectivityController$UidStats;->basePriority:I
