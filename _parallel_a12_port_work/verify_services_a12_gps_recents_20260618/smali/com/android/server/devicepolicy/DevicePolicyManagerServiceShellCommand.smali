...
.method private parseArgs(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/devicepolicy/DevicePolicyManagerServiceShellCommand;->parseComponentName(Ljava/lang/String;)Landroid/content/ComponentName;
...
.method private printAndGetSize(Ljava/io/PrintWriter;Ljava/util/Collection;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, p3, v0}, Ljava/io/PrintWriter;->printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
...
.method private runListOwners(Ljava/io/PrintWriter;)I
    ...
    :cond_3
    iget-boolean v4, v4, Lcom/android/server/devicepolicy/OwnerShellData;->isAffiliated:Z

    if-eqz v4, :cond_4

    const-string v4, ",Affiliated"
...
.method private runSetDeviceOwner(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v0, v2, v1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->removeActiveAdmin(Landroid/content/ComponentName;I)V
...
.method private runSetProfileOwner(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->removeActiveAdmin(Landroid/content/ComponentName;I)V
...
.method private showHelp(Ljava/io/PrintWriter;)V
    ...
    const-string v4, "list-policy-exempt-apps"
