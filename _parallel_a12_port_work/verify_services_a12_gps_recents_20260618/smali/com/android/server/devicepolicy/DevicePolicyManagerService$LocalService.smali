...
.method private checkCrossProfilePackagePermissions(Ljava/lang/String;IZ)Z
    ...
    :cond_2
    :try_start_0
    const-class p3, Landroid/content/pm/CrossProfileAppsInternal;

    invoke-static {p3}, Lcom/android/server/LocalServices;->getService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/content/pm/CrossProfileAppsInternal;

    invoke-virtual {p3, p1, p2}, Landroid/content/pm/CrossProfileAppsInternal;->verifyPackageHasInteractAcrossProfilePermission(Ljava/lang/String;I)Z
    ...
    const-string p3, "Cannot find the package %s to check for permissions."

    invoke-static {p1, p3, p2}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private checkModifyQuietModePermission(Ljava/lang/String;I)Z
    ...
    invoke-static {v2, p2, v3, v0}, Landroid/app/ActivityManager;->checkComponentPermission(Ljava/lang/String;IIZ)I
    ...
    const-string v0, "Cannot find the package %s to check for permissions."

    invoke-static {p1, v0, p2}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public broadcastIntentToCrossProfileManifestReceiversAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Z)V
    ...
    invoke-direct {p0, v7, v0, p3}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService;->checkCrossProfilePackagePermissions(Ljava/lang/String;IZ)Z

    move-result v8

    if-nez v8, :cond_0

    invoke-direct {p0, v7, v0}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService;->checkModifyQuietModePermission(Ljava/lang/String;I)Z
    ...
    :cond_0
    const-string v8, "Sending %s broadcast to %s."
    ...
    invoke-static {v3, v8, v9}, Lcom/android/server/utils/Slogf;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v7, v6, p2}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
    ...
    invoke-static {v3, p1, p3}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createShowAdminSupportIntent(IZ)Landroid/content/Intent;
    ...
    invoke-static {p2, p1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->access$3400(Lcom/android/server/devicepolicy/DevicePolicyManagerService;I)Landroid/content/Intent;
...
.method public createUserRestrictionSupportIntent(ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->access$3300(Lcom/android/server/devicepolicy/DevicePolicyManagerService;ILjava/lang/String;)Landroid/os/Bundle;
...
.method public getPrintingDisabledReasonForUser(I)Ljava/lang/CharSequence;
    ...
    new-instance v6, Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService$$ExternalSyntheticLambda1;

    invoke-direct {v6, v1, p1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService$$ExternalSyntheticLambda1;-><init>(Landroid/content/pm/PackageManager;Ljava/lang/String;)V
    ...
    invoke-static {p1, v1}, Lcom/android/server/utils/Slogf;->e(Ljava/lang/String;Ljava/lang/String;)I
...
.method public notifyUnsafeOperationStateChanged(Landroid/app/admin/DevicePolicySafetyChecker;IZ)V
    ...
    invoke-static {v1, p3, p1, v0}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->access$3900(Lcom/android/server/devicepolicy/DevicePolicyManagerService;Ljava/lang/String;Landroid/os/Bundle;I)V
...
.method public resetOp(ILjava/lang/String;I)V
    ...
    invoke-virtual {p1, p2, v0, p3}, Landroid/content/pm/CrossProfileAppsInternal;->setInteractAcrossProfilesAppOp(Ljava/lang/String;II)V
    ...
    const-string v0, "Unsupported op for DPM reset: "
