...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;Landroid/os/Looper;)V
    ...
    invoke-direct {p3, p0, p1}, Lcom/android/server/DropBoxManagerService$DropBoxManagerInternalImpl;-><init>(Lcom/android/server/DropBoxManagerService;Lcom/android/server/DropBoxManagerService$1;)V
...
.method private dumpProtoLocked(Ljava/io/FileDescriptor;Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/server/DropBoxManagerService;->matchEntry(Lcom/android/server/DropBoxManagerService$EntryFile;Ljava/util/ArrayList;)Z
...
.method private matchEntry(Lcom/android/server/DropBoxManagerService$EntryFile;Ljava/util/ArrayList;)Z
    ...
    iget-object v6, p1, Lcom/android/server/DropBoxManagerService$EntryFile;->tag:Ljava/lang/String;
...
.method private declared-synchronized trimToFit()J
    ...
    const-string v5, "dropbox_reserve_percent"
    ...
    const-string v5, "dropbox_quota_kb"
    ...
    invoke-virtual {v6, v5}, Landroid/os/StatFs;->restat(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :try_start_2
    iget-object v5, p0, Lcom/android/server/DropBoxManagerService;->mStatFs:Landroid/os/StatFs;
    ...
    iget v3, p0, Lcom/android/server/DropBoxManagerService;->mBlockSize:I
    ...
    iget v2, v2, Lcom/android/server/DropBoxManagerService$FileList;->blocks:I
    ...
    iget v5, v2, Lcom/android/server/DropBoxManagerService$EntryFile;->blocks:I
    ...
    iget v6, v2, Lcom/android/server/DropBoxManagerService$EntryFile;->blocks:I
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/DropBoxManagerService$EntryFile;->deleteFile(Ljava/io/File;)V

    new-instance v4, Lcom/android/server/DropBoxManagerService$EntryFile;

    iget-object v5, p0, Lcom/android/server/DropBoxManagerService;->mDropBoxDir:Ljava/io/File;

    iget-object v6, v2, Lcom/android/server/DropBoxManagerService$EntryFile;->tag:Ljava/lang/String;
...
.method public addEntry(Ljava/lang/String;Lcom/android/server/DropBoxManagerInternal$EntrySource;I)V
    ...
    :goto_0
    invoke-direct {p0, v2, p1, p3}, Lcom/android/server/DropBoxManagerService;->createEntry(Ljava/io/File;Ljava/lang/String;I)J
    ...
    invoke-static {v0, p1, p3}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_9
...
.method public declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_3
    invoke-direct {v1, v0, v5}, Lcom/android/server/DropBoxManagerService;->dumpProtoLocked(Ljava/io/FileDescriptor;Ljava/util/ArrayList;)V
    :try_end_3
    ...
    invoke-direct {v1, v11, v5}, Lcom/android/server/DropBoxManagerService;->matchEntry(Lcom/android/server/DropBoxManagerService$EntryFile;Ljava/util/ArrayList;)Z
...
.method public declared-synchronized getNextEntry(Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;)Landroid/os/DropBoxManager$Entry;
    ...
    invoke-direct {p0, v0, p4, p5}, Lcom/android/server/DropBoxManagerService;->checkPermission(ILjava/lang/String;Ljava/lang/String;)Z
