...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;)V
    ...
    const-string p2, "gnss_satellite_blocklist"
    ...
    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
...
.method updateSatelliteBlocklist()V
    ...
    const-string v0, "blocklist string has odd number of values.Aborting updateSatelliteBlocklist"
    ...
    :cond_2
    iget-object v0, p0, Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper;->mCallback:Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;

    invoke-interface {v0, v4, v5}, Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;->onUpdateSatelliteBlocklist([I[I)V
    ...
    const-string v1, "Exception thrown when parsing blocklist string."
