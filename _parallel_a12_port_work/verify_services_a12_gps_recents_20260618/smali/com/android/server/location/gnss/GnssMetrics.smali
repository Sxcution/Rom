...
.method private logCn0L5(Landroid/location/GnssStatus;)V
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssMetrics;->mL5TopFourAverageCn0DbmHzReportsStatistics:Lcom/android/server/location/gnss/GnssMetrics$Statistics;
...
.method public dumpGnssMetricsAsText()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/server/location/gnss/GnssMetrics;->mGnssPowerMetrics:Lcom/android/server/location/gnss/GnssMetrics$GnssPowerMetrics;

    invoke-virtual {v3}, Lcom/android/server/location/gnss/GnssMetrics$GnssPowerMetrics;->getGpsBatteryStats()Landroid/os/connectivity/GpsBatteryStats;
    ...
    invoke-virtual {v3}, Landroid/os/connectivity/GpsBatteryStats;->getLoggingDurationMs()J
    ...
    invoke-virtual {v3}, Landroid/os/connectivity/GpsBatteryStats;->getTimeInGpsSignalQualityLevel()[J
    ...
    invoke-virtual {v3}, Landroid/os/connectivity/GpsBatteryStats;->getEnergyConsumedMaMs()J
    ...
    const-string/jumbo v2, "ro.boot.revision"
...
.method public logCn0(Landroid/location/GnssStatus;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/location/gnss/GnssMetrics$GnssPowerMetrics;->reportSignalQuality([F)V
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssMetrics;->mTopFourAverageCn0DbmHzReportsStatistics:Lcom/android/server/location/gnss/GnssMetrics$Statistics;
...
.method public logPositionAccuracyMeters(F)V
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssMetrics;->mPositionAccuracyMetersReportsStatistics:Lcom/android/server/location/gnss/GnssMetrics$Statistics;

    invoke-virtual {p1, v1, v2}, Lcom/android/server/location/gnss/GnssMetrics$Statistics;->addItem(D)V
...
.method public logReceivedLocationStatus(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssMetrics;->mLocationFailureReportsStatistics:Lcom/android/server/location/gnss/GnssMetrics$Statistics;
...
.method public logTimeToFirstFixMilliSecs(I)V
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssMetrics;->mTimeToFirstFixMilliSReportsStatistics:Lcom/android/server/location/gnss/GnssMetrics$Statistics;
