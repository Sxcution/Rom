...
.method public constructor <init>(Lcom/android/server/location/injector/AppOpsHelper;)V
    ...
    iput-object p1, p0, Lcom/android/server/location/injector/LocationAttributionHelper;->mAttributions:Ljava/util/Map;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/location/injector/LocationAttributionHelper;->mHighPowerAttributions:Ljava/util/Map;
...
.method public declared-synchronized reportHighPowerLocationStart(Landroid/location/util/identity/CallerIdentity;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/location/injector/LocationAttributionHelper;->mAppOpsHelper:Lcom/android/server/location/injector/AppOpsHelper;

    const/16 v2, 0x2a

    invoke-virtual {v0, v2, p1}, Lcom/android/server/location/injector/AppOpsHelper;->startOpNoThrow(ILandroid/location/util/identity/CallerIdentity;)Z
...
.method public declared-synchronized reportHighPowerLocationStop(Landroid/location/util/identity/CallerIdentity;)V
    ...
    const-string/jumbo v2, "stopping high power location attribution for "
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/location/injector/AppOpsHelper;->finishOp(ILandroid/location/util/identity/CallerIdentity;)V
