...
.method public onQueryResponse(ILjava/util/List;)V
    ...
    iget-object p1, p0, Lcom/android/server/location/contexthub/ContextHubService$8;->this$0:Lcom/android/server/location/contexthub/ContextHubService;

    iget v0, p0, Lcom/android/server/location/contexthub/ContextHubService$8;->val$contextHubId:I

    const/4 v1, 0x5

    const/4 v2, -0x1

    invoke-static {p1, v1, v0, v2, p2}, Lcom/android/server/location/contexthub/ContextHubService;->access$900(Lcom/android/server/location/contexthub/ContextHubService;III[B)I
