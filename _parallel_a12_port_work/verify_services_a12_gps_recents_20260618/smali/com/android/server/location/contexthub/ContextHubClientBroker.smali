...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/location/contexthub/IContextHubWrapper;Lcom/android/server/location/contexthub/ContextHubClientManager;Landroid/hardware/location/ContextHubInfo;SLandroid/hardware/location/IContextHubClientCallback;Ljava/lang/String;Lcom/android/server/location/contexthub/ContextHubTransactionManager;Landroid/app/PendingIntent;JLjava/lang/String;)V
    ...
    const-string p2, "android.permission.ACCESS_CONTEXT_HUB"
...
.method private authStateToString(I)Ljava/lang/String;
    ...
    :pswitch_1
    const-string p1, "DENIED_GRACE_PERIOD"
...
.method private createIntent(I)Landroid/content/Intent;
    ...
    iget-object p1, p0, Lcom/android/server/location/contexthub/ContextHubClientBroker;->mAttachedContextHubInfo:Landroid/hardware/location/ContextHubInfo;
...
.method private declared-synchronized sendPendingIntent(Ljava/util/function/Supplier;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->doSendPendingIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized sendPendingIntent(Ljava/util/function/Supplier;J)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->doSendPendingIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method handleAuthStateTimerExpiry(J)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->updateNanoAppAuthState(JLjava/util/List;Z)I
...
.method public synthetic lambda$sendAuthStateCallback$11$ContextHubClientBroker(JI)Landroid/content/Intent;
    ...
    const-string p2, "android.hardware.location.extra.CLIENT_AUTHORIZATION_STATE"
...
.method public synthetic lambda$sendMessageToClient$1$ContextHubClientBroker(JLandroid/hardware/location/NanoAppMessage;)Landroid/content/Intent;
    ...
    const-string p2, "android.hardware.location.extra.MESSAGE"
...
.method sendMessageToClient(Landroid/hardware/location/NanoAppMessage;Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object p2, p0, Lcom/android/server/location/contexthub/ContextHubClientBroker;->mPackage:Ljava/lang/String;

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p2, " in grace period and napp msg has permissions"
    ...
    :cond_1
    new-instance p2, Lcom/android/server/location/contexthub/ContextHubClientBroker$$ExternalSyntheticLambda4;

    invoke-direct {p2, p1}, Lcom/android/server/location/contexthub/ContextHubClientBroker$$ExternalSyntheticLambda4;-><init>(Landroid/hardware/location/NanoAppMessage;)V

    invoke-direct {p0, p2}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->invokeCallback(Lcom/android/server/location/contexthub/ContextHubClientBroker$CallbackConsumer;)V

    new-instance p2, Lcom/android/server/location/contexthub/ContextHubClientBroker$$ExternalSyntheticLambda11;

    invoke-direct {p2, p0, v0, v1, p1}, Lcom/android/server/location/contexthub/ContextHubClientBroker$$ExternalSyntheticLambda11;-><init>(Lcom/android/server/location/contexthub/ContextHubClientBroker;JLandroid/hardware/location/NanoAppMessage;)V

    invoke-direct {p0, p2, v0, v1}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->sendPendingIntent(Ljava/util/function/Supplier;J)V
    ...
    const-string p2, " doesn\'t have permission"
...
.method public sendMessageToNanoApp(Landroid/hardware/location/NanoAppMessage;)I
    ...
    invoke-static {v0, p1}, Lcom/android/server/location/contexthub/ContextHubServiceUtil;->createHidlContextHubMessage(SLandroid/hardware/location/NanoAppMessage;)Landroid/hardware/contexthub/V1_0/ContextHubMsg;
    ...
    :try_start_0
    iget-object v3, p0, Lcom/android/server/location/contexthub/ContextHubClientBroker;->mContextHubProxy:Lcom/android/server/location/contexthub/IContextHubWrapper;

    invoke-virtual {v3}, Lcom/android/server/location/contexthub/IContextHubWrapper;->getHub()Landroid/hardware/contexthub/V1_0/IContexthub;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->authStateToString(I)Ljava/lang/String;
...
.method updateNanoAppAuthState(JLjava/util/List;ZZ)I
    ...
    invoke-direct {p0, p1, p2, v3}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->sendAuthStateCallback(JI)V
