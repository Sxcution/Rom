...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/devicestate/DeviceStatePolicy;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/DisplayThread;->getLooper()Landroid/os/Looper;
    ...
    invoke-direct {p2, p0, v0}, Lcom/android/server/devicestate/DeviceStateManagerService$DeviceStateProviderListener;-><init>(Lcom/android/server/devicestate/DeviceStateManagerService;Lcom/android/server/devicestate/DeviceStateManagerService$1;)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/devicestate/DeviceStateManagerService$BinderService;-><init>(Lcom/android/server/devicestate/DeviceStateManagerService;Lcom/android/server/devicestate/DeviceStateManagerService$1;)V
...
.method private cancelRequestInternal(ILandroid/os/IBinder;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/devicestate/OverrideRequestController;->cancelRequest(Landroid/os/IBinder;)V
...
.method private notifyDeviceStateInfoChangedAsync()V
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/devicestate/DeviceStateManagerService$ProcessRecord;->notifyDeviceStateInfoAsync(Landroid/hardware/devicestate/DeviceStateInfo;)V
...
.method private onOverrideRequestStatusChangedLocked(Lcom/android/server/devicestate/OverrideRequest;I)V
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/devicestate/DeviceStateManagerService$ProcessRecord;->notifyRequestActiveAsync(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/devicestate/DeviceStateManagerService$ProcessRecord;->notifyRequestSuspendedAsync(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/devicestate/DeviceStateManagerService$ProcessRecord;->notifyRequestCanceledAsync(Landroid/os/IBinder;)V
...
.method private registerProcess(ILandroid/hardware/devicestate/IDeviceStateManagerCallback;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/devicestate/DeviceStateManagerService$ProcessRecord;->notifyDeviceStateInfoAsync(Landroid/hardware/devicestate/DeviceStateInfo;)V
    ...
    const-string p2, "The calling process has already registered an IDeviceStateManagerCallback."
...
.method private requestStateInternal(IIILandroid/os/IBinder;)V
    ...
    const-string p4, "Requested state: "
    ...
    const-string p3, "Request has already been made for the supplied token: "
    ...
    const-string p3, " has no registered callback."
...
.method private setBaseState(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/devicestate/DeviceState;->getFlags()I
    ...
    invoke-virtual {p1}, Lcom/android/server/devicestate/OverrideRequestController;->cancelStickyRequests()V

    :cond_1
    iget-object p1, p0, Lcom/android/server/devicestate/DeviceStateManagerService;->mOverrideRequestController:Lcom/android/server/devicestate/OverrideRequestController;

    invoke-virtual {p1}, Lcom/android/server/devicestate/OverrideRequestController;->handleBaseStateChanged()Z
    ...
    const-string v1, "Base state is not supported"
...
.method private updateSupportedStates([Lcom/android/server/devicestate/DeviceState;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/devicestate/OverrideRequestController;->handleNewSupportedStates([I)Z
