...
.method private switchStagingRulesDir()V
    ...
    const-string v2, "Error switching staging/rules directory"
...
.method private updateRuleIndexingController()V
    ...
    const-string v2, "Error parsing the rule indexing file."
...
.method private writeMetadata(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object p2, p0, Lcom/android/server/integrity/IntegrityFileManager;->mRuleMetadataCache:Lcom/android/server/integrity/model/RuleMetadata;

    invoke-static {p2, p1}, Lcom/android/server/integrity/serializer/RuleMetadataSerializer;->serialize(Lcom/android/server/integrity/model/RuleMetadata;Ljava/io/OutputStream;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public readRules(Landroid/content/integrity/AppInstallMetadata;)Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/integrity/IntegrityFileManager;->mRuleParser:Lcom/android/server/integrity/parser/RuleParser;
    ...
    invoke-interface {v2, p1, v1}, Lcom/android/server/integrity/parser/RuleParser;->parse(Lcom/android/server/integrity/parser/RandomAccessObject;Ljava/util/List;)Ljava/util/List;
