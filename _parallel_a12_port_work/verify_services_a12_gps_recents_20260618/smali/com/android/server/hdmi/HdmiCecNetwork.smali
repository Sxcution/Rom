...
.method private handleCecVersion(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/hdmi/HdmiCecNetwork;->updateDeviceCecVersion(II)V
...
.method private handleDeviceVendorId(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    const-string v1, "Unknown source device info for <Device Vendor ID> "
...
.method private handleReportPhysicalAddress(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-virtual {p0, v0, v6, v4}, Lcom/android/server/hdmi/HdmiCecNetwork;->updateCecSwitchInfo(III)Z
    ...
    const-string v1, "Unknown source device info for <Report Physical Address> "
...
.method private handleSetOsdName(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    const-string v2, "Updating device OSD name from "
    ...
    const-string v3, "Invalid <Set Osd Name> request:"
...
.method private hideDevicesBehindLegacySwitch(Landroid/hardware/hdmi/HdmiDeviceInfo;)Z
    ...
    invoke-static {p1, v1}, Lcom/android/server/hdmi/HdmiCecNetwork;->isConnectedToCecSwitch(ILjava/util/Collection;)Z
...
.method private updateDeviceCecVersion(II)V
    ...
    const-string v0, "Can not update CEC version of non-existing device:"
...
.method getDeviceInfoList(Z)Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/hdmi/HdmiCecNetwork;->mDeviceInfos:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/hdmi/HdmiCecNetwork;->isLocalDeviceAddress(I)Z
...
.method public handleCecMessage(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/hdmi/HdmiCecNetwork;->getCecDeviceInfo(I)Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-virtual {p0, v7}, Lcom/android/server/hdmi/HdmiCecNetwork;->addCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
...
.method physicalAddressToPortId(I)I
    ...
    iget-object v0, p0, Lcom/android/server/hdmi/HdmiCecNetwork;->mPortIdMap:Lcom/android/server/hdmi/UnmodifiableSparseIntArray;
...
.method final removeCecDevice(Lcom/android/server/hdmi/HdmiCecLocalDevice;I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/hdmi/HdmiCecNetwork;->invokeDeviceEventListener(Landroid/hardware/hdmi/HdmiDeviceInfo;I)V
...
.method final updateCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/hdmi/HdmiCecNetwork;->invokeDeviceEventListener(Landroid/hardware/hdmi/HdmiDeviceInfo;I)V
