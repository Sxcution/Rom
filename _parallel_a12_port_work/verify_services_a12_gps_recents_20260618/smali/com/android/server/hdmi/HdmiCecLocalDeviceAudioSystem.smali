...
.method protected constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    iput-object v0, p0, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;->mDelayedMessageBuffer:Lcom/android/server/hdmi/DelayedMessageBuffer;
...
.method private getSupportedShortAudioDescriptorsFromConfig(Ljava/util/List;[I)[B
    ...
    const-string/jumbo v1, "sadConfig.xml does not have required device info for "
...
.method private getSystemAudioDeviceInfo()Landroid/media/AudioDeviceInfo;
    ...
    sget-object v9, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem$$ExternalSyntheticLambda0;
...
.method private handleRoutingChangeAndInformationForSwitch(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    const-string v2, "HdmiCecLocalDeviceAudioSystem#handleRoutingChangeAndInformationForSwitch()"

    invoke-virtual {v0, p1, v1, v2}, Lcom/android/server/hdmi/HdmiControlService;->setAndBroadcastActiveSourceFromOneDeviceType(IILjava/lang/String;)V
...
.method private setSystemAudioMode(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;->hasAction(Ljava/lang/Class;)Z
...
.method protected handleGiveSystemAudioModeStatus(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    invoke-static {v2, p1, v0}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildReportSystemAudioMode(IIZ)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method protected handleRequestArcTermination(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    const-string v1, "ARC is not established between TV and AVR device"
...
.method protected handleRequestShortAudioDescriptor(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    invoke-static {v2, p1, v0}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildReportShortAudioDescriptor(II[B)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method handleSystemAudioModeOnFromNonTvDevice(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    const-string v0, "Cannot turn onsystem audio mode because the System Audio Control feature is disabled."
    ...
    invoke-static {v2, v3, p1}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildSetSystemAudioMode(IIZ)Lcom/android/server/hdmi/HdmiCecMessage;
