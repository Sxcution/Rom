...
.method private configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;)V
    ...
    invoke-direct {p0, p1, v1, p2, v0}, Lcom/android/server/display/DisplayManagerService;->populateViewportLocked(IILcom/android/server/display/DisplayDevice;Lcom/android/server/display/DisplayDeviceInfo;)V
...
.method private createVirtualDisplayInternal(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Landroid/view/Surface;ILandroid/hardware/display/VirtualDisplayConfig;)I
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/android/server/display/VirtualDisplayAdapter;->createVirtualDisplayLocked(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Landroid/view/Surface;ILandroid/hardware/display/VirtualDisplayConfig;)Lcom/android/server/display/DisplayDevice;
    ...
    :cond_1
    iget-object v3, v0, Lcom/android/server/display/DisplayManagerService;->mDisplayDeviceRepo:Lcom/android/server/display/DisplayDeviceRepository;

    const/4 v4, 0x1

    invoke-virtual {v3, v2, v4}, Lcom/android/server/display/DisplayDeviceRepository;->onDisplayDeviceEvent(Lcom/android/server/display/DisplayDevice;I)V
    ...
    iget-object v3, v0, Lcom/android/server/display/DisplayManagerService;->mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;

    invoke-interface {p1}, Landroid/hardware/display/IVirtualDisplayCallback;->asBinder()Landroid/os/IBinder;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/android/server/display/VirtualDisplayAdapter;->releaseVirtualDisplayLocked(Landroid/os/IBinder;)Lcom/android/server/display/DisplayDevice;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/server/display/DisplayDeviceRepository;->onDisplayDeviceEvent(Lcom/android/server/display/DisplayDevice;I)V
...
.method private deliverDisplayGroupEvent(II)V
    ...
    :pswitch_0
    iget-object p2, p0, Lcom/android/server/display/DisplayManagerService;->mDisplayGroupListeners:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    check-cast v0, Landroid/hardware/display/DisplayManagerInternal$DisplayGroupListener;

    invoke-interface {v0, p1}, Landroid/hardware/display/DisplayManagerInternal$DisplayGroupListener;->onDisplayGroupRemoved(I)V
    ...
    invoke-interface {v0, p1}, Landroid/hardware/display/DisplayManagerInternal$DisplayGroupListener;->onDisplayGroupChanged(I)V
    ...
    invoke-interface {v0, p1}, Landroid/hardware/display/DisplayManagerInternal$DisplayGroupListener;->onDisplayGroupAdded(I)V
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v4, p1, v1}, Lcom/android/server/display/DisplayManagerService$$ExternalSyntheticLambda8;-><init>(Ljava/io/PrintWriter;Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method private getBrightnessConfigForDisplayWithPdsFallbackLocked(Ljava/lang/String;I)Landroid/hardware/display/BrightnessConfiguration;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/display/PersistentDataStore;->getBrightnessConfiguration(I)Landroid/hardware/display/BrightnessConfiguration;
...
.method private getDisplayInfoForFrameRateOverride([Landroid/view/DisplayEventReceiver$FrameRateOverride;Landroid/view/DisplayInfo;I)Landroid/view/DisplayInfo;
    ...
    iput p2, p1, Landroid/view/DisplayInfo;->refreshRateOverride:F
    ...
    iput p2, p1, Landroid/view/DisplayInfo;->modeId:I
    ...
    :cond_7
    iget-boolean v1, p0, Lcom/android/server/display/DisplayManagerService;->mAllowNonNativeRefreshRateOverride:Z
    ...
    iget-object p3, p2, Landroid/view/DisplayInfo;->supportedModes:[Landroid/view/Display$Mode;
    ...
    iput-object p2, p1, Landroid/view/DisplayInfo;->supportedModes:[Landroid/view/Display$Mode;

    iget-object p2, p1, Landroid/view/DisplayInfo;->supportedModes:[Landroid/view/Display$Mode;

    iget-object p3, p1, Landroid/view/DisplayInfo;->supportedModes:[Landroid/view/Display$Mode;
    ...
    iget v4, p1, Landroid/view/DisplayInfo;->refreshRateOverride:F

    invoke-direct {v1, v2, v3, v0, v4}, Landroid/view/Display$Mode;-><init>(IIIF)V
...
.method private getDisplayInfoInternal(II)Landroid/view/DisplayInfo;
    ...
    invoke-direct {p0, v2, v1, p2}, Lcom/android/server/display/DisplayManagerService;->getDisplayInfoForFrameRateOverride([Landroid/view/DisplayEventReceiver$FrameRateOverride;Landroid/view/DisplayInfo;I)Landroid/view/DisplayInfo;
...
.method private handleLogicalDisplayChangedLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/display/DisplayManagerService;->sendDisplayEventLocked(II)V
    ...
    iget-object p1, p0, Lcom/android/server/display/DisplayManagerService;->mDisplayPowerControllers:Landroid/util/SparseArray;
    ...
    invoke-virtual {p1}, Lcom/android/server/display/DisplayPowerController;->onDisplayChanged()V
...
.method private handleLogicalDisplayDeviceStateTransitionLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/display/DisplayPowerController;->onDeviceStateTransition()V
...
.method private handleLogicalDisplayFrameRateOverridesChangedLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/display/DisplayManagerService;->sendDisplayEventFrameRateOverrideLocked(I)V
...
.method private handleLogicalDisplaySwappedLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;->post(Ljava/lang/Runnable;)Z
...
.method private populateViewportLocked(IILcom/android/server/display/DisplayDevice;Lcom/android/server/display/DisplayDeviceInfo;)V
    ...
    iget p2, p4, Lcom/android/server/display/DisplayDeviceInfo;->state:I

    invoke-static {p2}, Landroid/view/Display;->isActiveState(I)Z

    move-result p2

    iput-boolean p2, p1, Landroid/hardware/display/DisplayViewport;->isActive:Z
...
.method private releaseVirtualDisplayInternal(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/display/DisplayDeviceRepository;->onDisplayDeviceEvent(Lcom/android/server/display/DisplayDevice;I)V
...
.method private requestDisplayStateInternal(IIFF)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/display/DisplayManagerService;->updateDisplayStateLocked(Lcom/android/server/display/DisplayDevice;)Ljava/lang/Runnable;
...
.method private sendDisplayEventFrameRateOverrideLocked(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private setAreUserDisabledHdrTypesAllowedInternal(Z)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/display/DisplayManagerService$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/display/DisplayManagerService;[I)V
...
.method private setUserDisabledHdrTypesInternal([I)V
    ...
    const-string v1, "Null is not an expected argument to setUserDisabledHdrTypesInternal"
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/display/DisplayManagerService$$ExternalSyntheticLambda7;-><init>(Lcom/android/server/display/DisplayManagerService;[I)V
...
.method private systemScreenshotInternal(I)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    invoke-virtual {v2, v1, p1}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setSize(II)Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;

    move-result-object p1

    const/4 v1, 0x1

    invoke-virtual {p1, v1}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setUseIdentityTransform(Z)Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setCaptureSecureLayers(Z)Landroid/view/SurfaceControl$CaptureArgs$Builder;

    move-result-object p1

    check-cast p1, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;

    invoke-virtual {p1, v1}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setAllowProtected(Z)Landroid/view/SurfaceControl$CaptureArgs$Builder;
...
.method private updateDisplayStateLocked(Lcom/android/server/display/DisplayDevice;)Ljava/lang/Runnable;
    ...
    iget v1, v0, Lcom/android/server/display/DisplayManagerService$BrightnessPair;->brightness:F

    iget v0, v0, Lcom/android/server/display/DisplayManagerService$BrightnessPair;->sdrBrightness:F

    invoke-virtual {p1, v2, v1, v0}, Lcom/android/server/display/DisplayDevice;->requestDisplayStateLocked(IFF)Ljava/lang/Runnable;
...
.method private updateViewportPowerStateLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/display/DisplayManagerService;->getViewportType(Lcom/android/server/display/DisplayDeviceInfo;)Ljava/util/Optional;
...
.method private userScreenshotInternal(I)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    invoke-direct {v1, p1}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;-><init>(Landroid/os/IBinder;)V
...
.method public synthetic lambda$onUserSwitching$0$DisplayManagerService(ZIILcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/display/DisplayPowerController;->setBrightnessConfiguration(Landroid/hardware/display/BrightnessConfiguration;)V
...
.method public synthetic lambda$performTraversalLocked$4$DisplayManagerService(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;)V
...
.method public synthetic lambda$resetBrightnessConfigurations$5$DisplayManagerService(Lcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, v0, p1, v1, v2}, Lcom/android/server/display/DisplayManagerService;->setBrightnessConfigurationForDisplayInternal(Landroid/hardware/display/BrightnessConfiguration;Ljava/lang/String;ILjava/lang/String;)V
...
.method public onUserSwitching(Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$TargetUser;)V
    ...
    invoke-direct {v3, p0, v1, p2, p1}, Lcom/android/server/display/DisplayManagerService$$ExternalSyntheticLambda5;-><init>(Lcom/android/server/display/DisplayManagerService;ZII)V
