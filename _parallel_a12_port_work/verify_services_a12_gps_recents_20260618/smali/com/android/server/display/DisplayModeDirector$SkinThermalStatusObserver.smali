...
.method public notifyThrottling(Landroid/os/Temperature;)V
    ...
    invoke-static {p1}, Lcom/android/server/display/DisplayModeDirector;->access$2500(Lcom/android/server/display/DisplayModeDirector;)Z
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/display/DisplayModeDirector$SkinThermalStatusObserver;->mBallotBox:Lcom/android/server/display/DisplayModeDirector$BallotBox;

    const/4 v1, -0x1

    const/16 v2, 0xa

    invoke-interface {v0, v1, v2, p1}, Lcom/android/server/display/DisplayModeDirector$BallotBox;->vote(IILcom/android/server/display/DisplayModeDirector$Vote;)V
