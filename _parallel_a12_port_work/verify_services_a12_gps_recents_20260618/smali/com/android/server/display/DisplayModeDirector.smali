...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/DisplayModeDirector$Injector;)V
    ...
    invoke-direct {p2, p0, v0}, Lcom/android/server/display/DisplayModeDirector$UdfpsObserver;-><init>(Lcom/android/server/display/DisplayModeDirector;Lcom/android/server/display/DisplayModeDirector$1;)V
    ...
    iput-object p1, p0, Lcom/android/server/display/DisplayModeDirector;->mDeviceConfig:Lcom/android/server/utils/DeviceConfigInterface;
...
.method static synthetic access$2600(Lcom/android/server/display/DisplayModeDirector;)Lcom/android/server/utils/DeviceConfigInterface;
    ...
    iget-object p0, p0, Lcom/android/server/display/DisplayModeDirector;->mDeviceConfig:Lcom/android/server/utils/DeviceConfigInterface;
...
.method private summarizeVotes(Landroid/util/SparseArray;IILcom/android/server/display/DisplayModeDirector$VoteSummary;)V
    ...
    check-cast v0, Lcom/android/server/display/DisplayModeDirector$Vote;
    ...
    :cond_0
    iget v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->minRefreshRate:F

    iget-object v2, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->refreshRateRange:Landroid/hardware/display/DisplayManagerInternal$RefreshRateRange;
    ...
    iput v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->minRefreshRate:F

    iget v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->maxRefreshRate:F

    iget-object v2, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->refreshRateRange:Landroid/hardware/display/DisplayManagerInternal$RefreshRateRange;

    iget v2, v2, Landroid/hardware/display/DisplayManagerInternal$RefreshRateRange;->max:F

    invoke-static {v1, v2}, Ljava/lang/Math;->min(FF)F

    move-result v1

    iput v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->maxRefreshRate:F

    iget v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->height:I

    const/4 v2, -0x1

    if-ne v1, v2, :cond_1

    iget v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->width:I

    if-ne v1, v2, :cond_1

    iget v1, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->height:I

    if-lez v1, :cond_1

    iget v1, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->width:I
    ...
    iput v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->height:I

    :cond_1
    iget-boolean v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->disableRefreshRateSwitching:Z

    if-nez v1, :cond_2

    iget-boolean v1, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->disableRefreshRateSwitching:Z

    if-eqz v1, :cond_2

    const/4 v1, 0x1

    iput-boolean v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->disableRefreshRateSwitching:Z

    :cond_2
    iget v1, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->baseModeRefreshRate:F
    ...
    iget v1, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->baseModeRefreshRate:F

    cmpl-float v1, v1, v2

    if-lez v1, :cond_3

    iget v0, v0, Lcom/android/server/display/DisplayModeDirector$Vote;->baseModeRefreshRate:F

    iput v0, p4, Lcom/android/server/display/DisplayModeDirector$VoteSummary;->baseModeRefreshRate:F
...
.method private updateVoteLocked(IILcom/android/server/display/DisplayModeDirector$Vote;)V
    ...
    invoke-static {v2, p1, p2}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public getDesiredDisplayModeSpecs(I)Lcom/android/server/display/DisplayModeDirector$DesiredDisplayModeSpecs;
    ...
    invoke-direct {v0, v3, v8, v11, v7}, Lcom/android/server/display/DisplayModeDirector;->summarizeVotes(Landroid/util/SparseArray;IILcom/android/server/display/DisplayModeDirector$VoteSummary;)V
    ...
    :cond_3
    invoke-direct {v0, v4, v7}, Lcom/android/server/display/DisplayModeDirector;->filterModes([Landroid/view/Display$Mode;Lcom/android/server/display/DisplayModeDirector$VoteSummary;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3, v11, v9, v8}, Lcom/android/server/display/DisplayModeDirector;->summarizeVotes(Landroid/util/SparseArray;IILcom/android/server/display/DisplayModeDirector$VoteSummary;)V
...
.method getVote(II)Lcom/android/server/display/DisplayModeDirector$Vote;
    ...
    check-cast p1, Lcom/android/server/display/DisplayModeDirector$Vote;
