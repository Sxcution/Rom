...
.method constructor <init>(Lcom/android/server/display/HighBrightnessModeController$Injector;Landroid/os/Handler;IILandroid/os/IBinder;FFLcom/android/server/display/DisplayDeviceConfig$HighBrightnessModeData;Ljava/lang/Runnable;Landroid/content/Context;)V
    ...
    iput-object p10, p0, Lcom/android/server/display/HighBrightnessModeController;->mClock:Lcom/android/server/display/DisplayManagerService$Clock;
    ...
    new-instance p6, Lcom/android/server/display/HighBrightnessModeController$SkinThermalStatusObserver;

    invoke-direct {p6, p0, p1, p2}, Lcom/android/server/display/HighBrightnessModeController$SkinThermalStatusObserver;-><init>(Lcom/android/server/display/HighBrightnessModeController;Lcom/android/server/display/HighBrightnessModeController$Injector;Landroid/os/Handler;)V

    iput-object p6, p0, Lcom/android/server/display/HighBrightnessModeController;->mSkinThermalStatusObserver:Lcom/android/server/display/HighBrightnessModeController$SkinThermalStatusObserver;
...
.method private calculateRemainingTime(J)J
    ...
    iget-wide p1, p1, Lcom/android/server/display/DisplayDeviceConfig$HighBrightnessModeData;->timeMaxMillis:J
...
.method private dumpHbmEvent(Ljava/io/PrintWriter;Lcom/android/server/display/HighBrightnessModeController$HbmEvent;)J
    ...
    iget-wide p1, p2, Lcom/android/server/display/HighBrightnessModeController$HbmEvent;->startTimeMillis:J
...
.method private dumpLocal(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/server/display/HighBrightnessModeController;->dumpHbmEvent(Ljava/io/PrintWriter;Lcom/android/server/display/HighBrightnessModeController$HbmEvent;)J
    ...
    :cond_3
    invoke-direct {p0, p1, v3}, Lcom/android/server/display/HighBrightnessModeController;->dumpHbmEvent(Ljava/io/PrintWriter;Lcom/android/server/display/HighBrightnessModeController$HbmEvent;)J
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/display/HighBrightnessModeController$SkinThermalStatusObserver;->dump(Ljava/io/PrintWriter;)V
...
.method private recalculateTimeAllowance()V
    ...
    iget-wide v7, v4, Lcom/android/server/display/DisplayDeviceConfig$HighBrightnessModeData;->timeWindowMillis:J
    ...
    check-cast v4, Lcom/android/server/display/HighBrightnessModeController$HbmEvent;

    iget-wide v9, v4, Lcom/android/server/display/HighBrightnessModeController$HbmEvent;->startTimeMillis:J
    ...
    iget-wide v11, v4, Lcom/android/server/display/DisplayDeviceConfig$HighBrightnessModeData;->timeMinMillis:J
...
.method private updateHbmMode()V
    ...
    iget-object v0, p0, Lcom/android/server/display/HighBrightnessModeController;->mHbmChangeCallback:Ljava/lang/Runnable;
...
.method onBrightnessChanged(F)V
    ...
    :cond_3
    iget-object p1, p0, Lcom/android/server/display/HighBrightnessModeController;->mEvents:Ljava/util/LinkedList;

    new-instance v0, Lcom/android/server/display/HighBrightnessModeController$HbmEvent;

    iget-wide v6, p0, Lcom/android/server/display/HighBrightnessModeController;->mRunningStartTimeMillis:J

    invoke-direct {v0, v6, v7, v4, v5}, Lcom/android/server/display/HighBrightnessModeController$HbmEvent;-><init>(JJ)V
...
.method resetHbmData(IILandroid/os/IBinder;Lcom/android/server/display/DisplayDeviceConfig$HighBrightnessModeData;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/display/HighBrightnessModeController$SettingsObserver;->startObserving()V
