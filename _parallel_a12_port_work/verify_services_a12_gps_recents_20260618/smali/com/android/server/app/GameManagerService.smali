...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/android/server/app/GameManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iput-object p1, p0, Lcom/android/server/app/GameManagerService;->mPlatformCompat:Lcom/android/internal/compat/IPlatformCompat;
...
.method private enableCompatScale(Ljava/lang/String;J)V
    ...
    :try_start_1
    iget-object p3, p0, Lcom/android/server/app/GameManagerService;->mPlatformCompat:Lcom/android/internal/compat/IPlatformCompat;

    invoke-interface {p3, p2, p1}, Lcom/android/internal/compat/IPlatformCompat;->putOverridesOnReleaseBuilds(Lcom/android/internal/compat/CompatibilityOverrideConfig;Ljava/lang/String;)V
    :try_end_1
...
.method private getGameModeFromSettings(Ljava/lang/String;I)I
    ...
    check-cast p2, Lcom/android/server/app/GameManagerSettings;

    invoke-virtual {p2, p1}, Lcom/android/server/app/GameManagerSettings;->getGameModeLocked(Ljava/lang/String;)I
...
.method private getInstalledGamePackageNames(I)[Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda2;

    invoke-interface {p1, v0}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object p1

    sget-object v0, Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda0;

    invoke-interface {p1, v0}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p1

    sget-object v0, Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/app/GameManagerService$$ExternalSyntheticLambda1;
...
.method private updateCompatModeDownscale(Ljava/lang/String;I)V
    ...
    const-string v3, "Game mode "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p2, " not found for "
    ...
    :cond_3
    invoke-virtual {v1}, Lcom/android/server/app/GameManagerService$GamePackageConfiguration$GameModeConfiguration;->getCompatChangeId()J
    ...
    const-string v4, "Invalid downscaling change id "
    ...
    :cond_4
    invoke-direct {p0, p1, v1, v2}, Lcom/android/server/app/GameManagerService;->enableCompatScale(Ljava/lang/String;J)V
...
.method public disableCompatScale(Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object v3, p0, Lcom/android/server/app/GameManagerService;->mPlatformCompat:Lcom/android/internal/compat/IPlatformCompat;

    invoke-interface {v3, v4, p1}, Lcom/android/internal/compat/IPlatformCompat;->putOverridesOnReleaseBuilds(Lcom/android/internal/compat/CompatibilityOverrideConfig;Ljava/lang/String;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public getAngleEnabled(Ljava/lang/String;I)Z
    ...
    check-cast p1, Lcom/android/server/app/GameManagerService$GamePackageConfiguration;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/app/GameManagerService$GamePackageConfiguration;->getGameModeConfiguration(I)Lcom/android/server/app/GameManagerService$GamePackageConfiguration$GameModeConfiguration;
    ...
    :cond_2
    invoke-virtual {p1}, Lcom/android/server/app/GameManagerService$GamePackageConfiguration$GameModeConfiguration;->getUseAngle()Z
...
.method public setGameMode(Ljava/lang/String;II)V
    ...
    invoke-virtual {v3, v2, p3}, Landroid/os/Handler;->hasEqualMessages(ILjava/lang/Object;)Z

    move-result p3

    if-nez p3, :cond_2

    iget-object p3, p0, Lcom/android/server/app/GameManagerService;->mHandler:Landroid/os/Handler;

    const-wide/16 v2, 0x2710

    invoke-virtual {p3, v1, v2, v3}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public varargs updateConfigsForUser(I[Ljava/lang/String;)V
    ...
    :try_start_4
    invoke-static {v6}, Lcom/android/server/app/GameManagerService$GamePackageConfiguration;->access$1000(Lcom/android/server/app/GameManagerService$GamePackageConfiguration;)I
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/server/app/GameManagerService;->bitFieldContainsModeBitmask(II)Z
    ...
    invoke-direct {p0, v5, v7}, Lcom/android/server/app/GameManagerService;->bitFieldContainsModeBitmask(II)Z
    ...
    invoke-virtual {p0, v3, v7, p1}, Lcom/android/server/app/GameManagerService;->setGameMode(Ljava/lang/String;II)V
    ...
    const-string v2, "Failed to update compat modes for user "
