...
.method private ensureRemoteServiceLocked(Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;)Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;
    ...
    iget-object p1, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;

    check-cast p1, Lcom/android/server/musicrecognition/MusicRecognitionManagerService;

    iget-boolean p1, p1, Lcom/android/server/musicrecognition/MusicRecognitionManagerService;->verbose:Z
    ...
    iget v5, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mUserId:I
    ...
    invoke-virtual {p1}, Lcom/android/server/musicrecognition/MusicRecognitionManagerService;->isBindInstantServiceAllowed()Z
    ...
    iget-boolean v9, p1, Lcom/android/server/musicrecognition/MusicRecognitionManagerService;->verbose:Z
    ...
    invoke-virtual {v0}, Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;->getComponentName()Landroid/content/ComponentName;
    ...
    invoke-virtual {v1}, Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;->getComponentName()Landroid/content/ComponentName;
...
.method private startRecordAudioOp(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mServiceInfo:Landroid/content/pm/ServiceInfo;
    ...
    iget-object v0, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mServiceInfo:Landroid/content/pm/ServiceInfo;
...
.method private streamAudio(Landroid/media/musicrecognition/RecognitionRequest;ILandroid/media/AudioRecord;Ljava/io/OutputStream;)V
    ...
    const-string p3, "Streamed %s bytes from audio record"
...
.method private streamAudio(Ljava/lang/String;Landroid/media/musicrecognition/RecognitionRequest;Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;Landroid/os/ParcelFileDescriptor;)V
    ...
    const-string p2, "No audio requested. Closing stream."
    ...
    const-string p3, "Problem closing stream."
    ...
    :try_start_b
    invoke-interface {p3, p1}, Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;->onRecognitionFailed(I)V
    :try_end_b
...
.method public beginRecognitionLocked(Landroid/media/musicrecognition/RecognitionRequest;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->ensureRemoteServiceLocked(Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;)Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;
    ...
    :try_start_0
    invoke-interface {p2, p1}, Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;->onRecognitionFailed(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object p2, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    iget-object p2, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerPerUserService;->mRemoteService:Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;

    invoke-virtual {p1}, Landroid/media/musicrecognition/RecognitionRequest;->getAudioFormat()Landroid/media/AudioFormat;

    move-result-object p1

    invoke-virtual {p2, v0, p1}, Lcom/android/server/musicrecognition/RemoteMusicRecognitionService;->onAudioStreamStarted(Landroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;)V
...
.method protected newServiceInfoLocked(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;
    ...
    const-string v1, "android.permission.BIND_MUSIC_RECOGNITION_SERVICE"
    ...
    const-string v3, "MusicRecognitionService from \'"
    ...
    const-string v0, "Service does not require permission android.permission.BIND_MUSIC_RECOGNITION_SERVICE"
