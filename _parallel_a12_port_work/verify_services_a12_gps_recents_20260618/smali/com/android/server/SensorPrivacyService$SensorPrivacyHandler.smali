...
.method private addDeathRecipient(Landroid/hardware/ISensorPrivacyListener;)V
    ...
    new-instance v2, Lcom/android/server/SensorPrivacyService$DeathRecipient;

    iget-object v3, p0, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler;->this$0:Lcom/android/server/SensorPrivacyService;

    invoke-direct {v2, v3, p1}, Lcom/android/server/SensorPrivacyService$DeathRecipient;-><init>(Lcom/android/server/SensorPrivacyService;Landroid/hardware/ISensorPrivacyListener;)V
    ...
    check-cast v0, Lcom/android/server/SensorPrivacyService$DeathRecipient;
...
.method static synthetic lambda$onSensorPrivacyChanged$0(Ljava/lang/Object;)V
    ...
    check-cast p0, Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;

    invoke-static {p0}, Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;->access$2600(Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;)V
...
.method static synthetic lambda$removeSuppressPackageReminderToken$2(Ljava/lang/Object;Landroid/util/Pair;Landroid/os/IBinder;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;->access$3100(Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;Landroid/util/Pair;Landroid/os/IBinder;)V
...
.method private removeDeathRecipient(Landroid/hardware/ISensorPrivacyListener;)V
    ...
    check-cast p1, Lcom/android/server/SensorPrivacyService$DeathRecipient;

    invoke-virtual {p1}, Lcom/android/server/SensorPrivacyService$DeathRecipient;->destroy()V
...
.method public handleSensorPrivacyChanged(IIZ)V
    ...
    :try_start_1
    invoke-interface {v1, p3}, Landroid/hardware/ISensorPrivacyListener;->onSensorPrivacyChanged(Z)V
    :try_end_1
...
.method public handleSensorPrivacyChanged(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler;->mListeners:Landroid/os/RemoteCallbackList;
...
.method public handleUserGlobalSensorPrivacyChanged(IZ)V
    ...
    :try_start_1
    invoke-interface {v2, p2}, Landroid/hardware/ISensorPrivacyListener;->onSensorPrivacyChanged(Z)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onSensorPrivacyChanged(IIZ)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler;->sendMessage(Landroid/os/Message;)Z

    sget-object p1, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler$$ExternalSyntheticLambda5;

    iget-object p2, p0, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler;->this$0:Lcom/android/server/SensorPrivacyService;

    invoke-static {p2}, Lcom/android/server/SensorPrivacyService;->access$2700(Lcom/android/server/SensorPrivacyService;)Lcom/android/server/SensorPrivacyService$SensorPrivacyServiceImpl;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/android/internal/util/function/pooled/PooledLambda;->obtainMessage(Ljava/util/function/Consumer;Ljava/lang/Object;)Landroid/os/Message;
...
.method public onSensorPrivacyChanged(Z)V
    ...
    sget-object p1, Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/SensorPrivacyService$SensorPrivacyHandler$$ExternalSyntheticLambda4;
    ...
    invoke-static {p1, v0}, Lcom/android/internal/util/function/pooled/PooledLambda;->obtainMessage(Ljava/util/function/Consumer;Ljava/lang/Object;)Landroid/os/Message;
