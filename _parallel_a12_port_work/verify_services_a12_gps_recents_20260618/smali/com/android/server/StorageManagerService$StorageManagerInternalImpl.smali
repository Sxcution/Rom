...
.method private killAppForOpChange(II)V
    ...
    invoke-interface {v0, p2, v1, p1}, Landroid/app/IActivityManager;->killUid(IILjava/lang/String;)V
    :try_end_0
...
.method public freeCache(Ljava/lang/String;J)V
    ...
    const-string v0, "Failed to free cache of vol : "
...
.method public onAppOpsChanged(IILjava/lang/String;II)V
    ...
    :sswitch_1
    :try_start_1
    iget-object p1, p0, Lcom/android/server/StorageManagerService$StorageManagerInternalImpl;->this$0:Lcom/android/server/StorageManagerService;
    ...
    :goto_0
    invoke-static {p1, p3, p2, p4}, Lcom/android/server/StorageManagerService;->access$4700(Lcom/android/server/StorageManagerService;Ljava/lang/String;IZ)V
    :try_end_1
...
.method public prepareStorageDirs(ILjava/util/Set;Ljava/lang/String;)Z
    ...
    invoke-static {v7}, Lcom/android/server/StorageManagerService;->access$6300(Lcom/android/server/StorageManagerService;)Landroid/content/pm/PackageManagerInternal;
    ...
    const-string v1, "Unable to create obb and data directories for "
...
.method public resetUser(I)V
    ...
    invoke-static {p1}, Lcom/android/server/StorageManagerService;->access$2800(Lcom/android/server/StorageManagerService;)Landroid/os/Handler;
