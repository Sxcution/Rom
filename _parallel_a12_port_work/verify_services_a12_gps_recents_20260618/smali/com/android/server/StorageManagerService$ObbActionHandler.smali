...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Lcom/android/server/StorageManagerService;->access$5700(Lcom/android/server/StorageManagerService;)Ljava/util/Map;
    ...
    iget-object v4, v3, Lcom/android/server/StorageManagerService$ObbState;->canonicalPath:Ljava/lang/String;
    ...
    :try_start_1
    iget-object v2, v1, Lcom/android/server/StorageManagerService$ObbState;->token:Landroid/os/storage/IObbActionListener;

    iget-object v3, v1, Lcom/android/server/StorageManagerService$ObbState;->rawPath:Ljava/lang/String;

    iget v4, v1, Lcom/android/server/StorageManagerService$ObbState;->nonce:I

    const/4 v5, 0x2

    invoke-interface {v2, v3, v4, v5}, Landroid/os/storage/IObbActionListener;->onObbResult(Ljava/lang/String;II)V
    :try_end_1
    ...
    const-string v4, "Couldn\'t send unmount notification for  OBB: "
