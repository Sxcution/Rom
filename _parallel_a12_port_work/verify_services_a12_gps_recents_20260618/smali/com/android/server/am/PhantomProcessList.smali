...
.method private addChildPidLocked(Lcom/android/server/am/ProcessRecord;II)V
    ...
    :cond_4
    :goto_1
    iget-object p1, p0, Lcom/android/server/am/PhantomProcessList;->mPhantomToAppProcessMap:Landroid/util/SparseArray;
...
.method private lookForPhantomProcessesLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {p0, p1, v6, v0}, Lcom/android/server/am/PhantomProcessList;->addChildPidLocked(Lcom/android/server/am/ProcessRecord;II)V
    ...
    iget-object p1, p0, Lcom/android/server/am/PhantomProcessList;->mCgroupProcsFds:Landroid/util/SparseArray;
...
.method private onPhantomProcessFdEvent(Ljava/io/FileDescriptor;I)I
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/am/PhantomProcessRecord;->onProcDied(Z)V
    ...
    invoke-virtual {p1, p2, v2}, Lcom/android/server/am/PhantomProcessRecord;->killLocked(Ljava/lang/String;Z)V
...
.method dumpPhantomeProcessLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/util/SparseArray;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/am/PhantomProcessRecord;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/am/PhantomProcessRecord;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method getOrCreatePhantomProcessIfNeededLocked(Ljava/lang/String;IIZ)Lcom/android/server/am/PhantomProcessRecord;
    ...
    invoke-direct {v8, p0}, Lcom/android/server/am/PhantomProcessList$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/am/PhantomProcessList;)V
    ...
    new-instance p4, Lcom/android/server/am/PhantomProcessList$$ExternalSyntheticLambda0;

    invoke-direct {p4, p0}, Lcom/android/server/am/PhantomProcessList$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/am/PhantomProcessList;)V
...
.method killPhantomProcessGroupLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/PhantomProcessRecord;IILjava/lang/String;)V
    ...
    invoke-virtual {v4, p5, v2}, Lcom/android/server/am/PhantomProcessRecord;->killLocked(Ljava/lang/String;Z)V
    ...
    const-string v6, "Caused by siling process: "
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/am/PhantomProcessRecord;->killLocked(Ljava/lang/String;Z)V
    ...
    const-string v0, "Caused by child process: "
    ...
    invoke-virtual {p1, p2, p3, p4, v2}, Lcom/android/server/am/ProcessRecord;->killLocked(Ljava/lang/String;IIZ)V
