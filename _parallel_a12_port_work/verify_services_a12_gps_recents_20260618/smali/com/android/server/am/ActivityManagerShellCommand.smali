...
.method private runCompat(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v2, v6}, Lcom/android/server/compat/PlatformCompat;->lookupChangeId(Ljava/lang/String;)J
    ...
    invoke-virtual {v2, v9, v10}, Lcom/android/server/compat/PlatformCompat;->isKnownChangeId(J)Z
    ...
    :goto_3
    const-string v8, " changes gated by targetSdkVersion "
    ...
    :try_start_4
    invoke-virtual {v2, v13}, Lcom/android/server/compat/PlatformCompat;->clearOverrides(Ljava/lang/String;)V

    goto :goto_4

    :cond_5
    invoke-virtual {v2, v13}, Lcom/android/server/compat/PlatformCompat;->clearOverridesForTest(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v9, v10, v13}, Lcom/android/server/compat/PlatformCompat;->clearOverride(JLjava/lang/String;)Z
    ...
    :cond_7
    invoke-virtual {v2, v9, v10, v13}, Lcom/android/server/compat/PlatformCompat;->clearOverrideForTest(JLjava/lang/String;)Z
    ...
    invoke-virtual {v2, v13, v0}, Lcom/android/server/compat/PlatformCompat;->disableTargetSdkChanges(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v0, v13}, Lcom/android/server/compat/PlatformCompat;->setOverrides(Lcom/android/internal/compat/CompatibilityChangeConfig;Ljava/lang/String;)V

    goto :goto_7

    :cond_b
    invoke-virtual {v2, v0, v13}, Lcom/android/server/compat/PlatformCompat;->setOverridesForTest(Lcom/android/internal/compat/CompatibilityChangeConfig;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v13, v0}, Lcom/android/server/compat/PlatformCompat;->enableTargetSdkChanges(Ljava/lang/String;I)I
    ...
    const-string v2, "Invalid toggle value: \'"
...
.method private runProfile(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v0, v15, v5}, Lcom/android/server/am/ActivityManagerShellCommand;->openFileForSystem(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method private runResetMemoryFactor(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/am/ActivityManagerService;->setMemFactorOverride(I)V
...
.method private runServiceRestartBackoff(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityManagerService;->isServiceRestartBackoffEnabled(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v0, v4, v5}, Lcom/android/server/am/ActivityManagerService;->setServiceRestartBackoffEnabled(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    invoke-virtual {p1, v0, v2, v5}, Lcom/android/server/am/ActivityManagerService;->setServiceRestartBackoffEnabled(Ljava/lang/String;ZLjava/lang/String;)V
...
.method private runSetMemoryFactor(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/ActivityManagerService;->setMemFactorOverride(I)V
    ...
    const-string v2, "Error: Unknown level option: "
...
.method private runSetStopUserOnSwitch(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityManagerService;->setStopUserOnSwitch(I)V

    const-string v0, "Reset to default value"
...
.method private switchUserAndWaitForComplete(I)Z
    ...
    const-string v1, "Error: Thread interrupted unexpectedly."
...
.method private writeDeviceConfig(Landroid/util/proto/ProtoOutputStream;JLjava/io/PrintWriter;Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;)V
    ...
    sget-object v1, Lcom/android/server/am/ActivityManagerShellCommand$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/am/ActivityManagerShellCommand$$ExternalSyntheticLambda1;
    ...
    sget-object v0, Lcom/android/server/am/ActivityManagerShellCommand$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/am/ActivityManagerShellCommand$$ExternalSyntheticLambda0;
...
.method runClearDebugApp(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {p1, v0, v1, v2}, Landroid/app/IActivityManager;->setDebugApp(Ljava/lang/String;ZZ)V
...
.method runClearExitInfo(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/am/AppExitInfoTracker;->clearHistoryProcessExitInfo(Ljava/lang/String;I)V
...
.method runDisplayMoveStack(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {v1, p1, v0}, Landroid/app/IActivityTaskManager;->moveRootTaskToDisplay(II)V
...
.method runFgsNotificationRateLimit(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {p1, v1}, Landroid/app/IActivityManager;->enableFgsNotificationRateLimit(Z)Z
...
.method runGetInactive(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {v2, v1, v0, v3}, Landroid/app/usage/IUsageStatsManager;->isAppInactive(Ljava/lang/String;ILjava/lang/String;)Z
...
.method runHang(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v4}, Landroid/os/ShellCallback;->getShellCallbackBinder()Landroid/os/IBinder;

    move-result-object v4

    invoke-interface {v3, v4, v2}, Landroid/app/IActivityManager;->hang(Landroid/os/IBinder;Z)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Hanging failed, since caller "
    ...
    const-string v2, " did not provide a ShellCallback!"
...
.method runStackMoveTask(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {v2, p1, v0, v1}, Landroid/app/IActivityTaskManager;->moveTaskToRootTask(IIZ)V
...
.method runStartActivity(Ljava/io/PrintWriter;)I
    ...
    const-string v20, "com.android.shell"
    ...
    const-string v6, "Error: Activity not started, unable to resolve "

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual/range {v24 .. v24}, Landroid/content/Intent;->toString()Ljava/lang/String;
    ...
    const-string v6, "Error: Activity class "
    ...
    const-string v6, "Error: Activity not started, voice control not allowed for: "
...
.method runSwitchUser(Ljava/io/PrintWriter;)I
    ...
    const-string v1, "Error: Failed to switch to user %d\n"
...
.method taskResize(ILandroid/graphics/Rect;IZ)V
    ...
    invoke-interface {v0, p1, p2, p4}, Landroid/app/IActivityTaskManager;->resizeTask(ILandroid/graphics/Rect;I)Z
