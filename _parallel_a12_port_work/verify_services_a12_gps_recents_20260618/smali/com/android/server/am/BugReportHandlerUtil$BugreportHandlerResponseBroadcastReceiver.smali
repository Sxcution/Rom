...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget v0, p0, Lcom/android/server/am/BugReportHandlerUtil$BugreportHandlerResponseBroadcastReceiver;->handlerUser:I

    invoke-static {p1, p2, v0}, Lcom/android/server/am/BugReportHandlerUtil;->access$000(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    const-string v0, "Request bug report because no response from handler app."

    invoke-static {p2, v0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    const-class p2, Landroid/os/BugreportManager;
    ...
    new-instance p2, Landroid/os/BugreportParams;

    const/4 v0, 0x1

    invoke-direct {p2, v0}, Landroid/os/BugreportParams;-><init>(I)V

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0, v0}, Landroid/os/BugreportManager;->requestBugreport(Landroid/os/BugreportParams;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
