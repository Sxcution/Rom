...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/ContentProviderRecord;->onProviderPublishStatusLocked(Z)V
    ...
    invoke-static {p1}, Lcom/android/server/am/ActivityManagerService;->access$400(Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-virtual {v2, p1, v1}, Lcom/android/server/am/ProcessList;->killAppZygoteIfNeededLocked(Landroid/os/AppZygote;Z)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/am/ActiveServices;->serviceForegroundCrash(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ActiveServices;->serviceForegroundTimeout(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ActivityManagerService;->idleUids()V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ContentProviderHelper;->processContentProviderPublishTimedOutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-static {p1, v1}, Lcom/android/server/am/ActivityManagerService;->access$302(Lcom/android/server/am/ActivityManagerService;Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/AppProfiler;->handleAbortDumpHeap(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/AppProfiler;->handlePostDumpHeapNotification()V
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/am/ActivityManagerService$PidMap;->valueAt(I)Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ProcessList;->updateAllTimePrefsLOSP(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ProcessList;->setAllHttpProxy()V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/ActivityManagerService$MainHandler;->removeMessages(I)V

    invoke-virtual {p0, p1}, Lcom/android/server/am/ActivityManagerService$MainHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/android/server/am/ActivityManagerService$MainHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-static {v1, p1}, Lcom/android/server/am/ActivityManagerService;->access$100(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;)V
    ...
    sget-object v2, Lcom/android/server/am/ActivityManagerService$MainHandler$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/am/ActivityManagerService$MainHandler$$ExternalSyntheticLambda0;

    invoke-virtual {p1, v1, v2}, Lcom/android/server/am/ProcessList;->forEachLruProcessesLOSP(ZLjava/util/function/Consumer;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ActiveServices;->serviceTimeout(Lcom/android/server/am/ProcessRecord;)V
