...
.method private dumpAggregatedStats(Landroid/util/proto/ProtoOutputStream;JIJ)V
    ...
    invoke-virtual {v0, p1, p5, p6, p4}, Lcom/android/internal/app/procstats/ProcessStats;->dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
...
.method private dumpInner(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v12, v3, v0, v5, v11}, Lcom/android/server/am/ProcessStatsService;->parseStateList([Ljava/lang/String;ILjava/lang/String;[Z[Ljava/lang/String;)[I
    ...
    invoke-static {v11, v4, v12, v0, v5}, Lcom/android/server/am/ProcessStatsService;->parseStateList([Ljava/lang/String;ILjava/lang/String;[Z[Ljava/lang/String;)[I
    ...
    iget-object v11, v14, Lcom/android/server/am/ProcessStatsService;->mLock:Ljava/lang/Object;
    ...
    iget v5, v0, Lcom/android/internal/app/procstats/ProcessStats;->mFlags:I

    const/4 v10, 0x1

    or-int/2addr v5, v10

    iput v5, v0, Lcom/android/internal/app/procstats/ProcessStats;->mFlags:I

    invoke-direct {v14, v10, v10}, Lcom/android/server/am/ProcessStatsService;->writeStateLocked(ZZ)V
    ...
    invoke-direct {v14, v10, v5}, Lcom/android/server/am/ProcessStatsService;->scheduleRequestPssAllProcs(ZZ)V
    ...
    :try_start_5
    invoke-direct {v14, v5, v10, v10}, Lcom/android/server/am/ProcessStatsService;->getCommittedFilesLF(IZZ)Ljava/util/ArrayList;
    ...
    iget-object v5, v14, Lcom/android/server/am/ProcessStatsService;->mFile:Landroid/util/AtomicFile;

    invoke-direct {v14, v0, v5}, Lcom/android/server/am/ProcessStatsService;->readLF(Lcom/android/internal/app/procstats/ProcessStats;Landroid/util/AtomicFile;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/am/AppProfiler;->setTestPssMode(Z)V
    ...
    :try_start_d
    iput-object v12, v14, Lcom/android/server/am/ProcessStatsService;->mInjectedScreenState:Ljava/lang/Boolean;
    ...
    :try_start_f
    invoke-direct {v14, v1, v1, v2}, Lcom/android/server/am/ProcessStatsService;->getCommittedFilesLF(IZZ)Ljava/util/ArrayList;
    ...
    invoke-direct {v14, v2, v1}, Lcom/android/server/am/ProcessStatsService;->readLF(Lcom/android/internal/app/procstats/ProcessStats;Landroid/util/AtomicFile;)Z
    :try_end_10
    ...
    :try_start_11
    invoke-direct {v14, v2, v2, v1}, Lcom/android/server/am/ProcessStatsService;->getCommittedFilesLF(IZZ)Ljava/util/ArrayList;
    ...
    invoke-direct {v14, v2, v0}, Lcom/android/server/am/ProcessStatsService;->readLF(Lcom/android/internal/app/procstats/ProcessStats;Landroid/util/AtomicFile;)Z
...
.method private performWriteState(J)V
    ...
    iget-object p1, p0, Lcom/android/server/am/ProcessStatsService;->mFileLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object p2, p0, Lcom/android/server/am/ProcessStatsService;->mFileLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public getCommittedStatsMerged(JIZLjava/util/List;Lcom/android/internal/app/procstats/ProcessStats;)J
    ...
    invoke-direct {v12, v7}, Lcom/android/internal/app/procstats/ProcessStats;-><init>(Z)V
    ...
    invoke-virtual {v4, v12}, Lcom/android/internal/app/procstats/ProcessStats;->add(Lcom/android/internal/app/procstats/ProcessStats;)V
    ...
    invoke-static {v12, v2}, Lcom/android/server/am/ProcessStatsService;->protoToParcelFileDescriptor(Lcom/android/internal/app/procstats/ProcessStats;I)Landroid/os/ParcelFileDescriptor;
...
.method public getStatsOverTime(J)Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_1
    invoke-direct {p0, v6, v6, v1}, Lcom/android/server/am/ProcessStatsService;->getCommittedFilesLF(IZZ)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v5, v1}, Lcom/android/server/am/ProcessStatsService;->readLF(Lcom/android/internal/app/procstats/ProcessStats;Landroid/util/AtomicFile;)Z
