...
.method private updateNumberToReRank()V
    ...
    invoke-direct {v3, v4}, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;-><init>(Lcom/android/server/am/CacheOomRanker$1;)V
...
.method reRankLruCachedAppsLSP(Ljava/util/ArrayList;I)V
    ...
    iput-object v3, v15, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;

    aget-object v3, v12, v14

    const/4 v15, 0x0

    iput v15, v3, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->score:F
    ...
    iget-object v15, v13, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;

    iget-object v15, v15, Lcom/android/server/am/ProcessRecord;->mState:Lcom/android/server/am/ProcessStateRecord;

    invoke-virtual {v15}, Lcom/android/server/am/ProcessStateRecord;->getCacheOomRankerRssTimeMs()J
    ...
    invoke-virtual {v15}, Lcom/android/server/am/ProcessStateRecord;->getCacheOomRankerRss()J
    ...
    :cond_6
    iget-object v15, v0, Lcom/android/server/am/CacheOomRanker;->mProcessDependencies:Lcom/android/server/am/CacheOomRanker$ProcessDependencies;

    move-wide/from16 v17, v9

    iget-object v9, v13, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v9}, Lcom/android/server/am/ProcessRecord;->getPid()I

    move-result v9

    invoke-interface {v15, v9}, Lcom/android/server/am/CacheOomRanker$ProcessDependencies;->getRss(I)[J
    ...
    :cond_7
    iget-object v10, v13, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v10, v0, v1, v2, v3}, Lcom/android/server/am/ProcessStateRecord;->setCacheOomRankerRss(JJ)V

    iget-object v0, v13, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;

    iget-object v0, v0, Lcom/android/server/am/ProcessRecord;->mProfile:Lcom/android/server/am/ProcessProfileRecord;

    aget-wide v9, v9, v15

    invoke-virtual {v0, v9, v10}, Lcom/android/server/am/ProcessProfileRecord;->setLastRss(J)V
    ...
    invoke-static {v12, v2, v14, v1}, Ljava/util/Arrays;->sort([Ljava/lang/Object;IILjava/util/Comparator;)V
    ...
    invoke-static {v12, v1, v14, v0}, Ljava/util/Arrays;->sort([Ljava/lang/Object;IILjava/util/Comparator;)V
    ...
    invoke-static {v12, v5}, Lcom/android/server/am/CacheOomRanker;->addToScore([Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;F)V
    ...
    iget-object v1, v1, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;
    ...
    iput-object v1, v0, Lcom/android/server/am/CacheOomRanker$RankedProcessRecord;->proc:Lcom/android/server/am/ProcessRecord;
