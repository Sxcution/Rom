...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V
    ...
    iput v2, v0, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_RESTART_DURATION_FACTOR:I

    const-wide/16 v2, 0x2710

    iput-wide v2, v0, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_MIN_RESTART_TIME_BETWEEN:J

    iput-wide v14, v0, Lcom/android/server/am/ActivityManagerConstants;->MAX_SERVICE_INACTIVITY:J

    const-wide/16 v4, 0x3a98

    iput-wide v4, v0, Lcom/android/server/am/ActivityManagerConstants;->BG_START_TIMEOUT:J

    iput-wide v2, v0, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_BG_ACTIVITY_START_TIMEOUT:J

    iput-wide v14, v0, Lcom/android/server/am/ActivityManagerConstants;->BOUND_SERVICE_CRASH_RESTART_DURATION:J

    const-wide/16 v6, 0x10

    iput-wide v6, v0, Lcom/android/server/am/ActivityManagerConstants;->BOUND_SERVICE_MAX_CRASH_RETRY:J
    ...
    iput-wide v4, v0, Lcom/android/server/am/ActivityManagerConstants;->TOP_TO_FGS_GRACE_DURATION:J
    ...
    iput-boolean v4, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsStartRestrictionNotificationEnabled:Z
    ...
    iput-boolean v4, v0, Lcom/android/server/am/ActivityManagerConstants;->mFlagFgsNotificationDeferralApiGated:Z

    iput-wide v2, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsNotificationDeferralInterval:J

    const-wide/32 v5, 0x1d4c0

    iput-wide v5, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsNotificationDeferralExclusionTime:J
    ...
    iput-wide v5, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgToBgFgsGraceDuration:J

    iput-wide v2, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsStartForegroundTimeoutMs:J

    const/high16 v2, 0x3f800000    # 1.0f

    iput v2, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsAtomSampleRate:F

    const/high16 v3, 0x3e800000    # 0.25f

    iput v3, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsStartAllowedLogSampleRate:F

    iput v2, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsStartDeniedLogSampleRate:F

    iput-boolean v4, v0, Lcom/android/server/am/ActivityManagerConstants;->mFgsAllowOptOut:Z
    ...
    sget-object v3, Lcom/android/server/am/ActivityManagerConstants$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/am/ActivityManagerConstants$$ExternalSyntheticLambda2;
...
.method private updateConstants()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/ActivityManagerService$MainHandler;->removeMessages(I)V
    ...
    invoke-virtual {v2, v0, v3, v4}, Lcom/android/server/am/ActivityManagerService$MainHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private updateMaxPhantomProcesses()V
    ...
    invoke-direct {v2, v1}, Lcom/android/server/am/ActivityManagerConstants$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/am/PhantomProcessList;)V
