...
.method private addEnergyConsumerIdLocked(Landroid/util/IntArray;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Landroid/util/IntArray;->addAll([I)V
...
.method private updateExternalStatsLocked(Ljava/lang/String;IZZI[IZ)V
    ...
    new-instance v9, Lcom/android/server/am/BatteryExternalStatsWorker$$ExternalSyntheticLambda0;

    invoke-direct {v9, v5}, Lcom/android/server/am/BatteryExternalStatsWorker$$ExternalSyntheticLambda0;-><init>(Landroid/os/SynchronousResultReceiver;)V
    ...
    invoke-virtual {v8, v9}, Landroid/bluetooth/BluetoothAdapter;->requestControllerActivityEnergyInfo(Landroid/os/ResultReceiver;)V
    ...
    invoke-direct {v11, v1, v0}, Lcom/android/server/am/BatteryExternalStatsWorker$4;-><init>(Lcom/android/server/am/BatteryExternalStatsWorker;Ljava/util/concurrent/CompletableFuture;)V
    ...
    invoke-virtual/range {v18 .. v25}, Lcom/android/internal/os/BatteryStatsImpl;->updateWifiState(Landroid/os/connectivity/WifiActivityEnergyInfo;JJJ)V
    ...
    invoke-virtual/range {v12 .. v19}, Lcom/android/internal/os/BatteryStatsImpl;->noteModemControllerActivity(Landroid/telephony/ModemActivityInfo;JJJ)V
...
.method public getMeasuredEnergyLocked(I)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/server/am/BatteryExternalStatsWorker;->addEnergyConsumerIdLocked(Landroid/util/IntArray;I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/am/BatteryExternalStatsWorker;->addEnergyConsumerIdLocked(Landroid/util/IntArray;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/BatteryExternalStatsWorker;->getEnergyConsumptionData([I)Ljava/util/concurrent/CompletableFuture;
...
.method public scheduleSyncDueToScreenStateChange(IZZI[I)Ljava/util/concurrent/Future;
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/am/BatteryExternalStatsWorker;->scheduleSyncLocked(Ljava/lang/String;I)Ljava/util/concurrent/Future;
...
.method public systemServicesReady()V
    ...
    invoke-virtual {v3, v0, v1}, Lcom/android/internal/os/BatteryStatsImpl;->initMeasuredEnergyStatsLocked([Z[Ljava/lang/String;)V
