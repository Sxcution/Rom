...
.method public authenticate(J)I
    ...
    const-string p1, "face.hidl.TestHal"
...
.method public getFeature(II)Landroid/hardware/biometrics/face/V1_0/OptionalBool;
    ...
    new-instance p1, Landroid/hardware/biometrics/face/V1_0/OptionalBool;

    invoke-direct {p1}, Landroid/hardware/biometrics/face/V1_0/OptionalBool;-><init>()V

    const/4 p2, 0x0

    iput p2, p1, Landroid/hardware/biometrics/face/V1_0/OptionalBool;->status:I

    const/4 p2, 0x1

    iput-boolean p2, p1, Landroid/hardware/biometrics/face/V1_0/OptionalBool;->value:Z
...
.method public remove(I)I
    ...
    invoke-interface {p1, v1, v2, v0, v3}, Landroid/hardware/biometrics/face/V1_0/IBiometricsFaceClientCallback;->onRemoved(JLjava/util/ArrayList;I)V
    ...
    iget p1, p0, Lcom/android/server/biometrics/sensors/face/hidl/TestHal;->mUserId:I

    invoke-interface {v0, v1, v2, v3, p1}, Landroid/hardware/biometrics/face/V1_0/IBiometricsFaceClientCallback;->onRemoved(JLjava/util/ArrayList;I)V
