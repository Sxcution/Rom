...
.method public acceptAuthentication(I)V
    ...
    const-string p1, "fp/aidl/BiometricTestSessionImpl"

    const-string v0, "No fingerprints, returning"
    ...
    iget-object p1, p1, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$Session;->mHalSessionCallback:Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;->onAuthenticationSucceeded(ILandroid/hardware/keymaster/HardwareAuthToken;)V
...
.method public finishEnroll(I)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;->onEnrollmentProgress(II)V
...
.method public notifyAcquired(II)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;->onAcquired(BI)V
...
.method public notifyError(II)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;->onError(BI)V
...
.method public rejectAuthentication(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;->onAuthenticationFailed()V
