...
.method public synthetic lambda$onAuthenticated$1$Face10$HalResultController(IJLjava/util/ArrayList;)V
    ...
    invoke-direct {v2, v3, p1, p2, p3}, Landroid/hardware/face/Face;-><init>(Ljava/lang/CharSequence;IJ)V

    invoke-interface {v0, v2, v1, p4}, Lcom/android/server/biometrics/sensors/AuthenticationConsumer;->onAuthenticated(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;ZLjava/util/ArrayList;)V
...
.method public synthetic lambda$onEnrollResult$0$Face10$HalResultController(IIJI)V
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;->mScheduler:Lcom/android/server/biometrics/sensors/BiometricScheduler;
    ...
    instance-of p2, p1, Lcom/android/server/biometrics/sensors/face/hidl/FaceEnrollClient;
    ...
    const-string/jumbo p3, "onEnrollResult for non-enroll client: "
    ...
    :cond_0
    check-cast p1, Lcom/android/server/biometrics/sensors/face/hidl/FaceEnrollClient;

    invoke-virtual {p1, v0, p5}, Lcom/android/server/biometrics/sensors/face/hidl/FaceEnrollClient;->onEnrollResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
...
.method public synthetic lambda$onEnumerate$5$Face10$HalResultController(Ljava/util/ArrayList;J)V
    ...
    invoke-direct {v1, v4, v3, p2, p3}, Landroid/hardware/face/Face;-><init>(Ljava/lang/CharSequence;IJ)V
...
.method public synthetic lambda$onError$3$Face10$HalResultController(II)V
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;->mCallback:Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$Callback;

    if-eqz p1, :cond_2

    invoke-interface {p1}, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$Callback;->onHardwareUnavailable()V
...
.method public synthetic lambda$onLockoutChanged$6$Face10$HalResultController(J)V
    ...
    iget p2, p0, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;->mSensorId:I
...
.method public synthetic lambda$onRemoved$4$Face10$HalResultController(Ljava/util/ArrayList;J)V
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;->mContext:Landroid/content/Context;
    ...
    invoke-static {p1, p3, v3, p2}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method public onAcquired(JIII)V
    ...
    new-instance p2, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0, p4, p5}, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;II)V
...
.method public onAuthenticated(JIILjava/util/ArrayList;)V
    ...
    new-instance v6, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$$ExternalSyntheticLambda3;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/biometrics/sensors/face/hidl/Face10$HalResultController;IJLjava/util/ArrayList;)V
