...
.method protected constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/sensors/HalClientMonitor$LazyDaemon;Landroid/os/IBinder;ILjava/lang/String;Ljava/util/List;Lcom/android/server/biometrics/sensors/BiometricUtils;II)V
    ...
    iput-boolean v0, v12, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mCleanup:Z
...
.method private doTemplateCleanup()V
    ...
    iget-boolean v3, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mCleanup:Z
    ...
    iget v3, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mStatsModality:I

    const/4 v4, 0x2

    const/4 v5, -0x1

    invoke-static {v2, v3, v4, v5}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIII)V
...
.method public onEnumerationResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mCallback:Lcom/android/server/biometrics/sensors/BaseClientMonitor$Callback;
