...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/sensors/HalClientMonitor$LazyDaemon;Landroid/os/IBinder;Lcom/android/server/biometrics/sensors/ClientMonitorCallbackConverter;IJZLjava/lang/String;IZIZIILandroid/app/TaskStackListener;Lcom/android/server/biometrics/sensors/LockoutTracker;ZZZ)V
    ...
    iput-wide v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mOperationId:J

    move/from16 v0, p11

    iput-boolean v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mRequireConfirmation:Z

    invoke-static {}, Landroid/app/ActivityTaskManager;->getInstance()Landroid/app/ActivityTaskManager;

    move-result-object v0

    iput-object v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mActivityTaskManager:Landroid/app/ActivityTaskManager;
    ...
    iput-object v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mBiometricManager:Landroid/hardware/biometrics/BiometricManager;

    move-object/from16 v0, p16

    iput-object v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mTaskStackListener:Landroid/app/TaskStackListener;

    move-object/from16 v0, p17

    iput-object v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mLockoutTracker:Lcom/android/server/biometrics/sensors/LockoutTracker;

    move/from16 v0, p8

    iput-boolean v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mIsRestricted:Z

    move/from16 v0, p18

    iput-boolean v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mAllowBackgroundAuthentication:Z

    move/from16 v0, p20

    iput-boolean v0, v13, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mIsKeyguardBypassEnabled:Z
...
.method private sendCancelOnly(Lcom/android/server/biometrics/sensors/ClientMonitorCallbackConverter;)V
    ...
    const-string p1, "Unable to sendAuthenticationCanceled, listener null"
...
.method public onAcquired(II)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/biometrics/sensors/PerformanceTracker;->incrementAcquireForUser(IZ)V
...
.method public onAuthenticated(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;ZLjava/util/ArrayList;)V
    ...
    iget-boolean v3, p0, Lcom/android/server/biometrics/sensors/AuthenticationClient;->mRequireConfirmation:Z
    ...
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Landroid/app/ActivityTaskManager;->getTasks(I)Ljava/util/List;
    ...
    const-string v1, "Unable to get top activity"
    ...
    const-string v6, "Background authentication detected, top: "
    ...
    :cond_4
    :goto_1
    const-string v1, "No running tasks reported"
    ...
    :cond_9
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->markAlreadyDone()V
    ...
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/AuthenticationClient;->getToken()Landroid/os/IBinder;
