...
.method private removeRecordLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Landroid/util/ArrayMap;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p3, p1}, Lcom/android/server/notification/SnoozeHelper;->getPkgKey(ILjava/lang/String;)Ljava/lang/String;
...
.method private storeRecordLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Landroid/util/ArrayMap;Ljava/lang/Object;)V
    ...
    invoke-virtual {p4, p1, v0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected cancel(IZ)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/notification/SnoozeHelper;->mSnoozedNotifications:Landroid/util/ArrayMap;
    ...
    iput-boolean v3, v2, Lcom/android/server/notification/NotificationRecord;->isCanceled:Z
...
.method protected cancel(ILjava/lang/String;)Z
    ...
    iput-boolean v2, v3, Lcom/android/server/notification/NotificationRecord;->isCanceled:Z
...
.method cleanupPersistedContext(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, p1, v1, v3}, Lcom/android/server/notification/SnoozeHelper;->removeRecordLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Landroid/util/ArrayMap;)Ljava/lang/Object;
...
.method public synthetic lambda$clearData$1$SnoozeHelper(Ljava/lang/String;Lcom/android/server/notification/NotificationRecord;I)V
    ...
    iget-object p3, p0, Lcom/android/server/notification/SnoozeHelper;->mAm:Landroid/app/AlarmManager;
    ...
    invoke-virtual {p1, p2}, Landroid/metrics/LogMaker;->setCategory(I)Landroid/metrics/LogMaker;
...
.method protected readXml(Landroid/util/TypedXmlPullParser;J)V
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/server/notification/SnoozeHelper;->storeRecordLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Landroid/util/ArrayMap;Ljava/lang/Object;)V
...
.method protected repost(Ljava/lang/String;IZ)V
    ...
    invoke-direct {p0, v0, v1, p2}, Lcom/android/server/notification/SnoozeHelper;->createPendingIntent(Ljava/lang/String;Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    invoke-interface {v0, p2, p1, p3}, Lcom/android/server/notification/SnoozeHelper$Callback;->repost(ILcom/android/server/notification/NotificationRecord;Z)V
...
.method public scheduleRepostsForPersistedNotifications(J)V
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/server/notification/SnoozeHelper;->scheduleRepostAtTime(Ljava/lang/String;Ljava/lang/String;IJ)V
...
.method protected writeXml(Landroid/util/TypedXmlSerializer;)V
    ...
    invoke-direct {p0, p1, v1, v2, v3}, Lcom/android/server/notification/SnoozeHelper;->writeXml(Landroid/util/TypedXmlSerializer;Landroid/util/ArrayMap;Ljava/lang/String;Lcom/android/server/notification/SnoozeHelper$Inserter;)V

    const-string/jumbo v1, "snoozed-notifications"
