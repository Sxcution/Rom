...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$Dependencies$1;->val$settings:Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;

    invoke-interface {p1}, Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;->getCombineSubtypeEnabled()Z

    move-result p1

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$Dependencies$1;->val$monitor:Lcom/android/server/net/NetworkStatsSubscriptionsMonitor;

    invoke-virtual {p1}, Lcom/android/server/net/NetworkStatsSubscriptionsMonitor;->start()V
    ...
    invoke-virtual {p1}, Lcom/android/server/net/NetworkStatsSubscriptionsMonitor;->stop()V
