...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/INetworkManagementService;Landroid/content/pm/IPackageManager;Ljava/time/Clock;Ljava/io/File;Z)V
    ...
    invoke-direct {p3, p2, v0}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V
    ...
    invoke-direct {p4, p2, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V
    ...
    invoke-direct {p1, v2, p3}, Lcom/android/server/connectivity/MultipathPolicyTracker;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mMultipathPolicyTracker:Lcom/android/server/connectivity/MultipathPolicyTracker;
...
.method private addDefaultRestrictBackgroundAllowlistUidsUL(I)Z
    ...
    invoke-direct {p0, v8, v4, v2}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidPolicyUncheckedUL(IIZ)V
...
.method private enforceSubscriptionPlanValidity([Landroid/telephony/SubscriptionPlan;)V
    ...
    const-string v0, "Received empty plans list. Clearing existing SubscriptionPlans."
    ...
    const-string v0, "Subscription plan contains duplicate network types."
    ...
    :cond_4
    invoke-static {v2, v6}, Lcom/android/server/net/NetworkPolicyManagerService;->addAll(Landroid/util/ArraySet;[I)Z
...
.method private ensureActiveCarrierPolicyAL(ILjava/lang/String;)Z
    ...
    invoke-virtual {v3, v9}, Landroid/net/NetworkTemplate;->matches(Landroid/net/NetworkIdentity;)Z
...
.method private findRapidBlame(Landroid/net/NetworkTemplate;JJ)Landroid/content/pm/ApplicationInfo;
    ...
    iget v12, v9, Landroid/net/NetworkStats$Entry;->uid:I
...
.method private forEachUid(Ljava/lang/String;Ljava/util/function/IntConsumer;)V
    ...
    invoke-interface {p2, v9}, Ljava/util/function/IntConsumer;->accept(I)V
    :try_end_4
...
.method private initService(Ljava/util/concurrent/CountDownLatch;)V
    ...
    iput-object v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mAppStandby:Lcom/android/server/usage/AppStandbyInternal;
    ...
    new-instance v5, Lcom/android/server/net/NetworkPolicyManagerService$RestrictedModeObserver;

    iget-object v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mContext:Landroid/content/Context;

    new-instance v7, Lcom/android/server/net/NetworkPolicyManagerService$$ExternalSyntheticLambda0;

    invoke-direct {v7, p0}, Lcom/android/server/net/NetworkPolicyManagerService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/net/NetworkPolicyManagerService;)V

    invoke-direct {v5, v6, v7}, Lcom/android/server/net/NetworkPolicyManagerService$RestrictedModeObserver;-><init>(Landroid/content/Context;Lcom/android/server/net/NetworkPolicyManagerService$RestrictedModeObserver$RestrictedModeListener;)V

    iput-object v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mRestrictedModeObserver:Lcom/android/server/net/NetworkPolicyManagerService$RestrictedModeObserver;

    invoke-virtual {v5}, Lcom/android/server/net/NetworkPolicyManagerService$RestrictedModeObserver;->isRestrictedModeEnabled()Z

    move-result v5

    iput-boolean v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mRestrictedNetworkingMode:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mRestrictBackgroundLowPowerMode:Z
    ...
    invoke-virtual {p0}, Lcom/android/server/net/NetworkPolicyManagerService;->addDefaultRestrictBackgroundAllowlistUidsUL()Z
    ...
    const-string v6, "init_service"

    invoke-direct {p0, v5, v6}, Lcom/android/server/net/NetworkPolicyManagerService;->setRestrictBackgroundUL(ZLjava/lang/String;)V
    ...
    const-string v6, "android.permission.NETWORK_STACK"
    ...
    iget-object v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mConnManager:Landroid/net/ConnectivityManager;
    ...
    iget-object v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mAppStandby:Lcom/android/server/usage/AppStandbyInternal;

    new-instance v4, Lcom/android/server/net/NetworkPolicyManagerService$NetPolicyAppIdleStateChangeListener;

    invoke-direct {v4, p0, v7}, Lcom/android/server/net/NetworkPolicyManagerService$NetPolicyAppIdleStateChangeListener;-><init>(Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/net/NetworkPolicyManagerService$1;)V
    ...
    new-instance v5, Lcom/android/server/net/NetworkPolicyManagerService$3;

    invoke-direct {v5, p0}, Lcom/android/server/net/NetworkPolicyManagerService$3;-><init>(Lcom/android/server/net/NetworkPolicyManagerService;)V

    invoke-virtual {v3, v4, v5}, Landroid/telephony/SubscriptionManager;->addOnSubscriptionsChangedListener(Ljava/util/concurrent/Executor;Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;)V
...
.method private isUidForegroundOnRestrictBackgroundUL(I)Z
    ...
    check-cast p1, Landroid/net/NetworkPolicyManager$UidState;

    invoke-static {p1}, Landroid/net/NetworkPolicyManager;->isProcStateAllowedWhileOnRestrictBackground(Landroid/net/NetworkPolicyManager$UidState;)Z
...
.method private isUidForegroundOnRestrictPowerUL(I)Z
    ...
    invoke-static {p1}, Landroid/net/NetworkPolicyManager;->isProcStateAllowedWhileIdleOrPowerSaveMode(Landroid/net/NetworkPolicyManager$UidState;)Z
...
.method private maybeUpdateCarrierPolicyCycleAL(ILjava/lang/String;)Z
    ...
    invoke-virtual {v1, v10}, Landroid/net/NetworkTemplate;->matches(Landroid/net/NetworkIdentity;)Z
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->updateDefaultCarrierPolicyAL(ILandroid/net/NetworkPolicy;)Z
...
.method private readPolicyAL()V
    ...
    :try_start_2
    const-string/jumbo v12, "policy-list"
    ...
    invoke-static {v6, v9}, Lcom/android/internal/util/XmlUtils;->readBooleanAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v13, v12}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    invoke-interface {v13, v5, v14}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v13, v5, v6}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v5}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I

    move-result v5

    const-string/jumbo v6, "templateMetered"

    invoke-static {v13, v6}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    const-string v5, "Update template match rule from mobile to carrier and force to metered"
    ...
    invoke-static {v13, v9}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v8, v3, v5, v6}, Landroid/util/RecurrenceRule;-><init>(Ljava/time/ZonedDateTime;Ljava/time/ZonedDateTime;Ljava/time/Period;)V
    ...
    invoke-static {v13, v3}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    invoke-interface {v13, v6, v5}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v3}, Lcom/android/internal/util/XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)J

    move-result-wide v32

    invoke-static {v13, v15}, Lcom/android/internal/util/XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)J
    ...
    const-string v5, "lastLimitSnooze"

    invoke-static {v13, v5}, Lcom/android/internal/util/XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)J
    ...
    const-string/jumbo v5, "metered"

    invoke-static {v13, v5}, Lcom/android/internal/util/XmlUtils;->readBooleanAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v13, v3}, Lcom/android/internal/util/XmlUtils;->readBooleanAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-direct/range {v18 .. v28}, Landroid/net/NetworkTemplate;-><init>(ILjava/lang/String;[Ljava/lang/String;Ljava/lang/String;IIIIII)V
    ...
    invoke-direct/range {v29 .. v41}, Landroid/net/NetworkPolicy;-><init>(Landroid/net/NetworkTemplate;Landroid/util/RecurrenceRule;JJJJZZ)V
    ...
    invoke-static {v5, v9}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v9, v3, v6, v8}, Landroid/telephony/SubscriptionPlan$Builder;-><init>(Ljava/time/ZonedDateTime;Ljava/time/ZonedDateTime;Ljava/time/Period;)V
    ...
    invoke-virtual {v9, v3}, Landroid/telephony/SubscriptionPlan$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    invoke-virtual {v9, v3}, Landroid/telephony/SubscriptionPlan$Builder;->setSummary(Ljava/lang/CharSequence;)Landroid/telephony/SubscriptionPlan$Builder;

    const-wide/16 v12, -0x1

    invoke-static {v5, v15, v12, v13}, Lcom/android/internal/util/XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
    ...
    invoke-static {v5, v3, v6}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    invoke-virtual {v9, v14, v15, v3}, Landroid/telephony/SubscriptionPlan$Builder;->setDataLimit(JI)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    invoke-static {v5, v3, v12, v13}, Lcom/android/internal/util/XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
    ...
    invoke-virtual {v9, v14, v15, v6, v7}, Landroid/telephony/SubscriptionPlan$Builder;->setDataUsage(JJ)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    invoke-static {v5, v6}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v12, "networkTypes"

    const-string/jumbo v13, "name"

    invoke-static {v5, v13}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v2, v12}, Lcom/android/internal/util/XmlUtils;->readThisIntArrayXml(Landroid/util/TypedXmlPullParser;Ljava/lang/String;[Ljava/lang/String;)[I

    move-result-object v13

    invoke-virtual {v9, v13}, Landroid/telephony/SubscriptionPlan$Builder;->setNetworkTypes([I)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    iget-object v9, v1, Lcom/android/server/net/NetworkPolicyManagerService;->mSubscriptionPlans:Landroid/util/SparseArray;

    const-class v13, Landroid/telephony/SubscriptionPlan;

    invoke-virtual {v9, v3}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, [Landroid/telephony/SubscriptionPlan;

    invoke-static {v13, v14, v7}, Lcom/android/internal/util/ArrayUtils;->appendElement(Ljava/lang/Class;[Ljava/lang/Object;Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    iget-object v7, v1, Lcom/android/server/net/NetworkPolicyManagerService;->mSubscriptionPlansOwner:Landroid/util/SparseArray;
    ...
    :try_start_6
    invoke-static {v5, v15}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    invoke-direct {v1, v3, v9, v6}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidPolicyUncheckedUL(IIZ)V
    ...
    invoke-direct {v1, v3, v9, v13}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidPolicyUncheckedUL(IIZ)V
    ...
    invoke-virtual {v8, v3, v6}, Landroid/util/SparseBooleanArray;->append(IZ)V
    ...
    const-string v9, "ignoring restrict-background-allowlist for "
...
.method private removeUidStateUL(I)Z
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/net/NetworkPolicyManagerService;->updateRestrictBackgroundRulesOnUidStatusChangedUL(ILandroid/net/NetworkPolicyManager$UidState;Landroid/net/NetworkPolicyManager$UidState;)V
...
.method private setNetworkTemplateEnabledInner(Landroid/net/NetworkTemplate;Z)V
    ...
    invoke-direct/range {v7 .. v15}, Landroid/net/NetworkIdentity;-><init>(IILjava/lang/String;Ljava/lang/String;ZZZI)V
    ...
    invoke-virtual {v2, v4}, Landroid/telephony/TelephonyManager;->setPolicyDataEnabled(Z)V
...
.method private setRestrictBackgroundUL(ZLjava/lang/String;)V
    ...
    const-string/jumbo v3, "setRestrictBackgroundUL: already "
...
.method private updateBlockedReasonsForRestrictedModeUL(I)V
    ...
    iget v0, v0, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->effectiveBlockedReasons:I

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v2, v3, p1, v0, v1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private updateRulesForAppIdleParoleUL()V
    ...
    invoke-direct {p0, v8}, Lcom/android/server/net/NetworkPolicyManagerService;->isUidValidForDenylistRulesUL(I)Z
    ...
    invoke-direct {p0, v8}, Lcom/android/server/net/NetworkPolicyManagerService;->isUidForegroundOnRestrictPowerUL(I)Z
    ...
    invoke-virtual {v10, v8, v6}, Landroid/util/SparseIntArray;->put(II)V
    ...
    :goto_3
    invoke-direct {p0, v8, v9, v7}, Lcom/android/server/net/NetworkPolicyManagerService;->updateRulesForPowerRestrictionsUL(IIZ)I
    ...
    invoke-virtual {v6, v8}, Landroid/util/SparseIntArray;->delete(I)V
...
.method private updateRulesForDataUsageRestrictionsULInner(I)V
    ...
    new-instance v8, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;

    invoke-direct {v8}, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;-><init>()V
    ...
    const-string v10, ", isRestrictedByAdmin="
    ...
    const-string v13, ", oldBlockedMeteredReasons="

    invoke-virtual {v15, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v8, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->blockedReasons:I

    const/high16 v19, -0x10000

    and-int v13, v13, v19

    invoke-static {v13}, Landroid/net/NetworkPolicyManager;->blockedReasonsToString(I)Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v15, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v13, ", oldBlockedMeteredEffectiveReasons="

    invoke-virtual {v15, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v8, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->effectiveBlockedReasons:I
    ...
    const-string v13, ", oldAllowedMeteredReasons="

    invoke-virtual {v15, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v8, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->allowedReasons:I
    ...
    invoke-virtual {v13, v1, v12}, Landroid/util/SparseIntArray;->put(II)V
    ...
    invoke-static {v5, v13}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    const-string v6, ", allowlisted="

    invoke-virtual {v13, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v13, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v2, ", denylisted="
    ...
    invoke-static {v5, v3}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    iget v4, v8, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->effectiveBlockedReasons:I
...
.method private updateRulesForPowerRestrictionsULInner(IIZ)I
    ...
    new-instance v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;

    invoke-direct {v11}, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;-><init>()V
    ...
    iget v14, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->allowedReasons:I
    ...
    const-string/jumbo v13, "updateRulesForPowerRestrictionsUL("

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, "), isIdle: "
    ...
    invoke-static {v10, v3}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    :cond_12
    iget v2, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->effectiveBlockedReasons:I

    iget v3, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->blockedReasons:I
    ...
    iput v3, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->blockedReasons:I

    iget v3, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->allowedReasons:I

    and-int/2addr v3, v4

    or-int/2addr v3, v6

    iput v3, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->allowedReasons:I

    invoke-virtual {v11}, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->updateEffectiveBlockedReasons()V

    iget v3, v11, Lcom/android/server/net/NetworkPolicyManagerService$UidBlockedState;->effectiveBlockedReasons:I
...
.method private updateUidStateUL(III)Z
    ...
    iget-object p2, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidState:Landroid/util/SparseArray;
...
.method buildDefaultCarrierPolicy(ILjava/lang/String;)Landroid/net/NetworkPolicy;
    ...
    invoke-static {p2}, Landroid/net/NetworkTemplate;->buildTemplateCarrierMetered(Ljava/lang/String;)Landroid/net/NetworkTemplate;
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, Lcom/android/server/net/NetworkPolicyManagerService;->updateDefaultCarrierPolicyAL(ILandroid/net/NetworkPolicy;)Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mMultipathPolicyTracker:Lcom/android/server/connectivity/MultipathPolicyTracker;

    invoke-virtual {p2, p1}, Lcom/android/server/connectivity/MultipathPolicyTracker;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method public factoryReset(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, p1}, Landroid/net/NetworkTemplate;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidPolicy(II)V
...
.method public synthetic lambda$updateRestrictedModeAllowlistUL$3$NetworkPolicyManagerService(I)V
    ...
    iget-object v4, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidFirewallRestrictedModeRules:Landroid/util/SparseIntArray;

    invoke-virtual {v4, p1, v3}, Landroid/util/SparseIntArray;->append(II)V
...
.method public networkScoreAndNetworkManagementServiceReady()Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/server/net/NetworkPolicyManagerService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/net/NetworkPolicyManagerService;Ljava/util/concurrent/CountDownLatch;)V
...
.method public setRestrictBackground(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/net/NetworkPolicyManagerService;->setRestrictBackgroundUL(ZLjava/lang/String;)V
...
.method public setSubscriptionOverride(III[IJLjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, p7}, Lcom/android/server/net/NetworkPolicyManagerService;->enforceSubscriptionPlanAccess(IILjava/lang/String;)V
...
.method public setSubscriptionPlans(I[Landroid/telephony/SubscriptionPlan;Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p1, v5}, Landroid/util/SparseArray;->get(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/net/NetworkPolicyManagerService;->ensureActiveCarrierPolicyAL(ILjava/lang/String;)Z

    invoke-direct {p0, p1, p3}, Lcom/android/server/net/NetworkPolicyManagerService;->maybeUpdateCarrierPolicyCycleAL(ILjava/lang/String;)Z
    ...
    invoke-static {p3, v5}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;)I

    :goto_1
    const/4 p3, 0x1

    invoke-virtual {p0, p3}, Lcom/android/server/net/NetworkPolicyManagerService;->handleNetworkPoliciesUpdateAL(Z)V
    ...
    invoke-virtual {v0, p3, v4}, Landroid/content/Context;->sendBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
...
.method updateNetworkRulesNL()V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/net/NetworkPolicyManagerService;->parseSubId(Landroid/net/NetworkStateSnapshot;)I
    ...
    invoke-static {v3, v2, v12, v11}, Landroid/net/NetworkIdentity;->buildNetworkIdentity(Landroid/content/Context;Landroid/net/NetworkStateSnapshot;ZI)Landroid/net/NetworkIdentity;
    ...
    iget-wide v5, v11, Landroid/net/NetworkPolicy;->lastWarningSnooze:J

    cmp-long v5, v5, v24

    if-gez v5, :cond_a

    invoke-virtual {v11, v1, v2}, Landroid/net/NetworkPolicy;->isOverWarning(J)Z
    ...
    invoke-static {v14, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->collectIfaces(Landroid/util/ArraySet;Landroid/net/NetworkStateSnapshot;)V
    ...
    invoke-virtual {v14, v11}, Landroid/util/ArraySet;->valueAt(I)Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, Landroid/util/ArraySet;->contains(Ljava/lang/Object;)Z

    move-result v4

    if-nez v4, :cond_15

    invoke-direct {v0, v3}, Lcom/android/server/net/NetworkPolicyManagerService;->removeInterfaceQuotasAsync(Ljava/lang/String;)V
    ...
    :cond_1a
    invoke-direct {v0, v14}, Lcom/android/server/net/NetworkPolicyManagerService;->getPrimarySubscriptionPlanLocked(I)Landroid/telephony/SubscriptionPlan;
    ...
    check-cast v23, Ljava/time/ZonedDateTime;

    invoke-virtual/range {v23 .. v23}, Ljava/time/ZonedDateTime;->toInstant()Ljava/time/Instant;

    move-result-object v23

    invoke-virtual/range {v23 .. v23}, Ljava/time/Instant;->toEpochMilli()J

    move-result-wide v23

    iget-object v5, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mClock:Ljava/time/Clock;
    ...
    invoke-virtual {v2, v6}, Ljava/time/ZonedDateTime;->truncatedTo(Ljava/time/temporal/TemporalUnit;)Ljava/time/ZonedDateTime;
    ...
    :cond_1f
    invoke-static {v1}, Landroid/net/NetworkTemplate;->buildTemplateCarrierMetered(Ljava/lang/String;)Landroid/net/NetworkTemplate;
    ...
    invoke-virtual/range {v25 .. v25}, Ljava/time/Instant;->toEpochMilli()J
...
.method updateRestrictedModeForUidUL(I)V
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidFirewallRule(III)V
...
.method updateRulesForAppIdleUL()V
    ...
    invoke-direct {p0, v10}, Lcom/android/server/net/NetworkPolicyManagerService;->hasInternetPermissionUL(I)Z

    move-result v11

    if-eqz v11, :cond_0

    invoke-direct {p0, v10}, Lcom/android/server/net/NetworkPolicyManagerService;->isUidForegroundOnRestrictPowerUL(I)Z
...
.method writePolicyAL()V
    ...
    :try_start_1
    invoke-static {v8}, Landroid/util/Xml;->resolveSerializer(Ljava/io/OutputStream;)Landroid/util/TypedXmlSerializer;
    ...
    invoke-interface {v9, v7, v10}, Landroid/util/TypedXmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V

    invoke-interface {v9, v7, v6}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    :try_start_3
    invoke-interface {v9, v8, v0}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v9, v5, v8, v3}, Landroid/util/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    :goto_1
    const-string/jumbo v3, "subscriberIdMatchRule"

    invoke-virtual {v7}, Landroid/net/NetworkTemplate;->getSubscriberIdMatchRule()I

    move-result v5

    invoke-static {v9, v3, v5}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
    ...
    invoke-interface {v9, v8, v5, v3}, Landroid/util/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    :cond_3
    const-string/jumbo v3, "templateMetered"

    invoke-virtual {v7}, Landroid/net/NetworkTemplate;->getMeteredness()I

    move-result v5

    invoke-static {v9, v3, v5}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V

    iget-object v3, v12, Landroid/net/NetworkPolicy;->cycleRule:Landroid/util/RecurrenceRule;
    ...
    invoke-static {v9, v10, v3}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v9, v15, v3}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v9, v14, v3}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v3, "warningBytes"

    iget-wide v7, v12, Landroid/net/NetworkPolicy;->warningBytes:J

    invoke-static {v9, v3, v7, v8}, Lcom/android/internal/util/XmlUtils;->writeLongAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;J)V
    ...
    iget-boolean v5, v12, Landroid/net/NetworkPolicy;->metered:Z

    invoke-static {v9, v3, v5}, Lcom/android/internal/util/XmlUtils;->writeBooleanAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Z)V

    const-string v3, "inferred"

    iget-boolean v5, v12, Landroid/net/NetworkPolicy;->inferred:Z

    invoke-static {v9, v3, v5}, Lcom/android/internal/util/XmlUtils;->writeBooleanAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Z)V

    const/4 v3, 0x0

    invoke-interface {v9, v3, v0}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    :try_end_3
    ...
    invoke-interface {v9, v8, v2}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v8, "subId"

    invoke-static {v9, v8, v5}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V

    const-string/jumbo v8, "ownerPackage"

    invoke-static {v9, v8, v7}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    iget-object v5, v8, Landroid/util/RecurrenceRule;->start:Ljava/time/ZonedDateTime;

    invoke-static {v5}, Landroid/util/RecurrenceRule;->convertZonedDateTime(Ljava/time/ZonedDateTime;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v9, v10, v5}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V

    iget-object v5, v8, Landroid/util/RecurrenceRule;->end:Ljava/time/ZonedDateTime;

    invoke-static {v5}, Landroid/util/RecurrenceRule;->convertZonedDateTime(Ljava/time/ZonedDateTime;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v9, v15, v5}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V

    iget-object v5, v8, Landroid/util/RecurrenceRule;->period:Ljava/time/Period;

    invoke-static {v5}, Landroid/util/RecurrenceRule;->convertPeriod(Ljava/time/Period;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v9, v14, v5}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v5, "title"

    invoke-virtual {v0}, Landroid/telephony/SubscriptionPlan;->getTitle()Ljava/lang/CharSequence;

    move-result-object v8

    invoke-static {v9, v5, v8}, Lcom/android/internal/util/XmlUtils;->writeStringAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string/jumbo v5, "summary"

    invoke-virtual {v0}, Landroid/telephony/SubscriptionPlan;->getSummary()Ljava/lang/CharSequence;
    ...
    const-string v7, "limitBehavior"

    invoke-virtual {v0}, Landroid/telephony/SubscriptionPlan;->getDataLimitBehavior()I

    move-result v8

    invoke-static {v9, v7, v8}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
    ...
    invoke-static {v9, v7, v10, v11}, Lcom/android/internal/util/XmlUtils;->writeLongAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;J)V
    ...
    :try_start_6
    invoke-virtual {v0}, Landroid/telephony/SubscriptionPlan;->getNetworkTypes()[I

    move-result-object v0

    const-string/jumbo v7, "networkTypes"

    invoke-static {v0, v7, v9}, Lcom/android/internal/util/XmlUtils;->writeIntArrayXml([ILjava/lang/String;Landroid/util/TypedXmlSerializer;)V
    :try_end_6
    ...
    :try_start_7
    invoke-interface {v9, v7, v2}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    :try_end_7
    ...
    invoke-interface {v9, v7, v4}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    invoke-static {v9, v3, v2}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
    ...
    invoke-interface {v9, v2, v4}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    :try_end_9
    ...
    :try_start_a
    invoke-interface {v9, v2, v6}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    move-object/from16 v4, v18

    invoke-interface {v9, v2, v4}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    :try_start_b
    iget-object v2, v1, Lcom/android/server/net/NetworkPolicyManagerService;->mRestrictBackgroundAllowlistRevokedUids:Landroid/util/SparseBooleanArray;

    invoke-virtual {v2, v10}, Landroid/util/SparseBooleanArray;->keyAt(I)I
    ...
    invoke-interface {v9, v6, v5}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    invoke-static {v9, v3, v2}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V

    invoke-interface {v9, v6, v5}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    :try_end_b
