...
.method constructor <init>(ILandroid/content/Context;Lcom/android/server/accessibility/AccessibilityUserState$ServiceInfoChangeListener;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/accessibility/AccessibilityUserState;->mSupportMagnificationArea:Z
...
.method private saveSoftKeyboardValueToSettings(I)V
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/android/server/accessibility/AccessibilityUserState;->putSecureIntForUser(Ljava/lang/String;II)V
...
.method private setUserOverridesHardKeyboardSetting()V
    ...
    invoke-direct {p0, v1, v0, v2}, Lcom/android/server/accessibility/AccessibilityUserState;->putSecureIntForUser(Ljava/lang/String;II)V
...
.method getClientStateLocked(ZI)I
    ...
    iget-boolean p1, p0, Lcom/android/server/accessibility/AccessibilityUserState;->mIsTouchExplorationEnabled:Z
    ...
    :cond_3
    iget-boolean p1, p0, Lcom/android/server/accessibility/AccessibilityUserState;->mIsTextHighContrastEnabled:Z
...
.method public getShortcutTargetsLocked(I)Landroid/util/ArraySet;
    ...
    iget-object p1, p0, Lcom/android/server/accessibility/AccessibilityUserState;->mAccessibilityShortcutKeyTargets:Landroid/util/ArraySet;
    ...
    iget-object p1, p0, Lcom/android/server/accessibility/AccessibilityUserState;->mAccessibilityButtonTargets:Landroid/util/ArraySet;
...
.method reconcileSoftKeyboardModeWithSettingsLocked()V
    ...
    invoke-direct {p0, v1, v2, v0}, Lcom/android/server/accessibility/AccessibilityUserState;->putSecureIntForUser(Ljava/lang/String;II)V
...
.method public removeShortcutTargetLocked(ILandroid/content/ComponentName;)Z
    ...
    new-instance v0, Lcom/android/server/accessibility/AccessibilityUserState$$ExternalSyntheticLambda0;

    invoke-direct {v0, p2}, Lcom/android/server/accessibility/AccessibilityUserState$$ExternalSyntheticLambda0;-><init>(Landroid/content/ComponentName;)V

    invoke-virtual {p1, v0}, Landroid/util/ArraySet;->removeIf(Ljava/util/function/Predicate;)Z
...
.method setSoftKeyboardModeLocked(ILandroid/content/ComponentName;)Z
    ...
    sget-object p1, Lcom/android/server/accessibility/AccessibilityUserState;->LOG_TAG:Ljava/lang/String;
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/accessibility/AccessibilityServiceConnection;->notifySoftKeyboardShowModeChangedLocked(I)V
