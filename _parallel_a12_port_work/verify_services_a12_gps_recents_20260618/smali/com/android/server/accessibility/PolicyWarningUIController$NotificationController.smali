...
.method private trySendNotification(ILandroid/content/ComponentName;)V
    ...
    iget-object v0, p0, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->mAccessibilitySecurityPolicy:Lcom/android/server/accessibility/AccessibilitySecurityPolicy;

    invoke-virtual {v0, v2}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->isA11yCategoryService(Landroid/accessibilityservice/AccessibilityServiceInfo;)Z
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->sendNotification(ILandroid/content/ComponentName;Ljava/lang/CharSequence;Landroid/graphics/Bitmap;)V
...
.method private writeNotifiedServiceList(ILandroid/util/ArraySet;)V
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->mContext:Landroid/content/Context;
    ...
    invoke-static {p2, v1, v0, p1}, Landroid/provider/Settings$Secure;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
...
.method protected onNotificationCanceled(ILandroid/content/ComponentName;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->writeNotifiedServiceList(ILandroid/util/ArraySet;)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {p0, p2, v0}, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->trySendNotification(ILandroid/content/ComponentName;)V
    ...
    invoke-direct {p0, p2, v0}, Lcom/android/server/accessibility/PolicyWarningUIController$NotificationController;->launchSettings(ILandroid/content/ComponentName;)V
