...
.method private insertAndBatchAlarm(Lcom/android/server/alarm/Alarm;)V
    ...
    invoke-static {p1, v1}, Lcom/android/server/alarm/BatchingAlarmStore;->addBatch(Ljava/util/ArrayList;Lcom/android/server/alarm/BatchingAlarmStore$Batch;)V
...
.method private rebatchAllAlarms()V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/alarm/BatchingAlarmStore;->insertAndBatchAlarm(Lcom/android/server/alarm/Alarm;)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/alarm/BatchingAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;

    invoke-virtual {v2, v4, v0, v1}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
...
.method public dump(Landroid/util/IndentingPrintWriter;JLjava/text/SimpleDateFormat;)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/alarm/BatchingAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;
...
.method public getCount(Ljava/util/function/Predicate;)I
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/alarm/BatchingAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;

    const/4 v2, 0x1

    invoke-virtual {p1, v2, v0, v1}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
...
.method public getNextWakeupDeliveryTime()J
    ...
    iget-wide v0, v1, Lcom/android/server/alarm/BatchingAlarmStore$Batch;->mStart:J
