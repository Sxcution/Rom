...
.method private getFullPowerWhitelistExceptIdleInternal(II)[Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda3;
...
.method private getFullPowerWhitelistInternal(II)[Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda4;
...
.method private getTempAllowListType(II)I
    ...
    invoke-virtual {p1}, Landroid/app/ActivityManagerInternal;->getPushMessagingOverQuotaBehavior()I
...
.method private getUserPowerWhitelistInternal(II)[Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda8;->INSTANCE:Lcom/android/server/DeviceIdleController$$ExternalSyntheticLambda8;
...
.method private onAppRemovedFromTempWhitelistLocked(ILjava/lang/String;)V
    ...
    invoke-interface {p1, v1, p2, v0}, Lcom/android/internal/app/IBatteryStats;->noteEvent(ILjava/lang/String;I)V
    :try_end_0
...
.method private registerDeviceIdleConstraintInternal(Lcom/android/server/deviceidle/IDeviceIdleConstraint;Ljava/lang/String;I)V
    ...
    const-string v0, "Registering device-idle constraint with invalid type: "
...
.method addPowerSaveTempAllowlistAppChecked(Ljava/lang/String;JIILjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, v11, v3}, Lcom/android/server/DeviceIdleController;->getTempAllowListType(II)I
...
.method addPowerSaveTempWhitelistAppDirectInternal(IIJIZILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, v10, Lcom/android/server/DeviceIdleController;->mConstants:Lcom/android/server/DeviceIdleController$Constants;

    iget-wide v2, v2, Lcom/android/server/DeviceIdleController$Constants;->MAX_TEMP_APP_ALLOWLIST_DURATION_MS:J
    ...
    iget-object v2, v10, Lcom/android/server/DeviceIdleController;->mTempWhitelistAppIdEndTimes:Landroid/util/SparseArray;
    ...
    invoke-direct {v2, v6, v14}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iget-object v6, v10, Lcom/android/server/DeviceIdleController;->mTempWhitelistAppIdEndTimes:Landroid/util/SparseArray;

    invoke-virtual {v6, v12, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V
    ...
    iput-wide v0, v2, Landroid/util/MutableLong;->value:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v0, v1, v14, v13}, Lcom/android/internal/app/IBatteryStats;->noteEvent(ILjava/lang/String;I)V
    :try_end_1
    ...
    :goto_1
    :try_start_2
    invoke-direct {v10, v13, v4, v5}, Lcom/android/server/DeviceIdleController;->postTempActiveTimeoutMessage(IJ)V
    ...
    invoke-virtual {v0, v1, v12, v15, v14}, Lcom/android/server/DeviceIdleController$MyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    :goto_2
    invoke-direct {v10, v13, v11}, Lcom/android/server/DeviceIdleController;->reportTempWhitelistChangedLocked(IZ)V
    ...
    invoke-virtual {v0, v6, v3, v2, v1}, Lcom/android/server/net/NetworkPolicyManagerInternal;->onTempPowerSaveWhitelistChange(IZILjava/lang/String;)V
...
.method becomeInactiveIfAppropriateLocked()V
    ...
    iget-wide v4, v2, Lcom/android/server/DeviceIdleController$Constants;->FLEX_TIME_SHORT:J

    invoke-virtual {p0, v0, v1, v4, v5}, Lcom/android/server/DeviceIdleController;->scheduleLightAlarmLocked(JJ)V
...
.method onShellCommand(Lcom/android/server/DeviceIdleController$Shell;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v13}, Lcom/android/server/DeviceIdleController;->addPowerSaveWhitelistAppsInternal(Ljava/util/List;)I
    ...
    const-string/jumbo v7, "pre-idle-factor: "
...
.method public onStart()V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/server/DeviceIdleController;->publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V

    new-instance v0, Lcom/android/server/DeviceIdleController$LocalService;

    invoke-direct {v0, p0, v1}, Lcom/android/server/DeviceIdleController$LocalService;-><init>(Lcom/android/server/DeviceIdleController;Lcom/android/server/DeviceIdleController$1;)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/server/DeviceIdleController;->publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/server/DeviceIdleController$LocalPowerAllowlistService;-><init>(Lcom/android/server/DeviceIdleController;Lcom/android/server/DeviceIdleController$1;)V

    invoke-virtual {p0, v0, v2}, Lcom/android/server/DeviceIdleController;->publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
...
.method stepLightIdleStateLocked(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/DeviceIdleController$MyHandler;->sendEmptyMessage(I)Z
    ...
    iget-wide v2, p1, Lcom/android/server/DeviceIdleController$Constants;->FLEX_TIME_SHORT:J
