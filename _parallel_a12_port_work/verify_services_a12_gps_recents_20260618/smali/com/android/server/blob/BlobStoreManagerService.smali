...
.method private acquireLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/CharSequence;JILjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, v9, v10}, Lcom/android/server/blob/BlobStoreManagerService;->getLeasedBlobsCountLocked(ILjava/lang/String;)I
    ...
    iget-wide v2, v1, Landroid/app/blob/BlobHandle;->expiryTimeMillis:J
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/server/blob/BlobStoreManagerService;->getRemainingLeaseQuotaBytesInternal(ILjava/lang/String;)J
...
.method private addSessionForUserLocked(Lcom/android/server/blob/BlobStoreSession;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/blob/BlobStoreManagerService;->addActiveBlobIdLocked(J)V
...
.method private createSessionInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)J
    ...
    :try_start_0
    invoke-direct {p0, p2, p3}, Lcom/android/server/blob/BlobStoreManagerService;->getSessionsCountLocked(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v11, v3}, Lcom/android/server/blob/BlobStoreManagerService;->addSessionForUserLocked(Lcom/android/server/blob/BlobStoreSession;I)V
    ...
    :cond_1
    new-instance p1, Landroid/os/LimitExceededException;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    const-string p3, "Too many active sessions for the caller: "
    ...
    invoke-direct {p1, p2}, Landroid/os/LimitExceededException;-><init>(Ljava/lang/String;)V
...
.method private deleteBlobInternal(JI)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda18;-><init>(Lcom/android/server/blob/BlobStoreManagerService;J)V
...
.method private forEachSessionInUser(Ljava/util/function/Consumer;I)V
    ...
    check-cast v3, Lcom/android/server/blob/BlobStoreSession;
...
.method private getAllPackages()Landroid/util/SparseArray;
    ...
    invoke-virtual {v7, v8, v5, v9}, Landroid/content/pm/PackageManagerInternal;->getInstalledApplications(III)Ljava/util/List;
...
.method private getSessionsCountLocked(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v1, p1}, Lcom/android/server/blob/BlobStoreManagerService;->forEachSessionInUser(Ljava/util/function/Consumer;I)V
...
.method private handleUserRemoved(I)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda16;-><init>(Lcom/android/server/blob/BlobStoreManagerService;I)V
    ...
    const-string v3, "Removed blobs data in user "
...
.method static synthetic lambda$queryBlobsForUserInternal$6(ILjava/util/function/Function;Landroid/app/blob/BlobHandle;Ljava/util/ArrayList;Lcom/android/server/blob/BlobMetadata$Leasee;)V
    ...
    :cond_2
    iget-object p0, p4, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
    ...
    iget-object v1, p4, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
...
.method static synthetic lambda$queryBlobsForUserInternal$7(ILjava/util/function/Function;Ljava/util/ArrayList;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
    ...
    new-instance v0, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda8;

    invoke-direct {v0, p0, p1, p3, v9}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda8;-><init>(ILjava/util/function/Function;Landroid/app/blob/BlobHandle;Ljava/util/ArrayList;)V
...
.method private queryBlobsForUserInternal(I)Ljava/util/List;
    ...
    invoke-direct {v2, p1, v3, v0}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda6;-><init>(ILjava/util/function/Function;Ljava/util/ArrayList;)V

    invoke-direct {p0, v2}, Lcom/android/server/blob/BlobStoreManagerService;->forEachBlobLocked(Ljava/util/function/BiConsumer;)V
...
.method private readBlobSessionsLocked(Landroid/util/SparseArray;)V
    ...
    const-string p1, "Error creating sessions index file"
    ...
    const-string v2, "Sessions index file not available: "
    ...
    const-string p1, "Finished reading sessions data"
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/blob/BlobStoreManagerService;->addSessionForUserLocked(Lcom/android/server/blob/BlobStoreSession;I)V
    ...
    const-string v0, "Error reading sessions data"
...
.method private readBlobsInfoLocked(Landroid/util/SparseArray;)V
    ...
    const-string v2, "Blobs index file not available: "
...
.method private registerReceivers()V
    ...
    invoke-direct {v1, p0, v6}, Lcom/android/server/blob/BlobStoreManagerService$PackageChangedReceiver;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Lcom/android/server/blob/BlobStoreManagerService$1;)V
    ...
    invoke-direct {v8, p0, v6}, Lcom/android/server/blob/BlobStoreManagerService$UserActionReceiver;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Lcom/android/server/blob/BlobStoreManagerService$1;)V
...
.method private releaseLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)V
    ...
    new-instance p3, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda4;

    invoke-direct {p3, p0, p1, v1}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
...
.method handleIdleMaintenanceLocked()V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda20;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/util/ArrayList;)V
    ...
    invoke-direct {v3, p0, v0}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/util/ArrayList;)V
...
.method handlePackageRemoved(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/server/blob/BlobStoreManagerService$$ExternalSyntheticLambda19;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/lang/String;I)V
    ...
    const-string v3, "Removed blobs data associated with pkg="
...
.method public synthetic lambda$queryBlobsForUserInternal$5$BlobStoreManagerService(Landroid/util/ArrayMap;ILjava/lang/String;)Landroid/content/res/Resources;
    ...
    invoke-static {v0, p3, p2}, Lcom/android/server/blob/BlobStoreUtils;->getPackageResources(Landroid/content/Context;Ljava/lang/String;I)Landroid/content/res/Resources;
...
.method public synthetic lambda$runClearAllBlobs$16$BlobStoreManagerService(ILjava/util/Map$Entry;)Z
    ...
    iget-object p1, p0, Lcom/android/server/blob/BlobStoreManagerService;->mActiveBlobIds:Landroid/util/ArraySet;
...
.method public onBootPhase(I)V
    ...
    iget-object p1, p0, Lcom/android/server/blob/BlobStoreManagerService;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/android/server/blob/BlobStoreConfig;->initialize(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/blob/BlobStoreManagerService;->readBlobSessionsLocked(Landroid/util/SparseArray;)V

    invoke-direct {p0, p1}, Lcom/android/server/blob/BlobStoreManagerService;->readBlobsInfoLocked(Landroid/util/SparseArray;)V
    ...
    invoke-static {p1}, Lcom/android/server/blob/BlobStoreIdleJobService;->schedule(Landroid/content/Context;)V
