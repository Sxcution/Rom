...
.method private createRevocableFd(Ljava/io/FileDescriptor;Ljava/lang/String;I)Landroid/os/ParcelFileDescriptor;
    ...
    new-instance p1, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0, v1, v0}, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/blob/BlobMetadata;Lcom/android/server/blob/BlobMetadata$Accessor;Landroid/os/RevocableFileDescriptor;)V
...
.method private hasALeaseeInUser(I)Z
    ...
    iget v4, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->uid:I
...
.method private hasOtherLeasees(Ljava/lang/String;II)Z
    ...
    iget-object v7, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
    ...
    iget v7, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->uid:I
...
.method static synthetic lambda$removeCommitter$0(ILjava/lang/String;Lcom/android/server/blob/BlobMetadata$Committer;)Z
    ...
    iget-object p0, p2, Lcom/android/server/blob/BlobMetadata$Committer;->packageName:Ljava/lang/String;
...
.method static synthetic lambda$removeCommittersFromUnknownPkgs$1(Landroid/util/SparseArray;Lcom/android/server/blob/BlobMetadata$Committer;)Z
    ...
    :cond_0
    iget-object v1, p1, Lcom/android/server/blob/BlobMetadata$Committer;->packageName:Ljava/lang/String;

    iget p1, p1, Lcom/android/server/blob/BlobMetadata$Committer;->uid:I
...
.method static synthetic lambda$removeDataForUser$6(ILcom/android/server/blob/BlobMetadata$Leasee;)Z
    ...
    iget p1, p1, Lcom/android/server/blob/BlobMetadata$Leasee;->uid:I
...
.method static synthetic lambda$removeLeasee$2(ILjava/lang/String;Lcom/android/server/blob/BlobMetadata$Leasee;)Z
    ...
    iget-object p0, p2, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
...
.method static synthetic lambda$removeLeaseesFromUnknownPkgs$3(Landroid/util/SparseArray;Lcom/android/server/blob/BlobMetadata$Leasee;)Z
    ...
    :cond_0
    iget-object v1, p1, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
...
.method dumpAsStatsEvent(I)Landroid/util/StatsEvent;
    ...
    iget v13, v12, Lcom/android/server/blob/BlobMetadata$Committer;->uid:I
    ...
    iget v12, v5, Lcom/android/server/blob/BlobMetadata$Leasee;->uid:I
...
.method getLeaseInfo(Ljava/lang/String;I)Landroid/app/blob/LeaseInfo;
    ...
    iget-object v5, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/blob/BlobMetadata;->mContext:Landroid/content/Context;

    iget-object v1, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->descriptionResEntryName:Ljava/lang/String;

    iget-object v2, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->packageName:Ljava/lang/String;

    iget v3, v4, Lcom/android/server/blob/BlobMetadata$Leasee;->uid:I

    invoke-static {v3}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v3

    invoke-static {p2, v1, v2, v3}, Lcom/android/server/blob/BlobStoreUtils;->getDescriptionResourceId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    :goto_1
    new-instance p2, Landroid/app/blob/LeaseInfo;
...
.method hasACommitterInUser(I)Z
    ...
    iget v4, v4, Lcom/android/server/blob/BlobMetadata$Committer;->uid:I
...
.method isAccessAllowedForCaller(Ljava/lang/String;I)Z
    ...
    iget-object v6, v6, Lcom/android/server/blob/BlobMetadata$Committer;->packageName:Ljava/lang/String;
    ...
    iget v6, v5, Lcom/android/server/blob/BlobMetadata$Committer;->uid:I
    ...
    :cond_8
    invoke-direct {p0, p1, v6}, Lcom/android/server/blob/BlobMetadata;->isPackageInstalledOnUser(Ljava/lang/String;I)Z
    ...
    iget-object v5, v5, Lcom/android/server/blob/BlobMetadata$Committer;->packageName:Ljava/lang/String;
...
.method openForRead(Ljava/lang/String;I)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {p1, v0}, Landroid/os/ParcelFileDescriptor;-><init>(Ljava/io/FileDescriptor;)V
    :try_end_1
