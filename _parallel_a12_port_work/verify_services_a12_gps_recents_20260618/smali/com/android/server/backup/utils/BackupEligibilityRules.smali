...
.method public appIsRunningAndEligibleForBackupWithTransport(Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/backup/transport/TransportClient;->connectOrThrow(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    invoke-interface {p1, p2, v1}, Lcom/android/internal/backup/IBackupTransport;->isAppEligibleForBackup(Landroid/content/pm/PackageInfo;Z)Z
    ...
    const-string v2, "Unable to ask about eligibility: "
...
.method public isAppBackupAllowed(Landroid/content/pm/ApplicationInfo;)Z
    ...
    const-string p1, "Invalid ApplicationInfo object"
    ...
    const-string v1, "android.backup.ALLOW_ADB_BACKUP"

    invoke-virtual {p1, v1, v3}, Landroid/content/pm/PackageManager;->getProperty(Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/PackageManager$Property;
    ...
    const-string v1, "Failed to read allowAdbBackup property for + "
    ...
    invoke-static {v3, v4, p1, v5}, Landroid/app/compat/CompatChanges;->isChangeEnabled(JLjava/lang/String;Landroid/os/UserHandle;)Z
...
.method public signaturesMatch([Landroid/content/pm/Signature;Landroid/content/pm/PackageInfo;)Z
    ...
    const-string/jumbo p2, "signingInfo is empty, app was either unsigned or the flag PackageManager#GET_SIGNING_CERTIFICATES was not specified"
    ...
    invoke-virtual {v1, p1, p2}, Landroid/content/pm/PackageManagerInternal;->isDataRestoreSafe(Landroid/content/pm/Signature;Ljava/lang/String;)Z
