...
.method private finishOrPause(Landroid/os/IBinder;ZZ)V
    ...
    invoke-static/range {v3 .. v10}, Lcom/android/server/appop/AppOpsService;->access$500(Lcom/android/server/appop/AppOpsService;IILjava/lang/String;Ljava/lang/String;ZII)V
...
.method private finishPossiblyPaused(Landroid/os/IBinder;Z)V
    ...
    const-string p1, "No ops running or paused"
    ...
    const-string p1, "No op running or paused for the client"
    ...
    invoke-static {p1}, Lcom/android/server/appop/AppOpsService;->access$600(Lcom/android/server/appop/AppOpsService;)Lcom/android/server/appop/AppOpsService$InProgressStartOpEventPool;

    move-result-object p1

    invoke-virtual {p1, p2}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEventPool;->release(Ljava/lang/Object;)Z
...
.method public accessed(ILjava/lang/String;Ljava/lang/String;II)V
    ...
    iget-object v2, v10, Lcom/android/server/appop/AppOpsService$AttributedOp;->parent:Lcom/android/server/appop/AppOpsService$Op;

    iget v2, v2, Lcom/android/server/appop/AppOpsService$Op;->uid:I

    iget-object v3, v10, Lcom/android/server/appop/AppOpsService$AttributedOp;->parent:Lcom/android/server/appop/AppOpsService$Op;

    iget-object v3, v3, Lcom/android/server/appop/AppOpsService$Op;->packageName:Ljava/lang/String;

    iget-object v4, v10, Lcom/android/server/appop/AppOpsService$AttributedOp;->tag:Ljava/lang/String;
...
.method public accessed(JJILjava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-static {v0}, Lcom/android/server/appop/AppOpsService;->access$100(Lcom/android/server/appop/AppOpsService;)Lcom/android/server/appop/AppOpsService$OpEventProxyInfoPool;
...
.method public add(Lcom/android/server/appop/AppOpsService$AttributedOp;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/appop/AppOpsService$AttributedOp;->add(Landroid/util/LongSparseArray;Landroid/util/LongSparseArray;)Landroid/util/LongSparseArray;
...
.method public onUidStateChanged(I)V
    ...
    invoke-direct {v12, v2, v11}, Lcom/android/server/appop/AppOpsService$AttributedOp;->finished(Landroid/os/IBinder;Z)V
...
.method public rejected(JII)V
    ...
    invoke-static {p3}, Lcom/android/server/appop/AppOpsService;->access$100(Lcom/android/server/appop/AppOpsService;)Lcom/android/server/appop/AppOpsService$OpEventProxyInfoPool;
    ...
    invoke-direct/range {v1 .. v6}, Landroid/app/AppOpsManager$NoteOpEvent;-><init>(JJLandroid/app/AppOpsManager$OpEventProxyInfo;)V

    invoke-virtual {v0, p3, p4, v7}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V
...
.method public resume()V
    ...
    invoke-static {v13}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;->access$800(Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;)Landroid/os/IBinder;
    ...
    invoke-static {v13, v3, v4}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;->access$902(Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;J)J

    invoke-static {v13, v14, v15}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;->access$1002(Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;J)J
    ...
    invoke-static {v13}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;->access$700(Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;)I

    move-result v8

    invoke-static {v13}, Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;->access$1100(Lcom/android/server/appop/AppOpsService$InProgressStartOpEvent;)I
