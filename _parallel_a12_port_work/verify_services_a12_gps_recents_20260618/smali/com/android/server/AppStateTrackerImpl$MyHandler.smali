...
.method private removeUid(IZ)V
    ...
    iget-object p2, p0, Lcom/android/server/AppStateTrackerImpl$MyHandler;->this$0:Lcom/android/server/AppStateTrackerImpl;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/AppStateTrackerImpl$MyHandler;->notifyUidActiveStateChanged(I)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/AppStateTrackerImpl;->handleUserRemoved(I)V
    ...
    invoke-static {v0}, Lcom/android/server/AppStateTrackerImpl;->access$600(Lcom/android/server/AppStateTrackerImpl;)Lcom/android/internal/util/jobs/StatLogger;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/AppStateTrackerImpl$MyHandler;->handleUidDisabled(I)V
    ...
    invoke-static {p1}, Lcom/android/server/AppStateTrackerImpl;->access$700(Lcom/android/server/AppStateTrackerImpl;)[Lcom/android/server/AppStateTrackerImpl$Listener;
    ...
    invoke-static {v5, v0}, Lcom/android/server/AppStateTrackerImpl$Listener;->access$1300(Lcom/android/server/AppStateTrackerImpl$Listener;Lcom/android/server/AppStateTrackerImpl;)V
    ...
    invoke-static {p1}, Lcom/android/server/AppStateTrackerImpl;->access$600(Lcom/android/server/AppStateTrackerImpl;)Lcom/android/internal/util/jobs/StatLogger;

    move-result-object p1

    const/4 v0, 0x6

    invoke-virtual {p1, v0, v1, v2}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
    ...
    iget-boolean p1, p1, Lcom/android/server/AppStateTrackerImpl;->mForcedAppStandbyEnabled:Z
    ...
    invoke-static {v5, v0}, Lcom/android/server/AppStateTrackerImpl$Listener;->access$1400(Lcom/android/server/AppStateTrackerImpl$Listener;Lcom/android/server/AppStateTrackerImpl;)V
    ...
    invoke-static {v5, v0}, Lcom/android/server/AppStateTrackerImpl$Listener;->access$1200(Lcom/android/server/AppStateTrackerImpl$Listener;Lcom/android/server/AppStateTrackerImpl;)V
    ...
    invoke-static {v5, v0}, Lcom/android/server/AppStateTrackerImpl$Listener;->access$1100(Lcom/android/server/AppStateTrackerImpl$Listener;Lcom/android/server/AppStateTrackerImpl;)V
    ...
    invoke-static {v5, v0}, Lcom/android/server/AppStateTrackerImpl$Listener;->access$1000(Lcom/android/server/AppStateTrackerImpl$Listener;Lcom/android/server/AppStateTrackerImpl;)V
    ...
    invoke-virtual {p1, v5, v1, v2}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
