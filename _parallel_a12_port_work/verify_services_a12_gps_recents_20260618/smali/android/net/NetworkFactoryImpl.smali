...
.method private handleAddRequest(Landroid/net/NetworkRequest;)V
    ...
    invoke-virtual {v0, p1}, Landroid/net/NetworkFactory;->needNetworkFor(Landroid/net/NetworkRequest;)V
...
.method private handleRemoveRequest(Landroid/net/NetworkRequest;)V
    ...
    iget-object p1, p0, Landroid/net/NetworkFactoryImpl;->mParent:Landroid/net/NetworkFactory;

    iget-object v0, v0, Landroid/net/NetworkFactoryImpl$NetworkRequestInfo;->request:Landroid/net/NetworkRequest;

    invoke-virtual {p1, v0}, Landroid/net/NetworkFactory;->releaseNetworkFor(Landroid/net/NetworkRequest;)V
...
.method private handleSetFilter(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {p1}, Landroid/net/NetworkFactory;->reevaluateAllRequests()V
...
.method private register(Ljava/lang/String;Z)V
    ...
    iget-object p1, p0, Landroid/net/NetworkFactoryImpl;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Landroid/net/NetworkFactoryImpl;->obtainMessage(I)Landroid/os/Message;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/net/NetworkFactoryImpl;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string p2, "A NetworkFactory must only be registered once"
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p1, p0, Landroid/net/NetworkFactoryImpl;->mNetworkRequests:Ljava/util/Map;
    ...
    check-cast p3, Landroid/net/NetworkFactoryImpl$NetworkRequestInfo;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, p1}, Landroid/net/NetworkFactoryImpl;->handleOfferNetwork(Landroid/net/NetworkScore;)V
    ...
    invoke-direct {p0, p1}, Landroid/net/NetworkFactoryImpl;->handleSetScore(Landroid/net/NetworkScore;)V
...
.method public setCapabilityFilter(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/net/NetworkFactoryImpl;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
