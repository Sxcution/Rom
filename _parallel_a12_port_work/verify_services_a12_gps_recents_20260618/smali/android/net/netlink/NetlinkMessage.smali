...
.method public static parse(Ljava/nio/ByteBuffer;I)Landroid/net/netlink/NetlinkMessage;
    ...
    invoke-static {v0, p0, v2}, Landroid/net/netlink/NetlinkMessage;->parseCtlMessage(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;I)Landroid/net/netlink/NetlinkMessage;
    ...
    invoke-static {v0, p0}, Landroid/net/netlink/NetlinkMessage;->parseRtMessage(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)Landroid/net/netlink/NetlinkMessage;
    ...
    invoke-static {v0, p0}, Landroid/net/netlink/NetlinkMessage;->parseInetDiagMessage(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)Landroid/net/netlink/NetlinkMessage;
    ...
    invoke-static {v0, p0}, Landroid/net/netlink/NetlinkMessage;->parseNfMessage(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)Landroid/net/netlink/NetlinkMessage;
...
.method private static parseCtlMessage(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;I)Landroid/net/netlink/NetlinkMessage;
    ...
    new-instance p1, Landroid/net/netlink/NetlinkMessage;

    invoke-direct {p1, p0}, Landroid/net/netlink/NetlinkMessage;-><init>(Landroid/net/netlink/StructNlMsgHdr;)V
