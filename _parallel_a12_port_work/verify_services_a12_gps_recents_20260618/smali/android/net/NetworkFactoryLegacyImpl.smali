...
.method private handleRemoveRequest(Landroid/net/NetworkRequest;)V
    ...
    iget-object p1, p0, Landroid/net/NetworkFactoryLegacyImpl;->mParent:Landroid/net/NetworkFactory;

    iget-object v0, v0, Landroid/net/NetworkFactoryLegacyImpl$NetworkRequestInfo;->request:Landroid/net/NetworkRequest;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    check-cast p3, Landroid/net/NetworkFactoryLegacyImpl$NetworkRequestInfo;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, p1}, Landroid/net/NetworkFactoryLegacyImpl;->handleSetFilter(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-direct {p0, p1}, Landroid/net/NetworkFactoryLegacyImpl;->handleSetScore(I)V
...
.method public synthetic lambda$releaseRequestAsUnfulfillableByAnyFactory$0$NetworkFactoryLegacyImpl(Landroid/net/NetworkRequest;)V
    ...
    invoke-virtual {p1, v0}, Landroid/net/NetworkFactory;->log(Ljava/lang/String;)V
...
.method public register(Ljava/lang/String;)V
    ...
    const-string v0, "A NetworkFactory must only be registered once"
...
.method public setCapabilityFilter(Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/net/NetworkFactoryLegacyImpl;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/net/NetworkFactoryLegacyImpl;->sendMessage(Landroid/os/Message;)Z
