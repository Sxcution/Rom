...
.method public getEnergyConsumed([I)[Landroid/hardware/power/stats/EnergyConsumerResult;
    ...
    invoke-interface {v2, p1}, Landroid/hardware/power/stats/IPowerStats;->getEnergyConsumed([I)[Landroid/hardware/power/stats/EnergyConsumerResult;
    ...
    const-string v2, "Method getEnergyConsumed is unimplemented."
    ...
    sget-object p1, Landroid/hardware/power/stats/EnergyConsumerResult;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p1}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Landroid/hardware/power/stats/EnergyConsumerResult;
    :try_end_1
...
.method public getEnergyConsumerInfo()[Landroid/hardware/power/stats/EnergyConsumer;
    ...
    invoke-interface {v2}, Landroid/hardware/power/stats/IPowerStats;->getEnergyConsumerInfo()[Landroid/hardware/power/stats/EnergyConsumer;
    ...
    const-string v3, "Method getEnergyConsumerInfo is unimplemented."
    ...
    sget-object v2, Landroid/hardware/power/stats/EnergyConsumer;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public getEnergyMeterInfo()[Landroid/hardware/power/stats/Channel;
    ...
    invoke-interface {v2}, Landroid/hardware/power/stats/IPowerStats;->getEnergyMeterInfo()[Landroid/hardware/power/stats/Channel;
    ...
    const-string v3, "Method getEnergyMeterInfo is unimplemented."
    ...
    sget-object v2, Landroid/hardware/power/stats/Channel;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public declared-synchronized getInterfaceHash()Ljava/lang/String;
    ...
    invoke-interface {v2}, Landroid/hardware/power/stats/IPowerStats;->getInterfaceHash()Ljava/lang/String;
...
.method public getInterfaceVersion()I
    ...
    invoke-interface {v2}, Landroid/hardware/power/stats/IPowerStats;->getInterfaceVersion()I
...
.method public getPowerEntityInfo()[Landroid/hardware/power/stats/PowerEntity;
    ...
    invoke-interface {v2}, Landroid/hardware/power/stats/IPowerStats;->getPowerEntityInfo()[Landroid/hardware/power/stats/PowerEntity;
    ...
    const-string v3, "Method getPowerEntityInfo is unimplemented."
    ...
    sget-object v2, Landroid/hardware/power/stats/PowerEntity;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, v2}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Landroid/hardware/power/stats/PowerEntity;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public getStateResidency([I)[Landroid/hardware/power/stats/StateResidencyResult;
    ...
    const-string v2, "Method getStateResidency is unimplemented."
    ...
    sget-object p1, Landroid/hardware/power/stats/StateResidencyResult;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public readEnergyMeter([I)[Landroid/hardware/power/stats/EnergyMeasurement;
    ...
    invoke-interface {v2, p1}, Landroid/hardware/power/stats/IPowerStats;->readEnergyMeter([I)[Landroid/hardware/power/stats/EnergyMeasurement;
    ...
    const-string v2, "Method readEnergyMeter is unimplemented."
    ...
    sget-object p1, Landroid/hardware/power/stats/EnergyMeasurement;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p1}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Landroid/hardware/power/stats/EnergyMeasurement;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
