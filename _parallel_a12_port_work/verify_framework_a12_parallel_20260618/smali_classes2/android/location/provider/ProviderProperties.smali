...
.method synthetic constructor blacklist <init>(ZZZZZZZIILandroid/location/provider/ProviderProperties$1;)V
    .locals 0
...
.method static synthetic blacklist access$100(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$200(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$300(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$400(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$500(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$600(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$700(Landroid/location/provider/ProviderProperties;)Z
    .locals 0
...
.method static synthetic blacklist access$800(Landroid/location/provider/ProviderProperties;)I
    .locals 0
...
.method static synthetic blacklist access$900(Landroid/location/provider/ProviderProperties;)I
    .locals 0
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasNetworkRequirement:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasSatelliteRequirement:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasSatelliteRequirement:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasCellRequirement:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasCellRequirement:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasMonetaryCost:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasMonetaryCost:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasAltitudeSupport:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasAltitudeSupport:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasSpeedSupport:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasSpeedSupport:Z

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Landroid/location/provider/ProviderProperties;->mHasBearingSupport:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderProperties;->mHasBearingSupport:Z

    if-ne v1, v3, :cond_2

    iget v1, p0, Landroid/location/provider/ProviderProperties;->mPowerUsage:I

    iget v3, p1, Landroid/location/provider/ProviderProperties;->mPowerUsage:I

    if-ne v1, v3, :cond_2

    iget v1, p0, Landroid/location/provider/ProviderProperties;->mAccuracy:I

    iget p1, p1, Landroid/location/provider/ProviderProperties;->mAccuracy:I
...
.method public whitelist test-api toString()Ljava/lang/String;
    ...
    .line 231
    const-string/jumbo v1, "powerUsage="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Landroid/location/provider/ProviderProperties;->mPowerUsage:I

    invoke-static {v1}, Landroid/location/provider/ProviderProperties;->powerToString(I)Ljava/lang/String;
    ...
    invoke-static {v1}, Landroid/location/provider/ProviderProperties;->accuracyToString(I)Ljava/lang/String;
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 190
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasNetworkRequirement:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 191
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasSatelliteRequirement:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 192
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasCellRequirement:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 193
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasMonetaryCost:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 194
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasAltitudeSupport:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 195
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasSpeedSupport:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 196
    iget-boolean p2, p0, Landroid/location/provider/ProviderProperties;->mHasBearingSupport:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 197
    iget p2, p0, Landroid/location/provider/ProviderProperties;->mPowerUsage:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 198
    iget p2, p0, Landroid/location/provider/ProviderProperties;->mAccuracy:I
