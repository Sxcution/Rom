...
.method private constructor blacklist <init>(JIJZZZLandroid/os/WorkSource;)V
    ...
    check-cast p9, Landroid/os/WorkSource;

    iput-object p9, p0, Landroid/location/provider/ProviderRequest;->mWorkSource:Landroid/os/WorkSource;

    .line 92
    return-void
.end method

.method synthetic constructor blacklist <init>(JIJZZZLandroid/os/WorkSource;Landroid/location/provider/ProviderRequest$1;)V
    .locals 0
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 226
    iget-wide v2, p0, Landroid/location/provider/ProviderRequest;->mIntervalMillis:J
    ...
    .line 227
    iget-wide v2, p1, Landroid/location/provider/ProviderRequest;->mIntervalMillis:J
    ...
    .line 229
    :cond_3
    iget-wide v4, p1, Landroid/location/provider/ProviderRequest;->mIntervalMillis:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_4

    iget v2, p0, Landroid/location/provider/ProviderRequest;->mQuality:I

    iget v3, p1, Landroid/location/provider/ProviderRequest;->mQuality:I

    if-ne v2, v3, :cond_4

    iget-wide v2, p0, Landroid/location/provider/ProviderRequest;->mMaxUpdateDelayMillis:J

    iget-wide v4, p1, Landroid/location/provider/ProviderRequest;->mMaxUpdateDelayMillis:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_4

    iget-boolean v2, p0, Landroid/location/provider/ProviderRequest;->mLowPower:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderRequest;->mLowPower:Z

    if-ne v2, v3, :cond_4

    iget-boolean v2, p0, Landroid/location/provider/ProviderRequest;->mAdasGnssBypass:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderRequest;->mAdasGnssBypass:Z

    if-ne v2, v3, :cond_4

    iget-boolean v2, p0, Landroid/location/provider/ProviderRequest;->mLocationSettingsIgnored:Z

    iget-boolean v3, p1, Landroid/location/provider/ProviderRequest;->mLocationSettingsIgnored:Z

    if-ne v2, v3, :cond_4

    iget-object v2, p0, Landroid/location/provider/ProviderRequest;->mWorkSource:Landroid/os/WorkSource;

    iget-object p1, p1, Landroid/location/provider/ProviderRequest;->mWorkSource:Landroid/os/WorkSource;
