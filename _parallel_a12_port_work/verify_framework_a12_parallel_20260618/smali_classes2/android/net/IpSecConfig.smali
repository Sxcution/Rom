...
.method public constructor greylist-max-o <init>(Landroid/net/IpSecConfig;)V
    ...
    .line 263
    iget p1, p1, Landroid/net/IpSecConfig;->mXfrmInterfaceId:I
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 340
    :cond_0
    check-cast p1, Landroid/net/IpSecConfig;

    .line 341
    iget v0, p0, Landroid/net/IpSecConfig;->mMode:I

    iget v2, p1, Landroid/net/IpSecConfig;->mMode:I

    if-ne v0, v2, :cond_3

    iget-object v0, p0, Landroid/net/IpSecConfig;->mSourceAddress:Ljava/lang/String;

    iget-object v2, p1, Landroid/net/IpSecConfig;->mSourceAddress:Ljava/lang/String;
    ...
    iget-object v2, p1, Landroid/net/IpSecConfig;->mDestinationAddress:Ljava/lang/String;
    ...
    iget-object v2, p1, Landroid/net/IpSecConfig;->mNetwork:Landroid/net/Network;
    ...
    iget v2, p1, Landroid/net/IpSecConfig;->mEncapType:I

    if-ne v0, v2, :cond_3

    iget v0, p0, Landroid/net/IpSecConfig;->mEncapSocketResourceId:I

    iget v2, p1, Landroid/net/IpSecConfig;->mEncapSocketResourceId:I

    if-ne v0, v2, :cond_3

    iget v0, p0, Landroid/net/IpSecConfig;->mEncapRemotePort:I

    iget v2, p1, Landroid/net/IpSecConfig;->mEncapRemotePort:I

    if-ne v0, v2, :cond_3

    iget v0, p0, Landroid/net/IpSecConfig;->mNattKeepaliveInterval:I

    iget v2, p1, Landroid/net/IpSecConfig;->mNattKeepaliveInterval:I

    if-ne v0, v2, :cond_3

    iget v0, p0, Landroid/net/IpSecConfig;->mSpiResourceId:I

    iget v2, p1, Landroid/net/IpSecConfig;->mSpiResourceId:I

    if-ne v0, v2, :cond_3

    iget-object v0, p0, Landroid/net/IpSecConfig;->mEncryption:Landroid/net/IpSecAlgorithm;

    iget-object v2, p1, Landroid/net/IpSecConfig;->mEncryption:Landroid/net/IpSecAlgorithm;

    .line 351
    invoke-static {v0, v2}, Landroid/net/IpSecAlgorithm;->equals(Landroid/net/IpSecAlgorithm;Landroid/net/IpSecAlgorithm;)Z
    ...
    iget-object v2, p1, Landroid/net/IpSecConfig;->mAuthenticatedEncryption:Landroid/net/IpSecAlgorithm;
    ...
    iget-object v2, p1, Landroid/net/IpSecConfig;->mAuthentication:Landroid/net/IpSecAlgorithm;
    ...
    iget v2, p1, Landroid/net/IpSecConfig;->mMarkValue:I

    if-ne v0, v2, :cond_3

    iget v0, p0, Landroid/net/IpSecConfig;->mMarkMask:I

    iget v2, p1, Landroid/net/IpSecConfig;->mMarkMask:I
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 234
    iget p2, p0, Landroid/net/IpSecConfig;->mEncapType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 235
    iget p2, p0, Landroid/net/IpSecConfig;->mEncapSocketResourceId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 236
    iget p2, p0, Landroid/net/IpSecConfig;->mEncapRemotePort:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 237
    iget p2, p0, Landroid/net/IpSecConfig;->mNattKeepaliveInterval:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 238
    iget p2, p0, Landroid/net/IpSecConfig;->mMarkValue:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 239
    iget p2, p0, Landroid/net/IpSecConfig;->mMarkMask:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 240
    iget p2, p0, Landroid/net/IpSecConfig;->mXfrmInterfaceId:I
