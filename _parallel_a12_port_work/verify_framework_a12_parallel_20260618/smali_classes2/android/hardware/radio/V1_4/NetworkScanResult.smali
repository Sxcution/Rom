...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 81
    new-instance v4, Landroid/hardware/radio/V1_4/NetworkScanResult;

    invoke-direct {v4}, Landroid/hardware/radio/V1_4/NetworkScanResult;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/radio/V1_4/NetworkScanResult;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/radio/V1_4/NetworkScanResult;

    mul-int/lit8 v5, v4, 0x18

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/radio/V1_4/NetworkScanResult;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 29
    :cond_2
    check-cast p1, Landroid/hardware/radio/V1_4/NetworkScanResult;

    .line 30
    iget v2, p0, Landroid/hardware/radio/V1_4/NetworkScanResult;->status:I

    iget v3, p1, Landroid/hardware/radio/V1_4/NetworkScanResult;->status:I
    ...
    .line 33
    :cond_3
    iget v2, p0, Landroid/hardware/radio/V1_4/NetworkScanResult;->error:I

    iget v3, p1, Landroid/hardware/radio/V1_4/NetworkScanResult;->error:I
    ...
    iget-object p1, p1, Landroid/hardware/radio/V1_4/NetworkScanResult;->networkInfos:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 100
    iget-object v2, v0, Landroid/hardware/radio/V1_4/NetworkScanResult;->networkInfos:Ljava/util/ArrayList;
    ...
    .line 102
    new-instance v3, Landroid/hardware/radio/V1_4/CellInfo;

    invoke-direct {v3}, Landroid/hardware/radio/V1_4/CellInfo;-><init>()V
    ...
    invoke-virtual {v3, v7, v1, v5, v6}, Landroid/hardware/radio/V1_4/CellInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 104
    iget-object v5, v0, Landroid/hardware/radio/V1_4/NetworkScanResult;->networkInfos:Ljava/util/ArrayList;
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    .line 142
    iget-object v4, p0, Landroid/hardware/radio/V1_4/NetworkScanResult;->networkInfos:Ljava/util/ArrayList;
    ...
    mul-int/lit16 v6, v5, 0x88

    int-to-long v6, v6

    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_4/CellInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
