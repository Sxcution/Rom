...
.method private blacklist sendBackgroundScanCompleteLocked()V
    ...
    invoke-direct {v1, p0}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda3;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;)V
...
.method public synthetic blacklist lambda$onAntennaState$9$TunerCallbackAdapter(Z)V
    .locals 1
...
.method public synthetic blacklist lambda$onBackgroundScanAvailabilityChange$10$TunerCallbackAdapter(Z)V
    .locals 1
...
.method public synthetic blacklist lambda$onConfigurationChanged$5$TunerCallbackAdapter(Landroid/hardware/radio/RadioManager$BandConfig;)V
    .locals 1
...
.method public synthetic blacklist lambda$onCurrentProgramInfoChanged$6$TunerCallbackAdapter(Landroid/hardware/radio/RadioManager$ProgramInfo;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/hardware/radio/RadioTuner$Callback;->onMetadataChanged(Landroid/hardware/radio/RadioMetadata;)V
...
.method public synthetic blacklist lambda$onEmergencyAnnouncement$8$TunerCallbackAdapter(Z)V
    .locals 1
...
.method public synthetic blacklist lambda$onError$2$TunerCallbackAdapter(I)V
    .locals 1
...
.method public synthetic blacklist lambda$onParametersUpdated$14$TunerCallbackAdapter(Ljava/util/Map;)V
    .locals 1
...
.method public synthetic blacklist lambda$onProgramListChanged$12$TunerCallbackAdapter()V
    .locals 1
...
.method public synthetic blacklist lambda$onProgramListUpdated$13$TunerCallbackAdapter(Landroid/hardware/radio/ProgramList$Chunk;)V
    .locals 2
    ...
    invoke-virtual {v1, p1}, Landroid/hardware/radio/ProgramList;->apply(Landroid/hardware/radio/ProgramList$Chunk;)V
...
.method public synthetic blacklist lambda$onTrafficAnnouncement$7$TunerCallbackAdapter(Z)V
    .locals 1
...
.method public synthetic blacklist lambda$onTuneFailed$3$TunerCallbackAdapter(ILandroid/hardware/radio/ProgramSelector;)V
    .locals 1
...
.method public synthetic blacklist lambda$onTuneFailed$4$TunerCallbackAdapter(I)V
    .locals 1
...
.method public synthetic blacklist lambda$sendBackgroundScanCompleteLocked$11$TunerCallbackAdapter()V
    .locals 1
...
.method public synthetic blacklist lambda$setProgramListObserver$0$TunerCallbackAdapter(Landroid/hardware/radio/ProgramList;Landroid/hardware/radio/ProgramList$OnCloseListener;)V
    .locals 2
...
.method public synthetic blacklist lambda$setProgramListObserver$1$TunerCallbackAdapter(Landroid/hardware/radio/ProgramList;)V
    .locals 2
...
.method public blacklist onConfigurationChanged(Landroid/hardware/radio/RadioManager$BandConfig;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda8;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Landroid/hardware/radio/RadioManager$BandConfig;)V
...
.method public blacklist onCurrentProgramInfoChanged(Landroid/hardware/radio/RadioManager$ProgramInfo;)V
    ...
    const-string v0, "ProgramInfo must not be null"
    ...
    invoke-direct {v1, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda9;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Landroid/hardware/radio/RadioManager$ProgramInfo;)V
...
.method public blacklist onError(I)V
    ...
    new-instance v1, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda4;

    invoke-direct {v1, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda4;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;I)V
...
.method public blacklist onParametersUpdated(Ljava/util/Map;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda10;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Ljava/util/Map;)V
...
.method public blacklist onProgramListChanged()V
    ...
    invoke-direct {v1, p0}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda2;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;)V
...
.method public blacklist onProgramListUpdated(Landroid/hardware/radio/ProgramList$Chunk;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda7;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Landroid/hardware/radio/ProgramList$Chunk;)V
...
.method public blacklist onTuneFailed(ILandroid/hardware/radio/ProgramSelector;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda6;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;ILandroid/hardware/radio/ProgramSelector;)V
    ...
    const-string v0, "Got an error with no mapping to the legacy API ("
    ...
    .line 141
    :goto_1
    iget-object p2, p0, Landroid/hardware/radio/TunerCallbackAdapter;->mHandler:Landroid/os/Handler;

    new-instance v0, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda5;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;I)V
...
.method blacklist setProgramListObserver(Landroid/hardware/radio/ProgramList;Landroid/hardware/radio/ProgramList$OnCloseListener;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda0;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Landroid/hardware/radio/ProgramList;Landroid/hardware/radio/ProgramList$OnCloseListener;)V
    ...
    invoke-direct {p2, p0, p1}, Landroid/hardware/radio/TunerCallbackAdapter$$ExternalSyntheticLambda1;-><init>(Landroid/hardware/radio/TunerCallbackAdapter;Landroid/hardware/radio/ProgramList;)V
