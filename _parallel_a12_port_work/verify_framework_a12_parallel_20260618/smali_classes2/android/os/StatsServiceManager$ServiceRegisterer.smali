...
.method public blacklist getOrThrow()Landroid/os/IBinder;
    ...
    .line 72
    new-instance v0, Landroid/os/StatsServiceManager$ServiceNotFoundException;

    iget-object v1, p0, Landroid/os/StatsServiceManager$ServiceRegisterer;->mServiceName:Ljava/lang/String;

    invoke-direct {v0, v1}, Landroid/os/StatsServiceManager$ServiceNotFoundException;-><init>(Ljava/lang/String;)V
