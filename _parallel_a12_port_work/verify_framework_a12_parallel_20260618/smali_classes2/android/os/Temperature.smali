...
.method public constructor blacklist <init>(FILjava/lang/String;I)V
    ...
    iput-object p1, p0, Landroid/os/Temperature;->mName:Ljava/lang/String;
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 180
    iget v0, p1, Landroid/os/Temperature;->mValue:F
    ...
    iget v0, p1, Landroid/os/Temperature;->mType:I

    iget v2, p0, Landroid/os/Temperature;->mType:I

    if-ne v0, v2, :cond_1

    iget-object v0, p1, Landroid/os/Temperature;->mName:Ljava/lang/String;

    iget-object v2, p0, Landroid/os/Temperature;->mName:Ljava/lang/String;
    ...
    iget p1, p1, Landroid/os/Temperature;->mStatus:I
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 186
    iget p2, p0, Landroid/os/Temperature;->mValue:F

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeFloat(F)V

    .line 187
    iget p2, p0, Landroid/os/Temperature;->mType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 188
    iget-object p2, p0, Landroid/os/Temperature;->mName:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 189
    iget p2, p0, Landroid/os/Temperature;->mStatus:I
