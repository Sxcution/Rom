...
.method public whitelist connect()V
    ...
    invoke-virtual {v1, v2}, Landroid/nfc/Tag;->setConnectedTechnology(I)Z
    ...
    const-string v2, "Only one TagTechnology can be connected at a time."
    ...
    const-string v1, "NFC service died"
...
.method greylist-max-o transceive([BZ)[B
    ...
    .line 154
    invoke-virtual {p1}, Landroid/nfc/TransceiveResult;->getResponseOrThrow()[B
    ...
    const-string/jumbo p2, "transceive failed"
    ...
    const-string p2, "NFC service died"
