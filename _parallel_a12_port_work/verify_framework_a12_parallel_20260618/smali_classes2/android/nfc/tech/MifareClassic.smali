...
.method public constructor greylist-max-o <init>(Landroid/nfc/Tag;)V
    ...
    iput-boolean v0, p0, Landroid/nfc/tech/MifareClassic;->mIsEmulated:Z

    .line 154
    invoke-virtual {p1}, Landroid/nfc/tech/NfcA;->getSak()S
    ...
    const-string v2, "Tag incorrectly enumerated as MIFARE Classic, SAK = "
    ...
    iput p1, p0, Landroid/nfc/tech/MifareClassic;->mType:I
    ...
    .line 180
    iput v2, p0, Landroid/nfc/tech/MifareClassic;->mSize:I
    ...
    iput p1, p0, Landroid/nfc/tech/MifareClassic;->mSize:I
...
.method private greylist-max-o authenticate(I[BZ)Z
    ...
    invoke-static {p2, v1, v0, p1, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method private static greylist-max-o validateValueOperand(I)V
    ...
    const-string/jumbo v0, "value operand negative"
...
.method public whitelist decrement(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/nfc/tech/MifareClassic;->transceive([BZ)[B
...
.method public whitelist writeBlock(I[B)V
    ...
    const-string/jumbo p2, "must write 16-bytes"
