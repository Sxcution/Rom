...
.method public static greylist-max-o endBlockSuppression(Landroid/content/Context;)V
    ...
    const-string v0, "endBlockSuppression: caller=%s"

    invoke-static {v1, v0, v2}, Landroid/telecom/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static greylist-max-o getBlockSuppressionStatus(Landroid/content/Context;)Landroid/provider/BlockedNumberContract$SystemContract$BlockSuppressionStatus;
    ...
    .line 517
    const-string p0, "getBlockSuppressionStatus: caller=%s, status=%s"

    invoke-static {v0, p0, v2}, Landroid/telecom/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static greylist-max-o getEnhancedBlockSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v0, "getEnhancedBlockSetting: provider not ready."

    invoke-static {p1, v0, p0}, Landroid/telecom/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static greylist-max-o notifyEmergencyContact(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "notifyEmergencyContact: provider not ready."

    invoke-static {v1, v0, p0}, Landroid/telecom/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static greylist-max-o shouldShowEmergencyCallNotification(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "shouldShowEmergencyCallNotification: provider not ready."

    invoke-static {v0, v2, p0}, Landroid/telecom/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static blacklist shouldSystemBlockNumber(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 497
    invoke-static {p2, v2, v3}, Landroid/telecom/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo p2, "shouldSystemBlockNumber: provider not ready."

    invoke-static {p0, p2, p1}, Landroid/telecom/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
