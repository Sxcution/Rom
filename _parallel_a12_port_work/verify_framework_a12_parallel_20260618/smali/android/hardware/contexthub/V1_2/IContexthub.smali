...
.method public static blacklist asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_2/IContexthub;
    ...
    .line 21
    check-cast v2, Landroid/hardware/contexthub/V1_2/IContexthub;

    return-object v2

    .line 24
    :cond_1
    new-instance v2, Landroid/hardware/contexthub/V1_2/IContexthub$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/contexthub/V1_2/IContexthub$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 27
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/contexthub/V1_2/IContexthub;->interfaceChain()Ljava/util/ArrayList;
...
.method public static blacklist castFrom(Landroid/os/IHwInterface;)Landroid/hardware/contexthub/V1_2/IContexthub;
    ...
    invoke-static {p0}, Landroid/hardware/contexthub/V1_2/IContexthub;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_2/IContexthub;
