...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 326
    new-instance v4, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;

    invoke-direct {v4}, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;

    mul-int/lit8 v5, v4, 0x28

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 280
    :cond_2
    check-cast p1, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;

    .line 281
    iget-object v2, p0, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->v2_0:Landroid/hardware/gnss/V2_0/IGnssCallback$GnssSvInfo;

    iget-object v3, p1, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->v2_0:Landroid/hardware/gnss/V2_0/IGnssCallback$GnssSvInfo;
    ...
    iget-wide v4, p1, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->basebandCN0DbHz:D
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput-wide p1, p0, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->basebandCN0DbHz:D
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-wide v0, p0, Landroid/hardware/gnss/V2_1/IGnssCallback$GnssSvInfo;->basebandCN0DbHz:D
