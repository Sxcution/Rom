...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 536
    new-instance v4, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;

    invoke-direct {v4}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;

    mul-int/lit8 v5, v4, 0x68

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 490
    :cond_2
    check-cast p1, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;

    .line 491
    iget-object v2, p0, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->v1_0:Landroid/hardware/gnss/V1_0/IGnssMeasurementCallback$GnssClock;

    iget-object v3, p1, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->v1_0:Landroid/hardware/gnss/V1_0/IGnssMeasurementCallback$GnssClock;
    ...
    .line 494
    :cond_3
    iget-object v2, p0, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->referenceSignalTypeForIsb:Landroid/hardware/gnss/V2_1/GnssSignalType;

    iget-object p1, p1, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssClock;->referenceSignalTypeForIsb:Landroid/hardware/gnss/V2_1/GnssSignalType;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/hardware/gnss/V2_1/GnssSignalType;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/hardware/gnss/V2_1/GnssSignalType;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
