...
.method static synthetic blacklist access$000(Landroid/app/ActivityTransitionState;)Landroid/app/EnterTransitionCoordinator;
    .locals 0
...
.method static synthetic blacklist access$002(Landroid/app/ActivityTransitionState;Landroid/app/EnterTransitionCoordinator;)Landroid/app/EnterTransitionCoordinator;
    .locals 0
...
.method static synthetic blacklist access$100(Landroid/app/ActivityTransitionState;)V
    .locals 0
...
.method static synthetic blacklist access$200(Landroid/app/ActivityTransitionState;)V
    .locals 0
...
.method public greylist-max-o enterReady(Landroid/app/Activity;)V
    ...
    .line 208
    iget-object p1, p0, Landroid/app/ActivityTransitionState;->mEnterActivityOptions:Landroid/app/ActivityOptions;

    invoke-virtual {p1}, Landroid/app/ActivityOptions;->isCrossTask()Z
...
.method public synthetic blacklist lambda$startExitBackTransition$0$ActivityTransitionState(Landroid/app/Activity;)V
    .locals 1
...
.method public greylist-max-o saveState(Landroid/os/Bundle;)V
    ...
    .line 161
    iget-object v0, p0, Landroid/app/ActivityTransitionState;->mExitingTo:Ljava/util/ArrayList;
...
.method public greylist-max-o setEnterActivityOptions(Landroid/app/Activity;Landroid/app/ActivityOptions;)V
    ...
    .line 180
    iget-object p2, p0, Landroid/app/ActivityTransitionState;->mEnterActivityOptions:Landroid/app/ActivityOptions;

    invoke-virtual {p2}, Landroid/app/ActivityOptions;->getResultCode()I
    ...
    invoke-virtual {v0}, Landroid/app/ActivityOptions;->getResultData()Landroid/content/Intent;
    ...
    .line 186
    :cond_1
    invoke-virtual {p1, p2, v0}, Landroid/app/Activity;->onActivityReenter(ILandroid/content/Intent;)V
...
.method public greylist-max-o startExitOutTransition(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    .line 384
    invoke-virtual {p1}, Landroid/app/ActivityOptions;->getExitCoordinatorKey()I
    ...
    invoke-virtual {p1}, Landroid/app/ExitTransitionCoordinator;->startExit()V
