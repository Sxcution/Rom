...
.method synthetic constructor blacklist <init>(Landroid/app/admin/SystemUpdatePolicy$1;)V
    .locals 0
...
.method static synthetic blacklist access$202(Landroid/app/admin/SystemUpdatePolicy;I)I
    .locals 0
...
.method static synthetic blacklist access$302(Landroid/app/admin/SystemUpdatePolicy;I)I
    .locals 0
...
.method static synthetic blacklist access$402(Landroid/app/admin/SystemUpdatePolicy;I)I
    .locals 0
...
.method static synthetic blacklist access$500(Landroid/app/admin/SystemUpdatePolicy;)Ljava/util/ArrayList;
    .locals 0
...
.method private greylist-max-o getInstallationOptionRegardlessFreezeAt(J)Landroid/app/admin/SystemUpdatePolicy$InstallationOption;
    ...
    iget v4, p0, Landroid/app/admin/SystemUpdatePolicy;->mMaintenanceWindowEnd:I
    ...
    invoke-direct {v0, v1, v4, v5}, Landroid/app/admin/SystemUpdatePolicy$InstallationOption;-><init>(IJ)V
    ...
    const-string p2, "Unknown policy type"
    ...
    invoke-direct {p1, v0, v1, v2}, Landroid/app/admin/SystemUpdatePolicy$InstallationOption;-><init>(IJ)V
...
.method private greylist-max-o timeUntilNextFreezePeriod(J)J
    ...
    .line 509
    invoke-virtual {v3, v1}, Landroid/app/admin/FreezePeriod;->after(Ljava/time/LocalDate;)Z
    ...
    .line 512
    :cond_0
    invoke-virtual {v3, v1}, Landroid/app/admin/FreezePeriod;->contains(Ljava/time/LocalDate;)Z
    ...
    const-string p2, "Given date is inside a freeze period"
    ...
    invoke-virtual {v0, v1}, Landroid/app/admin/FreezePeriod;->toCurrentOrFutureRealDates(Ljava/time/LocalDate;)Landroid/util/Pair;
...
.method public whitelist getInstallationOptionAt(J)Landroid/app/admin/SystemUpdatePolicy$InstallationOption;
    ...
    invoke-direct {v1, v2, v3, v4}, Landroid/app/admin/SystemUpdatePolicy$InstallationOption;-><init>(IJ)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/app/admin/SystemUpdatePolicy$InstallationOption;->limitEffectiveTime(J)V
...
.method public blacklist saveToXml(Landroid/util/TypedXmlSerializer;)V
    ...
    invoke-virtual {v2}, Ljava/time/MonthDay;->toString()Ljava/lang/String;
...
.method public whitelist test-api toString()Ljava/lang/String;
    ...
    sget-object v2, Landroid/app/admin/SystemUpdatePolicy$$ExternalSyntheticLambda0;->INSTANCE:Landroid/app/admin/SystemUpdatePolicy$$ExternalSyntheticLambda0;
