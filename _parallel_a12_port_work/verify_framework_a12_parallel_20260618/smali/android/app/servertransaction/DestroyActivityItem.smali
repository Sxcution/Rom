...
.method private constructor greylist-max-o <init>(Landroid/os/Parcel;)V
    ...
    iput p1, p0, Landroid/app/servertransaction/DestroyActivityItem;->mConfigChanges:I

    .line 96
    return-void
.end method

.method synthetic constructor blacklist <init>(Landroid/os/Parcel;Landroid/app/servertransaction/DestroyActivityItem$1;)V
    .locals 0
...
.method public static greylist-max-o obtain(ZI)Landroid/app/servertransaction/DestroyActivityItem;
    ...
    invoke-direct {v0}, Landroid/app/servertransaction/DestroyActivityItem;-><init>()V
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v3, p1, Landroid/app/servertransaction/DestroyActivityItem;->mFinished:Z

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/app/servertransaction/DestroyActivityItem;->mConfigChanges:I

    iget p1, p1, Landroid/app/servertransaction/DestroyActivityItem;->mConfigChanges:I
...
.method public blacklist execute(Landroid/app/ClientTransactionHandler;Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/servertransaction/PendingTransactionActions;)V
    ...
    .line 47
    iget-boolean v4, p0, Landroid/app/servertransaction/DestroyActivityItem;->mFinished:Z

    iget v5, p0, Landroid/app/servertransaction/DestroyActivityItem;->mConfigChanges:I

    const/4 v6, 0x0

    const-string v7, "DestroyActivityItem"

    move-object v2, p1

    move-object v3, p2

    invoke-virtual/range {v2 .. v7}, Landroid/app/ClientTransactionHandler;->handleDestroyActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZIZLjava/lang/String;)V
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 88
    iget-boolean p2, p0, Landroid/app/servertransaction/DestroyActivityItem;->mFinished:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 89
    iget p2, p0, Landroid/app/servertransaction/DestroyActivityItem;->mConfigChanges:I
