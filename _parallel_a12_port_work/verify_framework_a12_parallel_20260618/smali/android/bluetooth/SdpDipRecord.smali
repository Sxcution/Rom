...
.method public constructor blacklist <init>(Landroid/os/Parcel;)V
    ...
    iput-boolean p1, p0, Landroid/bluetooth/SdpDipRecord;->mPrimaryRecord:Z
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 82
    iget p2, p0, Landroid/bluetooth/SdpDipRecord;->mSpecificationId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 83
    iget p2, p0, Landroid/bluetooth/SdpDipRecord;->mVendorId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 84
    iget p2, p0, Landroid/bluetooth/SdpDipRecord;->mVendorIdSource:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 85
    iget p2, p0, Landroid/bluetooth/SdpDipRecord;->mProductId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 86
    iget p2, p0, Landroid/bluetooth/SdpDipRecord;->mVersion:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 87
    iget-boolean p2, p0, Landroid/bluetooth/SdpDipRecord;->mPrimaryRecord:Z
