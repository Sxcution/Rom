...
# static fields
.field public static final greylist-max-o DESCRIPTOR:Ljava/lang/String; = "android.content.ISyncAdapterUnsyncableAccountCallback"

.field static final greylist-max-o TRANSACTION_onUnsyncableAccountDone:I = 0x1
...
.method public static greylist-max-o asInterface(Landroid/os/IBinder;)Landroid/content/ISyncAdapterUnsyncableAccountCallback;
    .locals 2
    ...
    .line 46
    check-cast v0, Landroid/content/ISyncAdapterUnsyncableAccountCallback;

    return-object v0

    .line 48
    :cond_1
    new-instance v0, Landroid/content/ISyncAdapterUnsyncableAccountCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/content/ISyncAdapterUnsyncableAccountCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V

    return-object v0
.end method

.method public static blacklist getDefaultImpl()Landroid/content/ISyncAdapterUnsyncableAccountCallback;
    .locals 1
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    .line 61
    :pswitch_0
    const-string p0, "onUnsyncableAccountDone"
...
.method public static blacklist setDefaultImpl(Landroid/content/ISyncAdapterUnsyncableAccountCallback;)Z
    .locals 1
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 92
    :goto_0
    invoke-virtual {p0, p1}, Landroid/content/ISyncAdapterUnsyncableAccountCallback$Stub;->onUnsyncableAccountDone(Z)V
