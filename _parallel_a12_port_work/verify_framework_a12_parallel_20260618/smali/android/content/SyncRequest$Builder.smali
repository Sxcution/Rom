...
.method static synthetic blacklist access$100(Landroid/content/SyncRequest$Builder;)J
    .locals 2
...
.method static synthetic blacklist access$1000(Landroid/content/SyncRequest$Builder;)Landroid/os/Bundle;
    .locals 0
...
.method static synthetic blacklist access$1100(Landroid/content/SyncRequest$Builder;)Z
    .locals 0
...
.method static synthetic blacklist access$200(Landroid/content/SyncRequest$Builder;)J
    .locals 2
...
.method static synthetic blacklist access$300(Landroid/content/SyncRequest$Builder;)Landroid/accounts/Account;
    .locals 0
...
.method static synthetic blacklist access$400(Landroid/content/SyncRequest$Builder;)Ljava/lang/String;
    .locals 0
...
.method static synthetic blacklist access$500(Landroid/content/SyncRequest$Builder;)I
    .locals 0
...
.method static synthetic blacklist access$600(Landroid/content/SyncRequest$Builder;)I
    .locals 0
...
.method static synthetic blacklist access$700(Landroid/content/SyncRequest$Builder;)Z
    .locals 0
...
.method static synthetic blacklist access$800(Landroid/content/SyncRequest$Builder;)Z
    .locals 0
...
.method static synthetic blacklist access$900(Landroid/content/SyncRequest$Builder;)Landroid/os/Bundle;
    .locals 0
...
.method private greylist-max-o setupInterval(JJ)V
    ...
    const-string p2, "Specified run time for the sync must be after the specified flex time."
...
.method public whitelist setDisallowMetered(Z)Landroid/content/SyncRequest$Builder;
    ...
    const-string v0, "setDisallowMetered(true) after having specified that settings are ignored."
...
.method public whitelist setIgnoreSettings(Z)Landroid/content/SyncRequest$Builder;
    ...
    const-string/jumbo v0, "setIgnoreSettings(true) after having specified sync settings with this builder."
...
.method public whitelist setSyncAdapter(Landroid/accounts/Account;Ljava/lang/String;)Landroid/content/SyncRequest$Builder;
    ...
    const-string p2, "Sync target has already been defined."
...
.method public whitelist syncPeriodic(JJ)Landroid/content/SyncRequest$Builder;
    ...
    const-string p2, "Sync type has already been defined."
