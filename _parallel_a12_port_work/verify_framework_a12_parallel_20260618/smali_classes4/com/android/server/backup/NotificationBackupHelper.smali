...
.method protected blacklist applyRestoredPayload(Ljava/lang/String;[B)V
    ...
    .line 69
    iget v0, p0, Lcom/android/server/backup/NotificationBackupHelper;->mUserId:I

    invoke-interface {p1, p2, v0}, Landroid/app/INotificationManager;->applyRestore([BI)V
    :try_end_0
    ...
    .line 71
    const-string p2, "Couldn\'t communicate with notification manager"
...
.method protected blacklist getBackupPayload(Ljava/lang/String;)[B
    ...
    .line 49
    iget v1, p0, Lcom/android/server/backup/NotificationBackupHelper;->mUserId:I

    invoke-interface {p1, v1}, Landroid/app/INotificationManager;->getBackupPayload(I)[B
