...
.method public constructor blacklist <init>()V
    ...
    .line 54
    invoke-static {v1}, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->readPublicKeyBlockList(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;

    .line 55
    invoke-static {v0}, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->readSerialBlockList(Ljava/lang/String;)Ljava/util/Set;
...
.method public constructor blacklist <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;
    ...
    iput-object p1, p0, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->serialBlocklist:Ljava/util/Set;
...
.method private static blacklist readBlocklist(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "Could not read blocklist"
...
.method private static blacklist readFileAsBytes(Ljava/lang/String;)Ljava/io/ByteArrayOutputStream;
    ...
    .line 112
    invoke-static {v1}, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->closeQuietly(Ljava/io/Closeable;)V
...
.method private static blacklist readPublicKeyBlockList(Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 209
    invoke-static {v2}, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->isPubkeyHash(Ljava/lang/String;)Z
    ...
    .line 212
    :cond_0
    sget-object v4, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->logger:Ljava/util/logging/Logger;
    ...
    const-string v7, "Tried to blocklist invalid pubkey "
...
.method private static blacklist readSerialBlockList(Ljava/lang/String;)Ljava/util/Set;
    ...
    const-string v9, "Tried to blocklist invalid serial number "
...
.method public blacklist isPublicKeyBlockListed(Ljava/security/PublicKey;)Z
    ...
    invoke-interface {v0, p1, v2, v1}, Lcom/android/internal/org/bouncycastle/crypto/Digest;->update([BII)V
    ...
    .line 225
    invoke-interface {v0, p1, v2}, Lcom/android/internal/org/bouncycastle/crypto/Digest;->doFinal([BI)I

    .line 226
    iget-object v0, p0, Lcom/android/internal/org/bouncycastle/jce/provider/CertBlocklist;->pubkeyBlocklist:Ljava/util/Set;
    ...
    .line 227
    invoke-static {p1}, Lcom/android/internal/org/bouncycastle/util/encoders/Hex;->encode([B)[B
