...
.method public constructor blacklist <init>(Ljava/lang/String;Ljava/lang/String;JZLjava/lang/String;)V
    ...
    iput-object p1, p0, Landroid/telecom/Logging/Session;->mChildSessions:Ljava/util/ArrayList;
...
.method static synthetic blacklist access$000(Landroid/telecom/Logging/Session;)Ljava/lang/String;
    .locals 0
...
.method static synthetic blacklist access$100(Landroid/telecom/Logging/Session;)Z
    .locals 0
...
.method private declared-synchronized blacklist getFullMethodPath(Ljava/lang/StringBuilder;ZI)V
    ...
    const-string p3, "getFullMethodPath: Hit recursion limit!"
    ...
    invoke-direct {v0, p1, p2, p3}, Landroid/telecom/Logging/Session;->getFullMethodPath(Ljava/lang/StringBuilder;ZI)V
...
.method private blacklist getFullSessionId(I)Ljava/lang/String;
    ...
    .line 286
    iget-object p1, p0, Landroid/telecom/Logging/Session;->mSessionId:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Landroid/telecom/Logging/Session;->getFullSessionId(I)Ljava/lang/String;
...
.method private blacklist getRootSession(Ljava/lang/String;)Landroid/telecom/Logging/Session;
    ...
    const-string v2, "getRootSession: Hit recursion limit from "
...
.method private blacklist printSessionTree(ILjava/lang/StringBuilder;I)V
    ...
    const-string p3, "printSessionTree: Hit recursion limit!"
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    iget-wide v4, p1, Landroid/telecom/Logging/Session;->mExecutionStartTimeMs:J
    ...
    iget-wide v4, p1, Landroid/telecom/Logging/Session;->mExecutionEndTimeMs:J
    ...
    iget-boolean v3, p1, Landroid/telecom/Logging/Session;->mIsCompleted:Z
    ...
    .line 435
    :cond_4
    iget v2, p0, Landroid/telecom/Logging/Session;->mChildCounter:I

    iget v3, p1, Landroid/telecom/Logging/Session;->mChildCounter:I
    ...
    iget-boolean v3, p1, Landroid/telecom/Logging/Session;->mIsStartedFromActiveSession:Z
    ...
    iget-object v3, p1, Landroid/telecom/Logging/Session;->mSessionId:Ljava/lang/String;
    ...
    iget-object v3, p1, Landroid/telecom/Logging/Session;->mShortMethodName:Ljava/lang/String;
    ...
    iget-object v3, p1, Landroid/telecom/Logging/Session;->mParentSession:Landroid/telecom/Logging/Session;

    invoke-virtual {v2, v3}, Landroid/telecom/Logging/Session;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Landroid/telecom/Logging/Session;->mChildSessions:Ljava/util/ArrayList;
...
.method public blacklist printFullSessionTree()Ljava/lang/String;
    ...
    .line 320
    const-string v0, "printFullSessionTree"
