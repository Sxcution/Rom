...
.method public blacklist loadLanguage(Landroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v1, p2, v7, v8}, Landroid/speech/tts/TextToSpeechService;->onIsLanguageAvailable(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 1434
    :cond_1
    new-instance v12, Landroid/speech/tts/TextToSpeechService$LoadLanguageItem;
    ...
    .line 1443
    iget-object v0, v0, Landroid/speech/tts/TextToSpeechService$1;->this$0:Landroid/speech/tts/TextToSpeechService;

    invoke-static {v0}, Landroid/speech/tts/TextToSpeechService;->access$1000(Landroid/speech/tts/TextToSpeechService;)Landroid/speech/tts/TextToSpeechService$SynthHandler;

    move-result-object v0

    invoke-virtual {v0, v9, v12}, Landroid/speech/tts/TextToSpeechService$SynthHandler;->enqueueSpeechItem(ILandroid/speech/tts/TextToSpeechService$SpeechItem;)I
...
.method public blacklist loadVoice(Landroid/os/IBinder;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v0, v9}, Landroid/speech/tts/TextToSpeechService$SynthHandler;->enqueueSpeechItem(ILandroid/speech/tts/TextToSpeechService$SpeechItem;)I
...
.method public blacklist playAudio(Landroid/os/IBinder;Landroid/net/Uri;ILandroid/os/Bundle;Ljava/lang/String;)I
    ...
    .line 1339
    :cond_0
    new-instance v8, Landroid/speech/tts/TextToSpeechService$AudioSpeechItem;
    ...
    invoke-virtual {p1, p3, v8}, Landroid/speech/tts/TextToSpeechService$SynthHandler;->enqueueSpeechItem(ILandroid/speech/tts/TextToSpeechService$SpeechItem;)I
...
.method public blacklist playSilence(Landroid/os/IBinder;JILjava/lang/String;)I
    ...
    .line 1357
    :cond_0
    new-instance v8, Landroid/speech/tts/TextToSpeechService$SilenceSpeechItem;
    ...
    invoke-virtual {p1, p4, v8}, Landroid/speech/tts/TextToSpeechService$SynthHandler;->enqueueSpeechItem(ILandroid/speech/tts/TextToSpeechService$SpeechItem;)I
...
.method public blacklist speak(Landroid/os/IBinder;Ljava/lang/CharSequence;ILandroid/os/Bundle;Ljava/lang/String;)I
    ...
    .line 1287
    :cond_0
    new-instance v8, Landroid/speech/tts/TextToSpeechService$SynthesisSpeechItem;
...
.method public blacklist synthesizeToFileDescriptor(Landroid/os/IBinder;Ljava/lang/CharSequence;Landroid/os/ParcelFileDescriptor;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v2, v12}, Landroid/speech/tts/TextToSpeechService$SynthHandler;->enqueueSpeechItem(ILandroid/speech/tts/TextToSpeechService$SpeechItem;)I
