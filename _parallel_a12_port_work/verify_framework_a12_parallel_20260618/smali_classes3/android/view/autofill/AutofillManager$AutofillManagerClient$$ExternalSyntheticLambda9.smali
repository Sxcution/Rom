...
.method public synthetic constructor blacklist <init>(Landroid/view/autofill/AutofillManager;ILjava/util/List;Ljava/util/List;Z)V
    ...
    iput p2, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$1:I

    iput-object p3, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$2:Ljava/util/List;

    iput-object p4, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$3:Ljava/util/List;

    iput-boolean p5, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$4:Z
...
.method public final whitelist test-api run()V
    ...
    iget v1, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$1:I

    iget-object v2, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$2:Ljava/util/List;

    iget-object v3, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$3:Ljava/util/List;

    iget-boolean v4, p0, Landroid/view/autofill/AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9;->f$4:Z
