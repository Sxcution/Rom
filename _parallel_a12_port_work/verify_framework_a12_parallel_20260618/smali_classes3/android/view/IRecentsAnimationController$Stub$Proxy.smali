...
.method public blacklist animateNavigationBarToApp(J)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/view/IRecentsAnimationController;->animateNavigationBarToApp(J)V
    :try_end_0
...
.method public blacklist cleanupScreenshot()V
    ...
    invoke-interface {v2}, Landroid/view/IRecentsAnimationController;->cleanupScreenshot()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist detachNavigationBarFromApp(Z)V
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->detachNavigationBarFromApp(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist finish(ZZ)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/view/IRecentsAnimationController;->finish(ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o hideCurrentInputMethod()V
    ...
    invoke-interface {v2}, Landroid/view/IRecentsAnimationController;->hideCurrentInputMethod()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist removeTask(I)Z
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->removeTask(I)Z
...
.method public blacklist screenshotTask(I)Landroid/window/TaskSnapshot;
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->screenshotTask(I)Landroid/window/TaskSnapshot;
...
.method public greylist-max-o setAnimationTargetsBehindSystemBars(Z)V
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->setAnimationTargetsBehindSystemBars(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist setDeferCancelUntilNextTransition(ZZ)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/view/IRecentsAnimationController;->setDeferCancelUntilNextTransition(ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist setFinishTaskTransaction(ILandroid/window/PictureInPictureSurfaceTransaction;Landroid/view/SurfaceControl;)V
    ...
    .line 468
    invoke-virtual {p2, v0, v3}, Landroid/window/PictureInPictureSurfaceTransaction;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface {v2, p1, p2, p3}, Landroid/view/IRecentsAnimationController;->setFinishTaskTransaction(ILandroid/window/PictureInPictureSurfaceTransaction;Landroid/view/SurfaceControl;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o setInputConsumerEnabled(Z)V
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->setInputConsumerEnabled(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist setWillFinishToHome(Z)V
    ...
    invoke-interface {v2, p1}, Landroid/view/IRecentsAnimationController;->setWillFinishToHome(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
