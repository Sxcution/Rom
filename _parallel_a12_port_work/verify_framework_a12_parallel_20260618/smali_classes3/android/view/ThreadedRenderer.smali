...
.method private greylist-max-o updateRootDisplayList(Landroid/view/View;Landroid/view/ThreadedRenderer$DrawCallbacks;)V
    ...
    .line 548
    new-instance v3, Landroid/view/ThreadedRenderer$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Landroid/view/ThreadedRenderer$$ExternalSyntheticLambda0;-><init>(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v2, p1}, Landroid/graphics/RecordingCanvas;->drawRenderNode(Landroid/graphics/RenderNode;)V
...
.method blacklist draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/ThreadedRenderer$DrawCallbacks;)V
    ...
    .line 636
    const-string p3, "OpenGLRenderer"
...
.method greylist-max-o dumpGfxInfo(Ljava/io/PrintWriter;Ljava/io/FileDescriptor;[Ljava/lang/String;)V
    ...
    .line 513
    :cond_3
    invoke-virtual {p0, p2, v1}, Landroid/view/ThreadedRenderer;->dumpProfileInfo(Ljava/io/FileDescriptor;I)V
...
.method greylist-max-o setLightCenter(Landroid/view/View$AttachInfo;)V
    ...
    iget v1, p1, Landroid/view/View$AttachInfo;->mWindowLeft:I
    ...
    .line 467
    iget v1, p0, Landroid/view/ThreadedRenderer;->mLightY:F
    ...
    .line 468
    iget p1, p0, Landroid/view/ThreadedRenderer;->mLightZ:F

    iget v2, p0, Landroid/view/ThreadedRenderer;->mLightRadius:F

    invoke-virtual {p0, v0, v1, p1, v2}, Landroid/view/ThreadedRenderer;->setLightSourceGeometry(FFFF)V
