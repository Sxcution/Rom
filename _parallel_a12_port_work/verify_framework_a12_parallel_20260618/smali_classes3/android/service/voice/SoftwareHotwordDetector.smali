...
.method constructor blacklist <init>(Lcom/android/internal/app/IVoiceInteractionManagerService;Landroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/os/SharedMemory;Landroid/service/voice/HotwordDetector$Callback;)V
    ...
    iput-object p1, p0, Landroid/service/voice/SoftwareHotwordDetector;->mHandler:Landroid/os/Handler;

    .line 69
    new-instance p2, Landroid/service/voice/SoftwareHotwordDetector$InitializationStateListener;

    invoke-direct {p2, p1, p5}, Landroid/service/voice/SoftwareHotwordDetector$InitializationStateListener;-><init>(Landroid/os/Handler;Landroid/service/voice/HotwordDetector$Callback;)V

    invoke-virtual {p0, p3, p4, p2, v0}, Landroid/service/voice/SoftwareHotwordDetector;->updateStateLocked(Landroid/os/PersistableBundle;Landroid/os/SharedMemory;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;I)V
