...
.method public whitelist mapProperties(Landroid/view/inspector/PropertyMapper;)V
    ...
    iput p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mToStartOfId:I
...
.method public blacklist readProperties(Landroid/widget/RelativeLayout$LayoutParams;Landroid/view/inspector/PropertyReader;)V
    ...
    iget-boolean p1, p1, Landroid/widget/RelativeLayout$LayoutParams;->alignWithParent:Z

    invoke-interface {p2, v1, p1}, Landroid/view/inspector/PropertyReader;->readBoolean(IZ)V

    .line 1859
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mBelowId:I

    const/4 v1, 0x3

    aget v1, v0, v1

    invoke-interface {p2, p1, v1}, Landroid/view/inspector/PropertyReader;->readResourceId(II)V

    .line 1860
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mCenterHorizontalId:I
    ...
    :goto_6
    invoke-interface {p2, p1, v1}, Landroid/view/inspector/PropertyReader;->readBoolean(IZ)V

    .line 1861
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mCenterInParentId:I
    ...
    .line 1862
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mCenterVerticalId:I
    ...
    .line 1863
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mToEndOfId:I
    ...
    .line 1864
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mToLeftOfId:I
    ...
    .line 1865
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mToRightOfId:I
    ...
    .line 1866
    iget p1, p0, Landroid/widget/RelativeLayout$LayoutParams$InspectionCompanion;->mToStartOfId:I

    const/16 v1, 0x10

    aget v0, v0, v1

    invoke-interface {p2, p1, v0}, Landroid/view/inspector/PropertyReader;->readResourceId(II)V
