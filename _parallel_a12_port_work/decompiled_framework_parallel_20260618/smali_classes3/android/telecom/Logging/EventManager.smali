...
.method static synthetic blacklist access$000(Landroid/telecom/Logging/EventManager;)Ljava/util/Map;
    .locals 0
...
.method static synthetic blacklist access$100(Landroid/telecom/Logging/EventManager;)Ljava/util/Map;
    .locals 0
...
.method private blacklist addEventRecord(Landroid/telecom/Logging/EventManager$EventRecord;)V
    ...
    check-cast v2, Landroid/telecom/Logging/EventManager$EventListener;

    .line 420
    invoke-interface {v2, p1}, Landroid/telecom/Logging/EventManager$EventListener;->eventRecordAdded(Landroid/telecom/Logging/EventManager$EventRecord;)V
...
.method public blacklist changeEventCacheSize(I)V
    ...
    .line 367
    new-instance p1, Landroid/telecom/Logging/EventManager$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0}, Landroid/telecom/Logging/EventManager$$ExternalSyntheticLambda0;-><init>(Landroid/telecom/Logging/EventManager;)V
...
.method public blacklist dumpEventsTimeline(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    .line 343
    :cond_1
    sget-object v1, Landroid/telecom/Logging/EventManager$$ExternalSyntheticLambda1;->INSTANCE:Landroid/telecom/Logging/EventManager$$ExternalSyntheticLambda1;
    ...
    iget-object v2, v2, Landroid/telecom/Logging/EventManager$Event;->timestampString:Ljava/lang/String;
    ...
    check-cast v3, Landroid/telecom/Logging/EventManager$Loggable;
    ...
    iget-object v3, v3, Landroid/telecom/Logging/EventManager$Event;->eventId:Ljava/lang/String;
    ...
    iget-object v1, v1, Landroid/telecom/Logging/EventManager$Event;->data:Ljava/lang/Object;
...
.method public blacklist event(Landroid/telecom/Logging/EventManager$Loggable;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 288
    const-string p1, "Logging.Events"

    const-string v0, "Non-call EVENT: %s, %s"
    ...
    invoke-static {p1, v0, v1}, Landroid/telecom/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 298
    invoke-virtual {p1, p2, v0, p3}, Landroid/telecom/Logging/EventManager$EventRecord;->addEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public varargs blacklist event(Landroid/telecom/Logging/EventManager$Loggable;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 308
    const-string p4, "IllegalFormatException: formatString=\'%s\' numArgs=%d"

    invoke-static {p0, v0, p4, v1}, Landroid/telecom/Log;->e(Ljava/lang/Object;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public synthetic blacklist lambda$changeEventCacheSize$1$EventManager(Landroid/telecom/Logging/EventManager$EventRecord;)V
    .locals 3
