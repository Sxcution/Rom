...
.method synthetic constructor blacklist <init>(Landroid/telecom/CallDiagnosticService;Landroid/telecom/CallDiagnosticService$1;)V
    .locals 0
...
.method public blacklist callQualityChanged(Ljava/lang/String;Landroid/telephony/CallQuality;)V
    ...
    invoke-static {v0, p1, p2}, Landroid/telecom/CallDiagnosticService;->access$700(Landroid/telecom/CallDiagnosticService;Ljava/lang/String;Landroid/telephony/CallQuality;)V
...
.method public blacklist initializeDiagnosticCall(Landroid/telecom/ParcelableCall;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/CallDiagnosticService;->access$100(Landroid/telecom/CallDiagnosticService;Landroid/telecom/ParcelableCall;)V

    .line 83
    return-void
.end method

.method public synthetic blacklist lambda$updateCallAudioState$0$CallDiagnosticService$CallDiagnosticServiceBinder(Landroid/telecom/CallAudioState;)V
    .locals 1
...
.method public blacklist notifyCallDisconnected(Ljava/lang/String;Landroid/telecom/DisconnectCause;)V
    ...
    invoke-static {v0, p1, p2}, Landroid/telecom/CallDiagnosticService;->access$600(Landroid/telecom/CallDiagnosticService;Ljava/lang/String;Landroid/telecom/DisconnectCause;)V
...
.method public blacklist receiveBluetoothCallQualityReport(Landroid/telecom/BluetoothCallQualityReport;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/CallDiagnosticService;->access$500(Landroid/telecom/CallDiagnosticService;Landroid/telecom/BluetoothCallQualityReport;)V
...
.method public blacklist receiveDeviceToDeviceMessage(Ljava/lang/String;II)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroid/telecom/CallDiagnosticService;->access$400(Landroid/telecom/CallDiagnosticService;Ljava/lang/String;II)V
...
.method public blacklist removeDiagnosticCall(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/CallDiagnosticService;->access$300(Landroid/telecom/CallDiagnosticService;Ljava/lang/String;)V
...
.method public blacklist setAdapter(Lcom/android/internal/telecom/ICallDiagnosticServiceAdapter;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/CallDiagnosticService;->access$000(Landroid/telecom/CallDiagnosticService;Lcom/android/internal/telecom/ICallDiagnosticServiceAdapter;)V
...
.method public blacklist updateCall(Landroid/telecom/ParcelableCall;)V
    ...
    invoke-static {v0, p1}, Landroid/telecom/CallDiagnosticService;->access$200(Landroid/telecom/CallDiagnosticService;Landroid/telecom/ParcelableCall;)V
