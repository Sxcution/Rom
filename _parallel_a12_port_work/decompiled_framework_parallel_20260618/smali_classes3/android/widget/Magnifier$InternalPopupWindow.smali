...
.method constructor blacklist <init>(Landroid/content/Context;Landroid/view/Display;Landroid/view/SurfaceControl;IIFIFFLandroid/graphics/drawable/Drawable;Landroid/os/Handler;Ljava/lang/Object;Landroid/widget/Magnifier$Callback;Z)V
    ...
    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mTransaction:Landroid/view/SurfaceControl$Transaction;

    .line 968
    const/4 v6, 0x1

    iput-boolean v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mFirstDraw:Z
    ...
    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mOverlay:Landroid/graphics/drawable/Drawable;

    .line 996
    move-object/from16 v6, p12

    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mLock:Ljava/lang/Object;

    .line 997
    move-object/from16 v6, p13

    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mCallback:Landroid/widget/Magnifier$Callback;

    .line 999
    iput v0, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mContentWidth:I

    .line 1000
    iput v2, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mContentHeight:I

    .line 1001
    move/from16 v6, p6

    iput v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mZoom:F

    .line 1002
    move/from16 v6, p7

    iput v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mRamp:I
    ...
    iput v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mOffsetX:I

    .line 1004
    iput v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mOffsetY:I
    ...
    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mSurfaceSession:Landroid/view/SurfaceSession;

    .line 1009
    new-instance v7, Landroid/view/SurfaceControl$Builder;

    invoke-direct {v7, v6}, Landroid/view/SurfaceControl$Builder;-><init>(Landroid/view/SurfaceSession;)V

    .line 1010
    const-string v8, "magnifier surface"
    ...
    invoke-virtual {v7, v8}, Landroid/view/SurfaceControl$Builder;->setFlags(I)Landroid/view/SurfaceControl$Builder;
    ...
    .line 1014
    const-string v8, "InternalPopupWindow"
    ...
    iput-object v7, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mSurfaceControl:Landroid/view/SurfaceControl;

    .line 1016
    new-instance v9, Landroid/view/SurfaceControl$Builder;

    invoke-direct {v9, v6}, Landroid/view/SurfaceControl$Builder;-><init>(Landroid/view/SurfaceSession;)V

    .line 1017
    const-string v6, "magnifier surface bbq wrapper"
    ...
    invoke-virtual {v6, v14}, Landroid/view/SurfaceControl$Builder;->setHidden(Z)Landroid/view/SurfaceControl$Builder;
    ...
    iput-object v10, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mBbqSurfaceControl:Landroid/view/SurfaceControl;

    .line 1024
    new-instance v6, Landroid/graphics/BLASTBufferQueue;

    const-string v9, "magnifier surface"

    const/4 v13, -0x3

    move-object v8, v6

    invoke-direct/range {v8 .. v13}, Landroid/graphics/BLASTBufferQueue;-><init>(Ljava/lang/String;Landroid/view/SurfaceControl;III)V

    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mBBQ:Landroid/graphics/BLASTBufferQueue;
    ...
    iput-object v6, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mSurface:Landroid/view/Surface;
    ...
    invoke-direct {v7, v9, v8, v6}, Landroid/view/ThreadedRenderer$SimpleRenderer;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/view/Surface;)V

    iput-object v7, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mRenderer:Landroid/view/ThreadedRenderer$SimpleRenderer;

    .line 1036
    const-string v6, "magnifier content"

    invoke-direct {p0, v6, v3, v4}, Landroid/widget/Magnifier$InternalPopupWindow;->createRenderNodeForBitmap(Ljava/lang/String;FF)Landroid/graphics/RenderNode;

    move-result-object v3

    iput-object v3, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mBitmapRenderNode:Landroid/graphics/RenderNode;

    .line 1041
    const-string v6, "magnifier overlay"

    invoke-direct {p0, v6, v4}, Landroid/widget/Magnifier$InternalPopupWindow;->createRenderNodeForOverlay(Ljava/lang/String;F)Landroid/graphics/RenderNode;

    move-result-object v4

    iput-object v4, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mOverlayRenderNode:Landroid/graphics/RenderNode;
    ...
    invoke-virtual {v6, v0, v2}, Landroid/graphics/RenderNode;->beginRecording(II)Landroid/graphics/RecordingCanvas;
    ...
    .line 1050
    invoke-virtual {v2, v3}, Landroid/graphics/RecordingCanvas;->drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 1058
    iget v2, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mContentHeight:I
    ...
    iput-object v0, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mHandler:Landroid/os/Handler;

    .line 1065
    new-instance v0, Landroid/widget/Magnifier$InternalPopupWindow$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0}, Landroid/widget/Magnifier$InternalPopupWindow$$ExternalSyntheticLambda1;-><init>(Landroid/widget/Magnifier$InternalPopupWindow;)V

    iput-object v0, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mMagnifierUpdater:Ljava/lang/Runnable;

    .line 1066
    iput-boolean v14, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mFrameDrawScheduled:Z

    .line 1067
    iput-boolean v5, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mIsFishEyeStyle:Z
    ...
    iget-object v1, v1, Landroid/widget/Magnifier$InternalPopupWindow;->mRenderer:Landroid/view/ThreadedRenderer$SimpleRenderer;
...
.method private blacklist createRenderNodeForBitmap(Ljava/lang/String;FF)Landroid/graphics/RenderNode;
    ...
    invoke-virtual {p2, p3}, Landroid/graphics/Outline;->setAlpha(F)V

    .line 1163
    invoke-virtual {p1, p2}, Landroid/graphics/RenderNode;->setOutline(Landroid/graphics/Outline;)Z
...
.method private blacklist createRenderNodeForOverlay(Ljava/lang/String;F)Landroid/graphics/RenderNode;
    ...
    .line 1189
    invoke-virtual {p1, v0}, Landroid/graphics/RenderNode;->setOutline(Landroid/graphics/Outline;)Z
...
.method private greylist-max-o doDraw()V
    ...
    .line 1310
    iget-object v2, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mBitmap:Landroid/graphics/Bitmap;
    ...
    .line 1313
    iget-boolean v4, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mIsFishEyeStyle:Z
    ...
    .line 1314
    iget v4, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mContentWidth:I
    ...
    invoke-direct {v5, v4, v6, v1, v2}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v9, v10, v6, v11, v12}, Landroid/graphics/Rect;-><init>(IIII)V

    .line 1321
    iget-object v10, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mBitmap:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v10, v5, v9, v3}, Landroid/graphics/RecordingCanvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V

    .line 1324
    iget-object v5, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mBitmap:Landroid/graphics/Bitmap;

    .line 1325
    invoke-static {v5, v6, v6, v4, v2}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
    ...
    .line 1328
    invoke-static {v5, v1, v6, v4, v2}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
    ...
    iget v2, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mContentWidth:I

    iget v5, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mContentHeight:I
    ...
    invoke-virtual {v0, v2, v4, v1, v3}, Landroid/graphics/RecordingCanvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    :try_end_1
    ...
    .line 1341
    iput-boolean v6, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mFirstDraw:Z

    .line 1342
    nop

    .line 1343
    iput-boolean v6, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mPendingWindowPositionUpdate:Z

    .line 1344
    iget v9, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mWindowPositionX:I

    .line 1345
    iget v10, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mWindowPositionY:I

    .line 1347
    new-instance v11, Landroid/widget/Magnifier$InternalPopupWindow$$ExternalSyntheticLambda0;
    ...
    .line 1362
    iget-boolean v0, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mIsFishEyeStyle:Z

    if-nez v0, :cond_4

    .line 1364
    iget-object v0, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mRenderer:Landroid/view/ThreadedRenderer$SimpleRenderer;

    iget-object v1, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mDisplay:Landroid/view/Display;

    invoke-virtual {v0, v1, v9, v10}, Landroid/view/ThreadedRenderer$SimpleRenderer;->setLightCenter(Landroid/view/Display;II)V
    ...
    .line 1370
    :goto_2
    iput-boolean v12, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mFrameDrawScheduled:Z
    ...
    .line 1374
    iget-object v0, v7, Landroid/widget/Magnifier$InternalPopupWindow;->mCallback:Landroid/widget/Magnifier$Callback;
...
.method private blacklist updateContentFactors(IF)V
    ...
    invoke-virtual {v0, v1, p1}, Landroid/graphics/RenderNode;->beginRecording(II)Landroid/graphics/RecordingCanvas;
