...
.method constructor blacklist <init>(Landroid/net/lowpan/LowpanInterface;Landroid/os/Handler;Landroid/net/lowpan/LowpanInterface$Callback;)V
    ...
    .line 563
    :cond_0
    invoke-static {p1}, Landroid/net/lowpan/LowpanInterface;->access$000(Landroid/net/lowpan/LowpanInterface;)Landroid/os/Looper;
    ...
    iput-object p1, p0, Landroid/net/lowpan/LowpanInterface$1;->mHandler:Landroid/os/Handler;
...
.method public blacklist onConnectedChanged(Z)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda7;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Z)V
...
.method public blacklist onEnabledChanged(Z)V
    ...
    new-instance v2, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda8;

    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda8;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Z)V
...
.method public blacklist onLinkAddressAdded(Ljava/lang/String;)V
    ...
    .line 621
    iget-object p1, p0, Landroid/net/lowpan/LowpanInterface$1;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Landroid/net/lowpan/LowpanInterface$1;->val$cb:Landroid/net/lowpan/LowpanInterface$Callback;

    new-instance v2, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda2;

    invoke-direct {v2, v1, v0}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda2;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Landroid/net/LinkAddress;)V
...
.method public blacklist onLinkAddressRemoved(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, v0}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda3;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Landroid/net/LinkAddress;)V
...
.method public blacklist onLinkNetworkAdded(Landroid/net/IpPrefix;)V
    ...
    new-instance v2, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda0;

    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda0;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Landroid/net/IpPrefix;)V
...
.method public blacklist onLinkNetworkRemoved(Landroid/net/IpPrefix;)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda1;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Landroid/net/IpPrefix;)V
...
.method public blacklist onLowpanIdentityChanged(Landroid/net/lowpan/LowpanIdentity;)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda4;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Landroid/net/lowpan/LowpanIdentity;)V
...
.method public blacklist onRoleChanged(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda5;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Ljava/lang/String;)V
...
.method public blacklist onStateChanged(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/net/lowpan/LowpanInterface$1$$ExternalSyntheticLambda6;-><init>(Landroid/net/lowpan/LowpanInterface$Callback;Ljava/lang/String;)V
