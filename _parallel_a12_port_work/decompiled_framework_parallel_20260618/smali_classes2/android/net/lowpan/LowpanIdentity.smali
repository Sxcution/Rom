...
.method static synthetic blacklist access$000(Landroid/net/lowpan/LowpanIdentity;)Ljava/lang/String;
    .locals 0
...
.method static synthetic blacklist access$002(Landroid/net/lowpan/LowpanIdentity;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic blacklist access$102(Landroid/net/lowpan/LowpanIdentity;[B)[B
    .locals 0
...
.method static synthetic blacklist access$200(Landroid/net/lowpan/LowpanIdentity;)Z
    .locals 0
...
.method static synthetic blacklist access$202(Landroid/net/lowpan/LowpanIdentity;Z)Z
    .locals 0
...
.method static synthetic blacklist access$402(Landroid/net/lowpan/LowpanIdentity;[B)[B
    .locals 0
...
.method static synthetic blacklist access$502(Landroid/net/lowpan/LowpanIdentity;I)I
    .locals 0
...
.method static synthetic blacklist access$602(Landroid/net/lowpan/LowpanIdentity;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic blacklist access$702(Landroid/net/lowpan/LowpanIdentity;I)I
    .locals 0
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 205
    :cond_0
    check-cast p1, Landroid/net/lowpan/LowpanIdentity;

    .line 206
    iget-object v0, p0, Landroid/net/lowpan/LowpanIdentity;->mRawName:[B

    iget-object v2, p1, Landroid/net/lowpan/LowpanIdentity;->mRawName:[B
    ...
    iget-object v2, p1, Landroid/net/lowpan/LowpanIdentity;->mXpanid:[B
    ...
    iget-object v2, p1, Landroid/net/lowpan/LowpanIdentity;->mType:Ljava/lang/String;
    ...
    iget v2, p1, Landroid/net/lowpan/LowpanIdentity;->mPanid:I

    if-ne v0, v2, :cond_1

    iget v0, p0, Landroid/net/lowpan/LowpanIdentity;->mChannel:I

    iget p1, p1, Landroid/net/lowpan/LowpanIdentity;->mChannel:I
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 228
    iget-object p2, p0, Landroid/net/lowpan/LowpanIdentity;->mRawName:[B

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeByteArray([B)V

    .line 229
    iget-object p2, p0, Landroid/net/lowpan/LowpanIdentity;->mType:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 230
    iget-object p2, p0, Landroid/net/lowpan/LowpanIdentity;->mXpanid:[B

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeByteArray([B)V

    .line 231
    iget p2, p0, Landroid/net/lowpan/LowpanIdentity;->mPanid:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 232
    iget p2, p0, Landroid/net/lowpan/LowpanIdentity;->mChannel:I
