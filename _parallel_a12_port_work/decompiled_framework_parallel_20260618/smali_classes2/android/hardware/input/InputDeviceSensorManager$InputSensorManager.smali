...
.method public whitelist getDefaultSensor(I)Landroid/hardware/Sensor;
    ...
    invoke-static {v0, v1, p1}, Landroid/hardware/input/InputDeviceSensorManager;->access$500(Landroid/hardware/input/InputDeviceSensorManager;II)Landroid/hardware/Sensor;
...
.method protected blacklist getFullSensorList()Ljava/util/List;
    ...
    invoke-static {v0, v1}, Landroid/hardware/input/InputDeviceSensorManager;->access$600(Landroid/hardware/input/InputDeviceSensorManager;I)Ljava/util/List;
...
.method protected blacklist registerListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;II)Z
    ...
    invoke-static/range {v0 .. v5}, Landroid/hardware/input/InputDeviceSensorManager;->access$700(Landroid/hardware/input/InputDeviceSensorManager;Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;IILandroid/os/Handler;)Z
...
.method protected blacklist unregisterListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;)V
    ...
    invoke-static {v0, p1, p2}, Landroid/hardware/input/InputDeviceSensorManager;->access$800(Landroid/hardware/input/InputDeviceSensorManager;Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;)V
