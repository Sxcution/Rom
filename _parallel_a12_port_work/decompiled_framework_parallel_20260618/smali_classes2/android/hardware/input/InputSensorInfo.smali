...
.method public constructor blacklist <init>(Ljava/lang/String;Ljava/lang/String;IIIFFFIIILjava/lang/String;Ljava/lang/String;III)V
    ...
    invoke-static {v5, v6, p1}, Lcom/android/internal/util/AnnotationValidations;->validate(Ljava/lang/Class;Landroid/annotation/NonNull;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v6, p2}, Lcom/android/internal/util/AnnotationValidations;->validate(Ljava/lang/Class;Landroid/annotation/NonNull;Ljava/lang/Object;)V

    .line 96
    move v1, p3

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mVersion:I

    .line 97
    move v1, p4

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mHandle:I

    .line 98
    move v1, p5

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mType:I

    .line 99
    move v1, p6

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mMaxRange:F

    .line 100
    move v1, p7

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mResolution:F

    .line 101
    move v1, p8

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mPower:F

    .line 102
    move/from16 v1, p9

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mMinDelay:I

    .line 103
    move/from16 v1, p10

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mFifoReservedEventCount:I

    .line 104
    move/from16 v1, p11

    iput v1, v0, Landroid/hardware/input/InputSensorInfo;->mFifoMaxEventCount:I
    ...
    invoke-static {v1, v6, v3}, Lcom/android/internal/util/AnnotationValidations;->validate(Ljava/lang/Class;Landroid/annotation/NonNull;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v6, v4}, Lcom/android/internal/util/AnnotationValidations;->validate(Ljava/lang/Class;Landroid/annotation/NonNull;Ljava/lang/Object;)V
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 245
    iget p2, p0, Landroid/hardware/input/InputSensorInfo;->mId:I
