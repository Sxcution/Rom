...
.method public whitelist onTransact(ILandroid/os/HwParcel;Landroid/os/HwParcel;I)V
    ...
    .line 667
    const-string p4, "android.hardware.vibrator@1.0::IVibrator"
    ...
    .line 782
    invoke-virtual {p0, p1, p2}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->debug(Landroid/os/NativeHandle;Ljava/util/ArrayList;)V
    ...
    .line 754
    new-instance p4, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$3;

    invoke-direct {p4, p0, p3}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$3;-><init>(Landroid/hardware/vibrator/V1_2/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, p1, p2, p4}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->perform_1_2(IBLandroid/hardware/vibrator/V1_2/IVibrator$perform_1_2Callback;)V
    ...
    .line 737
    new-instance p4, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$2;

    invoke-direct {p4, p0, p3}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$2;-><init>(Landroid/hardware/vibrator/V1_2/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, p1, p2, p4}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->perform_1_1(IBLandroid/hardware/vibrator/V1_1/IVibrator$perform_1_1Callback;)V
    ...
    .line 720
    new-instance p4, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$1;

    invoke-direct {p4, p0, p3}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub$1;-><init>(Landroid/hardware/vibrator/V1_2/IVibrator$Stub;Landroid/os/HwParcel;)V

    invoke-virtual {p0, p1, p2, p4}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->perform(IBLandroid/hardware/vibrator/V1_0/IVibrator$performCallback;)V
    ...
    .line 707
    invoke-virtual {p0, p1}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->setAmplitude(B)I
    ...
    .line 673
    invoke-virtual {p0, p1}, Landroid/hardware/vibrator/V1_2/IVibrator$Stub;->on(I)I
