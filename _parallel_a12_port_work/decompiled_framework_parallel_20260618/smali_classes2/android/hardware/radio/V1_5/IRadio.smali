...
.method public static blacklist asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/V1_5/IRadio;
    ...
    .line 29
    check-cast v2, Landroid/hardware/radio/V1_5/IRadio;

    return-object v2

    .line 32
    :cond_1
    new-instance v2, Landroid/hardware/radio/V1_5/IRadio$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/radio/V1_5/IRadio$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 35
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/radio/V1_5/IRadio;->interfaceChain()Ljava/util/ArrayList;
...
.method public static blacklist castFrom(Landroid/os/IHwInterface;)Landroid/hardware/radio/V1_5/IRadio;
    ...
    invoke-static {p0}, Landroid/hardware/radio/V1_5/IRadio;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/V1_5/IRadio;
