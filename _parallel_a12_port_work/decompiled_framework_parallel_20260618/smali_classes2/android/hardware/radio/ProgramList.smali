...
.method private greylist-max-o putLocked(Landroid/hardware/radio/RadioManager$ProgramInfo;)V
    ...
    .line 200
    iget-object v0, p0, Landroid/hardware/radio/ProgramList;->mListCallbacks:Ljava/util/List;

    new-instance v1, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda5;

    invoke-direct {v1, p1}, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda5;-><init>(Landroid/hardware/radio/ProgramSelector$Identifier;)V
...
.method private greylist-max-o removeLocked(Landroid/hardware/radio/ProgramSelector$Identifier;)V
    ...
    new-instance v1, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda6;

    invoke-direct {v1, p1}, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda6;-><init>(Landroid/hardware/radio/ProgramSelector$Identifier;)V
...
.method public whitelist addOnCompleteListener(Ljava/util/concurrent/Executor;Landroid/hardware/radio/ProgramList$OnCompleteListener;)V
    ...
    invoke-direct {v0, p1, p2}, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda0;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/radio/ProgramList$OnCompleteListener;)V
...
.method greylist-max-o apply(Landroid/hardware/radio/ProgramList$Chunk;)V
    ...
    new-instance v2, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda2;

    invoke-direct {v2, p0}, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda2;-><init>(Landroid/hardware/radio/ProgramList;)V
    ...
    new-instance v2, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda3;

    invoke-direct {v2, p0}, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda3;-><init>(Landroid/hardware/radio/ProgramList;)V
    ...
    iput-boolean p1, p0, Landroid/hardware/radio/ProgramList;->mIsComplete:Z

    .line 191
    iget-object p1, p0, Landroid/hardware/radio/ProgramList;->mOnCompleteListeners:Ljava/util/List;

    sget-object v1, Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda7;->INSTANCE:Landroid/hardware/radio/ProgramList$$ExternalSyntheticLambda7;
...
.method public synthetic blacklist lambda$apply$1$ProgramList(Landroid/hardware/radio/ProgramSelector$Identifier;)V
    .locals 0
...
.method public synthetic blacklist lambda$apply$2$ProgramList(Landroid/hardware/radio/ProgramSelector$Identifier;)V
    .locals 0
...
.method public synthetic blacklist lambda$apply$3$ProgramList(Landroid/hardware/radio/RadioManager$ProgramInfo;)V
    .locals 0
...
.method greylist-max-o setOnCloseListener(Landroid/hardware/radio/ProgramList$OnCloseListener;)V
    ...
    const-string v1, "Close callback is already set"
