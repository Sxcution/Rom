...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 39
    :cond_7
    iget-object v2, p0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->bearerData:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v5, v0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->teleserviceId:I
    ...
    invoke-virtual {p2, v5, v6}, Landroid/os/HwBlob;->getBool(J)Z

    move-result v5

    iput-boolean v5, v0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->isServicePresent:Z
    ...
    invoke-virtual {p2, v7, v8}, Landroid/os/HwBlob;->getInt32(J)I

    move-result v7

    iput v7, v0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->serviceCategory:I

    .line 107
    iget-object v7, v0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->address:Landroid/hardware/radio/V1_0/CdmaSmsAddress;

    const-wide/16 v8, 0x10

    add-long v8, p3, v8

    invoke-virtual {v7, p1, p2, v8, v9}, Landroid/hardware/radio/V1_0/CdmaSmsAddress;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 108
    iget-object v7, v0, Landroid/hardware/radio/V1_0/CdmaSmsMessage;->subAddress:Landroid/hardware/radio/V1_0/CdmaSmsSubaddress;

    const-wide/16 v8, 0x30

    add-long v8, p3, v8

    invoke-virtual {v7, p1, p2, v8, v9}, Landroid/hardware/radio/V1_0/CdmaSmsSubaddress;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
