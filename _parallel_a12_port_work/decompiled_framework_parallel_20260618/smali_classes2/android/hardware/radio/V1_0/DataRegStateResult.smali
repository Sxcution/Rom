...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 86
    new-instance v4, Landroid/hardware/radio/V1_0/DataRegStateResult;

    invoke-direct {v4}, Landroid/hardware/radio/V1_0/DataRegStateResult;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/radio/V1_0/DataRegStateResult;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/radio/V1_0/DataRegStateResult;

    mul-int/lit8 v5, v4, 0x68

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/radio/V1_0/DataRegStateResult;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 22
    :cond_2
    check-cast p1, Landroid/hardware/radio/V1_0/DataRegStateResult;

    .line 23
    iget v2, p0, Landroid/hardware/radio/V1_0/DataRegStateResult;->regState:I

    iget v3, p1, Landroid/hardware/radio/V1_0/DataRegStateResult;->regState:I
    ...
    iget v3, p1, Landroid/hardware/radio/V1_0/DataRegStateResult;->rat:I
    ...
    iget v3, p1, Landroid/hardware/radio/V1_0/DataRegStateResult;->reasonDataDenied:I
    ...
    iget v3, p1, Landroid/hardware/radio/V1_0/DataRegStateResult;->maxDataCalls:I
    ...
    .line 35
    :cond_6
    iget-object v2, p0, Landroid/hardware/radio/V1_0/DataRegStateResult;->cellIdentity:Landroid/hardware/radio/V1_0/CellIdentity;

    iget-object p1, p1, Landroid/hardware/radio/V1_0/DataRegStateResult;->cellIdentity:Landroid/hardware/radio/V1_0/CellIdentity;
