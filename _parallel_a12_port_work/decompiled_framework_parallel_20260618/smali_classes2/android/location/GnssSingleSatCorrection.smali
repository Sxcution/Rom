...
.method private constructor blacklist <init>(Landroid/location/GnssSingleSatCorrection$Builder;)V
    ...
    iput-object p1, p0, Landroid/location/GnssSingleSatCorrection;->mReflectingPlane:Landroid/location/GnssReflectingPlane;
...
.method public whitelist test-api toString()Ljava/lang/String;
    ...
    const-string v3, "SingleSatCorrectionFlags = "

    const/4 v4, 0x0

    aput-object v3, v2, v4

    iget v3, p0, Landroid/location/GnssSingleSatCorrection;->mSingleSatCorrectionFlags:I
    ...
    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mConstellationType:I
    ...
    const-string v6, "SatId = "

    aput-object v6, v2, v4

    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mSatId:I
    ...
    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mCarrierFrequencyHz:F
    ...
    const-string v6, "ProbSatIsLos = "

    aput-object v6, v2, v4

    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mProbSatIsLos:F
    ...
    const-string v6, "ExcessPathLengthMeters = "

    aput-object v6, v2, v4

    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mExcessPathLengthMeters:F
    ...
    const-string v6, "ExcessPathLengthUncertaintyMeters = "

    aput-object v6, v2, v4

    iget v6, p0, Landroid/location/GnssSingleSatCorrection;->mExcessPathLengthUncertaintyMeters:F
    ...
    iget-object v2, p0, Landroid/location/GnssSingleSatCorrection;->mReflectingPlane:Landroid/location/GnssReflectingPlane;
