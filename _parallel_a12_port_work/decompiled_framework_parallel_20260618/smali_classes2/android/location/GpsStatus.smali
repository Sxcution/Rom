...
.method greylist-max-o setStatus(Landroid/location/GnssStatus;I)V
    ...
    .line 199
    :cond_5
    iget-object p2, p0, Landroid/location/GpsStatus;->mSatellites:Landroid/util/SparseArray;
    ...
    .line 201
    new-instance p2, Landroid/location/GpsSatellite;

    invoke-direct {p2, v1}, Landroid/location/GpsSatellite;-><init>(I)V
    ...
    .line 205
    :cond_6
    iput-boolean v3, p2, Landroid/location/GpsSatellite;->mValid:Z
    ...
    iput v1, p2, Landroid/location/GpsSatellite;->mSnr:F
    ...
    iput v1, p2, Landroid/location/GpsSatellite;->mElevation:F
    ...
    iput v1, p2, Landroid/location/GpsSatellite;->mAzimuth:F
    ...
    iput-boolean v1, p2, Landroid/location/GpsSatellite;->mHasEphemeris:Z
    ...
    iput-boolean v1, p2, Landroid/location/GpsSatellite;->mHasAlmanac:Z
    ...
    iput-boolean v1, p2, Landroid/location/GpsSatellite;->mUsedInFix:Z
