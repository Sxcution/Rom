...
.method private greylist-max-o initializeFromParcelLocked(Landroid/os/Parcel;ZZ)V
    ...
    .line 288
    :try_start_0
    iget-object p3, p0, Landroid/os/BaseBundle;->mClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {p1, v3, v0, p3}, Landroid/os/Parcel;->readArrayMapSafelyInternal(Landroid/util/ArrayMap;ILjava/lang/ClassLoader;)V
    ...
    invoke-virtual {p1, v3, v0, p3}, Landroid/os/Parcel;->readArrayMapInternal(Landroid/util/ArrayMap;ILjava/lang/ClassLoader;)V
    :try_end_0
    ...
    .line 295
    :try_start_1
    sget-boolean v0, Landroid/os/BaseBundle;->sShouldDefuse:Z
...
.method private greylist-max-o readFromParcelInner(Landroid/os/Parcel;I)V
    ...
    const-string v0, "Bad magic number for Bundle: 0x"
    ...
    const-string v1, "Bundle length is not aligned by 4: "
    ...
    const-string v1, "Bad length in parcel: "
...
.method greylist-max-o copyInternal(Landroid/os/BaseBundle;Z)V
    ...
    invoke-virtual {p0, v4}, Landroid/os/BaseBundle;->deepCopyValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 463
    :goto_2
    iget-object p2, p1, Landroid/os/BaseBundle;->mClassLoader:Ljava/lang/ClassLoader;

    iput-object p2, p0, Landroid/os/BaseBundle;->mClassLoader:Ljava/lang/ClassLoader;
...
.method public greylist-max-o getPairValue()Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v0, v4, v2}, Landroid/os/BaseBundle;->typeWarning(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/ClassCastException;)V
...
.method public greylist-max-o kindofEquals(Landroid/os/BaseBundle;)Z
    ...
    invoke-virtual {v1, p1}, Landroid/os/Parcel;->compareData(Landroid/os/Parcel;)I
...
.method greylist-max-o typeWarning(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/ClassCastException;)V
    ...
    invoke-static {p2, p1, p5}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
