...
.field private final blacklist mZygoteRuntimeFlags:I
...
# direct methods
.method public constructor blacklist <init>(Landroid/content/pm/ApplicationInfo;IIII)V
    .locals 1
    ...
    .line 67
    iput p5, p0, Landroid/os/AppZygote;->mZygoteRuntimeFlags:I
...
.method private blacklist connectToZygoteIfNeededLocked()V
    ...
    iget v8, p0, Landroid/os/AppZygote;->mZygoteRuntimeFlags:I
    ...
    .line 129
    const-string v1, "Application preload done."
