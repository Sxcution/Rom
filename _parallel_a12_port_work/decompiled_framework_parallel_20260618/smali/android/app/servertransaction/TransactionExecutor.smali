...
.method private greylist-max-o executeLifecycleState(Landroid/app/servertransaction/ClientTransaction;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/app/servertransaction/ActivityLifecycleItem;->execute(Landroid/app/ClientTransactionHandler;Landroid/os/IBinder;Landroid/app/servertransaction/PendingTransactionActions;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/app/servertransaction/ActivityLifecycleItem;->postExecute(Landroid/app/ClientTransactionHandler;Landroid/os/IBinder;Landroid/app/servertransaction/PendingTransactionActions;)V
...
.method private blacklist performLifecycleSequence(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/util/IntArray;Landroid/app/servertransaction/ClientTransaction;)V
    ...
    .line 209
    invoke-virtual {p2, v12}, Landroid/util/IntArray;->get(I)I
    ...
    invoke-virtual {v1, p1, v11}, Landroid/app/ClientTransactionHandler;->performRestartActivity(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    const-string v6, "performLifecycleSequence. cycling to:"
    ...
    iget-boolean v2, v8, Landroid/app/ActivityThread$ActivityClientRecord;->isForward:Z

    const-string v3, "LIFECYCLER_RESUME_ACTIVITY"

    invoke-virtual {v1, p1, v11, v2, v3}, Landroid/app/ClientTransactionHandler;->handleResumeActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZLjava/lang/String;)V
...
.method public greylist-max-o execute(Landroid/app/servertransaction/ClientTransaction;)V
    ...
    const-string v1, "Skip pre-destroyed transaction:\n"
    ...
    .line 87
    invoke-static {p1, v1}, Landroid/app/servertransaction/TransactionExecutorHelper;->transactionToString(Landroid/app/servertransaction/ClientTransaction;Landroid/app/ClientTransactionHandler;)Ljava/lang/String;
    ...
    .line 98
    iget-object p1, p0, Landroid/app/servertransaction/TransactionExecutor;->mPendingActions:Landroid/app/servertransaction/PendingTransactionActions;

    invoke-virtual {p1}, Landroid/app/servertransaction/PendingTransactionActions;->clear()V
...
.method public greylist-max-o executeCallbacks(Landroid/app/servertransaction/ClientTransaction;)V
    ...
    .line 146
    :goto_2
    invoke-direct {p0, v2, v10, v9, p1}, Landroid/app/servertransaction/TransactionExecutor;->cycleToPath(Landroid/app/ActivityThread$ActivityClientRecord;IZLandroid/app/servertransaction/ClientTransaction;)V
