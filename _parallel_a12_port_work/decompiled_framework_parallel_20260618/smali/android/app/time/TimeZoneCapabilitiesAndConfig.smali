...
.method public constructor blacklist <init>(Landroid/app/time/TimeZoneCapabilities;Landroid/app/time/TimeZoneConfiguration;)V
    ...
    iput-object p1, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mCapabilities:Landroid/app/time/TimeZoneCapabilities;

    .line 59
    invoke-static {p2}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    check-cast p2, Landroid/app/time/TimeZoneConfiguration;

    iput-object p2, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;

    .line 60
    return-void
.end method

.method static synthetic blacklist access$000(Landroid/os/Parcel;)Landroid/app/time/TimeZoneCapabilitiesAndConfig;
    .locals 0
...
.method private static blacklist createFromParcel(Landroid/os/Parcel;)Landroid/app/time/TimeZoneCapabilitiesAndConfig;
    ...
    check-cast v1, Landroid/app/time/TimeZoneCapabilities;
    ...
    check-cast p0, Landroid/app/time/TimeZoneConfiguration;
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 104
    :cond_1
    check-cast p1, Landroid/app/time/TimeZoneCapabilitiesAndConfig;

    .line 105
    iget-object v2, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mCapabilities:Landroid/app/time/TimeZoneCapabilities;

    iget-object v3, p1, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mCapabilities:Landroid/app/time/TimeZoneCapabilities;

    invoke-virtual {v2, v3}, Landroid/app/time/TimeZoneCapabilities;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;

    iget-object p1, p1, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;

    .line 106
    invoke-virtual {v2, p1}, Landroid/app/time/TimeZoneConfiguration;->equals(Ljava/lang/Object;)Z
