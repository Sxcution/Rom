...
.method private constructor blacklist <init>(Landroid/app/time/TimeCapabilities$Builder;)V
    ...
    .line 61
    invoke-static {p1}, Landroid/app/time/TimeCapabilities$Builder;->access$100(Landroid/app/time/TimeCapabilities$Builder;)Landroid/os/UserHandle;
    ...
    .line 63
    invoke-static {p1}, Landroid/app/time/TimeCapabilities$Builder;->access$200(Landroid/app/time/TimeCapabilities$Builder;)I
    ...
    .line 65
    invoke-static {p1}, Landroid/app/time/TimeCapabilities$Builder;->access$300(Landroid/app/time/TimeCapabilities$Builder;)I

    move-result p1

    iput p1, p0, Landroid/app/time/TimeCapabilities;->mSuggestTimeManuallyCapability:I

    .line 66
    return-void
.end method

.method synthetic constructor blacklist <init>(Landroid/app/time/TimeCapabilities$Builder;Landroid/app/time/TimeCapabilities$1;)V
    .locals 0
...
.method static synthetic blacklist access$000(Landroid/os/Parcel;)Landroid/app/time/TimeCapabilities;
    .locals 0
...
.method static synthetic blacklist access$400(Landroid/app/time/TimeCapabilities;)Landroid/os/UserHandle;
    .locals 0
...
.method static synthetic blacklist access$500(Landroid/app/time/TimeCapabilities;)I
    .locals 0
...
.method static synthetic blacklist access$600(Landroid/app/time/TimeCapabilities;)I
    .locals 0
...
.method private static blacklist createFromParcel(Landroid/os/Parcel;)Landroid/app/time/TimeCapabilities;
    ...
    invoke-virtual {v1, v0}, Landroid/app/time/TimeCapabilities$Builder;->setConfigureAutoTimeDetectionEnabledCapability(I)Landroid/app/time/TimeCapabilities$Builder;
    ...
    invoke-virtual {v0, p0}, Landroid/app/time/TimeCapabilities$Builder;->setSuggestTimeManuallyCapability(I)Landroid/app/time/TimeCapabilities$Builder;
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 112
    iget v2, p0, Landroid/app/time/TimeCapabilities;->mConfigureAutoTimeDetectionEnabledCapability:I

    iget v3, p1, Landroid/app/time/TimeCapabilities;->mConfigureAutoTimeDetectionEnabledCapability:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/app/time/TimeCapabilities;->mSuggestTimeManuallyCapability:I

    iget v3, p1, Landroid/app/time/TimeCapabilities;->mSuggestTimeManuallyCapability:I

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Landroid/app/time/TimeCapabilities;->mUserHandle:Landroid/os/UserHandle;
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 80
    iget p2, p0, Landroid/app/time/TimeCapabilities;->mConfigureAutoTimeDetectionEnabledCapability:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 81
    iget p2, p0, Landroid/app/time/TimeCapabilities;->mSuggestTimeManuallyCapability:I
