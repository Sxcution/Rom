...
# static fields
.field public static blacklist sDefaultImpl:Landroid/app/trust/ITrustManager;
...
.method public blacklist clearAllBiometricRecognized(Landroid/hardware/biometrics/BiometricSourceType;)V
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->clearAllBiometricRecognized(Landroid/hardware/biometrics/BiometricSourceType;)V
    :try_end_0
...
.method public greylist-max-o isDeviceLocked(I)Z
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->isDeviceLocked(I)Z
...
.method public greylist-max-o isDeviceSecure(I)Z
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->isDeviceSecure(I)Z
...
.method public greylist-max-o isTrustUsuallyManaged(I)Z
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->isTrustUsuallyManaged(I)Z
...
.method public greylist-max-o registerTrustListener(Landroid/app/trust/ITrustListener;)V
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->registerTrustListener(Landroid/app/trust/ITrustListener;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o reportEnabledTrustAgentsChanged(I)V
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->reportEnabledTrustAgentsChanged(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o reportKeyguardShowingChanged()V
    ...
    invoke-interface {v2}, Landroid/app/trust/ITrustManager;->reportKeyguardShowingChanged()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o reportUnlockAttempt(ZI)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/trust/ITrustManager;->reportUnlockAttempt(ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o reportUnlockLockout(II)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/trust/ITrustManager;->reportUnlockLockout(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o setDeviceLockedForUser(IZ)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/trust/ITrustManager;->setDeviceLockedForUser(IZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist unlockedByBiometricForUser(ILandroid/hardware/biometrics/BiometricSourceType;)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/trust/ITrustManager;->unlockedByBiometricForUser(ILandroid/hardware/biometrics/BiometricSourceType;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o unregisterTrustListener(Landroid/app/trust/ITrustListener;)V
    ...
    invoke-interface {v2, p1}, Landroid/app/trust/ITrustManager;->unregisterTrustListener(Landroid/app/trust/ITrustListener;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
