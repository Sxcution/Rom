...
.method static synthetic blacklist access$200(Landroid/app/FragmentManagerImpl;)V
    .locals 0
...
.method static synthetic blacklist access$300(Landroid/app/FragmentManagerImpl;Landroid/app/BackStackRecord;ZZZ)V
    .locals 0
...
.method private greylist-max-o completeExecute(Landroid/app/BackStackRecord;ZZZ)V
    ...
    invoke-virtual {p0, p2, v6}, Landroid/app/FragmentManagerImpl;->moveToState(IZ)V
    ...
    iget-boolean v1, v0, Landroid/app/Fragment;->mIsNewlyAdded:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/app/Fragment;->mContainerId:I
    ...
    .line 2348
    iput-boolean p3, v0, Landroid/app/Fragment;->mIsNewlyAdded:Z
...
.method private greylist-max-o executeOpsTogether(Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    ...
    iput-object v0, v6, Landroid/app/FragmentManagerImpl;->mTmpAddedFragments:Ljava/util/ArrayList;
    ...
    iget-object v1, v6, Landroid/app/FragmentManagerImpl;->mAdded:Ljava/util/ArrayList;
    ...
    .line 2193
    iget-object v4, v6, Landroid/app/FragmentManagerImpl;->mTmpAddedFragments:Ljava/util/ArrayList;

    invoke-virtual {v3, v4, v0}, Landroid/app/BackStackRecord;->expandOps(Ljava/util/ArrayList;Landroid/app/Fragment;)Landroid/app/Fragment;
    ...
    invoke-virtual {v3, v4}, Landroid/app/BackStackRecord;->trackAddedFragmentsInPop(Ljava/util/ArrayList;)V

    .line 2197
    :goto_2
    if-nez v12, :cond_3

    iget-boolean v3, v3, Landroid/app/BackStackRecord;->mAddToBackStack:Z
    ...
    .line 2210
    invoke-direct {p0, v14}, Landroid/app/FragmentManagerImpl;->addAddedFragments(Landroid/util/ArraySet;)V
    ...
    .line 2213
    invoke-direct {p0, v14}, Landroid/app/FragmentManagerImpl;->makeRemovedFragmentsInvisible(Landroid/util/ArraySet;)V
    ...
    invoke-virtual {p0, v0, v13}, Landroid/app/FragmentManagerImpl;->moveToState(IZ)V
    ...
    iget v1, v0, Landroid/app/BackStackRecord;->mIndex:I
    ...
    invoke-virtual {p0, v1}, Landroid/app/FragmentManagerImpl;->freeBackStackIndex(I)V

    .line 2228
    const/4 v1, -0x1

    iput v1, v0, Landroid/app/BackStackRecord;->mIndex:I

    .line 2230
    :cond_8
    invoke-virtual {v0}, Landroid/app/BackStackRecord;->runOnCommitRunnables()V
...
.method private greylist-max-o popBackStackImmediate(Ljava/lang/String;II)Z
    ...
    iget-object p3, p0, Landroid/app/FragmentManagerImpl;->mTmpIsPop:Ljava/util/ArrayList;
...
.method private greylist-max-o throwException(Ljava/lang/RuntimeException;)V
    ...
    invoke-virtual {v0, v6, v5, v2, v3}, Landroid/app/FragmentHostCallback;->onDump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_0
...
.method public whitelist dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1100
    iget-object p1, p0, Landroid/app/FragmentManagerImpl;->mNoTransactionsBecause:Ljava/lang/String;
...
.method public whitelist getBackStackEntryAt(I)Landroid/app/FragmentManager$BackStackEntry;
    ...
    check-cast p1, Landroid/app/FragmentManager$BackStackEntry;
...
.method greylist-max-o moveToState(Landroid/app/Fragment;IIIZ)V
    ...
    .line 1280
    iget v0, v8, Landroid/app/Fragment;->mContainerId:I
    ...
    invoke-direct {v7, v0}, Landroid/app/FragmentManagerImpl;->throwException(Ljava/lang/RuntimeException;)V

    .line 1287
    :cond_14
    iget-object v0, v7, Landroid/app/FragmentManagerImpl;->mContainer:Landroid/app/FragmentContainer;

    iget v2, v8, Landroid/app/Fragment;->mContainerId:I

    invoke-virtual {v0, v2}, Landroid/app/FragmentContainer;->onFindViewById(I)Landroid/view/View;
    ...
    :cond_16
    :goto_9
    iput-object v2, v8, Landroid/app/Fragment;->mContainer:Landroid/view/ViewGroup;

    .line 1303
    iget-object v0, v8, Landroid/app/Fragment;->mSavedFragmentState:Landroid/os/Bundle;

    invoke-virtual {v8, v0}, Landroid/app/Fragment;->performGetLayoutInflater(Landroid/os/Bundle;)Landroid/view/LayoutInflater;

    move-result-object v0

    iget-object v3, v8, Landroid/app/Fragment;->mSavedFragmentState:Landroid/os/Bundle;

    invoke-virtual {v8, v0, v2, v3}, Landroid/app/Fragment;->performCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;

    move-result-object v0

    iput-object v0, v8, Landroid/app/Fragment;->mView:Landroid/view/View;
    ...
    .line 1310
    :cond_17
    iget-boolean v0, v8, Landroid/app/Fragment;->mHidden:Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/app/Fragment;->onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v7, v8, v0, v2, v15}, Landroid/app/FragmentManagerImpl;->dispatchOnFragmentViewCreated(Landroid/app/Fragment;Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    iget-object v0, v8, Landroid/app/Fragment;->mContainer:Landroid/view/ViewGroup;
    ...
    .line 1389
    iget v1, v7, Landroid/app/FragmentManagerImpl;->mCurState:I
    ...
    invoke-virtual {v7, v8, v1, v15, v2}, Landroid/app/FragmentManagerImpl;->loadAnimator(Landroid/app/Fragment;IZI)Landroid/animation/Animator;
    ...
    .line 1397
    iget-object v3, v8, Landroid/app/Fragment;->mContainer:Landroid/view/ViewGroup;
    ...
    .line 1401
    invoke-virtual {v8, v10}, Landroid/app/Fragment;->setAnimatingAway(Landroid/animation/Animator;)V

    .line 1402
    invoke-virtual {v8, v0}, Landroid/app/Fragment;->setStateAfterAnimating(I)V

    .line 1403
    new-instance v11, Landroid/app/FragmentManagerImpl$2;
    ...
    invoke-direct {v7, v1, v10}, Landroid/app/FragmentManagerImpl;->setHWLayerAnimListenerIfAlpha(Landroid/view/View;Landroid/animation/Animator;)V
...
.method public whitelist onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 3553
    iget-object v5, v0, Landroid/app/FragmentManagerImpl;->mContainer:Landroid/app/FragmentContainer;
    ...
    .line 3559
    iput-object v0, v5, Landroid/app/Fragment;->mFragmentManager:Landroid/app/FragmentManagerImpl;
    ...
    iget-boolean v1, v6, Landroid/app/Fragment;->mFromLayout:Z
    ...
    .line 3590
    :cond_c
    invoke-virtual {p0, v6}, Landroid/app/FragmentManagerImpl;->moveToState(Landroid/app/Fragment;)V
...
.method greylist-max-o popBackStackState(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/String;II)Z
    ...
    check-cast p3, Landroid/app/BackStackRecord;
...
.method public whitelist putFragment(Landroid/os/Bundle;Ljava/lang/String;Landroid/app/Fragment;)V
    ...
    .line 933
    :cond_0
    iget p3, p3, Landroid/app/Fragment;->mIndex:I
...
.method greylist-max-o saveAllState()Landroid/os/Parcelable;
    ...
    iget-object v8, v11, Landroid/app/Fragment;->mTarget:Landroid/app/Fragment;

    const-string v12, "android:target_state"

    invoke-virtual {p0, v7, v12, v8}, Landroid/app/FragmentManagerImpl;->putFragment(Landroid/os/Bundle;Ljava/lang/String;Landroid/app/Fragment;)V
    ...
    iget v8, v11, Landroid/app/Fragment;->mTargetRequestCode:I
...
.method public whitelist saveFragmentInstanceState(Landroid/app/Fragment;)Landroid/app/Fragment$SavedState;
    ...
    invoke-direct {v1, p1}, Landroid/app/Fragment$SavedState;-><init>(Landroid/os/Bundle;)V
...
.method public whitelist unregisterFragmentLifecycleCallbacks(Landroid/app/FragmentManager$FragmentLifecycleCallbacks;)V
    ...
    .line 3247
    iget-object p1, p0, Landroid/app/FragmentManagerImpl;->mLifecycleCallbacks:Ljava/util/concurrent/CopyOnWriteArrayList;
