...
# static fields
.field public static final greylist-max-o HI_SYNC_ID_INVALID:I = 0x0
...
.method public abstract blacklist getActiveDevices(Landroid/content/AttributionSource;)Ljava/util/List;
...
.method public abstract blacklist getDeviceMode(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract blacklist getDeviceSide(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract blacklist getHiSyncId(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)J
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract blacklist setVolume(ILandroid/content/AttributionSource;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
