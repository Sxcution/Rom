...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/hardware/SensorPrivacyManager;->addSensorPrivacyListener(IILjava/util/concurrent/Executor;Landroid/hardware/SensorPrivacyManager$OnSensorPrivacyChangedListener;)V
.end annotation
...
.method constructor blacklist <init>(Landroid/hardware/SensorPrivacyManager;Ljava/util/concurrent/Executor;Landroid/hardware/SensorPrivacyManager$OnSensorPrivacyChangedListener;I)V
    ...
    iput-object p2, p0, Landroid/hardware/SensorPrivacyManager$2;->val$executor:Ljava/util/concurrent/Executor;
    ...
    iput p4, p0, Landroid/hardware/SensorPrivacyManager$2;->val$sensor:I
...
.method public blacklist onSensorPrivacyChanged(Z)V
    ...
    .line 331
    iget-object v0, p0, Landroid/hardware/SensorPrivacyManager$2;->val$executor:Ljava/util/concurrent/Executor;

    iget-object v1, p0, Landroid/hardware/SensorPrivacyManager$2;->val$listener:Landroid/hardware/SensorPrivacyManager$OnSensorPrivacyChangedListener;

    iget v2, p0, Landroid/hardware/SensorPrivacyManager$2;->val$sensor:I

    new-instance v3, Landroid/hardware/SensorPrivacyManager$2$$ExternalSyntheticLambda0;

    invoke-direct {v3, v1, v2, p1}, Landroid/hardware/SensorPrivacyManager$2$$ExternalSyntheticLambda0;-><init>(Landroid/hardware/SensorPrivacyManager$OnSensorPrivacyChangedListener;IZ)V
