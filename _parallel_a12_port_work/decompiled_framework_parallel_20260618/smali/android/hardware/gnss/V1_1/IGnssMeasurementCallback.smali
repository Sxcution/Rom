...
.method public static blacklist asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;
    ...
    .line 24
    check-cast v2, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;

    return-object v2

    .line 27
    :cond_1
    new-instance v2, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 30
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;->interfaceChain()Ljava/util/ArrayList;
...
.method public static blacklist castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;
    ...
    invoke-static {p0}, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback;
