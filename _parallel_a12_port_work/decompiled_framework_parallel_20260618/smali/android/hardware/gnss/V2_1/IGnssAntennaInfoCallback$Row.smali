...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 148
    new-instance v4, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;

    invoke-direct {v4}, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;

    mul-int/lit8 v5, v4, 0x10

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 108
    :cond_2
    check-cast p1, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;

    .line 109
    iget-object v2, p0, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->row:Ljava/util/ArrayList;

    iget-object p1, p1, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->row:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v1, v3, v4}, Landroid/os/HwBlob;->getDouble(J)D

    move-result-wide v3

    .line 169
    iget-object v6, v0, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->row:Ljava/util/ArrayList;
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object v4, p0, Landroid/hardware/gnss/V2_1/IGnssAntennaInfoCallback$Row;->row:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v6, v7, v8, v9}, Landroid/os/HwBlob;->putDouble(JD)V
