...
.method public static blacklist asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IAGnssRil;
    ...
    .line 27
    check-cast v2, Landroid/hardware/gnss/V1_0/IAGnssRil;

    return-object v2

    .line 30
    :cond_1
    new-instance v2, Landroid/hardware/gnss/V1_0/IAGnssRil$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/gnss/V1_0/IAGnssRil$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 33
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/gnss/V1_0/IAGnssRil;->interfaceChain()Ljava/util/ArrayList;
...
.method public static blacklist castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_0/IAGnssRil;
    ...
    invoke-static {p0}, Landroid/hardware/gnss/V1_0/IAGnssRil;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IAGnssRil;
