...
.method public blacklist setColor(II)V
    ...
    invoke-virtual {p0, p1, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V
    ...
    invoke-virtual {p2}, Landroid/graphics/Color;->alpha()F
    ...
    .line 202
    const-string p2, "in_sparkleColor"

    invoke-virtual {p0, p2, p1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V
...
.method public blacklist setNoisePhase(F)V
    ...
    const-string v3, "in_noisePhase"

    invoke-virtual {v0, v3, v2}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;F)V

    .line 165
    nop

    .line 166
    const-string v2, "in_turbulencePhase"

    invoke-virtual {v0, v2, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;F)V
    ...
    .line 169
    const-wide v8, 0x3fea666666666667L    # 0.8250000000000001
    ...
    .line 168
    const-string v1, "in_tCircle1"

    invoke-virtual {v0, v1, v3}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V

    .line 172
    new-array v1, v2, [F

    const-wide v7, -0x4084f765fd8adabaL    # -0.0066

    mul-double/2addr v7, v4

    .line 173
    const-wide v11, 0x3fe599999999999aL    # 0.675
    ...
    const-wide v15, 0x3fd3333333333334L    # 0.30000000000000004
    ...
    .line 172
    const-string v3, "in_tCircle2"

    invoke-virtual {v0, v3, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V

    .line 176
    new-array v1, v2, [F

    .line 177
    const-wide v11, 0x3fe0ccccccccccccL    # 0.5249999999999999
    ...
    .line 176
    const-string v3, "in_tCircle3"

    invoke-virtual {v0, v3, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V

    .line 180
    const-wide v7, 0x3f9921fb54442d18L    # 0.02454369260617026

    mul-double/2addr v7, v4

    const-wide v11, 0x40155ce26e06bfeeL    # 5.340707511102648
    ...
    .line 181
    const-string v3, "in_tRotation1"

    invoke-virtual {v0, v3, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V

    .line 184
    const-wide v11, -0x4066de04abbbd2e8L    # -0.02454369260617026
    ...
    .line 185
    const-string v3, "in_tRotation2"

    invoke-virtual {v0, v3, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V

    .line 188
    const-wide v3, 0x4021475cc9eedf00L    # 8.63937979737193
...
.method public blacklist setOrigin(FF)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V
...
.method public blacklist setProgress(F)V
    ...
    invoke-virtual {p0, v0, p1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;F)V
...
.method public blacklist setResolution(FF)V
    ...
    const-string v2, "in_resolutionScale"

    invoke-virtual {p0, v2, v1}, Landroid/graphics/drawable/RippleShader;->setUniform(Ljava/lang/String;[F)V
