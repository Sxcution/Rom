...
.method static synthetic blacklist access$000(Landroid/graphics/drawable/RippleAnimationSession;)Landroid/animation/Animator;
    .locals 0
...
.method static synthetic blacklist access$002(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/Animator;)Landroid/animation/Animator;
    .locals 0
...
.method static synthetic blacklist access$100(Landroid/graphics/drawable/RippleAnimationSession;)Ljava/util/function/Consumer;
    .locals 0
...
.method static synthetic blacklist access$200(Landroid/graphics/drawable/RippleAnimationSession;)Landroid/animation/Animator;
    .locals 0
...
.method static synthetic blacklist access$202(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/Animator;)Landroid/animation/Animator;
    .locals 0
...
.method static synthetic blacklist access$300(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/Animator;)V
    .locals 0
...
.method private blacklist enterSoftware()V
    ...
    .line 209
    new-instance v2, Landroid/graphics/drawable/RippleAnimationSession$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0, v1}, Landroid/graphics/drawable/RippleAnimationSession$$ExternalSyntheticLambda0;-><init>(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {v2, p0, v0}, Landroid/graphics/drawable/RippleAnimationSession$$ExternalSyntheticLambda1;-><init>(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/ValueAnimator;)V
...
.method private blacklist exitSoftware()V
    ...
    .line 117
    new-instance v1, Landroid/graphics/drawable/RippleAnimationSession$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0, v0}, Landroid/graphics/drawable/RippleAnimationSession$$ExternalSyntheticLambda2;-><init>(Landroid/graphics/drawable/RippleAnimationSession;Landroid/animation/ValueAnimator;)V
...
.method public synthetic blacklist lambda$enterSoftware$1$RippleAnimationSession(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    .line 211
    iget-object p2, p0, Landroid/graphics/drawable/RippleAnimationSession;->mProperties:Landroid/graphics/drawable/RippleAnimationSession$AnimationProperties;

    invoke-virtual {p2}, Landroid/graphics/drawable/RippleAnimationSession$AnimationProperties;->getShader()Landroid/graphics/drawable/RippleShader;
    ...
    invoke-virtual {p2, p1}, Landroid/graphics/drawable/RippleShader;->setProgress(F)V

    .line 212
    return-void
.end method

.method public synthetic blacklist lambda$enterSoftware$2$RippleAnimationSession(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-virtual {p2, p1}, Landroid/graphics/drawable/RippleShader;->setNoisePhase(F)V

    .line 217
    return-void
.end method

.method public synthetic blacklist lambda$exitSoftware$0$RippleAnimationSession(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator;)V
    .locals 0
