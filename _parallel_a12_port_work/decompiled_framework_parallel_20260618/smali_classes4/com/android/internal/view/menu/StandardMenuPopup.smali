...
# static fields
.field private static final blacklist ITEM_LAYOUT:I = 0x10900cb
...
.method public constructor blacklist <init>(Landroid/content/Context;Lcom/android/internal/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput p6, p0, Lcom/android/internal/view/menu/StandardMenuPopup;->mPopupMaxWidth:I

    .line 128
    iput-object p3, p0, Lcom/android/internal/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;

    .line 130
    new-instance p3, Landroid/widget/MenuPopupWindow;

    const/4 p6, 0x0

    invoke-direct {p3, v0, p6, p4, p5}, Landroid/widget/MenuPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Lcom/android/internal/view/menu/StandardMenuPopup;->mPopup:Landroid/widget/MenuPopupWindow;
...
.method static synthetic blacklist access$000(Lcom/android/internal/view/menu/StandardMenuPopup;)Landroid/widget/MenuPopupWindow;
    .locals 0
...
.method static synthetic blacklist access$100(Lcom/android/internal/view/menu/StandardMenuPopup;)Landroid/view/View;
    .locals 0
...
.method static synthetic blacklist access$200(Lcom/android/internal/view/menu/StandardMenuPopup;)Landroid/view/ViewTreeObserver;
    .locals 0
...
.method static synthetic blacklist access$202(Lcom/android/internal/view/menu/StandardMenuPopup;Landroid/view/ViewTreeObserver;)Landroid/view/ViewTreeObserver;
    .locals 0
...
.method static synthetic blacklist access$300(Lcom/android/internal/view/menu/StandardMenuPopup;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    .locals 0
...
.method private blacklist tryShow()Z
    ...
    invoke-virtual {v0, v3}, Landroid/widget/MenuPopupWindow;->setDropDownGravity(I)V
...
.method public blacklist onSubMenuSelected(Lcom/android/internal/view/menu/SubMenuBuilder;)Z
    ...
    .line 284
    iget-object v4, p0, Lcom/android/internal/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;
...
.method public blacklist updateMenuView(Z)V
    ...
    .line 250
    iget-object p1, p0, Lcom/android/internal/view/menu/StandardMenuPopup;->mAdapter:Lcom/android/internal/view/menu/MenuAdapter;
