.class public Lcom/android/internal/util/custom/ColorUtils;
.super Ljava/lang/Object;
.source "ColorUtils.java"


# static fields
.field private static blacklist COEFFICIENTS:[F

.field private static blacklist SOLID_COLORS:[I

.field private static final blacklist sColorTable:[D
...
.method static constructor blacklist <clinit>()V
    ...
    sput-object v1, Lcom/android/internal/util/custom/ColorUtils;->SOLID_COLORS:[I

    .line 43
    new-array v1, v0, [F

    sput-object v1, Lcom/android/internal/util/custom/ColorUtils;->COEFFICIENTS:[F
    ...
    .line 50
    sget-object v3, Lcom/android/internal/util/custom/ColorUtils;->COEFFICIENTS:[F
    ...
    sput-object v0, Lcom/android/internal/util/custom/ColorUtils;->sColorTable:[D
...
.method public static blacklist calculateDeltaE(DDDDDD)D
    .locals 37
    ...
    .line 172
    const-wide v27, 0x3fc5c28f5c28f5c3L    # 0.17

    const-wide v29, 0x3fe0c152382d7365L    # 0.5235987755982988

    sub-double v31, v2, v29
    ...
    sub-double v27, v16, v31

    const-wide v31, 0x3fceb851eb851eb8L    # 0.24

    mul-double v33, v2, v18
    ...
    const-wide v31, 0x3fd47ae147ae147bL    # 0.32

    const-wide/high16 v33, 0x4008000000000000L    # 3.0

    mul-double v33, v33, v2

    const-wide v35, 0x3fbacee9f37bebd5L    # 0.10471975511965977
    ...
    const-wide v35, 0x3ff197c987c952c4L    # 1.0995574287564276
    ...
    const-wide v22, 0x4071300000000000L    # 275.0
...
.method public static blacklist convertRGBtoLAB(I)[F
    .locals 15
...
.method public static blacklist dropAlpha(I)I
    .locals 1
...
.method public static blacklist findPerceptuallyNearestColor(I[I)I
    .locals 23
    ...
    .line 221
    invoke-static/range {p0 .. p0}, Lcom/android/internal/util/custom/ColorUtils;->convertRGBtoLAB(I)[F
    ...
    invoke-static {v7}, Lcom/android/internal/util/custom/ColorUtils;->convertRGBtoLAB(I)[F
    ...
    invoke-static/range {v9 .. v20}, Lcom/android/internal/util/custom/ColorUtils;->calculateDeltaE(DDDDDD)D
...
.method public static blacklist findPerceptuallyNearestSolidColor(I)I
    .locals 1

    .line 245
    sget-object v0, Lcom/android/internal/util/custom/ColorUtils;->SOLID_COLORS:[I

    invoke-static {p0, v0}, Lcom/android/internal/util/custom/ColorUtils;->findPerceptuallyNearestColor(I[I)I
...
.method public static blacklist generateAlertColorFromDrawable(Landroid/graphics/drawable/Drawable;)I
    .locals 7
    ...
    invoke-virtual {v2}, Lcom/android/internal/util/custom/palette/Palette$Builder;->generate()Lcom/android/internal/util/custom/palette/Palette;
    ...
    .line 304
    :cond_2
    invoke-static {v2}, Lcom/android/internal/util/custom/ColorUtils;->getDominantSwatch(Lcom/android/internal/util/custom/palette/Palette;)Lcom/android/internal/util/custom/palette/Palette$Swatch;
    ...
    .line 307
    invoke-virtual {v3}, Lcom/android/internal/util/custom/palette/Palette$Swatch;->getRgb()I

    move-result v3

    .line 308
    invoke-static {v3}, Lcom/android/internal/util/custom/ColorUtils;->findPerceptuallyNearestSolidColor(I)I
    ...
    :cond_5
    :goto_2
    invoke-virtual {v2, v4}, Lcom/android/internal/util/custom/palette/Palette;->getVibrantColor(I)I

    move-result v0

    .line 314
    invoke-static {v0}, Lcom/android/internal/util/custom/ColorUtils;->findPerceptuallyNearestSolidColor(I)I
...
.method public static blacklist getDominantSwatch(Lcom/android/internal/util/custom/palette/Palette;)Lcom/android/internal/util/custom/palette/Palette$Swatch;
    .locals 1

    .line 255
    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lcom/android/internal/util/custom/palette/Palette;->getSwatches()Ljava/util/List;
    ...
    new-instance v0, Lcom/android/internal/util/custom/ColorUtils$1;

    invoke-direct {v0}, Lcom/android/internal/util/custom/ColorUtils$1;-><init>()V

    invoke-static {p0, v0}, Ljava/util/Collections;->max(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/android/internal/util/custom/palette/Palette$Swatch;
...
.method public static blacklist temperatureToRGB(I)[F
    .locals 9
    ...
    .line 338
    sget-object v4, Lcom/android/internal/util/custom/ColorUtils;->COEFFICIENTS:[F
