...
.method private refreshFeatureFlag(Landroid/content/Context;)V
    ...
    const-string v3, "context.createPackageContextAsUser() fail: "
    ...
    const-string v2, "battery_24_hrs_stats"
    ...
    :cond_1
    iput-boolean v1, p0, Lcom/android/settings/applications/appinfo/AppBatteryPreferenceController;->mIsChartGraphEnabled:Z
...
.method updateBattery()V
    ...
    sget v3, Lcom/android/settings/R$string;->battery_summary:I
...
.method updateBatteryWithDiffEntry()V
    ...
    sget v4, Lcom/android/settings/R$string;->battery_summary_24hr:I
    ...
    sget v3, Lcom/android/settings/R$string;->no_battery_summary_24hr:I
