...
# direct methods
.method public static $r8$lambda$WlKOr2mZicOwhxlhByT2XVGXtIA(Landroid/service/settings/suggestions/Suggestion;Landroid/view/View;)V
    .locals 0
...
.method public static $r8$lambda$mcVPCHGkZnm8qSd3F_KzOAg8Ys4(Lcom/google/android/settings/dashboard/suggestions/ContextualSuggestionFragment;)V
    .locals 0
...
.method public static $r8$lambda$qgCu46CLOQvZEcmr7ijHXjge6Cg(Lcom/google/android/settings/dashboard/suggestions/ContextualSuggestionFragment;Ljava/util/List;)V
    .locals 0
...
.method private lambda$loadSuggestions$0(Ljava/util/List;)V
    .locals 0
...
.method private lambda$loadSuggestions$1()V
    .locals 5
...
.method private static lambda$updateState$2(Landroid/service/settings/suggestions/Suggestion;Landroid/view/View;)V
    .locals 1
...
.method getSuggestionSummary(Ljava/lang/String;)I
    ...
    :cond_0
    sget p0, Lcom/android/settings/R$string;->tips_suggestion_summary:I

    return p0

    :cond_1
    sget p0, Lcom/android/settings/R$string;->setup_suggestion_summary:I
...
.method getSuggestionTitle(Ljava/lang/String;)I
    ...
    :cond_0
    sget p0, Lcom/android/settings/R$string;->tips_suggestion_title:I

    return p0

    :cond_1
    sget p0, Lcom/android/settings/R$string;->setup_suggestion_title:I
...
.method public onAttach(Landroid/content/Context;)V
    ...
    invoke-interface {v1}, Lcom/android/settings/dashboard/suggestions/SuggestionFeatureProvider;->getSuggestionServiceComponent()Landroid/content/ComponentName;

    move-result-object v1

    invoke-direct {v0, p1, v1, p0}, Lcom/android/settingslib/suggestions/SuggestionController;-><init>(Landroid/content/Context;Landroid/content/ComponentName;Lcom/android/settingslib/suggestions/SuggestionController$ServiceConnectionListener;)V

    iput-object v0, p0, Lcom/google/android/settings/dashboard/suggestions/ContextualSuggestionFragment;->mSuggestionController:Lcom/android/settingslib/suggestions/SuggestionController;
