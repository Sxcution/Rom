...
# direct methods
.method public static $r8$lambda$HC23ga66YqE40mBL7BfstUgvHoY(Lcom/google/android/settings/accessibility/AccessibilitySearchFeatureProviderGoogleImpl$SearchIndexableRawHelper;Landroid/content/pm/ActivityInfo;Ljava/util/List;Ljava/util/Map$Entry;)V
    .locals 0
...
.method public static $r8$lambda$gah_z3aD0yPxkNHkUuJVk7KBs5E(Lcom/google/android/settings/accessibility/AccessibilitySearchFeatureProviderGoogleImpl$SearchIndexableRawHelper;Landroid/content/pm/ResolveInfo;Ljava/util/List;Ljava/util/Map$Entry;)V
    .locals 0
...
.method public static $r8$lambda$sPiFvvY-Qm786zNQSTw_S8WOVTA(Landroid/content/ComponentName;Ljava/util/Map$Entry;)Z
    .locals 0
...
.method public static $r8$lambda$vZ9Gx2WZA85BgNN8guoaGpHRyY8(Landroid/content/ComponentName;Ljava/util/Map$Entry;)Z
    .locals 0
...
.method private static lambda$buildSupportedActivitySearchIndex$2(Landroid/content/ComponentName;Ljava/util/Map$Entry;)Z
    .locals 0
...
.method private lambda$buildSupportedActivitySearchIndex$3(Landroid/content/pm/ActivityInfo;Ljava/util/List;Ljava/util/Map$Entry;)V
    .locals 2
...
.method private static lambda$buildSupportedServiceSearchIndex$0(Landroid/content/ComponentName;Ljava/util/Map$Entry;)Z
    .locals 0
...
.method private lambda$buildSupportedServiceSearchIndex$1(Landroid/content/pm/ResolveInfo;Ljava/util/List;Ljava/util/Map$Entry;)V
    .locals 2
...
.method public buildSupportedServiceSearchIndex(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v7, v5}, Lcom/google/android/settings/accessibility/AccessibilitySearchFeatureProviderGoogleImpl$SearchIndexableRawHelper$$ExternalSyntheticLambda2;-><init>(Landroid/content/ComponentName;)V
