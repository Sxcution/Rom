...
.method public static makePsdBundle(Landroid/content/Context;I)Lcom/google/android/settings/support/PsdBundle;
    ...
    const-string v15, "persist.sys.timezone"
    ...
    const-string v4, "Dump battery stats, length: %d"

    invoke-static {v4, v11}, Ljava/lang/String;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v4

    const-string v5, "PsdValuesLoader"
    ...
    invoke-virtual {v13, v3}, Landroid/media/AudioManager;->getStreamVolume(I)I
    ...
    invoke-static {v9, v13, v3}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-static {v10, v4}, Lcom/google/android/settings/support/PsdValuesLoader;->readVersionInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;)[Ljava/lang/String;
    ...
    new-instance v7, Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    invoke-static {v9, v10, v4, v5}, Lcom/google/android/settings/experiments/GServicesProxy;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J

    move-result-wide v4

    invoke-direct {v7, v0, v4, v5}, Lcom/google/android/settings/support/PsdBundle$Builder;-><init>(Landroid/content/Context;J)V

    sget-object v4, Landroid/os/Build;->DISPLAY:Ljava/lang/String;

    const-string v5, "noe_display_name"

    invoke-virtual {v7, v5, v4}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v4

    sget-object v5, Landroid/os/Build;->TYPE:Ljava/lang/String;

    const-string v7, "noe_type"

    invoke-virtual {v4, v7, v5}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v4

    sget-object v5, Landroid/os/Build;->PRODUCT:Ljava/lang/String;

    const-string v7, "noe_product"
    ...
    const-string v7, "noe_incremental"
    ...
    const-string v7, "noe_fingerprint"
    ...
    const-string v7, "noe_preview_sdk_int"
    ...
    const-string v7, "noe_security_patch"

    invoke-virtual {v4, v7, v5}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v4

    sget-object v5, Lcom/google/android/settings/support/PsdValuesLoader;->DATE_FORMATTER:Ljava/text/SimpleDateFormat;
    ...
    const-string v7, "noe_dump_datetime"
    ...
    :cond_e
    const-string v5, "noe_timezone"

    invoke-virtual {v4, v5, v15}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v4

    sget-object v5, Landroid/os/Build;->BOOTLOADER:Ljava/lang/String;

    const-string v7, "noe_bootloader"
    ...
    :cond_f
    const-string v5, "noe_network_operator"

    invoke-virtual {v4, v5, v6}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    :goto_d
    const-string v6, "noe_network_type"

    invoke-virtual {v4, v6, v5}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    :goto_e
    const-string v6, "noe_phone_type"
    ...
    :cond_12
    const-string v5, "noe_is_volte_available"

    invoke-virtual {v4, v5, v2}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    sget-object v4, Landroid/os/Build;->ID:Ljava/lang/String;

    const-string v5, "noe_build_id"
    ...
    const-string v5, "noe_decimal_gsf_id"

    invoke-virtual {v2, v5, v4}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    const-string v4, "noe_gps_enabled"

    move-object/from16 v5, v27

    invoke-virtual {v2, v4, v5}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    invoke-virtual {v2, v4, v15}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    :goto_11
    const-string v5, "noe_alarm_max_volume"
    ...
    :goto_12
    const-string v5, "noe_voice_call_max_volume"
    ...
    :goto_13
    const-string v5, "noe_notification_max_volume"
    ...
    :goto_14
    const-string v5, "noe_music_max_volume"
    ...
    :goto_15
    const-string v5, "noe_ringer_max_volume"
    ...
    :goto_16
    const-string v5, "noe_display_timeout"
    ...
    :goto_17
    const-string v5, "noe_sim_state"

    invoke-virtual {v2, v5, v4}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    const-string v4, "noe_good_reboots_last_day"

    invoke-virtual {v2, v4, v12}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    const-string v4, "noe_bad_reboots_last_day"

    invoke-virtual {v2, v4, v12}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    const-string v4, "noe_good_reboots_last_week"

    invoke-virtual {v2, v4, v12}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    const-string v4, "noe_bad_reboots_last_week"
    ...
    const-string v5, "noe_location_mode"
    ...
    const-string v5, "noe_wifi_state"
    ...
    :goto_18
    const-string v4, "noe_wifi_security_key_valid"
    ...
    const-string v4, "noe_battery_health"
    ...
    const-string v5, "noe_battery_level"
    ...
    const-string v5, "noe_battery_scale"
    ...
    const-string v4, "noe_battery_voltage"
    ...
    const-string v5, "noe_battery_present"
    ...
    const-string v6, "noe_storage_available"
    ...
    const-string v7, "noe_storage_total"

    invoke-virtual {v2, v7, v6}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    aget-object v6, v52, v4

    const-string v7, "noe_ram_available"

    invoke-virtual {v2, v7, v6}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v2

    aget-object v6, v52, v5

    const-string v7, "noe_ram_total"
    ...
    const-string v7, "noe_google_app_version_code"
    ...
    const-string v7, "noe_google_app_version_name"
    ...
    const-string v7, "noe_google_play_services_version_code"
    ...
    const-string v6, "noe_google_play_services_version_name"

    invoke-virtual {v2, v6, v1}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v1

    aget-object v2, v60, v4

    const-string v6, "noe_google_play_store_version_code"

    invoke-virtual {v1, v6, v2}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v1

    aget-object v2, v60, v5

    const-string v6, "noe_google_play_store_version_name"
    ...
    invoke-virtual {v1, v2, v6}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v1

    aget-object v2, v57, v4

    const-string v6, "noe_num_bluetooth_connections"

    invoke-virtual {v1, v6, v2}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v1

    aget-object v2, v57, v5

    const-string v6, "noe_bluetooth_enabled"
    ...
    const-string v6, "noe_camera_version_code"

    invoke-virtual {v1, v6, v2}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v1

    aget-object v2, v58, v5

    const-string v6, "noe_camera_version_name"
    ...
    const-string v4, "noe_wear_version_code"
    ...
    aget-object v2, v56, v5

    const-string v4, "noe_wear_version_name"
    ...
    invoke-virtual {v4}, Lcom/google/android/settings/support/PsdBundle$Builder;->addConnectedBluetoothDevicesSignals()Lcom/google/android/settings/support/PsdBundle$Builder;

    move-result-object v4

    invoke-virtual {v4}, Lcom/google/android/settings/support/PsdBundle$Builder;->addTopBatteryApps()Lcom/google/android/settings/support/PsdBundle$Builder;

    :cond_1d
    if-ne v5, v2, :cond_1e

    const-string v4, "noe_device_activation_time"

    move-object/from16 v8, v55

    invoke-virtual {v1, v4, v8}, Lcom/google/android/settings/support/PsdBundle$Builder;->addSignal(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/settings/support/PsdBundle$Builder;
    ...
    :goto_19
    const-string v4, "noe_voice_call_volume"
    ...
    :goto_1a
    const-string v5, "noe_notification_volume"
    ...
    :goto_1b
    const-string v5, "noe_system_volume"
    ...
    const-string v4, "noe_battery_status"
    ...
    :goto_1c
    const-string v3, "noe_alarm_volume"
    ...
    :goto_1e
    const-string v3, "noe_ringer_volume"
