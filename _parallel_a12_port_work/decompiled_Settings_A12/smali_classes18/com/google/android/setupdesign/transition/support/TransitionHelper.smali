...
.method public static applyBackwardTransition(Landroidx/fragment/app/Fragment;)V
    ...
    invoke-static {v2}, Lcom/google/android/setupdesign/transition/TransitionHelper;->getConfigTransitionType(Landroid/content/Context;)I
    ...
    :cond_0
    const-string p0, "Not apply the backward transition for support lib\'s fragment."
    ...
    :cond_1
    const-string p0, "Not apply the backward transition for support lib\'s fragment. The API is supported from Android Sdk 23"
...
.method public static applyForwardTransition(Landroidx/fragment/app/Fragment;)V
    ...
    :cond_0
    const-string p0, "Not apply the forward transition for support lib\'s fragment."
    ...
    :cond_1
    const-string p0, "Not apply the forward transition for support lib\'s fragment. The API is supported from Android Sdk 23"
