...
.method public getNotificationSoundTimeout(Ljava/lang/String;I)J
    ...
    invoke-interface {p0, p1, p2}, Landroid/app/INotificationManager;->getNotificationSoundTimeout(Ljava/lang/String;I)J
...
.method public loadAppRow(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;)Lcom/android/settings/notification/NotificationBackend$AppRow;
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/settings/notification/NotificationBackend;->getNotificationSoundTimeout(Ljava/lang/String;I)J

    move-result-wide p2

    iput-wide p2, v0, Lcom/android/settings/notification/NotificationBackend$AppRow;->soundTimeout:J
...
.method public setNotificationSoundTimeout(Ljava/lang/String;IJ)Z
    ...
    invoke-interface {p0, p1, p2, p3, p4}, Landroid/app/INotificationManager;->setNotificationSoundTimeout(Ljava/lang/String;IJ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
