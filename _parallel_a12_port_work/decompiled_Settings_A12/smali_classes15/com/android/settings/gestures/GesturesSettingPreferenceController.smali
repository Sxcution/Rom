...
.method private static buildAllPreferenceControllers(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 80
    new-instance v2, Lcom/android/settings/gestures/SwipeToScreenshotPreferenceController;

    invoke-direct {v2, p0, v3}, Lcom/android/settings/gestures/SwipeToScreenshotPreferenceController;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 81
    new-instance v2, Lcom/android/settings/gestures/ScreenOffUdfpsPreferenceController;

    invoke-direct {v2, p0, v3}, Lcom/android/settings/gestures/ScreenOffUdfpsPreferenceController;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 82
    invoke-virtual {v2, v0}, Lcom/android/settings/gestures/ScreenOffUdfpsPreferenceController;->setConfig(Landroid/hardware/display/AmbientDisplayConfiguration;)Lcom/android/settings/gestures/ScreenOffUdfpsPreferenceController;
