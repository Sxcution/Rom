...
.method private static buildPreferenceControllers(Landroid/content/Context;Lcom/android/settings/dashboard/DashboardFragment;Lcom/android/internal/widget/LockPatternUtils;)Ljava/util/List;
    ...
    .line 74
    new-instance v1, Lcom/android/settings/security/screenlock/PatternErrorVisiblePreferenceController;

    invoke-direct {v1, p0, v2, p2}, Lcom/android/settings/security/screenlock/PatternErrorVisiblePreferenceController;-><init>(Landroid/content/Context;ILcom/android/internal/widget/LockPatternUtils;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 76
    new-instance v1, Lcom/android/settings/security/screenlock/PatternDotsVisiblePreferenceController;

    invoke-direct {v1, p0, v2, p2}, Lcom/android/settings/security/screenlock/PatternDotsVisiblePreferenceController;-><init>(Landroid/content/Context;ILcom/android/internal/widget/LockPatternUtils;)V
    ...
    .line 82
    new-instance v1, Lcom/android/settings/security/screenlock/PinScramblePreferenceController;

    invoke-direct {v1, p0, v2, p2}, Lcom/android/settings/security/screenlock/PinScramblePreferenceController;-><init>(Landroid/content/Context;ILcom/android/internal/widget/LockPatternUtils;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 84
    new-instance p2, Lcom/android/settings/security/screenlock/FingerprintUnlockPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/security/screenlock/FingerprintUnlockPreferenceController;-><init>(Landroid/content/Context;)V
