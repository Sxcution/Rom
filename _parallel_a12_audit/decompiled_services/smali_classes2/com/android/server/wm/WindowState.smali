...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;ILandroid/view/WindowManager$LayoutParams;IIIZLcom/android/server/wm/WindowState$PowerManagerWrapper;)V
    ...
    iput v14, v1, Lcom/android/server/wm/WindowState;->mOwnerUid:I
    ...
    invoke-direct {v14, v1, v12}, Lcom/android/server/wm/WindowState$WindowId;-><init>(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState$1;)V
    ...
    iget-object v14, v7, Landroid/view/WindowManager$LayoutParams;->surfaceInsets:Landroid/graphics/Rect;
    ...
    iget-object v14, v1, Lcom/android/server/wm/WindowState;->mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    new-instance v14, Lcom/android/server/wm/WindowState$DeathRecipient;

    invoke-direct {v14, v1, v12}, Lcom/android/server/wm/WindowState$DeathRecipient;-><init>(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState$1;)V
    ...
    new-instance v15, Landroid/view/InputWindowHandle;
    ...
    invoke-direct {v15, v12, v11}, Landroid/view/InputWindowHandle;-><init>(Landroid/view/InputApplicationHandle;I)V

    invoke-direct {v3, v15}, Lcom/android/server/wm/InputWindowHandleWrapper;-><init>(Landroid/view/InputWindowHandle;)V
    ...
    invoke-virtual {v3, v11}, Lcom/android/server/wm/InputWindowHandleWrapper;->setOwnerPid(I)V

    iget v11, v2, Lcom/android/server/wm/Session;->mUid:I

    invoke-virtual {v3, v11}, Lcom/android/server/wm/InputWindowHandleWrapper;->setOwnerUid(I)V

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/WindowState;->getName()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/android/server/wm/InputWindowHandleWrapper;->setName(Ljava/lang/String;)V

    iget-object v11, v7, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;

    invoke-virtual {v3, v11}, Lcom/android/server/wm/InputWindowHandleWrapper;->setPackageName(Ljava/lang/String;)V

    iget v11, v7, Landroid/view/WindowManager$LayoutParams;->type:I

    invoke-virtual {v3, v11}, Lcom/android/server/wm/InputWindowHandleWrapper;->setLayoutParamsType(I)V

    iget v11, v7, Landroid/view/WindowManager$LayoutParams;->privateFlags:I
    ...
    invoke-interface {v3, v14, v9}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    nop

    iput-object v14, v1, Lcom/android/server/wm/WindowState;->mDeathRecipient:Lcom/android/server/wm/WindowState$DeathRecipient;
    ...
    invoke-interface {v13, v4}, Lcom/android/server/policy/WindowManagerPolicy;->getWindowLayerLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)I
    ...
    invoke-interface {v13, v3}, Lcom/android/server/policy/WindowManagerPolicy;->getSubWindowLayerFromTypeLw(I)I

    move-result v3

    iput v3, v1, Lcom/android/server/wm/WindowState;->mSubLayer:I

    iput-boolean v8, v1, Lcom/android/server/wm/WindowState;->mIsChildWindow:Z
    ...
    invoke-virtual {v4, v1, v3}, Lcom/android/server/wm/WindowState;->addChild(Lcom/android/server/wm/WindowContainer;Ljava/util/Comparator;)V
    ...
    :goto_d
    iput-object v12, v1, Lcom/android/server/wm/WindowState;->mWpcForDisplayAreaConfigChanges:Lcom/android/server/wm/WindowProcessController;
    ...
    iput-object v2, v1, Lcom/android/server/wm/WindowState;->mWpcForDisplayAreaConfigChanges:Lcom/android/server/wm/WindowProcessController;
...
.method private applyGravityAndUpdateFrame(Lcom/android/server/wm/WindowFrames;Landroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget v7, v7, Lcom/android/server/wm/DisplayFrames;->mRotation:I

    invoke-virtual {v0, v7}, Lcom/android/server/wm/WindowState;->getLayoutingAttrs(I)Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/WindowState;->hasCompatScale()Z
    ...
    iget v9, v5, Lcom/android/server/wm/WindowState;->mInvGlobalScale:F

    invoke-static {v8, v9}, Lcom/android/server/wm/utils/CoordinateTransforms;->scaleRectSize(Landroid/graphics/Rect;F)V

    if-eqz v6, :cond_f

    iget-object v9, v0, Lcom/android/server/wm/WindowState;->mTmpRect2:Landroid/graphics/Rect;
    ...
    iget v5, v5, Lcom/android/server/wm/WindowState;->mInvGlobalScale:F

    invoke-static {v9, v5}, Lcom/android/server/wm/utils/CoordinateTransforms;->scaleRectSize(Landroid/graphics/Rect;F)V
    ...
    iget v5, v7, Landroid/view/WindowManager$LayoutParams;->horizontalMargin:F
    ...
    iget v5, v7, Landroid/view/WindowManager$LayoutParams;->verticalMargin:F
    ...
    invoke-static {v2, v9, v3}, Landroid/view/Gravity;->applyDisplay(ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method private forAllWindowBottomToTop(Lcom/android/internal/util/ToBooleanFunction;)Z
    ...
    invoke-direct {v1, p1, v2}, Lcom/android/server/wm/WindowState;->applyInOrderWithImeWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/wm/WindowList;->get(I)Ljava/lang/Object;
...
.method private registeredForDisplayAreaConfigChanges()Z
    ...
    iget-object v0, v0, Lcom/android/server/wm/WindowState;->mWpcForDisplayAreaConfigChanges:Lcom/android/server/wm/WindowProcessController;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mWpcForDisplayAreaConfigChanges:Lcom/android/server/wm/WindowProcessController;

    :goto_0
    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/android/server/wm/WindowProcessController;->registeredForDisplayAreaConfigChanges()Z
...
.method private removeIfPossible(Z)V
    ...
    :cond_2
    iget-object v8, v0, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v8, v9, v1}, Lcom/android/server/wm/ActivityRecord;->forAllWindowsUnchecked(Lcom/android/internal/util/ToBooleanFunction;Z)Z
    ...
    invoke-virtual {v0, v6, v8}, Lcom/android/server/wm/WindowState;->isSelfAnimating(II)Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/wm/WindowState;->isAnimating(I)Z
    ...
    invoke-static {v3, v4, v5, v7, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v4, v3}, Lcom/android/server/wm/WindowState;->isAnimating(II)Z
...
.method calculateSurfaceBounds(Landroid/view/WindowManager$LayoutParams;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p2, v0, v1, v2, p1}, Landroid/graphics/Rect;->inset(IIII)V
...
.method public canReceiveKeys(Z)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->isOnTop()Z
...
.method computeFrame(Lcom/android/server/wm/DisplayFrames;)V
    ...
    invoke-virtual {v5, v3}, Lcom/android/server/wm/DisplayContent;->getImeTarget(I)Lcom/android/server/wm/InsetsControlTarget;
    ...
    :cond_7
    iget-object v2, v7, Lcom/android/server/wm/WindowFrames;->mContainingFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v2, v8, v3}, Landroid/view/InsetsState;->calculateInsets(Landroid/graphics/Rect;IZ)Landroid/graphics/Insets;

    move-result-object v1

    invoke-virtual {v2, v1}, Landroid/graphics/Rect;->inset(Landroid/graphics/Insets;)V

    iget-object v1, v7, Lcom/android/server/wm/WindowFrames;->mContainingFrame:Landroid/graphics/Rect;
    ...
    iget-object v8, v7, Lcom/android/server/wm/WindowFrames;->mContainingFrame:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcom/android/server/wm/WindowState;->mInsetFrame:Landroid/graphics/Rect;
    ...
    iget-object v2, v7, Lcom/android/server/wm/WindowFrames;->mParentFrame:Landroid/graphics/Rect;
    ...
    iget-object v2, v7, Lcom/android/server/wm/WindowFrames;->mDisplayFrame:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    :cond_a
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mTmpRect2:Landroid/graphics/Rect;
    ...
    iget-object v4, v7, Lcom/android/server/wm/WindowFrames;->mContainingFrame:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lcom/android/server/wm/WindowState;->mInsetFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v9, v3, v3, v10, v6}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v6, v7, Lcom/android/server/wm/WindowFrames;->mDisplayFrame:Landroid/graphics/Rect;

    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mTmpRect:Landroid/graphics/Rect;

    invoke-direct {p0, v6, v8, v1, v9}, Lcom/android/server/wm/WindowState;->subtractInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object v6, v7, Lcom/android/server/wm/WindowFrames;->mContainingFrame:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v6, v8, v9, v10}, Lcom/android/server/wm/WindowState;->subtractInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object v1, v7, Lcom/android/server/wm/WindowFrames;->mDisplayFrame:Landroid/graphics/Rect;
    ...
    iget v6, p0, Lcom/android/server/wm/WindowState;->mRequestedWidth:I

    iget v9, p0, Lcom/android/server/wm/WindowState;->mLastRequestedWidth:I

    if-ne v6, v9, :cond_d

    iget v9, p0, Lcom/android/server/wm/WindowState;->mRequestedHeight:I

    iget v10, p0, Lcom/android/server/wm/WindowState;->mLastRequestedHeight:I
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/wm/WindowFrames;->setContentChanged(Z)V

    :cond_e
    iget-object v6, v7, Lcom/android/server/wm/WindowFrames;->mFrame:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v7, v8, v1, p1}, Lcom/android/server/wm/WindowState;->applyGravityAndUpdateFrame(Lcom/android/server/wm/WindowFrames;Landroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object p1, v7, Lcom/android/server/wm/WindowFrames;->mFrame:Landroid/graphics/Rect;

    iget-object v1, v7, Lcom/android/server/wm/WindowFrames;->mLastFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v7, p1, v0}, Lcom/android/server/wm/WindowFrames;->offsetFrames(II)V

    iget-object p1, v7, Lcom/android/server/wm/WindowFrames;->mCompatFrame:Landroid/graphics/Rect;
    ...
    :cond_11
    iget-object p1, v5, Lcom/android/server/wm/DisplayContent;->mWallpaperController:Lcom/android/server/wm/WallpaperController;

    invoke-virtual {p1, p0, v3}, Lcom/android/server/wm/WallpaperController;->updateWallpaperOffset(Lcom/android/server/wm/WindowState;Z)Z

    :cond_12
    iget-object p1, v7, Lcom/android/server/wm/WindowFrames;->mRelFrame:Landroid/graphics/Rect;
    ...
    iget-object v1, v7, Lcom/android/server/wm/WindowFrames;->mFrame:Landroid/graphics/Rect;
...
.method computeFrameAndUpdateSourceFrame(Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowState;->mControllableInsetProvider:Lcom/android/server/wm/InsetsSourceProvider;
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/InsetsSourceProvider;->updateSourceFrame()V
...
.method executeDrawHandlers(Landroid/view/SurfaceControl$Transaction;)Z
    ...
    :goto_1
    iget-object v4, p0, Lcom/android/server/wm/WindowState;->mReadyDrawHandlers:Ljava/util/List;
...
.method fillClientWindowFramesAndConfiguration(Landroid/window/ClientWindowFrames;Landroid/util/MergedConfiguration;ZZ)V
    ...
    invoke-virtual {v1}, Landroid/app/WindowConfiguration;->useWindowFrameForBackdrop()Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowToken;->isVisibleRequested()Z
...
.method finishDrawing(Landroid/view/SurfaceControl$Transaction;)Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/wm/ActivityMetricsLogger;->notifyStartingWindowDrawn(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p1, v0, v2}, Lcom/android/server/wm/WindowStateAnimator;->finishDrawingLocked(Landroid/view/SurfaceControl$Transaction;Z)Z
...
.method finishSeamlessRotation(Landroid/view/SurfaceControl$Transaction;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/InsetsSourceProvider;->finishSeamlessRotation()V
...
.method getAnimationFrames(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p4, p1, v0, v1}, Landroid/view/InsetsState;->calculateInsets(Landroid/graphics/Rect;IZ)Landroid/graphics/Insets;
    ...
    invoke-virtual {p4, p1, p2, v0}, Landroid/view/InsetsState;->calculateInsets(Landroid/graphics/Rect;IZ)Landroid/graphics/Insets;
...
.method getImeControlTarget()Lcom/android/server/wm/InsetsControlTarget;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/android/server/wm/DisplayContent;->getImeHostOrFallback(Lcom/android/server/wm/WindowState;)Lcom/android/server/wm/InsetsControlTarget;
...
.method getSurfaceTouchableRegion(Landroid/graphics/Region;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {p1, v1, v2, p2, v0}, Landroid/graphics/Region;->set(IIII)Z
    ...
    invoke-virtual {p1, v0, p2}, Landroid/graphics/Region;->translate(II)V
...
.method getVisibleBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v3, v1}, Lcom/android/server/wm/Task;->getDimBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/TaskDisplayArea;->getRootSplitScreenSecondaryTask()Lcom/android/server/wm/Task;
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/wm/WindowState;->cutRect(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/view/InsetsState;->calculateVisibleInsets(Landroid/graphics/Rect;I)Landroid/graphics/Insets;
...
.method hide(ZZ)Z
    ...
    invoke-static {p1, v3, v0, v4, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method isPotentialDragTarget(Z)Z
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowState;->mInputWindowHandle:Lcom/android/server/wm/InputWindowHandleWrapper;
...
.method matchesDisplayAreaBounds()Z
    ...
    :cond_1
    invoke-virtual {v0}, Lcom/android/server/wm/DisplayArea;->getBounds()Landroid/graphics/Rect;
...
.method public notifyInsetsControlChanged()V
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowFrames;->isFrameSizeChangeReported()Z

    move-result v4

    invoke-interface {v1, v2, v0, v3, v4}, Landroid/view/IWindow;->insetsControlChanged(Landroid/view/InsetsState;[Landroid/view/InsetsSourceControl;ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onAnimationFinished(ILcom/android/server/wm/AnimationAdapter;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowStateAnimator;->onAnimationFinished()V
...
.method onAppVisibilityChanged(ZZ)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/ActivityRecord;->isAnimating(I)Z
    ...
    invoke-virtual {p2, v1, v0}, Lcom/android/server/wm/WindowStateAnimator;->applyAnimationLocked(IZ)Z
    ...
    invoke-virtual {p1, p0, v1}, Lcom/android/server/wm/AccessibilityController;->onWindowTransition(Lcom/android/server/wm/WindowState;I)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1, v2}, Landroid/app/WindowConfiguration;->diff(Landroid/app/WindowConfiguration;Z)J
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->updateImeControlTarget()V
...
.method onDisplayChanged(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/InputWindowHandleWrapper;->setDisplayId(I)V
...
.method onParentChanged(Lcom/android/server/wm/ConfigurationContainer;Lcom/android/server/wm/ConfigurationContainer;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->reapplyMagnificationSpec()V
...
.method reportResized()V
    ...
    const-string v3, "wm.reportResized_"
    ...
    invoke-static {v7, v8, v5, v3, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v7, v8, v5, v3, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_5
    iget-boolean v6, p0, Lcom/android/server/wm/WindowState;->mReportOrientationChanged:Z

    iput-boolean v5, p0, Lcom/android/server/wm/WindowState;->mReportOrientationChanged:Z
    ...
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mClientWindowFrames:Landroid/window/ClientWindowFrames;

    iget-object v8, p0, Lcom/android/server/wm/WindowState;->mLastReportedConfiguration:Landroid/util/MergedConfiguration;

    invoke-virtual {p0, v7, v8, v4, v5}, Lcom/android/server/wm/WindowState;->fillClientWindowFramesAndConfiguration(Landroid/window/ClientWindowFrames;Landroid/util/MergedConfiguration;ZZ)V

    invoke-direct {p0}, Lcom/android/server/wm/WindowState;->shouldSendRedrawForSync()Z
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/DisplayPolicy;->areSystemBarsForcedShownLw()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->markRedrawForSyncReported()V

    :try_start_0
    iget-object v8, p0, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;

    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mClientWindowFrames:Landroid/window/ClientWindowFrames;

    iget-object v11, p0, Lcom/android/server/wm/WindowState;->mLastReportedConfiguration:Landroid/util/MergedConfiguration;

    move v14, v7

    invoke-interface/range {v8 .. v14}, Landroid/view/IWindow;->resized(Landroid/window/ClientWindowFrames;ZLandroid/util/MergedConfiguration;ZZI)V
    ...
    iput-wide v8, p0, Lcom/android/server/wm/WindowState;->mOrientationChangeRedrawRequestTime:J
    ...
    invoke-static {v6, v8, v5, v3, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput v3, p0, Lcom/android/server/wm/WindowState;->mLastFreezeDuration:I
...
.method seamlesslyRotateIfAllowed(Landroid/view/SurfaceControl$Transaction;IIZ)V
    ...
    :cond_5
    iget-object p4, p0, Lcom/android/server/wm/WindowState;->mControllableInsetProvider:Lcom/android/server/wm/InsetsSourceProvider;
    ...
    iget-object p2, p0, Lcom/android/server/wm/WindowState;->mLastSurfacePosition:Landroid/graphics/Point;
...
.method setOrientationChanging(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowState;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    invoke-virtual {p1, p0}, Lcom/android/server/wm/DisplayContent;->waitForUnfreeze(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p1, p0}, Lcom/android/server/wm/DisplayContent;->finishFadeRotationAnimation(Lcom/android/server/wm/WindowState;)V
...
.method setWindowScale(II)V
    ...
    :goto_1
    iput v0, p0, Lcom/android/server/wm/WindowState;->mHScale:F
...
.method showToCurrentUser()Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/wm/WindowManagerService;->isCurrentProfile(I)Z
...
.method transformFrameToSurfacePosition(IILandroid/graphics/Point;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/Task;->getTaskOutset()I
    ...
    iget p2, p0, Lcom/android/server/wm/WindowState;->mSurfaceTranslationY:I
...
.method updateFrameRateSelectionPriorityIfNeeded()V
    ...
    iget v2, p0, Lcom/android/server/wm/WindowState;->mAppPreferredFrameRate:F

    const/16 v3, 0x64

    const/4 v4, 0x1

    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/view/SurfaceControl$Transaction;->setFrameRate(Landroid/view/SurfaceControl;FII)Landroid/view/SurfaceControl$Transaction;
...
.method updateResizingWindowIfNeeded()V
    ...
    invoke-static {v2, v5, v4, v7, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/WindowFrames;->getInsetsChangedInfo()Ljava/lang/String;
    ...
    invoke-static {v10, v11, v12, v7, v13}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v5, v8, v4, v7, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method updateSurfacePosition(Landroid/view/SurfaceControl$Transaction;)V
    ...
    :cond_7
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mSetSurfacePositionConsumer:Ljava/util/function/Consumer;
...
.method updateTapExcludeRegion(Landroid/graphics/Region;)V
    ...
    const-string v0, "Trying to update window not attached to any display."
