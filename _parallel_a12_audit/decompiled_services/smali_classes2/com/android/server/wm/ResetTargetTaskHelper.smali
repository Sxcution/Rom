...
.method private processActivity(Lcom/android/server/wm/ActivityRecord;Z)Z
    ...
    iget-object p2, p1, Lcom/android/server/wm/ActivityRecord;->resultTo:Lcom/android/server/wm/ActivityRecord;

    if-eqz p2, :cond_4

    iget-object p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mResultActivities:Ljava/util/ArrayList;
    ...
    iget-object p2, p1, Lcom/android/server/wm/ActivityRecord;->taskAffinity:Ljava/lang/String;

    if-eqz p2, :cond_5

    iget-object p2, p1, Lcom/android/server/wm/ActivityRecord;->taskAffinity:Ljava/lang/String;

    iget-object v0, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mTask:Lcom/android/server/wm/Task;
    ...
    iget-object p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mPendingReparentActivities:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-boolean p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mForceReset:Z
    ...
    const-string p2, "clearWhenTaskReset"

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/ResetTargetTaskHelper;->finishActivities(Ljava/util/ArrayList;Ljava/lang/String;)V
    ...
    :cond_a
    iget-boolean p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mTargetTaskFound:Z

    if-eqz p2, :cond_e

    if-eqz v0, :cond_e

    iget-object p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mTargetTask:Lcom/android/server/wm/Task;

    iget-object p2, p2, Lcom/android/server/wm/Task;->affinity:Ljava/lang/String;
    ...
    :cond_b
    iget p2, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mActivityReparentPosition:I
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/wm/ResetTargetTaskHelper;->processResultActivities(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;IZZ)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/Task;->getActivityBelow(Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p2, p1, v3}, Lcom/android/server/wm/ActivityRecord;->finishIfPossible(Ljava/lang/String;Z)I
...
.method private processPendingReparentActivities()V
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/Task;->getBottomMostTask()Lcom/android/server/wm/Task;
...
.method process(Lcom/android/server/wm/Task;Z)Landroid/app/ActivityOptions;
    ...
    sget-object p2, Lcom/android/server/wm/ResetTargetTaskHelper$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/wm/ResetTargetTaskHelper$$ExternalSyntheticLambda1;
    ...
    invoke-static {p2, p0, v0}, Lcom/android/internal/util/function/pooled/PooledLambda;->obtainConsumer(Ljava/util/function/BiConsumer;Ljava/lang/Object;Lcom/android/internal/util/function/pooled/ArgumentPlaceholder;)Lcom/android/internal/util/function/pooled/PooledConsumer;

    move-result-object p2

    iget-object p1, p1, Lcom/android/server/wm/Task;->mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object p1, p1, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    const/4 v0, 0x1

    invoke-virtual {p1, p2, v0}, Lcom/android/server/wm/RootWindowContainer;->forAllLeafTasks(Ljava/util/function/Consumer;Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/ResetTargetTaskHelper;->mTopOptions:Landroid/app/ActivityOptions;
