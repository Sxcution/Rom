...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/DisplayPolicy;->mDeskDockEnablesAccelerometer:Z
    ...
    iput-object v0, p0, Lcom/android/server/wm/DisplayPolicy;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-direct {v7, p0, v0}, Lcom/android/server/wm/DisplayPolicy$PolicyHandler;-><init>(Lcom/android/server/wm/DisplayPolicy;Landroid/os/Looper;)V
    ...
    invoke-direct {v8, v4, v7, v9}, Lcom/android/server/wm/SystemGesturesPointerEventListener;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/wm/SystemGesturesPointerEventListener$Callbacks;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/server/wm/AppTransition;->registerListenerLocked(Lcom/android/server/wm/WindowManagerInternal$AppTransitionListener;)V

    iget-object v5, p2, Lcom/android/server/wm/DisplayContent;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    invoke-direct {v4, v3, v0, v5}, Lcom/android/server/wm/ImmersiveModeConfirmation;-><init>(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    new-instance v0, Lcom/android/server/wm/DisplayPolicy$SettingsObserver;

    invoke-direct {v0, p0, v7}, Lcom/android/server/wm/DisplayPolicy$SettingsObserver;-><init>(Lcom/android/server/wm/DisplayPolicy;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/wm/DisplayPolicy;->mSettingsObserver:Lcom/android/server/wm/DisplayPolicy$SettingsObserver;
    ...
    invoke-direct {p1, v7, v3, p2}, Lcom/android/internal/policy/GestureNavigationSettingsObserver;-><init>(Landroid/os/Handler;Landroid/content/Context;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p2, p1}, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda11;-><init>(Lcom/android/internal/policy/GestureNavigationSettingsObserver;)V
...
.method static synthetic access$1300(Lcom/android/server/wm/DisplayPolicy;)Lcom/android/server/wm/WindowState;
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/wm/DisplayPolicy;)Landroid/content/Context;
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/wm/DisplayPolicy;I)Lcom/android/server/wm/WindowState;
    .locals 0
...
.method private configureNavBarOpacity(IZZ)I
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/server/wm/DisplayPolicy;->isFullyTransparentAllowed(Lcom/android/server/wm/WindowState;I)Z
...
.method private getBarContentFrameForWindow(Lcom/android/server/wm/WindowState;I)Landroid/graphics/Rect;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/WindowToken;->getFixedRotationBarContentFrame(I)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-boolean p1, Landroid/view/ViewRootImpl;->INSETS_LAYOUT_GENERALIZATION:Z

    if-nez p1, :cond_1

    iget-object p1, p0, Lcom/android/server/wm/DisplayPolicy;->mBarContentFrames:Landroid/util/SparseArray;
...
.method private getNavigationBarFrameHeight(II)I
    ...
    sget-boolean p2, Landroid/view/ViewRootImpl;->INSETS_LAYOUT_GENERALIZATION:Z
...
.method private getNavigationBarHeight(II)I
    ...
    :cond_0
    invoke-virtual {p2, p1}, Lcom/android/server/wm/WindowState;->getLayoutingAttrs(I)Landroid/view/WindowManager$LayoutParams;
...
.method private getNavigationBarWidth(III)I
    ...
    iget-object v1, p2, Landroid/view/WindowManager$LayoutParams;->paramsForRotation:[Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p2, p2, Landroid/view/WindowManager$LayoutParams;->paramsForRotation:[Landroid/view/WindowManager$LayoutParams;
    ...
    iget p1, p2, Landroid/view/WindowManager$LayoutParams;->width:I

    iget-object p3, p2, Landroid/view/WindowManager$LayoutParams;->providedInternalInsets:Landroid/graphics/Insets;
...
.method private getRotatedWindowBounds(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
    ...
    :cond_1
    sget-object v0, Lcom/android/server/wm/DisplayPolicy;->sTmpDisplayFrameBounds:Landroid/graphics/Rect;

    iget v2, p1, Lcom/android/server/wm/DisplayFrames;->mDisplayWidth:I
    ...
    :goto_1
    sget-object p1, Lcom/android/server/wm/DisplayPolicy;->sTmpDisplayFrameBounds:Landroid/graphics/Rect;

    invoke-static {p3, p1, p2}, Landroid/util/RotationUtils;->rotateBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private getStatusBarAppearance(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)I
    ...
    iget-object p2, p0, Lcom/android/server/wm/DisplayPolicy;->mNotificationShade:Lcom/android/server/wm/WindowState;
    ...
    invoke-static {p2, v2}, Lcom/android/server/wm/DisplayPolicy;->isLightBarAllowed(Lcom/android/server/wm/WindowState;I)Z
...
.method private synthetic lambda$addWindowLw$10(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
    ...
    iget p1, p0, Lcom/android/server/wm/DisplayPolicy;->mLeftGestureInset:I
...
.method private layoutNavigationBar(Lcom/android/server/wm/DisplayFrames;Landroid/graphics/Rect;)I
    ...
    invoke-direct {p0, p1, v4, v1}, Lcom/android/server/wm/DisplayPolicy;->getRotatedWindowBounds(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V

    sget-object v4, Lcom/android/server/wm/DisplayPolicy;->sTmpRect:Landroid/graphics/Rect;

    iget-object v5, p1, Lcom/android/server/wm/DisplayFrames;->mUnrestricted:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v2, v0, v3}, Lcom/android/server/wm/DisplayPolicy;->getNavigationBarWidth(III)I
...
.method private requestTransientBars(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-interface {v0, p1, v2}, Lcom/android/server/wm/InsetsControlTarget;->showInsets(IZ)V
...
.method private shouldBeHiddenByKeyguard(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-interface {v0, p2}, Lcom/android/server/policy/WindowManagerPolicy;->canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
...
.method private simulateLayoutDecorWindow(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowFrames;Landroid/util/SparseArray;Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {p1, v3, v2}, Lcom/android/server/wm/WindowState;->setRequestedSize(II)V

    sget-object v2, Lcom/android/server/wm/DisplayPolicy;->sTmpDecorFrame:Landroid/graphics/Rect;

    iget v3, p2, Lcom/android/server/wm/DisplayFrames;->mDisplayWidth:I

    iget v4, p2, Lcom/android/server/wm/DisplayFrames;->mDisplayHeight:I

    const/4 v5, 0x0

    invoke-virtual {v2, v5, v5, v3, v4}, Landroid/graphics/Rect;->set(IIII)V

    invoke-virtual {p3, v2, v2}, Lcom/android/server/wm/WindowFrames;->setFrames(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    const/4 v2, 0x1

    iput-boolean v2, p3, Lcom/android/server/wm/WindowFrames;->mIsSimulatingDecorWindow:Z
    ...
    sget-boolean p5, Landroid/view/ViewRootImpl;->INSETS_LAYOUT_GENERALIZATION:Z
    ...
    iget-object p5, p1, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    iget p5, p5, Landroid/view/WindowManager$LayoutParams;->type:I

    invoke-virtual {p4, p5, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    :cond_2
    iget-object p4, p0, Lcom/android/server/wm/DisplayPolicy;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    invoke-virtual {p4}, Lcom/android/server/wm/DisplayContent;->getInsetsStateController()Lcom/android/server/wm/InsetsStateController;

    move-result-object p4

    invoke-virtual {p4, p1, p2, p3}, Lcom/android/server/wm/InsetsStateController;->computeSimulatedState(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowFrames;)V
    ...
    sget-boolean p3, Landroid/view/ViewRootImpl;->INSETS_LAYOUT_GENERALIZATION:Z
...
.method private updateSystemBarsLw(Lcom/android/server/wm/WindowState;I)I
    ...
    :goto_3
    iput-boolean v5, p0, Lcom/android/server/wm/DisplayPolicy;->mForceShowSystemBars:Z
    ...
    invoke-virtual {v5, p1}, Lcom/android/server/wm/InsetsPolicy;->updateBarControlTarget(Lcom/android/server/wm/WindowState;)V

    nop

    invoke-direct {p0, v1}, Lcom/android/server/wm/DisplayPolicy;->configureStatusBarOpacity(I)I

    move-result v1

    invoke-direct {p0, v1, v2, v0}, Lcom/android/server/wm/DisplayPolicy;->configureNavBarOpacity(IZZ)I

    move-result v0

    invoke-virtual {p1, v4}, Lcom/android/server/wm/WindowState;->getRequestedVisibility(I)Z
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/wm/InsetsPolicy;->isHidden(I)Z
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/server/wm/InsetsPolicy;->showTransient([IZ)V

    :cond_5
    iget-boolean v1, p0, Lcom/android/server/wm/DisplayPolicy;->mLastImmersiveMode:Z

    invoke-direct {p0, p1}, Lcom/android/server/wm/DisplayPolicy;->isImmersiveMode(Lcom/android/server/wm/WindowState;)Z
    ...
    :cond_6
    iget p1, p1, Lcom/android/server/wm/RootDisplayArea;->mFeatureId:I
    ...
    invoke-virtual {v1, p1, v2, v3, p2}, Lcom/android/server/wm/ImmersiveModeConfirmation;->immersiveModeChangedLw(IZZZ)V
...
.method addWindowLw(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/DisplayPolicy;)V

    sget-object v1, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda9;->INSTANCE:Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda9;

    const/4 v2, 0x1

    invoke-virtual {p2, v2, p1, v0, v1}, Lcom/android/server/wm/DisplayContent;->setInsetProvider(ILcom/android/server/wm/WindowState;Lcom/android/internal/util/function/TriConsumer;Lcom/android/internal/util/function/TriConsumer;)V

    iget-object p2, p0, Lcom/android/server/wm/DisplayPolicy;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    const/16 v0, 0x8

    new-instance v1, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda3;

    invoke-direct {v1, p0}, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/wm/DisplayPolicy;)V
    ...
    new-instance p2, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/DisplayPolicy;)V
    ...
    invoke-virtual {v2, v1, p1, p2}, Lcom/android/server/wm/DisplayContent;->setInsetProvider(ILcom/android/server/wm/WindowState;Lcom/android/internal/util/function/TriConsumer;)V
...
.method public adjustWindowParamsLw(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    const-string v1, "Illegal attributes: Main activity window that isn\'t translucent trying to fit insets: "
    ...
    iput p1, p0, Lcom/android/server/wm/DisplayPolicy;->mExtraNavBarAltPosition:I
...
.method public applyPostLayoutPolicyLw(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/DisplayPolicy;->mForceStatusBar:Z
    ...
    iget-object p3, p0, Lcom/android/server/wm/DisplayPolicy;->mStatusBarColorWindows:Ljava/util/ArrayList;
...
.method public finishPostLayoutPolicyLw()I
    ...
    invoke-interface {v4, v3}, Lcom/android/server/statusbar/StatusBarManagerInternal;->setTopAppHidesStatusBar(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowManagerService;->notifyShowingDreamChanged()V
    ...
    invoke-interface {v0, v1, v3}, Lcom/android/server/policy/WindowManagerPolicy;->setAllowLockscreenWhenOn(IZ)V
...
.method getLayoutHint(Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowToken;Landroid/view/InsetsState;Z)Z
    ...
    :goto_1
    invoke-virtual {p3, v0, p4}, Landroid/view/InsetsState;->set(Landroid/view/InsetsState;Z)V
    ...
    iget p1, p1, Lcom/android/server/wm/DisplayContent;->mCompatibleScreenScale:F
    ...
    invoke-virtual {p3, p2}, Landroid/view/InsetsState;->scale(F)V
...
.method getNonDecorDisplaySize(IIIILandroid/view/DisplayCutout;)Landroid/graphics/Point;
    ...
    :cond_1
    invoke-direct {p0, p3, p4, v0}, Lcom/android/server/wm/DisplayPolicy;->getNavigationBarWidth(III)I
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/wm/WindowState;->getLayoutingAttrs(I)Landroid/view/WindowManager$LayoutParams;

    move-result-object p3

    invoke-direct {p0, p3}, Lcom/android/server/wm/DisplayPolicy;->getAltBarPosition(Landroid/view/WindowManager$LayoutParams;)I
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/DisplayPolicy;->getAltBarWidth(I)I
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/DisplayPolicy;->getAltBarHeight(I)I
...
.method public getNonDecorInsetsLw(IIILandroid/view/DisplayCutout;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/wm/DisplayPolicy;->getNavigationBarWidth(III)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/DisplayPolicy;->getAltBarPosition(Landroid/view/WindowManager$LayoutParams;)I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/DisplayPolicy;->getAltBarHeight(I)I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/DisplayPolicy;->getAltBarWidth(I)I
...
.method isFullyTransparentAllowed(Lcom/android/server/wm/WindowState;I)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/WindowState;->isFullyTransparentBarAllowed(Landroid/graphics/Rect;)Z
...
.method public synthetic lambda$addWindowLw$2$DisplayPolicy(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
    ...
    iget p2, p0, Lcom/android/server/wm/DisplayPolicy;->mDisplayCutoutTouchableRegionSize:I
...
.method public synthetic lambda$addWindowLw$3$DisplayPolicy(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
    ...
    :cond_0
    iget p2, p1, Lcom/android/server/wm/DisplayFrames;->mDisplayWidth:I

    iget v0, p1, Lcom/android/server/wm/DisplayFrames;->mDisplayHeight:I

    iget v1, p1, Lcom/android/server/wm/DisplayFrames;->mRotation:I

    invoke-virtual {p0, p2, v0, v1}, Lcom/android/server/wm/DisplayPolicy;->navigationBarPosition(III)I
    ...
    iget-boolean p2, p0, Lcom/android/server/wm/DisplayPolicy;->mNavButtonForcedVisible:Z
    ...
    invoke-virtual {p2, v0}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
...
.method public synthetic lambda$getImeSourceFrameProvider$13$DisplayPolicy(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Lcom/android/server/wm/DisplayPolicy;->navigationBarPosition(III)I
    ...
    iget-object p2, p2, Lcom/android/server/wm/WindowState;->mGivenContentInsets:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p1, p2, Lcom/android/server/wm/WindowState;->mGivenContentInsets:Landroid/graphics/Rect;

    invoke-virtual {p3, p1}, Landroid/graphics/Rect;->inset(Landroid/graphics/Rect;)V
...
.method public synthetic lambda$simulateLayoutDisplay$14$DisplayPolicy(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/InsetsSourceProvider;Landroid/graphics/Rect;)V
    ...
    iget-object p2, p2, Lcom/android/server/wm/InsetsSourceProvider;->mWin:Lcom/android/server/wm/WindowState;

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wm/DisplayPolicy;->simulateLayoutForContentFrame(Lcom/android/server/wm/DisplayFrames;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;)V
...
.method public layoutWindowLw(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object v1, v0, Lcom/android/server/wm/DisplayPolicy;->mBarContentFrames:Landroid/util/SparseArray;
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/server/wm/DisplayPolicy;->layoutNavigationBar(Lcom/android/server/wm/DisplayFrames;Landroid/graphics/Rect;)I

    move-result v1

    iput v1, v0, Lcom/android/server/wm/DisplayPolicy;->mNavigationBarPosition:I
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/server/wm/DisplayPolicy;->layoutStatusBar(Lcom/android/server/wm/DisplayFrames;Landroid/graphics/Rect;)V
    ...
    iget-boolean v12, v8, Lcom/android/server/wm/WindowFrames;->mIsSimulatingDecorWindow:Z

    if-eqz v12, :cond_5

    sget-boolean v12, Landroid/view/ViewRootImpl;->INSETS_LAYOUT_GENERALIZATION:Z

    if-eqz v12, :cond_5

    invoke-static {v3, v15, v11, v11}, Landroid/view/ViewRootImpl;->computeWindowBounds(Landroid/view/WindowManager$LayoutParams;Landroid/view/InsetsState;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v15, v7}, Landroid/view/InsetsState;->peekSource(I)Landroid/view/InsetsSource;
    ...
    invoke-virtual {v7, v10, v12}, Landroid/view/InsetsSource;->calculateInsets(Landroid/graphics/Rect;Z)Landroid/graphics/Insets;
    ...
    :goto_6
    sget-object v13, Lcom/android/server/wm/DisplayPolicy;->sTmpDisplayCutoutSafeExceptMaybeBarsRect:Landroid/graphics/Rect;
    ...
    iget v0, v0, Lcom/android/server/wm/DisplayPolicy;->mNavigationBarPosition:I
    ...
    invoke-virtual {v10, v13}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/wm/WindowFrames;->setParentFrameWasClippedByDisplayCutout(Z)V

    :cond_13
    invoke-virtual {v11, v13}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/wm/WindowFrames;->setContentChanged(Z)V

    :cond_16
    move-object/from16 v0, p1

    invoke-virtual {v0, v2}, Lcom/android/server/wm/WindowState;->computeFrameAndUpdateSourceFrame(Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object v0, v2, Lcom/android/server/wm/DisplayFrames;->mDisplayCutoutSafe:Landroid/graphics/Rect;

    iget v0, v0, Landroid/graphics/Rect;->top:I

    iget-object v1, v2, Lcom/android/server/wm/DisplayFrames;->mUnrestricted:Landroid/graphics/Rect;
    ...
    iget-object v1, v2, Lcom/android/server/wm/DisplayFrames;->mDisplayCutoutSafe:Landroid/graphics/Rect;
...
.method public setDropInputModePolicy(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {p2, p1, v0}, Landroid/view/SurfaceControl$Transaction;->setDropInputMode(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
...
.method updateSystemBarAttributes()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/wm/DisplayPolicy;->updateSystemBarsLw(Lcom/android/server/wm/WindowState;I)I
    ...
    invoke-static {v6, v8, v9}, Lcom/android/server/wm/DisplayPolicy;->chooseNavigationColorWindowLw(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;I)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v0, v8, v6}, Lcom/android/server/wm/DisplayPolicy;->updateLightNavigationBarLw(ILcom/android/server/wm/WindowState;)I
    ...
    iget v11, v3, Landroid/view/InsetsFlags;->behavior:I
    ...
    new-array v9, v6, [Lcom/android/internal/view/AppearanceRegion;
    ...
    iget-object v12, v0, Lcom/android/server/wm/DisplayPolicy;->mStatusBarColorWindows:Ljava/util/ArrayList;
    ...
    new-instance v14, Lcom/android/internal/view/AppearanceRegion;

    invoke-direct {v0, v12, v12}, Lcom/android/server/wm/DisplayPolicy;->getStatusBarAppearance(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)I
    ...
    invoke-direct {v14, v15, v4}, Lcom/android/internal/view/AppearanceRegion;-><init>(ILandroid/graphics/Rect;)V
    ...
    :cond_9
    iget v4, v0, Lcom/android/server/wm/DisplayPolicy;->mLastDisableFlags:I
    ...
    invoke-direct {v6, v7, v2, v4}, Lcom/android/server/wm/DisplayPolicy$$ExternalSyntheticLambda16;-><init>(IILjava/lang/String;)V

    invoke-direct {v0, v6}, Lcom/android/server/wm/DisplayPolicy;->callStatusBarSafely(Ljava/util/function/Consumer;)V
    ...
    iget-object v2, v0, Lcom/android/server/wm/DisplayPolicy;->mRequestedVisibilities:Landroid/view/InsetsVisibilities;

    invoke-virtual {v1}, Lcom/android/server/wm/WindowState;->getRequestedVisibilities()Landroid/view/InsetsVisibilities;

    move-result-object v4

    invoke-virtual {v2, v4}, Landroid/view/InsetsVisibilities;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v2, v9}, Ljava/util/Arrays;->equals([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    :cond_e
    new-instance v12, Landroid/view/InsetsVisibilities;

    invoke-virtual {v1}, Lcom/android/server/wm/WindowState;->getRequestedVisibilities()Landroid/view/InsetsVisibilities;

    move-result-object v1

    invoke-direct {v12, v1}, Landroid/view/InsetsVisibilities;-><init>(Landroid/view/InsetsVisibilities;)V

    iput v8, v0, Lcom/android/server/wm/DisplayPolicy;->mLastAppearance:I

    iput v11, v0, Lcom/android/server/wm/DisplayPolicy;->mLastBehavior:I

    iput-object v12, v0, Lcom/android/server/wm/DisplayPolicy;->mRequestedVisibilities:Landroid/view/InsetsVisibilities;

    iput-object v13, v0, Lcom/android/server/wm/DisplayPolicy;->mFocusedApp:Ljava/lang/String;
