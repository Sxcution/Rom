...
.method private findRemoveIndexForAddTask(Lcom/android/server/wm/Task;)I
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/server/wm/RecentTasks;->hasCompatibleActivityTypeAndWindowingMode(Lcom/android/server/wm/Task;Lcom/android/server/wm/Task;)Z
...
.method private getRecentTasksImpl(IIZII)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v6, v1, v5, v0}, Lcom/android/server/wm/RecentTasks;->isInVisibleRange(Lcom/android/server/wm/Task;IIZ)Z
...
.method private isActiveRecentTask(Lcom/android/server/wm/Task;Landroid/util/SparseBooleanArray;)Z
    ...
    iget p1, p1, Lcom/android/server/wm/Task;->mAffiliatedTaskId:I
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/RecentTasks;->isActiveRecentTask(Lcom/android/server/wm/Task;Landroid/util/SparseBooleanArray;)Z
...
.method private notifyTaskAdded(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyTaskListUpdated()V
...
.method private trimInactiveRecentTasks()V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/wm/RecentTasks;->isActiveRecentTask(Lcom/android/server/wm/Task;Landroid/util/SparseBooleanArray;)Z
    ...
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/android/server/wm/RecentTasks;->isInVisibleRange(Lcom/android/server/wm/Task;IIZ)Z
    ...
    invoke-direct {p0, v4, v3, v2}, Lcom/android/server/wm/RecentTasks;->notifyTaskRemoved(Lcom/android/server/wm/Task;ZZ)V
...
.method add(Lcom/android/server/wm/Task;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/wm/RecentTasks;->moveAffiliatedTasksToFront(Lcom/android/server/wm/Task;I)Z
...
.method createRecentTaskInfo(Lcom/android/server/wm/Task;Z)Landroid/app/ActivityManager$RecentTaskInfo;
    ...
    iget-object v2, p1, Lcom/android/server/wm/Task;->mLastTaskSnapshotData:Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;

    invoke-virtual {p2, v2}, Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;->set(Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;)V

    iget-boolean p2, p1, Lcom/android/server/wm/Task;->mCreatedByOrganizer:Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/Task;->getChildAt(I)Lcom/android/server/wm/WindowContainer;
    ...
    invoke-virtual {v3, v4, v2, v1}, Lcom/android/server/wm/Task;->fillTaskInfo(Landroid/app/TaskInfo;ZLcom/android/server/wm/TaskDisplayArea;)V

    iget-object v3, v0, Landroid/app/ActivityManager$RecentTaskInfo;->childrenTaskInfos:Ljava/util/ArrayList;
...
.method dump(Ljava/io/PrintWriter;ZLjava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/ActivityTaskManagerService$H;->hasCallbacks(Ljava/lang/Runnable;)Z
...
.method getRecentTaskIds()Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, v5, v3, v4, v2}, Lcom/android/server/wm/RecentTasks;->isInVisibleRange(Lcom/android/server/wm/Task;IIZ)Z
...
.method notifyTaskPersisterLocked(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/TaskPersister;->wakeup(Lcom/android/server/wm/Task;Z)V
...
.method onActivityIdle(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/RecentTasks;->removeUnreachableHiddenTasks(I)V
...
.method removeAllVisibleTasks(I)V
    ...
    invoke-direct {p0, v2, v1, v1}, Lcom/android/server/wm/RecentTasks;->notifyTaskRemoved(Lcom/android/server/wm/Task;ZZ)V
...
.method resetFreezeTaskListReordering(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyTaskListFrozen(Z)V
