...
.method private printDisplayUserRotation(Ljava/io/PrintWriter;I)I
    ...
    const-string p2, "Error: check logcat for more details."
...
.method private runDisplayDensity(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {v0, v1, v3, p1}, Landroid/view/IWindowManager;->setForcedDisplayDensityForUser(III)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/view/IWindowManager;->clearForcedDisplayDensityForUser(II)V
...
.method private runDisplaySize(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {v0, v1, v3, p1}, Landroid/view/IWindowManager;->setForcedDisplaySize(III)V
...
.method private runDisplayUserRotation(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/wm/WindowManagerShellCommand;->printDisplayUserRotation(Ljava/io/PrintWriter;I)I
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/wm/WindowManagerShellCommand;->printDisplayUserRotation(Ljava/io/PrintWriter;I)I
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/wm/WindowManagerService;->thawDisplayRotation(I)V
    ...
    const-string v1, "Error: argument needs to be either -d, free or lock."
...
.method private runDumpVisibleWindowViews(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {v6, v4, v2}, Lcom/android/server/wm/WindowManagerShellCommand$$ExternalSyntheticLambda0;-><init>(ILjava/util/ArrayList;)V

    invoke-virtual {v5, v6, v0}, Lcom/android/server/wm/RootWindowContainer;->forAllWindows(Ljava/util/function/Consumer;Z)V
...
.method private runFixedToUserRotation(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/wm/WindowManagerShellCommand;->printFixedToUserRotation(Ljava/io/PrintWriter;I)I
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/wm/WindowManagerShellCommand;->printFixedToUserRotation(Ljava/io/PrintWriter;I)I
    ...
    invoke-interface {p1, v2, v3}, Landroid/view/IWindowManager;->setFixedToUserRotation(II)V
...
.method private runResetMultiWindowConfig()I
    ...
    iput v1, v0, Lcom/android/server/wm/ActivityTaskManagerService;->mRespectsActivityMinWidthHeightMultiWindow:I
...
.method private runSetBlurDisabled(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/BlurController;->getBlurEnabled()Z
    ...
    const-string v2, "Error: expected true, 1, false, 0, but got "
...
.method private runSetIgnoreOrientationRequest(Ljava/io/PrintWriter;)I
    ...
    invoke-interface {p1, v0, v3}, Landroid/view/IWindowManager;->setIgnoreOrientationRequest(IZ)V
...
.method private runSetMultiWindowConfig()I
    ...
    const-string v4, "Error: Unrecognized multi window option: "
...
.method private runSetRespectsActivityMinWidthHeightMultiWindow()I
    ...
    const-string v1, "Error: a config value of [-1, 0, 1] must be provided as an argument for respectsActivityMinWidthHeightMultiWindow"
    ...
    iput v0, v2, Lcom/android/server/wm/ActivityTaskManagerService;->mRespectsActivityMinWidthHeightMultiWindow:I
...
.method private runSetSupportsNonResizableMultiWindow()I
    ...
    const-string v1, "Error: a config value of [-1, 0, 1] must be provided as an argument for supportsNonResizableMultiWindow"
    ...
    iput v0, v2, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsNonResizableMultiWindow:I
...
.method public onCommand(Ljava/lang/String;)I
    ...
    const-string v5, "Not handled, calling status bar with args: "
    ...
    invoke-interface {v4, p1, v3}, Lcom/android/server/statusbar/StatusBarManagerInternal;->handleWindowManagerLoggingCommand([Ljava/lang/String;Landroid/os/ParcelFileDescriptor;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v4, "Failed to handle logging command: "
