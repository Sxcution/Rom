...
.method public dumpForProcesses(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ZLjava/lang/String;IZZI)Z
    ...
    invoke-static {p8}, Lcom/android/server/wm/ActivityTaskManagerService;->access$1400(Lcom/android/server/wm/ActivityTaskManagerService;)Z
    ...
    iget-object p4, p4, Lcom/android/server/wm/ActivityTaskSupervisor;->mLaunchingActivityWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public getTopActivityForTask(I)Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;
    ...
    :cond_2
    :try_start_3
    new-instance v7, Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;-><init>(Lcom/android/server/wm/ActivityTaskManagerInternal;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/IApplicationThread;Landroid/os/IBinder;)V
...
.method public handleAppCrashInActivityController(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/Watchdog;->setActivityController(Landroid/app/IActivityController;)V
...
.method public notifyKeyguardFlagsChanged(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p2, v2}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(I)V
...
.method public notifyLockedProfile(II)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/RootWindowContainer;->lockAllProfileTasks(I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public setAccessibilityServiceUids(Landroid/util/IntArray;)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/wm/ActivityTaskManagerService;->access$902(Lcom/android/server/wm/ActivityTaskManagerService;[I)[I
...
.method public shuttingDown(ZI)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityTaskSupervisor;->shutdownLocked(I)Z
...
.method public startActivitiesAsPackage(Ljava/lang/String;Ljava/lang/String;I[Landroid/content/Intent;Landroid/os/Bundle;)I
    ...
    :try_start_1
    invoke-interface {v0, p1, v7, v9}, Landroid/content/pm/IPackageManager;->getPackageUid(Ljava/lang/String;II)I
    ...
    invoke-virtual/range {v1 .. v12}, Lcom/android/server/wm/ActivityStartController;->startActivitiesInPackage(ILjava/lang/String;Ljava/lang/String;[Landroid/content/Intent;[Ljava/lang/String;Landroid/os/IBinder;Lcom/android/server/wm/SafeActivityOptions;IZLcom/android/server/am/PendingIntentRecord;Z)I
...
.method public updateTopComponentForFactoryTest()V
    ...
    new-instance v3, Lcom/android/server/wm/ActivityTaskManagerService$LocalService$$ExternalSyntheticLambda2;

    invoke-direct {v3, p0, v1}, Lcom/android/server/wm/ActivityTaskManagerService$LocalService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/ActivityTaskManagerService$LocalService;Ljava/lang/CharSequence;)V
...
.method public updateUserConfiguration()V
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/server/wm/ActivityTaskManagerService;->access$2000(Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/res/Configuration;Lcom/android/server/wm/ActivityRecord;ZZIZ)Z
...
.method public writeProcessesToProto(Landroid/util/proto/ProtoOutputStream;Ljava/lang/String;IZ)V
    ...
    invoke-static {v3, p1, p3, p4}, Lcom/android/server/wm/ActivityTaskManagerService;->access$1700(Lcom/android/server/wm/ActivityTaskManagerService;Landroid/util/proto/ProtoOutputStream;IZ)V
    ...
    invoke-virtual {p2, p1, p3, p4, v1}, Lcom/android/server/am/AppTimeTracker;->dumpDebug(Landroid/util/proto/ProtoOutputStream;JZ)V
