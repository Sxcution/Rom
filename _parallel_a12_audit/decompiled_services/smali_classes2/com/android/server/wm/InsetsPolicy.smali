...
.method private adjustVisibilityForIme(Lcom/android/server/wm/WindowState;Landroid/view/InsetsState;Z)Landroid/view/InsetsState;
    ...
    invoke-virtual {p3, v1}, Landroid/view/InsetsSource;->setVisible(Z)V
    ...
    invoke-direct {p1, v3}, Landroid/view/InsetsSource;-><init>(Landroid/view/InsetsSource;)V

    invoke-virtual {p1, v1}, Landroid/view/InsetsSource;->setVisible(Z)V
...
.method private checkAbortTransient(Lcom/android/server/wm/InsetsControlTarget;)V
    ...
    invoke-interface {p1, v1, v0}, Lcom/android/server/statusbar/StatusBarManagerInternal;->abortTransient(I[I)V
...
.method private controlAnimationUnchecked(ILandroid/util/SparseArray;ZLjava/lang/Runnable;)V
    ...
    iget-object p4, v0, Lcom/android/server/wm/InsetsPolicy$InsetsPolicyAnimationControlListener;->mControlCallbacks:Lcom/android/server/wm/InsetsPolicy$InsetsPolicyAnimationControlListener$InsetsPolicyAnimationControlCallbacks;

    invoke-static {p4, p1, p2, p3}, Lcom/android/server/wm/InsetsPolicy$InsetsPolicyAnimationControlListener$InsetsPolicyAnimationControlCallbacks;->access$400(Lcom/android/server/wm/InsetsPolicy$InsetsPolicyAnimationControlListener$InsetsPolicyAnimationControlCallbacks;ILandroid/util/SparseArray;Z)V
...
.method private getNavControlTarget(Lcom/android/server/wm/WindowState;Z)Lcom/android/server/wm/InsetsControlTarget;
    ...
    iget-object p1, p0, Lcom/android/server/wm/InsetsPolicy;->mDummyControlTarget:Lcom/android/server/wm/InsetsControlTarget;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/DisplayContent$RemoteInsetsControlTarget;->topFocusedWindowChanged(Ljava/lang/String;)V
...
.method getInsetsForWindow(Lcom/android/server/wm/WindowState;)Landroid/view/InsetsState;
    ...
    :goto_0
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/wm/InsetsPolicy;->adjustVisibilityForIme(Lcom/android/server/wm/WindowState;Landroid/view/InsetsState;Z)Landroid/view/InsetsState;
...
.method getInsetsForWindowMetrics(Landroid/view/WindowManager$LayoutParams;)Landroid/view/InsetsState;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/InsetsPolicy;->adjustVisibilityForTransientTypes(Landroid/view/InsetsState;)Landroid/view/InsetsState;
...
.method isHidden(I)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/InsetsSourceProvider;->hasWindow()Z
...
.method showTransient([IZ)V
    ...
    invoke-interface {p1, v0, v1, p2}, Lcom/android/server/statusbar/StatusBarManagerInternal;->showTransient(I[IZ)V
...
.method startAnimation(ZLjava/lang/Runnable;)V
    ...
    :cond_2
    invoke-direct {p0, v3, v0, p1, p2}, Lcom/android/server/wm/InsetsPolicy;->controlAnimationUnchecked(ILandroid/util/SparseArray;ZLjava/lang/Runnable;)V
...
.method updateBarControlTarget(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-static {p1, v1, v0}, Lcom/android/server/wm/InsetsPolicy$BarWindow;->access$300(Lcom/android/server/wm/InsetsPolicy$BarWindow;Lcom/android/server/wm/InsetsControlTarget;I)V

    iget-object p1, p0, Lcom/android/server/wm/InsetsPolicy;->mNavBar:Lcom/android/server/wm/InsetsPolicy$BarWindow;

    invoke-static {p1, v2, v6}, Lcom/android/server/wm/InsetsPolicy$BarWindow;->access$300(Lcom/android/server/wm/InsetsPolicy$BarWindow;Lcom/android/server/wm/InsetsControlTarget;I)V
