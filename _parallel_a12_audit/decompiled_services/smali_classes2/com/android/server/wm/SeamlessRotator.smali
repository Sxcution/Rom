...
.method public constructor <init>(IILandroid/view/DisplayInfo;Z)V
    ...
    iget p4, p3, Landroid/view/DisplayInfo;->rotation:I
    ...
    iget p4, p3, Landroid/view/DisplayInfo;->logicalWidth:I

    goto :goto_1

    :cond_2
    iget p4, p3, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    invoke-static {p1, p3, p4, v0}, Lcom/android/server/wm/utils/CoordinateTransforms;->transformLogicalToPhysicalCoordinates(IIILandroid/graphics/Matrix;)V

    invoke-static {p2, p3, p4, v1}, Lcom/android/server/wm/utils/CoordinateTransforms;->transformPhysicalToLogicalCoordinates(IIILandroid/graphics/Matrix;)V
...
.method finish(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/WindowContainer;)V
    ...
    invoke-virtual {p1, p2}, Landroid/view/SurfaceControl$Transaction;->unsetFixedTransformHint(Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
...
.method public unrotate(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/WindowContainer;)V
    ...
    iget v0, p0, Lcom/android/server/wm/SeamlessRotator;->mFixedTransformHint:I
