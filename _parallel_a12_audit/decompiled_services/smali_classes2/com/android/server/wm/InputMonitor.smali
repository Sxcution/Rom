...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/wm/InputMonitor$UpdateInputForAllWindowsConsumer;-><init>(Lcom/android/server/wm/InputMonitor;Lcom/android/server/wm/InputMonitor$1;)V
...
.method static populateOverlayInputInfo(Lcom/android/server/wm/InputWindowHandleWrapper;Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/InputWindowHandleWrapper;->setFocusable(Z)V

    const/4 p1, 0x2

    invoke-virtual {p0, p1}, Lcom/android/server/wm/InputWindowHandleWrapper;->setInputFeatures(I)V

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lcom/android/server/wm/InputWindowHandleWrapper;->setToken(Landroid/os/IBinder;)V

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-virtual {p0, v0}, Lcom/android/server/wm/InputWindowHandleWrapper;->setScaleFactor(F)V

    const/16 v0, 0x38

    invoke-virtual {p0, v0}, Lcom/android/server/wm/InputWindowHandleWrapper;->setLayoutParamsFlags(I)V

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Lcom/android/server/wm/InputWindowHandleWrapper;->setPortalToDisplayId(I)V

    invoke-virtual {p0}, Lcom/android/server/wm/InputWindowHandleWrapper;->clearTouchableRegion()V

    invoke-virtual {p0, p1}, Lcom/android/server/wm/InputWindowHandleWrapper;->setTouchableRegionCrop(Landroid/view/SurfaceControl;)V
...
.method private requestFocus(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0, v2, v1, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method static setTrustedOverlayInputInfo(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$Transaction;ILjava/lang/String;)V
    ...
    invoke-static {v0, p2}, Lcom/android/server/wm/InputMonitor;->populateOverlayInputInfo(Lcom/android/server/wm/InputWindowHandleWrapper;Z)V
...
.method private updateInputFocusRequest(Lcom/android/server/wm/InputConsumerImpl;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/wm/InputMonitor;->requestFocus(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3, p1}, Lcom/android/server/wm/InputMonitor;->requestFocus(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v2, p1, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method createInputConsumer(Landroid/os/IBinder;Ljava/lang/String;Landroid/view/InputChannel;ILandroid/os/UserHandle;)V
    ...
    iput-boolean p4, p1, Landroid/view/InputWindowHandle;->focusable:Z
    ...
    iput-boolean p4, p1, Landroid/view/InputWindowHandle;->hasWallpaper:Z
...
.method populateInputWindowHandle(Lcom/android/server/wm/InputWindowHandleWrapper;Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/TaskFragment;->getSurfaceControl()Landroid/view/SurfaceControl;
...
.method setFocusedAppLw(Lcom/android/server/wm/ActivityRecord;)V
    ...
    :goto_0
    invoke-virtual {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->setFocusedApplication(ILandroid/view/InputApplicationHandle;)V
