...
.method private getActionRestrictionForCallingPackage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-virtual {p1, p5, p3}, Landroid/hardware/SensorPrivacyManagerInternal;->isSensorPrivacyEnabled(II)Z
    ...
    invoke-virtual {p1, p5, p4, p2, v2}, Landroid/app/AppOpsManagerInternal;->getOpRestrictionCount(ILandroid/os/UserHandle;Ljava/lang/String;Ljava/lang/String;)I
...
.method private getComponentRestrictionForCallingPackage(Landroid/content/pm/ActivityInfo;Ljava/lang/String;Ljava/lang/String;IIZ)I
    ...
    :cond_0
    iget-object p4, p1, Landroid/content/pm/ActivityInfo;->permission:Ljava/lang/String;
...
.method private handleLaunchTaskBehindCompleteLocked(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v0, p1, v1, v1}, Lcom/android/server/wm/Task;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method private processStoppingAndFinishingActivities(Lcom/android/server/wm/ActivityRecord;ZLjava/lang/String;)V
    ...
    invoke-virtual {v7, v9, v8}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z

    move-result v8

    if-nez v8, :cond_1

    invoke-virtual {v7}, Lcom/android/server/wm/ActivityRecord;->inTransition()Z
...
.method private removeHistoryRecords(Ljava/util/ArrayList;Lcom/android/server/wm/WindowProcessController;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/ActivityRecord;->removeTimeouts()V
...
.method activityIdleInternal(Lcom/android/server/wm/ActivityRecord;ZZLandroid/content/res/Configuration;)V
    ...
    iget-object p4, p0, Lcom/android/server/wm/ActivityTaskSupervisor;->mRecentTasks:Lcom/android/server/wm/RecentTasks;

    invoke-virtual {p4, p1}, Lcom/android/server/wm/RecentTasks;->onActivityIdle(Lcom/android/server/wm/ActivityRecord;)V

    :cond_6
    iget-object p4, p0, Lcom/android/server/wm/ActivityTaskSupervisor;->mLaunchingActivityWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object p4, p0, Lcom/android/server/wm/ActivityTaskSupervisor;->mHandler:Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;

    const/16 v2, 0xcc

    invoke-virtual {p4, v2}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->removeMessages(I)V
    ...
    invoke-virtual {p4, v2, v1, v1}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V

    :cond_8
    const-string p4, "idle"

    invoke-direct {p0, p1, p3, p4}, Lcom/android/server/wm/ActivityTaskSupervisor;->processStoppingAndFinishingActivities(Lcom/android/server/wm/ActivityRecord;ZLjava/lang/String;)V
    ...
    iget-object p3, p0, Lcom/android/server/wm/ActivityTaskSupervisor;->mStartingUsers:Ljava/util/ArrayList;
    ...
    invoke-direct {p2, p0}, Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/ActivityTaskSupervisor;)V
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/wm/Task;ZZ)V
    ...
    :cond_1
    sget-object v0, Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda0;
    ...
    :cond_9
    sget-object p1, Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda4;
...
.method findTaskToMoveToFront(Lcom/android/server/wm/Task;ILandroid/app/ActivityOptions;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v7, v14}, Lcom/android/server/wm/ActivityTaskSupervisor;->canUseActivityOptionsLaunchBounds(Landroid/app/ActivityOptions;)Z
    ...
    invoke-virtual {v2, v11, v14, v0, v13}, Lcom/android/server/wm/RootWindowContainer;->getLaunchRootTask(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/Task;Z)Lcom/android/server/wm/Task;
    ...
    invoke-direct {v7, v15, v3, v6}, Lcom/android/server/wm/ActivityTaskSupervisor;->moveHomeRootTaskToFrontIfNeeded(ILcom/android/server/wm/TaskDisplayArea;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v3, v3}, Lcom/android/server/wm/Task;->resize(Landroid/graphics/Rect;ZZ)V

    goto :goto_2

    :cond_4
    invoke-virtual {v0, v3, v3}, Lcom/android/server/wm/Task;->resize(ZZ)V
    ...
    invoke-direct {v7, v15, v1, v6}, Lcom/android/server/wm/ActivityTaskSupervisor;->moveHomeRootTaskToFrontIfNeeded(ILcom/android/server/wm/TaskDisplayArea;Ljava/lang/String;)V
...
.method getReparentTargetRootTask(Lcom/android/server/wm/Task;Lcom/android/server/wm/Task;Z)Lcom/android/server/wm/Task;
    ...
    const-string p3, "Can not reparent to same root task, task="
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/wm/Task;->supportsMultiWindowInDisplayArea(Lcom/android/server/wm/TaskDisplayArea;)Z
    ...
    invoke-virtual {p1, v0, p2, p3}, Lcom/android/server/wm/TaskDisplayArea;->createRootTask(IIZ)Lcom/android/server/wm/Task;
    ...
    const-string v0, "No support to reparent to PIP, task="
...
.method handleNonResizableTaskIfNeeded(Lcom/android/server/wm/Task;ILcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {p3, p1, p2}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyActivityLaunchOnSecondaryDisplayFailed(Landroid/app/TaskInfo;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleForcedResizableTaskIfNeeded(Lcom/android/server/wm/Task;I)V
    ...
    :cond_a
    :goto_3
    iget-object p2, p1, Lcom/android/server/wm/Task;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyActivityDismissingDockedRootTask()V

    invoke-virtual {p2, p1}, Lcom/android/server/wm/TaskDisplayArea;->onSplitScreenModeDismissed(Lcom/android/server/wm/Task;)V

    iget-object p1, p2, Lcom/android/server/wm/TaskDisplayArea;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    const/4 p2, 0x0

    invoke-virtual {p1, p2, v0, v1, v1}, Lcom/android/server/wm/DisplayContent;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZZ)V
...
.method handleTopResumedStateReleased(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->removeMessages(I)V
...
.method isCallerAllowedToLaunchOnDisplay(IIILandroid/content/pm/ActivityInfo;)Z
    ...
    invoke-static {v0, v1, v5, v6, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method onUserUnlocked(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/ActivityTaskSupervisor;->scheduleStartHome(Ljava/lang/String;)V
...
.method realStartActivityLocked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/WindowProcessController;ZZ)Z
    ...
    iget-object v10, v2, Lcom/android/server/wm/ActivityRecord;->app:Lcom/android/server/wm/WindowProcessController;
    ...
    invoke-static {v13, v10}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-wide v10, v2, Lcom/android/server/wm/ActivityRecord;->lastLaunchTime:J
    ...
    iget v14, v0, Lcom/android/server/wm/Task;->mTaskId:I

    iget-object v15, v2, Lcom/android/server/wm/ActivityRecord;->shortComponentName:Ljava/lang/String;

    invoke-static {v10, v11, v14, v15}, Lcom/android/server/wm/EventLogTags;->writeWmRestartActivity(IIILjava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/Task;->getBottomMostActivity()Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-direct {v11, v10, v14}, Landroid/util/MergedConfiguration;-><init>(Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2, v7}, Lcom/android/server/wm/ActivityRecord;->getFilteredReferrer(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v12, v2, Lcom/android/server/wm/ActivityRecord;->shareableActivityToken:Landroid/os/Binder;
    ...
    invoke-static/range {v35 .. v35}, Landroid/app/servertransaction/ResumeActivityItem;->obtain(Z)Landroid/app/servertransaction/ResumeActivityItem;
    ...
    :goto_4
    invoke-virtual {v4, v0}, Landroid/app/servertransaction/ClientTransaction;->setLifecycleStateRequest(Landroid/app/servertransaction/ActivityLifecycleItem;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/wm/ClientLifecycleManager;->scheduleTransaction(Landroid/app/servertransaction/ClientTransaction;)V
    ...
    invoke-virtual {v3, v2, v4}, Lcom/android/server/wm/WindowProcessController;->removeActivity(Lcom/android/server/wm/ActivityRecord;Z)V
...
.method removeTask(Lcom/android/server/wm/Task;ZZLjava/lang/String;)V
    ...
    invoke-virtual {p2, p3, v0}, Lcom/android/server/wm/ActivityTaskManagerService;->notifyTaskPersisterLocked(Lcom/android/server/wm/Task;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method reportResumedActivityLocked(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/RootWindowContainer;->executeAppTransitionForAllDisplay()V
...
.method resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    sget-object v0, Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/wm/ActivityTaskSupervisor$$ExternalSyntheticLambda1;
...
.method restoreRecentTaskLocked(Lcom/android/server/wm/Task;Landroid/app/ActivityOptions;Z)Z
    ...
    const-string v0, "restoreRecentTaskLocked"

    invoke-virtual {p1, p2, p3, v1, v0}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/Task;IZLjava/lang/String;)V
...
.method scheduleIdleTimeout(Lcom/android/server/wm/ActivityRecord;)V
    ...
    sget v1, Lcom/android/server/wm/ActivityTaskSupervisor;->IDLE_TIMEOUT:I

    int-to-long v1, v1

    invoke-virtual {v0, p1, v1, v2}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method scheduleUpdateMultiWindowMode(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->hasMessages(I)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->sendEmptyMessage(I)Z
...
.method scheduleUpdatePictureInPictureModeIfNeeded(Lcom/android/server/wm/Task;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->hasMessages(I)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityTaskSupervisor$ActivityTaskSupervisorHandler;->sendEmptyMessage(I)Z
...
.method startActivityFromRecents(IIILcom/android/server/wm/SafeActivityOptions;)I
    ...
    invoke-static {v7, v10, v11}, Lcom/android/server/wm/ActivityTaskManagerService;->checkPermission(Ljava/lang/String;II)I
    ...
    invoke-virtual {v2, v0, v12, v8, v4}, Lcom/android/server/wm/RootWindowContainer;->anyTaskForId(IILandroid/app/ActivityOptions;Z)Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v0, v4, v10}, Lcom/android/server/wm/RootWindowContainer;->startPowerModeLaunchIfNeeded(ZLcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v0, v2, v12, v3}, Lcom/android/server/wm/ActivityStartController;->postStartActivityProcessingForLastStarter(Lcom/android/server/wm/ActivityRecord;ILcom/android/server/wm/Task;)V
    ...
    iget v0, v15, Lcom/android/server/wm/Task;->mUserId:I
...
.method updateTopResumedActivityIfNeeded()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/ActivityTaskManagerService;->updateTopApp(Lcom/android/server/wm/ActivityRecord;)V
