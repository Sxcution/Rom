...
.method private handleOccludedChanged(ILcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-interface {p1, v1}, Lcom/android/server/policy/WindowManagerPolicy;->onKeyguardOccludedChangedLw(Z)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/android/server/wm/DisplayContent;->requestTransitionAndLegacyPrepare(II)V
    ...
    :goto_2
    invoke-direct {p0, p1}, Lcom/android/server/wm/KeyguardController;->dismissMultiWindowModeForTaskIfNeeded(Lcom/android/server/wm/Task;)V
...
.method private updateKeyguardSleepToken(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/server/wm/ActivityTaskManagerInternal$SleepTokenAcquirer;->acquire(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/server/wm/ActivityTaskManagerInternal$SleepTokenAcquirer;->release(I)V
...
.method isDisplayOccluded(I)Z
    ...
    invoke-static {p1}, Lcom/android/server/wm/KeyguardController$KeyguardDisplayState;->access$300(Lcom/android/server/wm/KeyguardController$KeyguardDisplayState;)Z
...
.method isKeyguardUnoccludedOrAodShowing(I)Z
    ...
    iget-boolean p1, p0, Lcom/android/server/wm/KeyguardController;->mKeyguardGoingAway:Z
...
.method keyguardGoingAway(I)V
    ...
    invoke-virtual {v2, v3, p1}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(II)V
    ...
    invoke-virtual {v3, v4, p1, v6, v2}, Lcom/android/server/wm/TransitionController;->requestTransitionIfNeeded(IILcom/android/server/wm/WindowContainer;Lcom/android/server/wm/WindowContainer;)Lcom/android/server/wm/Transition;
    ...
    invoke-virtual {p1, v6, v5, v5}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method setKeyguardShown(ZZ)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/KeyguardController;->dismissMultiWindowModeForTaskIfNeeded(Lcom/android/server/wm/Task;)V
