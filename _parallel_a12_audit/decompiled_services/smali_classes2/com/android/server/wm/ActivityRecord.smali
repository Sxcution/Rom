...
.method private constructor <init>(Lcom/android/server/wm/ActivityTaskManagerService;Lcom/android/server/wm/WindowProcessController;IILjava/lang/String;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/wm/ActivityTaskSupervisor;Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;Landroid/os/PersistableBundle;Landroid/app/ActivityManager$TaskDescription;J)V
    ...
    invoke-virtual {v5, v2, v4, v6, v3}, Lcom/android/internal/policy/AttributeCache;->get(Ljava/lang/String;I[II)Lcom/android/internal/policy/AttributeCache$Entry;

    move-result-object v4

    if-eqz v4, :cond_b

    iget-object v5, v4, Lcom/android/internal/policy/AttributeCache$Entry;->array:Landroid/content/res/TypedArray;

    invoke-static {v5}, Landroid/content/pm/ActivityInfo;->isTranslucentOrFloating(Landroid/content/res/TypedArray;)Z
    ...
    invoke-virtual {v5, v6, v14}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    :goto_8
    iput-boolean v5, v7, Lcom/android/server/wm/ActivityRecord;->mOccludesParent:Z

    iget-object v4, v4, Lcom/android/internal/policy/AttributeCache$Entry;->array:Landroid/content/res/TypedArray;
    ...
    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->noDisplay:Z
    ...
    iput-boolean v4, v7, Lcom/android/server/wm/ActivityRecord;->mOverrideTaskTransition:Z
    ...
    invoke-virtual {v4, v2, v3, v5}, Lcom/android/server/display/color/ColorDisplayService$ColorDisplayServiceInternal;->attachColorTransformController(Ljava/lang/String;ILjava/lang/ref/WeakReference;)Z
    ...
    invoke-direct {v0, v4}, Landroid/util/MergedConfiguration;-><init>(Landroid/content/res/Configuration;)V
    ...
    const-string v4, "ActivityRecord ctor"

    invoke-virtual {v7, v0, v4}, Lcom/android/server/wm/ActivityRecord;->setState(Lcom/android/server/wm/ActivityRecord$State;Ljava/lang/String;)V

    const/4 v6, 0x0

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->launchFailed:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->stopped:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->delayedResume:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->finishing:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->deferRelaunchUntilPaused:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->keysPaused:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->inHistory:Z

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->nowVisible:Z

    const/4 v0, 0x1

    invoke-super {v7, v0}, Lcom/android/server/wm/WindowToken;->setClientVisible(Z)V

    iput-boolean v6, v7, Lcom/android/server/wm/ActivityRecord;->idle:Z
    ...
    iget v5, v7, Lcom/android/server/wm/ActivityRecord;->launchMode:I

    invoke-static {v0, v4, v5}, Lcom/android/server/wm/ActivityRecord;->computeTaskAffinity(Ljava/lang/String;II)Ljava/lang/String;
    ...
    iget-object v4, v12, Landroid/content/pm/ActivityInfo;->windowLayout:Landroid/content/pm/ActivityInfo$WindowLayout;
    ...
    iput-object v0, v4, Landroid/content/pm/ActivityInfo$WindowLayout;->windowLayoutAffinity:Ljava/lang/String;
    ...
    iget-object v4, v7, Lcom/android/server/wm/ActivityRecord;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iput-object v4, v7, Lcom/android/server/wm/ActivityRecord;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iget-object v4, v9, Lcom/android/server/wm/WindowProcessController;->mInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v1, v7, Lcom/android/server/wm/ActivityRecord;->mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method static activityResumedLocked(Landroid/os/IBinder;Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
...
.method private applyAspectRatio(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;FZ)Z
    ...
    invoke-virtual {p1, v1, v2, p4, v0}, Landroid/graphics/Rect;->set(IIII)V
...
.method private applyOptionsAnimation(Landroid/app/ActivityOptions;Landroid/content/Intent;)V
    ...
    :goto_0
    invoke-virtual {v0, v7, v2, v3}, Lcom/android/server/wm/AppTransition;->overridePendingAppTransitionMultiThumbFuture(Landroid/view/IAppTransitionAnimationSpecsFuture;Landroid/os/IRemoteCallback;Z)V
    ...
    invoke-virtual {v0, v6, v1, v2, v5}, Lcom/android/server/wm/AppTransition;->overridePendingAppTransitionMultiThumb([Landroid/view/AppTransitionAnimationSpec;Landroid/os/IRemoteCallback;Landroid/os/IRemoteCallback;Z)V
    ...
    invoke-virtual/range {v7 .. v14}, Lcom/android/server/wm/AppTransition;->overridePendingAppTransitionAspectScaledThumb(Landroid/hardware/HardwareBuffer;IIIILandroid/os/IRemoteCallback;Z)V
    ...
    invoke-static {v1, v2, v5, v3}, Landroid/window/TransitionInfo$AnimationOptions;->makeThumnbnailAnimOptions(Landroid/hardware/HardwareBuffer;IIZ)Landroid/window/TransitionInfo$AnimationOptions;
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/window/TransitionInfo$AnimationOptions;->makeCustomAnimOptions(Ljava/lang/String;IIZ)Landroid/window/TransitionInfo$AnimationOptions;
    ...
    iget-object v2, v2, Lcom/android/server/wm/ActivityRecord;->mTransitionController:Lcom/android/server/wm/TransitionController;
...
.method private applyStartingWindowTheme(Ljava/lang/String;I)V
    ...
    iget p1, p0, Lcom/android/server/wm/ActivityRecord;->windowFlags:I

    const/high16 p2, 0x100000

    or-int/2addr p1, p2

    iput p1, p0, Lcom/android/server/wm/ActivityRecord;->windowFlags:I
...
.method static canLaunchDreamActivity(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/android/server/wm/ActivityRecord;->getPackageName(Landroid/content/ComponentName;)Ljava/lang/String;
...
.method private createSnapshot(Landroid/window/TaskSnapshot;I)Z
    ...
    sget-object p2, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda19;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda19;

    invoke-virtual {p1, p2}, Lcom/android/server/wm/Task;->forAllLeafTaskFragments(Ljava/util/function/Function;)Z
...
.method static dumpActivity(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ILcom/android/server/wm/ActivityRecord;Ljava/lang/String;Ljava/lang/String;ZZZLjava/lang/String;ZLjava/lang/Runnable;Lcom/android/server/wm/Task;)Z
    ...
    iget-object p3, p3, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
...
.method private getAppCompatState(Z)I
    ...
    :cond_2
    iget-boolean p1, p0, Lcom/android/server/wm/ActivityRecord;->mIsAspectRatioApplied:Z
...
.method private getSplashscreenTheme()I
    ...
    invoke-virtual {v3, v4, v2}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;
    ...
    invoke-virtual {v3, v0, v1, v1}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
...
.method private postApplyAnimation(ZZ)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/ActivityRecord;->mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    :try_start_0
    sget-object p1, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda14;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda14;

    invoke-virtual {p0, p1, v2}, Lcom/android/server/wm/ActivityRecord;->forAllWindows(Ljava/util/function/Consumer;Z)V
    :try_end_0
...
.method private resolveFixedOrientationConfiguration(Landroid/content/res/Configuration;I)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/wm/ActivityRecord;->orientationRespectedWithInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z

    move-result v2

    invoke-virtual {p0}, Lcom/android/server/wm/ActivityRecord;->handlesOrientationChangeFromDescendant()Z
    ...
    invoke-virtual {v3, v5}, Lcom/android/server/wm/Task;->isResizeable(Z)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-virtual {p0, v5}, Lcom/android/server/wm/ActivityRecord;->isResizeable(Z)Z
    ...
    invoke-virtual {v9, v4, v6, v7, v2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v8, v4, v6, v7, v2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v9, v4, v6, v2, v7}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v8, v4, v6, v2, v7}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/wm/LetterboxUiController;->getFixedOrientationLetterboxAspectRatio(Landroid/content/res/Configuration;)F
    ...
    invoke-direct/range {v6 .. v11}, Lcom/android/server/wm/ActivityRecord;->applyAspectRatio(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;FZ)Z
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/server/wm/ActivityRecord$CompatDisplayInsets;->getBoundsByRotation(Landroid/graphics/Rect;I)V
...
.method private resolveSizeCompatModeConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {v0, v3, v6, v9}, Lcom/android/server/wm/ActivityRecord;->applyAspectRatio(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :goto_9
    iget v10, v0, Lcom/android/server/wm/ActivityRecord;->mSizeCompatScale:F
    ...
    invoke-direct {v0, v1, v5}, Lcom/android/server/wm/ActivityRecord;->isInSizeCompatModeForBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
...
.method static restoreFromXml(Landroid/util/TypedXmlPullParser;Lcom/android/server/wm/ActivityTaskSupervisor;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-static {v1, v0}, Lcom/android/server/wm/ActivityRecord$Builder;->access$500(Lcom/android/server/wm/ActivityRecord$Builder;Landroid/os/PersistableBundle;)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    invoke-static {v0, v15}, Lcom/android/server/wm/ActivityRecord$Builder;->access$600(Lcom/android/server/wm/ActivityRecord$Builder;Landroid/app/ActivityManager$TaskDescription;)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    move-wide/from16 v1, v19

    invoke-static {v0, v1, v2}, Lcom/android/server/wm/ActivityRecord$Builder;->access$700(Lcom/android/server/wm/ActivityRecord$Builder;J)Lcom/android/server/wm/ActivityRecord$Builder;
...
.method private scheduleActivityMovedToDisplay(ILandroid/content/res/Configuration;)V
    ...
    sget-object p1, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_SWITCH:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    invoke-static {p1, v0, v5, v4, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method private scheduleConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v0, v4, v3, v2, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method private setVisibleRequested(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/ActivityRecord;->setInsetsFrozen(Z)V
...
.method private shouldUseEmptySplashScreen(Lcom/android/server/wm/ActivityRecord;Z)Z
    ...
    iget-boolean p1, p1, Lcom/android/server/wm/ActivityRecord;->mSplashScreenStyleEmpty:Z
...
.method static splashScreenAttachedLocked(Landroid/os/IBinder;)V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/wm/ActivityRecord;->onSplashScreenAttachComplete()V
...
.method private transferStartingWindow(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method private validateStartingWindowTheme(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;I)Z
    ...
    iget p2, p1, Lcom/android/server/wm/ActivityRecord;->mTransferringSplashScreenState:I

    if-nez p2, :cond_7

    iget-object p2, p1, Lcom/android/server/wm/ActivityRecord;->mStartingData:Lcom/android/server/wm/StartingData;

    if-nez p2, :cond_6

    iget-object p2, p1, Lcom/android/server/wm/ActivityRecord;->mStartingWindow:Lcom/android/server/wm/WindowState;

    if-eqz p2, :cond_7

    iget-object p1, p1, Lcom/android/server/wm/ActivityRecord;->mStartingSurface:Lcom/android/server/policy/WindowManagerPolicy$StartingSurface;
...
.method activityPaused(Z)V
    ...
    invoke-virtual {p1, v3, v4, v4}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method activityStopped(Landroid/os/Bundle;Landroid/os/PersistableBundle;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->notifyTaskPersisterLocked(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-static {v1, v4, v3, p2, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p3, v1, v3, p2, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p0}, Lcom/android/server/wm/RootWindowContainer;->updatePreviousProcess(Lcom/android/server/wm/ActivityRecord;)V

    :goto_1
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    invoke-virtual {p1, v2}, Lcom/android/server/wm/ActivityTaskSupervisor;->checkReadyForSleepLocked(Z)V
...
.method addStartingWindow(Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIIILcom/android/server/wm/ActivityRecord;ZZZZZZ)Z
    ...
    iget-object v0, v7, Lcom/android/server/wm/ActivityRecord;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-static {v0, v1, v9, v4, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-object v0, v7, Lcom/android/server/wm/ActivityRecord;->mStartingData:Lcom/android/server/wm/StartingData;
...
.method addToStopping(ZZLjava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/Task;->getChildCount()I
...
.method attachCrossProfileAppsThumbnailAnimation()V
    ...
    invoke-virtual {v2, v1, v0}, Lcom/android/server/wm/AppTransition;->createCrossProfileAppsThumbnail(ILandroid/graphics/Rect;)Landroid/hardware/HardwareBuffer;
    ...
    invoke-virtual {v3, v2, v1, v4}, Lcom/android/server/wm/WindowContainerThumbnail;->startAnimation(Landroid/view/SurfaceControl$Transaction;Landroid/view/animation/Animation;Landroid/graphics/Point;)V
...
.method attachThumbnailAnimation()V
    ...
    invoke-static {v2, v3, v5, v4, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v1, v0}, Lcom/android/server/wm/WindowContainerThumbnail;->startAnimation(Landroid/view/SurfaceControl$Transaction;Landroid/view/animation/Animation;)V
...
.method checkEnterPictureInPictureState(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/ActivityRecord$State;->ordinal()I
...
.method commitVisibility(ZZZ)V
    ...
    iget-object v5, p0, Lcom/android/server/wm/ActivityRecord;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/ActivityRecord;->setVisibleRequested(Z)V
    ...
    invoke-direct {v2, v1}, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda9;-><init>(Lcom/android/server/wm/WindowManagerService;)V

    invoke-virtual {p0, v2, v4}, Lcom/android/server/wm/ActivityRecord;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/wm/ActivityRecord;->postApplyAnimation(ZZ)V
...
.method completeResumeLocked()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/Task;->getBottomMostActivity()Lcom/android/server/wm/ActivityRecord;
...
.method final deliverNewIntentLocked(ILandroid/content/Intent;Lcom/android/server/uri/NeededUriGrants;Ljava/lang/String;)V
    ...
    :goto_1
    invoke-static {p2, v5}, Landroid/app/servertransaction/NewIntentItem;->obtain(Ljava/util/List;Z)Landroid/app/servertransaction/NewIntentItem;

    move-result-object p2

    invoke-virtual {v2, v3, v4, p2}, Lcom/android/server/wm/ClientLifecycleManager;->scheduleTransaction(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/app/servertransaction/ClientTransactionItem;)V
    :try_end_0
    ...
    invoke-direct {p0, p3}, Lcom/android/server/wm/ActivityRecord;->addNewIntentLocked(Lcom/android/internal/content/ReferrerIntent;)V
...
.method destroyIfPossible(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v5, v4, v6, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method destroyImmediately(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/wm/ActivityTaskManagerService;->clearHeavyWeightProcessIfEquals(Lcom/android/server/wm/WindowProcessController;)V
    ...
    iget-object v5, p0, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
    ...
    invoke-virtual {v0, v4, v5, v6}, Lcom/android/server/wm/ClientLifecycleManager;->scheduleTransaction(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/app/servertransaction/ActivityLifecycleItem;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p1, v1, v4, v5}, Lcom/android/server/wm/ActivityTaskManagerService$H;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    invoke-static {v0, v4, v3, v1, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_9
    sget-object p1, Lcom/android/server/wm/ActivityRecord$State;->DESTROYED:Lcom/android/server/wm/ActivityRecord$State;

    const-string v0, "destroyActivityLocked. not finishing and had no app"
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    iget p3, p0, Lcom/android/server/wm/ActivityRecord;->mOrientation:I
    ...
    iget-boolean p3, p0, Lcom/android/server/wm/ActivityRecord;->paused:Z
    ...
    iget-object p3, p0, Lcom/android/server/wm/ActivityRecord;->mStartingSurface:Lcom/android/server/policy/WindowManagerPolicy$StartingSurface;
...
.method dumpDebug(Landroid/util/proto/ProtoOutputStream;I)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z
    ...
    iget-object p2, p0, Lcom/android/server/wm/ActivityRecord;->mThumbnail:Lcom/android/server/wm/WindowContainerThumbnail;
    ...
    invoke-virtual {p2}, Lcom/android/server/wm/ActivityRecord$State;->toString()Ljava/lang/String;
...
.method ensureActivityConfiguration(IZZ)Z
    ...
    invoke-direct {v0, v6}, Lcom/android/server/wm/ActivityRecord;->getConfigurationChanges(Landroid/content/res/Configuration;)I
    ...
    invoke-direct {v0, v8, v7}, Lcom/android/server/wm/ActivityRecord;->setLastReportedConfiguration(Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/server/wm/ActivityRecord;->scheduleActivityMovedToDisplay(ILandroid/content/res/Configuration;)V

    goto :goto_1

    :cond_12
    invoke-direct {v0, v7}, Lcom/android/server/wm/ActivityRecord;->scheduleConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {v0, v6, v2}, Lcom/android/server/wm/ActivityRecord;->shouldRelaunchLocked(ILandroid/content/res/Configuration;)Z
...
.method finishIfPossible(ILandroid/content/Intent;Lcom/android/server/uri/NeededUriGrants;Ljava/lang/String;Z)I
    ...
    iget-object v8, v1, Lcom/android/server/wm/ActivityRecord;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;

    invoke-virtual {v8, v0}, Lcom/android/server/wm/RootWindowContainer;->isTopDisplayFocusedRootTask(Lcom/android/server/wm/Task;)Z
    ...
    :try_start_0
    iget-object v8, v1, Lcom/android/server/wm/ActivityRecord;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;
    ...
    iget-object v12, v1, Lcom/android/server/wm/ActivityRecord;->shortComponentName:Ljava/lang/String;

    move-object/from16 v13, p4

    invoke-static {v9, v10, v11, v12, v13}, Lcom/android/server/wm/EventLogTags;->writeWmFinishActivity(IIILjava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v8, p0}, Lcom/android/server/wm/Task;->getActivityAbove(Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v8, v4}, Lcom/android/server/wm/Task;->topRunningActivity(Z)Lcom/android/server/wm/ActivityRecord;

    move-result-object v9

    if-nez v9, :cond_7

    const-string v9, "finish-top"

    invoke-virtual {v8, v9, v5, v0}, Lcom/android/server/wm/Task;->adjustFocusToNextFocusableTask(Ljava/lang/String;ZZ)Lcom/android/server/wm/Task;
    ...
    :goto_3
    iget-object v6, v1, Lcom/android/server/wm/ActivityRecord;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    :goto_4
    invoke-virtual {v6, v9}, Lcom/android/server/wm/TransitionController;->requestCloseTransitionIfNeeded(Lcom/android/server/wm/WindowContainer;)V

    sget-object v6, Lcom/android/server/wm/ActivityRecord$State;->RESUMED:Lcom/android/server/wm/ActivityRecord$State;

    invoke-virtual {p0, v6}, Lcom/android/server/wm/ActivityRecord;->isState(Lcom/android/server/wm/ActivityRecord$State;)Z
    ...
    invoke-virtual {v6, v9}, Lcom/android/server/wm/TaskChangeNotificationController;->notifyTaskRemovalStarted(Landroid/app/ActivityManager$RunningTaskInfo;)V

    :cond_a
    iget-object v6, v1, Lcom/android/server/wm/ActivityRecord;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-static {v6, v9, v5, v3, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/wm/LockTaskController;->clearLockedTask(Lcom/android/server/wm/Task;)V
    ...
    :cond_11
    invoke-virtual {v8, v5}, Lcom/android/server/wm/Task;->onlyHasTaskOverlayActivities(Z)Z

    move-result v3

    if-eqz v3, :cond_12

    sget-object v3, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda11;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda11;

    invoke-virtual {v8, v3}, Lcom/android/server/wm/Task;->forAllActivities(Ljava/util/function/Consumer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method getImeTargetBelowWindow(Lcom/android/server/wm/WindowState;)Lcom/android/server/wm/WindowState;
    ...
    sget-object v0, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda22;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda22;

    invoke-virtual {p1, v0}, Lcom/android/server/wm/WindowState;->getWindow(Ljava/util/function/Predicate;)Lcom/android/server/wm/WindowState;
...
.method getInputApplicationHandle(Z)Landroid/view/InputApplicationHandle;
    ...
    iget-wide v2, v2, Landroid/view/InputApplicationHandle;->dispatchingTimeoutMillis:J
    ...
    iget-object v0, v0, Landroid/view/InputApplicationHandle;->name:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mInputApplicationHandle:Landroid/view/InputApplicationHandle;
...
.method getOrientation(I)I
    ...
    iget p1, p0, Lcom/android/server/wm/ActivityRecord;->mOrientation:I
...
.method handleAppDied()V
    ...
    invoke-direct {v1, v0}, Lcom/android/server/wm/ActivityRecord;->transferStartingWindow(Lcom/android/server/wm/ActivityRecord;)Z
...
.method protected onAnimationFinished(ILcom/android/server/wm/AnimationAdapter;)V
    ...
    iput v0, p0, Lcom/android/server/wm/ActivityRecord;->mTransit:I

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/wm/ActivityRecord;->mTransitFlags:I

    iput-boolean v0, p0, Lcom/android/server/wm/ActivityRecord;->mNeedsAnimationBoundsLayer:Z
    ...
    iput-object v1, p0, Lcom/android/server/wm/ActivityRecord;->mThumbnail:Lcom/android/server/wm/WindowContainerThumbnail;
    ...
    sget-object v2, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda13;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda13;
    ...
    sget-object v2, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda23;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda23;

    invoke-virtual {v1, v2}, Lcom/android/server/wm/Task;->getWindow(Ljava/util/function/Predicate;)Lcom/android/server/wm/WindowState;
...
.method public onAnimationLeashLost(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mAnimationBoundsLayer:Landroid/view/SurfaceControl;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/WindowProcessController;->dispatchConfiguration(Landroid/content/res/Configuration;)V
...
.method onDisplayChanged(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/LetterboxUiController;->onMovedToDisplay(I)V
...
.method onFirstWindowDrawn(Lcom/android/server/wm/WindowState;)V
    ...
    :cond_3
    sget-object p1, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda21;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda21;

    invoke-virtual {v2, p1}, Lcom/android/server/wm/Task;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
...
.method onParentChanged(Lcom/android/server/wm/ConfigurationContainer;Lcom/android/server/wm/ConfigurationContainer;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/ActivityRecord;->shouldStartChangeTransition(Lcom/android/server/wm/TaskFragment;Lcom/android/server/wm/TaskFragment;)Z
    ...
    invoke-virtual {p1, v3, v4}, Lcom/android/server/wm/TaskFragment;->initializeChangeTransition(Landroid/graphics/Rect;Landroid/view/SurfaceControl;)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/ActivityRecord;->mAnimatingActivityRegistry:Lcom/android/server/wm/AnimatingActivityRegistry;

    if-eqz v2, :cond_9

    invoke-virtual {v2, p0}, Lcom/android/server/wm/AnimatingActivityRegistry;->notifyFinished(Lcom/android/server/wm/ActivityRecord;)V

    :cond_9
    if-eqz v1, :cond_a

    invoke-virtual {v1}, Lcom/android/server/wm/Task;->getAnimatingActivityRegistry()Lcom/android/server/wm/AnimatingActivityRegistry;
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/wm/Task;->setHasBeenVisible(Z)V
...
.method onRemovedFromDisplay()V
    ...
    iput-boolean v3, p0, Lcom/android/server/wm/ActivityRecord;->waitingToShow:Z

    const/4 v1, 0x7

    const/16 v4, 0x11

    invoke-virtual {p0, v1, v4}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z
    ...
    :cond_3
    iget-object v4, p0, Lcom/android/server/wm/ActivityRecord;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    :cond_5
    invoke-direct {p0, v3}, Lcom/android/server/wm/ActivityRecord;->setVisibleRequested(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/ActivityRecord;->getAnimation()Lcom/android/server/wm/AnimationAdapter;
    ...
    invoke-virtual {p0, v7, v0}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z
    ...
    iget-object v7, p0, Lcom/android/server/wm/ActivityRecord;->token:Landroid/os/IBinder;
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/ActivityRecord;->isEmpty()Z
    ...
    invoke-static {v8, v9, v3, v2, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method onStartingWindowDrawn()V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/ActivityRecord;->mSplashScreenStyleEmpty:Z
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/DisplayContent;->isNextTransitionForward()Z
...
.method postWindowRemoveStartingWindowCleanup(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-static {p1, v0, v3, v2, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method removeStartingWindowAnimation(Z)V
    ...
    sget-boolean p1, Lcom/android/server/wm/StartingSurfaceController;->DEBUG_ENABLE_SHELL_DRAWER:Z
...
.method reparent(Lcom/android/server/wm/TaskFragment;ILjava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/ActivityRecord;->reparent(Lcom/android/server/wm/WindowContainer;I)V
...
.method resolveOverrideConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/wm/ActivityRecord;->resolveFixedOrientationConfiguration(Landroid/content/res/Configuration;I)V
...
.method scheduleTopResumedActivityChanged(Z)Z
    ...
    invoke-static {v0, v4, v3, v1, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method setAppLayoutChanges(ILjava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/wm/ActivityRecord;->mChildren:Lcom/android/server/wm/WindowList;
...
.method setLocusId(Landroid/content/LocusId;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/Task;->dispatchTaskInfoChangedIfNeeded(Z)V
...
.method setMainWindowOpaque(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowStateAnimator;->setOpaqueLocked(Z)V
...
.method setOccludesParent(Z)Z
    ...
    invoke-virtual {p1, v2, v1, v1}, Lcom/android/server/wm/RootWindowContainer;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
...
.method setPictureInPictureParams(Landroid/app/PictureInPictureParams;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/Task;->onPictureInPictureParamsChanged()V
...
.method setProcess(Lcom/android/server/wm/WindowProcessController;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/TaskFragment;->sendTaskFragmentInfoChanged()V
...
.method setState(Lcom/android/server/wm/ActivityRecord$State;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0, v4, v2, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p2, v4}, Lcom/android/server/wm/ActivityTaskSupervisor;->onProcessActivityStateChanged(Lcom/android/server/wm/WindowProcessController;Z)V
    ...
    invoke-virtual {p1, v3, v4, v3, v4}, Lcom/android/server/wm/WindowProcessController;->updateProcessInfo(ZZZZ)V
    ...
    invoke-virtual {p1, p0, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->updateBatteryStats(Lcom/android/server/wm/ActivityRecord;Z)V

    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {p1, p0, v3}, Lcom/android/server/wm/ActivityTaskManagerService;->updateActivityUsageStats(Lcom/android/server/wm/ActivityRecord;I)V
    ...
    invoke-virtual {p1, v4, v3, v3, v3}, Lcom/android/server/wm/WindowProcessController;->updateProcessInfo(ZZZZ)V
    ...
    invoke-virtual {p1, p2, v0, v1}, Lcom/android/server/contentcapture/ContentCaptureManagerInternal;->notifyActivityEvent(ILandroid/content/ComponentName;I)V
...
.method setTaskDescription(Landroid/app/ActivityManager$TaskDescription;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/Task;->updateTaskDescription()V
...
.method setVisibility(Z)V
    ...
    iput-boolean v0, p1, Lcom/android/server/wm/ActivityTaskSupervisor;->mAppVisibilitiesChangedSinceLastPause:Z
...
.method setVisibility(ZZ)V
    ...
    iput-boolean v8, v0, Lcom/android/server/wm/ActivityRecord;->waitingToShow:Z
    ...
    sget-object v2, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda15;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda15;

    invoke-virtual {v0, v2, v8}, Lcom/android/server/wm/ActivityRecord;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    invoke-virtual {v0, v6, v2}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z
    ...
    invoke-virtual {v0, v8, v6}, Lcom/android/server/wm/ActivityRecord;->okToAnimate(ZZ)Z
...
.method shouldApplyAnimation(Z)Z
    ...
    sget-object p1, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda2;

    invoke-virtual {p0, p1, v1}, Lcom/android/server/wm/ActivityRecord;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
...
.method shouldBeVisible()Z
    ...
    :goto_1
    invoke-direct {p0, v0, v1}, Lcom/android/server/wm/ActivityRecord;->shouldBeVisible(ZZ)Z
...
.method shouldMakeActive(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {p1, p0}, Lcom/android/server/wm/Task;->hasChild(Lcom/android/server/wm/WindowContainer;)Z
...
.method showStartingWindow(Lcom/android/server/wm/ActivityRecord;ZZZLcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/server/wm/ActivityRecord;->shouldUseEmptySplashScreen(Lcom/android/server/wm/ActivityRecord;Z)Z

    move-result v2

    iput-boolean v2, v0, Lcom/android/server/wm/ActivityRecord;->mSplashScreenStyleEmpty:Z
    ...
    invoke-direct {v0, v9, v4, v5, v1}, Lcom/android/server/wm/ActivityRecord;->evaluateStartingWindowTheme(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;II)I
    ...
    new-instance v5, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda20;

    invoke-direct {v5, v0}, Lcom/android/server/wm/ActivityRecord$$ExternalSyntheticLambda20;-><init>(Lcom/android/server/wm/ActivityRecord;)V

    invoke-virtual {v1, v5}, Lcom/android/server/wm/Task;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object v7, v0, Lcom/android/server/wm/ActivityRecord;->nonLocalizedLabel:Ljava/lang/CharSequence;

    iget v8, v0, Lcom/android/server/wm/ActivityRecord;->labelRes:I

    iget v10, v0, Lcom/android/server/wm/ActivityRecord;->icon:I

    iget v11, v0, Lcom/android/server/wm/ActivityRecord;->logo:I

    iget v12, v0, Lcom/android/server/wm/ActivityRecord;->windowFlags:I
    ...
    iget-boolean v6, v0, Lcom/android/server/wm/ActivityRecord;->mSplashScreenStyleEmpty:Z
...
.method startFreezingScreen(I)V
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(I)V
    ...
    invoke-virtual {p1, v2, v3, v4}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    :cond_6
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->mChildren:Lcom/android/server/wm/WindowList;
...
.method startFreezingScreenLocked(Lcom/android/server/wm/WindowProcessController;I)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;
    ...
    invoke-static {p2, v0, v3, v1, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method stopIfPossible()V
    ...
    invoke-virtual {v1, v2, v6, v7}, Lcom/android/server/wm/ActivityTaskManagerService$H;->postDelayed(Ljava/lang/Runnable;J)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method supportsMultiWindowInDisplayArea(Lcom/android/server/wm/TaskDisplayArea;)Z
    ...
    invoke-virtual {p1, v2, v0, v3}, Lcom/android/server/wm/TaskDisplayArea;->supportsActivityMinWidthHeightMultiWindow(IILandroid/content/pm/ActivityInfo;)Z
...
.method updateDrawnWindowStates(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p0, v3, v0}, Lcom/android/server/wm/ActivityRecord;->isAnimating(II)Z
    ...
    iget-boolean p1, p1, Lcom/android/server/wm/WindowState;->mAppFreezing:Z
    ...
    invoke-virtual {p1, p0}, Lcom/android/server/wm/ActivityMetricsLogger;->notifyStartingWindowDrawn(Lcom/android/server/wm/ActivityRecord;)V
...
.method updateReportedVisibilityLocked()V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/wm/ActivityRecord;->onWindowsDrawn(J)V

    :cond_5
    iput-boolean v3, p0, Lcom/android/server/wm/ActivityRecord;->mReportedDrawn:Z
