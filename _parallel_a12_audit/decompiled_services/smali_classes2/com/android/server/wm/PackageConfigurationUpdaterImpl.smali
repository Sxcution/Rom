...
.method private updateConfig(ILjava/lang/String;)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/wm/PackageConfigurationUpdaterImpl;->mLocales:Landroid/os/LocaleList;
    ...
    invoke-static {v2, v3}, Lcom/android/server/wm/LocaleOverlayHelper;->combineLocalesIfOverlayExists(Landroid/os/LocaleList;Landroid/os/LocaleList;)Landroid/os/LocaleList;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/wm/PackageConfigurationUpdaterImpl;->mNightMode:Ljava/lang/Integer;

    invoke-virtual {v1, v3, v2}, Lcom/android/server/wm/WindowProcessController;->applyAppSpecificConfig(Ljava/lang/Integer;Landroid/os/LocaleList;)Z

    iget-object v3, p0, Lcom/android/server/wm/PackageConfigurationUpdaterImpl;->mNightMode:Ljava/lang/Integer;

    invoke-virtual {v1, v3, v2}, Lcom/android/server/wm/WindowProcessController;->updateAppSpecificSettingsForAllActivities(Ljava/lang/Integer;Landroid/os/LocaleList;)V
...
.method public commit()V
    ...
    const-string v5, "commit: Override application configuration failed: cannot find pid "
    ...
    const-string v5, "commit: update of application configuration failed: userId or packageName not valid "
    ...
    invoke-virtual {v3, v4, v5, p0}, Lcom/android/server/wm/PackageConfigPersister;->updateFromImpl(Ljava/lang/String;ILcom/android/server/wm/PackageConfigurationUpdaterImpl;)V
    :try_end_8
