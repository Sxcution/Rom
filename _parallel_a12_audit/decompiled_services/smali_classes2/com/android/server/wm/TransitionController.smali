...
.method private createTransition(II)Lcom/android/server/wm/Transition;
    ...
    invoke-static {p2, v0, v2, p1, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p2, "Simultaneous transitions not supported yet."
    ...
    const-string p2, "Shell Transitions not enabled"
...
.method finishTransition(Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/TransitionController;->setAnimationRunning(Z)V
...
.method legacyDetachNavigationBarFromApp(Landroid/os/IBinder;)V
    ...
    const-string v1, "Transition isn\'t playing: "
...
.method moveToPlaying(Lcom/android/server/wm/Transition;)V
    ...
    const-string v0, "Trying to move non-collecting transition to playing"
...
.method registerTransitionPlayer(Landroid/window/ITransitionPlayer;Landroid/app/IApplicationThread;)V
    ...
    const-string p2, "Unable to set transition player"
...
.method requestStartTransition(Lcom/android/server/wm/Transition;Lcom/android/server/wm/Task;Landroid/window/RemoteTransition;)Lcom/android/server/wm/Transition;
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/wm/TransitionController;->mTransitionPlayer:Landroid/window/ITransitionPlayer;

    new-instance v1, Landroid/window/TransitionRequestInfo;

    iget v2, p1, Lcom/android/server/wm/Transition;->mType:I

    invoke-direct {v1, v2, v0, p3}, Landroid/window/TransitionRequestInfo;-><init>(ILandroid/app/ActivityManager$RunningTaskInfo;Landroid/window/RemoteTransition;)V

    invoke-interface {p2, p1, v1}, Landroid/window/ITransitionPlayer;->requestStartTransition(Landroid/os/IBinder;Landroid/window/TransitionRequestInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p3, "TransitionController"

    const-string v0, "Error requesting transition"
...
.method requestTransitionIfNeeded(IILcom/android/server/wm/WindowContainer;Lcom/android/server/wm/WindowContainer;Landroid/window/RemoteTransition;)Lcom/android/server/wm/Transition;
    ...
    invoke-virtual {p5, p4, v0}, Lcom/android/server/wm/Transition;->setReady(Lcom/android/server/wm/WindowContainer;Z)V
    ...
    :cond_2
    invoke-virtual {p0, p2, v1, p5}, Lcom/android/server/wm/TransitionController;->requestStartTransition(Lcom/android/server/wm/Transition;Lcom/android/server/wm/Task;Landroid/window/RemoteTransition;)Lcom/android/server/wm/Transition;
...
.method setTransientLaunch(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/Transition;->addFlag(I)V
