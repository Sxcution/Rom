...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZLcom/android/server/policy/WindowManagerPolicy;Lcom/android/server/wm/ActivityTaskManagerService;Lcom/android/server/wm/DisplayWindowSettingsProvider;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Ljava/util/function/Function;)V
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mAllowBootMessages:Z

    move/from16 v1, p4

    iput-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mOnlyCore:Z
    ...
    invoke-static {v6, v1, v13}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-static {v7, v1, v15}, Lcom/android/server/wm/KeyguardDisableHandler;->create(Landroid/content/Context;Lcom/android/server/policy/WindowManagerPolicy;Landroid/os/Handler;)Lcom/android/server/wm/KeyguardDisableHandler;
    ...
    invoke-virtual {v1, v13, v2}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v1

    iput-object v1, v0, Lcom/android/server/wm/WindowManagerService;->mScreenFrozenLock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v1, v11}, Landroid/os/PowerManager$WakeLock;->setReferenceCounted(Z)V
    ...
    invoke-virtual {v1, v3, v14, v2}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V
    ...
    invoke-static {v14, v1, v11}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-direct {v1, v0, v8, v13, v2}, Lcom/android/server/wm/TaskPositioningController;-><init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/input/InputManagerService;Landroid/app/IActivityTaskManager;Landroid/os/Looper;)V
...
.method private applyForcedPropertiesForDefaultDisplay()Z
    ...
    :cond_0
    const-string v1, "ro.config.size_override"
    ...
    invoke-static {v10, v11, v12, v13, v14}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v6, "FORCED DISPLAY SCALING DISABLED"

    invoke-static {v1, v5, v3, v6, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method private createSurfaceControl(Landroid/view/SurfaceControl;ILcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;)I
    ...
    sget-boolean p3, Lcom/android/server/wm/ProtoLogCache;->WM_SHOW_TRANSACTIONS_enabled:Z
    ...
    sget-object p3, Lcom/android/internal/protolog/ProtoLogGroup;->WM_SHOW_TRANSACTIONS:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    invoke-static {p3, p4, v1, v2, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    goto :goto_0

    :cond_1
    sget-boolean p4, Lcom/android/server/wm/ProtoLogCache;->WM_ERROR_enabled:Z
    ...
    const-string p3, "Failed to create surface control for %s"

    invoke-static {p4, v2, v1, p3, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method private doDump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;Z)V
    ...
    new-instance p3, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda12;

    invoke-direct {p3, p2}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda12;-><init>(Ljava/io/PrintWriter;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowManagerService;->mConstants:Lcom/android/server/wm/WindowManagerConstants;

    invoke-virtual {p1, p2}, Lcom/android/server/wm/WindowManagerConstants;->dump(Ljava/io/PrintWriter;)V
...
.method private dumpWindows(Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZ)Z
    ...
    new-instance v3, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda15;

    invoke-direct {v3, p2, p4, p3}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda15;-><init>(ZZLjava/util/ArrayList;)V
...
.method private dumpWindowsNoHeaderLocked(Ljava/io/PrintWriter;ZLjava/util/ArrayList;)V
    ...
    new-instance v0, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda5;

    invoke-direct {v0, p1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda5;-><init>(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p3, p1}, Lcom/android/server/wm/RootWindowContainer;->dumpDefaultMinSizeOfResizableTask(Ljava/io/PrintWriter;)V

    iget-object p3, p0, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    new-instance v0, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda11;

    invoke-direct {v0, p1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda11;-><init>(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p2, p1, v3}, Lcom/android/server/wm/RecentsAnimationController;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method private getDisplayContentOrCreate(ILandroid/os/IBinder;)Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/RootWindowContainer;->getDisplayContentOrCreate(I)Lcom/android/server/wm/DisplayContent;
...
.method private getInsetsSourceControls(Lcom/android/server/wm/WindowState;[Landroid/view/InsetsSourceControl;)V
    ...
    invoke-virtual {v2, v3}, Landroid/view/InsetsSourceControl;->setParcelableFlags(I)V
...
.method static synthetic lambda$dumpWindowsNoHeaderLocked$9(Ljava/io/PrintWriter;Lcom/android/server/wm/DisplayContent;)V
    ...
    const-string v4, "  imeLayeringTarget in display# "
...
.method private onPointerDownOutsideFocusLocked(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/EmbeddedWindowController;->getHostWindow(Landroid/os/IBinder;)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowState;->canReceiveKeys(Z)Z
    ...
    invoke-virtual {v2, v3, v1, p1}, Lcom/android/server/wm/WindowContainer;->positionChildAt(ILcom/android/server/wm/WindowContainer;Z)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/wm/WindowManagerService;->handleTaskFocusChange(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;)V
...
.method private performEnableScreen()V
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/wm/RootWindowContainer;->getChildAt(I)Lcom/android/server/wm/WindowContainer;
    ...
    invoke-static {v1, v2, v4, v3, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v7, v8, v4, v9, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v1, v7, v4, v8, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->e(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method private prepareWindowReplacementTransition(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {v2, v1, v0}, Landroid/view/InsetsState;->calculateVisibleInsets(Landroid/graphics/Rect;I)Landroid/graphics/Insets;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Lcom/android/server/wm/AppTransition;->overridePendingAppTransitionClipReveal(IIII)V
...
.method private static queryHdrSupport()Z
    ...
    invoke-interface {v1}, Landroid/hardware/configstore/V1_1/ISurfaceFlingerConfigs;->hasHDRDisplay()Landroid/hardware/configstore/V1_0/OptionalBool;
...
.method private static queryPrimaryDisplayOrientation()I
    ...
    invoke-virtual {v0}, Landroid/sysprop/SurfaceFlingerProperties$primary_display_orientation_values;->ordinal()I
    ...
    iget-boolean v1, v0, Landroid/hardware/configstore/V1_1/OptionalDisplayOrientation;->specified:Z
...
.method private static queryWideColorGamutSupport()Z
    ...
    invoke-interface {v1}, Landroid/hardware/configstore/V1_1/ISurfaceFlingerConfigs;->hasWideColorDisplay()Landroid/hardware/configstore/V1_0/OptionalBool;
...
.method private sanitizeFlagSlippery(ILjava/lang/String;II)I
    ...
    const-string p4, "Removing FLAG_SLIPPERY from \'"
...
.method private setGlobalShadowSettings()V
    ...
    invoke-static {v11, v5, v4, v6, v8}, Landroid/view/SurfaceControl;->setGlobalShadowSettings([F[FFFF)V
...
.method private showStrictModeViolation(II)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowManagerService;->mTransaction:Landroid/view/SurfaceControl$Transaction;
...
.method private tryStartExitingAnimation(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;Z)Z
    ...
    :cond_2
    iget-object p2, p1, Lcom/android/server/wm/WindowState;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual {p1, v1, p2}, Lcom/android/server/wm/WindowState;->isAnimating(II)Z
    ...
    invoke-virtual {p2, p1, v0}, Lcom/android/server/wm/AccessibilityController;->onWindowTransition(Lcom/android/server/wm/WindowState;I)V
...
.method private unprivilegedAppCanCreateTokenWith(Lcom/android/server/wm/WindowState;IIILandroid/os/IBinder;Ljava/lang/String;)Z
    ...
    const-string p1, "Attempted to add application window with unknown token %s.  Aborting."

    invoke-static {p2, p3, v1, p1, p4}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p1, "Attempted to add input method window with unknown token %s.  Aborting."
    ...
    const-string p1, "Attempted to add voice interaction window with unknown token %s.  Aborting."
    ...
    const-string p1, "Attempted to add wallpaper window with unknown token %s.  Aborting."
    ...
    const-string p1, "Attempted to add QS dialog window with unknown token %s.  Aborting."
    ...
    const-string p1, "Attempted to add Accessibility overlay window with unknown token %s.  Aborting."
    ...
    const-string p1, "Attempted to add a toast window with unknown token %s.  Aborting."
...
.method private updateInputChannel(Landroid/os/IBinder;IIILandroid/view/SurfaceControl;Ljava/lang/String;Landroid/view/InputApplicationHandle;IIILandroid/graphics/Region;Landroid/view/IWindow;)V
    ...
    invoke-direct {p0, p8, p6, p2, p3}, Lcom/android/server/wm/WindowManagerService;->sanitizeFlagSlippery(ILjava/lang/String;II)I
    ...
    iput-boolean p6, v0, Landroid/view/InputWindowHandle;->hasWallpaper:Z

    iput-boolean p6, v0, Landroid/view/InputWindowHandle;->paused:Z

    iput p2, v0, Landroid/view/InputWindowHandle;->ownerUid:I

    iput p3, v0, Landroid/view/InputWindowHandle;->ownerPid:I

    iput p6, v0, Landroid/view/InputWindowHandle;->inputFeatures:I

    if-nez p11, :cond_1

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Landroid/view/InputWindowHandle;->replaceTouchableRegionWithCrop(Landroid/view/SurfaceControl;)V
    ...
    iput-boolean p6, v0, Landroid/view/InputWindowHandle;->replaceTouchableRegionWithCrop:Z
    ...
    :goto_2
    iput-boolean p4, v0, Landroid/view/InputWindowHandle;->trustedOverlay:Z
    ...
    invoke-virtual {p1, p5, v0}, Landroid/view/SurfaceControl$Transaction;->setInputWindowInfo(Landroid/view/SurfaceControl;Landroid/view/InputWindowHandle;)Landroid/view/SurfaceControl$Transaction;
...
.method private waitForAnimationsToComplete()V
    ...
    sget-object v6, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda20;->INSTANCE:Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda20;

    invoke-virtual {v5, v6}, Lcom/android/server/wm/RootWindowContainer;->forAllActivities(Ljava/util/function/Function;)Z
    ...
    invoke-virtual {v1, v8, v7}, Lcom/android/server/wm/RootWindowContainer;->getAnimatingContainer(II)Lcom/android/server/wm/WindowContainer;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    invoke-virtual {v2}, Lcom/android/server/wm/WindowAnimator;->isAnimationScheduled()Z
...
.method public addShellRoot(ILandroid/view/IWindow;I)Landroid/view/SurfaceControl;
    ...
    :cond_0
    :try_start_2
    invoke-virtual {p1, p2, p3}, Lcom/android/server/wm/DisplayContent;->addShellRoot(Landroid/view/IWindow;I)Landroid/view/SurfaceControl;
    ...
    const-string p2, "Must hold permission android.permission.MANAGE_APP_TOKENS"
...
.method public addWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/view/WindowManager$LayoutParams;IIILandroid/view/InsetsVisibilities;Landroid/view/InputChannel;Landroid/view/InsetsState;[Landroid/view/InsetsSourceControl;)I
    ...
    invoke-direct {v0, v1, v10}, Lcom/android/server/wm/WindowManagerService;->getDisplayContentOrCreate(ILandroid/os/IBinder;)Lcom/android/server/wm/DisplayContent;
    ...
    invoke-static {v0, v1, v3, v2, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v2, v5, v9}, Lcom/android/server/wm/WindowManagerService;->doesAddToastWindowRequireToken(Ljava/lang/String;ILcom/android/server/wm/WindowState;)Z
    ...
    const-string v4, "Non-null activity for system window of rootType=%d"
    ...
    invoke-static {v3, v6, v12, v4, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_c
    new-instance v3, Lcom/android/server/wm/WindowState;

    const/16 v19, 0x0

    aget v20, v21, v19

    iget v2, v8, Lcom/android/server/wm/Session;->mUid:I

    iget-boolean v1, v8, Lcom/android/server/wm/Session;->mCanAddInternalSystemWindow:Z
    ...
    :cond_3d
    :try_start_18
    invoke-virtual/range {p4 .. p4}, Lcom/android/server/wm/DisplayContent;->getDisplayPolicy()Lcom/android/server/wm/DisplayPolicy;
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lcom/android/server/wm/WindowManagerService;->sanitizeFlagSlippery(ILjava/lang/String;II)I
    ...
    :try_start_19
    iget v5, v13, Landroid/view/WindowManager$LayoutParams;->inputFeatures:I
    ...
    invoke-virtual {v15, v3}, Lcom/android/server/wm/WindowState;->openInputChannel(Landroid/view/InputChannel;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/server/wm/DisplayContent;->canAddToastWindowForUid(I)Z
    ...
    iget-object v8, v5, Lcom/android/server/wm/DisplayContent;->mCurrentFocus:Lcom/android/server/wm/WindowState;

    if-eqz v8, :cond_43

    iget-object v8, v5, Lcom/android/server/wm/DisplayContent;->mCurrentFocus:Lcom/android/server/wm/WindowState;

    iget v8, v8, Lcom/android/server/wm/WindowState;->mOwnerUid:I
    ...
    invoke-virtual {v8, v9, v15}, Lcom/android/server/wm/WindowManagerService$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v9

    iget-object v10, v15, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    iget-wide v10, v10, Landroid/view/WindowManager$LayoutParams;->hideTimeoutMilliseconds:J
    ...
    iget-object v8, v0, Lcom/android/server/wm/WindowManagerService;->mWindowContextListenerController:Lcom/android/server/wm/WindowContextListenerController;

    move-object/from16 v10, v20

    invoke-virtual {v8, v10}, Lcom/android/server/wm/WindowContextListenerController;->hasListener(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {v8, v10}, Lcom/android/server/wm/WindowContextListenerController;->getWindowType(Landroid/os/IBinder;)I
    ...
    const-string v12, "Window types in WindowContext and LayoutParams.type should match! Type from LayoutParams is %d, but type from WindowContext is %d"
    ...
    const v6, 0x4aa91377    # 5540283.5f

    invoke-static {v4, v6, v9, v12, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_f
    invoke-static/range {v19 .. v19}, Landroid/window/WindowProviderService;->isWindowProviderService(Landroid/os/Bundle;)Z
    ...
    iget-object v7, v5, Lcom/android/server/wm/DisplayContent;->mWinAddedSinceNullFocus:Ljava/util/ArrayList;
    ...
    :cond_4d
    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->attach()V
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->initAppOpsState()V

    iget-object v7, v0, Lcom/android/server/wm/WindowManagerService;->mPmInternal:Landroid/content/pm/PackageManagerInternal;

    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->getOwningPackage()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->getOwningUid()I
    ...
    invoke-virtual {v7, v12, v14}, Landroid/content/pm/PackageManagerInternal;->isPackageSuspended(Ljava/lang/String;I)Z

    move-result v7

    invoke-virtual {v6, v7}, Lcom/android/server/wm/WindowState;->setHiddenWhileSuspended(Z)V

    iget-object v7, v0, Lcom/android/server/wm/WindowManagerService;->mHidingNonSystemOverlayWindows:Ljava/util/ArrayList;
    ...
    :goto_12
    invoke-virtual {v6, v7}, Lcom/android/server/wm/WindowState;->setForceHideNonSystemOverlayWindowIfNeeded(Z)V

    nop

    iget-object v7, v6, Lcom/android/server/wm/WindowState;->mToken:Lcom/android/server/wm/WindowToken;

    invoke-virtual {v7, v6}, Lcom/android/server/wm/WindowToken;->addWindow(Lcom/android/server/wm/WindowState;)V

    invoke-virtual {v1, v6, v13}, Lcom/android/server/wm/DisplayPolicy;->addWindowLw(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V

    iget-object v7, v6, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    invoke-virtual {v1, v6, v7}, Lcom/android/server/wm/DisplayPolicy;->setDropInputModePolicy(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {v12, v6}, Lcom/android/server/wm/ActivityRecord;->attachStartingWindow(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-static {v14, v15, v11, v8, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_53
    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->hasWallpaper()Z
    ...
    invoke-virtual {v3, v6}, Lcom/android/server/wm/WallpaperController;->isBelowWallpaperTarget(Lcom/android/server/wm/WindowState;)Z
    ...
    iput-boolean v10, v7, Lcom/android/server/wm/WindowStateAnimator;->mEnterAnimationPending:Z

    iput-boolean v10, v7, Lcom/android/server/wm/WindowStateAnimator;->mEnteringAnimation:Z

    iget-object v7, v6, Lcom/android/server/wm/WindowState;->mTransitionController:Lcom/android/server/wm/TransitionController;
    ...
    invoke-direct {v0, v12}, Lcom/android/server/wm/WindowManagerService;->prepareWindowReplacementTransition(Lcom/android/server/wm/ActivityRecord;)Z

    move-result v7

    if-nez v7, :cond_56

    invoke-direct {v0, v12}, Lcom/android/server/wm/WindowManagerService;->prepareNoneTransitionForRelaunching(Lcom/android/server/wm/ActivityRecord;)V

    :cond_56
    iget-object v7, v6, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->isClientLocal()Z
    ...
    invoke-virtual {v1, v7, v14, v13, v12}, Lcom/android/server/wm/DisplayPolicy;->getLayoutHint(Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowToken;Landroid/view/InsetsState;Z)Z
    ...
    invoke-virtual {v0, v10, v11}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
    ...
    :cond_5d
    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->getParent()Lcom/android/server/wm/WindowContainer;
    ...
    invoke-virtual {v1, v3, v11}, Lcom/android/server/wm/InputMonitor;->setInputFocusLw(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-virtual {v1, v11}, Lcom/android/server/wm/InputMonitor;->updateInputWindowsLw(Z)V
    ...
    invoke-static {v9, v12, v11, v8, v13}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_5f
    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->isVisibleRequestedOrAdding()Z
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/DisplayContent;->sendNewConfiguration()V

    :cond_60
    invoke-virtual {v5}, Lcom/android/server/wm/DisplayContent;->getInsetsStateController()Lcom/android/server/wm/InsetsStateController;

    move-result-object v1

    invoke-virtual {v1, v6, v11}, Lcom/android/server/wm/InsetsStateController;->updateAboveInsetsState(Lcom/android/server/wm/WindowState;Z)V

    move-object/from16 v1, p10

    invoke-direct {v0, v6, v1}, Lcom/android/server/wm/WindowManagerService;->getInsetsSourceControls(Lcom/android/server/wm/WindowState;[Landroid/view/InsetsSourceControl;)V
...
.method public addWindowToken(Landroid/os/IBinder;IILandroid/os/Bundle;)V
    ...
    invoke-static {p4, v4, v5, v6, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v7, "addWindowToken: Attempted to add binder token: %s for already created window token: %s displayId=%d"
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/wm/WindowToken$Builder;->setPersistOnEmpty(Z)Lcom/android/server/wm/WindowToken$Builder;

    move-result-object p1

    invoke-virtual {p1, v3}, Lcom/android/server/wm/WindowToken$Builder;->setOwnerCanManageAppTokens(Z)Lcom/android/server/wm/WindowToken$Builder;

    move-result-object p1

    invoke-virtual {p1, p4}, Lcom/android/server/wm/WindowToken$Builder;->setOptions(Landroid/os/Bundle;)Lcom/android/server/wm/WindowToken$Builder;
...
.method public attachToDisplayContent(Landroid/os/IBinder;I)Landroid/content/res/Configuration;
    ...
    :cond_0
    :try_start_2
    new-instance p1, Landroid/view/WindowManager$InvalidDisplayException;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "attachToDisplayContent: trying to attach to a non-existing display:"
    ...
    invoke-direct {p1, p2}, Landroid/view/WindowManager$InvalidDisplayException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/DisplayContent;->getConfiguration()Landroid/content/res/Configuration;
    ...
    const-string p2, "clientToken must not be null!"
...
.method public attachWindowContextToDisplayArea(Landroid/os/IBinder;IILandroid/os/Bundle;)Landroid/content/res/Configuration;
    ...
    const-string v1, "attachWindowContextToDisplayArea"
    ...
    const-string v0, "attachWindowContextToDisplayArea: trying to attach to a non-existing display:%d"
    ...
    invoke-static {p3, p4, v3, v0, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v3, p2, p4, v0, v2}, Lcom/android/server/wm/DisplayContent;->findAreaForWindowType(ILandroid/os/Bundle;ZZ)Lcom/android/server/wm/DisplayArea;
    ...
    invoke-virtual {p3}, Lcom/android/server/wm/DisplayArea;->getConfiguration()Landroid/content/res/Configuration;
...
.method public attachWindowContextToWindowToken(Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    const-string v3, "Then token:%s is invalid. It might be removed"
    ...
    invoke-static {p2, v0, v2, v3, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v2, "The WindowToken\'s type should match the created WindowContext\'s type. WindowToken\'s type is "
    ...
    const-string v2, ", while WindowContext\'s is "
    ...
    const-string v2, "The clientToken:"
...
.method checkCallingPermission(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p3, v1, v7, p1, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public createInputConsumer(Landroid/os/IBinder;Ljava/lang/String;ILandroid/view/InputChannel;)V
    ...
    const-string p2, "createInputConsumer requires INPUT_CONSUMER permission"
...
.method public destroyInputConsumer(Ljava/lang/String;I)Z
    ...
    const-string p2, "destroyInputConsumer requires INPUT_CONSUMER permission"
...
.method dumpDebugLocked(Landroid/util/proto/ProtoOutputStream;I)V
    ...
    iget-boolean p2, p0, Lcom/android/server/wm/WindowManagerService;->mHardKeyboardAvailable:Z
...
.method finishDrawingWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/view/SurfaceControl$Transaction;)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/server/wm/WindowState;->finishDrawing(Landroid/view/SurfaceControl$Transaction;)Z
...
.method generateDisplayHash(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/graphics/Rect;Ljava/lang/String;Landroid/os/RemoteCallback;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/WindowManagerService;->mDisplayHashController:Lcom/android/server/wm/DisplayHashController;

    invoke-virtual {p1, p5, v2}, Lcom/android/server/wm/DisplayHashController;->sendDisplayHashError(Landroid/os/RemoteCallback;I)V
    ...
    invoke-virtual {p1, p5, v3}, Lcom/android/server/wm/DisplayHashController;->sendDisplayHashError(Landroid/os/RemoteCallback;I)V
...
.method public getDisplayImePolicy(I)I
    ...
    const-string v4, "Attempted to get IME policy of a display that does not exist: %d"
    ...
    invoke-static {p1, v0, v1, v4, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method getDisplayUserRotation(I)I
    ...
    const-string v1, "Trying to get user rotation of a missing display."
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayRotation;->getUserRotation()I
...
.method getFixedToUserRotation(I)I
    ...
    const-string v1, "Trying to get fixed to user rotation for a missing display."
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayRotation;->getFixedToUserRotationMode()I
...
.method getIgnoreOrientationRequest(I)Z
    ...
    const-string v1, "Trying to getIgnoreOrientationRequest() for a missing display."
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->getIgnoreOrientationRequest()Z
...
.method public getNavBarPosition(I)I
    ...
    invoke-virtual {p1, v2, v3, v1}, Lcom/android/server/wm/DisplayPolicy;->navigationBarPosition(III)I
...
.method public getRemoveContentMode(I)I
    ...
    invoke-static {p1, v1, v6, v5, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public getWindowInsets(Landroid/view/WindowManager$LayoutParams;ILandroid/view/InsetsState;)Z
    ...
    invoke-virtual {v4, p2}, Lcom/android/server/wm/DisplayContent;->getWindowToken(Landroid/os/IBinder;)Lcom/android/server/wm/WindowToken;
    ...
    invoke-virtual {v4, p1, p2, p3, v0}, Lcom/android/server/wm/DisplayPolicy;->getLayoutHint(Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowToken;Landroid/view/InsetsState;Z)Z
...
.method grantEmbeddedWindowFocus(Lcom/android/server/wm/Session;Landroid/os/IBinder;Z)V
    ...
    const-string p2, "Embedded window not found"
    ...
    const-string v1, "Window not in session:"
    ...
    const-string p2, "Focus token found but input channel token not found"
    ...
    iget v6, p2, Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;->mDisplayId:I
    ...
    invoke-virtual {v1, v4, v2, v6}, Landroid/view/SurfaceControl$Transaction;->setFocusedWindow(Landroid/os/IBinder;Ljava/lang/String;I)Landroid/view/SurfaceControl$Transaction;
    ...
    :cond_4
    invoke-virtual {v2}, Lcom/android/server/wm/DisplayContent;->findFocusedWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-static {p2, p3, v10, v8, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_6
    :try_start_4
    iget-object v2, v11, Lcom/android/server/wm/WindowState;->mInputChannelToken:Landroid/os/IBinder;

    invoke-virtual {v11}, Lcom/android/server/wm/WindowState;->getName()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/view/SurfaceControl$Transaction;->requestFocusTransfer(Landroid/os/IBinder;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;I)Landroid/view/SurfaceControl$Transaction;
    ...
    const-string v2, "reason=grantEmbeddedWindowFocus(false)"
    ...
    sget-object p3, Lcom/android/internal/protolog/ProtoLogGroup;->WM_DEBUG_FOCUS:Lcom/android/internal/protolog/ProtoLogGroup;
    ...
    invoke-static {p3, v1, v10, v8, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method grantEmbeddedWindowFocus(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/os/IBinder;Z)V
    ...
    const-string p2, "Host window not found"
    ...
    const-string p2, "Host window does not have an input channel"
    ...
    const-string p2, "Embedded window does not belong to the host"
    ...
    :cond_3
    :try_start_4
    iget-object p3, p0, Lcom/android/server/wm/WindowManagerService;->mTransactionFactory:Ljava/util/function/Supplier;
    ...
    invoke-static {p3, v2}, Landroid/util/EventLog;->writeEvent(I[Ljava/lang/Object;)I
    ...
    invoke-static {p3, p4, v1, v2, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method grantInputChannel(Lcom/android/server/wm/Session;IIILandroid/view/SurfaceControl;Landroid/view/IWindow;Landroid/os/IBinder;IIILandroid/os/IBinder;Landroid/view/InputChannel;)V
    ...
    new-instance v12, Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;
    ...
    invoke-virtual {v12}, Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;->openInputChannel()Landroid/view/InputChannel;
    ...
    invoke-virtual {v1, v2, v12}, Lcom/android/server/wm/EmbeddedWindowController;->add(Landroid/os/IBinder;Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;)V

    invoke-virtual {v12}, Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;->getApplicationHandle()Landroid/view/InputApplicationHandle;

    move-result-object v8

    invoke-virtual {v12}, Lcom/android/server/wm/EmbeddedWindowController$EmbeddedWindow;->toString()Ljava/lang/String;
...
.method handleTaskFocusChange(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/ActivityTaskManagerService;->setFocusedTask(ILcom/android/server/wm/ActivityRecord;)V
...
.method public hideTransientBars(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/InsetsPolicy;->hideTransient()V
    ...
    const-string v3, "hideTransientBars with invalid displayId="
    ...
    const-string v0, "Requires STATUS_BAR permission"
...
.method initializeRecentsAnimation(ILandroid/view/IRecentsAnimationRunner;Lcom/android/server/wm/RecentsAnimationController$RecentsAnimationCallbacks;ILandroid/util/SparseBooleanArray;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p2, p1, p5, p6}, Lcom/android/server/wm/RecentsAnimationController;->initialize(ILandroid/util/SparseBooleanArray;Lcom/android/server/wm/ActivityRecord;)V
...
.method public isDisplayRotationFrozen(I)Z
    ...
    const-string v1, "Trying to check if rotation is frozen on a missing display."
...
.method public isLayerTracing()Z
    ...
    invoke-interface {v4, v6, v3, v5, v2}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v6, "Failed to get layer tracing"
...
.method isValidPictureInPictureAspectRatio(Lcom/android/server/wm/DisplayContent;F)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/PinnedTaskController;->isValidPictureInPictureAspectRatio(F)Z
...
.method public mirrorDisplay(ILandroid/view/SurfaceControl;)Z
    ...
    invoke-static {p1}, Landroid/view/SurfaceControl;->mirrorSurface(Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl;

    move-result-object p1

    const-string v0, "WMS.mirrorDisplay"

    invoke-virtual {p2, p1, v0}, Landroid/view/SurfaceControl;->copyFrom(Landroid/view/SurfaceControl;Ljava/lang/String;)V
    ...
    const-string p2, "Requires READ_FRAME_BUFFER permission"
...
.method public mirrorWallpaperSurface(I)Landroid/view/SurfaceControl;
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WallpaperController;->mirrorWallpaperSurface()Landroid/view/SurfaceControl;
...
.method public moveWindowTokenToDisplay(Landroid/os/IBinder;I)V
    ...
    const-string v7, "moveWindowTokenToDisplay: Attempted to move token: %s to non-exiting displayId=%d"
    ...
    invoke-static {p2, v1, v6, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/RootWindowContainer;->getWindowToken(Landroid/os/IBinder;)Lcom/android/server/wm/WindowToken;
    ...
    const-string v4, "moveWindowTokenToDisplay: Attempted to move non-existing token: %s"

    new-array v2, v2, [Ljava/lang/Object;

    aput-object p1, v2, v3

    invoke-static {p2, v1, v3, v4, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v4, "moveWindowTokenToDisplay: Cannot move to the original display for token: %s"
    ...
    :cond_5
    :try_start_3
    invoke-virtual {v1, p2}, Lcom/android/server/wm/DisplayContent;->reParentWindowToken(Lcom/android/server/wm/WindowToken;)V
...
.method public onRectangleOnScreenRequested(Landroid/os/IBinder;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/server/wm/AccessibilityController;->onRectangleOnScreenRequested(ILandroid/graphics/Rect;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string p2, "Window Manager Crash %s"

    invoke-static {p3, p4, v1, p2, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->wtf(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public overridePendingAppTransitionRemote(Landroid/view/RemoteAnimationAdapter;I)V
    ...
    invoke-virtual {p1, p2, v2}, Landroid/view/RemoteAnimationAdapter;->setCallingPidUid(II)V
...
.method postWindowRemoveCleanupLocked(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-static {v8, v9, v3, v1, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-boolean v3, v5, Lcom/android/server/wm/ActivityRecord;->firstWindowDrawn:Z
    ...
    iget-object v1, v1, Lcom/android/server/wm/Task;->mExitingActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, p1}, Lcom/android/server/wm/ActivityRecord;->postWindowRemoveStartingWindowCleanup(Lcom/android/server/wm/WindowState;)V
...
.method public refreshScreenCaptureDisabled(I)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/RootWindowContainer;->setSecureSurfaceState(I)V
...
.method public registerPinnedTaskListener(ILandroid/view/IPinnedTaskListener;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/PinnedTaskController;->registerPinnedTaskListener(Landroid/view/IPinnedTaskListener;)V
...
.method public relayoutWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/view/WindowManager$LayoutParams;IIIIJLandroid/window/ClientWindowFrames;Landroid/util/MergedConfiguration;Landroid/view/SurfaceControl;Landroid/view/InsetsState;[Landroid/view/InsetsSourceControl;Landroid/graphics/Point;)I
    ...
    invoke-virtual {v0, v12, v13, v11}, Lcom/android/server/wm/WindowManagerService;->windowForClientLocked(Lcom/android/server/wm/Session;Landroid/view/IWindow;Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v12, v11, v13}, Lcom/android/server/wm/WindowState;->setRequestedSize(II)V
    ...
    invoke-virtual {v15, v12, v1}, Lcom/android/server/wm/DisplayPolicy;->adjustWindowParamsLw(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V

    iget-object v9, v12, Lcom/android/server/wm/WindowState;->mToken:Lcom/android/server/wm/WindowToken;

    invoke-virtual {v9, v12, v1}, Lcom/android/server/wm/WindowToken;->adjustWindowParams(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-direct {v0, v9, v11, v7, v6}, Lcom/android/server/wm/WindowManagerService;->sanitizeFlagSlippery(ILjava/lang/String;II)I
    ...
    :cond_2
    iput v9, v12, Lcom/android/server/wm/WindowState;->mDisableFlags:I
    ...
    iget-object v6, v6, Landroid/view/WindowManager$LayoutParams;->providesInsetsTypes:[I

    iget-object v9, v1, Landroid/view/WindowManager$LayoutParams;->providesInsetsTypes:[I
    ...
    iget-object v9, v12, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v11, v12, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    invoke-virtual {v11, v1}, Landroid/view/WindowManager$LayoutParams;->copyFrom(Landroid/view/WindowManager$LayoutParams;)I

    move-result v11

    and-int/lit16 v13, v11, 0x4001

    if-eqz v13, :cond_3

    iput-boolean v8, v12, Lcom/android/server/wm/WindowState;->mLayoutNeeded:Z

    :cond_3
    iget-object v13, v12, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v13}, Lcom/android/server/wm/ActivityRecord;->checkKeyguardFlagsChanged()V
    ...
    invoke-virtual {v13}, Lcom/android/server/wm/AccessibilityController;->hasCallbacks()Z
    ...
    invoke-virtual {v13, v7, v6}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMovedWithCallingUid(I[I)V
    ...
    :goto_1
    invoke-virtual {v5, v6}, Lcom/android/server/wm/WindowStateAnimator;->setColorSpaceAgnosticLocked(Z)V
    ...
    iput v1, v5, Lcom/android/server/wm/WindowStateAnimator;->mAlpha:F

    :cond_e
    iget v1, v12, Lcom/android/server/wm/WindowState;->mRequestedWidth:I

    iget v7, v12, Lcom/android/server/wm/WindowState;->mRequestedHeight:I

    invoke-virtual {v12, v1, v7}, Lcom/android/server/wm/WindowState;->setWindowScale(II)V
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/wm/WindowStateAnimator;->setOpaqueLocked(Z)V

    :cond_10
    iget v1, v12, Lcom/android/server/wm/WindowState;->mViewVisibility:I
    ...
    :goto_5
    iget v11, v12, Lcom/android/server/wm/WindowState;->mViewVisibility:I
    ...
    iget-boolean v11, v12, Lcom/android/server/wm/WindowState;->mRelayoutCalled:Z
    ...
    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->hasWallpaper()Z
    ...
    iget-object v6, v5, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceController:Lcom/android/server/wm/WindowSurfaceController;
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/wm/WindowSurfaceController;->setSecure(Z)V

    :cond_19
    iput-boolean v8, v12, Lcom/android/server/wm/WindowState;->mRelayoutCalled:Z

    iput-boolean v8, v12, Lcom/android/server/wm/WindowState;->mInRelayout:Z

    invoke-virtual {v12, v2}, Lcom/android/server/wm/WindowState;->setViewVisibility(I)V

    sget-boolean v6, Lcom/android/server/wm/ProtoLogCache;->WM_DEBUG_SCREEN_ON_enabled:Z
    ...
    invoke-direct/range {v19 .. v19}, Ljava/lang/RuntimeException;-><init>()V
    ...
    invoke-static {v4, v6, v7, v8, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_b
    iput-boolean v3, v12, Lcom/android/server/wm/WindowState;->mGivenInsetsPending:Z

    if-nez v2, :cond_1d

    iget-object v3, v12, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    iget-boolean v4, v12, Lcom/android/server/wm/WindowState;->mAnimatingExit:Z

    if-nez v4, :cond_20

    nop

    iget-boolean v4, v12, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z

    if-nez v4, :cond_1f

    if-eqz v13, :cond_1e

    iget-object v4, v14, Lcom/android/server/wm/DisplayContent;->mWallpaperController:Lcom/android/server/wm/WallpaperController;

    invoke-virtual {v4}, Lcom/android/server/wm/WallpaperController;->adjustWallpaperWindows()V

    :cond_1e
    invoke-direct {v0, v12, v5, v11}, Lcom/android/server/wm/WindowManagerService;->tryStartExitingAnimation(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;Z)Z
    ...
    :try_start_3
    invoke-direct {v0, v6, v4, v12, v5}, Lcom/android/server/wm/WindowManagerService;->createSurfaceControl(Landroid/view/SurfaceControl;ILcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;)I
    ...
    const-string v6, "Exception thrown when creating surface for client %s (%s). %s"
    ...
    const-string v9, "relayoutWindow: viewVisibility_1"

    invoke-static {v7, v8, v9}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    invoke-virtual {v12, v4}, Lcom/android/server/wm/WindowState;->relayoutVisibleWindow(I)I
    ...
    iget-object v9, v14, Lcom/android/server/wm/DisplayContent;->mInputMethodWindow:Lcom/android/server/wm/WindowState;
    ...
    :cond_25
    const-string v9, "relayoutWindow: viewVisibility_2"

    invoke-static {v7, v8, v9}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    const/4 v9, 0x0

    iput-boolean v9, v5, Lcom/android/server/wm/WindowStateAnimator;->mEnterAnimationPending:Z

    iput-boolean v9, v5, Lcom/android/server/wm/WindowStateAnimator;->mEnteringAnimation:Z
    ...
    const-string v9, "relayoutWindow: getSurface"

    invoke-static {v7, v8, v9}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    iget-object v9, v5, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceController:Lcom/android/server/wm/WindowSurfaceController;

    invoke-virtual {v9, v6}, Lcom/android/server/wm/WindowSurfaceController;->getSurfaceControl(Landroid/view/SurfaceControl;)V
    ...
    const-string v10, "wmReleaseOutSurface_"
    ...
    invoke-virtual {v0, v15, v10}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
    ...
    invoke-virtual {v14, v9}, Lcom/android/server/wm/DisplayContent;->computeImeTarget(Z)Lcom/android/server/wm/WindowState;

    if-eqz v10, :cond_29

    const/4 v9, 0x0

    invoke-virtual {v14, v9}, Lcom/android/server/wm/DisplayContent;->assignWindowLayers(Z)V

    :cond_29
    if-eqz v13, :cond_2a

    iget v9, v14, Lcom/android/server/wm/DisplayContent;->pendingLayoutChanges:I

    const/4 v13, 0x4

    or-int/2addr v9, v13

    iput v9, v14, Lcom/android/server/wm/DisplayContent;->pendingLayoutChanges:I

    :cond_2a
    iget-object v9, v12, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;

    if-eqz v9, :cond_2b

    iget-object v9, v14, Lcom/android/server/wm/DisplayContent;->mUnknownAppVisibilityController:Lcom/android/server/wm/UnknownAppVisibilityController;

    iget-object v13, v12, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {v9, v13}, Lcom/android/server/wm/UnknownAppVisibilityController;->notifyRelayouted(Lcom/android/server/wm/ActivityRecord;)V

    :cond_2b
    const-string v9, "relayoutWindow: updateOrientation"

    invoke-static {v7, v8, v9}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    invoke-virtual {v14}, Lcom/android/server/wm/DisplayContent;->updateOrientation()Z

    move-result v9

    invoke-static {v7, v8}, Landroid/os/Trace;->traceEnd(J)V

    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->getDisplayInfo()Landroid/view/DisplayInfo;

    move-result-object v13

    iget v15, v13, Landroid/view/DisplayInfo;->rotation:I

    iget-object v7, v13, Landroid/view/DisplayInfo;->address:Landroid/view/DisplayAddress;

    if-eqz v7, :cond_2c

    iget-object v7, v13, Landroid/view/DisplayInfo;->address:Landroid/view/DisplayAddress;

    iget-object v8, v0, Lcom/android/server/wm/WindowManagerService;->mPrimaryDisplayPhysicalAddress:Landroid/view/DisplayAddress;
    ...
    iget v8, v0, Lcom/android/server/wm/WindowManagerService;->mPrimaryDisplayOrientation:I
    ...
    invoke-static {v15}, Landroid/view/SurfaceControl;->rotationToBufferTransform(I)I

    move-result v8

    invoke-virtual {v6, v8}, Landroid/view/SurfaceControl;->setTransformHint(I)V
    ...
    const-string v15, " on primary display with orientation "

    invoke-virtual {v7, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v15, v0, Lcom/android/server/wm/WindowManagerService;->mPrimaryDisplayOrientation:I
    ...
    invoke-static {v15, v6, v5, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-boolean v5, v12, Lcom/android/server/wm/WindowState;->mIsWallpaper:Z

    if-eqz v5, :cond_30

    iget-object v5, v14, Lcom/android/server/wm/DisplayContent;->mWallpaperController:Lcom/android/server/wm/WallpaperController;

    const/4 v6, 0x0

    invoke-virtual {v5, v12, v6}, Lcom/android/server/wm/WallpaperController;->updateWallpaperOffset(Lcom/android/server/wm/WindowState;Z)Z

    :cond_30
    iget-object v5, v12, Lcom/android/server/wm/WindowState;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_31
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/DisplayPolicy;->areSystemBarsForcedShownLw()Z
    ...
    :cond_32
    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->isGoneForLayout()Z
    ...
    iput-boolean v5, v12, Lcom/android/server/wm/WindowState;->mResizedWhileGone:Z
    ...
    invoke-virtual {v12, v6, v7, v5, v3}, Lcom/android/server/wm/WindowState;->fillClientWindowFramesAndConfiguration(Landroid/window/ClientWindowFrames;Landroid/util/MergedConfiguration;ZZ)V

    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->onResizeHandled()V

    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->getCompatInsetsState()Landroid/view/InsetsState;
    ...
    invoke-virtual {v6, v3, v5}, Landroid/view/InsetsState;->set(Landroid/view/InsetsState;Z)V
    ...
    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->prepareDrawHandlers()V

    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->markRedrawForSyncReported()V
    ...
    const-string v2, "relayoutWindow: postNewConfigurationToHandler"

    const-wide/16 v4, 0x20

    invoke-static {v4, v5, v2}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V

    invoke-virtual {v14}, Lcom/android/server/wm/DisplayContent;->sendNewConfiguration()V
    ...
    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->getWindowConfiguration()Landroid/app/WindowConfiguration;
    ...
    invoke-virtual {v12, v2}, Lcom/android/server/wm/WindowState;->getLayoutingAttrs(I)Landroid/view/WindowManager$LayoutParams;

    move-result-object v2

    iget-object v4, v0, Lcom/android/server/wm/WindowManagerService;->mTmpRect:Landroid/graphics/Rect;

    invoke-virtual {v12, v2, v4}, Lcom/android/server/wm/WindowState;->calculateSurfaceBounds(Landroid/view/WindowManager$LayoutParams;Landroid/graphics/Rect;)V

    iget-object v2, v0, Lcom/android/server/wm/WindowManagerService;->mTmpRect:Landroid/graphics/Rect;
    ...
    invoke-virtual {v5, v2, v4}, Landroid/graphics/Point;->set(II)V

    :cond_38
    move-object/from16 v2, p14

    invoke-direct {v0, v12, v2}, Lcom/android/server/wm/WindowManagerService;->getInsetsSourceControls(Lcom/android/server/wm/WindowState;[Landroid/view/InsetsSourceControl;)V
...
.method removeWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;)V
    ...
    :cond_0
    :try_start_1
    iget-object p1, p0, Lcom/android/server/wm/WindowManagerService;->mEmbeddedWindowController:Lcom/android/server/wm/EmbeddedWindowController;

    invoke-virtual {p1, p2}, Lcom/android/server/wm/EmbeddedWindowController;->remove(Landroid/view/IWindow;)V
...
.method removeWindowToken(Landroid/os/IBinder;ZZI)V
    ...
    const-string v5, "removeWindowToken: Attempted to remove token: %s for non-exiting displayId=%d"
    ...
    invoke-static {p4, v1, v4, v5, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p4, "removeWindowToken: Attempted to remove non-existing token: %s"

    new-array v1, v3, [Ljava/lang/Object;

    aput-object p1, v1, v2

    invoke-static {p2, p3, v2, p4, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method reportFocusChanged(Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    const-string p2, "Unknown focus tokens, dropping reportFocusChanged"
    ...
    iget-object p2, v6, Lcom/android/server/wm/WindowState;->mInputChannelToken:Landroid/os/IBinder;
...
.method public requestAssistScreenshot(Landroid/app/IAssistDataReceiver;)Z
    ...
    new-instance v2, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda1;

    invoke-direct {v2, p1, v1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda1;-><init>(Landroid/app/IAssistDataReceiver;Landroid/graphics/Bitmap;)V
...
.method public requestScrollCapture(ILandroid/os/IBinder;ILandroid/view/IScrollCaptureResponseListener;)V
    ...
    const v7, 0x269025b8    # 1.0002231E-15f

    const-string v8, "Invalid displayId for requestScrollCapture: %d"
    ...
    invoke-static {v6, v7, v2, v8, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->e(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_0
    const-string p2, "bad displayId: %d"
    ...
    invoke-virtual {v4, p1}, Landroid/view/ScrollCaptureResponse$Builder;->setDescription(Ljava/lang/String;)Landroid/view/ScrollCaptureResponse$Builder;

    invoke-virtual {v4}, Landroid/view/ScrollCaptureResponse$Builder;->build()Landroid/view/ScrollCaptureResponse;

    move-result-object p1

    invoke-interface {p4, p1}, Landroid/view/IScrollCaptureResponseListener;->onScrollCaptureResponse(Landroid/view/ScrollCaptureResponse;)V
    ...
    const-string p1, "findScrollCaptureTargetWindow returned null"
    ...
    invoke-interface {p2, p4}, Landroid/view/IWindow;->requestScrollCapture(Landroid/view/IScrollCaptureResponseListener;)V
    :try_end_3
    ...
    const-string v8, "requestScrollCapture: caught exception dispatching to window.token=%s"

    new-array v9, v2, [Ljava/lang/Object;

    aput-object p3, v9, v3

    invoke-static {v6, v7, v3, v8, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, p3}, Landroid/view/ScrollCaptureResponse$Builder;->setWindowTitle(Ljava/lang/String;)Landroid/view/ScrollCaptureResponse$Builder;

    invoke-virtual {p1}, Lcom/android/server/wm/WindowState;->getOwningPackage()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Landroid/view/ScrollCaptureResponse$Builder;->setPackageName(Ljava/lang/String;)Landroid/view/ScrollCaptureResponse$Builder;

    const-string p1, "caught exception: %s"
    ...
    const-string p4, "requestScrollCapture: caught exception dispatching callback: %s"

    new-array v2, v2, [Ljava/lang/Object;

    aput-object p1, v2, v3

    invoke-static {p2, p3, v3, p4, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    :try_end_8
...
.method restorePointerIconLocked(Lcom/android/server/wm/DisplayContent;FF)V
    ...
    const-string v1, "unable to restore pointer icon"

    invoke-static {p1, p2, p3, v1, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method saveANRStateLocked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/ActivityRecord;->stringName:Ljava/lang/String;
...
.method scheduleClearWillReplaceWindows(Landroid/os/IBinder;Z)V
    ...
    const-string p1, "Attempted to reset replacing window on non-existing app token %s"

    invoke-static {p2, v0, v2, p1, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public setCurrentUser(I[I)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/RootWindowContainer;->switchUser(I)V
    ...
    new-instance v2, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda8;

    invoke-direct {v2, p1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda8;-><init>(I)V
...
.method public setDisplayImePolicy(II)V
    ...
    const-string v5, "Attempted to set IME policy to a display that does not exist: %d"
    ...
    invoke-static {v3, v4, v6, v5, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v3, p2}, Lcom/android/server/wm/DisplayWindowSettings;->setDisplayImePolicy(Lcom/android/server/wm/DisplayContent;I)V
    ...
    const-string v4, "Attempted to set IME policy to an untrusted virtual display: "
...
.method public setDisplayWindowInsetsController(ILandroid/view/IDisplayWindowInsetsController;)V
    ...
    :cond_0
    :try_start_2
    invoke-virtual {p1, p2}, Lcom/android/server/wm/DisplayContent;->setRemoteInsetsController(Landroid/view/IDisplayWindowInsetsController;)V
...
.method public setFixedToUserRotation(II)V
    ...
    const-string p2, "Trying to set fixed to user rotation for a missing display."
...
.method public setIgnoreOrientationRequest(IZ)V
    ...
    const-string p2, "Trying to setIgnoreOrientationRequest() for a missing display."
    ...
    :cond_0
    :try_start_2
    invoke-virtual {p1, p2}, Lcom/android/server/wm/DisplayContent;->setIgnoreOrientationRequest(Z)Z
...
.method setInsetsWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Region;)V
    ...
    invoke-virtual {p2, v0, p3}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMovedWithCallingUid(I[I)V
...
.method public setLayerTracing(Z)V
    ...
    invoke-interface {v3, p1, v4, v2, v5}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v3, "Failed to set layer tracing"
...
.method public setLayerTracingFlags(I)V
    ...
    const-string v3, "Failed to set layer tracing flags"
...
.method public setRemoveContentMode(II)V
    ...
    const-string v5, "Attempted to set remove mode to a display that does not exist: %d"
    ...
    invoke-virtual {p1, v3, p2}, Lcom/android/server/wm/DisplayWindowSettings;->setRemoveContentModeLocked(Lcom/android/server/wm/DisplayContent;I)V
...
.method setSandboxDisplayApis(IZ)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/DisplayContent;->setSandboxDisplayApis(Z)V
...
.method public setShellRootAccessibilityWindow(IILandroid/view/IWindow;)V
    ...
    :cond_1
    :try_start_3
    invoke-virtual {p1, p3}, Lcom/android/server/wm/ShellRoot;->setAccessibilityWindow(Landroid/view/IWindow;)V
...
.method public setShouldShowSystemDecors(IZ)V
    ...
    const-string v5, "Attempted to set system decors flag to a display that does not exist: %d"
    ...
    invoke-virtual {p1, v3, p2}, Lcom/android/server/wm/DisplayWindowSettings;->setShouldShowSystemDecorsLocked(Lcom/android/server/wm/DisplayContent;Z)V
...
.method public setShouldShowWithInsecureKeyguard(IZ)V
    ...
    const-string v5, "Attempted to set flag to a display that does not exist: %d"
    ...
    invoke-virtual {p1, v3, p2}, Lcom/android/server/wm/DisplayWindowSettings;->setShouldShowWithInsecureKeyguardLocked(Lcom/android/server/wm/DisplayContent;Z)V
...
.method setWillReplaceWindow(Landroid/os/IBinder;Z)V
    ...
    const-string p1, "Attempted to set replacing window on non-existing app token %s"
    ...
    const-string p1, "Attempted to set replacing window on app token with no content %s"
...
.method setWillReplaceWindows(Landroid/os/IBinder;Z)V
    ...
    const-string v4, "Attempted to set replacing window on non-existing app token %s"
    ...
    const-string v4, "Attempted to set replacing window on app token with no content %s"
...
.method setWindowOpaqueLocked(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/wm/ActivityRecord;->setMainWindowOpaque(Z)V
...
.method public setWindowingMode(II)V
    ...
    const-string v5, "Attempted to set windowing mode to a display that does not exist: %d"
    ...
    invoke-virtual {v4, v3, p2}, Lcom/android/server/wm/DisplayWindowSettings;->setWindowingModeLocked(Lcom/android/server/wm/DisplayContent;I)V
...
.method shouldRestoreImeVisibility(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {p0, v2, p1, v1, v1}, Lcom/android/server/wm/WindowManagerService;->getTaskSnapshot(IIZZ)Landroid/window/TaskSnapshot;
...
.method public shouldShowWithInsecureKeyguard(I)Z
    ...
    const-string v5, "Attempted to get flag of a display that does not exist: %d"
...
.method public startViewServer(I)Z
    ...
    invoke-static {p1, v4, v1, v3, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method stopFreezingDisplayLocked()V
    ...
    invoke-static {v3, v4, v2, v9, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v3, v0, Lcom/android/server/wm/WindowManagerService;->mInputManagerCallback:Lcom/android/server/wm/InputManagerCallback;

    invoke-virtual {v3}, Lcom/android/server/wm/InputManagerCallback;->thawInputDispatchingLw()V
    ...
    const-string v4, "Screen frozen for "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, v0, Lcom/android/server/wm/WindowManagerService;->mLastDisplayFreezeDuration:I

    int-to-long v4, v4

    invoke-static {v4, v5, v3}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V

    iget-object v4, v0, Lcom/android/server/wm/WindowManagerService;->mLastFinishedFreezeSource:Ljava/lang/Object;
    ...
    invoke-static {v4, v5, v2, v3, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v4, v5, v2, v9, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget v10, v0, Lcom/android/server/wm/WindowManagerService;->mExitAnimId:I

    iget v11, v0, Lcom/android/server/wm/WindowManagerService;->mEnterAnimId:I

    invoke-virtual {v5, v10, v11, v2}, Lcom/android/server/wm/DisplayRotation;->validateRotationAnimation(IIZ)Z
    ...
    iget v5, v0, Lcom/android/server/wm/WindowManagerService;->mExitAnimId:I
    ...
    invoke-virtual {v4, v5, v10, v11}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-virtual {v1, v6}, Lcom/android/server/wm/ActivityTaskManagerService;->endLaunchPowerMode(I)V
    ...
    invoke-static {v1, v0, v3, v9, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public syncInputTransactions(Z)V
    ...
    new-instance v4, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda9;

    invoke-direct {v4, p1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda9;-><init>(Landroid/view/SurfaceControl$Transaction;)V
...
.method updateDisplayContentLocation(Landroid/view/IWindow;III)V
    ...
    const-string p4, "Bad requesting window %s"
    ...
    invoke-static {p2, p3, v4, p4, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public updateDisplayWindowRequestedVisibilities(ILandroid/view/InsetsVisibilities;)V
    ...
    iget-object v3, p1, Lcom/android/server/wm/DisplayContent;->mRemoteInsetsControlTarget:Lcom/android/server/wm/DisplayContent$RemoteInsetsControlTarget;
    ...
    invoke-virtual {v3, p2}, Lcom/android/server/wm/DisplayContent$RemoteInsetsControlTarget;->setRequestedVisibilities(Landroid/view/InsetsVisibilities;)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/wm/InsetsStateController;->onInsetsModified(Lcom/android/server/wm/InsetsControlTarget;)V
...
.method updateNonSystemOverlayWindowsVisibilityIfNeeded(Lcom/android/server/wm/WindowState;Z)V
    ...
    new-instance v0, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda14;

    invoke-direct {v0, p1}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda14;-><init>(Z)V
...
.method updatePointerIcon(Landroid/view/IWindow;)V
    ...
    const-string v2, "Bad requesting window %s"
    ...
    invoke-static {v0, v1, v4, v2, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v5, v1, p1}, Landroid/view/IWindow;->updatePointerIcon(FF)V
    :try_end_5
    .catch Landroid/os/RemoteException; {:try_start_5 .. :try_end_5} :catch_0
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
    ...
    const-string v2, "unable to update pointer icon"

    check-cast v0, [Ljava/lang/Object;

    invoke-static {p1, v1, v4, v2, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public updateStaticPrivacyIndicatorBounds(I[Landroid/graphics/Rect;)V
    ...
    const-string v2, "updateStaticPrivacyIndicatorBounds with invalid displayId="
...
.method updateTapExcludeRegion(Landroid/view/IWindow;Landroid/graphics/Region;)V
    ...
    const-string v3, "Bad requesting window %s"
    ...
    invoke-static {p2, v1, v2, v3, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method viewServerListWindows(Ljava/net/Socket;)Z
    ...
    invoke-direct {v4, v0}, Lcom/android/server/wm/WindowManagerService$$ExternalSyntheticLambda13;-><init>(Ljava/util/ArrayList;)V
...
.method viewServerWindowCommand(Ljava/net/Socket;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v7, "Could not send command %s with parameters %s. %s"
    ...
    invoke-static {v4, v6, v1, v7, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    :try_end_5
...
.method final windowForClientLocked(Lcom/android/server/wm/Session;Landroid/os/IBinder;Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-static {p3, v4, v8, v3, v0}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
