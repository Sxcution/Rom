...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p2, p1, v0, p3}, Lcom/android/internal/policy/TransitionAnimation;-><init>(Landroid/content/Context;ZLjava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/wm/AppTransition;->mDecelerateInterpolator:Landroid/view/animation/Interpolator;

    new-instance p2, Lcom/android/server/wm/AppTransition$1;

    invoke-direct {p2, p0}, Lcom/android/server/wm/AppTransition$1;-><init>(Lcom/android/server/wm/AppTransition;)V

    iput-object p2, p0, Lcom/android/server/wm/AppTransition;->mThumbnailFadeInInterpolator:Landroid/view/animation/Interpolator;

    new-instance p2, Lcom/android/server/wm/AppTransition$2;

    invoke-direct {p2, p0}, Lcom/android/server/wm/AppTransition$2;-><init>(Lcom/android/server/wm/AppTransition;)V

    iput-object p2, p0, Lcom/android/server/wm/AppTransition;->mThumbnailFadeOutInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput p2, p0, Lcom/android/server/wm/AppTransition;->mClipRevealTranslationY:I
    ...
    iput-boolean p2, p0, Lcom/android/server/wm/AppTransition;->mLowRamRecentsEnabled:Z
...
.method private createAspectScaledThumbnailFreeformAnimationLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)Landroid/view/animation/AnimationSet;
    ...
    invoke-direct {p0, v7}, Lcom/android/server/wm/AppTransition;->setAppTransitionFinishedCallbackIfNeeded(Landroid/view/animation/Animation;)V
...
.method createThumbnailScaleAnimationLocked(IIILandroid/hardware/HardwareBuffer;)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p4}, Landroid/hardware/HardwareBuffer;->getWidth()I
    ...
    :goto_0
    invoke-virtual {p4}, Landroid/hardware/HardwareBuffer;->getHeight()I
    ...
    invoke-static {v0, v2}, Lcom/android/internal/policy/TransitionAnimation;->computePivot(IF)F
    ...
    invoke-static {v0, v1}, Lcom/android/internal/policy/TransitionAnimation;->computePivot(IF)F
    ...
    :goto_2
    invoke-virtual {p0, v1, p1, p2, p3}, Lcom/android/server/wm/AppTransition;->prepareThumbnailAnimation(Landroid/view/animation/Animation;III)Landroid/view/animation/Animation;
...
.method getAppTransitionThumbnailHeader(Lcom/android/server/wm/WindowContainer;)Landroid/hardware/HardwareBuffer;
    ...
    iget-object p1, p1, Landroid/view/AppTransitionAnimationSpec;->buffer:Landroid/hardware/HardwareBuffer;
...
.method getNextAppTransitionStartRect(Lcom/android/server/wm/WindowContainer;Landroid/graphics/Rect;)V
    ...
    const-string v1, "Starting rect for container: "
...
.method goodToGo(ILcom/android/server/wm/ActivityRecord;)I
    ...
    invoke-direct/range {v2 .. v10}, Lcom/android/server/wm/AppTransition;->notifyAppTransitionStartingLocked(ZZJJJ)I
    ...
    invoke-direct {p1, v3}, Lcom/android/server/wm/NavBarFadeAnimationController;-><init>(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {p1, v3, v4, v0, p2}, Lcom/android/server/wm/NavBarFadeAnimationController;->fadeOutAndInSequentially(JLandroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZLcom/android/server/wm/WindowContainer;)Landroid/view/animation/Animation;
    ...
    invoke-static {v5, v6, v12, v2, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v9, v13}, Lcom/android/server/wm/AppTransition;->loadAnimationAttr(Landroid/view/WindowManager$LayoutParams;II)Landroid/view/animation/Animation;
    ...
    invoke-static {v7, v9, v11, v4, v13}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v5, v4, v3, v7, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v9, v0, Lcom/android/server/wm/AppTransition;->mDefaultNextAppTransitionAnimationSpec:Landroid/view/AppTransitionAnimationSpec;

    if-eqz v9, :cond_30

    iget-object v9, v9, Landroid/view/AppTransitionAnimationSpec;->rect:Landroid/graphics/Rect;
    ...
    const-string v5, "ANIM_THUMBNAIL_SCALE_UP"

    goto :goto_1d

    :cond_31
    const-string v5, "ANIM_THUMBNAIL_SCALE_DOWN"
    ...
    invoke-static {v9, v4, v3, v7, v10}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V

    :cond_32
    nop

    :goto_1e
    invoke-direct {v0, v11}, Lcom/android/server/wm/AppTransition;->setAppTransitionFinishedCallbackIfNeeded(Landroid/view/animation/Animation;)V
...
.method overridePendingAppTransitionMultiThumb([Landroid/view/AppTransitionAnimationSpec;Landroid/os/IRemoteCallback;Landroid/os/IRemoteCallback;Z)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/wm/DisplayContent;->getTask(Ljava/util/function/Predicate;)Lcom/android/server/wm/Task;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/wm/AppTransition;->putDefaultNextAppTransitionCoordinates(IIIILandroid/hardware/HardwareBuffer;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/wm/AppTransition;->appTransitionFlagsToString(I)Ljava/lang/String;
