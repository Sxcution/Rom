...
.method findAreaForWindowTypeInLayer(IZZ)Lcom/android/server/wm/DisplayArea$Tokens;
    ...
    iget-object p2, p0, Lcom/android/server/wm/RootDisplayArea;->mAreaForLayer:[Lcom/android/server/wm/DisplayArea$Tokens;
    ...
    const-string p2, "There shouldn\'t be WindowToken on APPLICATION_LAYER"
...
.method onHierarchyBuilt(Ljava/util/ArrayList;[Lcom/android/server/wm/DisplayArea$Tokens;Ljava/util/Map;)V
    ...
    const-string p2, "Root should only build the hierarchy once"
...
.method placeImeContainer(Lcom/android/server/wm/DisplayArea$Tokens;)V
    ...
    invoke-direct {v0, v3}, Lcom/android/server/wm/RootDisplayArea;->updateImeContainerForLayers(Lcom/android/server/wm/DisplayArea$Tokens;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/wm/DisplayArea$Tokens;->reparent(Lcom/android/server/wm/WindowContainer;I)V
    ...
    const-string v0, "There must be exactly one DisplayArea for the FEATURE_IME_PLACEHOLDER"
    ...
    const-string v0, "There is no FEATURE_IME_PLACEHOLDER in this root to place the IME container"
