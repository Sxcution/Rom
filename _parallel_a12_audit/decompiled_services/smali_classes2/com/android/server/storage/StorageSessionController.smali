...
.method private initExternalStorageServiceComponent()V
    ...
    const-string v1, "No valid ExternalStorageService component found"
    ...
    const-string v1, "No valid MediaStore provider found"
...
.method private killExternalStorageService(I)V
    ...
    const-string v1, "Failed to kill the ExtenalStorageService for user "
...
.method public getConnectionUserIdForVolume(Landroid/os/storage/VolumeInfo;)I
    ...
    iget-object v1, p0, Lcom/android/server/storage/StorageSessionController;->mUserManager:Landroid/os/UserManager;
    ...
    iget p1, v1, Landroid/content/pm/UserInfo;->profileGroupId:I
...
.method public isAppIoBlocked(I)Z
    ...
    check-cast v0, Lcom/android/server/storage/StorageUserConnection;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/storage/StorageUserConnection;->isAppIoBlocked(I)Z
...
.method public notifyAnrDelayStarted(Ljava/lang/String;III)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/storage/StorageUserConnection;->notifyAnrDelayStarted(Ljava/lang/String;III)V
...
.method public notifyAppIoBlocked(Ljava/lang/String;III)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/storage/StorageUserConnection;->notifyAppIoBlocked(Ljava/lang/String;III)V
...
.method public notifyAppIoResumed(Ljava/lang/String;III)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/storage/StorageUserConnection;->notifyAppIoResumed(Ljava/lang/String;III)V
...
.method public notifyVolumeStateChanged(Landroid/os/storage/VolumeInfo;)V
    ...
    invoke-virtual {p1, v1, v4, v5}, Landroid/os/storage/VolumeInfo;->buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;

    move-result-object p1

    invoke-virtual {v3, v0, p1}, Lcom/android/server/storage/StorageUserConnection;->notifyVolumeStateChanged(Ljava/lang/String;Landroid/os/storage/StorageVolume;)V
    ...
    const-string v3, "No available storage user connection for userId : "
...
.method public onReset(Landroid/os/IVold;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/storage/StorageSessionController;->killExternalStorageService(I)V
    ...
    const-string p2, "StorageSessionController"

    const-string v0, "Finished resetting external storage service"
...
.method public onVolumeMount(Landroid/os/ParcelFileDescriptor;Landroid/os/storage/VolumeInfo;)V
    ...
    invoke-virtual {v3, v0, p1, v1, p2}, Lcom/android/server/storage/StorageUserConnection;->startSession(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onVolumeRemove(Landroid/os/storage/VolumeInfo;)Lcom/android/server/storage/StorageUserConnection;
    ...
    check-cast p1, Lcom/android/server/storage/StorageUserConnection;
    ...
    const-string v4, "Removed session for vol with id: "
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/storage/StorageUserConnection;->removeSession(Ljava/lang/String;)Lcom/android/server/storage/StorageUserConnection$Session;
    ...
    const-string v4, "Session already removed for vol with id: "
...
.method public onVolumeUnmount(Landroid/os/storage/VolumeInfo;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcom/android/server/storage/StorageUserConnection;->removeSessionAndWait(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v3, "Failed to end session for vol with id: "
