...
.method private armRebootEscrow(Ljava/lang/String;Z)Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;
    ...
    const-string p1, "Missing packageName when rebooting with lskf."
    ...
    invoke-direct {p1, p2, v1}, Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;-><init>(II)V
    ...
    invoke-direct {v0, v3, v1}, Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;-><init>(II)V
    :try_end_0
    ...
    :cond_3
    :try_start_1
    invoke-virtual {v2}, Lcom/android/internal/widget/LockSettingsInternal;->armRebootEscrow()I
    ...
    invoke-direct {p1, v3, v2}, Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;-><init>(II)V
    ...
    invoke-direct {p1, v1, v1}, Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;-><init>(II)V
...
.method private static getCompressedApexInfoList(Ljava/lang/String;)Landroid/apex/CompressedApexInfoList;
    ...
    sget-object v2, Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda2;

    invoke-interface {p0, v2}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object p0

    sget-object v2, Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda0;->INSTANCE:Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda0;

    invoke-interface {p0, v2}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p0

    sget-object v2, Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda1;->INSTANCE:Lcom/android/server/recoverysystem/RecoverySystemService$$ExternalSyntheticLambda1;
...
.method private rebootWithLskfImpl(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->getPowerManager()Landroid/os/PowerManager;
...
.method private reportMetricsOnRebootWithLskf(Ljava/lang/String;ZLcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;)V
    ...
    invoke-direct {p0}, Lcom/android/server/recoverysystem/RecoverySystemService;->useServerBasedRoR()Z
...
.method private reportMetricsOnRequestLskf(Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v0, p2, v1}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->reportRebootEscrowPreparationMetrics(III)V
...
.method private setupOrClearBcb(ZLjava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->connectService()Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;
    ...
    :try_start_0
    invoke-virtual {v0, p2}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->sendCommand(Ljava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->getPercentageUncrypted()I

    move-result p2

    invoke-virtual {v0}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->sendAck()V
    ...
    const-string v3, "uncrypt failed with status: "
...
.method private verifySlotForNextBoot(Z)Z
    ...
    const-string p1, "Device isn\'t a/b, skipping slot verification."
    ...
    const-string p1, "Cannot get the boot control HAL, skipping slot verification."
    ...
    const-string v3, "Current boot slot should be 0 or 1, got "
    ...
    const-string v1, "Failed to query the active slots"
    ...
    const-string v3, "Failed to get the boot control HAL "
...
.method public allocateSpaceForUpdate(Ljava/lang/String;)Z
    ...
    const-string p1, "Updatable Apex not supported, allocateSpaceForUpdate does nothing."
    ...
    const-string p1, "apex_info.pb not present in OTA package. Assuming device doesn\'t support compressedAPEX, continueing without allocating space."
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/pm/ApexManager;->reserveSpaceForCompressedApex(Landroid/apex/CompressedApexInfoList;)V
    :try_end_1
    ...
    :try_start_2
    const-string v0, "Failed to reserve space for compressed apex: "
...
.method public clearLskf(Ljava/lang/String;)Z
    ...
    const-string v1, "Unsupported action type on clear "
    ...
    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->getLockSettingsService()Lcom/android/internal/widget/LockSettingsInternal;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p1}, Lcom/android/internal/widget/LockSettingsInternal;->clearRebootEscrow()Z
    ...
    const-string v2, "RoR clear called before preparation for caller "
...
.method public isLskfCaptured(Ljava/lang/String;)Z
    ...
    const-string v2, "Reboot requested before prepare completed for caller "
...
.method onSystemServicesReady()V
    ...
    const-string v1, "Failed to get lock settings service, skipping set RebootEscrowListener"
...
.method public requestLskf(Ljava/lang/String;Landroid/content/IntentSender;)Z
    ...
    const-string v0, "Unsupported action type on new request "
    ...
    const-string p1, "Failed to get lock settings service, skipping prepareRebootEscrow"
...
.method public uncrypt(Ljava/lang/String;Landroid/os/IRecoverySystemProgressListener;)Z
    ...
    const-string p2, "uncrypt service is unavailable."
    ...
    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->connectService()Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;
    ...
    :goto_0
    :try_start_5
    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->getPercentageUncrypted()I
    ...
    const-string v7, "uncrypt read status: "
    ...
    const-string v6, "RemoteException when posting progress"
    ...
    const-string v1, "uncrypt successfully finished."

    invoke-static {p2, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->sendAck()V
    :try_end_7
    ...
    :try_start_8
    invoke-virtual {p1}, Lcom/android/server/recoverysystem/RecoverySystemService$UncryptSocket;->close()V
    ...
    const-string v3, "IOException when reading status: "
    ...
    invoke-virtual {v3}, Lcom/android/server/recoverysystem/RecoverySystemService$Injector;->getUncryptPackageFileName()Ljava/lang/String;
