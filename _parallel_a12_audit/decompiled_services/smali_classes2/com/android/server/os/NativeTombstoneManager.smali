...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/os/NativeTombstoneManager$TombstoneWatcher;->startWatching()V
...
.method private handleProtoTombstone(Ljava/io/File;)V
    ...
    const-string v2, "unexpected tombstone name: "
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/server/os/NativeTombstoneManager;->mLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_2
    iget-object p1, p0, Lcom/android/server/os/NativeTombstoneManager;->mTombstones:Landroid/util/SparseArray;
    ...
    invoke-virtual {p1}, Lcom/android/server/os/NativeTombstoneManager$TombstoneFile;->dispose()V
...
.method private handleTombstone(Ljava/io/File;)V
    ...
    invoke-static {v0, p1, v1}, Lcom/android/server/BootReceiver;->addTombstoneToDropBox(Landroid/content/Context;Ljava/io/File;Z)V
...
.method public synthetic lambda$collectTombstones$3$NativeTombstoneManager(IIILjava/util/ArrayList;ILjava/util/concurrent/CompletableFuture;)V
    ...
    sget-object v0, Lcom/android/server/os/NativeTombstoneManager$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/os/NativeTombstoneManager$$ExternalSyntheticLambda3;
