...
.method public getAppStandbyBucket(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-static {v3, v10, v2}, Lcom/android/server/usage/UsageStatsService;->access$1600(Lcom/android/server/usage/UsageStatsService;II)Z
...
.method public getAppStandbyBuckets(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-interface {p1, p2}, Lcom/android/server/usage/AppStandbyInternal;->getAppStandbyBuckets(I)Ljava/util/List;
...
.method public getLastTimeAnyComponentUsed(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-static {p2}, Lcom/android/server/usage/UsageStatsService;->access$1300(Lcom/android/server/usage/UsageStatsService;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/android/server/usage/UsageStatsService;->access$2200(Lcom/android/server/usage/UsageStatsService;)Ljava/util/Map;
    ...
    const-string p2, "Don\'t have permission to query usage stats"
    ...
    const-string p2, "Caller doesn\'t have INTERACT_ACROSS_USERS permission"
...
.method public isAppInactive(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    invoke-virtual {v3, v1, v4, v13}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
    ...
    invoke-static {v1, v10, v13}, Lcom/android/server/usage/UsageStatsService;->access$1600(Lcom/android/server/usage/UsageStatsService;II)Z
...
.method public queryEvents(JJLjava/lang/String;)Landroid/app/usage/UsageEvents;
    ...
    invoke-static {v3, v0, v1}, Lcom/android/server/usage/UsageStatsService;->access$1600(Lcom/android/server/usage/UsageStatsService;II)Z
    ...
    invoke-static {v4, v1, p5, v2, v0}, Lcom/android/server/usage/UsageStatsService;->access$1700(Lcom/android/server/usage/UsageStatsService;ILjava/lang/String;II)Z

    move-result p5

    iget-object v4, p0, Lcom/android/server/usage/UsageStatsService$BinderService;->this$0:Lcom/android/server/usage/UsageStatsService;

    invoke-static {v4, v2, v0}, Lcom/android/server/usage/UsageStatsService;->access$1800(Lcom/android/server/usage/UsageStatsService;II)Z
    ...
    invoke-static {v5, v2, v0}, Lcom/android/server/usage/UsageStatsService;->access$1900(Lcom/android/server/usage/UsageStatsService;II)Z
...
.method public queryEventsForUser(JJILjava/lang/String;)Landroid/app/usage/UsageEvents;
    ...
    invoke-static {v6, v4, v3}, Lcom/android/server/usage/UsageStatsService;->access$1600(Lcom/android/server/usage/UsageStatsService;II)Z
    ...
    invoke-static {v6, p5, v2, v5, v4}, Lcom/android/server/usage/UsageStatsService;->access$1700(Lcom/android/server/usage/UsageStatsService;ILjava/lang/String;II)Z

    move-result v2

    iget-object v6, v0, Lcom/android/server/usage/UsageStatsService$BinderService;->this$0:Lcom/android/server/usage/UsageStatsService;

    invoke-static {v6, v5, v4}, Lcom/android/server/usage/UsageStatsService;->access$1900(Lcom/android/server/usage/UsageStatsService;II)Z
    ...
    invoke-static {v9, v5, v4}, Lcom/android/server/usage/UsageStatsService;->access$1800(Lcom/android/server/usage/UsageStatsService;II)Z
...
.method public queryUsageStats(IJJLjava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {v0, v7}, Lcom/android/server/usage/UsageStatsService$BinderService;->hasPermission(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v9, v2}, Lcom/android/server/usage/UsageStatsService;->access$1600(Lcom/android/server/usage/UsageStatsService;II)Z
...
.method public registerAppUsageLimitObserver(I[Ljava/lang/String;JJLandroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/usage/UsageStatsService;->access$1500(Lcom/android/server/usage/UsageStatsService;)Landroid/app/admin/DevicePolicyManagerInternal;
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/server/usage/UsageStatsService$BinderService;->hasPermissions(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method public reportChooserSelection(Ljava/lang/String;ILjava/lang/String;[Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v0}, Lcom/android/server/usage/UsageStatsService;->access$100(Lcom/android/server/usage/UsageStatsService;ILandroid/app/usage/UsageEvents$Event;)V
...
.method public reportPastUsageStart(Landroid/os/IBinder;Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-static {v3, p5, p2}, Lcom/android/server/usage/UsageStatsService;->access$2000(Lcom/android/server/usage/UsageStatsService;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public reportUsageStop(Landroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, p3, p2}, Lcom/android/server/usage/UsageStatsService;->access$2000(Lcom/android/server/usage/UsageStatsService;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public reportUserInteraction(Ljava/lang/String;I)V
    ...
    const-string p2, "Only system is allowed to call reportUserInteraction"
...
.method public setAppInactive(Ljava/lang/String;ZI)V
    ...
    invoke-interface {v2, p1, p2, p3}, Lcom/android/server/usage/AppStandbyInternal;->setAppIdleAsync(Ljava/lang/String;ZI)V
    :try_end_2
...
.method public setAppStandbyBuckets(Landroid/content/pm/ParceledListSlice;I)V
    ...
    invoke-interface {v4, p1, p2, v0, v1}, Lcom/android/server/usage/AppStandbyInternal;->setAppStandbyBuckets(Ljava/util/List;III)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public unregisterAppUsageLimitObserver(ILjava/lang/String;)V
    ...
    const-string p2, "Caller must be the active supervision app or it must have both SUSPEND_APPS and OBSERVE_APP_USAGE permissions"
    ...
    invoke-virtual {v3, v0, p1, p2}, Lcom/android/server/usage/UsageStatsService;->unregisterAppUsageLimitObserver(III)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
