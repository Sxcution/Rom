...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/usage/StorageStatsService$H;-><init>(Lcom/android/server/usage/StorageStatsService;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/usage/StorageStatsService;->mHandler:Lcom/android/server/usage/StorageStatsService$H;

    const/16 v1, 0x65

    invoke-virtual {p1, v1}, Lcom/android/server/usage/StorageStatsService$H;->sendEmptyMessage(I)Z
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/usage/StorageStatsService$LocalService;-><init>(Lcom/android/server/usage/StorageStatsService;Lcom/android/server/usage/StorageStatsService$1;)V
...
.method private checkStatsPermission(ILjava/lang/String;Z)Ljava/lang/String;
    ...
    :sswitch_0
    iget-object p3, p0, Lcom/android/server/usage/StorageStatsService;->mContext:Landroid/content/Context;
    ...
    const-string v0, "Caller does not have android.permission.PACKAGE_USAGE_STATS; callingPackage="
...
.method private enforceCratesPermission(ILjava/lang/String;)V
    ...
    const-string v0, "android.permission.MANAGE_CRATES"
...
.method private getAppCrates(Ljava/lang/String;[Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-static {p1}, Lcom/android/server/usage/StorageStatsService;->convertCrateInfoFrom([Landroid/os/storage/CrateMetadata;)Ljava/util/List;
...
.method public isReservedSupported(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string p1, "vold.has_reserved"
...
.method public queryCratesForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v0, p4}, Lcom/android/server/usage/StorageStatsService;->enforceCratesPermission(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p4, p3}, Lcom/android/server/usage/StorageStatsService;->getAppCrates(Ljava/lang/String;[Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
...
.method public queryCratesForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    :cond_4
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/usage/StorageStatsService;->getAppCrates(Ljava/lang/String;[Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
...
.method public queryCratesForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    :try_start_0
    iget-object p3, p0, Lcom/android/server/usage/StorageStatsService;->mInstaller:Lcom/android/server/pm/Installer;

    invoke-virtual {p3, p1, p2}, Lcom/android/server/pm/Installer;->getUserCrates(Ljava/lang/String;I)[Landroid/os/storage/CrateMetadata;
...
.method public queryStatsForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    invoke-direct {p0, v4, v1, v6}, Lcom/android/server/usage/StorageStatsService;->checkStatsPermission(ILjava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v4, v1}, Lcom/android/server/usage/StorageStatsService;->enforceStatsPermission(ILjava/lang/String;)V
...
.method public queryStatsForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    invoke-direct {v0, v3, v2, v14}, Lcom/android/server/usage/StorageStatsService;->checkStatsPermission(ILjava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v2}, Lcom/android/server/usage/StorageStatsService;->enforceStatsPermission(ILjava/lang/String;)V
    ...
    invoke-direct {v2, v3, v1, v15}, Lcom/android/server/usage/StorageStatsService$$ExternalSyntheticLambda0;-><init>(Landroid/content/pm/PackageStats;IZ)V
