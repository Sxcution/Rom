...
.method public constructor <init>(Lcom/android/server/vcn/VcnContext;Landroid/os/ParcelUuid;Landroid/net/vcn/VcnConfig;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Lcom/android/server/VcnManagementService$VcnCallback;Lcom/android/server/vcn/Vcn$Dependencies;)V
    ...
    check-cast p6, Lcom/android/server/vcn/Vcn$Dependencies;
    ...
    invoke-direct {p2, p0, p5}, Lcom/android/server/vcn/Vcn$VcnNetworkRequestListener;-><init>(Lcom/android/server/vcn/Vcn;Lcom/android/server/vcn/Vcn$1;)V
    ...
    invoke-direct {v0, p0, p0, p5}, Lcom/android/server/vcn/Vcn$VcnMobileDataContentObserver;-><init>(Lcom/android/server/vcn/Vcn;Landroid/os/Handler;Lcom/android/server/vcn/Vcn$1;)V
    ...
    check-cast p3, Landroid/net/vcn/VcnConfig;
    ...
    check-cast p4, Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/vcn/VcnNetworkProvider;->registerListener(Lcom/android/server/vcn/VcnNetworkProvider$NetworkRequestListener;)V
...
.method private handleConfigUpdated(Landroid/net/vcn/VcnConfig;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/vcn/VcnNetworkProvider;->resendAllRequests(Lcom/android/server/vcn/VcnNetworkProvider$NetworkRequestListener;)V
...
.method private handleMobileDataToggled()V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/vcn/Vcn;->logWtf(Ljava/lang/String;)V
...
.method private handleNetworkRequested(Landroid/net/NetworkRequest;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->logDbg(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->logWtf(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->logVdbg(Ljava/lang/String;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->handleGatewayConnectionQuit(Landroid/net/vcn/VcnGatewayConnectionConfig;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->handleSubscriptionsChanged(Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->handleNetworkRequested(Landroid/net/NetworkRequest;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/vcn/Vcn;->handleConfigUpdated(Landroid/net/vcn/VcnConfig;)V
...
.method public updateConfig(Landroid/net/vcn/VcnConfig;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/vcn/Vcn;->sendMessage(Landroid/os/Message;)Z
