...
.method private calculatePriorityClass(Landroid/os/ParcelUuid;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;Landroid/os/PersistableBundle;)I
    ...
    iget-object p2, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->network:Landroid/net/Network;
    ...
    invoke-static {p1}, Lcom/android/server/vcn/UnderlyingNetworkTracker;->access$1200(Ljava/lang/String;)V
    ...
    iget-object p3, p3, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->network:Landroid/net/Network;

    invoke-virtual {v3, p3}, Landroid/net/Network;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p2, p1}, Lcom/android/server/vcn/UnderlyingNetworkTracker;->access$1600(Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Ljava/util/Set;)Z
...
.method private dump(Lcom/android/internal/util/IndentingPrintWriter;Landroid/os/ParcelUuid;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;Landroid/os/PersistableBundle;)V
    ...
    const-string p4, "Priority class: "
    ...
    iget-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->network:Landroid/net/Network;
    ...
    iget-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    iget-object p3, p0, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->linkProperties:Landroid/net/LinkProperties;
...
.method static synthetic lambda$getComparator$0(Landroid/os/ParcelUuid;Lcom/android/server/vcn/TelephonySubscriptionTracker$TelephonySubscriptionSnapshot;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;Landroid/os/PersistableBundle;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;)I
    ...
    invoke-static {p4, p0}, Ljava/lang/Integer;->compare(II)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    check-cast p1, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;
    ...
    iget-object v3, p1, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    iget-object v3, p1, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->linkProperties:Landroid/net/LinkProperties;
    ...
    iget-boolean p1, p1, Lcom/android/server/vcn/UnderlyingNetworkTracker$UnderlyingNetworkRecord;->isBlocked:Z
