...
.method private getRemoteServiceLocked()Lcom/android/server/searchui/RemoteSearchUiService;
    ...
    iget-object v0, p0, Lcom/android/server/searchui/SearchUiPerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;

    check-cast v0, Lcom/android/server/searchui/SearchUiManagerService;

    iget-boolean v0, v0, Lcom/android/server/searchui/SearchUiManagerService;->verbose:Z
    ...
    iget v5, p0, Lcom/android/server/searchui/SearchUiPerUserService;->mUserId:I
    ...
    invoke-virtual {v1}, Lcom/android/server/searchui/SearchUiManagerService;->isBindInstantServiceAllowed()Z
    ...
    iget-boolean v8, v1, Lcom/android/server/searchui/SearchUiManagerService;->verbose:Z

    const-string v3, "android.service.search.SearchUiService"

    move-object v1, v0

    move-object v6, p0

    invoke-direct/range {v1 .. v8}, Lcom/android/server/searchui/RemoteSearchUiService;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;ILcom/android/server/searchui/RemoteSearchUiService$RemoteSearchUiServiceCallbacks;ZZ)V
...
.method public onConnectedStateChanged(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/searchui/SearchUiPerUserService;->mLock:Ljava/lang/Object;
...
.method public onCreateSearchSessionLocked(Landroid/app/search/SearchContext;Landroid/app/search/SearchSessionId;Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, p0, p2}, Lcom/android/server/searchui/SearchUiPerUserService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/searchui/SearchUiPerUserService;Landroid/app/search/SearchSessionId;)V
    ...
    iget-object p1, p0, Lcom/android/server/searchui/SearchUiPerUserService;->mSessionInfos:Landroid/util/ArrayMap;
...
.method public queryLocked(Landroid/app/search/SearchSessionId;Landroid/app/search/Query;Landroid/app/search/ISearchCallback;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/server/searchui/SearchUiPerUserService$$ExternalSyntheticLambda3;-><init>(Landroid/app/search/SearchSessionId;Landroid/app/search/Query;Landroid/app/search/ISearchCallback;)V
...
.method protected resolveService(Landroid/app/search/SearchSessionId;Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/searchui/RemoteSearchUiService;->executeOnResolvedService(Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)V
