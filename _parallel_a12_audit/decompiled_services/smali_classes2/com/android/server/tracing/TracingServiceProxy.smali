...
.method private notifyTraceur(Z)V
    ...
    :try_start_1
    iget-object p1, p0, Lcom/android/server/tracing/TracingServiceProxy;->mContext:Landroid/content/Context;

    sget-object v4, Landroid/os/UserHandle;->SYSTEM:Landroid/os/UserHandle;

    invoke-virtual {p1, v1, v4}, Landroid/content/Context;->startForegroundServiceAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/ComponentName;
    :try_end_1
    ...
    :try_start_3
    const-string v1, "Failed to notifyTraceSessionEnded"
    ...
    const-string v1, "Failed to locate Traceur"
