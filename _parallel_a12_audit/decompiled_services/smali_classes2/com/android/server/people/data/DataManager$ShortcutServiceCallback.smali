...
.method public synthetic lambda$onShortcutsAddedOrUpdated$0$DataManager$ShortcutServiceCallback(Ljava/lang/String;Landroid/os/UserHandle;Ljava/util/List;)V
    ...
    invoke-static {v1}, Lcom/android/server/people/data/DataManager;->access$1900(Lcom/android/server/people/data/DataManager;)Landroid/content/pm/ShortcutServiceInternal;
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/people/data/DataManager;->access$2000(Lcom/android/server/people/data/DataManager;II)V
...
.method public synthetic lambda$onShortcutsRemoved$1$DataManager$ShortcutServiceCallback(Ljava/lang/String;Landroid/os/UserHandle;Ljava/util/List;)V
    ...
    iget-object p2, p0, Lcom/android/server/people/data/DataManager$ShortcutServiceCallback;->this$0:Lcom/android/server/people/data/DataManager;

    invoke-static {p2}, Lcom/android/server/people/data/DataManager;->access$1800(Lcom/android/server/people/data/DataManager;)Lcom/android/server/notification/NotificationManagerInternal;

    move-result-object p2

    invoke-interface {p2, p1, v1, v2}, Lcom/android/server/notification/NotificationManagerInternal;->onConversationRemoved(Ljava/lang/String;ILjava/util/Set;)V
