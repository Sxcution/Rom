...
.method public calculateVibrationStatus(I)Lcom/android/server/vibrator/Vibration$Status;
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/vibrator/VibrationThread$StepQueue;->mSuccessfulVibratorOnSteps:I
    ...
    :cond_1
    sget-object p1, Lcom/android/server/vibrator/Vibration$Status;->IGNORED_UNSUPPORTED:Lcom/android/server/vibrator/Vibration$Status;
...
.method public cancel()V
    ...
    invoke-virtual {v1}, Lcom/android/server/vibrator/VibrationThread$Step;->cancel()Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/vibrator/VibrationThread$StepQueue;->mNextSteps:Ljava/util/PriorityQueue;
...
.method public cancelImmediately()V
    ...
    invoke-virtual {v0}, Lcom/android/server/vibrator/VibrationThread$Step;->cancelImmediately()V
...
.method public consumeNext()V
    ...
    iget v0, p0, Lcom/android/server/vibrator/VibrationThread$StepQueue;->mPendingVibrateSteps:I

    sub-int/2addr v0, v4

    iput v0, p0, Lcom/android/server/vibrator/VibrationThread$StepQueue;->mPendingVibrateSteps:I
...
.method public notifyVibratorComplete(I)V
    ...
    iget-boolean p1, p0, Lcom/android/server/vibrator/VibrationThread$StepQueue;->mWaitToProcessVibratorCallbacks:Z
