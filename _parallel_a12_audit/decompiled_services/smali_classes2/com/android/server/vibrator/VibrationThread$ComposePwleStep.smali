...
.method constructor <init>(Lcom/android/server/vibrator/VibrationThread;JLcom/android/server/vibrator/VibratorController;Landroid/os/VibrationEffect$Composed;IJ)V
    ...
    iput-object v1, v0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->this$0:Lcom/android/server/vibrator/VibrationThread;
...
.method public play()Ljava/util/List;
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->effect:Landroid/os/VibrationEffect$Composed;
    ...
    iget-object v5, p0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->effect:Landroid/os/VibrationEffect$Composed;
    ...
    iget-object v4, p0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->effect:Landroid/os/VibrationEffect$Composed;
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->skipToNextSteps(I)Ljava/util/List;
    ...
    iget-object v5, p0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->this$0:Lcom/android/server/vibrator/VibrationThread;
    ...
    invoke-virtual {v2, v4, v5, v6}, Lcom/android/server/vibrator/VibratorController;->on([Landroid/os/vibrator/RampSegment;J)J

    move-result-wide v4

    iput-wide v4, p0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->mVibratorOnResult:J

    invoke-interface {v3}, Ljava/util/List;->size()I

    move-result v2

    invoke-virtual {p0, v2}, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;->nextSteps(I)Ljava/util/List;
