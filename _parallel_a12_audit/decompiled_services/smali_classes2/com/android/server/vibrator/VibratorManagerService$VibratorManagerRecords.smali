...
.method declared-synchronized dumpProto(Ljava/io/FileDescriptor;)V
    ...
    iget-object p1, p0, Lcom/android/server/vibrator/VibratorManagerService$VibratorManagerRecords;->this$0:Lcom/android/server/vibrator/VibratorManagerService;
    ...
    invoke-static {v1}, Lcom/android/server/vibrator/VibratorManagerService;->access$1300(Lcom/android/server/vibrator/VibratorManagerService;)Lcom/android/server/vibrator/VibrationSettings;
    ...
    :goto_2
    iget-object v4, p0, Lcom/android/server/vibrator/VibratorManagerService$VibratorManagerRecords;->mPreviousVibrations:Landroid/util/SparseArray;
    ...
    invoke-virtual {v5, v0, v2, v3}, Lcom/android/server/vibrator/Vibration$DebugInfo;->dumpProto(Landroid/util/proto/ProtoOutputStream;J)V
...
.method dumpText(Ljava/io/PrintWriter;)V
    ...
    iget-object v4, p0, Lcom/android/server/vibrator/VibratorManagerService$VibratorManagerRecords;->this$0:Lcom/android/server/vibrator/VibratorManagerService;

    invoke-static {v4}, Lcom/android/server/vibrator/VibratorManagerService;->access$1400(Lcom/android/server/vibrator/VibratorManagerService;)Landroid/util/SparseArray;
    ...
    const-string v2, "  mCurrentVibration:"
    ...
    invoke-static {v3}, Lcom/android/server/vibrator/VibratorManagerService;->access$200(Lcom/android/server/vibrator/VibratorManagerService;)Lcom/android/server/vibrator/VibrationThread;
    ...
    invoke-virtual {v3}, Lcom/android/server/vibrator/VibrationThread;->getVibration()Lcom/android/server/vibrator/Vibration;

    move-result-object v3

    invoke-virtual {v3}, Lcom/android/server/vibrator/Vibration;->getDebugInfo()Lcom/android/server/vibrator/Vibration$DebugInfo;
    ...
    const-string v2, "  mNextVibration:"
    ...
    invoke-static {v3}, Lcom/android/server/vibrator/VibratorManagerService;->access$400(Lcom/android/server/vibrator/VibratorManagerService;)Lcom/android/server/vibrator/VibrationThread;
    ...
    invoke-virtual {v3}, Lcom/android/server/vibrator/VibratorManagerService$ExternalVibrationHolder;->getDebugInfo()Lcom/android/server/vibrator/Vibration$DebugInfo;
