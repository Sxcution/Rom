...
.method constructor <init>(Lcom/android/server/vibrator/Vibration;Lcom/android/server/vibrator/VibrationSettings;Lcom/android/server/vibrator/DeviceVibrationEffectAdapter;Landroid/util/SparseArray;Landroid/os/PowerManager$WakeLock;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/vibrator/VibrationThread$VibrationCallbacks;)V
    ...
    iget p3, p1, Lcom/android/server/vibrator/Vibration;->uid:I

    invoke-direct {p2, p3}, Landroid/os/WorkSource;-><init>(I)V

    iput-object p2, p0, Lcom/android/server/vibrator/VibrationThread;->mWorkSource:Landroid/os/WorkSource;
    ...
    iget-object p2, p0, Lcom/android/server/vibrator/VibrationThread;->mVibrators:Landroid/util/SparseArray;
...
.method static synthetic access$1000(Lcom/android/server/vibrator/VibrationThread;)Lcom/android/server/vibrator/VibrationSettings;
    ...
    iget-object p0, p0, Lcom/android/server/vibrator/VibrationThread;->mVibrationSettings:Lcom/android/server/vibrator/VibrationSettings;
...
.method static synthetic access$1100(Lcom/android/server/vibrator/VibrationThread;)Lcom/android/server/vibrator/DeviceVibrationEffectAdapter;
    ...
    iget-object p0, p0, Lcom/android/server/vibrator/VibrationThread;->mDeviceEffectAdapter:Lcom/android/server/vibrator/DeviceVibrationEffectAdapter;
...
.method static synthetic access$400(Lcom/android/server/vibrator/VibrationThread;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lcom/android/server/vibrator/VibrationThread;->mVibrators:Landroid/util/SparseArray;
...
.method static synthetic access$600(Lcom/android/server/vibrator/VibrationThread;)Lcom/android/server/vibrator/VibrationThread$VibrationCallbacks;
    ...
    iget-object p0, p0, Lcom/android/server/vibrator/VibrationThread;->mCallbacks:Lcom/android/server/vibrator/VibrationThread$VibrationCallbacks;
...
.method static synthetic access$700(Lcom/android/server/vibrator/VibrationThread;)Lcom/android/server/vibrator/Vibration;
    ...
    iget-object p0, p0, Lcom/android/server/vibrator/VibrationThread;->mVibration:Lcom/android/server/vibrator/Vibration;
...
.method private nextVibrateStep(JLcom/android/server/vibrator/VibratorController;Landroid/os/VibrationEffect$Composed;IJ)Lcom/android/server/vibrator/VibrationThread$SingleVibratorStep;
    ...
    new-instance v0, Lcom/android/server/vibrator/VibrationThread$CompleteStep;
    ...
    invoke-direct/range {v8 .. v15}, Lcom/android/server/vibrator/VibrationThread$CompleteStep;-><init>(Lcom/android/server/vibrator/VibrationThread;JZLcom/android/server/vibrator/VibratorController;J)V
    ...
    new-instance v0, Lcom/android/server/vibrator/VibrationThread$PerformStep;
    ...
    new-instance v0, Lcom/android/server/vibrator/VibrationThread$ComposePrimitivesStep;
    ...
    new-instance v0, Lcom/android/server/vibrator/VibrationThread$ComposePwleStep;
    ...
    :cond_4
    new-instance v0, Lcom/android/server/vibrator/VibrationThread$AmplitudeStep;
...
.method private noteVibratorOn(J)V
    ...
    :goto_0
    :try_start_0
    iget-object p1, p0, Lcom/android/server/vibrator/VibrationThread;->mBatteryStatsService:Lcom/android/internal/app/IBatteryStats;

    iget-object p2, p0, Lcom/android/server/vibrator/VibrationThread;->mVibration:Lcom/android/server/vibrator/Vibration;

    iget p2, p2, Lcom/android/server/vibrator/Vibration;->uid:I

    invoke-interface {p1, p2, v4, v5}, Lcom/android/internal/app/IBatteryStats;->noteVibratorOn(IJ)V

    const/16 v0, 0x54

    iget-object p1, p0, Lcom/android/server/vibrator/VibrationThread;->mVibration:Lcom/android/server/vibrator/Vibration;
...
.method private playVibration()V
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/vibrator/VibrationThread;->mStepQueue:Lcom/android/server/vibrator/VibrationThread$StepQueue;

    invoke-virtual {v0}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->isEmpty()Z
    ...
    invoke-virtual {v4}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->calculateWaitTime()J
    ...
    invoke-virtual {v0}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->consumeNext()V
    ...
    sget-object v0, Lcom/android/server/vibrator/Vibration$Status;->CANCELLED:Lcom/android/server/vibrator/Vibration$Status;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->calculateVibrationStatus(I)Lcom/android/server/vibrator/Vibration$Status;
    ...
    iget-boolean v4, p0, Lcom/android/server/vibrator/VibrationThread;->mCalledVibrationCompleteCallback:Z
    ...
    invoke-virtual {v0}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->cancel()V
    ...
    invoke-virtual {v0}, Lcom/android/server/vibrator/VibrationThread$StepQueue;->cancelImmediately()V
...
.method public vibratorComplete(I)V
    ...
    iget-object p1, p0, Lcom/android/server/vibrator/VibrationThread;->mLock:Ljava/lang/Object;
