...
.method private isCameraPermissionGranted(Ljava/lang/String;II)Z
    ...
    sget-object p2, Lcom/android/server/usb/UsbUserPermissionManager;->TAG:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/usb/UsbUserPermissionManager;->mContext:Landroid/content/Context;
...
.method private readPermission(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object p1, p0, Lcom/android/server/usb/UsbUserPermissionManager;->mDevicePersistentPermissionMap:Landroid/util/ArrayMap;
    ...
    iget-object p1, p0, Lcom/android/server/usb/UsbUserPermissionManager;->mAccessoryPersistentPermissionMap:Landroid/util/ArrayMap;
    ...
    const-string v1, "error reading usb permission granted state"
...
.method hasPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;II)Z
    ...
    :cond_4
    iget-object p3, p0, Lcom/android/server/usb/UsbUserPermissionManager;->mDevicePermissionMap:Landroid/util/ArrayMap;
...
.method public synthetic lambda$scheduleWritePermissionsLocked$0$UsbUserPermissionManager()V
    ...
    invoke-interface {v12, v4, v6, v2}, Landroid/util/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v12, v6, v2, v4}, Landroid/util/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    aget-object v2, v3, v13

    invoke-virtual {v2, v12}, Landroid/hardware/usb/DeviceFilter;->write(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-interface {v12, v6, v4}, Landroid/util/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v12, v13, v4, v6}, Landroid/util/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-virtual {v4, v12}, Landroid/hardware/usb/AccessoryFilter;->write(Lorg/xmlpull/v1/XmlSerializer;)V

    const-string v4, "permission"

    const/4 v6, 0x0

    invoke-interface {v12, v6, v4}, Landroid/util/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
...
.method public requestPermission(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/usb/UsbUserPermissionManager;->requestPermissionDialog(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;ZLjava/lang/String;Landroid/app/PendingIntent;I)V
...
.method requestPermissionDialog(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;ZLjava/lang/String;ILandroid/content/Context;Landroid/app/PendingIntent;)V
    ...
    iget-object p1, p0, Lcom/android/server/usb/UsbUserPermissionManager;->mUser:Landroid/os/UserHandle;
    ...
    const-string p2, "unable to start UsbPermissionActivity"
