...
.method private requestShow(Ljava/io/PrintWriter;)I
    ...
    invoke-virtual {v4, v2, v6, v3, v5}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;->showSessionForActiveService(Landroid/os/Bundle;ILcom/android/internal/app/IVoiceInteractionSessionShowCallback;Landroid/os/IBinder;)Z

    move-result v2

    if-nez v2, :cond_0

    const-string v0, "showSessionForActiveService() returned false"
    ...
    const-string v0, "Callback not called in %d ms\n"
    ...
    const-string v1, "showSessionForActiveService()"
...
.method private setDebugHotwordLogging(Ljava/io/PrintWriter;)I
    ...
    const-string v1, "setDebugHotwordLogging()"
