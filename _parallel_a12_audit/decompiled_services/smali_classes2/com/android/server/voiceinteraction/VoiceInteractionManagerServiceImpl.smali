...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;ILandroid/content/ComponentName;)V
    ...
    invoke-direct {v3, v4, p5, p4}, Landroid/service/voice/VoiceInteractionServiceInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/content/ComponentName;I)V
    :try_end_0
    ...
    iput-boolean p4, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->mValid:Z
    ...
    invoke-direct {v0, p5, p4}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p4}, Landroid/view/IWindowManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/view/IWindowManager;

    move-result-object p4

    iput-object p4, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->mIWindowManager:Landroid/view/IWindowManager;
    ...
    invoke-virtual {p1, v2, p4, p3, p2}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
...
.method private logDetectorCreateEventIfNeeded(Lcom/android/internal/app/IHotwordRecognitionStatusCallback;IZI)V
    ...
    invoke-static {p2, p1, p4}, Lcom/android/server/voiceinteraction/HotwordMetricsLogger;->writeDetectorCreateEvent(IZI)V
...
.method public requestDirectActionsLocked(Landroid/os/IBinder;ILandroid/os/IBinder;Landroid/os/RemoteCallback;Landroid/os/RemoteCallback;)V
    ...
    :cond_3
    :goto_2
    const-string p1, "requestDirectActionsLocked does not match active session"
...
.method setDebugHotwordLoggingLocked(Z)V
    ...
    const-string v0, "Failed to set temporary debug logging: no hotword detection active"
...
.method public setKeepAwakeLocked(Landroid/os/IBinder;Z)V
    ...
    const-string p2, "setKeepAwake does not match active session"
...
.method public startAssistantActivityLocked(Ljava/lang/String;IILandroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;)I
    ...
    :cond_0
    iget-object p4, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->mActiveSession:Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;

    iget-boolean p4, p4, Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;->mShown:Z

    if-nez p4, :cond_1

    const-string p1, "startAssistantActivity not allowed on hidden session"
    ...
    :cond_2
    :goto_0
    const-string p1, "startAssistantActivity does not match active session"
...
.method public startListeningVisibleActivityChangedLocked(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;->startListeningVisibleActivityChangedLocked()V
    ...
    const-string v0, "startListeningVisibleActivityChangedLocked does not match active session"
...
.method public stopListeningVisibleActivityChangedLocked(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;->stopListeningVisibleActivityChangedLocked()V
    ...
    const-string v0, "stopListeningVisibleActivityChangedLocked does not match active session"
...
.method public triggerHardwareRecognitionEventForTestLocked(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;)V
    ...
    const-string p2, "triggerHardwareRecognitionEventForTestLocked() called but connection isn\'t established"
...
.method public updateStateLocked(Landroid/media/permission/Identity;Landroid/os/PersistableBundle;Landroid/os/SharedMemory;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;I)V
    ...
    invoke-direct {p0, v11, v12, v4, v2}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->logDetectorCreateEventIfNeeded(Lcom/android/internal/app/IHotwordRecognitionStatusCallback;IZI)V
    ...
    invoke-direct {p0, v11, v12, v1, v2}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->logDetectorCreateEventIfNeeded(Lcom/android/internal/app/IHotwordRecognitionStatusCallback;IZI)V
