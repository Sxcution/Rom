...
.method static synthetic access$200(Lcom/android/server/uwb/UwbServiceImpl$UwbRangingCallbacksWrapper;)Landroid/uwb/IUwbRangingCallbacks;
    ...
    iget-object p0, p0, Lcom/android/server/uwb/UwbServiceImpl$UwbRangingCallbacksWrapper;->mExternalCb:Landroid/uwb/IUwbRangingCallbacks;
...
.method private linkToDeath()V
    ...
    const-string v2, "Unable to link to client death event."
...
.method public declared-synchronized onRangingResult(Landroid/uwb/SessionHandle;Landroid/uwb/RangingReport;)V
    ...
    const-string p1, "UwbServiceImpl"

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "Not delivering ranging result because of permission denial"

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lcom/android/server/uwb/UwbServiceImpl$UwbRangingCallbacksWrapper;->mSessionHandle:Landroid/uwb/SessionHandle;
    ...
    invoke-interface {v0, p1, p2}, Landroid/uwb/IUwbRangingCallbacks;->onRangingResult(Landroid/uwb/SessionHandle;Landroid/uwb/RangingReport;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
