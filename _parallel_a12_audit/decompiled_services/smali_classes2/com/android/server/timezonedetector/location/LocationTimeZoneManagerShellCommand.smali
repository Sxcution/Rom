...
.method private runDumpControllerState()I
    ...
    invoke-direct {v4, v2}, Landroid/util/proto/ProtoOutputStream;-><init>(Ljava/io/FileDescriptor;)V
    ...
    invoke-direct {v2, v4, v5}, Landroid/util/IndentingPrintWriter;-><init>(Ljava/io/Writer;Ljava/lang/String;)V

    invoke-direct {v3, v2}, Lcom/android/internal/util/dump/DualDumpOutputStream;-><init>(Landroid/util/IndentingPrintWriter;)V
    ...
    const-string v6, "last_suggestion"

    invoke-virtual {v3, v6, v4, v5}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J
    ...
    const-wide v8, 0x20900000001L

    const-string v10, "zone_ids"

    invoke-virtual {v3, v10, v8, v9, v7}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JLjava/lang/String;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v2}, Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;->getDebugInfo()Ljava/util/List;
    ...
    invoke-virtual {v3, v9, v7, v8, v6}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JLjava/lang/String;)V

    goto :goto_2

    :cond_3
    invoke-virtual {v3, v4, v5}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V
    ...
    const-string v6, "primary_provider_states"

    invoke-static {v3, v2, v6, v4, v5}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerShellCommand;->writeProviderStates(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/util/List;Ljava/lang/String;J)V
    ...
    const-string v2, "secondary_provider_states"

    invoke-static {v3, v0, v2, v4, v5}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerShellCommand;->writeProviderStates(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/util/List;Ljava/lang/String;J)V
...
.method private runRecordProviderStates()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerService;->setProviderStateRecordingEnabled(Z)V
    :try_end_1
