...
.method static fromConfig(Landroid/os/BatterySaverPolicyConfig;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    new-instance v23, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    new-instance v5, Lcom/android/server/power/batterysaver/CpuFrequencies;

    invoke-direct {v5}, Lcom/android/server/power/batterysaver/CpuFrequencies;-><init>()V

    invoke-virtual {v5, v1}, Lcom/android/server/power/batterysaver/CpuFrequencies;->parseString(Ljava/lang/String;)Lcom/android/server/power/batterysaver/CpuFrequencies;
    ...
    invoke-direct/range {v2 .. v22}, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;-><init>(FZLcom/android/server/power/batterysaver/CpuFrequencies;Lcom/android/server/power/batterysaver/CpuFrequencies;ZZZZZZZZZZZZZZII)V
...
.method private static fromSettings(Ljava/lang/String;Ljava/lang/String;Landroid/provider/DeviceConfig$Properties;Ljava/lang/String;Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    invoke-direct {v5, v0}, Landroid/util/KeyValueListParser;-><init>(C)V
    ...
    const-string v8, "Bad battery saver constants: "
    ...
    iget v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->adjustBrightnessFactor:F

    invoke-virtual {v3, v0, v7}, Landroid/provider/DeviceConfig$Properties;->getFloat(Ljava/lang/String;F)F

    move-result v0

    invoke-virtual {v5, v1, v0}, Landroid/util/KeyValueListParser;->getFloat(Ljava/lang/String;F)F
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->advertiseIsEnabled:Z

    invoke-virtual {v3, v0, v7}, Landroid/provider/DeviceConfig$Properties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    invoke-virtual {v5, v1, v0}, Landroid/util/KeyValueListParser;->getBoolean(Ljava/lang/String;Z)Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->deferFullBackup:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->deferKeyValueBackup:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->disableAnimation:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->disableAod:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->disableLaunchBoost:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->disableOptionalSensors:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->disableVibration:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->enableAdjustBrightness:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->enableDataSaver:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->enableFirewall:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->enableNightMode:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->enableQuickDoze:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->forceAllAppsStandby:Z
    ...
    iget-boolean v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->forceBackgroundCheck:Z
    ...
    iget v7, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->locationMode:I

    invoke-virtual {v3, v0, v7}, Landroid/provider/DeviceConfig$Properties;->getInt(Ljava/lang/String;I)I

    move-result v0

    invoke-virtual {v5, v1, v0}, Landroid/util/KeyValueListParser;->getInt(Ljava/lang/String;I)I
    ...
    iget v4, v4, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->soundTriggerMode:I

    invoke-virtual {v3, v0, v4}, Landroid/provider/DeviceConfig$Properties;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v1, v9}, Lcom/android/server/power/batterysaver/CpuFrequencies;->parseString(Ljava/lang/String;)Lcom/android/server/power/batterysaver/CpuFrequencies;

    move-result-object v14

    invoke-direct/range {v10 .. v30}, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;-><init>(FZLcom/android/server/power/batterysaver/CpuFrequencies;Lcom/android/server/power/batterysaver/CpuFrequencies;ZZZZZZZZZZZZZZII)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v3, p1, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->soundTriggerMode:I
    ...
    iget-object v3, p1, Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;->cpuFrequenciesForInteractive:Lcom/android/server/power/batterysaver/CpuFrequencies;

    invoke-virtual {v1, v3}, Lcom/android/server/power/batterysaver/CpuFrequencies;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/power/batterysaver/CpuFrequencies;->equals(Ljava/lang/Object;)Z
