...
.method public acquireWakeLock(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;I)V
    ...
    invoke-static/range {v0 .. v9}, Lcom/android/server/power/PowerManagerService;->access$4600(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;IILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;II)V
    :try_end_0
...
.method public boostScreenBrightness(J)V
    ...
    invoke-static {v3, p1, p2, v0}, Lcom/android/server/power/PowerManagerService;->access$7500(Lcom/android/server/power/PowerManagerService;JI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p2, p1}, Lcom/android/server/power/PowerManagerService;->access$7800(Lcom/android/server/power/PowerManagerService;Ljava/io/FileDescriptor;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/power/PowerManagerService;->access$7900(Lcom/android/server/power/PowerManagerService;Ljava/io/PrintWriter;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public forceSuspend()Z
    ...
    invoke-static {v3, v0}, Lcom/android/server/power/PowerManagerService;->access$7700(Lcom/android/server/power/PowerManagerService;I)Z
...
.method public getAmbientDisplaySuppressionTokens()Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/android/server/power/PowerManagerService;->access$7400(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/AmbientDisplaySuppressionController;
...
.method public getBrightnessConstraint(I)F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDefaultKeyboard:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDefaultButton:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDefaultVr:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessMaximumVr:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessMinimumVr:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDoze:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDim:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessDefault:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessMaximum:F
    ...
    iget p1, p1, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessMinimum:F
...
.method public isAmbientDisplayAvailable()Z
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$7300(Lcom/android/server/power/PowerManagerService;)Landroid/hardware/display/AmbientDisplayConfiguration;
...
.method public isAmbientDisplaySuppressed()Z
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$7400(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/AmbientDisplaySuppressionController;
...
.method public reboot(ZLjava/lang/String;Z)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/power/PowerManagerService;->access$6800(Lcom/android/server/power/PowerManagerService;IZLjava/lang/String;ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public rebootSafeMode(ZZ)V
    ...
    invoke-static {v0, v4}, Lcom/android/server/power/ShutdownCheckPoints;->recordCheckPoint(ILjava/lang/String;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/server/power/PowerManagerService;->access$6800(Lcom/android/server/power/PowerManagerService;IZLjava/lang/String;ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setBatteryDischargePrediction(Landroid/os/ParcelDuration;Z)V
    ...
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->access$700(Lcom/android/server/power/PowerManagerService;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lcom/android/server/power/PowerManagerService;->access$6000(Lcom/android/server/power/PowerManagerService;)Z
    ...
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->access$6100(Lcom/android/server/power/PowerManagerService;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lcom/android/server/power/PowerManagerService;->access$6200(Lcom/android/server/power/PowerManagerService;)J
    ...
    invoke-static {v10}, Lcom/android/server/power/PowerManagerService;->access$6200(Lcom/android/server/power/PowerManagerService;)J
    ...
    invoke-static {v8, v2, v3}, Lcom/android/server/power/PowerManagerService;->access$6302(Lcom/android/server/power/PowerManagerService;J)J

    iget-object v2, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    invoke-static {v2, p2}, Lcom/android/server/power/PowerManagerService;->access$6402(Lcom/android/server/power/PowerManagerService;Z)Z

    iget-object p2, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    invoke-static {p2, v0, v1}, Lcom/android/server/power/PowerManagerService;->access$6202(Lcom/android/server/power/PowerManagerService;J)J
    ...
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->access$6500(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/Notifier;

    move-result-object p1

    invoke-virtual {p1, v6, v7}, Lcom/android/server/power/Notifier;->postEnhancedDischargePredictionBroadcast(J)V
    :try_end_5
    ...
    const-string v0, "Discharge prediction can\'t be set while the device is charging"
...
.method public setDozeAfterScreenOff(Z)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$7200(Lcom/android/server/power/PowerManagerService;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setKeyboardVisibility(Z)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/power/PowerManagerService;->access$7102(Lcom/android/server/power/PowerManagerService;Z)Z
...
.method public userActivity(IJII)V
    ...
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->access$5000(Lcom/android/server/power/PowerManagerService;)J
    ...
    invoke-static {p1, v0, v1}, Lcom/android/server/power/PowerManagerService;->access$5002(Lcom/android/server/power/PowerManagerService;J)J
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/server/power/PowerManagerService;->access$5100(Lcom/android/server/power/PowerManagerService;IJIII)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public wakeUp(JILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/power/PowerManagerService;->access$100(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$Clock;
    ...
    invoke-static/range {v3 .. v11}, Lcom/android/server/power/PowerManagerService;->access$5200(Lcom/android/server/power/PowerManagerService;IJILjava/lang/String;ILjava/lang/String;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
