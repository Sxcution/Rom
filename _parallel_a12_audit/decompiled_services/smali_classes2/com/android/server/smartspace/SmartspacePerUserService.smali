...
.method private getRemoteServiceLocked()Lcom/android/server/smartspace/RemoteSmartspaceService;
    ...
    iget-object v0, p0, Lcom/android/server/smartspace/SmartspacePerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;

    check-cast v0, Lcom/android/server/smartspace/SmartspaceManagerService;

    iget-boolean v0, v0, Lcom/android/server/smartspace/SmartspaceManagerService;->verbose:Z
    ...
    iget v5, p0, Lcom/android/server/smartspace/SmartspacePerUserService;->mUserId:I
    ...
    invoke-virtual {v1}, Lcom/android/server/smartspace/SmartspaceManagerService;->isBindInstantServiceAllowed()Z
    ...
    iget-boolean v8, v1, Lcom/android/server/smartspace/SmartspaceManagerService;->verbose:Z

    const-string v3, "android.service.smartspace.SmartspaceService"

    move-object v1, v0

    move-object v6, p0

    invoke-direct/range {v1 .. v8}, Lcom/android/server/smartspace/RemoteSmartspaceService;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;ILcom/android/server/smartspace/RemoteSmartspaceService$RemoteSmartspaceServiceCallbacks;ZZ)V
...
.method public notifySmartspaceEventLocked(Landroid/app/smartspace/SmartspaceSessionId;Landroid/app/smartspace/SmartspaceTargetEvent;)V
    ...
    :cond_0
    new-instance v0, Lcom/android/server/smartspace/SmartspacePerUserService$$ExternalSyntheticLambda6;

    invoke-direct {v0, p1, p2}, Lcom/android/server/smartspace/SmartspacePerUserService$$ExternalSyntheticLambda6;-><init>(Landroid/app/smartspace/SmartspaceSessionId;Landroid/app/smartspace/SmartspaceTargetEvent;)V
...
.method public onConnectedStateChanged(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/smartspace/SmartspacePerUserService;->mLock:Ljava/lang/Object;
...
.method public onCreateSmartspaceSessionLocked(Landroid/app/smartspace/SmartspaceConfig;Landroid/app/smartspace/SmartspaceSessionId;Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, p0, p2}, Lcom/android/server/smartspace/SmartspacePerUserService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/smartspace/SmartspacePerUserService;Landroid/app/smartspace/SmartspaceSessionId;)V
    ...
    iget-object p1, p0, Lcom/android/server/smartspace/SmartspacePerUserService;->mSessionInfos:Landroid/util/ArrayMap;
...
.method public requestSmartspaceUpdateLocked(Landroid/app/smartspace/SmartspaceSessionId;)V
    ...
    :cond_0
    new-instance v0, Lcom/android/server/smartspace/SmartspacePerUserService$$ExternalSyntheticLambda3;

    invoke-direct {v0, p1}, Lcom/android/server/smartspace/SmartspacePerUserService$$ExternalSyntheticLambda3;-><init>(Landroid/app/smartspace/SmartspaceSessionId;)V
...
.method protected resolveService(Landroid/app/smartspace/SmartspaceSessionId;Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/smartspace/RemoteSmartspaceService;->executeOnResolvedService(Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)V
