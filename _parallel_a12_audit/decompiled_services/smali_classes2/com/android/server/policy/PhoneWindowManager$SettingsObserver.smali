...
.method observe()V
    ...
    invoke-static {v1}, Lcom/android/server/policy/PhoneWindowManager;->access$1400(Lcom/android/server/policy/PhoneWindowManager;)Lcom/android/internal/custom/hardware/LineageHardwareManager;

    move-result-object v1

    const/16 v4, 0x40

    invoke-virtual {v1, v4}, Lcom/android/internal/custom/hardware/LineageHardwareManager;->isSupported(I)Z

    move-result v1

    if-eqz v1, :cond_0

    const-string v1, "swap_capacitive_keys"
...
.method public onChange(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/policy/PhoneWindowManager;->updateRotation(Z)V
