...
.method static synthetic access$100(Lcom/android/server/pm/verify/domain/DomainVerificationService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLock:Ljava/lang/Object;
...
.method private approvalLevelForDomain(Lcom/android/server/pm/PackageSetting;Ljava/lang/String;ZILjava/lang/Object;)I
    ...
    iget-boolean p4, p3, Landroid/content/pm/PackageUserState;->installed:Z
    ...
    invoke-virtual {p3, p4}, Landroid/content/pm/PackageUserState;->isPackageEnabled(Landroid/content/pm/parsing/ParsingPackageRead;)Z
    ...
    invoke-virtual {p3, p1, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->containsAutoVerifyDomain(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Ljava/lang/String;)Z
...
.method private approvalLevelForDomainInternal(Lcom/android/server/pm/PackageSetting;Ljava/lang/String;ZILjava/lang/Object;)I
    ...
    :cond_1
    iget-boolean v2, p3, Landroid/content/pm/PackageUserState;->installed:Z
    ...
    :cond_2
    invoke-virtual {p3, v0}, Landroid/content/pm/PackageUserState;->isPackageEnabled(Landroid/content/pm/parsing/ParsingPackageRead;)Z
    ...
    :cond_3
    iget-boolean p3, p3, Landroid/content/pm/PackageUserState;->suspended:Z
    ...
    iget-object v2, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mPlatformCompat:Lcom/android/server/compat/PlatformCompat;

    const-wide/32 v3, 0xa9dc3bd

    invoke-static {v2, v0, v3, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationUtils;->isChangeEnabled(Lcom/android/server/compat/PlatformCompat;Lcom/android/server/pm/parsing/pkg/AndroidPackage;J)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLegacySettings:Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;

    invoke-virtual {v2, p5, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->getUserState(Ljava/lang/String;I)I
    ...
    invoke-virtual {v3, p5}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->isLinkHandlingAllowed()Z
    ...
    invoke-virtual {p1, p4}, Lcom/android/server/pm/PackageSetting;->getInstantApp(I)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-static {v4}, Landroid/content/pm/verify/domain/DomainVerificationState;->isVerified(I)Z
    ...
    :cond_d
    invoke-virtual {v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->getEnabledHosts()Landroid/util/ArraySet;
...
.method private fillInfoMapForSamePackage(Landroid/util/ArrayMap;Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v1, v2}, Landroid/util/ArrayMap;->setValueAt(ILjava/lang/Object;)Ljava/lang/Object;
...
.method private fillMapWithApprovalLevels(Landroid/util/ArrayMap;Ljava/lang/String;ILjava/util/function/Function;)I
    ...
    invoke-direct {p0, p1, v12, v9}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->fillInfoMapForSamePackage(Landroid/util/ArrayMap;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, v12, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->fillInfoMapForSamePackage(Landroid/util/ArrayMap;Ljava/lang/String;I)V
...
.method private filterToLastDeclared(Ljava/util/List;Ljava/util/function/Function;)V
    ...
    invoke-direct {p0, v3, v1}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->indexOfIntentFilterEntry(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Landroid/content/pm/ResolveInfo;)I
    ...
    :cond_2
    invoke-direct {p0, v3, v6}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->indexOfIntentFilterEntry(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Landroid/content/pm/ResolveInfo;)I
...
.method private filterToLastFirstInstalled(Landroid/util/ArrayMap;Ljava/util/function/Function;)V
    ...
    :cond_0
    invoke-virtual {v6}, Lcom/android/server/pm/PackageSetting;->getFirstInstallTime()J
...
.method private getAndValidateAttachedLocked(Ljava/util/UUID;Ljava/util/Set;ZILjava/lang/Integer;Ljava/util/function/Function;)Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    ...
    invoke-interface {v2, v1, p4, p5}, Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;->filterAppAccess(Ljava/lang/String;II)Z
    ...
    invoke-virtual {p4}, Lcom/android/server/pm/PackageSetting;->getPkg()Lcom/android/server/pm/parsing/pkg/AndroidPackage;
    ...
    invoke-virtual {p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-virtual {p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-static {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;->error(I)Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    ...
    const-string p2, "Provided domain set cannot be empty"
    ...
    const-string p2, "domainSetId cannot be null"
...
.method private getApprovedPackagesLocked(Ljava/lang/String;IILjava/util/function/Function;)Landroid/util/Pair;
    ...
    invoke-static {v13, v9}, Lcom/android/internal/util/CollectionUtils;->add(Ljava/util/List;Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_7
    invoke-virtual {v5}, Lcom/android/server/pm/PackageSetting;->getFirstInstallTime()J
...
.method private getOwnersForDomainInternal(Ljava/lang/String;ZILjava/util/function/Function;)Landroid/util/SparseArray;
    ...
    invoke-interface {v7, v13}, Ljava/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v2, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda12;

    invoke-direct {v2, v7}, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda12;-><init>(Ljava/util/function/Function;)V
...
.method private indexOfIntentFilterEntry(Lcom/android/server/pm/parsing/pkg/AndroidPackage;Landroid/content/pm/ResolveInfo;)I
    ...
    invoke-virtual {v2}, Landroid/content/pm/parsing/component/ParsedActivity;->getComponentName()Landroid/content/ComponentName;
...
.method static synthetic lambda$getOwnersForDomainInternal$8(Ljava/util/function/Function;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/server/pm/PackageSetting;->getFirstInstallTime()J
...
.method static synthetic lambda$writeSettings$9(Ljava/util/function/Function;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/server/pm/PackageSetting;->getSignatures()[Landroid/content/pm/Signature;
...
.method private printOwnersForDomain(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;Ljava/util/function/Function;)V
    ...
    invoke-direct {p0, p2, v1, p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->getOwnersForDomainInternal(Ljava/lang/String;ZILjava/util/function/Function;)Landroid/util/SparseArray;
    ...
    invoke-direct {p0, p2, v1, v4, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->getOwnersForDomainInternal(Ljava/lang/String;ZILjava/util/function/Function;)Landroid/util/SparseArray;
    ...
    :cond_2
    :goto_2
    iget-object p3, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mDebug:Lcom/android/server/pm/verify/domain/DomainVerificationDebug;

    invoke-virtual {p3, p1, p2, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationDebug;->printOwners(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Landroid/util/SparseArray;)V
...
.method private printOwnersForPackage(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;Ljava/util/function/Function;)V
    ...
    invoke-direct {p0, p1, v2, p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->printOwnersForDomain(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;Ljava/util/function/Function;)V
...
.method private resetDomainState(Landroid/util/ArrayMap;Lcom/android/server/pm/PackageSetting;)V
    ...
    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyImmutableState(Lcom/android/server/pm/PackageSetting;Landroid/util/ArrayMap;Landroid/util/ArraySet;)Z
...
.method private revokeOtherUserSelectionsLocked(Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;ILjava/util/Set;Ljava/util/function/Function;)I
    ...
    invoke-direct {p0, v1, p2, v2, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->getApprovedPackagesLocked(Ljava/lang/String;IILjava/util/function/Function;)Landroid/util/Pair;
...
.method private sendBroadcast(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->sendBroadcast(Ljava/util/Set;)V
...
.method private shouldReBroadcastPackage(Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;)Z
    ...
    invoke-static {v3}, Landroid/content/pm/verify/domain/DomainVerificationState;->isDefault(I)Z
...
.method public addPackage(Lcom/android/server/pm/PackageSetting;)V
    ...
    invoke-direct {v0, v12, v3, v9}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyImmutableState(Lcom/android/server/pm/PackageSetting;Landroid/util/ArrayMap;Landroid/util/ArraySet;)Z
    ...
    invoke-direct {v0, v2}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->sendBroadcast(Ljava/lang/String;)V
...
.method public clearDomainVerificationState(Ljava/util/List;)V
    ...
    invoke-interface {p1}, Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;->scheduleWriteSettings()V
...
.method public filterToApprovedApp(Landroid/content/Intent;Ljava/util/List;ILjava/util/function/Function;)Landroid/util/Pair;
    ...
    :cond_1
    invoke-direct {p0, v0, p1, p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->fillMapWithApprovalLevels(Landroid/util/ArrayMap;Ljava/lang/String;ILjava/util/function/Function;)I
    ...
    invoke-direct {p0, v1, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->filterToLastDeclared(Ljava/util/List;Ljava/util/function/Function;)V
...
.method public synthetic lambda$clearDomainVerificationState$16$DomainVerificationService(Ljava/util/List;Ljava/util/function/Function;)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->valueAt(I)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->resetDomainState(Landroid/util/ArrayMap;Lcom/android/server/pm/PackageSetting;)V
    ...
    invoke-direct {p0, v4, v3}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->resetDomainState(Landroid/util/ArrayMap;Lcom/android/server/pm/PackageSetting;)V
...
.method public synthetic lambda$getDomainVerificationInfo$0$DomainVerificationService(Ljava/lang/String;Ljava/util/function/Function;)Landroid/content/pm/verify/domain/DomainVerificationInfo;
    ...
    invoke-virtual {v4, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-virtual {v3, v6, v7}, Landroid/util/ArrayMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Landroid/content/pm/verify/domain/DomainVerificationState;->convertToInfoState(I)I
    ...
    invoke-virtual {v3, v4, v1}, Landroid/util/ArrayMap;->setValueAt(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_4
    new-instance p2, Landroid/content/pm/verify/domain/DomainVerificationInfo;

    invoke-virtual {v2}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getId()Ljava/util/UUID;

    move-result-object v1

    invoke-direct {p2, v1, p1, v3}, Landroid/content/pm/verify/domain/DomainVerificationInfo;-><init>(Ljava/util/UUID;Ljava/lang/String;Ljava/util/Map;)V
...
.method public synthetic lambda$getDomainVerificationUserState$6$DomainVerificationService(Ljava/lang/String;ILjava/util/function/Function;)Landroid/content/pm/verify/domain/DomainVerificationUserState;
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-virtual {v2, p2}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getUserState(I)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    invoke-virtual {p3, v7}, Landroid/util/ArraySet;->valueAt(I)Ljava/lang/Object;
    ...
    :goto_5
    new-instance p3, Landroid/content/pm/verify/domain/DomainVerificationUserState;
    ...
    invoke-direct/range {v3 .. v8}, Landroid/content/pm/verify/domain/DomainVerificationUserState;-><init>(Ljava/util/UUID;Ljava/lang/String;Landroid/os/UserHandle;ZLjava/util/Map;)V
...
.method public synthetic lambda$printOwnersForPackage$14$DomainVerificationService(Ljava/lang/String;Landroid/util/IndentingPrintWriter;Ljava/lang/Integer;Ljava/util/function/Function;)V
    ...
    invoke-direct {p0, p2, v2, p3, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->printOwnersForPackage(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;Ljava/util/function/Function;)V
    :try_end_1
...
.method public synthetic lambda$setDomainVerificationStatusInternal$1$DomainVerificationService(Ljava/util/UUID;Ljava/util/Set;IILjava/util/function/Function;)Ljava/lang/Integer;
    ...
    invoke-static {p5}, Landroid/content/pm/verify/domain/DomainVerificationState;->isModifiable(I)Z
    ...
    invoke-virtual {p1, p3, p5}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->removeUserStatesForDomain(Ljava/lang/String;)V
...
.method public synthetic lambda$setDomainVerificationStatusInternal$2$DomainVerificationService(Landroid/util/ArraySet;ILandroid/util/ArraySet;Ljava/util/function/Function;)V
    ...
    invoke-virtual {v1, v5}, Landroid/util/ArraySet;->retainAll(Ljava/util/Collection;)Z
...
.method public synthetic lambda$setDomainVerificationStatusInternal$3$DomainVerificationService(Ljava/lang/String;Landroid/util/ArraySet;ILandroid/util/ArraySet;Ljava/util/function/Function;)V
    ...
    invoke-virtual {p5}, Lcom/android/server/pm/PackageSetting;->getPkg()Lcom/android/server/pm/parsing/pkg/AndroidPackage;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    iget-object p5, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mCollector:Lcom/android/server/pm/verify/domain/DomainVerificationCollector;

    invoke-virtual {p5, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;

    move-result-object p1

    invoke-virtual {p2, p1}, Landroid/util/ArraySet;->retainAll(Ljava/util/Collection;)Z
    ...
    invoke-virtual {p4, p2}, Landroid/util/ArraySet;->addAll(Landroid/util/ArraySet;)V

    :cond_1
    invoke-direct {p0, v1, p3, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->setDomainVerificationStatusInternal(Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;ILandroid/util/ArraySet;)V
...
.method public synthetic lambda$setDomainVerificationUserSelection$4$DomainVerificationService(Ljava/util/UUID;Ljava/util/Set;IIZLjava/util/function/Function;)Ljava/lang/Integer;
    ...
    invoke-direct {p0, p1, p4, p2, p6}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->revokeOtherUserSelectionsLocked(Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;ILjava/util/Set;Ljava/util/function/Function;)I
...
.method public synthetic lambda$setDomainVerificationUserSelectionInternal$5$DomainVerificationService(Ljava/lang/String;Landroid/util/ArraySet;IZLjava/util/function/Function;)V
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getOrCreateUserState(I)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;

    move-result-object v4

    invoke-direct {p0, v4, v3, p2, p5}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->revokeOtherUserSelectionsLocked(Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;ILjava/util/Set;Ljava/util/function/Function;)I

    if-eqz p4, :cond_2

    invoke-virtual {v4, p2}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->addHosts(Ljava/util/Set;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;

    goto :goto_2

    :cond_2
    invoke-virtual {v4, p2}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->removeHosts(Ljava/util/Set;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    invoke-direct {p0, p1, p3, p2, p5}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->revokeOtherUserSelectionsLocked(Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;ILjava/util/Set;Ljava/util/function/Function;)I
...
.method public synthetic lambda$writeSettings$10$DomainVerificationService(ZLandroid/util/TypedXmlSerializer;ILjava/util/function/Function;)V
    ...
    :try_start_0
    new-instance v1, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda16;

    invoke-direct {v1, p4}, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda16;-><init>(Ljava/util/function/Function;)V
    ...
    iget-object p4, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mAttachedPkgStates:Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;

    invoke-virtual {p1, p2, p4, p3, v1}, Lcom/android/server/pm/verify/domain/DomainVerificationSettings;->writeSettings(Landroid/util/TypedXmlSerializer;Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;ILjava/util/function/Function;)V
...
.method public migrateState(Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;)V
    ...
    invoke-direct {v0, v1, v5, v7}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyImmutableState(Lcom/android/server/pm/PackageSetting;Landroid/util/ArrayMap;Landroid/util/ArraySet;)Z
    ...
    invoke-direct {v0, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->sendBroadcast(Ljava/lang/String;)V
...
.method public setConnection(Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationEnforcer;->setCallback(Lcom/android/server/pm/verify/domain/DomainVerificationEnforcer$Callback;)V
...
.method public setDomainVerificationStatus(Ljava/util/UUID;Ljava/util/Set;I)I
    ...
    const-string v0, "Caller is not allowed to set state code "
...
.method public setDomainVerificationStatusInternal(Ljava/lang/String;ILandroid/util/ArraySet;)V
    ...
    const-string p2, "State must be one of NO_RESPONSE, SUCCESS, APPROVED, or DENIED"
    ...
    new-instance v1, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda13;

    invoke-direct {v1, p0, p3, p2, v0}, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda13;-><init>(Lcom/android/server/pm/verify/domain/DomainVerificationService;Landroid/util/ArraySet;ILandroid/util/ArraySet;)V

    invoke-interface {p1, v1}, Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;->withPackageSettingsSnapshot(Ljava/util/function/Consumer;)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/pm/verify/domain/DomainVerificationService;Ljava/lang/String;Landroid/util/ArraySet;ILandroid/util/ArraySet;)V

    invoke-interface {v1, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;->withPackageSettingsSnapshotThrowing(Lcom/android/internal/util/FunctionalUtils$ThrowingCheckedConsumer;)V
    ...
    invoke-direct {p0, p3}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->removeUserStatesForDomain(Ljava/lang/String;)V
...
.method public setDomainVerificationUserSelection(Ljava/util/UUID;Ljava/util/Set;ZI)I
    ...
    new-instance v8, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda11;
    ...
    invoke-interface {v0, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;->withPackageSettingsSnapshotReturningThrowing(Lcom/android/internal/util/FunctionalUtils$ThrowingCheckedFunction;)Ljava/lang/Object;
...
.method public verifyPackages(Ljava/util/List;Z)V
    ...
    invoke-direct {p0, v0, v3, p2}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->addIfShouldBroadcastLocked(Ljava/util/Collection;Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;Z)V
...
.method public writeSettings(Landroid/util/TypedXmlSerializer;ZI)V
    ...
    iget-object p2, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLegacySettings:Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;

    invoke-virtual {p2, p1}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->writeSettings(Landroid/util/TypedXmlSerializer;)V
