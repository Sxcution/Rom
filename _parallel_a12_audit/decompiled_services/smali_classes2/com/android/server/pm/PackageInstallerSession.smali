...
.method public constructor <init>(Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageSessionProvider;Lcom/android/server/pm/SilentUpdatePolicy;Landroid/os/Looper;Lcom/android/server/pm/StagingManager;IIILcom/android/server/pm/InstallSource;Landroid/content/pm/PackageInstaller$SessionParams;JJLjava/io/File;Ljava/lang/String;[Landroid/content/pm/InstallationFile;Landroid/util/ArrayMap;ZZZZ[IIZZZILjava/lang/String;)V
    ...
    iput-object v10, v0, Lcom/android/server/pm/PackageInstallerSession;->mTransactionLock:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v10, Ljava/lang/Object;

    invoke-direct {v10}, Ljava/lang/Object;-><init>()V

    iput-object v10, v0, Lcom/android/server/pm/PackageInstallerSession;->mProgressLock:Ljava/lang/Object;
    ...
    iput v12, v0, Lcom/android/server/pm/PackageInstallerSession;->mReportedProgress:F

    iput v10, v0, Lcom/android/server/pm/PackageInstallerSession;->mIncrementalProgress:F
    ...
    iput-boolean v11, v0, Lcom/android/server/pm/PackageInstallerSession;->mCommitted:Z

    iput-boolean v11, v0, Lcom/android/server/pm/PackageInstallerSession;->mRelinquished:Z
    ...
    iput-object v10, v0, Lcom/android/server/pm/PackageInstallerSession;->mChildSessions:Landroid/util/SparseArray;
    ...
    iput-object v10, v0, Lcom/android/server/pm/PackageInstallerSession;->mChecksums:Landroid/util/ArrayMap;
    ...
    invoke-direct {v10, p0}, Lcom/android/server/pm/PackageInstallerSession$4;-><init>(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    iput-object v12, v0, Lcom/android/server/pm/PackageInstallerSession;->mContext:Landroid/content/Context;
    ...
    iput-object v12, v0, Lcom/android/server/pm/PackageInstallerSession;->mSilentUpdatePolicy:Lcom/android/server/pm/SilentUpdatePolicy;

    new-instance v12, Landroid/os/Handler;

    move-object/from16 v13, p6

    invoke-direct {v12, v13, v10}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v12, v0, Lcom/android/server/pm/PackageInstallerSession;->mHandler:Landroid/os/Handler;
    ...
    iget-object v12, v0, Lcom/android/server/pm/PackageInstallerSession;->mChildSessions:Landroid/util/SparseArray;

    invoke-virtual {v12, v10, v1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V
    ...
    iput v3, v0, Lcom/android/server/pm/PackageInstallerSession;->mParentSessionId:I

    if-eqz v7, :cond_2

    iget-object v3, v0, Lcom/android/server/pm/PackageInstallerSession;->mFiles:Landroid/util/ArraySet;
    ...
    new-instance v12, Lcom/android/server/pm/PackageInstallerSession$FileEntry;

    invoke-direct {v12, v4, v9}, Lcom/android/server/pm/PackageInstallerSession$FileEntry;-><init>(ILandroid/content/pm/InstallationFile;)V
    ...
    iget-object v3, v0, Lcom/android/server/pm/PackageInstallerSession;->mChecksums:Landroid/util/ArrayMap;

    invoke-virtual {v3, v8}, Landroid/util/ArrayMap;->putAll(Landroid/util/ArrayMap;)V
    ...
    iput-boolean v3, v0, Lcom/android/server/pm/PackageInstallerSession;->mDestroyed:Z
    ...
    invoke-direct/range {p1 .. p7}, Lcom/android/server/pm/PackageInstallerSession$StagedSession;-><init>(Lcom/android/server/pm/PackageInstallerSession;ZZZILjava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/PackageInstallerSession;->isSystemDataLoaderInstallation()Z
...
.method static synthetic access$1100(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/pm/PackageInstallerSession;->mCommitted:Z
...
.method static synthetic access$1400(Lcom/android/server/pm/PackageInstallerSession;)Lcom/android/server/pm/StagingManager;
    ...
    iget-object p0, p0, Lcom/android/server/pm/PackageInstallerSession;->mStagingManager:Lcom/android/server/pm/StagingManager;
...
.method private assertCanWrite(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageInstallerSession;->assertShellOrSystemCalling(Ljava/lang/String;)V
    ...
    const-string v0, "Cannot write regular files in a data loader installation session."
...
.method private assertPackageConsistentLocked(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-direct {p3, v2, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
    ...
    iget-wide p3, p0, Lcom/android/server/pm/PackageInstallerSession;->mVersionCode:J
...
.method private canBeAddedAsChild(I)Z
    ...
    :cond_0
    iget-boolean p1, p0, Lcom/android/server/pm/PackageInstallerSession;->mCommitted:Z

    if-nez p1, :cond_1

    iget-boolean p1, p0, Lcom/android/server/pm/PackageInstallerSession;->mDestroyed:Z
...
.method private cleanStageDir(Ljava/util/List;)V
    ...
    invoke-direct {v0}, Lcom/android/server/pm/PackageInstallerSession;->cleanStageDir()V
...
.method private computeUserActionRequirement()I
    ...
    const-string v7, "android.permission.UPDATE_PACKAGES_WITHOUT_USER_ACTION"
    ...
    :goto_5
    iget-object v7, p0, Lcom/android/server/pm/PackageInstallerSession;->mPm:Lcom/android/server/pm/PackageManagerService;

    iget v8, p0, Lcom/android/server/pm/PackageInstallerSession;->userId:I

    invoke-virtual {v7, v1, v2, v8}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;II)I
    ...
    iget-object v10, p0, Lcom/android/server/pm/PackageInstallerSession;->mPm:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual {v10, v1}, Lcom/android/server/pm/PackageManagerService;->getInstallSourceInfo(Ljava/lang/String;)Landroid/content/pm/InstallSourceInfo;
    ...
    invoke-virtual {v0, v2, v4, v5}, Lcom/android/server/pm/PackageManagerService;->isInstallDisabledForPackage(Ljava/lang/String;II)Z
...
.method private createRevocableFdInternal(Landroid/os/RevocableFileDescriptor;Landroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/os/RevocableFileDescriptor;->init(Landroid/content/Context;Ljava/io/FileDescriptor;)V
...
.method private doWriteInternal(Ljava/lang/String;JJLandroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {p0, v0, v6, v7}, Lcom/android/server/pm/PackageInstallerSession;->openTargetInternal(Ljava/lang/String;II)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v13}, Lcom/android/internal/content/PackageHelper;->translateAllocateFlags(I)I
    ...
    sget-object v7, Lcom/android/server/am/BatteryExternalStatsWorker$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/am/BatteryExternalStatsWorker$$ExternalSyntheticLambda7;

    new-instance v8, Lcom/android/server/pm/PackageInstallerSession$$ExternalSyntheticLambda0;

    invoke-direct {v8, p0, v0}, Lcom/android/server/pm/PackageInstallerSession$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/pm/PackageInstallerSession;Landroid/system/Int64Ref;)V
    ...
    invoke-direct {p0, v10, v12}, Lcom/android/server/pm/PackageInstallerSession;->createRevocableFdInternal(Landroid/os/RevocableFileDescriptor;Landroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;
...
.method private extractNativeLibraries(Landroid/content/pm/parsing/PackageLite;Ljava/io/File;Ljava/lang/String;Z)V
    ...
    invoke-static {p4, v0, p3, p1}, Lcom/android/internal/content/NativeLibraryHelper;->copyNativeBinariesWithOverride(Lcom/android/internal/content/NativeLibraryHelper$Handle;Ljava/io/File;Ljava/lang/String;Z)I
    ...
    invoke-direct {p2, p1, p3}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
    ...
    const-string v0, "Failed to extract native libraries"

    invoke-direct {p2, p3, v0, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private generateInfoInternal(ZZ)Landroid/content/pm/PackageInstaller$SessionInfo;
    ...
    iget p1, p1, Landroid/content/pm/PackageInstaller$SessionParams;->autoRevokePermissionsMode:I
...
.method private getDataLoader(I)Landroid/content/pm/IDataLoader;
    ...
    const-string v1, "Failure to obtain data loader"
...
.method private getOrParsePackageLiteLocked(Ljava/io/File;I)Landroid/content/pm/parsing/PackageLite;
    ...
    invoke-direct {p2, v0, v1, p1}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleInstall()V
    ...
    invoke-direct {p0, v0, v4}, Lcom/android/server/pm/PackageInstallerSession;->isApexUpdateAllowed(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/server/pm/PackageInstallerSession;->onSessionValidationFailure(ILjava/lang/String;)V
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/pm/StagingManager;->getSessionIdByPackageName(Ljava/lang/String;)I
...
.method private handleStreamValidateAndCommit()V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/pm/PackageInstallerSession;->onSessionValidationFailure(Lcom/android/server/pm/PackageManagerException;)Lcom/android/server/pm/PackageManagerException;
    ...
    invoke-direct {v3, v2}, Lcom/android/server/pm/PackageInstallerSession;->onSessionValidationFailure(Lcom/android/server/pm/PackageManagerException;)Lcom/android/server/pm/PackageManagerException;
...
.method private install()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/PackageInstallerSession;->onSessionInstallationFailure(ILjava/lang/String;)V
...
.method private installNonStaged()V
    ...
    :try_start_1
    invoke-direct {v7}, Lcom/android/server/pm/PackageInstallerSession;->makeInstallParams()Lcom/android/server/pm/PackageManagerService$InstallParams;
    ...
    :try_start_2
    iget-object v5, p0, Lcom/android/server/pm/PackageInstallerSession;->mRemoteStatusReceiver:Landroid/content/IntentSender;
    ...
    iget v10, v3, Lcom/android/server/pm/PackageManagerException;->error:I
    ...
    invoke-static/range {v4 .. v12}, Lcom/android/server/pm/PackageInstallerSession;->sendOnPackageInstalled(Landroid/content/Context;Landroid/content/IntentSender;IZILjava/lang/String;ILjava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/server/pm/PackageManagerService;->installStage(Lcom/android/server/pm/PackageManagerService$InstallParams;Ljava/util/List;)V
    ...
    const-string v2, "Session should contain at least one apk session for installation"
...
.method private isApexUpdateAllowed(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/SystemConfig;->getModulesInstallerPackageName()Ljava/lang/String;

    move-result-object p1

    if-nez p1, :cond_0

    const-string p1, "No modules installer defined"
...
.method private isFsVerityRequiredForApk(Ljava/io/File;Ljava/io/File;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/PackageInstallerSession;->mResolvedStagedFiles:Ljava/util/List;
    ...
    const-string v0, "Previously staged apk is missing fs-verity signature"

    invoke-direct {p1, p2, v0}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;)V
...
.method private linkFiles(Ljava/util/List;Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/android/server/pm/PackageInstallerSession;->linkFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private logDataLoaderInstallationSession(I)V
    ...
    invoke-virtual {v3, v0, v5, v6}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;II)I
...
.method private makeVerificationParamsLocked()Lcom/android/server/pm/PackageManagerService$VerificationParams;
    ...
    iput-boolean v0, p0, Lcom/android/server/pm/PackageInstallerSession;->mRelinquished:Z
    ...
    iget v0, v6, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    :cond_2
    new-instance v0, Lcom/android/server/pm/PackageManagerService$VerificationParams;
...
.method private markAsSealed(Landroid/content/IntentSender;Z)Z
    ...
    invoke-static {v1, v4}, Lcom/android/server/pm/PackageInstallerSession;->isSecureFrpInstallAllowed(Landroid/content/Context;I)Z
    ...
    const-string p2, "Can\'t install packages while in secure FRP"
    ...
    invoke-virtual {p2, v1, v4}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
...
.method private maybeStageDexMetadataLocked(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/pm/PackageInstallerSession;->stageFileLocked(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/android/server/pm/PackageInstallerSession;->maybeStageFsveritySignatureLocked(Ljava/io/File;Ljava/io/File;Z)V
...
.method private maybeStageDigestsLocked(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2, p1, v2}, Lcom/android/server/pm/PackageInstallerSession;->storeBytesToInstallationFile(Ljava/lang/String;Ljava/lang/String;[B)V

    invoke-direct {p0, v0, v0}, Lcom/android/server/pm/PackageInstallerSession;->stageFileLocked(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {p0, p1, v0, p3}, Lcom/android/server/pm/PackageInstallerSession;->storeBytesToInstallationFile(Ljava/lang/String;Ljava/lang/String;[B)V

    invoke-direct {p0, p2, p2}, Lcom/android/server/pm/PackageInstallerSession;->stageFileLocked(Ljava/io/File;Ljava/io/File;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private maybeStageFsveritySignatureLocked(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/pm/PackageInstallerSession;->stageFileLocked(Ljava/io/File;Ljava/io/File;)V
...
.method private onSessionVerificationFailure(ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/server/pm/PackageInstallerSession;->mStagedSession:Lcom/android/server/pm/PackageInstallerSession$StagedSession;

    const/4 p2, 0x1

    invoke-virtual {p1, p2, v0}, Lcom/android/server/pm/PackageInstallerSession$StagedSession;->setSessionFailed(ILjava/lang/String;)V

    iget-object p1, p0, Lcom/android/server/pm/PackageInstallerSession;->mStagingManager:Lcom/android/server/pm/StagingManager;

    iget-object p2, p0, Lcom/android/server/pm/PackageInstallerSession;->mStagedSession:Lcom/android/server/pm/PackageInstallerSession$StagedSession;

    invoke-virtual {p1, p2}, Lcom/android/server/pm/StagingManager;->notifyVerificationComplete(Lcom/android/server/pm/StagingManager$StagedSession;)V
...
.method private parseApkLite()Landroid/content/pm/parsing/PackageLite;
    ...
    const-string v6, "Skipping native library creation for linking due to invalid path: "
...
.method private prepareDataLoaderLocked()Z
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/server/pm/PackageInstallerSession$7;-><init>(Lcom/android/server/pm/PackageInstallerSession;ZZLjava/util/List;Landroid/content/pm/DataLoaderParams;Ljava/util/List;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/pm/PackageManagerService;->getPerUidReadTimeouts()[Landroid/os/incremental/PerUidReadTimeouts;
    ...
    new-instance v8, Lcom/android/server/pm/PackageInstallerSession$8;

    invoke-direct {v8, p0, v10}, Lcom/android/server/pm/PackageInstallerSession$8;-><init>(Lcom/android/server/pm/PackageInstallerSession;Z)V
    ...
    invoke-virtual {v2, v3, v12, v4}, Lcom/android/server/pm/PackageManagerService;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    new-instance v14, Lcom/android/server/pm/PackageInstallerSession$9;

    invoke-direct {v14, p0}, Lcom/android/server/pm/PackageInstallerSession$9;-><init>(Lcom/android/server/pm/PackageInstallerSession;)V
...
.method private prepareForVerification()Lcom/android/server/pm/PackageManagerService$VerificationParams;
    ...
    :try_start_2
    iget-object v6, p0, Lcom/android/server/pm/PackageInstallerSession;->mPackageLite:Landroid/content/pm/parsing/PackageLite;
    ...
    iget-object v8, v8, Landroid/content/pm/PackageInstaller$SessionParams;->abiOverride:Ljava/lang/String;

    invoke-direct {p0}, Lcom/android/server/pm/PackageInstallerSession;->mayInheritNativeLibs()Z

    move-result v9

    invoke-direct {p0, v6, v7, v8, v9}, Lcom/android/server/pm/PackageInstallerSession;->extractNativeLibraries(Landroid/content/pm/parsing/PackageLite;Ljava/io/File;Ljava/lang/String;Z)V
...
.method public static readFromXml(Landroid/util/TypedXmlPullParser;Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Landroid/os/Looper;Lcom/android/server/pm/StagingManager;Ljava/io/File;Lcom/android/server/pm/PackageSessionProvider;Lcom/android/server/pm/SilentUpdatePolicy;)Lcom/android/server/pm/PackageInstallerSession;
    ...
    invoke-virtual {v6, v3, v5, v12}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;II)I

    move-result v5

    const-string v7, "installerUid"

    invoke-interface {v0, v1, v7, v5}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    const-string v7, "installOriginatingPackageName"
    ...
    invoke-interface {v0, v1, v8}, Landroid/util/TypedXmlPullParser;->getAttributeLong(Ljava/lang/String;Ljava/lang/String;)J

    move-result-wide v16

    const-string v8, "updatedMillis"
    ...
    invoke-interface {v0, v1, v8, v9, v10}, Landroid/util/TypedXmlPullParser;->getAttributeLong(Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v18

    const-string v8, "sessionStageDir"
    ...
    :goto_0
    const-string v8, "sessionStageCid"
    ...
    invoke-interface {v0, v1, v8, v10}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v8, "parentSessionId"

    const/4 v14, -0x1

    invoke-interface {v0, v1, v8, v14}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v29

    new-instance v15, Landroid/content/pm/PackageInstaller$SessionParams;

    invoke-direct {v15, v14}, Landroid/content/pm/PackageInstaller$SessionParams;-><init>(I)V

    const-string v8, "multiPackage"

    invoke-interface {v0, v1, v8, v10}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v8

    iput-boolean v8, v15, Landroid/content/pm/PackageInstaller$SessionParams;->isMultiPackage:Z

    const-string v8, "stagedSession"

    invoke-interface {v0, v1, v8, v10}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v8

    iput-boolean v8, v15, Landroid/content/pm/PackageInstaller$SessionParams;->isStaged:Z
    ...
    iput v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->mode:I

    const-string v9, "installFlags"

    invoke-interface {v0, v1, v9}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I

    move-result v9

    iput v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->installFlags:I
    ...
    iput v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->installLocation:I

    const-string v9, "sizeBytes"

    move/from16 v23, v11

    invoke-interface {v0, v1, v9}, Landroid/util/TypedXmlPullParser;->getAttributeLong(Ljava/lang/String;Ljava/lang/String;)J

    move-result-wide v10

    iput-wide v10, v15, Landroid/content/pm/PackageInstaller$SessionParams;->sizeBytes:J
    ...
    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->appPackageName:Ljava/lang/String;

    const-string v9, "appIcon"

    invoke-static {v0, v9}, Lcom/android/internal/util/XmlUtils;->readBitmapAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/graphics/Bitmap;

    move-result-object v9

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->appIcon:Landroid/graphics/Bitmap;
    ...
    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->appLabel:Ljava/lang/String;

    const-string v9, "originatingUri"

    invoke-static {v0, v9}, Lcom/android/internal/util/XmlUtils;->readUriAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v9

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->originatingUri:Landroid/net/Uri;

    nop

    const-string v9, "originatingUid"

    invoke-interface {v0, v1, v9, v14}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v9

    iput v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->originatingUid:I

    const-string v9, "referrerUri"

    invoke-static {v0, v9}, Lcom/android/internal/util/XmlUtils;->readUriAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v9

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->referrerUri:Landroid/net/Uri;

    const-string v9, "abiOverride"

    invoke-static {v0, v9}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->abiOverride:Ljava/lang/String;

    const-string v9, "volumeUuid"

    invoke-static {v0, v9}, Lcom/android/internal/util/XmlUtils;->readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->volumeUuid:Ljava/lang/String;

    const-string v9, "installRason"

    invoke-interface {v0, v1, v9}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I

    move-result v9

    iput v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->installReason:I

    const-string v9, "isDataLoader"

    const/4 v10, 0x0

    invoke-interface {v0, v1, v9, v10}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v9

    if-eqz v9, :cond_1

    new-instance v9, Landroid/content/pm/DataLoaderParams;

    const-string v10, "dataLoaderType"

    invoke-interface {v0, v1, v10}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {v11, v14, v1}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v9, v10, v11, v1}, Landroid/content/pm/DataLoaderParams;-><init>(ILandroid/content/ComponentName;Ljava/lang/String;)V

    iput-object v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->dataLoaderParams:Landroid/content/pm/DataLoaderParams;
    ...
    iput-wide v9, v15, Landroid/content/pm/PackageInstaller$SessionParams;->appIconLastModified:J
    ...
    invoke-interface {v0, v10, v1, v9}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v1

    const-string v14, "isFailed"

    invoke-interface {v0, v10, v14, v9}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v14

    const-string v6, "isApplied"

    invoke-interface {v0, v10, v6, v9}, Landroid/util/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v0, v10, v13, v9}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-static {v1, v6, v14}, Lcom/android/server/pm/PackageInstallerSession;->isStagedSessionStateValid(ZZZ)Z
    ...
    const-string v11, "granted-runtime-permission"
    ...
    const-string v12, "whitelisted-restricted-permission"
    ...
    const-string v12, "auto-revoke-permissions-mode"
    ...
    invoke-interface {v0, v3, v8}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-interface {v0, v12, v2, v3}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-interface {v0, v4, v2, v8}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    const-string v8, "lengthBytes"

    move-object/from16 v51, v2

    const/4 v2, 0x0

    invoke-interface {v0, v2, v8, v4, v5}, Landroid/util/TypedXmlPullParser;->getAttributeLong(Ljava/lang/String;Ljava/lang/String;J)J
    ...
    const-string v3, "sessionChecksum"
    ...
    new-instance v3, Landroid/content/pm/Checksum;
    ...
    invoke-interface {v0, v8, v4, v5}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v4

    const-string v5, "checksumValue"
    ...
    invoke-direct {v3, v4, v5}, Landroid/content/pm/Checksum;-><init>(I[B)V
    ...
    const-string v3, "sessionChecksumSignature"
    ...
    iput-object v10, v15, Landroid/content/pm/PackageInstaller$SessionParams;->whitelistedRestrictedPermissions:Ljava/util/List;
    ...
    sget-object v2, Lcom/android/server/pm/PackageInstallerSession;->EMPTY_INSTALLATION_FILE_ARRAY:[Landroid/content/pm/InstallationFile;
    ...
    new-instance v8, Lcom/android/server/pm/PackageInstallerSession$PerFileChecksum;

    invoke-interface {v5}, Ljava/util/List;->size()I

    move-result v9

    new-array v9, v9, [Landroid/content/pm/Checksum;
    ...
    invoke-direct {v8, v5, v6}, Lcom/android/server/pm/PackageInstallerSession$PerFileChecksum;-><init>([Landroid/content/pm/Checksum;[B)V
    ...
    invoke-static {v4, v7, v1, v3}, Lcom/android/server/pm/InstallSource;->create(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/pm/InstallSource;

    move-result-object v14

    move/from16 v1, v32

    new-instance v38, Lcom/android/server/pm/PackageInstallerSession;
...
.method private unsafeGetCertsWithoutVerification(Ljava/lang/String;)Landroid/content/pm/PackageParser$SigningDetails;
    ...
    const-string v3, "Couldn\'t obtain signatures from APK : "
...
.method private validateApexInstallLocked()V
    ...
    invoke-direct {p0, v0, v2, v1}, Lcom/android/server/pm/PackageInstallerSession;->resolveAndStageFileLocked(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    iput-wide v0, p0, Lcom/android/server/pm/PackageInstallerSession;->mVersionCode:J
...
.method private validateApkInstallLocked()Landroid/content/pm/parsing/PackageLite;
    ...
    invoke-virtual {v0, v3, v5, v4}, Lcom/android/server/pm/PackageManagerService;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    const-string v14, "PackageInstallerSession"
    ...
    invoke-virtual {v11}, Landroid/content/pm/parsing/result/ParseTypeImpl;->reset()Landroid/content/pm/parsing/result/ParseInput;

    move-result-object v15

    const/16 v4, 0x20

    invoke-static {v15, v13, v4}, Landroid/content/pm/parsing/ApkLiteParseUtils;->parseApkLite(Landroid/content/pm/parsing/result/ParseInput;Ljava/io/File;I)Landroid/content/pm/parsing/result/ParseResult;
    ...
    invoke-virtual {v4}, Landroid/content/pm/parsing/ApkLite;->getSplitName()Ljava/lang/String;

    move-result-object v15

    invoke-virtual {v9, v15}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z
    ...
    iput-object v15, v1, Lcom/android/server/pm/PackageInstallerSession;->mPackageName:Ljava/lang/String;

    move-object/from16 v16, v3

    invoke-virtual {v4}, Landroid/content/pm/parsing/ApkLite;->getLongVersionCode()J
    ...
    invoke-virtual {v4}, Landroid/content/pm/parsing/ApkLite;->getSigningDetails()Landroid/content/pm/PackageParser$SigningDetails;
    ...
    invoke-direct {v1, v2, v4}, Lcom/android/server/pm/PackageInstallerSession;->assertApkConsistentLocked(Ljava/lang/String;Landroid/content/pm/parsing/ApkLite;)V

    invoke-static {v4}, Landroid/content/pm/parsing/ApkLiteParseUtils;->splitNameToFileName(Landroid/content/pm/parsing/ApkLite;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Landroid/content/pm/parsing/ApkLite;->getInstallLocation()I
    ...
    const-string v3, " drops manifest attribute android:installLocation in "
    ...
    invoke-direct {v1, v13, v3, v2}, Lcom/android/server/pm/PackageInstallerSession;->resolveAndStageFileLocked(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2}, Lcom/android/server/pm/PackageInstallerSession;->unsafeGetCertsWithoutVerification(Ljava/lang/String;)Landroid/content/pm/PackageParser$SigningDetails;
    ...
    invoke-virtual {v12}, Landroid/content/pm/parsing/ApkLite;->isSplitRequired()Z
    ...
    invoke-static {v0, v2, v12, v10, v7}, Landroid/content/pm/parsing/ApkLiteParseUtils;->composePackageLiteFromApks(Landroid/content/pm/parsing/result/ParseInput;Ljava/io/File;Landroid/content/pm/parsing/ApkLite;Landroid/util/ArrayMap;Z)Landroid/content/pm/parsing/result/ParseResult;
    ...
    invoke-static {v2, v6, v10}, Landroid/content/pm/parsing/ApkLiteParseUtils;->parsePackageLite(Landroid/content/pm/parsing/result/ParseInput;Ljava/io/File;I)Landroid/content/pm/parsing/result/ParseResult;
    ...
    invoke-direct {v1, v12, v6, v10, v11}, Lcom/android/server/pm/PackageInstallerSession;->assertPackageConsistentLocked(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-direct {v1, v6}, Lcom/android/server/pm/PackageInstallerSession;->unsafeGetCertsWithoutVerification(Ljava/lang/String;)Landroid/content/pm/PackageParser$SigningDetails;

    move-result-object v6

    iget-object v10, v1, Lcom/android/server/pm/PackageInstallerSession;->mSigningDetails:Landroid/content/pm/PackageParser$SigningDetails;

    invoke-virtual {v10, v6}, Landroid/content/pm/PackageParser$SigningDetails;->signaturesMatchExactly(Landroid/content/pm/PackageParser$SigningDetails;)Z

    move-result v6

    if-eqz v6, :cond_37

    iget-object v6, v1, Lcom/android/server/pm/PackageInstallerSession;->mResolvedBaseFile:Ljava/io/File;
    ...
    invoke-direct {v1, v6}, Lcom/android/server/pm/PackageInstallerSession;->inheritFileLocked(Ljava/io/File;)V
    ...
    const-string v10, "219044664"

    invoke-static {v6, v10}, Landroid/util/EventLog;->writeEvent(ILjava/lang/String;)I

    iget-object v6, v1, Lcom/android/server/pm/PackageInstallerSession;->params:Landroid/content/pm/PackageInstaller$SessionParams;

    const/4 v10, 0x0

    invoke-virtual {v6, v10}, Landroid/content/pm/PackageInstaller$SessionParams;->setDontKillApp(Z)V
    ...
    invoke-direct {v1, v11}, Lcom/android/server/pm/PackageInstallerSession;->inheritFileLocked(Ljava/io/File;)V
    ...
    invoke-static {v10, v15}, Lcom/android/internal/util/ArrayUtils;->contains([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    new-array v10, v5, [Ljava/io/File;
    ...
    :cond_25
    :try_start_0
    invoke-static {v4, v6}, Lcom/android/server/pm/PackageInstallerSession;->getRelativePath(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/pm/PackageInstallerSession;->mIncrementalFileStorages:Landroid/os/incremental/IncrementalFileStorages;

    invoke-virtual {v1}, Landroid/os/incremental/IncrementalFileStorages;->disallowReadLogs()V
...
.method private verifyNonStaged()V
    ...
    const-string v2, "Non-staged multi package install of APEX and APK packages is not supported"
    ...
    :try_start_1
    invoke-direct {v7}, Lcom/android/server/pm/PackageInstallerSession;->prepareForVerification()Lcom/android/server/pm/PackageManagerService$VerificationParams;
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/server/pm/PackageManagerService;->verifyStage(Lcom/android/server/pm/PackageManagerService$VerificationParams;Ljava/util/List;)V
...
.method public addChildSessionId(I)V
    ...
    const-string v0, " have inconsistent rollback settings"
    ...
    const-string v0, " have inconsistent staged settings"
...
.method public commit(Landroid/content/IntentSender;Z)V
    ...
    invoke-direct {v4, p1, p2}, Lcom/android/server/pm/PackageInstallerSession;->markAsSealed(Landroid/content/IntentSender;Z)Z
...
.method public synthetic lambda$doWriteInternal$0$PackageInstallerSession(Landroid/system/Int64Ref;J)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/pm/PackageInstallerSession;->setClientProgressLocked(F)V
...
.method onAfterSessionRead(Landroid/util/SparseArray;)V
    ...
    const-string v2, "Package not valid"
...
.method public openRead(Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    const-string v0, "Cannot read regular files in a data loader installation session."
...
.method public removeChildSessionId(I)V
    ...
    invoke-direct {v1}, Lcom/android/server/pm/PackageInstallerSession;->acquireTransactionLock()V
    ...
    invoke-direct {v1}, Lcom/android/server/pm/PackageInstallerSession;->releaseTransactionLock()V
...
.method public removeFile(ILjava/lang/String;)V
    ...
    const-string p2, "Must specify package name to remove a split"
    ...
    const-string p2, "Cannot add files to non-data loader installation session."
...
.method public removeSplit(Ljava/lang/String;)V
    ...
    const-string v0, "Cannot remove splits in a data loader installation session."
...
.method public setChecksums(Ljava/lang/String;[Landroid/content/pm/Checksum;[B)V
    ...
    new-instance v2, Lcom/android/server/pm/PackageInstallerSession$PerFileChecksum;

    invoke-direct {v2, p2, p3}, Lcom/android/server/pm/PackageInstallerSession$PerFileChecksum;-><init>([Landroid/content/pm/Checksum;[B)V
    ...
    const-string p2, "Duplicate checksums."
    ...
    const-string p2, "Can\'t obtain calling installer\'s package."
...
.method public stageViaHardLink(Ljava/lang/String;)V
    ...
    const-string v0, "link() can only be run by the system"
...
.method public transfer(Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, p1, v0}, Lcom/android/server/pm/InstallSource;->create(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/pm/InstallSource;
...
.method write(Landroid/util/TypedXmlSerializer;Ljava/io/File;)V
    ...
    iget-boolean v3, p0, Lcom/android/server/pm/PackageInstallerSession;->mCommitted:Z
