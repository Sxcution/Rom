...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/res/TypedArray;Z)V
    ...
    invoke-direct {p0, p1, p5}, Lcom/android/server/pm/parsing/pkg/PackageImpl;->setBoolean(IZ)Lcom/android/server/pm/parsing/pkg/ParsedPackage;
...
.method public static buildFakeForDeletion(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/pm/parsing/pkg/AndroidPackage;
    ...
    invoke-interface {p0, p1}, Landroid/content/pm/parsing/ParsingPackage;->setVolumeUuid(Ljava/lang/String;)Landroid/content/pm/parsing/ParsingPackage;

    move-result-object p0

    invoke-interface {p0}, Landroid/content/pm/parsing/ParsingPackage;->hideAsParsed()Ljava/lang/Object;
...
.method public capPermissionPriorities()Lcom/android/server/pm/parsing/pkg/PackageImpl;
    ...
    invoke-virtual {v1, v2}, Landroid/content/pm/parsing/component/ParsedPermissionGroup;->setPriority(I)V
...
.method public markNotActivitiesAsNotExportedIfSingleUser()Lcom/android/server/pm/parsing/pkg/PackageImpl;
    ...
    invoke-virtual {v4, v1}, Landroid/content/pm/parsing/component/ParsedActivity;->setExported(Z)Landroid/content/pm/parsing/component/ParsedMainComponent;
    ...
    invoke-virtual {v4}, Landroid/content/pm/parsing/component/ParsedService;->getFlags()I
    ...
    invoke-virtual {v4, v1}, Landroid/content/pm/parsing/component/ParsedService;->setExported(Z)Landroid/content/pm/parsing/component/ParsedMainComponent;
    ...
    invoke-virtual {v4}, Landroid/content/pm/parsing/component/ParsedProvider;->getFlags()I
    ...
    invoke-virtual {v4, v1}, Landroid/content/pm/parsing/component/ParsedProvider;->setExported(Z)Landroid/content/pm/parsing/component/ParsedMainComponent;
...
.method public setAllComponentsDirectBootAware(Z)Lcom/android/server/pm/parsing/pkg/PackageImpl;
    ...
    invoke-virtual {v3, p1}, Landroid/content/pm/parsing/component/ParsedProvider;->setDirectBootAware(Z)Landroid/content/pm/parsing/component/ParsedMainComponent;
    ...
    invoke-virtual {v2, p1}, Landroid/content/pm/parsing/component/ParsedService;->setDirectBootAware(Z)Landroid/content/pm/parsing/component/ParsedMainComponent;
...
.method public setPackageName(Ljava/lang/String;)Lcom/android/server/pm/parsing/pkg/PackageImpl;
    ...
    invoke-virtual {v2, v3}, Landroid/content/pm/parsing/component/ParsedPermissionGroup;->setPackageName(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Landroid/content/pm/parsing/component/ParsedActivity;->setPackageName(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Landroid/content/pm/parsing/component/ParsedProvider;->setPackageName(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Landroid/content/pm/parsing/component/ParsedService;->setPackageName(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/content/pm/parsing/component/ParsedInstrumentation;->setPackageName(Ljava/lang/String;)V
...
.method public setSeInfoUser(Ljava/lang/String;)Lcom/android/server/pm/parsing/pkg/PackageImpl;
    ...
    iput-object p1, p0, Lcom/android/server/pm/parsing/pkg/PackageImpl;->seInfoUser:Ljava/lang/String;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Lcom/android/server/pm/parsing/pkg/PackageImpl;->seInfoUser:Ljava/lang/String;
