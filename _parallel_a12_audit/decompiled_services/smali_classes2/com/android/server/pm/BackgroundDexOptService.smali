...
.method private idleOptimizePackages(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;J)I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/BackgroundDexOptService;->reconcileSecondaryDexFiles(Lcom/android/server/pm/dex/DexManager;)I
    ...
    invoke-direct {p0, v7}, Lcom/android/server/pm/BackgroundDexOptService;->notifyPackagesUpdated(Landroid/util/ArraySet;)V
    ...
    :try_start_1
    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/BackgroundDexOptService;->shouldDowngrade(J)Z
    ...
    invoke-virtual {p1, v3, v4}, Lcom/android/server/pm/PackageManagerService;->getUnusedPackages(J)Ljava/util/Set;
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/pm/BackgroundDexOptService;->abortIdleOptimizations(J)I
    ...
    :cond_3
    :try_start_3
    invoke-direct {p0, p1, v2, v4}, Lcom/android/server/pm/BackgroundDexOptService;->downgradePackage(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, v2, v10}, Lcom/android/server/pm/BackgroundDexOptService;->downgradePackage(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Z)Z
...
.method private optimizePackages(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;JZLandroid/util/ArraySet;)I
    ...
    :cond_0
    invoke-direct {p0, p1, v0, p5}, Lcom/android/server/pm/BackgroundDexOptService;->optimizePackage(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Z)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p6, v0}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z
...
.method private performDexOptSecondary(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;II)Z
    ...
    new-instance p3, Lcom/android/server/pm/BackgroundDexOptService$$ExternalSyntheticLambda0;

    invoke-direct {p3, p1, v0}, Lcom/android/server/pm/BackgroundDexOptService$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/dex/DexoptOptions;)V
...
.method private postBootUpdate(Landroid/app/job/JobParameters;Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;)V
    ...
    invoke-static {v9, p2}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_1

    :cond_3
    sget-boolean v6, Lcom/android/server/pm/BackgroundDexOptService;->DEBUG:Z
    ...
    const-string v7, "Updating package "
    ...
    invoke-direct {v6, v5, v7, v8}, Lcom/android/server/pm/dex/DexoptOptions;-><init>(Ljava/lang/String;II)V
...
.method private runPostBootUpdate(Landroid/app/job/JobParameters;Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/pm/BackgroundDexOptService$2;-><init>(Lcom/android/server/pm/BackgroundDexOptService;Ljava/lang/String;Landroid/app/job/JobParameters;Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;)V
...
.method public static schedule(Landroid/content/Context;)V
    ...
    const-string v0, "BgDexopt scheduled"
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    const-string p1, "Low storage, skipping this run"
    ...
    const-string p1, "No packages to optimize"
