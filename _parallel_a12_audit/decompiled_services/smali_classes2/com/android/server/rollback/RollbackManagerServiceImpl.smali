...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda9;-><init>(Lcom/android/server/rollback/RollbackManagerServiceImpl;Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->registerUserCallbacks(Landroid/os/UserHandle;)V
...
.method private commitRollbackInternal(ILjava/util/List;Ljava/lang/String;Landroid/content/IntentSender;)V
    ...
    const-string p3, "Rollback unavailable"

    invoke-static {p1, p4, p2, p3}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->sendFailure(Landroid/content/Context;Landroid/content/IntentSender;ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v0, p2, p3, p4}, Lcom/android/server/rollback/Rollback;->commit(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Landroid/content/IntentSender;)V
...
.method private deleteRollback(Lcom/android/server/rollback/Rollback;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/rollback/RollbackManagerServiceImpl;->mRollbackStore:Lcom/android/server/rollback/RollbackStore;

    invoke-virtual {p2, p1}, Lcom/android/server/rollback/RollbackStore;->saveRollbackToHistory(Lcom/android/server/rollback/Rollback;)V
...
.method private destroyCeSnapshotsForExpiredRollbacks(I)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/server/pm/Installer;->destroyCeSnapshotsNotSpecified(I[I)Z
    :try_end_0
    ...
    const-string v2, "Failed to delete snapshots for user: "
...
.method private enableRollback(I)Z
    ...
    const-string p1, "Unable to find session for enabled rollback."
    ...
    const-string p1, "Unable to find parent session for enabled rollback."
    ...
    invoke-direct {p0, v0}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->createNewRollback(Landroid/content/pm/PackageInstaller$SessionInfo;)Lcom/android/server/rollback/Rollback;

    move-result-object v1

    :cond_4
    invoke-direct {p0, v1, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->enableRollbackForPackageSession(Lcom/android/server/rollback/Rollback;Landroid/content/pm/PackageInstaller$SessionInfo;)Z
...
.method private enableRollbackForPackageSession(Lcom/android/server/rollback/Rollback;Landroid/content/pm/PackageInstaller$SessionInfo;)Z
    ...
    invoke-direct {v0, v7, v9}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->computeRollbackDataPolicy(II)I
    ...
    const-string v9, "Enabling rollback for install of "
    ...
    iget v9, v1, Landroid/content/pm/PackageInstaller$SessionInfo;->sessionId:I

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v9, ", rollbackDataPolicy="
    ...
    invoke-direct {v0, v1, v8}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->enableRollbackAllowed(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_0
    :try_start_0
    invoke-direct {v0, v8}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->getPackageInfo(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    :try_start_1
    invoke-direct {v0, v7}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->getPackageInfo(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
...
.method private runExpiration()V
    ...
    iget-object v3, p0, Lcom/android/server/rollback/RollbackManagerServiceImpl;->mRunExpiration:Ljava/lang/Runnable;
...
.method public commitRollback(ILandroid/content/pm/ParceledListSlice;Ljava/lang/String;Landroid/content/IntentSender;)V
    ...
    new-instance v7, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda6;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/rollback/RollbackManagerServiceImpl;ILandroid/content/pm/ParceledListSlice;Ljava/lang/String;Landroid/content/IntentSender;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda10;

    invoke-direct {p2, p0, p1}, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/rollback/RollbackManagerServiceImpl;Lcom/android/internal/util/IndentingPrintWriter;)V

    invoke-direct {p0, p2}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->awaitResult(Ljava/lang/Runnable;)V
...
.method public synthetic lambda$dump$14$RollbackManagerServiceImpl(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/PackageWatchdog;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method public synthetic lambda$new$0$RollbackManagerServiceImpl(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->deleteRollback(Lcom/android/server/rollback/Rollback;Ljava/lang/String;)V
...
.method public synthetic lambda$notifyStagedSession$13$RollbackManagerServiceImpl(I)Ljava/lang/Integer;
    ...
    :cond_2
    invoke-direct {p0, v4, v9}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->enableRollbackForPackageSession(Lcom/android/server/rollback/Rollback;Landroid/content/pm/PackageInstaller$SessionInfo;)Z
    ...
    :cond_5
    iget-object p1, v4, Lcom/android/server/rollback/Rollback;->info:Landroid/content/rollback/RollbackInfo;
...
.method public synthetic lambda$onBootCompleted$11$RollbackManagerServiceImpl()V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/rollback/RollbackManagerServiceImpl;->makeRollbackAvailable(Lcom/android/server/rollback/Rollback;)V
...
.method public synthetic lambda$queueSleepIfNeeded$7$RollbackManagerServiceImpl(J)V
    ...
    const-string p2, "RollbackManagerHandlerThread interrupted"
...
.method public synthetic lambda$snapshotAndRestoreUserData$12$RollbackManagerServiceImpl(Ljava/lang/String;[IILjava/lang/String;I)V
    ...
    invoke-virtual {p1, p5, p2}, Landroid/content/pm/PackageManagerInternal;->finishPackageInstall(IZ)V
...
.method public notifyStagedSession(I)I
    ...
    const-string v0, "notifyStagedSession may only be called by the system."
...
.method public snapshotAndRestoreUserData(Ljava/lang/String;[IIJLjava/lang/String;I)V
    ...
    new-instance p5, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda12;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/rollback/RollbackManagerServiceImpl$$ExternalSyntheticLambda12;-><init>(Lcom/android/server/rollback/RollbackManagerServiceImpl;Ljava/lang/String;[IILjava/lang/String;I)V
    ...
    const-string p2, "snapshotAndRestoreUserData may only be called by the system."
