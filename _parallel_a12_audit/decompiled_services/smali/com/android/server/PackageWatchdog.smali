...
.method private handleFailureImmediately(Ljava/util/List;I)V
    ...
    invoke-interface {v3, p1, p2, v4}, Lcom/android/server/PackageWatchdog$PackageHealthObserver;->onHealthCheckFailed(Landroid/content/pm/VersionedPackage;II)I
    ...
    invoke-interface {v1, p1, p2, v4}, Lcom/android/server/PackageWatchdog$PackageHealthObserver;->execute(Landroid/content/pm/VersionedPackage;II)Z
...
.method private onPropertyChanged(Landroid/provider/DeviceConfig$Properties;)V
    ...
    const-string v0, "Failed to reload device config changes"
...
.method public noteBoot()V
    ...
    invoke-virtual {v3}, Lcom/android/server/PackageWatchdog$BootThreshold;->saveMitigationCountToMetadata()V
...
.method public onPackageFailure(Ljava/util/List;I)V
    ...
    const-string p2, "Could not resolve a list of failing packages"
