...
.method private add(Landroid/os/IBinder;IIZ)Lcom/android/server/TelephonyRegistry$Record;
    ...
    :try_start_1
    iget-object p4, p2, Lcom/android/server/TelephonyRegistry$Record;->deathRecipient:Lcom/android/server/TelephonyRegistry$TelephonyRegistryDeathRecipient;
...
.method private broadcastDataConnectionStateChanged(IILandroid/telephony/PreciseDataConnectionState;)V
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/content/Context;->sendBroadcastMultiplePermissions(Landroid/content/Intent;[Ljava/lang/String;[Ljava/lang/String;)V
...
.method private broadcastServiceStateChanged(Landroid/telephony/ServiceState;II)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/TelephonyRegistry$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/TelephonyRegistry;)V
    ...
    invoke-direct {p0, p1, p3, p2, v4}, Lcom/android/server/TelephonyRegistry;->createServiceStateIntent(Landroid/telephony/ServiceState;IIZ)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1, p3, p2, v1}, Lcom/android/server/TelephonyRegistry;->createServiceStateIntent(Landroid/telephony/ServiceState;IIZ)Landroid/content/Intent;
...
.method private broadcastSignalStrengthChanged(Landroid/telephony/SignalStrength;II)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/TelephonyRegistry;->fillInSignalStrengthNotifierBundle(Landroid/telephony/SignalStrength;Landroid/os/Bundle;)V
...
.method private checkListenerPermission(Ljava/util/Set;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p3, v0}, Lcom/android/server/TelephonyRegistry;->isPhoneStatePermissionRequired(Ljava/util/Set;Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    const-string p3, "android.permission.LISTEN_ALWAYS_REPORTED_SIGNAL_STRENGTH"
...
.method private checkPossibleMissNotify(Lcom/android/server/TelephonyRegistry$Record;I)V
    ...
    :cond_14
    :goto_c
    const-string p1, "checkPossibleMissNotify: events = null."
...
.method private getBackwardCompatibleTelephonyDisplayInfo(Landroid/telephony/TelephonyDisplayInfo;)Landroid/telephony/TelephonyDisplayInfo;
    ...
    invoke-direct {v1, v0, p1}, Landroid/telephony/TelephonyDisplayInfo;-><init>(II)V
...
.method private getNetworkTypeName(I)Ljava/lang/String;
    ...
    :pswitch_e
    const-string p1, "CDMA - EvDo rev. A"

    return-object p1

    :pswitch_f
    const-string p1, "CDMA - EvDo rev. 0"
...
.method private isPhoneStatePermissionRequired(Ljava/util/Set;Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    iget-object p1, p0, Lcom/android/server/TelephonyRegistry;->mConfigurationProvider:Lcom/android/server/TelephonyRegistry$ConfigurationProvider;

    invoke-virtual {p1, p2, p3}, Lcom/android/server/TelephonyRegistry$ConfigurationProvider;->isDisplayInfoReadPhoneStateEnforcedInPlatformCompat(Ljava/lang/String;Landroid/os/UserHandle;)Z
...
.method private listen(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;Ljava/util/Set;ZI)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/TelephonyRegistry;->checkListenerPermission(Ljava/util/Set;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, v3, v6, v2}, Lcom/android/server/TelephonyRegistry;->add(Landroid/os/IBinder;IIZ)Lcom/android/server/TelephonyRegistry$Record;
    ...
    iput-object p3, v1, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;
    ...
    :cond_4
    iput p6, v1, Lcom/android/server/TelephonyRegistry$Record;->subId:I
    ...
    iput-object p4, v1, Lcom/android/server/TelephonyRegistry$Record;->eventList:Ljava/util/Set;

    if-eqz p5, :cond_31

    iget p1, v1, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/server/TelephonyRegistry;->checkFineLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    :cond_5
    invoke-direct {p0, v1, p2}, Lcom/android/server/TelephonyRegistry;->checkCoarseLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    invoke-direct {p0, v1, p1}, Lcom/android/server/TelephonyRegistry;->validateEventAndUserLocked(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    :try_start_9
    invoke-direct {p0, v1, v5}, Lcom/android/server/TelephonyRegistry;->checkCoarseLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    invoke-direct {p0, v1, p5}, Lcom/android/server/TelephonyRegistry;->getCallIncomingNumber(Lcom/android/server/TelephonyRegistry$Record;I)Ljava/lang/String;

    move-result-object p5

    invoke-interface {p1, p3, p5}, Lcom/android/internal/telephony/IPhoneStateListener;->onLegacyCallStateChanged(ILjava/lang/String;)V
    :try_end_b
    ...
    iget p6, v1, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I

    aget p5, p5, p6

    invoke-interface {p1, p3, p5}, Lcom/android/internal/telephony/IPhoneStateListener;->onDataConnectionStateChanged(II)V
    :try_end_f
    ...
    iget-object p3, p0, Lcom/android/server/TelephonyRegistry;->mSignalStrength:[Landroid/telephony/SignalStrength;

    iget p5, v1, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I

    aget-object p3, p3, p5

    invoke-interface {p1, p3}, Lcom/android/internal/telephony/IPhoneStateListener;->onSignalStrengthsChanged(Landroid/telephony/SignalStrength;)V
    :try_end_13
    ...
    invoke-direct {p0, p1}, Lcom/android/server/TelephonyRegistry;->updateReportSignalStrengthDecision(I)V
    :try_end_14
    ...
    invoke-interface {p1, p2}, Lcom/android/internal/telephony/IPhoneStateListener;->onDisplayInfoChanged(Landroid/telephony/TelephonyDisplayInfo;)V
    :try_end_29
    ...
    invoke-direct {p0, v1, v5}, Lcom/android/server/TelephonyRegistry;->checkFineLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    iget-object p3, p0, Lcom/android/server/TelephonyRegistry;->mDataEnabledReason:[I
...
.method private notifyCellLocationForSubscriber(ILandroid/telephony/CellIdentity;Z)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/TelephonyRegistry;->validateEventAndUserLocked(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/TelephonyRegistry;->checkCoarseLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/TelephonyRegistry;->checkFineLocationAccess(Lcom/android/server/TelephonyRegistry$Record;I)Z
...
.method private onMultiSimConfigChanged()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/TelephonyRegistry;->cutListToSize(Ljava/util/List;I)V
    ...
    invoke-direct {v5, v6, v2, v7}, Landroid/telephony/CallAttributes;-><init>(Landroid/telephony/PreciseCallState;ILandroid/telephony/CallQuality;)V
...
.method private remove(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/TelephonyRegistry$Record;->matchTelephonyCallbackEvent(I)Z

    move-result p1

    if-eqz p1, :cond_1

    iget p1, v4, Lcom/android/server/TelephonyRegistry$Record;->subId:I
...
.method private updateReportSignalStrengthDecision(I)V
    ...
    invoke-virtual {p1, v1}, Landroid/telephony/TelephonyManager;->setAlwaysReportSignalStrength(Z)V
...
.method public addOnOpportunisticSubscriptionsChangedListener(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;)V
    ...
    invoke-direct {p0, v1, v2, v3, v4}, Lcom/android/server/TelephonyRegistry;->add(Landroid/os/IBinder;IIZ)Lcom/android/server/TelephonyRegistry$Record;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v4, "mIsDataEnabled="
    ...
    const-string v4, "mDataEnabledReason="
    ...
    const-string v4, "mLinkCapacityEstimateList="
...
.method idMatch(Lcom/android/server/TelephonyRegistry$Record;II)Z
    ...
    :cond_1
    iget p3, p1, Lcom/android/server/TelephonyRegistry$Record;->subId:I
...
.method public listenWithEventList(ILjava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;[IZ)V
    ...
    invoke-interface {p5}, Ljava/util/stream/IntStream;->boxed()Ljava/util/stream/Stream;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/TelephonyRegistry;->listen(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;Ljava/util/Set;ZI)V
...
.method public notifyBarringInfoChanged(IILandroid/telephony/BarringInfo;)V
    ...
    new-instance p3, Landroid/telephony/BarringInfo;

    invoke-direct {p3}, Landroid/telephony/BarringInfo;-><init>()V
