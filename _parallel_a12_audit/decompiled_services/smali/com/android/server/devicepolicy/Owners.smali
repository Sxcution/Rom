...
.method static synthetic access$400(Lcom/android/server/devicepolicy/Owners;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/devicepolicy/Owners;->mDeviceOwnerTypes:Landroid/util/ArrayMap;
...
.method static synthetic access$500(Lcom/android/server/devicepolicy/Owners;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/devicepolicy/Owners;->mDeviceOwnerProtectedPackages:Landroid/util/ArrayMap;
...
.method private readLegacyOwnerFileLocked(Ljava/io/File;)Z
    ...
    :try_start_1
    invoke-interface {v5, v10, v9}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    invoke-interface {v5, v10, v8}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v5, v10, v6}, Landroid/util/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    const-string/jumbo v7, "userId"

    invoke-interface {v5, v10, v7}, Landroid/util/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v9, "Error parsing device-owner file. Bad component name "
    ...
    invoke-static {v5}, Landroid/app/admin/SystemUpdatePolicy;->restoreFromXml(Landroid/util/TypedXmlPullParser;)Landroid/app/admin/SystemUpdatePolicy;
...
.method clearDeviceOwner()V
    ...
    invoke-virtual {v1, v2, v3}, Landroid/content/pm/PackageManagerInternal;->setDeviceOwnerProtectedPackages(Ljava/lang/String;Ljava/util/List;)V
...
.method public dump(Landroid/util/IndentingPrintWriter;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->dump(Landroid/util/IndentingPrintWriter;)V
...
.method isProfileOwnerOfOrganizationOwnedDevice(I)Z
    ...
    iget-boolean p1, p1, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->isOrganizationOwnedDevice:Z
...
.method listAllOwners()Ljava/util/List;
    ...
    iget-object v4, v4, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->admin:Landroid/content/ComponentName;
...
.method load()V
    ...
    const-string v3, "Failed to remove the legacy setting file"
    ...
    new-instance v4, Lcom/android/server/devicepolicy/Owners$ProfileOwnerReadWriter;

    iget v3, v3, Landroid/content/pm/UserInfo;->id:I

    invoke-direct {v4, p0, v3}, Lcom/android/server/devicepolicy/Owners$ProfileOwnerReadWriter;-><init>(Lcom/android/server/devicepolicy/Owners;I)V

    invoke-virtual {v4}, Lcom/android/server/devicepolicy/Owners$ProfileOwnerReadWriter;->readFromFileLocked()V
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/pm/UserManagerInternal;->setDeviceManaged(Z)V
    ...
    invoke-virtual {v3, v4, v2}, Lcom/android/server/pm/UserManagerInternal;->setUserManaged(IZ)V
    ...
    invoke-virtual {v3, v4, v2}, Landroid/content/pm/PackageManagerInternal;->setDeviceOwnerProtectedPackages(Ljava/lang/String;Ljava/util/List;)V
...
.method markProfileOwnerOfOrganizationOwnedDevice(I)V
    ...
    const-string v3, "No profile owner for user %d to set as org-owned."
...
.method setDeviceOwnerProtectedPackages(Ljava/lang/String;Ljava/util/List;)V
    ...
    const-string p2, "Attempting to set device owner protected packages when there is no device owner"
    ...
    const-string v2, "Attempting to set device owner protected packages when the provided package name "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, " does not match the device owner package name"
...
.method setDeviceOwnerType(Ljava/lang/String;I)V
    ...
    const-string p2, "Attempting to set a device owner type when there is no device owner"
    ...
    const-string v2, "Device owner type for "
...
.method transferDeviceOwnership(Landroid/content/ComponentName;)V
    ...
    iget-object p1, p0, Lcom/android/server/devicepolicy/Owners;->mDeviceOwnerTypes:Landroid/util/ArrayMap;

    iget-object v3, v10, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->packageName:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/devicepolicy/Owners;->mDeviceOwnerProtectedPackages:Landroid/util/ArrayMap;
