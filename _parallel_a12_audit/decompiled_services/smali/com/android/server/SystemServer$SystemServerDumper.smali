...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string p1, "Must pass at least one argument to --name"
    ...
    check-cast v4, Lcom/android/server/Dumpable;

    if-nez v4, :cond_4

    const-string p3, "No dummpable named %s\n"
    ...
    invoke-interface {v4, p1, p2}, Lcom/android/server/Dumpable;->dump(Landroid/util/IndentingPrintWriter;[Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-interface {v4}, Lcom/android/server/Dumpable;->getDumpableName()Ljava/lang/String;
    ...
    invoke-interface {v4, v3, p3}, Lcom/android/server/Dumpable;->dump(Landroid/util/IndentingPrintWriter;[Ljava/lang/String;)V
