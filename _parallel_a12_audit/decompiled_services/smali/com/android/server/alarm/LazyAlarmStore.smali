...
.method public addAll(Ljava/util/ArrayList;)V
    ...
    iget-object p1, p0, Lcom/android/server/alarm/LazyAlarmStore;->mAlarms:Ljava/util/ArrayList;

    sget-object v0, Lcom/android/server/alarm/LazyAlarmStore;->sDecreasingTimeOrder:Ljava/util/Comparator;
...
.method public dump(Landroid/util/IndentingPrintWriter;JLjava/text/SimpleDateFormat;)V
    ...
    iget-object p2, p0, Lcom/android/server/alarm/LazyAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;
...
.method public getCount(Ljava/util/function/Predicate;)I
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/alarm/LazyAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;
...
.method public getNextDeliveryTime()J
    ...
    :cond_2
    :goto_1
    iget-object v2, p0, Lcom/android/server/alarm/LazyAlarmStore;->mStatLogger:Lcom/android/internal/util/jobs/StatLogger;

    const/4 v5, 0x0

    invoke-virtual {v2, v5, v0, v1}, Lcom/android/internal/util/jobs/StatLogger;->logDurationStat(IJ)J
