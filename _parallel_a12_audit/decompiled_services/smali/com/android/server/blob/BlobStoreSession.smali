...
.method private closeSession(IZ)V
    ...
    invoke-static {v1}, Lcom/android/server/blob/BlobStoreSession;->stateToString(I)Ljava/lang/String;
...
.method private openReadInternal()Ljava/io/FileDescriptor;
    ...
    const-string v1, "Couldn\'t get the file for this session"
...
.method private openWriteInternal(JJ)Ljava/io/FileDescriptor;
    ...
    iget-object p1, p0, Lcom/android/server/blob/BlobStoreSession;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p1, v0, p3, p4}, Landroid/os/storage/StorageManager;->allocateBytes(Ljava/io/FileDescriptor;J)V
    ...
    const-string p2, "Couldn\'t get the file for this session"
...
.method public allowPackageAccess(Ljava/lang/String;[B)V
    ...
    iget-object v2, p0, Lcom/android/server/blob/BlobStoreSession;->mBlobAccessMode:Lcom/android/server/blob/BlobAccessMode;

    invoke-virtual {v2}, Lcom/android/server/blob/BlobAccessMode;->getAllowedPackagesCount()I
    ...
    invoke-direct {p2, v1}, Landroid/os/LimitExceededException;-><init>(Ljava/lang/String;)V
...
.method public commit(Landroid/app/blob/IBlobCommitCallback;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/blob/BlobStoreSession;->closeSession(IZ)V
...
.method public openWrite(JJ)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/blob/BlobStoreSession;->trackRevocableFdLocked(Landroid/os/RevocableFileDescriptor;)V
    ...
    invoke-static {p4}, Lcom/android/server/blob/BlobStoreSession;->stateToString(I)Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/android/server/blob/BlobStoreSession;->stateToString(I)Ljava/lang/String;
