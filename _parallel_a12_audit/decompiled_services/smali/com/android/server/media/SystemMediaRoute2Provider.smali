...
.method constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;)V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/server/media/SystemMediaRoute2Provider;->updateDeviceRoute(Landroid/media/AudioRoutesInfo;)V
    ...
    invoke-direct {v4, p0, v2}, Lcom/android/server/media/SystemMediaRoute2Provider$AudioManagerBroadcastReceiver;-><init>(Lcom/android/server/media/SystemMediaRoute2Provider;Lcom/android/server/media/SystemMediaRoute2Provider$1;)V
    ...
    invoke-direct {v0, p0, p2}, Lcom/android/server/media/SystemMediaRoute2Provider$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/media/SystemMediaRoute2Provider;Landroid/os/UserHandle;)V
...
.method private updateDeviceRoute(Landroid/media/AudioRoutesInfo;)V
    ...
    iget-object v5, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mCurAudioRoutesInfo:Landroid/media/AudioRoutesInfo;
    ...
    :goto_0
    new-instance p1, Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-direct {p1, v5, v1}, Landroid/media/MediaRoute2Info$Builder;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    :goto_1
    invoke-virtual {p1, v3}, Landroid/media/MediaRoute2Info$Builder;->setVolumeHandling(I)Landroid/media/MediaRoute2Info$Builder;

    move-result-object p1

    iget v1, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mDeviceVolume:I

    invoke-virtual {p1, v1}, Landroid/media/MediaRoute2Info$Builder;->setVolume(I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-virtual {p1, v0}, Landroid/media/MediaRoute2Info$Builder;->setVolumeMax(I)Landroid/media/MediaRoute2Info$Builder;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroid/media/MediaRoute2Info$Builder;->setType(I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-virtual {p1, v4}, Landroid/media/MediaRoute2Info$Builder;->setConnectionState(I)Landroid/media/MediaRoute2Info$Builder;
...
.method private updateProviderState()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/media/SystemMediaRoute2Provider;->setProviderState(Landroid/media/MediaRoute2ProviderInfo;)V
    ...
    const-string v2, "Updating system provider info : "
...
.method public requestCreateSession(JLjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object p3, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mCallback:Lcom/android/server/media/MediaRoute2Provider$Callback;
    ...
    iget-object p4, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mSessionInfos:Ljava/util/List;
...
.method public setRouteVolume(JLjava/lang/String;I)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mAudioManager:Landroid/media/AudioManager;
...
.method public transferToRoute(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/media/BluetoothRouteProvider;->transferTo(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p4}, Lcom/android/server/media/BluetoothRouteProvider;->transferTo(Ljava/lang/String;)V
...
.method updateSessionInfosIfNeeded()Z
    ...
    :cond_2
    iget-object v6, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mUniqueId:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/media/SystemMediaRoute2Provider;->mUniqueId:Ljava/lang/String;
