...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p2}, Lcom/android/server/media/MediaRouterService;->access$400(Lcom/android/server/media/MediaRouterService;)Ljava/lang/Object;
    ...
    iget-boolean v0, v0, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z
    ...
    iput-object p1, v1, Lcom/android/server/media/MediaRouterService;->mActiveBluetoothDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    :goto_0
    iput-boolean p1, v1, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z

    iget-object p1, p0, Lcom/android/server/media/MediaRouterService$MediaRouterServiceBroadcastReceiver;->this$0:Lcom/android/server/media/MediaRouterService;

    iget-boolean p1, p1, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z
    ...
    const-string v1, "GlobalBluetoothA2dpOn is changed to \'"
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaRouterService;->access$700(Lcom/android/server/media/MediaRouterService;)Landroid/util/SparseArray;

    move-result-object p1

    iget-object v0, p0, Lcom/android/server/media/MediaRouterService$MediaRouterServiceBroadcastReceiver;->this$0:Lcom/android/server/media/MediaRouterService;

    invoke-static {v0}, Lcom/android/server/media/MediaRouterService;->access$600(Lcom/android/server/media/MediaRouterService;)I
    ...
    :try_start_1
    iget-object v0, v0, Lcom/android/server/media/MediaRouterService$ClientRecord;->mClient:Landroid/media/IMediaRouterClient;

    iget-object v1, p0, Lcom/android/server/media/MediaRouterService$MediaRouterServiceBroadcastReceiver;->this$0:Lcom/android/server/media/MediaRouterService;

    iget-boolean v1, v1, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z

    invoke-interface {v0, v1}, Landroid/media/IMediaRouterClient;->onGlobalA2dpChanged(Z)V
    :try_end_1
