...
.method private dispatchAdjustVolumeLocked(Ljava/lang/String;Ljava/lang/String;IIZIIIZ)V
    ...
    invoke-direct {p0, v6}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isValidLocalStreamType(I)Z
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/media/MediaSessionService$MessageHandler;->post(Ljava/lang/Runnable;)Z
...
.method private dispatchMediaKeyEventLocked(Ljava/lang/String;IIZLandroid/view/KeyEvent;Z)V
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$2600(Lcom/android/server/media/MediaSessionService$FullUserRecord;)Lcom/android/server/media/MediaSessionRecordImpl;
    ...
    invoke-static {v2, v1}, Lcom/android/server/media/MediaSessionService;->access$3200(Lcom/android/server/media/MediaSessionService;Landroid/media/session/MediaSession$Token;)Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$3900(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaKeyDispatcher;
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$2700(Lcom/android/server/media/MediaSessionService$FullUserRecord;)Lcom/android/server/media/MediaButtonReceiverHolder;
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;->access$4400(Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;)I
...
.method private dispatchVolumeKeyEventLocked(Ljava/lang/String;Ljava/lang/String;IIZLandroid/view/KeyEvent;IZ)V
    ...
    invoke-direct/range {v6 .. v15}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchAdjustVolumeLocked(Ljava/lang/String;Ljava/lang/String;IIZIIIZ)V
...
.method private handleIncomingUser(IIILjava/lang/String;)I
    ...
    const-string v1, "Permission denied while calling from "

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p4, " with user id: "

    invoke-virtual {p2, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, p3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p3, "; Need to run as either the calling user id ("

    invoke-virtual {p2, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p3, "), or with "
...
.method private hasEnabledNotificationListener(ILjava/lang/String;I)Z
    ...
    const-string p1, "Failed to check enabled notification listener. Package name and UID doesn\'t match"
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaSessionService;->access$4200(Lcom/android/server/media/MediaSessionService;)Landroid/app/NotificationManager;
    ...
    invoke-virtual {p1, p2, v1}, Landroid/app/NotificationManager;->hasEnabledNotificationListener(Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    const-string p1, "Failed to check enabled notification listener. Package name doesn\'t exist"
...
.method private startVoiceInput(Z)V
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->access$4500(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->access$4600(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaSessionService;->access$4600(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
...
.method private verifySessionsRequest(Landroid/content/ComponentName;III)I
    ...
    invoke-static {v0, p1, p3, p4, p2}, Lcom/android/server/media/MediaSessionService;->access$4100(Lcom/android/server/media/MediaSessionService;Landroid/content/ComponentName;III)V
...
.method public addOnMediaKeyEventDispatchedListener(Landroid/media/session/IOnMediaKeyEventDispatchedListener;)V
    ...
    invoke-static {v5, v2}, Lcom/android/server/media/MediaSessionService;->access$200(Lcom/android/server/media/MediaSessionService;I)Lcom/android/server/media/MediaSessionService$FullUserRecord;

    move-result-object v5

    if-eqz v5, :cond_1

    invoke-static {v5}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$600(Lcom/android/server/media/MediaSessionService$FullUserRecord;)I
    ...
    invoke-static {p1, v1}, Lcom/android/server/media/MediaSessionService;->access$1300(Lcom/android/server/media/MediaSessionService;I)Ljava/lang/String;
    ...
    const-string v5, "Only the full user can add the listener, userId="
    ...
    const-string v0, "MEDIA_CONTENT_CONTROL permission is required to  add MediaKeyEventDispatchedListener"
...
.method public addOnMediaKeyEventSessionChangedListener(Landroid/media/session/IOnMediaKeyEventSessionChangedListener;)V
    ...
    :cond_0
    invoke-virtual {v5, p1, v1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->addOnMediaKeyEventSessionChangedListenerLocked(Landroid/media/session/IOnMediaKeyEventSessionChangedListener;I)V
    ...
    const-string v0, "MEDIA_CONTENT_CONTROL permission is required to  add MediaKeyEventSessionChangedListener"
...
.method public addSession2TokensListener(Landroid/media/session/ISession2TokensListener;I)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;Landroid/media/session/ISession2TokensListener;)I
    ...
    invoke-direct {v4, v5, p1, p2}, Lcom/android/server/media/MediaSessionService$Session2TokensListenerRecord;-><init>(Lcom/android/server/media/MediaSessionService;Landroid/media/session/ISession2TokensListener;I)V
...
.method public addSessionsListener(Landroid/media/session/IActiveSessionsListener;Landroid/content/ComponentName;I)V
    ...
    invoke-static {p3}, Lcom/android/server/media/MediaSessionService;->access$100(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {v0, p1}, Lcom/android/server/media/MediaSessionService;->access$2800(Lcom/android/server/media/MediaSessionService;Landroid/media/session/IActiveSessionsListener;)I
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaSessionService;->access$2000(Lcom/android/server/media/MediaSessionService;)Ljava/util/ArrayList;
...
.method public createSession(Ljava/lang/String;Landroid/media/session/ISessionCallback;Ljava/lang/String;Landroid/os/Bundle;I)Landroid/media/session/ISession;
    ...
    invoke-static {v0, p1, v2}, Lcom/android/server/media/MediaSessionService;->access$2200(Lcom/android/server/media/MediaSessionService;Ljava/lang/String;I)V
    ...
    invoke-static/range {v0 .. v7}, Lcom/android/server/media/MediaSessionService;->access$2300(Lcom/android/server/media/MediaSessionService;IIILjava/lang/String;Landroid/media/session/ISessionCallback;Ljava/lang/String;Landroid/os/Bundle;)Lcom/android/server/media/MediaSessionRecord;
    ...
    const-string p2, "Invalid session record"
    ...
    const-string p2, "Failed to create a new session record"
...
.method public dispatchMediaKeyEventToSessionAsSystemService(Ljava/lang/String;Landroid/view/KeyEvent;Landroid/media/session/MediaSession$Token;)Z
    ...
    invoke-static {v0, p3}, Lcom/android/server/media/MediaSessionService;->access$3200(Lcom/android/server/media/MediaSessionService;Landroid/media/session/MediaSession$Token;)Lcom/android/server/media/MediaSessionRecord;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaSessionService;->access$100(Lcom/android/server/media/MediaSessionService;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lcom/android/server/media/MediaSessionService;->access$1700(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-static {p3}, Lcom/android/server/media/MediaSessionService;->access$3600(Lcom/android/server/media/MediaSessionService;)Landroid/util/SparseArray;
    ...
    invoke-static {p3}, Lcom/android/server/media/MediaSessionService;->access$1000(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/AudioPlayerStateMonitor;
    ...
    invoke-static {p2, p1}, Lcom/android/server/media/MediaSessionDeviceConfig;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method public getMediaKeyEventSession()Landroid/media/session/MediaSession$Token;
    ...
    invoke-static {v1, v2}, Lcom/android/server/media/MediaSessionService;->access$200(Lcom/android/server/media/MediaSessionService;I)Lcom/android/server/media/MediaSessionService$FullUserRecord;
    ...
    const-string v7, "No matching user record to get the media key event session, userId="
    ...
    :try_start_3
    instance-of v0, v1, Lcom/android/server/media/MediaSessionRecord;
    ...
    const-string v1, "MEDIA_CONTENT_CONTROL permission is required to get the media key event session"
...
.method public getMediaKeyEventSessionPackageName()Ljava/lang/String;
    ...
    const-string v6, "No matching user record to get the media key event session package , userId="
    ...
    instance-of v5, v2, Lcom/android/server/media/MediaSessionRecord;

    if-eqz v5, :cond_1

    invoke-interface {v2}, Lcom/android/server/media/MediaSessionRecordImpl;->getPackageName()Ljava/lang/String;
    ...
    :cond_1
    :try_start_3
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$2700(Lcom/android/server/media/MediaSessionService$FullUserRecord;)Lcom/android/server/media/MediaButtonReceiverHolder;
    ...
    const-string v1, "MEDIA_CONTENT_CONTROL permission is required to get the media key event session package"
...
.method public getSessions(Landroid/content/ComponentName;I)Ljava/util/List;
    ...
    invoke-static {v1, p1}, Lcom/android/server/media/MediaSessionService;->access$2400(Lcom/android/server/media/MediaSessionService;I)Ljava/util/List;
...
.method public isTrusted(Ljava/lang/String;II)Z
    ...
    invoke-static {v3, p2, p3}, Lcom/android/server/media/MediaSessionService;->access$2500(Lcom/android/server/media/MediaSessionService;II)Z

    move-result p2

    if-nez p2, :cond_1

    invoke-direct {p0, v0, p1, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->hasEnabledNotificationListener(ILjava/lang/String;I)Z
...
.method public removeOnMediaKeyEventDispatchedListener(Landroid/media/session/IOnMediaKeyEventDispatchedListener;)V
    ...
    const-string v5, "Only the full user can remove the listener, userId="
    ...
    const-string v0, "MEDIA_CONTENT_CONTROL permission is required to  remove MediaKeyEventDispatchedListener"
...
.method public removeOnMediaKeyEventSessionChangedListener(Landroid/media/session/IOnMediaKeyEventSessionChangedListener;)V
    ...
    const-string v0, "MEDIA_CONTENT_CONTROL permission is required to  remove MediaKeyEventSessionChangedListener"
...
.method public removeSession2TokensListener(Landroid/media/session/ISession2TokensListener;)V
    ...
    invoke-static {v3, p1}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;Landroid/media/session/ISession2TokensListener;)I
...
.method public setOnMediaKeyListener(Landroid/media/session/IOnMediaKeyListener;)V
    ...
    invoke-static {v5, v4}, Lcom/android/server/media/MediaSessionService;->access$200(Lcom/android/server/media/MediaSessionService;I)Lcom/android/server/media/MediaSessionService$FullUserRecord;
    ...
    :cond_0
    invoke-static {v5}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$3000(Lcom/android/server/media/MediaSessionService$FullUserRecord;)Landroid/media/session/IOnMediaKeyListener;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-static {v5}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$3400(Lcom/android/server/media/MediaSessionService$FullUserRecord;)I
    ...
    :cond_1
    :try_start_2
    invoke-static {v5, p1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$3002(Lcom/android/server/media/MediaSessionService$FullUserRecord;Landroid/media/session/IOnMediaKeyListener;)Landroid/media/session/IOnMediaKeyListener;

    invoke-static {v5, v1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$3402(Lcom/android/server/media/MediaSessionService$FullUserRecord;I)I
    ...
    invoke-static {v6, v1}, Lcom/android/server/media/MediaSessionService;->access$1300(Lcom/android/server/media/MediaSessionService;I)Ljava/lang/String;
...
.method public setOnVolumeKeyLongPressListener(Landroid/media/session/IOnVolumeKeyLongPressListener;)V
    ...
    :cond_0
    invoke-static {v5}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$800(Lcom/android/server/media/MediaSessionService$FullUserRecord;)Landroid/media/session/IOnVolumeKeyLongPressListener;
    ...
    :cond_1
    :try_start_2
    invoke-static {v5, p1}, Lcom/android/server/media/MediaSessionService$FullUserRecord;->access$802(Lcom/android/server/media/MediaSessionService$FullUserRecord;Landroid/media/session/IOnVolumeKeyLongPressListener;)Landroid/media/session/IOnVolumeKeyLongPressListener;
...
.method public setSessionPolicies(Landroid/media/session/MediaSession$Token;I)V
    ...
    invoke-static {v3, v4}, Lcom/android/server/media/MediaSessionService;->access$200(Lcom/android/server/media/MediaSessionService;I)Lcom/android/server/media/MediaSessionService$FullUserRecord;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/media/MediaSessionStack;->updateMediaButtonSessionBySessionPolicyChange(Lcom/android/server/media/MediaSessionRecord;)V
