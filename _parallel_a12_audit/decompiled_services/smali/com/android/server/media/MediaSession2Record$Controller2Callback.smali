...
.method public onConnected(Landroid/media/MediaController2;Landroid/media/Session2CommandGroup;)V
    ...
    invoke-static {p1}, Lcom/android/server/media/MediaSession2Record;->access$300(Lcom/android/server/media/MediaSession2Record;)Ljava/lang/Object;
    ...
    invoke-static {p2, v0}, Lcom/android/server/media/MediaSession2Record;->access$402(Lcom/android/server/media/MediaSession2Record;Z)Z

    iget-object p2, p0, Lcom/android/server/media/MediaSession2Record$Controller2Callback;->this$0:Lcom/android/server/media/MediaSession2Record;

    invoke-static {p2}, Lcom/android/server/media/MediaSession2Record;->access$500(Lcom/android/server/media/MediaSession2Record;)Lcom/android/server/media/MediaSessionService;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/media/MediaSessionService;->onSessionActiveStateChanged(Lcom/android/server/media/MediaSessionRecordImpl;)V
...
.method public onDisconnected(Landroid/media/MediaController2;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/media/MediaSession2Record;->access$402(Lcom/android/server/media/MediaSession2Record;Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/media/MediaSessionService;->onSessionDied(Lcom/android/server/media/MediaSessionRecordImpl;)V
...
.method public onPlaybackActiveChanged(Landroid/media/MediaController2;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/media/MediaSessionService;->onSessionPlaybackStateChanged(Lcom/android/server/media/MediaSessionRecordImpl;Z)V
