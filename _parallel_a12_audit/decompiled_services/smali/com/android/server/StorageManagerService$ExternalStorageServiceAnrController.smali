...
.method public getAnrDelayMillis(Ljava/lang/String;I)J
    ...
    const-string v1, "anr_delay_millis"

    invoke-static {v0, v1, p2}, Landroid/provider/DeviceConfig;->getInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    const-string v1, "getAnrDelayMillis for "
...
.method public onAnrDelayCompleted(Ljava/lang/String;I)Z
    ...
    const-string/jumbo v0, "onAnrDelayCompleted for "
...
.method public onAnrDelayStarted(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2, v3, v2}, Lcom/android/server/storage/StorageSessionController;->notifyAnrDelayStarted(Ljava/lang/String;III)V
    :try_end_0
    ...
    const-string v2, "Failed to notify ANR delay started for "
