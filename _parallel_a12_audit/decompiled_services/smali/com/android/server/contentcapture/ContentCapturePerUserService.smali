...
.method constructor <init>(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/Object;ZILandroid/os/Handler;)V
    ...
    new-instance p1, Lcom/android/server/contentcapture/ContentCapturePerUserService$RebindServiceRunnable;

    invoke-direct {p1, p0, p2}, Lcom/android/server/contentcapture/ContentCapturePerUserService$RebindServiceRunnable;-><init>(Lcom/android/server/contentcapture/ContentCapturePerUserService;Lcom/android/server/contentcapture/ContentCapturePerUserService$1;)V

    iput-object p1, p0, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mReBindServiceRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$300(Lcom/android/server/contentcapture/ContentCapturePerUserService;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mZombie:Z
...
.method public onServiceDied(Lcom/android/server/contentcapture/RemoteContentCaptureService;)V
    ...
    const-string v2, "The current rebind count "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mRebindCount:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, " is reset."
    ...
    invoke-static {v0, v2}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeServiceEvent(ILandroid/content/ComponentName;)V
    ...
    iget-object v1, p0, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mReBindServiceRunnable:Ljava/lang/Runnable;
...
.method public sendActivityAssistDataLocked(Landroid/os/IBinder;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/contentcapture/ContentCaptureServerSession;->sendActivitySnapshotLocked(Landroid/service/contentcapture/SnapshotData;)V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/server/contentcapture/RemoteContentCaptureService;->onActivitySnapshotRequest(ILandroid/service/contentcapture/SnapshotData;)V
    ...
    const-string v2, "Notified activity assist data for activity: "
...
.method public startSessionLocked(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/content/pm/ActivityPresentationInfo;IIILcom/android/internal/os/IResultReceiver;)V
    ...
    invoke-virtual {v0, v3, v15}, Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;->isWhitelisted(ILandroid/content/ComponentName;)Z
    ...
    iget v4, v12, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mUserId:I
    ...
    iget-object v6, v12, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    iget v9, v12, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mUserId:I
    ...
    iget-object v9, v12, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    invoke-static {v14, v6, v1}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
    ...
    :cond_a
    iget-object v1, v12, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;

    if-nez v1, :cond_b

    invoke-direct {v12, v3}, Lcom/android/server/contentcapture/ContentCapturePerUserService;->updateRemoteServiceLocked(Z)V
    ...
    invoke-static {v14, v6, v0}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
