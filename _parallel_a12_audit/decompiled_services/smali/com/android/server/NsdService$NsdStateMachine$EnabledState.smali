...
.method private handleNativeEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    iget-object v4, v1, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->this$1:Lcom/android/server/NsdService$NsdStateMachine;

    iget-object v4, v4, Lcom/android/server/NsdService$NsdStateMachine;->this$0:Lcom/android/server/NsdService;

    invoke-static {v4}, Lcom/android/server/NsdService;->access$100(Lcom/android/server/NsdService;)Landroid/util/SparseArray;
    ...
    check-cast v4, Lcom/android/server/NsdService$ClientInfo;
    ...
    const-string v0, "id %d for %s has no client mapping"
    ...
    :cond_0
    invoke-static {v4, v3}, Lcom/android/server/NsdService$ClientInfo;->access$3200(Lcom/android/server/NsdService$ClientInfo;I)I
    ...
    const-string v0, "Notification %s for listener id %d that is no longer active"
    ...
    const-string v9, "Native daemon message %s: %s"
    ...
    :pswitch_0
    :try_start_0
    invoke-static {v4}, Lcom/android/server/NsdService$ClientInfo;->access$3000(Lcom/android/server/NsdService$ClientInfo;)Landroid/net/nsd/NsdServiceInfo;
    ...
    invoke-virtual {v0, v5}, Landroid/net/nsd/NsdServiceInfo;->setHost(Ljava/net/InetAddress;)V

    invoke-static {v4}, Lcom/android/server/NsdService$ClientInfo;->access$3300(Lcom/android/server/NsdService$ClientInfo;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-virtual {v0, v5, v7, v8, v6}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v0, v3}, Lcom/android/server/NsdService;->access$3700(Lcom/android/server/NsdService;I)Z

    invoke-direct {v1, v8, v3, v4}, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->removeRequestMap(IILcom/android/server/NsdService$ClientInfo;)V

    invoke-static {v4, v12}, Lcom/android/server/NsdService$ClientInfo;->access$3002(Lcom/android/server/NsdService$ClientInfo;Landroid/net/nsd/NsdServiceInfo;)Landroid/net/nsd/NsdServiceInfo;
    ...
    const-string v3, "Invalid service found "
    ...
    iget-object v6, v1, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->this$1:Lcom/android/server/NsdService$NsdStateMachine;

    iget-object v6, v6, Lcom/android/server/NsdService$NsdStateMachine;->this$0:Lcom/android/server/NsdService;

    invoke-static {v6, v0}, Lcom/android/server/NsdService;->access$3400(Lcom/android/server/NsdService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v0}, Landroid/net/nsd/NsdServiceInfo;->setServiceName(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5}, Landroid/net/nsd/NsdServiceInfo;->setTxtRecords(Ljava/lang/String;)V

    iget-object v0, v1, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->this$1:Lcom/android/server/NsdService$NsdStateMachine;

    iget-object v0, v0, Lcom/android/server/NsdService$NsdStateMachine;->this$0:Lcom/android/server/NsdService;

    invoke-static {v0, v3}, Lcom/android/server/NsdService;->access$3500(Lcom/android/server/NsdService;I)Z
    ...
    invoke-static {v0}, Lcom/android/server/NsdService;->access$2300(Lcom/android/server/NsdService;)I

    move-result v0

    iget-object v3, v1, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->this$1:Lcom/android/server/NsdService$NsdStateMachine;
    ...
    invoke-static {v3, v0, v5}, Lcom/android/server/NsdService;->access$3600(Lcom/android/server/NsdService;ILjava/lang/String;)Z
    ...
    invoke-direct {v1, v8, v0, v4, v3}, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->storeRequestMap(IILcom/android/server/NsdService$ClientInfo;I)V
    ...
    invoke-direct {v0, v1, v12}, Landroid/net/nsd/NsdServiceInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v3, v8, v0}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v7, v8}, Lcom/android/internal/util/AsyncChannel;->sendMessage(III)V
    ...
    invoke-direct {v0, v1, v3}, Landroid/net/nsd/NsdServiceInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v7, v8, v0}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
...
.method private removeRequestMap(IILcom/android/server/NsdService$ClientInfo;)V
    ...
    invoke-static {p1}, Lcom/android/server/NsdService;->access$100(Lcom/android/server/NsdService;)Landroid/util/SparseArray;
...
.method private storeRequestMap(IILcom/android/server/NsdService$ClientInfo;I)V
    ...
    invoke-static {p1}, Lcom/android/server/NsdService$NsdStateMachine;->access$1400(Lcom/android/server/NsdService$NsdStateMachine;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {p1}, Lcom/android/server/NsdService$NsdStateMachine;->access$2200(Lcom/android/server/NsdService$NsdStateMachine;)Lcom/android/server/NsdService$NsdStateMachine$DisabledState;
    ...
    invoke-static {v0, p1, v3, v1}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-static {v1, v0}, Lcom/android/server/NsdService$ClientInfo;->access$3002(Lcom/android/server/NsdService$ClientInfo;Landroid/net/nsd/NsdServiceInfo;)Landroid/net/nsd/NsdServiceInfo;

    iget v0, p1, Landroid/os/Message;->arg2:I

    iget p1, p1, Landroid/os/Message;->what:I

    invoke-direct {p0, v0, v2, v1, p1}, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->storeRequestMap(IILcom/android/server/NsdService$ClientInfo;I)V
    ...
    invoke-static {v0, p1, v3, v4}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/NsdService;->access$2900(Lcom/android/server/NsdService;I)Z
    ...
    invoke-static {v0, p1, v1}, Lcom/android/server/NsdService;->access$2700(Lcom/android/server/NsdService;Landroid/os/Message;I)V
    ...
    invoke-static {v0, p1, v1, v4}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-static {v0, p1, v6, v2}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-direct {p0, v1, v2, v0, p1}, Lcom/android/server/NsdService$NsdStateMachine$EnabledState;->storeRequestMap(IILcom/android/server/NsdService$ClientInfo;I)V
    ...
    invoke-static {v0, p1, v6, v4}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/NsdService;->access$2600(Lcom/android/server/NsdService;I)Z
    ...
    invoke-static {v0, p1, v7, v2}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
    ...
    invoke-static {v1, p1, v2, v0}, Lcom/android/server/NsdService;->access$2500(Lcom/android/server/NsdService;Landroid/os/Message;ILjava/lang/Object;)V
    ...
    invoke-static {v0, p1, v7, v4}, Lcom/android/server/NsdService;->access$1300(Lcom/android/server/NsdService;Landroid/os/Message;II)V
