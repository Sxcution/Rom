...
.method public nativeAddLogicalAddress(I)I
    ...
    const-string v1, "Failed to add a logical address : "

    invoke-static {v1, p1, v0}, Lcom/android/server/hdmi/HdmiLogger;->error(Ljava/lang/String;Ljava/lang/Exception;[Ljava/lang/Object;)V
...
.method public nativeEnableAudioReturnChannel(IZ)V
    ...
    const-string v0, "Failed to enable/disable ARC : "

    invoke-static {v0, p1, p2}, Lcom/android/server/hdmi/HdmiLogger;->error(Ljava/lang/String;Ljava/lang/Exception;[Ljava/lang/Object;)V
...
.method public nativeGetPortInfos()[Landroid/hardware/hdmi/HdmiPortInfo;
    ...
    invoke-interface {v1}, Landroid/hardware/tv/cec/V1_1/IHdmiCec;->getPortInfo()Ljava/util/ArrayList;
...
.method public nativeIsConnected(I)Z
    ...
    const-string v2, "Failed to get connection info : "

    invoke-static {v2, p1, v1}, Lcom/android/server/hdmi/HdmiLogger;->error(Ljava/lang/String;Ljava/lang/Exception;[Ljava/lang/Object;)V
...
.method public nativeSendCecCommand(II[B)I
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Lcom/android/server/hdmi/HdmiCecController$NativeWrapperImpl11;->mHdmiCec:Landroid/hardware/tv/cec/V1_1/IHdmiCec;

    invoke-interface {p1, v0}, Landroid/hardware/tv/cec/V1_1/IHdmiCec;->sendMessage_1_1(Landroid/hardware/tv/cec/V1_1/CecMessage;)I
    ...
    const-string p3, "Failed to send CEC message : "

    invoke-static {p3, p1, p2}, Lcom/android/server/hdmi/HdmiLogger;->error(Ljava/lang/String;Ljava/lang/Exception;[Ljava/lang/Object;)V
...
.method public nativeSetLanguage(Ljava/lang/String;)V
    ...
    const-string v1, "Failed to set language : "
...
.method public nativeSetOption(IZ)V
    ...
    const-string v0, "Failed to set option : "
...
.method public setCallback(Lcom/android/server/hdmi/HdmiCecController$HdmiCecCallback;)V
    ...
    const-string v1, "Couldn\'t initialise tv.cec callback : "
