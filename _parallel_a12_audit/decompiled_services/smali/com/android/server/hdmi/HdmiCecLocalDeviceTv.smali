...
.method private canStartArcUpdateAction(IZ)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->isDirectConnectAddress(I)Z
...
.method changeMute(Z)V
    ...
    const-string p1, "[A]:System audio is not activated."
...
.method changeVolume(III)V
    ...
    :cond_5
    invoke-virtual {p1, v2}, Lcom/android/server/hdmi/VolumeControlAction;->handleVolumeChange(Z)V
...
.method deviceSelect(ILandroid/hardware/hdmi/IHdmiControlCallback;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->setActiveSource(IILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->setActiveSource(Landroid/hardware/hdmi/HdmiDeviceInfo;Ljava/lang/String;)V
...
.method protected onAddressAllocated(II)V
    ...
    invoke-static {p2}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildRequestActiveSource(I)Lcom/android/server/hdmi/HdmiCecMessage;
...
.method setSystemAudioMode(Z)V
    ...
    const-string p1, "Cannot turn on system audio mode because the System Audio Control feature is disabled."
