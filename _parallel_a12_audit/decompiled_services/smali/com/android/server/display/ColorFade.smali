...
.method private captureScreen()Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    ...
    const-string v1, "Failed to take screenshot. Buffer is null"
...
.method private createEglContext(Z)Z
    ...
    const-string p1, "eglGetDisplay"

    invoke-static {p1}, Lcom/android/server/display/ColorFade;->logEglError(Ljava/lang/String;)V
    ...
    const-string p1, "eglChooseConfig"
    ...
    const-string/jumbo v0, "no valid config found"
...
.method private loadShader(Landroid/content/Context;II)I
    ...
    invoke-static {p2, v0, p1, v1}, Landroid/opengl/GLES20;->glGetShaderiv(II[II)V
...
.method private setScreenshotTextureAndSetViewport(Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;)Z
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/server/display/ColorFade;->ortho(FFFFFF)V
    :try_end_3
...
.method public prepare(Landroid/content/Context;I)Z
    ...
    const-string p2, "Failed to take screenshot because internal display is disconnected"
    ...
    invoke-direct {p0, v5}, Lcom/android/server/display/ColorFade;->createSurfaceControl(Z)Z
    ...
    :cond_4
    invoke-direct {p0, v4}, Lcom/android/server/display/ColorFade;->createEglContext(Z)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-direct {p0, v4, v0}, Lcom/android/server/display/ColorFade;->createEglSurface(ZZ)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-direct {p0, v2}, Lcom/android/server/display/ColorFade;->setScreenshotTextureAndSetViewport(Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;)Z
