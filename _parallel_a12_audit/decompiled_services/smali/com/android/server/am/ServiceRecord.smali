...
.method allowBgActivityStartsOnServiceStart(Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/ServiceRecord;->setAllowedBgActivityStartsByStart(Z)V
    ...
    iget-wide v1, v1, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_BG_ACTIVITY_START_TIMEOUT:J

    invoke-virtual {p1, v0, v1, v2}, Lcom/android/server/am/ActivityManagerService$MainHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method canStopIfKilled(Z)Z
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/am/ServiceRecord;->pendingStarts:Ljava/util/ArrayList;
...
.method public cancelNotification()V
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/am/ActivityManagerService$MainHandler;->post(Ljava/lang/Runnable;)Z
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v0, "mIsAllowedBgActivityStartsByBinding="
    ...
    const-string v0, "mIsAllowedBgActivityStartsByStart="
...
.method public setProcess(Lcom/android/server/am/ProcessRecord;Landroid/app/IApplicationThread;ILcom/android/server/am/UidRecord;)V
    ...
    invoke-virtual {p2, p3}, Lcom/android/server/am/ActivityManagerService$MainHandler;->removeCallbacks(Ljava/lang/Runnable;)V
