...
.method public static isFreezerSupported()Z
    ...
    const-string v4, "Exception closing freezer.killable: "
...
.method public synthetic lambda$enableFreezer$0$CachedAppOptimizer(ZLcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ProcessCachedOptimizerRecord;->setFreezerOverride(Z)V
...
.method public synthetic lambda$updateUseFreezer$1$CachedAppOptimizer(Z)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/am/CachedAppOptimizer$FreezeHandler;-><init>(Lcom/android/server/am/CachedAppOptimizer;Lcom/android/server/am/CachedAppOptimizer$1;)V
    ...
    invoke-static {p1, v0}, Landroid/os/Process;->setThreadGroupAndCpuset(II)V
...
.method shouldCompactBFGS(Lcom/android/server/am/ProcessRecord;J)Z
    ...
    iget-wide v0, p0, Lcom/android/server/am/CachedAppOptimizer;->mCompactThrottleBFGS:J
...
.method shouldCompactPersistent(Lcom/android/server/am/ProcessRecord;J)Z
    ...
    iget-wide v0, p0, Lcom/android/server/am/CachedAppOptimizer;->mCompactThrottlePersistent:J
...
.method unfreezeAppLSP(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v5, "Unable to unfreeze binder for "
    ...
    invoke-virtual {p1, v0, v6, v4, v7}, Lcom/android/server/am/ProcessRecord;->killLocked(Ljava/lang/String;IIZ)V
...
.method unscheduleFreezeAppLSP(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ProcessCachedOptimizerRecord;->setPendingFreeze(Z)V
