...
.method private incrementOpCount(IZ)V
    ...
    :try_start_0
    iget-object p2, p0, Lcom/android/server/am/ActiveServices$AppOpCallback;->mAcceptedOps:Landroid/util/SparseIntArray;

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lcom/android/server/am/ActiveServices$AppOpCallback;->mRejectedOps:Landroid/util/SparseIntArray;
    ...
    invoke-virtual {p2, v1, p1}, Landroid/util/SparseIntArray;->setValueAt(II)V
...
.method private incrementOpCountIfNeeded(III)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/ActiveServices$AppOpCallback;->incrementOpCount(IZ)V
