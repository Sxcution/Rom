...
.method private decideGwpAsanLevel(Lcom/android/server/am/ProcessRecord;)I
    ...
    iget-object p1, p1, Lcom/android/server/am/ProcessRecord;->processInfo:Landroid/content/pm/ProcessInfo;

    iget p1, p1, Landroid/content/pm/ProcessInfo;->gwpAsanMode:I
    ...
    invoke-virtual {p1}, Landroid/content/pm/ApplicationInfo;->getGwpAsanMode()I
...
.method private decideTaggingLevelForAppZygote(Lcom/android/server/am/ProcessRecord;)I
    ...
    invoke-virtual {v1, v2, v3, p1}, Lcom/android/server/compat/PlatformCompat;->isChangeEnabled(JLandroid/content/pm/ApplicationInfo;)Z
...
.method private dumpLruEntryLocked(Ljava/io/PrintWriter;ILcom/android/server/am/ProcessRecord;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Lcom/android/server/am/ProcessList;->makeOomAdjString(IZ)Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/android/server/am/ProcessServiceRecord;->hasClientActivities()Z

    move-result p4

    if-nez p4, :cond_1

    invoke-virtual {p2}, Lcom/android/server/am/ProcessServiceRecord;->isTreatedLikeActivity()Z
...
.method private enableNativeHeapZeroInit(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {p1}, Landroid/content/pm/ApplicationInfo;->getNativeHeapZeroInitialized()I
    ...
    invoke-virtual {v0, v4, v5, p1}, Lcom/android/server/compat/PlatformCompat;->isChangeEnabled(JLandroid/content/pm/ApplicationInfo;)Z
...
.method private getPackageAppDataInfoMap(Landroid/content/pm/PackageManagerInternal;[Ljava/lang/String;I)Ljava/util/Map;
    ...
    :cond_0
    invoke-interface {v4}, Lcom/android/server/pm/parsing/pkg/AndroidPackage;->getVolumeUuid()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v3, p3}, Landroid/content/pm/PackageManagerInternal;->getCeDataInode(Ljava/lang/String;I)J
    ...
    const-string p2, " inode == 0 (b/152760674)"
...
.method private getRequestedMemtagLevel(Lcom/android/server/am/ProcessRecord;)I
    ...
    iget p1, p1, Landroid/content/pm/ProcessInfo;->memtagMode:I

    invoke-direct {p0, p1}, Lcom/android/server/am/ProcessList;->memtagModeToZygoteMemtagLevel(I)I
    ...
    invoke-virtual {p1}, Landroid/content/pm/ApplicationInfo;->getMemtagMode()I
    ...
    invoke-virtual {v0, v2, v3, p1}, Lcom/android/server/compat/PlatformCompat;->isChangeEnabled(JLandroid/content/pm/ApplicationInfo;)Z
...
.method private handleProcessStart(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;[IIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    iget-object v1, v15, Lcom/android/server/am/ProcessRecord;->mPredecessor:Lcom/android/server/am/ProcessRecord;
    ...
    :try_start_0
    invoke-static {v11}, Landroid/os/StrictMode;->setThreadPolicyMask(I)V

    const/16 v0, 0x7d0

    invoke-static {v2, v0}, Landroid/os/Process;->waitForProcessDeath(II)V
    ...
    const-string v4, " has died but its obituary delivery is slow."
    ...
    const-string v4, " has died, but its cleanup isn\'t done"
    ...
    const-string v1, " refused to die, but we need to launch "
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ProcessRecord;->setPendingStart(Z)V
...
.method private handleZygoteMessages(Ljava/io/FileDescriptor;I)I
    ...
    invoke-virtual {p1, v1, v2, p2}, Lcom/android/server/am/AppExitInfoTracker;->handleZygoteSigChld(III)V
    :try_end_0
    ...
    const-string v1, "Exception in reading unsolicited zygote message: "
...
.method private isProcStartValidLocked(Lcom/android/server/am/ProcessRecord;J)Ljava/lang/String;
    ...
    iget-boolean p2, p2, Lcom/android/server/am/ActivityManagerConstants;->FLAG_PROCESS_START_ASYNC:Z
    ...
    :cond_7
    const-string p1, "Package is frozen;"
...
.method static synthetic lambda$updateApplicationInfoLOSP$1(ZLjava/util/List;Lcom/android/server/am/ProcessRecord;Ljava/util/ArrayList;Ljava/lang/String;)V
    ...
    invoke-interface {p0, p4, p1, v0}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
...
.method private needsStorageDataIsolation(Landroid/os/storage/StorageManagerInternal;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {p1, p2}, Landroid/os/storage/StorageManagerInternal;->isExternalStorageService(I)Z
...
.method private startProcess(Lcom/android/server/am/HostingRecord;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;I[IIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Landroid/os/Process$ProcessStartResult;
    ...
    invoke-direct {v0, v13, v14, v2}, Lcom/android/server/am/ProcessList;->checkSlow(JLjava/lang/String;)V
    ...
    :goto_1
    invoke-direct {v0, v3, v4, v15}, Lcom/android/server/am/ProcessList;->getPackageAppDataInfoMap(Landroid/content/pm/PackageManagerInternal;[Ljava/lang/String;I)Ljava/util/Map;
    ...
    iget-object v7, v0, Lcom/android/server/am/ProcessList;->mAppDataIsolationAllowlistedApps:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v11, v1}, Lcom/android/server/am/ProcessList;->needsStorageDataIsolation(Landroid/os/storage/StorageManagerInternal;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {v0, v3, v4, v1}, Lcom/android/server/am/ProcessList;->checkSlow(JLjava/lang/String;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method private updateLruProcessLSP(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;ZZ)V
    ...
    invoke-direct {v9, v10, v0, v3, v2}, Lcom/android/server/am/ProcessList;->updateClientActivitiesOrderingLSP(Lcom/android/server/am/ProcessRecord;III)V
    ...
    invoke-direct {v9, v10, v0, v3, v1}, Lcom/android/server/am/ProcessList;->updateClientActivitiesOrderingLSP(Lcom/android/server/am/ProcessRecord;III)V
...
.method dispatchProcessDied(II)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/am/ProcessList;->mProcessObservers:Landroid/os/RemoteCallbackList;
...
.method dumpLruLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-direct {p0, p1, v0, v4, v1}, Lcom/android/server/am/ProcessList;->dumpLruEntryLocked(Ljava/io/PrintWriter;ILcom/android/server/am/ProcessRecord;Ljava/lang/String;)V
...
.method dumpOomLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Z[Ljava/lang/String;IZLjava/lang/String;Z)Z
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/android/server/am/ProcessList;->printOomLevel(Ljava/io/PrintWriter;Ljava/lang/String;I)V
...
.method getProcessesWithPendingBindMounts(I)Ljava/util/Map;
    ...
    const-string v0, "Pending process is not started yet,retry later"
...
.method handleProcessStartedLocked(Lcom/android/server/am/ProcessRecord;IZJZ)Z
    ...
    invoke-virtual {p1, v12}, Lcom/android/server/am/ProcessRecord;->setPendingStart(Z)V
    ...
    invoke-virtual {p0, p1, v3, v3, v0}, Lcom/android/server/am/ProcessList;->noteAppKill(Lcom/android/server/am/ProcessRecord;IILjava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v10}, Lcom/android/server/Watchdog;->processStarted(Ljava/lang/String;I)V
    ...
    invoke-virtual {v3, v4, v0, v5}, Lcom/android/server/am/ActivityManagerService;->reportUidInfoMessageLocked(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v11}, Lcom/android/server/am/ProcessRecord;->setUsingWrapper(Z)V
...
.method init(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActiveUids;Lcom/android/server/compat/PlatformCompat;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ProcessList$KillHandler;->getLooper()Landroid/os/Looper;
...
.method public killAppZygoteIfNeededLocked(Landroid/os/AppZygote;Z)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/server/am/ProcessList$IsolatedUidRangeAllocator;->freeUidRangeLocked(Landroid/content/pm/ApplicationInfo;)V
...
.method newProcessRecordLocked(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;ZILcom/android/server/am/HostingRecord;)Lcom/android/server/am/ProcessRecord;
    ...
    :goto_1
    iget-object p5, p0, Lcom/android/server/am/ProcessList;->mAppExitInfoTracker:Lcom/android/server/am/AppExitInfoTracker;

    iget-object p5, p5, Lcom/android/server/am/AppExitInfoTracker;->mIsolatedUidRecords:Lcom/android/server/am/AppExitInfoTracker$IsolatedUidRecords;

    iget v3, p1, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {p5, v1, v3}, Lcom/android/server/am/AppExitInfoTracker$IsolatedUidRecords;->addIsolatedUid(II)V

    iget-object p5, p0, Lcom/android/server/am/ProcessList;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {p5}, Lcom/android/server/am/ActivityManagerService;->getPackageManagerInternal()Landroid/content/pm/PackageManagerInternal;
    ...
    invoke-static {p5, v3, v1, v2}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIII)V
    ...
    iget-object p2, p5, Lcom/android/server/am/ProcessRecord;->mState:Lcom/android/server/am/ProcessStateRecord;
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/am/ProcessStateRecord;->setCurrentSchedulingGroup(I)V

    invoke-virtual {p2, p1}, Lcom/android/server/am/ProcessStateRecord;->setSetSchedGroup(I)V

    invoke-virtual {p5, v2}, Lcom/android/server/am/ProcessRecord;->setPersistent(Z)V

    const/16 p1, -0x320

    invoke-virtual {p2, p1}, Lcom/android/server/am/ProcessStateRecord;->setMaxAdj(I)V
...
.method public onLmkdConnect(Ljava/io/OutputStream;)Z
    ...
    invoke-virtual {p1, v5, v1, v2}, Ljava/io/OutputStream;->write([BII)V
...
.method removeLruProcessLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/server/am/ActivityManagerService;->removeOomAdjTargetLocked(Lcom/android/server/am/ProcessRecord;Z)V
...
.method removeProcessLocked(Lcom/android/server/am/ProcessRecord;ZZIILjava/lang/String;)Z
    ...
    invoke-virtual {v3, v1, v2}, Lcom/android/server/am/ProcessList$MyProcessMap;->get(Ljava/lang/String;I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2, p1}, Lcom/android/server/am/ActivityManagerService$MainHandler;->removeMessages(ILjava/lang/Object;)V
...
.method startProcessLocked(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;ZILcom/android/server/am/HostingRecord;IZZILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/Runnable;)Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {p0, v7, v0}, Lcom/android/server/am/ProcessList;->getProcessRecordLocked(Ljava/lang/String;I)Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v1, v6, Lcom/android/server/am/ProcessList;->mDyingProcesses:Lcom/android/internal/app/ProcessMap;

    iget v2, v8, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {v1, v7, v2}, Lcom/android/internal/app/ProcessMap;->get(Ljava/lang/String;I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ProcessRecord;->setIsolatedEntryPoint(Ljava/lang/String;)V

    move-object/from16 v1, p12

    invoke-virtual {v0, v1}, Lcom/android/server/am/ProcessRecord;->setIsolatedEntryPointArgs([Ljava/lang/String;)V

    if-eqz v14, :cond_c

    iput-object v14, v0, Lcom/android/server/am/ProcessRecord;->mPredecessor:Lcom/android/server/am/ProcessRecord;

    iput-object v0, v14, Lcom/android/server/am/ProcessRecord;->mSuccessor:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v1, v8}, Lcom/android/server/am/ActivityManagerService;->isAllowedWhileBooting(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/server/am/ProcessList;->startProcessLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/HostingRecord;ILjava/lang/String;)Z
...
.method startProcessLocked(Lcom/android/server/am/HostingRecord;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;I[IIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Z
    ...
    invoke-virtual {v9, v14}, Lcom/android/server/am/ProcessRecord;->setPendingStart(Z)V

    const/4 v1, 0x0

    invoke-virtual {v9, v1}, Lcom/android/server/am/ProcessRecord;->setRemoved(Z)V
    ...
    invoke-virtual {v9, v1}, Lcom/android/server/am/ProcessRecord;->setKilledByAm(Z)V

    invoke-virtual {v9, v1}, Lcom/android/server/am/ProcessRecord;->setKilled(Z)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/server/am/ProcessRecord;->setDisabledCompatChanges([J)V
    ...
    invoke-virtual {v9, v12, v13}, Lcom/android/server/am/ProcessRecord;->setStartSeq(J)V
    ...
    new-instance v15, Lcom/android/server/am/ProcessList$$ExternalSyntheticLambda1;
    ...
    invoke-virtual {v9, v1}, Lcom/android/server/am/ProcessRecord;->setPendingStart(Z)V
...
.method startProcessLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/HostingRecord;IZZLjava/lang/String;)Z
    ...
    invoke-interface {v3, v5, v6, v7}, Landroid/content/pm/IPackageManager;->getPackageGids(Ljava/lang/String;II)[I
    ...
    :cond_4
    invoke-direct {v14, v7, v2, v5, v6}, Lcom/android/server/am/ProcessList;->computeGidsForProcess(II[IZ)[I
    ...
    const-string v7, ": ART verification disabled"
...
.method updateApplicationInfoLOSP(Ljava/util/List;IZ)V
    ...
    invoke-virtual {p1, v0, p3}, Lcom/android/server/wm/ActivityTaskManagerService;->updateAssetConfiguration(Ljava/util/List;Z)V
...
.method updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZLcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {p0, p1, p3, v0, v2}, Lcom/android/server/am/ProcessList;->updateLruProcessLSP(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;ZZ)V
