...
.method public handleUnsolicitedMessage(Ljava/io/DataInputStream;I)Z
    ...
    invoke-static {p1}, Lcom/android/server/am/LmkdStatsReporter;->logStateChanged(I)V
    ...
    invoke-virtual {v1, p2, p1}, Lcom/android/server/am/AppExitInfoTracker;->scheduleNoteLmkdProcKilled(II)V
    :try_end_0
    ...
    const-string p2, "Invalid buffer data. Failed to log LMK_KILL_OCCURRED"
