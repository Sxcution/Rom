...
.method private isActive(Landroid/location/util/identity/CallerIdentity;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/location/injector/SettingsHelper;->isLocationEnabled(I)Z
    ...
    invoke-virtual {v0, v2, p1}, Lcom/android/server/location/injector/SettingsHelper;->isLocationPackageBlacklisted(ILjava/lang/String;)Z
...
.method public addGeofence(Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p4, v2}, Lcom/android/server/location/geofence/GeofenceManager;->putRegistration(Ljava/lang/Object;Lcom/android/server/location/listeners/ListenerRegistration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected isActive(Lcom/android/server/location/geofence/GeofenceManager$GeofenceRegistration;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/location/geofence/GeofenceManager;->isActive(Landroid/location/util/identity/CallerIdentity;)Z
...
.method protected mergeRegistrations(Ljava/util/Collection;)Landroid/location/LocationRequest;
    ...
    invoke-virtual {v8}, Lcom/android/server/location/geofence/GeofenceManager$GeofenceRegistration;->getRequest()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/android/server/location/injector/SettingsHelper;->getBackgroundThrottleProximityAlertIntervalMs()J
    ...
    invoke-direct {p1, v0, v1}, Landroid/location/LocationRequest$Builder;-><init>(J)V

    const-wide/16 v0, 0x0

    invoke-virtual {p1, v0, v1}, Landroid/location/LocationRequest$Builder;->setMinUpdateIntervalMillis(J)Landroid/location/LocationRequest$Builder;

    move-result-object p1

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Landroid/location/LocationRequest$Builder;->setHiddenFromAppOps(Z)Landroid/location/LocationRequest$Builder;

    move-result-object p1

    invoke-virtual {p1, v5}, Landroid/location/LocationRequest$Builder;->setWorkSource(Landroid/os/WorkSource;)Landroid/location/LocationRequest$Builder;
...
.method onUserChanged(II)V
    ...
    new-instance p2, Lcom/android/server/location/geofence/GeofenceManager$$ExternalSyntheticLambda7;

    invoke-direct {p2, p1}, Lcom/android/server/location/geofence/GeofenceManager$$ExternalSyntheticLambda7;-><init>(I)V

    invoke-virtual {p0, p2}, Lcom/android/server/location/geofence/GeofenceManager;->updateRegistrations(Ljava/util/function/Predicate;)V
