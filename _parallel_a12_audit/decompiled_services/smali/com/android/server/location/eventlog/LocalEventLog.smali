...
.method public constructor <init>(I)V
    ...
    new-array p1, p1, [Lcom/android/server/location/eventlog/LocalEventLog$Log;

    iput-object p1, p0, Lcom/android/server/location/eventlog/LocalEventLog;->mLog:[Lcom/android/server/location/eventlog/LocalEventLog$Log;
...
.method static synthetic access$200(Lcom/android/server/location/eventlog/LocalEventLog;)[Lcom/android/server/location/eventlog/LocalEventLog$Log;
    ...
    iget-object p0, p0, Lcom/android/server/location/eventlog/LocalEventLog;->mLog:[Lcom/android/server/location/eventlog/LocalEventLog$Log;
...
.method private incrementIndex(I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/location/eventlog/LocalEventLog;->wrapIndex(I)I
...
.method public varargs declared-synchronized addLogEvent(I[Ljava/lang/Object;)V
    ...
    iget-wide v5, p0, Lcom/android/server/location/eventlog/LocalEventLog;->mLastLogRealtimeMs:J
    ...
    new-instance v2, Lcom/android/server/location/eventlog/LocalEventLog$FillerEvent;

    invoke-direct {v2, v5, v6}, Lcom/android/server/location/eventlog/LocalEventLog$FillerEvent;-><init>(J)V

    invoke-direct {p0, v2}, Lcom/android/server/location/eventlog/LocalEventLog;->addLogEventInternal(Lcom/android/server/location/eventlog/LocalEventLog$Log;)V
    ...
    :cond_3
    invoke-virtual {p0, v3, v4, p1, p2}, Lcom/android/server/location/eventlog/LocalEventLog;->createLogEvent(JI[Ljava/lang/Object;)Lcom/android/server/location/eventlog/LocalEventLog$LogEvent;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/android/server/location/eventlog/LocalEventLog;->addLogEventInternal(Lcom/android/server/location/eventlog/LocalEventLog$Log;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
