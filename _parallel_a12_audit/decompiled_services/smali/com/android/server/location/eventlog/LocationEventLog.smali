...
.method private getAggregateStats(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;
    ...
    check-cast p2, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;

    if-nez p2, :cond_1

    new-instance p2, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;

    invoke-direct {p2}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;-><init>()V
...
.method protected varargs createLogEvent(JI[Ljava/lang/Object;)Lcom/android/server/location/eventlog/LocalEventLog$LogEvent;
    ...
    invoke-direct {v0, p1, p2, v3}, Lcom/android/server/location/eventlog/LocationEventLog$LocationPowerSaveModeEvent;-><init>(JI)V
    ...
    check-cast v7, Landroid/location/provider/ProviderRequest;
    ...
    check-cast v7, Landroid/location/util/identity/CallerIdentity;
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$ProviderReceiveLocationEvent;-><init>(JLjava/lang/String;I)V
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$ProviderUpdateEvent;-><init>(JLjava/lang/String;Landroid/location/provider/ProviderRequest;)V
    ...
    check-cast v6, Landroid/location/util/identity/CallerIdentity;
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$ProviderMockedEvent;-><init>(JLjava/lang/String;Z)V
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$LocationAdasEnabledEvent;-><init>(JIZ)V
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$LocationEnabledEvent;-><init>(JIZ)V
    ...
    invoke-direct {v0, p1, p2, v4, v3}, Lcom/android/server/location/eventlog/LocationEventLog$UserSwitchedEvent;-><init>(JII)V
...
.method public logAdasLocationEnabled(IZ)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/location/eventlog/LocationEventLog;->addLogEvent(I[Ljava/lang/Object;)V
...
.method public logProviderClientActive(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestActive()V
...
.method public logProviderClientBackground(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestBackground()V
...
.method public logProviderClientForeground(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestForeground()V
...
.method public logProviderClientInactive(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestInactive()V
...
.method public logProviderClientRegistered(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;Landroid/location/LocationRequest;)V
    ...
    invoke-virtual {p1, p2, p3}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestAdded(J)V
...
.method public logProviderClientUnregistered(Ljava/lang/String;Landroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markRequestRemoved()V
...
.method public logProviderDeliveredLocations(Ljava/lang/String;ILandroid/location/util/identity/CallerIdentity;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/eventlog/LocationEventLog$AggregateStats;->markLocationDelivered()V
...
.method public logUserSwitched(II)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/server/location/eventlog/LocationEventLog;->addLogEvent(I[Ljava/lang/Object;)V
