...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lcom/android/server/location/contexthub/ContextHubServiceUtil;->createContextHubInfoMap(Ljava/util/List;)Ljava/util/HashMap;
    ...
    iput-object v2, p0, Lcom/android/server/location/contexthub/ContextHubService;->mContextHubIdToInfoMap:Ljava/util/Map;
    ...
    invoke-direct {p1, v3, v4}, Lcom/android/server/location/contexthub/ContextHubClientManager;-><init>(Landroid/content/Context;Lcom/android/server/location/contexthub/IContextHubWrapper;)V
    ...
    new-instance v3, Lcom/android/server/location/contexthub/ContextHubTransactionManager;
    ...
    invoke-direct {v3, v4, p1, v5}, Lcom/android/server/location/contexthub/ContextHubTransactionManager;-><init>(Landroid/hardware/contexthub/V1_0/IContexthub;Lcom/android/server/location/contexthub/ContextHubClientManager;Lcom/android/server/location/contexthub/NanoAppStateManager;)V
    ...
    iget-object v4, p0, Lcom/android/server/location/contexthub/ContextHubService;->mContextHubIdToInfoMap:Ljava/util/Map;
    ...
    invoke-direct {v5, p0, v3}, Lcom/android/server/location/contexthub/ContextHubService$ContextHubServiceCallback;-><init>(Lcom/android/server/location/contexthub/ContextHubService;I)V

    invoke-virtual {v4, v3, v5}, Lcom/android/server/location/contexthub/IContextHubWrapper;->registerCallback(ILandroid/hardware/contexthub/V1_2/IContexthubCallback;)V
    :try_end_1
    ...
    :goto_2
    invoke-direct {p0, v3}, Lcom/android/server/location/contexthub/ContextHubService;->queryNanoAppsInternal(I)I
    ...
    invoke-direct {p0, v2}, Lcom/android/server/location/contexthub/ContextHubService;->sendWifiSettingUpdate(Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/contexthub/IContextHubWrapper;->supportsMicrophoneDisableSettingNotifications()Z
...
.method private handleHubEventCallback(II)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/location/contexthub/ContextHubClientManager;->onHubReset(I)V
...
.method private handleLoadResponseOldApi(IILandroid/hardware/location/NanoAppBinary;)V
    ...
    invoke-direct {p0, p2, p1, p3, v0}, Lcom/android/server/location/contexthub/ContextHubService;->onMessageReceiptOldApi(III[B)I
...
.method private handleQueryAppsCallback(ILjava/util/List;)V
    ...
    iget-object p1, p0, Lcom/android/server/location/contexthub/ContextHubService;->mTransactionManager:Lcom/android/server/location/contexthub/ContextHubTransactionManager;

    invoke-virtual {p1, v0}, Lcom/android/server/location/contexthub/ContextHubTransactionManager;->onQueryResponse(Ljava/util/List;)V
...
.method private handleTransactionResultCallback(III)V
    ...
    invoke-virtual {p1, p2, p3}, Lcom/android/server/location/contexthub/ContextHubTransactionManager;->onTransactionResponse(II)V
...
.method private handleUnloadResponseOldApi(II)V
    ...
    invoke-direct {p0, p2, p1, v1, v0}, Lcom/android/server/location/contexthub/ContextHubService;->onMessageReceiptOldApi(III[B)I
...
.method private onMessageReceiptOldApi(III[B)I
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/location/contexthub/ContextHubService;->mCallbacksList:Landroid/os/RemoteCallbackList;
...
.method private sendWifiSettingUpdate(Z)V
    ...
    iget-boolean p1, p0, Lcom/android/server/location/contexthub/ContextHubService;->mIsWifiAvailable:Z
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/location/contexthub/IContextHubWrapper;->onWifiSettingChanged(Z)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/location/contexthub/ContextHubService;->dump(Landroid/util/proto/ProtoOutputStream;)V
    ...
    invoke-direct {v0, p2}, Lcom/android/server/location/contexthub/ContextHubService$$ExternalSyntheticLambda3;-><init>(Ljava/io/PrintWriter;)V
...
.method public findNanoAppOnHub(ILandroid/hardware/location/NanoAppFilter;)[I
    ...
    invoke-direct {v1, p2, p1}, Lcom/android/server/location/contexthub/ContextHubService$$ExternalSyntheticLambda1;-><init>(Landroid/hardware/location/NanoAppFilter;Ljava/util/ArrayList;)V

    invoke-virtual {v0, v1}, Lcom/android/server/location/contexthub/NanoAppStateManager;->foreachNanoAppInstanceInfo(Ljava/util/function/Consumer;)V
...
.method public sendMessage(IILandroid/hardware/location/ContextHubMessage;)I
    ...
    iget-object p3, p0, Lcom/android/server/location/contexthub/ContextHubService;->mDefaultClientMap:Ljava/util/Map;
...
.method public unloadNanoApp(I)I
    ...
    invoke-direct {p0, v3}, Lcom/android/server/location/contexthub/ContextHubService;->createUnloadTransactionCallback(I)Landroid/hardware/location/IContextHubTransactionCallback;
