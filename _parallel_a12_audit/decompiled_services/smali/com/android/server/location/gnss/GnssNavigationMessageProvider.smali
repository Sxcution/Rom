...
.method public synthetic lambda$onReportNavigationMessage$1$GnssNavigationMessageProvider(Landroid/location/GnssNavigationMessage;Lcom/android/server/location/gnss/GnssListenerMultiplexer$GnssListenerRegistration;)Lcom/android/internal/listeners/ListenerExecutor$ListenerOperation;
    ...
    new-instance p2, Lcom/android/server/location/gnss/GnssNavigationMessageProvider$$ExternalSyntheticLambda0;

    invoke-direct {p2, p1}, Lcom/android/server/location/gnss/GnssNavigationMessageProvider$$ExternalSyntheticLambda0;-><init>(Landroid/location/GnssNavigationMessage;)V
...
.method protected registerWithService(Ljava/lang/Void;Ljava/util/Collection;)Z
    ...
    iget-object p1, p0, Lcom/android/server/location/gnss/GnssNavigationMessageProvider;->mGnssNative:Lcom/android/server/location/gnss/hal/GnssNative;

    invoke-virtual {p1}, Lcom/android/server/location/gnss/hal/GnssNative;->startNavigationMessageCollection()Z
    ...
    const-string/jumbo p1, "starting gnss navigation messages"
    ...
    :cond_1
    const-string p1, "error starting gnss navigation messages"
