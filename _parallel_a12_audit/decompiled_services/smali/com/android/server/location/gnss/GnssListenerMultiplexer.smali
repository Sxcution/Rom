...
.method private isActive(Landroid/location/util/identity/CallerIdentity;)Z
    ...
    invoke-virtual {p1, v1, v0}, Landroid/location/LocationManagerInternal;->isProviderEnabledForUser(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/location/injector/SettingsHelper;->isLocationPackageBlacklisted(ILjava/lang/String;)Z
...
.method private onProviderEnabledChanged(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/location/gnss/GnssListenerMultiplexer;->updateRegistrations(Ljava/util/function/Predicate;)V
...
.method private onUserChanged(II)V
    ...
    new-instance p2, Lcom/android/server/location/gnss/GnssListenerMultiplexer$$ExternalSyntheticLambda8;

    invoke-direct {p2, p1}, Lcom/android/server/location/gnss/GnssListenerMultiplexer$$ExternalSyntheticLambda8;-><init>(I)V

    invoke-virtual {p0, p2}, Lcom/android/server/location/gnss/GnssListenerMultiplexer;->updateRegistrations(Ljava/util/function/Predicate;)V
...
.method protected addListener(Ljava/lang/Object;Landroid/location/util/identity/CallerIdentity;Landroid/os/IInterface;)V
    ...
    invoke-virtual {p0, v2, p1}, Lcom/android/server/location/gnss/GnssListenerMultiplexer;->putRegistration(Ljava/lang/Object;Lcom/android/server/location/listeners/ListenerRegistration;)V
    :try_end_0
...
.method protected mergeRegistrations(Ljava/util/Collection;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/server/location/gnss/GnssListenerMultiplexer$GnssListenerRegistration;

    invoke-virtual {v0}, Lcom/android/server/location/gnss/GnssListenerMultiplexer$GnssListenerRegistration;->getRequest()Ljava/lang/Object;
...
.method public removeListener(Landroid/os/IInterface;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/location/gnss/GnssListenerMultiplexer;->removeRegistration(Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
