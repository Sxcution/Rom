...
.method static synthetic access$000(Lcom/android/server/location/gnss/GnssMeasurementsProvider;)Lcom/android/server/location/injector/LocationAttributionHelper;
    ...
    iget-object p0, p0, Lcom/android/server/location/gnss/GnssMeasurementsProvider;->mLocationAttributionHelper:Lcom/android/server/location/injector/LocationAttributionHelper;
...
.method public synthetic lambda$onReportMeasurements$1$GnssMeasurementsProvider(Landroid/location/GnssMeasurementsEvent;Lcom/android/server/location/gnss/GnssListenerMultiplexer$GnssListenerRegistration;)Lcom/android/internal/listeners/ListenerExecutor$ListenerOperation;
    ...
    invoke-virtual {v0, v1, p2}, Lcom/android/server/location/injector/AppOpsHelper;->noteOpNoThrow(ILandroid/location/util/identity/CallerIdentity;)Z

    move-result p2

    if-eqz p2, :cond_0

    new-instance p2, Lcom/android/server/location/gnss/GnssMeasurementsProvider$$ExternalSyntheticLambda0;

    invoke-direct {p2, p1}, Lcom/android/server/location/gnss/GnssMeasurementsProvider$$ExternalSyntheticLambda0;-><init>(Landroid/location/GnssMeasurementsEvent;)V
...
.method protected mergeRegistrations(Ljava/util/Collection;)Landroid/location/GnssMeasurementRequest;
    ...
    invoke-virtual {v0}, Lcom/android/server/location/injector/SettingsHelper;->isGnssMeasurementsFullTrackingEnabled()Z
    ...
    invoke-virtual {p1, v0}, Landroid/location/GnssMeasurementRequest$Builder;->setFullTracking(Z)Landroid/location/GnssMeasurementRequest$Builder;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroid/location/GnssMeasurementRequest$Builder;->setCorrelationVectorOutputsEnabled(Z)Landroid/location/GnssMeasurementRequest$Builder;

    move-result-object p1

    invoke-virtual {p1}, Landroid/location/GnssMeasurementRequest$Builder;->build()Landroid/location/GnssMeasurementRequest;
...
.method protected registerWithService(Landroid/location/GnssMeasurementRequest;Ljava/util/Collection;)Z
    ...
    invoke-virtual {p2, v0, v1}, Lcom/android/server/location/gnss/hal/GnssNative;->startMeasurementCollection(ZZ)Z
    ...
    sget-boolean p2, Lcom/android/server/location/gnss/GnssManagerService;->D:Z
    ...
    :cond_1
    const-string p1, "error starting gnss measurements"
