...
.method public synthetic lambda$onReportSvStatus$2$GnssStatusProvider(Landroid/location/GnssStatus;Lcom/android/server/location/gnss/GnssListenerMultiplexer$GnssListenerRegistration;)Lcom/android/internal/listeners/ListenerExecutor$ListenerOperation;
    ...
    new-instance p2, Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda1;

    invoke-direct {p2, p1}, Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda1;-><init>(Landroid/location/GnssStatus;)V
...
.method public onReportStatus(I)V
    ...
    iput-boolean p1, p0, Lcom/android/server/location/gnss/GnssStatusProvider;->mIsNavigating:Z

    if-eqz p1, :cond_0

    sget-object p1, Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda2;

    invoke-virtual {p0, p1}, Lcom/android/server/location/gnss/GnssStatusProvider;->deliverToListeners(Lcom/android/internal/listeners/ListenerExecutor$ListenerOperation;)V

    goto :goto_1

    :cond_0
    sget-object p1, Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/location/gnss/GnssStatusProvider$$ExternalSyntheticLambda3;
...
.method protected registerWithService(Ljava/lang/Void;Ljava/util/Collection;)Z
    ...
    sget-boolean p1, Lcom/android/server/location/gnss/GnssManagerService;->D:Z

    if-eqz p1, :cond_0

    const-string p1, "GnssManager"

    const-string/jumbo p2, "starting gnss status"
