...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/location/injector/Injector;Lcom/android/server/location/gnss/hal/GnssNative;Lcom/android/server/location/gnss/GnssMetrics;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;)V
    ...
    new-instance p4, Lcom/android/server/location/gnss/GnssLocationProvider$ProviderHandler;
    ...
    invoke-direct {p4, p0, v2}, Lcom/android/server/location/gnss/GnssLocationProvider$ProviderHandler;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;Landroid/os/Looper;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/location/gnss/GnssLocationProvider;->setAllowed(Z)V
...
.method static synthetic access$700(Lcom/android/server/location/gnss/GnssLocationProvider;)Lcom/android/server/location/gnss/NtpTimeHelper;
    ...
    iget-object p0, p0, Lcom/android/server/location/gnss/GnssLocationProvider;->mNtpTimeHelper:Lcom/android/server/location/gnss/NtpTimeHelper;
...
.method private handleDownloadPsdsData(I)V
    ...
    const-string v0, "handleDownloadPsdsData() called when PSDS not supported"
...
.method private handleInitialize()V
    ...
    new-instance v4, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda4;

    invoke-direct {v4, p0}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;)V
...
.method private handleReportSvStatus(Landroid/location/GnssStatus;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/location/gnss/GnssMetrics;->logSvStatus(Landroid/location/GnssStatus;)V
...
.method private handleRequestLocation(ZZ)V
    ...
    sget-object p1, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda5;
    ...
    new-instance p1, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda3;

    invoke-direct {p1, p0}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;)V
    ...
    iget p2, v7, Lcom/android/server/location/gnss/GnssConfiguration$HalInterfaceVersion;->mMajor:I
    ...
    const-string v2, "GNSS HAL Requesting location updates from %s provider for %d millis."
    ...
    invoke-virtual {v0, v6, p2, v1, p1}, Landroid/location/LocationManager;->requestLocationUpdates(Ljava/lang/String;Landroid/location/LocationRequest;Ljava/util/concurrent/Executor;Landroid/location/LocationListener;)V
...
.method private requestRefLocation()V
    ...
    :goto_1
    iget-object v7, p0, Lcom/android/server/location/gnss/GnssLocationProvider;->mGnssNative:Lcom/android/server/location/gnss/hal/GnssNative;
    ...
    invoke-virtual/range {v7 .. v12}, Lcom/android/server/location/gnss/hal/GnssNative;->setAgpsReferenceLocationCellId(IIIII)V
...
.method private startBatching(J)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;J)V
    ...
    :cond_1
    const-string/jumbo p1, "native_start_batch failed in startBatching()"
...
.method private startNavigating()V
    ...
    invoke-direct {p0, v3, v2, v0, v4}, Lcom/android/server/location/gnss/GnssLocationProvider;->setPositionMode(IIIZ)Z
...
.method private updateRequirements()V
    ...
    invoke-direct {p0, v0, v2, v3, v4}, Lcom/android/server/location/gnss/GnssLocationProvider;->setPositionMode(IIIZ)Z
...
.method public synthetic lambda$handleDownloadPsdsData$2$GnssLocationProvider([BI)V
    ...
    :try_start_0
    iget-object p2, p0, Lcom/android/server/location/gnss/GnssLocationProvider;->mPsdsBackOff:Lcom/android/server/location/gnss/ExponentialBackOff;

    invoke-virtual {p2}, Lcom/android/server/location/gnss/ExponentialBackOff;->reset()V
...
.method public synthetic lambda$handleDownloadPsdsData$3$GnssLocationProvider(I)V
    ...
    invoke-direct {v2, p0, v0, p1}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda10;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;[BI)V
    ...
    invoke-virtual {v0, v3, p1, v4, v5}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v1, "WakeLock released by handleDownloadPsdsData()"
    ...
    const-string v1, "WakeLock expired before release in handleDownloadPsdsData()"
...
.method public synthetic lambda$startBatching$4$GnssLocationProvider(J)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/gnss/hal/GnssNative;->flushBatch()V
...
.method public onCapabilitiesChanged(Landroid/location/GnssCapabilities;Landroid/location/GnssCapabilities;)V
    ...
    new-instance p2, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda7;

    invoke-direct {p2, p0}, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda7;-><init>(Lcom/android/server/location/gnss/GnssLocationProvider;)V
...
.method public onExtraCommand(IILjava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/gnss/hal/GnssNative;->requestPowerStats()V
    ...
    const-string/jumbo p2, "sendExtraCommand: unknown command "
...
.method public onReportLocations([Landroid/location/Location;)V
    ...
    sget-object v0, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda14;->INSTANCE:Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda14;
    ...
    :cond_4
    sget-object v0, Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda13;->INSTANCE:Lcom/android/server/location/gnss/GnssLocationProvider$$ExternalSyntheticLambda13;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/location/gnss/GnssLocationProvider;->reportLocation(Landroid/location/LocationResult;)V
...
.method public onRequestSetID(I)V
    ...
    :cond_5
    invoke-virtual {v0, v2, p1}, Lcom/android/server/location/gnss/hal/GnssNative;->setAgpsSetId(ILjava/lang/String;)V
...
.method public onUpdateSatelliteBlocklist([I[I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/location/gnss/GnssMetrics;->resetConstellationTypes()V
