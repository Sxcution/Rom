...
.method public getCachedStats(I)Landroid/net/NetworkStats;
    ...
    :pswitch_0
    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mUidStats:Landroid/net/NetworkStats;

    goto :goto_0

    :pswitch_1
    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mIfaceStats:Landroid/net/NetworkStats;
...
.method public notifyStatsUpdated(ILandroid/net/NetworkStats;Landroid/net/NetworkStats;)V
    ...
    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mProviderStatsLock:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mIfaceStats:Landroid/net/NetworkStats;

    invoke-virtual {v0, p2}, Landroid/net/NetworkStats;->combineAllValues(Landroid/net/NetworkStats;)V
    ...
    iget-object p2, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mUidStats:Landroid/net/NetworkStats;

    invoke-virtual {p2, p3}, Landroid/net/NetworkStats;->combineAllValues(Landroid/net/NetworkStats;)V
    ...
    iget-object p1, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsProviderCallbackImpl;->mSemaphore:Ljava/util/concurrent/Semaphore;
