...
.method private checkDirection(I)V
    ...
    invoke-static {p1}, Lcom/android/net/module/util/PermissionUtils;->enforceNetworkStackPermission(Landroid/content/Context;)V
...
.method private createOrUpdateTransform(Landroid/net/IpSecConfig;ILcom/android/server/IpSecService$SpiRecord;Lcom/android/server/IpSecService$EncapSocketRecord;)V
    ...
    invoke-virtual {v10}, Landroid/net/Network;->getNetId()I
...
.method public declared-synchronized allocateSecurityParameterIndex(Ljava/lang/String;ILandroid/os/IBinder;)Landroid/net/IpSecSpiResponse;
    ...
    sget p3, Landroid/system/OsConstants;->ENOENT:I
...
.method public declared-synchronized applyTunnelModeTransform(IIILjava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Lcom/android/server/IpSecService;->checkDirection(I)V
    ...
    iget-object v2, v2, Lcom/android/server/IpSecService$UserRecord;->mEncapSocketRecords:Lcom/android/server/IpSecService$RefcountedResourceArray;
    ...
    invoke-virtual {v10}, Lcom/android/server/IpSecService$SpiRecord;->getSpi()I
...
.method public declared-synchronized createTunnelInterface(Ljava/lang/String;Ljava/lang/String;Landroid/net/Network;Landroid/os/IBinder;Ljava/lang/String;)Landroid/net/IpSecTunnelInterfaceResponse;
    ...
    new-instance v4, Lcom/android/server/IpSecService$$ExternalSyntheticLambda0;

    invoke-direct {v4, v3, v7}, Lcom/android/server/IpSecService$$ExternalSyntheticLambda0;-><init>(Landroid/net/INetd;Ljava/lang/String;)V
...
.method protected declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo p1, "mUserResourceTracker:"
...
.method reserveNetId()I
    ...
    iput v5, p0, Lcom/android/server/IpSecService;->mNextTunnelNetId:I
    ...
    iget-object v5, p0, Lcom/android/server/IpSecService;->mNetIdRange:Landroid/util/Range;
    ...
    :cond_0
    iget-object v5, p0, Lcom/android/server/IpSecService;->mTunnelNetIds:Landroid/util/SparseBooleanArray;
...
.method public declared-synchronized setNetworkForTunnelInterface(ILandroid/net/Network;Ljava/lang/String;)V
    ...
    const-string p3, "No underlying network was specified"
    ...
    iget-object p3, p0, Lcom/android/server/IpSecService;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p3, p2}, Landroid/net/ConnectivityManager;->getLinkProperties(Landroid/net/Network;)Landroid/net/LinkProperties;

    move-result-object p3

    invoke-virtual {p1}, Lcom/android/server/IpSecService$TunnelInterfaceRecord;->getInterfaceName()Ljava/lang/String;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/IpSecService$TunnelInterfaceRecord;->setUnderlyingNetwork(Landroid/net/Network;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string p2, "Underlying network cannot be the network being exposed by this tunnel"
