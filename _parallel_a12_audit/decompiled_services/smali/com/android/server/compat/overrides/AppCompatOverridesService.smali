...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/compat/IPlatformCompat;Ljava/util/List;)V
    ...
    invoke-direct {p2, p0, p1, v0}, Lcom/android/server/compat/overrides/AppCompatOverridesService$PackageReceiver;-><init>(Lcom/android/server/compat/overrides/AppCompatOverridesService;Landroid/content/Context;Lcom/android/server/compat/overrides/AppCompatOverridesService$1;)V
    ...
    invoke-direct {v1, p0, v2, p2, v0}, Lcom/android/server/compat/overrides/AppCompatOverridesService$DeviceConfigListener;-><init>(Lcom/android/server/compat/overrides/AppCompatOverridesService;Landroid/content/Context;Ljava/lang/String;Lcom/android/server/compat/overrides/AppCompatOverridesService$1;)V
...
.method private addAllPackageOverrides(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, v8}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->getOverridesToRemove(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Map;
...
.method private applyOverrides(Landroid/provider/DeviceConfig$Properties;Ljava/util/Set;Ljava/util/Map;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->getVersionCodeOrNull(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-virtual {p1, v4, v2}, Landroid/provider/DeviceConfig$Properties;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p3, v4, v1}, Ljava/util/Map;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v2 .. v9}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->applyPackageOverrides(Ljava/lang/String;Ljava/lang/String;JLjava/util/Set;Ljava/util/Set;Z)V
...
.method private applyPackageOverrides(Ljava/lang/String;Ljava/lang/String;JLjava/util/Set;Ljava/util/Set;Z)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->putPackageOverrides(Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_2
    invoke-direct {p0, p2, p3}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->removePackageOverrides(Ljava/lang/String;Ljava/util/Set;)V
...
.method private getOverridesToRemove(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Map;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/compat/overrides/AppCompatOverridesParser;->parseRemoveOverrides(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Map;
...
.method private putPackageOverrides(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {p2, v0, p1}, Lcom/android/internal/compat/IPlatformCompat;->putOverridesOnReleaseBuilds(Lcom/android/internal/compat/CompatibilityOverrideConfig;Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v0, "Failed to call IPlatformCompat#putOverridesOnReleaseBuilds"
...
.method private removeAllPackageOverrides(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->removePackageOverrides(Ljava/lang/String;Ljava/util/Set;)V
...
.method private removeOverrides(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/server/compat/overrides/AppCompatOverridesService;->removePackageOverrides(Ljava/lang/String;Ljava/util/Set;)V
...
.method private removePackageOverrides(Ljava/lang/String;Ljava/util/Set;)V
    ...
    invoke-interface {p2, v0, p1}, Lcom/android/internal/compat/IPlatformCompat;->removeOverridesOnReleaseBuilds(Lcom/android/internal/compat/CompatibilityOverridesToRemoveConfig;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v0, "Failed to call IPlatformCompat#removeOverridesOnReleaseBuilds"
