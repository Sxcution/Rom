...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object v3, p0, Lcom/android/server/StorageManagerService;->mUserReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean p1, p0, Lcom/android/server/StorageManagerService;->mIsAutomotive:Z
...
.method private completeUnlockUser(I)V
    ...
    invoke-static {v5, v4, v3, v3}, Lcom/android/server/StorageManagerService$Callbacks;->access$3300(Lcom/android/server/StorageManagerService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private configureTranscoding()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/StorageManagerService$ExternalStorageServiceAnrController;-><init>(Lcom/android/server/StorageManagerService;Lcom/android/server/StorageManagerService$1;)V
...
.method private enforceExternalStorageService()V
    ...
    const-string v1, "Only the ExternalStorageService is permitted"
...
.method private findStorageForUuidAsUser(Ljava/lang/String;I)Landroid/os/storage/VolumeInfo;
    ...
    const-string v0, "findStorageForUuidAsUser cannot find volumeUuid:"
...
.method private getMountModeInternal(ILjava/lang/String;)I
    ...
    invoke-virtual {p2, v6, v2}, Landroid/content/pm/PackageManagerInternal;->isInstantApp(Ljava/lang/String;I)Z
    ...
    invoke-interface {p2, v6, v0, v2}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
...
.method private onDiskScannedLocked(Landroid/os/storage/DiskInfo;)V
    ...
    invoke-static {v0, p1, v1}, Lcom/android/server/StorageManagerService$Callbacks;->access$4200(Lcom/android/server/StorageManagerService$Callbacks;Landroid/os/storage/DiskInfo;I)V
...
.method private onVolumeCreatedLocked(Landroid/os/storage/VolumeInfo;)V
    ...
    const-string v2, "Ignoring volume "
...
.method private onVolumeStateChangedAsync(Landroid/os/storage/VolumeInfo;II)V
    ...
    invoke-virtual {p1, v7}, Landroid/os/storage/VolumeInfo;->isVisibleForRead(I)Z
    ...
    invoke-static {v8, v7, p2, v2}, Lcom/android/server/StorageManagerService$Callbacks;->access$3300(Lcom/android/server/StorageManagerService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v0, v2}, Lcom/android/server/StorageManagerService$ObbActionHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private onVolumeStateChangedLocked(Landroid/os/storage/VolumeInfo;II)V
    ...
    iget-object p2, p0, Lcom/android/server/StorageManagerService;->mFuseMountedUser:Ljava/util/Set;
    ...
    new-instance v0, Lcom/android/server/StorageManagerService$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p2, p1}, Lcom/android/server/StorageManagerService$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/StorageManagerService;ILandroid/os/storage/VolumeInfo;)V
...
.method private prepareUserStorageIfNeeded(Landroid/os/storage/VolumeInfo;)V
    ...
    invoke-direct {p0, v5, v6, v3, v4}, Lcom/android/server/StorageManagerService;->prepareUserStorageInternal(Ljava/lang/String;III)V
...
.method private prepareUserStorageInternal(Ljava/lang/String;III)V
    ...
    invoke-static {p3, p1}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string p4, "ignoring error preparing storage for existing user "
...
.method private remountAppStorageDirs(Ljava/util/Map;I)V
    ...
    invoke-virtual {v3, v0, v4, p2}, Landroid/content/pm/PackageManagerInternal;->getPackageUid(Ljava/lang/String;II)I
...
.method private snapshotAndMonitorLegacyStorageAppOp(Landroid/os/UserHandle;)V
    ...
    iget-object p1, p0, Lcom/android/server/StorageManagerService;->mPackageMonitorsForUser:Ljava/util/Map;
...
.method private updateLegacyStorageApps(Ljava/lang/String;IZ)V
    ...
    iget-object p1, p0, Lcom/android/server/StorageManagerService;->mUidsWithLegacyExternalStorage:Ljava/util/Set;
...
.method public disableAppDataIsolation(Ljava/lang/String;II)V
    ...
    const-string/jumbo p2, "no permission to enable app visibility"
    ...
    invoke-interface {p1, p3, p2, v0}, Landroid/os/IVold;->unmountAppStorageDirs(II[Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v0, "isAutomotive:"

    invoke-virtual {p3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v0, p0, Lcom/android/server/StorageManagerService;->mIsAutomotive:Z
...
.method public fixupAppDir(Ljava/lang/String;)V
    ...
    const-string v1, "Asked to fixup an app dir without a userId: "
    ...
    invoke-interface {v3, v4, v1}, Landroid/os/IVold;->fixupAppDir(Ljava/lang/String;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    const-string v4, "Failed to fixup app dir for "
    ...
    const-string v3, "Couldn\'t find package to fixup app dir "
    ...
    const-string v3, "Invalid userId in path: "
...
.method public forgetAllVolumes()V
    ...
    invoke-static {v3, v2}, Lcom/android/server/StorageManagerService$Callbacks;->access$5400(Lcom/android/server/StorageManagerService$Callbacks;Ljava/lang/String;)V
...
.method public forgetVolume(Ljava/lang/String;)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/StorageManagerService$Callbacks;->access$5400(Lcom/android/server/StorageManagerService$Callbacks;Ljava/lang/String;)V
...
.method public getManageSpaceActivityIntent(Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    iget-object v3, v0, Landroid/content/pm/ApplicationInfo;->manageSpaceActivityName:Ljava/lang/String;
    ...
    invoke-static {v3, p2, v4, p1}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    const-string/jumbo p2, "packageName not found"
...
.method public getVolumeList(ILjava/lang/String;I)[Landroid/os/storage/StorageVolume;
    ...
    iget v10, v0, Lcom/android/server/StorageManagerService;->mMediaStoreAuthorityAppId:I
    ...
    invoke-virtual {v12, v2}, Lcom/android/server/pm/UserManagerInternal;->getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    iget-object v14, v0, Lcom/android/server/StorageManagerService;->mStorageManagerInternal:Lcom/android/server/StorageManagerService$StorageManagerInternalImpl;

    move/from16 v15, p1

    move-object/from16 v4, p2

    invoke-virtual {v14, v15, v4}, Lcom/android/server/StorageManagerService$StorageManagerInternalImpl;->hasExternalStorage(ILjava/lang/String;)Z
    ...
    :goto_4
    :try_start_1
    iget-object v5, v0, Lcom/android/server/StorageManagerService;->mVolumes:Landroid/util/ArrayMap;
    ...
    iget-object v12, v0, Lcom/android/server/StorageManagerService;->mVolumes:Landroid/util/ArrayMap;
    ...
    invoke-virtual {v12}, Landroid/os/storage/VolumeInfo;->getMountUserId()I
    ...
    invoke-virtual {v12, v2}, Landroid/os/storage/VolumeInfo;->isVisibleForWrite(I)Z
    ...
    :cond_5
    invoke-virtual {v12, v2}, Landroid/os/storage/VolumeInfo;->isVisibleForRead(I)Z
    ...
    const-string v5, " unmounted due to system locked"
    ...
    const-string/jumbo v5, "unmounted due to "
    ...
    const-string/jumbo v5, "unmounted due to missing permissions"
    ...
    invoke-virtual {v12, v3, v2, v1}, Landroid/os/storage/VolumeInfo;->buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;

    move-result-object v1

    invoke-virtual {v12}, Landroid/os/storage/VolumeInfo;->isPrimary()Z
    ...
    const-string v30, "demo"

    const-string/jumbo v31, "mounted_ro"
    ...
    invoke-direct/range {v17 .. v31}, Landroid/os/storage/StorageVolume;-><init>(Ljava/lang/String;Ljava/io/File;Ljava/io/File;Ljava/lang/String;ZZZZJLandroid/os/UserHandle;Ljava/util/UUID;Ljava/lang/String;Ljava/lang/String;)V
...
.method public lockUserKey(I)V
    ...
    const-string v0, "Headless system user data cannot be locked.."
...
.method public mkdirs(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v3, v1}, Landroid/os/IVold;->setupAppDir(Ljava/lang/String;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public setPrimaryStorageUuid(Ljava/lang/String;Landroid/content/pm/IPackageMoveObserver;)V
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/server/StorageManagerService;->findStorageForUuidAsUser(Ljava/lang/String;I)Landroid/os/storage/VolumeInfo;

    move-result-object v1

    invoke-direct {p0, p1, p2}, Lcom/android/server/StorageManagerService;->findStorageForUuidAsUser(Ljava/lang/String;I)Landroid/os/storage/VolumeInfo;
...
.method public setVolumeNickname(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, p1}, Lcom/android/server/StorageManagerService$Callbacks;->access$5300(Lcom/android/server/StorageManagerService$Callbacks;Landroid/os/storage/VolumeRecord;)V
...
.method public unlockUserKey(II[B[B)V
    ...
    const-string p4, "Not unlocking user "
    ...
    :try_start_1
    iget-object p3, p0, Lcom/android/server/StorageManagerService;->mLocalUnlockedUsers:Lcom/android/server/StorageManagerService$WatchedLockedUsers;

    invoke-virtual {p3, p1}, Lcom/android/server/StorageManagerService$WatchedLockedUsers;->append(I)V
