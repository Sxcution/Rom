...
.method private getSingleProvider()Landroid/util/Pair;
    ...
    invoke-interface {v4, v0}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->containsSensor(I)Z
    ...
    :cond_2
    const-string v0, "Single sensor, but provider not found"
