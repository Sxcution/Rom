...
.method private addAidlProviders()V
    ...
    new-instance v7, Lcom/android/server/biometrics/sensors/face/aidl/FaceProvider;

    iget-object v8, p0, Lcom/android/server/biometrics/sensors/face/FaceService$FaceServiceWrapper;->this$0:Lcom/android/server/biometrics/sensors/face/FaceService;

    invoke-virtual {v8}, Lcom/android/server/biometrics/sensors/face/FaceService;->getContext()Landroid/content/Context;
    ...
    invoke-static {v9}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$500(Lcom/android/server/biometrics/sensors/face/FaceService;)Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;

    move-result-object v9

    invoke-direct {v7, v8, v5, v3, v9}, Lcom/android/server/biometrics/sensors/face/aidl/FaceProvider;-><init>(Landroid/content/Context;[Landroid/hardware/biometrics/face/SensorProps;Ljava/lang/String;Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;)V
...
.method private addCustomProviders()V
    .locals 13

    invoke-static {}, Lcom/android/server/biometrics/sensors/face/custom/CustomFaceProvider;->useCustomFaceUnlockService()Z
    ...
    new-instance v1, Lcom/android/server/biometrics/sensors/face/custom/CustomFaceProvider;
    ...
    invoke-virtual {v2}, Lcom/android/server/biometrics/sensors/face/FaceService;->getContext()Landroid/content/Context;
    ...
    invoke-direct/range {v3 .. v11}, Landroid/hardware/face/FaceSensorPropertiesInternal;-><init>(IIILjava/util/List;IZZZ)V

    iget-object v3, p0, Lcom/android/server/biometrics/sensors/face/FaceService$FaceServiceWrapper;->this$0:Lcom/android/server/biometrics/sensors/face/FaceService;

    invoke-static {v3}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$500(Lcom/android/server/biometrics/sensors/face/FaceService;)Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;

    move-result-object v3

    invoke-direct {v1, v2, v12, v3}, Lcom/android/server/biometrics/sensors/face/custom/CustomFaceProvider;-><init>(Landroid/content/Context;Landroid/hardware/face/FaceSensorPropertiesInternal;Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;)V
...
.method public cancelAuthentication(Landroid/os/IBinder;Ljava/lang/String;J)V
    ...
    invoke-static {p2}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$200(Lcom/android/server/biometrics/sensors/face/FaceService;)Landroid/util/Pair;
    ...
    const-string p2, "Null provider for cancelAuthentication"
    ...
    invoke-interface {v0, p2, p1, p3, p4}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->cancelAuthentication(ILandroid/os/IBinder;J)V
...
.method public cancelAuthenticationFromService(ILandroid/os/IBinder;Ljava/lang/String;J)V
    ...
    invoke-virtual {p3}, Lcom/android/server/biometrics/sensors/face/FaceService;->getContext()Landroid/content/Context;
    ...
    invoke-static {p3, p1}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$000(Lcom/android/server/biometrics/sensors/face/FaceService;I)Lcom/android/server/biometrics/sensors/face/ServiceProvider;
    ...
    const-string p2, "Null provider for cancelAuthenticationFromService"
    ...
    :cond_0
    invoke-interface {p3, p1, p2, p4, p5}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->cancelAuthentication(ILandroid/os/IBinder;J)V
...
.method public cancelEnrollment(Landroid/os/IBinder;J)V
    ...
    invoke-interface {v1, v0, p1, p2, p3}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->cancelEnrollment(ILandroid/os/IBinder;J)V
...
.method public cancelFaceDetect(Landroid/os/IBinder;Ljava/lang/String;J)V
    ...
    const-string p3, "cancelFaceDetect called from non-sysui package: "
    ...
    const-string p1, "Null provider for cancelFaceDetect"
    ...
    invoke-interface {v0, p2, p1, p3, p4}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->cancelFaceDetect(ILandroid/os/IBinder;J)V
...
.method public detectFace(Landroid/os/IBinder;ILandroid/hardware/face/IFaceServiceReceiver;Ljava/lang/String;)J
    ...
    const-string p2, "detectFace called from non-sysui package: "
    ...
    const-string p1, "detectFace invoked when user is not encrypted or lockdown"
    ...
    const-string p1, "Null provider for detectFace"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$400(Lcom/android/server/biometrics/sensors/face/FaceService;)Ljava/util/List;
    ...
    invoke-interface {p3, v3, p2, v4}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->dumpProtoState(ILandroid/util/proto/ProtoOutputStream;Z)V
    ...
    invoke-static {p2}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$400(Lcom/android/server/biometrics/sensors/face/FaceService;)Ljava/util/List;
    ...
    invoke-interface {p3, v3, p1}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->dumpProtoMetrics(ILjava/io/FileDescriptor;)V
    ...
    invoke-static {p3, v5, v6, v7}, Ljava/util/Arrays;->copyOfRange([Ljava/lang/Object;IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v6

    check-cast v6, [Ljava/lang/String;

    invoke-interface {v2, v4, p1, v6}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->dumpHal(ILjava/io/FileDescriptor;[Ljava/lang/String;)V
    ...
    iget v5, v3, Landroid/hardware/face/FaceSensorPropertiesInternal;->sensorId:I
    ...
    invoke-interface {p3, v3, p2}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->dumpInternal(ILjava/io/PrintWriter;)V
...
.method public enrollRemotely(ILandroid/os/IBinder;[BLandroid/hardware/face/IFaceServiceReceiver;Ljava/lang/String;[I)J
    ...
    invoke-virtual {p1}, Lcom/android/server/biometrics/sensors/face/FaceService;->getContext()Landroid/content/Context;

    move-result-object p1

    const-string p2, "android.permission.MANAGE_BIOMETRIC"
...
.method public getEnrolledFaces(IILjava/lang/String;)Ljava/util/List;
    ...
    const-string p2, "Null provider for getEnrolledFaces, caller: "
...
.method public getFeature(Landroid/os/IBinder;IILandroid/hardware/face/IFaceServiceReceiver;Ljava/lang/String;)V
    ...
    const-string p2, "Null provider for getFeature"
...
.method public getSensorPropertiesInternal(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$100(Lcom/android/server/biometrics/sensors/face/FaceService;)Ljava/util/List;
...
.method public hasEnrolledFaces(IILjava/lang/String;)Z
    ...
    const-string p2, "Null provider for hasEnrolledFaces, caller: "
...
.method public isHardwareDetected(ILjava/lang/String;)Z
    ...
    const-string v3, "Null provider for isHardwareDetected, caller: "
...
.method public synthetic lambda$registerAuthenticators$0$FaceService$FaceServiceWrapper(Ljava/util/List;)V
    ...
    invoke-direct {p0}, Lcom/android/server/biometrics/sensors/face/FaceService$FaceServiceWrapper;->addCustomProviders()V
    ...
    invoke-static {v5}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$600(Lcom/android/server/biometrics/sensors/face/FaceService;)Lcom/android/server/biometrics/sensors/face/FaceService$FaceServiceWrapper;
...
.method public prepareForAuthentication(IZLandroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricSensorReceiver;Ljava/lang/String;JIZ)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$000(Lcom/android/server/biometrics/sensors/face/FaceService;I)Lcom/android/server/biometrics/sensors/face/ServiceProvider;
...
.method public removeAll(Landroid/os/IBinder;ILandroid/hardware/face/IFaceServiceReceiver;Ljava/lang/String;)V
    ...
    invoke-static {p3}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$400(Lcom/android/server/biometrics/sensors/face/FaceService;)Ljava/util/List;
...
.method public resetLockout(Landroid/os/IBinder;II[BLjava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/biometrics/sensors/face/FaceService;->access$000(Lcom/android/server/biometrics/sensors/face/FaceService;I)Lcom/android/server/biometrics/sensors/face/ServiceProvider;
    ...
    :cond_0
    invoke-interface {p1, p2, p3, p4}, Lcom/android/server/biometrics/sensors/face/ServiceProvider;->scheduleResetLockout(II[B)V
