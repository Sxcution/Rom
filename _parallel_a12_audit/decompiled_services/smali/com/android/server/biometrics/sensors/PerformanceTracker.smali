...
.method public getAcceptCryptoForUser(I)I
    ...
    check-cast p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;

    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcceptCrypto:I
...
.method public getAcceptForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAccept:I
...
.method public getAcquireCryptoForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquireCrypto:I
...
.method public getAcquireForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquire:I
...
.method public getPermanentLockoutForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mPermanentLockout:I
...
.method public getRejectCryptoForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mRejectCrypto:I
...
.method public getRejectForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mReject:I
...
.method public getTimedLockoutForUser(I)I
    ...
    iget p1, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mTimedLockout:I
...
.method incrementAcquireForUser(IZ)V
    ...
    iget-object p2, p0, Lcom/android/server/biometrics/sensors/PerformanceTracker;->mAllUsersInfo:Landroid/util/SparseArray;
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquireCrypto:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquireCrypto:I
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquire:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcquire:I
...
.method public incrementAuthForUser(IZ)V
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAccept:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAccept:I
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mReject:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mReject:I
...
.method incrementCryptoAuthForUser(IZ)V
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcceptCrypto:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mAcceptCrypto:I
    ...
    iget p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mRejectCrypto:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mRejectCrypto:I
...
.method incrementPermanentLockoutForUser(I)V
    ...
    iget v0, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mPermanentLockout:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mPermanentLockout:I
...
.method incrementTimedLockoutForUser(I)V
    ...
    iget v0, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mTimedLockout:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Lcom/android/server/biometrics/sensors/PerformanceTracker$Info;->mTimedLockout:I
