...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;

    invoke-direct {p1}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;-><init>()V

    iput-object p1, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mFingerprintStateCallback:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;
...
.method static synthetic access$700(Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;)Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;
    ...
    iget-object p0, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mFingerprintStateCallback:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;
...
.method private broadcastAllAuthenticatorsRegistered()V
    ...
    :try_start_1
    invoke-interface {v1, v2}, Landroid/hardware/fingerprint/IFingerprintAuthenticatorsRegisteredCallback;->onAllAuthenticatorsRegistered(Ljava/util/List;)V
    :try_end_1
    ...
    const-string v4, "Remote exception in onAllAuthenticatorsRegistered"
    ...
    const-string/jumbo v2, "mSensorProps is empty"
...
.method private broadcastCurrentEnrollmentState(Landroid/hardware/fingerprint/IFingerprintStateListener;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->getProviderForSensor(I)Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;
...
.method private getEnrolledFingerprintsDeprecated(ILjava/lang/String;)Ljava/util/List;
    ...
    const-string v0, "Null provider for getEnrolledFingerprintsDeprecated, caller: "
    ...
    invoke-interface {p2, v0, p1}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->getEnrolledFingerprints(II)Ljava/util/List;
...
.method private getSingleProvider()Landroid/util/Pair;
    ...
    const-string v0, "No providers found"
    ...
    iget-object v1, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mServiceProviders:Ljava/util/List;
    ...
    invoke-interface {v4, v0}, Lcom/android/server/biometrics/sensors/fingerprint/ServiceProvider;->containsSensor(I)Z
...
.method public synthetic lambda$broadcastCurrentEnrollmentState$0$FingerprintService(Landroid/hardware/fingerprint/IFingerprintStateListener;Landroid/content/pm/UserInfo;Landroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;Z)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;->notifyFingerprintEnrollmentStateChanged(Landroid/hardware/fingerprint/IFingerprintStateListener;IIZ)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mFingerprintStateCallback:Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;

    iget p2, p2, Landroid/content/pm/UserInfo;->id:I

    iget p3, p3, Landroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;->sensorId:I

    invoke-virtual {p1, p2, p3, p4}, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintStateCallback;->notifyAllFingerprintEnrollmentStateChanged(IIZ)V
