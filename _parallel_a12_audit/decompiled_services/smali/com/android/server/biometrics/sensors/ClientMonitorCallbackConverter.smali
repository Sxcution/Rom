...
.method onAcquired(III)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/biometrics/sensors/ClientMonitorCallbackConverter;->mFingerprintServiceReceiver:Landroid/hardware/fingerprint/IFingerprintServiceReceiver;

    if-eqz p1, :cond_2

    invoke-interface {p1, p2, p3}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onAcquired(II)V
...
.method onAuthenticationFailed(I)V
    ...
    invoke-interface {p1}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onAuthenticationFailed()V
...
.method onAuthenticationSucceeded(ILandroid/hardware/biometrics/BiometricAuthenticator$Identifier;[BIZ)V
    ...
    invoke-interface {p1, p2, p4, p5}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onAuthenticationSucceeded(Landroid/hardware/fingerprint/Fingerprint;IZ)V
...
.method onEnrollResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onEnrollResult(Landroid/hardware/fingerprint/Fingerprint;I)V
...
.method public onError(IIII)V
    ...
    invoke-interface {p1, p3, p4}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onError(II)V
...
.method onRemoved(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/hardware/fingerprint/IFingerprintServiceReceiver;->onRemoved(Landroid/hardware/fingerprint/Fingerprint;I)V
