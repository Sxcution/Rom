...
.method private dump(Landroid/os/ShellCommand;)I
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/graphics/fonts/FontManagerShellCommand;->dumpFontConfig(Landroid/util/IndentingPrintWriter;Landroid/text/FontConfig;)V
    ...
    :cond_2
    invoke-direct {p0, v0, v1}, Lcom/android/server/graphics/fonts/FontManagerShellCommand;->dumpFallback(Landroid/util/IndentingPrintWriter;[Landroid/graphics/fonts/FontFamily;)V
...
.method private dumpFamily(Landroid/util/IndentingPrintWriter;Landroid/graphics/fonts/FontFamily;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/graphics/fonts/FontManagerShellCommand;->dumpFont(Landroid/util/IndentingPrintWriter;Landroid/graphics/fonts/Font;)V
    :try_end_0
...
.method private dumpFont(Landroid/util/IndentingPrintWriter;Landroid/graphics/fonts/Font;)V
    ...
    invoke-static {p2}, Landroid/graphics/fonts/FontVariationAxis;->toFontVariationSettings([Landroid/graphics/fonts/FontVariationAxis;)Ljava/lang/String;
...
.method private execCommand(Landroid/os/ShellCommand;Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/graphics/fonts/FontManagerShellCommand;->writeCommandResult(Landroid/os/ShellCommand;Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException;)V
...
.method private status(Landroid/os/ShellCommand;)I
    ...
    invoke-virtual {p1}, Lcom/android/server/graphics/fonts/FontManagerService;->getFontFileMap()Ljava/util/Map;
    ...
    const-string v2, "Number of updated font files: "
...
.method private update(Landroid/os/ShellCommand;)I
    ...
    invoke-direct {v5, v1, v6}, Landroid/graphics/fonts/FontUpdateRequest;-><init>(Landroid/os/ParcelFileDescriptor;[B)V

    invoke-static {v5}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v5

    invoke-virtual {v3, v4, v5}, Lcom/android/server/graphics/fonts/FontManagerService;->update(ILjava/util/List;)V
    :try_end_5
    ...
    const-string v6, "Invalid read length"

    invoke-direct {v5, v3, v6}, Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException;-><init>(ILjava/lang/String;)V
    ...
    const-string v7, "Signature file is too large"
    ...
    const-string v6, "Failed to read signature file."

    invoke-direct {v5, v3, v6, v4}, Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v5, "Failed to open signature file"
    ...
    const-string v5, "Failed to open font file"
    ...
    const-string v1, "FontManagerShellCommand"

    const-string v3, "Error while closing files"
    ...
    const-string v0, "Signature file argument is required."

    invoke-direct {p1, v2, v0}, Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException;-><init>(ILjava/lang/String;)V
    ...
    const-string v0, "Font file path argument is required."
...
.method private updateFamily(Landroid/os/ShellCommand;)I
    ...
    invoke-virtual {v0, v2, v1}, Lcom/android/server/graphics/fonts/FontManagerService;->update(ILjava/util/List;)V
    ...
    const-string v2, "Failed to open XML file."
    ...
    const-string v1, "XML file path argument is required."

    invoke-direct {p1, v0, v1}, Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException;-><init>(ILjava/lang/String;)V
...
.method public onCommand(Ljava/lang/String;)I
    ...
    const-string v0, "Only shell or root user can execute font command."
