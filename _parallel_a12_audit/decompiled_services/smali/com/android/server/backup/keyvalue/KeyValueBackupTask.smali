...
.method private clearStatus(Ljava/lang/String;Ljava/io/File;)V
    ...
    const-string v0, "Unable to remove status file for "
...
.method private getTopLevelSuccessStateDirectory(Z)Ljava/io/File;
    ...
    const-string v0, "Unable to create backing-up state directory"
...
.method private informTransportOfUnchangedApps(Ljava/util/Set;)V
    ...
    :try_start_2
    invoke-direct {p0, v3, v9, v2}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->sendNoDataChangedTo(Lcom/android/internal/backup/IBackupTransport;Landroid/content/pm/PackageInfo;I)V
    ...
    invoke-direct {p0, v3, p1, v2}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->sendNoDataChangedTo(Lcom/android/internal/backup/IBackupTransport;Landroid/content/pm/PackageInfo;I)V
    :try_end_2
    ...
    const-string v1, "Could not inform transport of all unchanged apps"
...
.method private isEligibleForNoDataCall(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/backup/utils/BackupEligibilityRules;->appIsRunningAndEligibleForBackupWithTransport(Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;)Z
...
.method private sendNoDataChangedTo(Lcom/android/internal/backup/IBackupTransport;Landroid/content/pm/PackageInfo;I)V
    ...
    const-string p1, "Unable to find blank state file, aborting unchanged apps signal."
...
.method public static start(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZLcom/android/server/backup/utils/BackupEligibilityRules;)Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    ...
    new-instance v12, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
...
.method private transportPerformBackup(Landroid/content/pm/PackageInfo;Ljava/io/File;Z)I
    ...
    invoke-direct {p0, v2, p3}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->getPerformBackupFlags(ZZ)I

    move-result v2

    invoke-interface {v1, p1, p2, v2}, Lcom/android/internal/backup/IBackupTransport;->performBackup(Landroid/content/pm/PackageInfo;Landroid/os/ParcelFileDescriptor;I)I
...
.method public run()V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->setSuccessState(Ljava/lang/String;Z)V
    ...
    :try_start_2
    invoke-direct {p0, v2, v0}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->setSuccessState(Ljava/lang/String;Z)V
