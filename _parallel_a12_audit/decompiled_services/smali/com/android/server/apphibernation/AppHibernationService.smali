...
.method constructor <init>(Lcom/android/server/apphibernation/AppHibernationService$Injector;)V
    ...
    invoke-virtual {p1, v2}, Landroid/app/usage/UsageStatsManagerInternal;->registerListener(Landroid/app/usage/UsageStatsManagerInternal$UsageEventListener;)V
...
.method private checkHibernationEnabled(Ljava/lang/String;)Z
    ...
    const-string p1, "Attempted to call %s on unsupported device."
...
.method private checkUserStatesExist(ILjava/lang/String;)Z
    ...
    const-string p2, "Attempt to call %s before states have been read from disk"
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/util/IndentingPrintWriter;->print(Ljava/lang/Object;)V
...
.method private hibernatePackageForUser(Ljava/lang/String;I)V
    ...
    const-string v4, "Failed to hibernate due to manager not being available"

    invoke-direct {p2, v4, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private initializeGlobalHibernationStates(Ljava/util/List;)V
    ...
    const-string v1, "Package manager not available"
...
.method getHibernatingPackagesForUser(I)Ljava/util/List;
    ...
    iget-boolean v3, v2, Lcom/android/server/apphibernation/UserLevelState;->hibernated:Z

    if-eqz v3, :cond_2

    iget-object v2, v2, Lcom/android/server/apphibernation/UserLevelState;->packageName:Ljava/lang/String;
...
.method isHibernatingForUser(Ljava/lang/String;I)Z
    ...
    const-string v3, "Package %s is not installed for user %s"
    ...
    :cond_2
    iget-boolean p1, v1, Lcom/android/server/apphibernation/UserLevelState;->hibernated:Z
...
.method isHibernatingGlobally(Ljava/lang/String;)Z
    ...
    check-cast p1, Lcom/android/server/apphibernation/GlobalLevelState;
    ...
    :cond_1
    iget-boolean p1, p1, Lcom/android/server/apphibernation/GlobalLevelState;->hibernated:Z
...
.method public synthetic lambda$onUserUnlocking$5$AppHibernationService(Lcom/android/server/apphibernation/HibernationStateDiskStore;I)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/apphibernation/AppHibernationService;->initializeUserHibernationStates(ILjava/util/List;)V
...
.method public onBootPhase(I)V
    ...
    new-instance v0, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0}, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/apphibernation/AppHibernationService;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/apphibernation/AppHibernationService$StatsPullAtomCallbackImpl;-><init>(Lcom/android/server/apphibernation/AppHibernationService;Lcom/android/server/apphibernation/AppHibernationService$1;)V
...
.method setHibernatingForUser(Ljava/lang/String;IZ)V
    ...
    const-string v1, "Package %s is not installed for user %s"
    ...
    :cond_2
    iget-boolean v2, v1, Lcom/android/server/apphibernation/UserLevelState;->hibernated:Z
    ...
    :cond_3
    iput-boolean p3, v1, Lcom/android/server/apphibernation/UserLevelState;->hibernated:Z
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/apphibernation/AppHibernationService;Ljava/lang/String;I)V
    ...
    iput-wide v2, v1, Lcom/android/server/apphibernation/UserLevelState;->lastUnhibernatedMs:J

    :goto_0
    new-instance p1, Lcom/android/server/apphibernation/UserLevelState;

    invoke-direct {p1, v1}, Lcom/android/server/apphibernation/UserLevelState;-><init>(Lcom/android/server/apphibernation/UserLevelState;)V

    nop

    iget-object p3, p0, Lcom/android/server/apphibernation/AppHibernationService;->mBackgroundExecutor:Ljava/util/concurrent/Executor;

    new-instance v1, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda7;

    invoke-direct {v1, p1, p2}, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda7;-><init>(Lcom/android/server/apphibernation/UserLevelState;I)V
    ...
    iget-object p3, p0, Lcom/android/server/apphibernation/AppHibernationService;->mUserDiskStores:Landroid/util/SparseArray;

    invoke-virtual {p3, p2}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/android/server/apphibernation/HibernationStateDiskStore;

    invoke-virtual {p2, p1}, Lcom/android/server/apphibernation/HibernationStateDiskStore;->scheduleWriteHibernationStates(Ljava/util/List;)V
...
.method setHibernatingGlobally(Ljava/lang/String;Z)V
    ...
    const-string p2, "AppHibernationService"

    const-string v1, "Package %s is not installed for any user"
    ...
    new-instance v2, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda6;

    invoke-direct {v2, p0, p1, v1}, Lcom/android/server/apphibernation/AppHibernationService$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/apphibernation/AppHibernationService;Ljava/lang/String;Lcom/android/server/apphibernation/GlobalLevelState;)V
    ...
    iget-object p2, p0, Lcom/android/server/apphibernation/AppHibernationService;->mGlobalLevelHibernationDiskStore:Lcom/android/server/apphibernation/HibernationStateDiskStore;
