...
.method public onChange(Z)V
    ...
    invoke-static {p1}, Lcom/android/server/BluetoothManagerService;->access$1600(Lcom/android/server/BluetoothManagerService;)Z
    ...
    const-string p1, "DEVICE_PROVISIONED setting changed, but device is not provisioned"
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/BluetoothManagerService$BluetoothHandler;->hasMessages(I)Z

    move-result p1

    if-eqz p1, :cond_1

    const-string p1, "Device provisioned, reactivating pending flag changes"
