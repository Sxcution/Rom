...
.method private hasTrustedSystemInstallSource(Ljava/lang/String;)Z
    ...
    iget-object v2, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    invoke-direct {p0, v1}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->isTrustedInstallSource(Ljava/lang/String;)Z
    ...
    const-string v2, "can\'t find the package\'s install source:"
    ...
    const-string v1, "AccessibilitySecurityPolicy"
...
.method private isRetrievalAllowingWindowLocked(II)Z
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mAccessibilityWindowManager:Lcom/android/server/accessibility/AccessibilityWindowManager;

    invoke-virtual {p1, p2}, Lcom/android/server/accessibility/AccessibilityWindowManager;->findA11yWindowInfoByIdLocked(I)Landroid/view/accessibility/AccessibilityWindowInfo;
...
.method private isShellAllowedToRetrieveWindowLocked(II)Z
    ...
    :cond_1
    :try_start_2
    iget-object p2, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-virtual {p2, v2, p1}, Landroid/os/UserManager;->hasUserRestriction(Ljava/lang/String;Landroid/os/UserHandle;)Z
...
.method public canDispatchAccessibilityEventLocked(ILandroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->isRetrievalAllowingWindowLocked(II)Z
...
.method public checkAccessibilityAccess(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;)Z
    ...
    :try_start_0
    sget v4, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->OWN_PROCESS_ID:I
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mAppOpsManager:Landroid/app/AppOpsManager;
...
.method public computeValidReportedPackages(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mAppWidgetService:Landroid/appwidget/AppWidgetManagerInternal;
...
.method public isA11yCategoryService(Landroid/accessibilityservice/AccessibilityServiceInfo;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->hasTrustedSystemInstallSource(Ljava/lang/String;)Z
...
.method public onBoundServicesChangedLocked(ILjava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->isA11yCategoryService(Landroid/accessibilityservice/AccessibilityServiceInfo;)Z
...
.method public resolveValidReportedPackageLocked(Ljava/lang/CharSequence;III)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->isValidPackageForUid(Ljava/lang/String;I)Z
    ...
    :cond_4
    iget-object p1, p0, Lcom/android/server/accessibility/AccessibilitySecurityPolicy;->mPackageManager:Landroid/content/pm/PackageManager;
