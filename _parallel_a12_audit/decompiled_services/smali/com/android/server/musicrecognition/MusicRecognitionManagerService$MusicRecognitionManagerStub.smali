...
.method private isCalledByServiceAppLocked(Ljava/lang/String;)Z
    ...
    iget-object v5, p0, Lcom/android/server/musicrecognition/MusicRecognitionManagerService$MusicRecognitionManagerStub;->this$0:Lcom/android/server/musicrecognition/MusicRecognitionManagerService;

    invoke-virtual {v5}, Lcom/android/server/musicrecognition/MusicRecognitionManagerService;->getContext()Landroid/content/Context;
...
.method public beginRecognition(Landroid/media/musicrecognition/RecognitionRequest;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/musicrecognition/MusicRecognitionManagerService$MusicRecognitionManagerStub;->isCalledByServiceAppLocked(Ljava/lang/String;)Z
    ...
    invoke-interface {p1, p2}, Landroid/media/musicrecognition/IMusicRecognitionManagerCallback;->onRecognitionFailed(I)V
    :try_end_1
