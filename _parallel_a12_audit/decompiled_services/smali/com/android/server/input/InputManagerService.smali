...
.field private static final UNTRUSTED_TOUCHES_TOAST:Z
...
.method private getContextForPointerIcon(I)Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/android/server/input/InputManagerService;->mPointerIconDisplayContext:Landroid/content/Context;
...
.method private getKeyboardLayoutOverlay(Landroid/hardware/input/InputDeviceIdentifier;)[Ljava/lang/String;
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/input/InputManagerService$16;-><init>(Lcom/android/server/input/InputManagerService;[Ljava/lang/String;)V
...
.method private getVibratorToken(ILandroid/os/IBinder;)Lcom/android/server/input/InputManagerService$VibratorToken;
    ...
    :try_start_2
    iget-object p1, p0, Lcom/android/server/input/InputManagerService;->mVibratorTokens:Ljava/util/Map;
...
.method private injectInputEventInternal(Landroid/view/InputEvent;I)Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/input/InputManagerService;->getContextForDisplay(I)Landroid/content/Context;
    ...
    invoke-direct {p0, v9}, Lcom/android/server/input/InputManagerService;->getContextForDisplay(I)Landroid/content/Context;
    ...
    invoke-static {v1, v3, v4}, Landroid/view/MotionEvent;->createRotateMatrix(III)Landroid/graphics/Matrix;

    move-result-object v1

    invoke-virtual {v6, v1}, Landroid/view/MotionEvent;->applyTransform(Landroid/graphics/Matrix;)V
    ...
    invoke-static/range {v0 .. v7}, Lcom/android/server/input/InputManagerService;->nativeInjectInputEvent(JLandroid/view/InputEvent;IIIII)I
...
.method private notifySensorAccuracy(III)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/input/InputManagerService;->mSensorAccuracyListenersToNotify:Ljava/util/List;
...
.method private notifySwitch(JII)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private setDisplayViewportsInternal(Ljava/util/List;)V
    ...
    iget v2, v2, Landroid/hardware/display/DisplayViewport;->deviceHeight:I

    invoke-virtual {v3, v6, v6, v4, v2}, Landroid/graphics/Rect;->set(IIII)V
...
.method private setLightStateInternal(ILandroid/hardware/lights/Light;Landroid/hardware/lights/LightState;)V
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lcom/android/server/input/InputManagerService;->nativeSetLightPlayerId(JIII)V
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lcom/android/server/input/InputManagerService;->nativeSetLightColor(JIII)V
...
.method private setLightStatesInternal(I[I[Landroid/hardware/lights/LightState;)V
    ...
    invoke-direct {p0, p1, v0, v3}, Lcom/android/server/input/InputManagerService;->setLightStateInternal(ILandroid/hardware/lights/Light;Landroid/hardware/lights/LightState;)V
...
.method private updateDeepPressStatusFromSettings(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v4}, Lcom/android/server/input/InputManagerService;->nativeSetMotionClassifierEnabled(JZ)V
...
.method public addPortAssociation(Ljava/lang/String;I)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/input/InputManagerService;->nativeNotifyPortAssociationsChanged(J)V
    ...
    const-string p2, "Requires ASSOCIATE_INPUT_DEVICE_TO_DISPLAY permission"
...
.method public addUniqueIdAssociation(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/input/InputManagerService;->nativeChangeUniqueIdAssociation(J)V
...
.method public closeLightSession(ILandroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1, v3, v1}, Lcom/android/server/input/InputManagerService;->setLightStatesInternal(I[I[Landroid/hardware/lights/LightState;)V
    ...
    invoke-static {p2}, Lcom/android/server/input/InputManagerService$LightSession;->access$1400(Lcom/android/server/input/InputManagerService$LightSession;)[I

    move-result-object v1

    invoke-static {p2}, Lcom/android/server/input/InputManagerService$LightSession;->access$1500(Lcom/android/server/input/InputManagerService$LightSession;)[Landroid/hardware/lights/LightState;

    move-result-object p2

    invoke-direct {p0, p1, v1, p2}, Lcom/android/server/input/InputManagerService;->setLightStatesInternal(I[I[Landroid/hardware/lights/LightState;)V
...
.method public flushSensor(II)Z
    ...
    invoke-static {v1, v2, p1, p2}, Lcom/android/server/input/InputManagerService;->nativeFlushSensor(JII)Z
...
.method public getLightState(II)Landroid/hardware/lights/LightState;
    ...
    new-instance p2, Landroid/hardware/lights/LightState;

    invoke-direct {p2, v1, p1}, Landroid/hardware/lights/LightState;-><init>(II)V
...
.method public monitorGestureInput(Ljava/lang/String;I)Landroid/view/InputMonitor;
    ...
    invoke-direct {p2, p0, v0}, Lcom/android/server/input/InputManagerService$InputMonitorHost;-><init>(Lcom/android/server/input/InputManagerService;Landroid/os/IBinder;)V

    new-instance v0, Landroid/view/InputMonitor;

    invoke-direct {v0, p1, p2}, Landroid/view/InputMonitor;-><init>(Landroid/view/InputChannel;Landroid/view/IInputMonitorHost;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public openLightSession(ILjava/lang/String;Landroid/os/IBinder;)V
    ...
    :goto_1
    iget-object p1, p0, Lcom/android/server/input/InputManagerService;->mLightSessions:Landroid/util/ArrayMap;
...
.method public registerSensorListener(Landroid/hardware/input/IInputSensorEventListener;)Z
    ...
    const-string v2, " has already registered an InputSensorEventListener."
    ...
    :try_start_2
    iget-object p1, p0, Lcom/android/server/input/InputManagerService;->mSensorEventListeners:Landroid/util/SparseArray;
...
.method public registerVibratorStateListener(ILandroid/os/IVibratorStateListener;)Z
    ...
    const-string v4, "Could not register vibrator state listener "
...
.method public removePortAssociation(Ljava/lang/String;)V
    ...
    const-string v0, "Requires ASSOCIATE_INPUT_DEVICE_TO_DISPLAY permission"
...
.method public setLightStates(I[I[Landroid/hardware/lights/LightState;Landroid/os/IBinder;)V
    ...
    invoke-static {p4}, Lcom/android/server/input/InputManagerService$LightSession;->access$1300(Lcom/android/server/input/InputManagerService$LightSession;)I
    ...
    invoke-static {p4, v1}, Lcom/android/server/input/InputManagerService$LightSession;->access$1402(Lcom/android/server/input/InputManagerService$LightSession;[I)[I
    ...
    invoke-static {p4, v1}, Lcom/android/server/input/InputManagerService$LightSession;->access$1502(Lcom/android/server/input/InputManagerService$LightSession;[Landroid/hardware/lights/LightState;)[Landroid/hardware/lights/LightState;
...
.method public transferTouchFocus(Landroid/view/InputChannel;Landroid/view/InputChannel;Z)Z
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lcom/android/server/input/InputManagerService;->nativeTransferTouchFocus(JLandroid/os/IBinder;Landroid/os/IBinder;Z)Z
...
.method public unregisterVibratorStateListener(ILandroid/os/IVibratorStateListener;)Z
    ...
    const-string v4, "Vibrator state listener "
...
.method public vibrate(ILandroid/os/VibrationEffect;Landroid/os/IBinder;)V
    ...
    iget v7, p2, Lcom/android/server/input/InputManagerService$VibratorToken;->mTokenValue:I

    move v3, p1

    invoke-static/range {v1 .. v7}, Lcom/android/server/input/InputManagerService;->nativeVibrate(JI[J[III)V
...
.method public vibrateCombined(ILandroid/os/CombinedVibration;Landroid/os/IBinder;)V
    ...
    const-string p2, "Only Mono and Stereo effects are supported"
    ...
    iget v8, p3, Lcom/android/server/input/InputManagerService$VibratorToken;->mTokenValue:I

    move v4, p1

    invoke-static/range {v2 .. v8}, Lcom/android/server/input/InputManagerService;->nativeVibrateCombined(JI[JLandroid/util/SparseArray;II)V
