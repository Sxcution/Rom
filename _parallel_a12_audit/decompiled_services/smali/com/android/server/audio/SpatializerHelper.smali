...
.method private checkSpatForHeadTracking(Ljava/lang/String;)Z
    ...
    :goto_0
    iget-boolean p1, p0, Lcom/android/server/audio/SpatializerHelper;->mIsHeadTrackingSupported:Z
...
.method private dispatchActualHeadTrackingMode(I)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/SpatializerHelper;->mHeadTrackingModeCallbacks:Landroid/os/RemoteCallbackList;
...
.method private dispatchOutputUpdate(I)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/SpatializerHelper;->mOutputCallbacks:Landroid/os/RemoteCallbackList;
...
.method private dispatchPoseUpdate([F)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/SpatializerHelper;->mHeadPoseCallbacks:Landroid/os/RemoteCallbackList;
...
.method private declared-synchronized setDispatchFeatureEnabledState(Z)V
    ...
    const-string v1, "Invalid mState:"
    ...
    const-string v1, " for enabled true"
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioService;->persistSpatialAudioEnabled(Z)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v1, " for enabled false"
...
.method declared-synchronized canBeSpatialized(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;)Z
    ...
    const-string v0, "canBeSpatialized returning "
    ...
    invoke-static {p2}, Lcom/android/server/audio/SpatializerHelper;->logd(Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method declared-synchronized init(Z)V
    ...
    const-string v1, "Setting state to STATE_NOT_SUPPORTED due to effect not expected"
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/audio/SpatializerHelper$SpatializerCallback;-><init>(Lcom/android/server/audio/SpatializerHelper;Lcom/android/server/audio/SpatializerHelper$1;)V
    ...
    const-string v1, "init(): No Spatializer found"
    ...
    const-string v6, "found support for level: "
    ...
    invoke-static {v5}, Lcom/android/server/audio/SpatializerHelper;->logd(Ljava/lang/String;)V

    if-ne v4, v0, :cond_3

    const-string v1, "Setting capable level to LEVEL_MULTICHANNEL"

    invoke-static {v1}, Lcom/android/server/audio/SpatializerHelper;->logd(Ljava/lang/String;)V

    iput v4, p0, Lcom/android/server/audio/SpatializerHelper;->mCapableSpatLevel:I
    :try_end_2
    ...
    const-string v2, "Spatializer is useless"
...
.method declared-synchronized onInitSensors()V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/audio/SpatializerHelper$HelperDynamicSensorCallback;-><init>(Lcom/android/server/audio/SpatializerHelper;Lcom/android/server/audio/SpatializerHelper$1;)V
    ...
    invoke-virtual {v3, v0}, Landroid/hardware/SensorManager;->registerDynamicSensorCallback(Landroid/hardware/SensorManager$DynamicSensorCallback;)V
    :try_end_3
    ...
    const-string v3, "Error with SensorManager, can\'t initialize sensors"

    invoke-static {v1, v3, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    iput-object v2, p0, Lcom/android/server/audio/SpatializerHelper;->mSensorManager:Landroid/hardware/SensorManager;

    iput-object v2, p0, Lcom/android/server/audio/SpatializerHelper;->mDynSensorCallback:Lcom/android/server/audio/SpatializerHelper$HelperDynamicSensorCallback;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    const-string v4, "com.google.hardware.sensor.hid_dynamic.headtracker"
    ...
    iget-object v3, p0, Lcom/android/server/audio/SpatializerHelper;->mDynSensorCallback:Lcom/android/server/audio/SpatializerHelper$HelperDynamicSensorCallback;

    if-eqz v3, :cond_8

    invoke-virtual {v0, v3}, Landroid/hardware/SensorManager;->unregisterDynamicSensorCallback(Landroid/hardware/SensorManager$DynamicSensorCallback;)V
    ...
    const-string/jumbo v4, "setScreenSensor:"
    ...
    invoke-interface {v2, v1}, Landroid/media/ISpatializer;->setScreenSensor(I)V
    :try_end_6
    ...
    const-string v5, "Error calling setScreenSensor:"
    ...
    const-string/jumbo v3, "setHeadSensor:"
    ...
    invoke-interface {v1, v0}, Landroid/media/ISpatializer;->setHeadSensor(I)V
    :try_end_8
