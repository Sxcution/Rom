...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/audio/AudioSystemAdapter;Lcom/android/server/audio/SystemServerAdapter;)V
    ...
    invoke-direct {v2, v7}, Lcom/android/server/audio/AudioService$VolumeController;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v2, v7, Lcom/android/server/audio/AudioService;->mVolumeController:Lcom/android/server/audio/AudioService$VolumeController;
    ...
    iput-object v2, v7, Lcom/android/server/audio/AudioService;->mMode:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, v7, Lcom/android/server/audio/AudioService;->mSettingsLock:Ljava/lang/Object;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_VOICE:[I

    new-array v4, v2, [I

    fill-array-data v4, :array_1

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_TELEVISION:[I

    new-array v4, v2, [I

    fill-array-data v4, :array_2

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_NONE:[I

    new-array v2, v2, [I

    fill-array-data v2, :array_3

    iput-object v2, v7, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_DEFAULT:[I

    iput-boolean v3, v7, Lcom/android/server/audio/AudioService;->mAvrcpAbsVolSupported:Z

    new-instance v2, Lcom/android/server/audio/AudioService$1;

    invoke-direct {v2, v7}, Lcom/android/server/audio/AudioService$1;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v2, v7, Lcom/android/server/audio/AudioService;->mAudioSystemCallback:Landroid/media/AudioSystem$ErrorCallback;

    const/4 v2, -0x1

    iput v2, v7, Lcom/android/server/audio/AudioService;->mRingerModeExternal:I

    iput v3, v7, Lcom/android/server/audio/AudioService;->mRingerModeAffectedStreams:I

    iput v3, v7, Lcom/android/server/audio/AudioService;->mZenModeAffectedStreams:I

    new-instance v4, Lcom/android/server/audio/AudioService$AudioServiceBroadcastReceiver;

    const/4 v5, 0x0

    invoke-direct {v4, v7, v5}, Lcom/android/server/audio/AudioService$AudioServiceBroadcastReceiver;-><init>(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$1;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mReceiver:Landroid/content/BroadcastReceiver;

    new-instance v4, Lcom/android/server/audio/AudioService$AudioServiceUserRestrictionsListener;

    invoke-direct {v4, v7, v5}, Lcom/android/server/audio/AudioService$AudioServiceUserRestrictionsListener;-><init>(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$1;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mUserRestrictionsListener:Lcom/android/server/pm/UserManagerInternal$UserRestrictionsListener;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSetModeDeathHandlers:Ljava/util/ArrayList;

    iput v3, v7, Lcom/android/server/audio/AudioService;->mPrevVolDirection:I

    iput v2, v7, Lcom/android/server/audio/AudioService;->mVolumeControlStream:I

    iput-boolean v3, v7, Lcom/android/server/audio/AudioService;->mUserSelectedVolumeControlStream:Z

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mForceControlStreamLock:Ljava/lang/Object;

    iput-object v5, v7, Lcom/android/server/audio/AudioService;->mForceControlStreamClient:Lcom/android/server/audio/AudioService$ForceControlStreamClient;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mFixedVolumeDevices:Ljava/util/Set;

    new-instance v4, Ljava/util/HashSet;

    invoke-direct {v4}, Ljava/util/HashSet;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mFullVolumeDevices:Ljava/util/Set;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAbsVolumeMultiModeCaseDevices:Ljava/util/Set;

    iput-boolean v10, v7, Lcom/android/server/audio/AudioService;->mDockAudioMediaEnabled:Z

    new-instance v4, Lcom/android/server/audio/AudioService$RestorableParameters;

    invoke-direct {v4, v5}, Lcom/android/server/audio/AudioService$RestorableParameters;-><init>(Lcom/android/server/audio/AudioService$1;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mRestorableParameters:Lcom/android/server/audio/AudioService$RestorableParameters;

    iput v3, v7, Lcom/android/server/audio/AudioService;->mDockState:I

    new-array v4, v12, [F

    fill-array-data v4, :array_4

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mPrescaleAbsoluteVolume:[F

    sget-object v4, Landroid/media/VolumePolicy;->DEFAULT:Landroid/media/VolumePolicy;

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mVolumePolicy:Landroid/media/VolumePolicy;

    iput v2, v7, Lcom/android/server/audio/AudioService;->mHotwordDetectionServiceUid:I

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mHotwordDetectionServiceUidLock:Ljava/lang/Object;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAccessibilityServiceUidsLock:Ljava/lang/Object;

    iput v2, v7, Lcom/android/server/audio/AudioService;->mInputMethodServiceUid:I

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mInputMethodServiceUidLock:Ljava/lang/Object;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSupportedSystemUsagesLock:Ljava/lang/Object;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSupportedSystemUsages:[I

    new-instance v4, Lcom/android/server/audio/AudioService$2;

    invoke-direct {v4, v7}, Lcom/android/server/audio/AudioService$2;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mUidObserver:Landroid/app/IUidObserver;

    iput-boolean v3, v7, Lcom/android/server/audio/AudioService;->mRttEnabled:Z

    new-instance v4, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v4, v3}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mVoicePlaybackActive:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v4, Lcom/android/server/audio/AudioService$3;

    invoke-direct {v4, v7}, Lcom/android/server/audio/AudioService$3;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mVoicePlaybackActivityMonitor:Landroid/media/IPlaybackConfigDispatcher;

    new-instance v4, Lcom/android/server/audio/AudioService$4;

    invoke-direct {v4, v7}, Lcom/android/server/audio/AudioService$4;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mVoiceRecordingActivityMonitor:Landroid/media/IRecordingConfigDispatcher;

    iput v3, v7, Lcom/android/server/audio/AudioService;->mRmtSbmxFullVolRefCount:I

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mRmtSbmxFullVolDeathHandlers:Ljava/util/ArrayList;

    iput-boolean v3, v7, Lcom/android/server/audio/AudioService;->mIsCallScreeningModeSupported:Z

    new-instance v4, Landroid/os/RemoteCallbackList;

    invoke-direct {v4}, Landroid/os/RemoteCallbackList;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mModeDispatchers:Landroid/os/RemoteCallbackList;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSafeMediaVolumeStateLock:Ljava/lang/Object;

    iput v3, v7, Lcom/android/server/audio/AudioService;->mMcc:I
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSafeMediaVolumeDevices:Ljava/util/Set;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mHdmiClientLock:Ljava/lang/Object;

    iput-boolean v3, v7, Lcom/android/server/audio/AudioService;->mHdmiSystemAudioSupported:Z

    new-instance v4, Lcom/android/server/audio/AudioService$MyHdmiControlStatusChangeListenerCallback;

    invoke-direct {v4, v7, v5}, Lcom/android/server/audio/AudioService$MyHdmiControlStatusChangeListenerCallback;-><init>(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$1;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mHdmiControlStatusChangeListenerCallback:Lcom/android/server/audio/AudioService$MyHdmiControlStatusChangeListenerCallback;

    new-instance v4, Lcom/android/server/audio/AudioService$MyHdmiCecVolumeControlFeatureListener;

    invoke-direct {v4, v7, v5}, Lcom/android/server/audio/AudioService$MyHdmiCecVolumeControlFeatureListener;-><init>(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$1;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mMyHdmiCecVolumeControlFeatureListener:Lcom/android/server/audio/AudioService$MyHdmiCecVolumeControlFeatureListener;

    new-instance v4, Lcom/android/server/audio/AudioEventLogger;

    const/16 v5, 0x14

    const-string/jumbo v8, "phone state (logged after successful call to AudioSystem.setPhoneState(int, int))"

    invoke-direct {v4, v5, v8}, Lcom/android/server/audio/AudioEventLogger;-><init>(ILjava/lang/String;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mModeLogger:Lcom/android/server/audio/AudioEventLogger;

    new-instance v4, Lcom/android/server/audio/AudioEventLogger;

    const/16 v5, 0xa

    const-string v8, "dynamic policy events (logged when command received by AudioService)"

    invoke-direct {v4, v5, v8}, Lcom/android/server/audio/AudioEventLogger;-><init>(ILjava/lang/String;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mDynPolicyLogger:Lcom/android/server/audio/AudioEventLogger;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mExtVolumeControllerLock:Ljava/lang/Object;

    new-instance v4, Lcom/android/server/audio/AudioService$6;

    invoke-direct {v4, v7}, Lcom/android/server/audio/AudioService$6;-><init>(Lcom/android/server/audio/AudioService;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mDynPolicyCallback:Landroid/media/AudioSystem$DynamicPolicyCallback;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAudioServerStateListeners:Ljava/util/HashMap;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAudioPolicies:Ljava/util/HashMap;

    iput v3, v7, Lcom/android/server/audio/AudioService;->mAudioPolicyCounter:I

    sget-object v4, Lcom/android/server/audio/AudioService;->sLifecycleLogger:Lcom/android/server/audio/AudioEventLogger;
    ...
    invoke-virtual {v4, v8}, Lcom/android/server/audio/AudioEventLogger;->log(Lcom/android/server/audio/AudioEventLogger$Event;)V
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAppOps:Landroid/app/AppOpsManager;

    iput-object v1, v7, Lcom/android/server/audio/AudioService;->mAudioSystem:Lcom/android/server/audio/AudioSystemAdapter;

    move-object/from16 v4, p3

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSystemServer:Lcom/android/server/audio/SystemServerAdapter;

    invoke-static/range {p1 .. p1}, Landroid/media/AudioSystem;->getPlatformType(Landroid/content/Context;)I

    move-result v4

    iput v4, v7, Lcom/android/server/audio/AudioService;->mPlatformType:I

    invoke-static/range {p1 .. p1}, Landroid/media/AudioSystem;->isSingleVolume(Landroid/content/Context;)Z

    move-result v4

    iput-boolean v4, v7, Lcom/android/server/audio/AudioService;->mIsSingleVolume:Z
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mUserManagerInternal:Lcom/android/server/pm/UserManagerInternal;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSensorPrivacyManagerInternal:Landroid/hardware/SensorPrivacyManagerInternal;
    ...
    const-string v8, "handleAudioEvent"

    invoke-virtual {v4, v10, v8}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v4

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mAudioEventWakeLock:Landroid/os/PowerManager$WakeLock;

    new-instance v4, Lcom/android/server/audio/SoundEffectsHelper;

    invoke-direct {v4, v0}, Lcom/android/server/audio/SoundEffectsHelper;-><init>(Landroid/content/Context;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSfxHelper:Lcom/android/server/audio/SoundEffectsHelper;

    new-instance v4, Lcom/android/server/audio/SpatializerHelper;

    invoke-direct {v4, v7, v1}, Lcom/android/server/audio/SpatializerHelper;-><init>(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioSystemAdapter;)V

    iput-object v4, v7, Lcom/android/server/audio/AudioService;->mSpatializerHelper:Lcom/android/server/audio/SpatializerHelper;
    ...
    invoke-virtual {v1, v10}, Landroid/hardware/SensorPrivacyManager;->supportsSensorToggle(I)Z
    ...
    sget-object v9, Lcom/android/server/audio/AudioService;->MAX_STREAM_VOLUME:[I
    ...
    sget-object v8, Lcom/android/server/audio/AudioService;->MIN_STREAM_VOLUME:[I
    ...
    iput-boolean v1, v7, Lcom/android/server/audio/AudioService;->mVoiceCapable:Z
    ...
    iget-object v11, v7, Lcom/android/server/audio/AudioService;->mAudioHandler:Lcom/android/server/audio/AudioService$AudioHandler;
    ...
    iget-object v1, v7, Lcom/android/server/audio/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    ...
    :goto_8
    iput-boolean v1, v7, Lcom/android/server/audio/AudioService;->mLinkNotificationWithVolume:Z
    ...
    invoke-virtual {v1, v2, v10}, Lcom/android/server/audio/RecordingActivityMonitor;->registerRecordingCallback(Landroid/media/IRecordingConfigDispatcher;Z)V

    const-string v2, "AS.AudioService"

    invoke-direct {v7, v3, v2}, Lcom/android/server/audio/AudioService;->updateStreamVolumeAlias(ZLjava/lang/String;)V
    ...
    invoke-direct {v2, v0, v4}, Lcom/android/server/audio/PlaybackActivityMonitor;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v2, v0, v10}, Lcom/android/server/audio/PlaybackActivityMonitor;->registerPlaybackCallback(Landroid/media/IPlaybackConfigDispatcher;Z)V

    new-instance v0, Lcom/android/server/audio/MediaFocusControl;

    iget-object v4, v7, Lcom/android/server/audio/AudioService;->mContext:Landroid/content/Context;

    invoke-direct {v0, v4, v2}, Lcom/android/server/audio/MediaFocusControl;-><init>(Landroid/content/Context;Lcom/android/server/audio/PlayerFocusEnforcer;)V
...
.method static synthetic access$10100(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/audio/AudioService;->mHotwordDetectionServiceUidLock:Ljava/lang/Object;
...
.method static synthetic access$10200(Lcom/android/server/audio/AudioService;)I
    ...
    iget p0, p0, Lcom/android/server/audio/AudioService;->mHotwordDetectionServiceUid:I
...
.method static synthetic access$11000(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioEventLogger;
    .locals 0
...
.method static synthetic access$7600(Lcom/android/server/audio/AudioService;ZLjava/lang/String;)V
    .locals 0
...
.method static synthetic access$7700(Lcom/android/server/audio/AudioService;ILjava/lang/String;)V
    .locals 0
...
.method static synthetic access$8600(Lcom/android/server/audio/AudioService;)Landroid/hardware/SensorPrivacyManagerInternal;
    .locals 0
...
.method static synthetic access$8700(Lcom/android/server/audio/AudioService;I)V
    .locals 0
...
.method static synthetic access$9200(Lcom/android/server/audio/AudioService;ZII)V
    .locals 0
...
.method static synthetic access$9300(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    .locals 0
...
.method static synthetic access$9400(Lcom/android/server/audio/AudioService;)Landroid/hardware/hdmi/HdmiControlManager;
    .locals 0
...
.method private adjustSuggestedStreamVolume(IIILjava/lang/String;Ljava/lang/String;IIZI)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->notifyExternalVolumeController(I)Z
    ...
    :cond_6
    :goto_3
    invoke-direct {p0, v2, v4}, Lcom/android/server/audio/AudioService;->wasStreamActiveRecently(II)Z
...
.method private checkForRingerModeChange(IIIZLjava/lang/String;I)I
    ...
    invoke-direct {p0, v1, p3, v6}, Lcom/android/server/audio/AudioService;->setRingerMode(ILjava/lang/String;Z)V
...
.method private checkVolumeRangeInitialization(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(ILjava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
...
.method private enforceSafeMediaVolume(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/audio/AudioService;->safeMediaVolumeIndex(I)I
...
.method private getActiveStreamType(I)I
    ...
    invoke-virtual {p1}, Lcom/android/server/audio/AudioDeviceBroker;->isBluetoothScoActive()Z
    ...
    invoke-direct {p0, v5, p1}, Lcom/android/server/audio/AudioService;->wasStreamActiveRecently(II)Z
    ...
    invoke-virtual {p1, v6, v0}, Lcom/android/server/audio/AudioSystemAdapter;->isStreamActive(II)Z
    ...
    invoke-virtual {p1, v5, v0}, Lcom/android/server/audio/AudioSystemAdapter;->isStreamActive(II)Z
...
.method private getDevicesForStreamInt(I)I
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/audio/AudioService$VolumeStreamState;->observeDevicesForStream_syncVSS(Z)I
...
.method private getEnabledFormats()Ljava/util/HashSet;
    ...
    sget-object v2, Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda8;->INSTANCE:Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda8;
    ...
    new-instance v2, Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda3;

    invoke-direct {v2, v0}, Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda3;-><init>(Ljava/util/HashSet;)V
    ...
    const-string v3, "ENCODED_SURROUND_OUTPUT_ENABLED_FORMATS misformatted."
...
.method private getHearingAidStreamType(I)I
    ...
    iget-object p1, p0, Lcom/android/server/audio/AudioService;->mVoicePlaybackActive:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private isPolicyRegisterAllowed(Landroid/media/audiopolicy/AudioPolicyConfig;ZZLandroid/media/projection/IMediaProjection;)Z
    ...
    invoke-virtual {v6}, Landroid/media/audiopolicy/AudioMixingRule;->allowPrivilegedMediaPlaybackCapture()Z
    ...
    invoke-static {v6}, Landroid/media/audiopolicy/AudioMix;->canBeUsedForPrivilegedMediaCapture(Landroid/media/AudioFormat;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Landroid/media/audiopolicy/AudioMix;->containsMatchAttributeRuleForUsage(I)Z
    ...
    const-string p1, "Audio capture for voice communication requires CAPTURE_VOICE_COMMUNICATION_OUTPUT system permission"
...
.method private isValidAudioAttributesUsage(Landroid/media/AudioAttributes;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/audio/AudioService;->callerHasPermission(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->isSupportedSystemUsage(I)Z
...
.method private onAccessoryPlugMediaUnmute(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/audio/AudioService$VolumeStreamState;->mute(Z)Z
...
.method private onCheckVolumeCecOnHdmiConnection(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/audio/AudioService;->updateHdmiCecSinkLocked(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/audio/AudioService;->sendEnabledSurroundFormats(Landroid/content/ContentResolver;Z)V
...
.method private onObserveDevicesForAllStreams(I)V
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/audio/AudioService$VolumeStreamState;->observeDevicesForStream_syncVSS(Z)I

    move-result v4

    invoke-static {v4}, Landroid/media/AudioSystem;->generateAudioDeviceTypesSet(I)Ljava/util/Set;
    ...
    invoke-direct {p0, v5, v3, v6}, Lcom/android/server/audio/AudioService;->updateVolumeStates(IILjava/lang/String;)V
...
.method private onReinitVolumes(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(ILjava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(ILjava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
...
.method private onSetStreamVolume(IIIILjava/lang/String;Z)V
    ...
    :cond_2
    invoke-virtual {p1, p5}, Lcom/android/server/audio/AudioService$VolumeStreamState;->mute(Z)Z
...
.method private onUnmuteStream(II)V
    ...
    :try_start_1
    invoke-direct {p0, p2}, Lcom/android/server/audio/AudioService;->maybeSendSystemAudioStatusCommand(Z)V
...
.method private readUserRestrictions()V
    ...
    :goto_2
    invoke-direct {p0, v2}, Lcom/android/server/audio/AudioService;->setSystemAudioMute(Z)V

    invoke-static {v2}, Landroid/media/AudioSystem;->setMasterMute(Z)I

    invoke-direct {p0, v2}, Lcom/android/server/audio/AudioService;->broadcastMasterMuteStatus(Z)V
...
.method private rescaleStep(III)I
    ...
    const-string/jumbo p2, "rescaleStep : index range should not be zero"
...
.method private sendEnabledSurroundFormats(Landroid/content/ContentResolver;Z)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/audio/AudioService;->isSurroundFormat(I)Z
...
.method private setDeviceVolumeBehaviorInternal(IILjava/lang/String;)V
    ...
    const-string p2, "Absolute volume unsupported for now"
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/audio/AudioService;->postUpdateVolumeStatesForAudioDevice(ILjava/lang/String;)V
...
.method private setMasterMuteInternal(ZILjava/lang/String;III)V
    ...
    invoke-virtual {p3, v0, p6, p4}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I
...
.method private setStreamVolume(IIILjava/lang/String;Ljava/lang/String;IZ)V
    ...
    invoke-direct {p0, v6, v5, v3}, Lcom/android/server/audio/AudioService;->checkNoteAppOp(IILjava/lang/String;)Z
    ...
    :cond_3
    invoke-direct {p0, v3}, Lcom/android/server/audio/AudioService;->isAndroidNPlus(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_5

    invoke-direct {p0, v9, v1, v2}, Lcom/android/server/audio/AudioService;->getNewRingerMode(III)I

    move-result v5

    invoke-direct {p0, v5}, Lcom/android/server/audio/AudioService;->wouldToggleZenMode(I)Z
    ...
    :cond_5
    :goto_1
    invoke-direct {p0, v9, v2}, Lcom/android/server/audio/AudioService;->volumeAdjustmentAllowedByDnd(II)Z
    ...
    invoke-direct {p0, v1, v8, v9}, Lcom/android/server/audio/AudioService;->rescaleIndex(III)I
    ...
    invoke-direct {p0, v12, v1, v3, v2}, Lcom/android/server/audio/AudioService;->setSystemAudioVolume(IIII)V
    ...
    invoke-direct {p0, v10}, Lcom/android/server/audio/AudioService;->isFixedVolumeDevice(I)Z
    ...
    :goto_2
    invoke-direct {p0, v9, v3, v10}, Lcom/android/server/audio/AudioService;->checkSafeMediaVolume(III)Z
    ...
    :try_start_1
    invoke-direct {p0, v3}, Lcom/android/server/audio/AudioService;->maybeSendSystemAudioStatusCommand(Z)V
...
.method private unregisterAudioPolicyInt(Landroid/media/audiopolicy/IAudioPolicyCallback;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p2}, Lcom/android/server/audio/AudioEventLogger$StringEvent;->printLog(Ljava/lang/String;)Lcom/android/server/audio/AudioEventLogger$Event;
    ...
    const-string v1, "Trying to unregister unknown audio policy for pid "
...
.method private updateAssistantUId(Z)V
    ...
    :goto_1
    iget v1, p0, Lcom/android/server/audio/AudioService;->mAssistantUid:I
...
.method private updateHdmiCecSinkLocked(Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/audio/AudioService;->postUpdateVolumeStatesForAudioDevice(ILjava/lang/String;)V
...
.method private updateStreamVolumeAlias(ZLjava/lang/String;)V
    ...
    iget-object v10, v0, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_TELEVISION:[I

    sput-object v10, Lcom/android/server/audio/AudioService;->mStreamVolumeAlias:[I

    goto :goto_2

    :cond_2
    iget-boolean v10, v0, Lcom/android/server/audio/AudioService;->mUseVolumeGroupAliases:Z
    ...
    :cond_3
    iget v10, v0, Lcom/android/server/audio/AudioService;->mPlatformType:I

    packed-switch v10, :pswitch_data_0

    iget-object v10, v0, Lcom/android/server/audio/AudioService;->STREAM_VOLUME_ALIAS_DEFAULT:[I
    ...
    iput v10, v0, Lcom/android/server/audio/AudioService;->mRingerModeAffectedStreams:I
    ...
    invoke-virtual {v8, v3, v1}, Lcom/android/server/audio/AudioService$VolumeStreamState;->setAllIndexes(Lcom/android/server/audio/AudioService$VolumeStreamState;Ljava/lang/String;)V
    ...
    invoke-static {v3, v7}, Lcom/android/server/audio/AudioService$VolumeStreamState;->access$1402(Lcom/android/server/audio/AudioService$VolumeStreamState;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v10}, Lcom/android/server/audio/AudioService;->setRingerModeInt(IZ)V
...
.method private updateVibratorInfos()V
    ...
    const-string v0, "Vibrator manager is not found"
    ...
    const-string v0, "No vibrator found"
    ...
    const-string v0, "Cannot find any available vibrator"
...
.method private updateVolumeStates(IILjava/lang/String;)V
    ...
    invoke-virtual {p0, p3}, Lcom/android/server/audio/AudioService;->getDevicesForAttributesInt(Landroid/media/AudioAttributes;)Ljava/util/ArrayList;
...
.method private validateAudioAttributesUsage(Landroid/media/AudioAttributes;)V
    ...
    const-string v2, "Unsupported usage "
...
.method protected adjustStreamVolume(IIILjava/lang/String;Ljava/lang/String;IIZI)V
    ...
    invoke-direct {v0, v3, v1, v6}, Lcom/android/server/audio/AudioService;->checkNoteAppOp(IILjava/lang/String;)Z
    ...
    invoke-direct {v0, v13}, Lcom/android/server/audio/AudioService;->isFixedVolumeDevice(I)Z
    ...
    invoke-direct {v0, v3, v8, v15}, Lcom/android/server/audio/AudioService;->rescaleStep(III)I
    ...
    invoke-direct {v0, v15}, Lcom/android/server/audio/AudioService;->isUiSoundsStreamType(I)Z
    ...
    invoke-direct {v0, v3}, Lcom/android/server/audio/AudioService;->setSystemAudioMute(Z)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/server/audio/AudioService$VolumeStreamState;->mute(Z)Z
    ...
    invoke-direct {v0, v15, v3, v13}, Lcom/android/server/audio/AudioService;->checkSafeMediaVolume(III)Z
    ...
    :cond_19
    invoke-direct {v0, v13}, Lcom/android/server/audio/AudioService;->isFullVolumeDevice(I)Z
    ...
    invoke-virtual {v14, v3, v13, v5, v6}, Lcom/android/server/audio/AudioService$VolumeStreamState;->adjustIndex(IILjava/lang/String;Z)Z
    ...
    invoke-virtual {v6, v5}, Lcom/android/server/audio/AudioService$VolumeStreamState;->getIndex(I)I
    ...
    sget-object v13, Landroid/media/AudioSystem;->DEVICE_OUT_ALL_A2DP_SET:Ljava/util/Set;
    ...
    iget-object v13, v0, Lcom/android/server/audio/AudioService;->mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    div-int/lit8 v14, v6, 0xa

    invoke-virtual {v13, v14}, Lcom/android/server/audio/AudioDeviceBroker;->postSetAvrcpAbsoluteVolumeIndex(I)V
    ...
    invoke-virtual {v13, v6, v8}, Lcom/android/server/audio/AudioDeviceBroker;->postSetHearingAidVolumeIndex(II)V
    ...
    invoke-direct {v0, v2, v6, v13, v1}, Lcom/android/server/audio/AudioService;->setSystemAudioVolume(IIII)V
    ...
    iget-object v7, v0, Lcom/android/server/audio/AudioService;->mHdmiClientLock:Ljava/lang/Object;

    monitor-enter v7

    :try_start_1
    iget-object v13, v0, Lcom/android/server/audio/AudioService;->mHdmiManager:Landroid/hardware/hdmi/HdmiControlManager;

    if-eqz v13, :cond_27

    iget-object v13, v0, Lcom/android/server/audio/AudioService;->mHdmiPlaybackClient:Landroid/hardware/hdmi/HdmiPlaybackClient;
    ...
    invoke-direct {v0, v5}, Lcom/android/server/audio/AudioService;->isFullVolumeDevice(I)Z
    ...
    invoke-virtual {v10, v9, v3}, Landroid/hardware/hdmi/HdmiPlaybackClient;->sendVolumeKeyEvent(IZ)V

    goto :goto_f

    :pswitch_1
    iget-object v3, v0, Lcom/android/server/audio/AudioService;->mHdmiPlaybackClient:Landroid/hardware/hdmi/HdmiPlaybackClient;

    const/4 v10, 0x1

    invoke-virtual {v3, v9, v10}, Landroid/hardware/hdmi/HdmiPlaybackClient;->sendVolumeKeyEvent(IZ)V
    ...
    iget-object v15, v0, Lcom/android/server/audio/AudioService;->mHdmiPlaybackClient:Landroid/hardware/hdmi/HdmiPlaybackClient;

    invoke-virtual {v15, v9, v10}, Landroid/hardware/hdmi/HdmiPlaybackClient;->sendVolumeKeyEvent(IZ)V
    ...
    const-string v15, "Invalid keyEventMode "
    ...
    :cond_26
    invoke-direct {v0, v11}, Lcom/android/server/audio/AudioService;->maybeSendSystemAudioStatusCommand(Z)V
...
.method public adjustStreamVolumeForUid(IIILjava/lang/String;IILandroid/os/UserHandle;I)V
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/server/audio/AudioService;->hasAudioSettingsPermission(II)Z
...
.method public adjustSuggestedStreamVolumeForUid(IIILjava/lang/String;IILandroid/os/UserHandle;I)V
    ...
    invoke-direct {p0, v1, v9}, Lcom/android/server/audio/AudioService;->hasAudioSettingsPermission(II)Z
...
.method protected dispatchMode(I)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/audio/AudioService;->mModeDispatchers:Landroid/os/RemoteCallbackList;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0, p3}, Lcom/android/server/audio/AudioService$AudioHandler;->dump(Landroid/util/Printer;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->dumpDeviceTypes(Ljava/util/Set;)Ljava/lang/String;
    ...
    iget p1, p0, Lcom/android/server/audio/AudioService;->mAssistantUid:I
    ...
    const-string p3, "mHasSpatializerEffect:"
    ...
    const-string p3, "isSpatialAudioEnabled:"
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/audio/AudioSystemAdapter;->dump(Ljava/io/PrintWriter;)V
...
.method public getEncodedSurroundMode(I)I
    ...
    const-string v0, "Missing WRITE_SETTINGS permission"
...
.method public getMaxAdditionalOutputDeviceDelay(Landroid/media/AudioDeviceAttributes;)J
    ...
    const-string/jumbo v1, "max_additional_output_device_delay="
...
.method public getReportedSurroundFormats()Ljava/util/List;
    ...
    const-string v2, "getReportedSurroundFormats failed:"
...
.method public getStreamMinVolume(I)I
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/audio/AudioService$VolumeStreamState;->getMinIndex(Z)I
...
.method public getSurroundFormats()Ljava/util/Map;
    ...
    const-string v2, "getSurroundFormats failed:"
...
.method public getVolumeIndexForAttributes(Landroid/media/AudioAttributes;)I
    ...
    invoke-virtual {p1}, Lcom/android/server/audio/AudioService$VolumeGroupState;->getVolumeIndex()I
    ...
    const-string v2, "No volume group for attributes "
...
.method protected initMinStreamVolumeWithoutModifyAudioSettings()V
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/audio/AudioService$VolumeStreamState;->updateNoPermMinIndex(I)V
...
.method public isSurroundFormatEnabled(I)Z
    ...
    const-string v0, "audioFormat to enable is not a surround format."
...
.method public loadSoundEffects()Z
    ...
    invoke-direct {v7, v0}, Lcom/android/server/audio/AudioService$LoadSoundEffectReply;-><init>(Lcom/android/server/audio/AudioService$1;)V
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/audio/AudioService$LoadSoundEffectReply;->waitForLoaded(I)Z
...
.method monitorRoutingChanges(Z)V
    ...
    :goto_0
    invoke-static {p1}, Lcom/android/server/audio/AudioSystemAdapter;->setRoutingListener(Lcom/android/server/audio/AudioSystemAdapter$OnRoutingUpdatedListener;)V
...
.method public onAudioServerDied()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/audio/AudioService;->onReinitVolumes(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v3}, Lcom/android/server/audio/AudioService;->sendEncodedSurroundMode(Landroid/content/ContentResolver;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/server/audio/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    invoke-direct {p0, v1, v4}, Lcom/android/server/audio/AudioService;->sendEnabledSurroundFormats(Landroid/content/ContentResolver;Z)V
    ...
    invoke-static {v0}, Landroid/media/AudioSystem;->setHotwordDetectionServiceUid(I)I
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/audio/AudioSystemAdapter;->setCurrentImeUid(I)I
    ...
    :try_start_7
    iget-object v0, p0, Lcom/android/server/audio/AudioService;->mSupportedSystemUsages:[I

    invoke-static {v0}, Landroid/media/AudioSystem;->setSupportedSystemUsages([I)I
...
.method public registerAudioPolicy(Landroid/media/audiopolicy/AudioPolicyConfig;Landroid/media/audiopolicy/IAudioPolicyCallback;ZZZZLandroid/media/projection/IMediaProjection;)Ljava/lang/String;
    ...
    invoke-virtual {v14}, Lcom/android/server/audio/AudioService$AudioPolicyProxy;->toCompactLogString()Ljava/lang/String;
...
.method public removeUserIdDeviceAffinity(Landroid/media/audiopolicy/IAudioPolicyCallback;I)I
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lcom/android/server/audio/AudioService$AudioPolicyProxy;->removeUserIdDeviceAffinities(I)I
...
.method public requestAudioFocus(Landroid/media/AudioAttributes;ILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;ILandroid/media/audiopolicy/IAudioPolicyCallback;I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->isValidAudioAttributesUsage(Landroid/media/AudioAttributes;)Z
    ...
    invoke-direct {p0, p1, p2, v2}, Lcom/android/server/audio/AudioService;->forceFocusDuckingForAccessibility(Landroid/media/AudioAttributes;II)Z
...
.method public setAdditionalOutputDeviceDelay(Landroid/media/AudioDeviceAttributes;J)Z
    ...
    iget-object p3, p0, Lcom/android/server/audio/AudioService;->mRestorableParameters:Lcom/android/server/audio/AudioService$RestorableParameters;

    invoke-virtual {p3, p1, p2}, Lcom/android/server/audio/AudioService$RestorableParameters;->setParameters(Ljava/lang/String;Ljava/lang/String;)I
...
.method public setBluetoothA2dpOn(Z)V
    ...
    invoke-virtual {v0, p1, v2}, Lcom/android/server/audio/AudioDeviceBroker;->setBluetoothA2dpOn_Async(ZLjava/lang/String;)V
...
.method public setBluetoothScoOn(Z)V
    ...
    invoke-virtual {v0, p1, v2}, Lcom/android/server/audio/AudioDeviceBroker;->setBluetoothScoOn(ZLjava/lang/String;)V
...
.method public setCommunicationDevice(Landroid/os/IBinder;I)Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/audio/AudioService;->isValidCommunicationDevice(Landroid/media/AudioDeviceInfo;)Z
    ...
    const-string v1, "invalid portID "
    ...
    invoke-virtual {v0, p1, v1, v3, p2}, Lcom/android/server/audio/AudioDeviceBroker;->setCommunicationDevice(Landroid/os/IBinder;ILandroid/media/AudioDeviceInfo;Ljava/lang/String;)Z
...
.method public setDeviceVolumeBehavior(Landroid/media/AudioDeviceAttributes;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/audio/AudioService;->setDeviceVolumeBehaviorInternal(IILjava/lang/String;)V

    invoke-direct {p0, p1, p2}, Lcom/android/server/audio/AudioService;->persistDeviceVolumeBehavior(II)V
...
.method public setMicrophoneMute(ZLjava/lang/String;I)V
    ...
    const-string p2, "disallow unmuting"

    invoke-virtual {v1, p1, p2}, Landroid/media/MediaMetrics$Item;->set(Landroid/media/MediaMetrics$Key;Ljava/lang/Object;)Landroid/media/MediaMetrics$Item;
    ...
    const-string p2, "!checkAudioSettingsPermission"
...
.method public setMicrophoneMuteFromSwitch(Z)V
    ...
    const-string/jumbo v0, "setMicrophoneMuteFromSwitch() called from non system user!"
...
.method public setMode(ILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    iget-object v1, v9, Lcom/android/server/audio/AudioService;->mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    :try_start_0
    iget-object v1, v9, Lcom/android/server/audio/AudioService;->mSetModeDeathHandlers:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/android/server/audio/AudioService$AudioHandler;->removeEqualMessages(ILjava/lang/Object;)V
    ...
    invoke-interface {v1, v0, v14}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    :try_end_1
    ...
    const-string/jumbo v1, "setMode link does not exist ..."
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/audio/AudioService$SetModeDeathHandler;->setMode(I)V
    ...
    :try_start_3
    invoke-interface {v10, v0, v14}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_3
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/audio/AudioService$SetModeDeathHandler;->setPlaybackActive(Z)V

    invoke-virtual {v7, v0}, Lcom/android/server/audio/AudioService$SetModeDeathHandler;->setRecordingActive(Z)V

    iget-object v2, v9, Lcom/android/server/audio/AudioService;->mAudioHandler:Lcom/android/server/audio/AudioService$AudioHandler;
...
.method public setPreferredDevicesForCapturePreset(ILjava/util/List;)I
    ...
    const-string p2, "Unsupported output routing in "
...
.method public setPreferredDevicesForStrategy(ILjava/util/List;)I
    ...
    const-string p2, "Unsupported input routing in "
...
.method public setSpeakerphoneOn(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v0, p1, v1, p2, v2}, Lcom/android/server/audio/AudioDeviceBroker;->setSpeakerphoneOn(Landroid/os/IBinder;IZLjava/lang/String;)V
...
.method public setStreamVolume(IIILjava/lang/String;)V
    ...
    :cond_2
    sget-object v8, Lcom/android/server/audio/AudioService;->sVolumeLogger:Lcom/android/server/audio/AudioEventLogger;
...
.method public setStreamVolumeForUid(IIILjava/lang/String;IILandroid/os/UserHandle;I)V
    ...
    invoke-direct {p0, p5, v2}, Lcom/android/server/audio/AudioService;->hasAudioSettingsPermission(II)Z
...
.method public setSurroundFormatEnabled(IZ)Z
    ...
    const-string p2, "audioFormat to enable is not a surround format."
    ...
    const-string p2, "Missing WRITE_SETTINGS permission"
...
.method public setUserIdDeviceAffinity(Landroid/media/audiopolicy/IAudioPolicyCallback;I[I[Ljava/lang/String;)I
    ...
    :cond_1
    invoke-virtual {p1, p2, p3, p4}, Lcom/android/server/audio/AudioService$AudioPolicyProxy;->setUserIdDeviceAffinities(I[I[Ljava/lang/String;)I
...
.method public setVolumeIndexForAttributes(Landroid/media/AudioAttributes;IILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/audio/AudioService$VolumeGroupState;->setVolumeIndex(II)V
    ...
    :try_start_0
    invoke-direct {v6, v13}, Lcom/android/server/audio/AudioService;->ensureValidStreamType(I)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct/range {v12 .. v19}, Lcom/android/server/audio/AudioService;->setStreamVolume(IIILjava/lang/String;Ljava/lang/String;IZ)V
    ...
    const-string/jumbo v7, "volume group "

    invoke-virtual {v0, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v8}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, " has internal streams ("

    invoke-virtual {v0, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, "), do not change associated stream volume"
...
.method startBluetoothScoInt(Landroid/os/IBinder;IILjava/lang/String;)V
    ...
    const-string/jumbo p2, "permission or systemReady"
...
.method public stopBluetoothSco(Landroid/os/IBinder;)V
    ...
    const-string v0, "audio.bluetooth"

    invoke-direct {p1, v0}, Landroid/media/MediaMetrics$Item;-><init>(Ljava/lang/String;)V

    invoke-virtual {p1, v1}, Landroid/media/MediaMetrics$Item;->setUid(I)Landroid/media/MediaMetrics$Item;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroid/media/MediaMetrics$Item;->setPid(I)Landroid/media/MediaMetrics$Item;
    ...
    sget-object v0, Landroid/media/MediaMetrics$Property;->SCO_AUDIO_MODE:Landroid/media/MediaMetrics$Key;
...
.method updateAbsVolumeMultiModeDevices(II)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/audio/AudioSystemAdapter;->getDevicesForStream(I)I

    move-result v0

    invoke-static {v0}, Landroid/media/AudioSystem;->generateAudioDeviceTypesSet(I)Ljava/util/Set;
