...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_2
    invoke-virtual {p0, v2, p1, p2}, Landroid/hardware/biometrics/face/ISession$Stub;->setFeature(Landroid/hardware/keymaster/HardwareAuthToken;BZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->removeEnrollments([I)V
    ...
    invoke-interface {p1}, Landroid/hardware/biometrics/common/ICancellationSignal;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/hardware/biometrics/face/ISession$Stub;->authenticate(J)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    sget-object v3, Landroid/hardware/common/NativeHandle;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, p2}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Landroid/hardware/common/NativeHandle;
    ...
    :goto_4
    invoke-virtual {p0, p1, p4, v0, p2}, Landroid/hardware/biometrics/face/ISession$Stub;->enroll(Landroid/hardware/keymaster/HardwareAuthToken;B[BLandroid/hardware/common/NativeHandle;)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->getEnrollmentConfig(B)[Landroid/hardware/biometrics/face/EnrollmentStageConfig;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/hardware/biometrics/face/ISession$Stub;->revokeChallenge(J)V
