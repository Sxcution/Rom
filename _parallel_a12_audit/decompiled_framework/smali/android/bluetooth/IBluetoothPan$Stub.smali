...
# static fields
.field public static final greylist-max-o DESCRIPTOR:Ljava/lang/String; = "android.bluetooth.IBluetoothPan"
...
.field static final greylist-max-o TRANSACTION_isTetheringOn:I = 0x1

.field static final greylist-max-o TRANSACTION_setBluetoothTethering:I = 0x2
...
.method public static greylist-max-o asInterface(Landroid/os/IBinder;)Landroid/bluetooth/IBluetoothPan;
    .locals 2
...
.method public static blacklist getDefaultImpl()Landroid/bluetooth/IBluetoothPan;
    .locals 1
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    .line 90
    :pswitch_6
    const-string p0, "setBluetoothTethering"

    return-object p0

    .line 86
    :pswitch_7
    const-string p0, "isTetheringOn"
...
.method public static blacklist setDefaultImpl(Landroid/bluetooth/IBluetoothPan;)Z
    .locals 1
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 288
    :goto_1
    invoke-virtual {p0, p1, p4, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->setConnectionPolicy(Landroid/bluetooth/BluetoothDevice;ILandroid/content/AttributionSource;)Z
    ...
    .line 264
    :goto_3
    invoke-virtual {p0, p1, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->getConnectionState(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)I
    ...
    .line 242
    :goto_4
    invoke-virtual {p0, p1, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->getDevicesMatchingConnectionStates([ILandroid/content/AttributionSource;)Ljava/util/List;
    ...
    .line 225
    :goto_5
    invoke-virtual {p0, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->getConnectedDevices(Landroid/content/AttributionSource;)Ljava/util/List;
    ...
    .line 210
    :goto_7
    invoke-virtual {p0, p1, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->disconnect(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)Z
    ...
    .line 188
    :goto_9
    invoke-virtual {p0, p1, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->connect(Landroid/bluetooth/BluetoothDevice;Landroid/content/AttributionSource;)Z
    ...
    .line 167
    :goto_b
    invoke-virtual {p0, p1, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->setBluetoothTethering(ZLandroid/content/AttributionSource;)V
    ...
    .line 150
    :goto_c
    invoke-virtual {p0, v2}, Landroid/bluetooth/IBluetoothPan$Stub;->isTetheringOn(Landroid/content/AttributionSource;)Z
