...
.method private constructor blacklist <init>(FJLjava/lang/String;ILjava/lang/String;[F[JFFZIZIFFZZ[JJ)V
    ...
    iput-wide v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->timeStamp:J

    .line 134
    move-object v1, p4

    iput-object v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->packageName:Ljava/lang/String;

    .line 135
    move v1, p5

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->userId:I

    .line 136
    move-object v1, p6

    iput-object v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->uniqueDisplayId:Ljava/lang/String;

    .line 137
    move-object v1, p7

    iput-object v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->luxValues:[F

    .line 138
    move-object v1, p8

    iput-object v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->luxTimestamps:[J

    .line 139
    move v1, p9

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->batteryLevel:F

    .line 140
    move v1, p10

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->powerBrightnessFactor:F

    .line 141
    move v1, p11

    iput-boolean v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->nightMode:Z

    .line 142
    move v1, p12

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->colorTemperature:I

    .line 143
    move/from16 v1, p13

    iput-boolean v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->reduceBrightColors:Z

    .line 144
    move/from16 v1, p14

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->reduceBrightColorsStrength:I

    .line 145
    move/from16 v1, p15

    iput v1, v0, Landroid/hardware/display/BrightnessChangeEvent;->reduceBrightColorsOffset:F
...
.method synthetic constructor blacklist <init>(FJLjava/lang/String;ILjava/lang/String;[F[JFFZIZIFFZZ[JJLandroid/hardware/display/BrightnessChangeEvent$1;)V
    .locals 0
...
.method synthetic constructor blacklist <init>(Landroid/os/Parcel;Landroid/hardware/display/BrightnessChangeEvent$1;)V
    .locals 0
