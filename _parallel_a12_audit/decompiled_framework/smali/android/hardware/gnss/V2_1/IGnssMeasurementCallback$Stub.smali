...
.method public whitelist onTransact(ILandroid/os/HwParcel;Landroid/os/HwParcel;I)V
    ...
    .line 1291
    invoke-virtual {p0, p1, p2}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$Stub;->debug(Landroid/os/NativeHandle;Ljava/util/ArrayList;)V
    ...
    .line 1264
    :sswitch_9
    const-string p1, "android.hardware.gnss@2.1::IGnssMeasurementCallback"

    invoke-virtual {p2, p1}, Landroid/os/HwParcel;->enforceInterface(Ljava/lang/String;)V

    .line 1266
    new-instance p1, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssData;

    invoke-direct {p1}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssData;-><init>()V

    .line 1267
    invoke-virtual {p1, p2}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssData;->readFromParcel(Landroid/os/HwParcel;)V

    .line 1268
    invoke-virtual {p0, p1}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$Stub;->gnssMeasurementCb_2_1(Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$GnssData;)V
    ...
    .line 1252
    :sswitch_a
    const-string p1, "android.hardware.gnss@2.0::IGnssMeasurementCallback"

    invoke-virtual {p2, p1}, Landroid/os/HwParcel;->enforceInterface(Ljava/lang/String;)V

    .line 1254
    new-instance p1, Landroid/hardware/gnss/V2_0/IGnssMeasurementCallback$GnssData;

    invoke-direct {p1}, Landroid/hardware/gnss/V2_0/IGnssMeasurementCallback$GnssData;-><init>()V

    .line 1255
    invoke-virtual {p1, p2}, Landroid/hardware/gnss/V2_0/IGnssMeasurementCallback$GnssData;->readFromParcel(Landroid/os/HwParcel;)V

    .line 1256
    invoke-virtual {p0, p1}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$Stub;->gnssMeasurementCb_2_0(Landroid/hardware/gnss/V2_0/IGnssMeasurementCallback$GnssData;)V
    ...
    .line 1240
    :sswitch_b
    const-string p1, "android.hardware.gnss@1.1::IGnssMeasurementCallback"

    invoke-virtual {p2, p1}, Landroid/os/HwParcel;->enforceInterface(Ljava/lang/String;)V

    .line 1242
    new-instance p1, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$GnssData;

    invoke-direct {p1}, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$GnssData;-><init>()V

    .line 1243
    invoke-virtual {p1, p2}, Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$GnssData;->readFromParcel(Landroid/os/HwParcel;)V

    .line 1244
    invoke-virtual {p0, p1}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$Stub;->gnssMeasurementCb(Landroid/hardware/gnss/V1_1/IGnssMeasurementCallback$GnssData;)V
    ...
    .line 1232
    invoke-virtual {p0, p1}, Landroid/hardware/gnss/V2_1/IGnssMeasurementCallback$Stub;->GnssMeasurementCb(Landroid/hardware/gnss/V1_0/IGnssMeasurementCallback$GnssData;)V
