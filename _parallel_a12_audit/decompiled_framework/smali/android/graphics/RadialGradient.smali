...
.method private constructor blacklist <init>(FFFFFF[J[FLandroid/graphics/Shader$TileMode;Landroid/graphics/ColorSpace;)V
    ...
    const-string p2, "ending radius must be > 0"
    ...
    const-string/jumbo p2, "starting/focal radius must be >= 0"
...
.method protected blacklist createNativeInstance(JZ)J
    ...
    iget v2, v0, Landroid/graphics/RadialGradient;->mFocalX:F

    iget v3, v0, Landroid/graphics/RadialGradient;->mFocalY:F

    iget v4, v0, Landroid/graphics/RadialGradient;->mFocalRadius:F

    iget v5, v0, Landroid/graphics/RadialGradient;->mX:F

    iget v6, v0, Landroid/graphics/RadialGradient;->mY:F

    iget v7, v0, Landroid/graphics/RadialGradient;->mRadius:F

    iget-object v8, v0, Landroid/graphics/RadialGradient;->mColorLongs:[J

    iget-object v9, v0, Landroid/graphics/RadialGradient;->mPositions:[F

    iget-object v1, v0, Landroid/graphics/RadialGradient;->mTileMode:Landroid/graphics/Shader$TileMode;

    iget v10, v1, Landroid/graphics/Shader$TileMode;->nativeInt:I
