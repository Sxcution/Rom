...
.method private greylist-max-o createAndRegisterObserverProxyLocked(Landroid/database/IContentObserver;)V
    ...
    .line 269
    iget-object p1, p0, Landroid/database/CursorToBulkCursorAdaptor;->mCursor:Landroid/database/CrossProcessCursor;

    invoke-interface {p1, v0}, Landroid/database/CrossProcessCursor;->registerContentObserver(Landroid/database/ContentObserver;)V
...
.method public greylist-max-o requery(Landroid/database/IContentObserver;)I
    ...
    invoke-interface {p1}, Landroid/database/CrossProcessCursor;->getCount()I
