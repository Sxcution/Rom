...
# static fields
.field public static blacklist sDefaultImpl:Landroid/content/pm/IPackageInstallerSession;
...
.method public blacklist addChildSessionId(I)V
    ...
    invoke-interface {v2, p1}, Landroid/content/pm/IPackageInstallerSession;->addChildSessionId(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist addFile(ILjava/lang/String;J[B[B)V
    ...
    iget-object v3, v3, Landroid/content/pm/IPackageInstallerSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public greylist-max-o commit(Landroid/content/IntentSender;Z)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/content/pm/IPackageInstallerSession;->commit(Landroid/content/IntentSender;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getChildSessionIds()[I
    ...
    invoke-interface {v2}, Landroid/content/pm/IPackageInstallerSession;->getChildSessionIds()[I
...
.method public blacklist getInstallFlags()I
    ...
    invoke-interface {v2}, Landroid/content/pm/IPackageInstallerSession;->getInstallFlags()I
...
.method public blacklist getParentSessionId()I
    ...
    invoke-interface {v2}, Landroid/content/pm/IPackageInstallerSession;->getParentSessionId()I
...
.method public blacklist isStaged()Z
    ...
    invoke-interface {v2}, Landroid/content/pm/IPackageInstallerSession;->isStaged()Z
...
.method public blacklist removeChildSessionId(I)V
    ...
    invoke-interface {v2, p1}, Landroid/content/pm/IPackageInstallerSession;->removeChildSessionId(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist removeFile(ILjava/lang/String;)V
    ...
    invoke-interface {v2, p1, p2}, Landroid/content/pm/IPackageInstallerSession;->removeFile(ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist setChecksums(Ljava/lang/String;[Landroid/content/pm/Checksum;[B)V
    ...
    invoke-interface {v2, p1, p2, p3}, Landroid/content/pm/IPackageInstallerSession;->setChecksums(Ljava/lang/String;[Landroid/content/pm/Checksum;[B)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist stageViaHardLink(Ljava/lang/String;)V
    ...
    invoke-interface {v2, p1}, Landroid/content/pm/IPackageInstallerSession;->stageViaHardLink(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o write(Ljava/lang/String;JJLandroid/os/ParcelFileDescriptor;)V
    ...
    .line 648
    invoke-virtual {v0, v8, v1}, Landroid/os/ParcelFileDescriptor;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v7, v7, Landroid/content/pm/IPackageInstallerSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;
