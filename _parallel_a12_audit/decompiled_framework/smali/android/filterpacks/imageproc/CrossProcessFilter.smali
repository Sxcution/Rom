...
# instance fields
.field private final blacklist mCrossProcessShader:Ljava/lang/String;
...
.method public constructor blacklist <init>(Ljava/lang/String;)V
    ...
    iput p1, p0, Landroid/filterpacks/imageproc/CrossProcessFilter;->mTileSize:I

    .line 35
    const/4 p1, 0x0

    iput p1, p0, Landroid/filterpacks/imageproc/CrossProcessFilter;->mTarget:I

    .line 37
    const-string p1, "precision mediump float;\nuniform sampler2D tex_sampler_0;\nvarying vec2 v_texcoord;\nvoid main() {\n  vec4 color = texture2D(tex_sampler_0, v_texcoord);\n  vec3 ncolor = vec3(0.0, 0.0, 0.0);\n  float value;\n  if (color.r < 0.5) {\n    value = color.r;\n  } else {\n    value = 1.0 - color.r;\n  }\n  float red = 4.0 * value * value * value;\n  if (color.r < 0.5) {\n    ncolor.r = red;\n  } else {\n    ncolor.r = 1.0 - red;\n  }\n  if (color.g < 0.5) {\n    value = color.g;\n  } else {\n    value = 1.0 - color.g;\n  }\n  float green = 2.0 * value * value;\n  if (color.g < 0.5) {\n    ncolor.g = green;\n  } else {\n    ncolor.g = 1.0 - green;\n  }\n  ncolor.b = color.b * 0.5 + 0.25;\n  gl_FragColor = vec4(ncolor.rgb, color.a);\n}\n"

    iput-object p1, p0, Landroid/filterpacks/imageproc/CrossProcessFilter;->mCrossProcessShader:Ljava/lang/String;
...
.method public blacklist initProgram(Landroid/filterfw/core/FilterContext;I)V
    ...
    const-string v1, "Filter CrossProcess does not support frames of target "
    ...
    .line 90
    iget p1, p0, Landroid/filterpacks/imageproc/CrossProcessFilter;->mTileSize:I
...
.method public blacklist process(Landroid/filterfw/core/FilterContext;)V
    ...
    .line 119
    invoke-virtual {p0, v0, p1}, Landroid/filterpacks/imageproc/CrossProcessFilter;->pushOutput(Ljava/lang/String;Landroid/filterfw/core/Frame;)V
