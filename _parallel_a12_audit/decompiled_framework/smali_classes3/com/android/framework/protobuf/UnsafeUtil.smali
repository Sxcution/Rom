...
.method static blacklist getUnsafe()Lsun/misc/Unsafe;
    ...
    .line 287
    :try_start_0
    new-instance v0, Lcom/android/framework/protobuf/UnsafeUtil$1;

    invoke-direct {v0}, Lcom/android/framework/protobuf/UnsafeUtil$1;-><init>()V
...
.method static blacklist mismatch([BI[BII)I
    ...
    invoke-static {p2, v2, v3}, Lcom/android/framework/protobuf/UnsafeUtil;->getLong(Ljava/lang/Object;J)J
    ...
    .line 451
    invoke-static {v4, v5, v2, v3}, Lcom/android/framework/protobuf/UnsafeUtil;->firstDifferingByteIndexNativeEndian(JJ)I
