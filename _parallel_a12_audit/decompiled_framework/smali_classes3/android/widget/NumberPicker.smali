...
# static fields
.field private static final greylist-max-o DEFAULT_LAYOUT_RESOURCE_ID:I = 0x10900c3
...
.method public constructor whitelist <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p1, v3, v0, v5, v6}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v13, v9, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v13, v2, v10}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    .line 653
    invoke-virtual {v13, v10, v10}, Landroid/content/res/TypedArray;->getColor(II)I
    ...
    .line 669
    invoke-virtual {v13, v8, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    iput v4, v7, Landroid/widget/NumberPicker;->mSelectionDividerHeight:I
    ...
    invoke-virtual {v13, v5, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    iput v4, v7, Landroid/widget/NumberPicker;->mSelectionDividersDistance:I

    .line 678
    const/4 v4, 0x6

    invoke-virtual {v13, v4, v11}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v5

    iput v5, v7, Landroid/widget/NumberPicker;->mMinHeight:I

    .line 681
    const/4 v6, 0x4

    invoke-virtual {v13, v6, v11}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v6

    iput v6, v7, Landroid/widget/NumberPicker;->mMaxHeight:I
    ...
    invoke-virtual {v13, v5, v11}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v5

    iput v5, v7, Landroid/widget/NumberPicker;->mMinWidth:I
    ...
    iput v6, v7, Landroid/widget/NumberPicker;->mMaxWidth:I
    ...
    :goto_3
    iput-boolean v5, v7, Landroid/widget/NumberPicker;->mComputeMaxWidth:Z
    ...
    iput-object v5, v7, Landroid/widget/NumberPicker;->mVirtualButtonPressedDrawable:Landroid/graphics/drawable/Drawable;

    .line 703
    invoke-virtual {v13}, Landroid/content/res/TypedArray;->recycle()V

    .line 705
    new-instance v5, Landroid/widget/NumberPicker$PressedStateHelper;

    invoke-direct {v5, p0}, Landroid/widget/NumberPicker$PressedStateHelper;-><init>(Landroid/widget/NumberPicker;)V

    iput-object v5, v7, Landroid/widget/NumberPicker;->mPressedStateHelper:Landroid/widget/NumberPicker$PressedStateHelper;

    .line 712
    xor-int/lit8 v5, v0, 0x1

    invoke-virtual {p0, v5}, Landroid/widget/NumberPicker;->setWillNotDraw(Z)V
    ...
    .line 716
    invoke-virtual {v5, v1, p0, v8}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    .line 718
    new-instance v1, Landroid/widget/NumberPicker$1;

    invoke-direct {v1, p0}, Landroid/widget/NumberPicker$1;-><init>(Landroid/widget/NumberPicker;)V
    ...
    iput-object v9, v7, Landroid/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;

    .line 746
    invoke-virtual {v9, v1}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 747
    invoke-virtual {v9, v5}, Landroid/widget/ImageButton;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    goto :goto_4

    .line 749
    :cond_7
    iput-object v6, v7, Landroid/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;
    ...
    invoke-virtual {p0, v0}, Landroid/widget/NumberPicker;->findViewById(I)Landroid/view/View;
    ...
    .line 758
    :cond_8
    iput-object v6, v7, Landroid/widget/NumberPicker;->mDecrementButton:Landroid/widget/ImageButton;
    ...
    .line 763
    new-instance v1, Landroid/widget/NumberPicker$3;

    invoke-direct {v1, p0}, Landroid/widget/NumberPicker$3;-><init>(Landroid/widget/NumberPicker;)V
    ...
    new-instance v5, Landroid/widget/NumberPicker$InputTextFilter;

    invoke-direct {v5, p0}, Landroid/widget/NumberPicker$InputTextFilter;-><init>(Landroid/widget/NumberPicker;)V
    ...
    iput v2, v7, Landroid/widget/NumberPicker;->mTouchSlop:I
    ...
    iput v2, v7, Landroid/widget/NumberPicker;->mMinimumFlingVelocity:I
    ...
    iput v1, v7, Landroid/widget/NumberPicker;->mMaximumFlingVelocity:I
    ...
    iput v1, v7, Landroid/widget/NumberPicker;->mTextSize:I
    ...
    invoke-virtual {v0, v1, v11}, Landroid/content/res/ColorStateList;->getColorForState([II)I
    ...
    .line 797
    iput-object v2, v7, Landroid/widget/NumberPicker;->mSelectorWheelPaint:Landroid/graphics/Paint;
    ...
    invoke-direct {v0, v1, v6, v8}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;Z)V

    iput-object v0, v7, Landroid/widget/NumberPicker;->mFlingScroller:Landroid/widget/Scroller;
    ...
    .line 807
    invoke-virtual {p0, v8}, Landroid/widget/NumberPicker;->setImportantForAccessibility(I)V
    ...
    .line 812
    invoke-virtual {p0, v8}, Landroid/widget/NumberPicker;->setFocusable(I)V

    .line 813
    invoke-virtual {p0, v8}, Landroid/widget/NumberPicker;->setFocusableInTouchMode(Z)V
...
.method private greylist-max-o resolveSizeAndStateRespectingMinSize(III)I
    ...
    invoke-static {p1, p3, p2}, Landroid/widget/NumberPicker;->resolveSizeAndState(III)I
...
.method protected whitelist dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1119
    :pswitch_1
    invoke-virtual {v1, v0, v3}, Landroid/widget/NumberPicker$AccessibilityNodeProviderImpl;->sendAccessibilityEventForVirtualView(II)V
    ...
    .line 1099
    :pswitch_2
    invoke-virtual {v1, v0, v6}, Landroid/widget/NumberPicker$AccessibilityNodeProviderImpl;->sendAccessibilityEventForVirtualView(II)V

    .line 1101
    iput v0, p0, Landroid/widget/NumberPicker;->mLastHoveredChildVirtualViewId:I

    .line 1102
    invoke-virtual {v1, v0, v5, v4}, Landroid/widget/NumberPicker$AccessibilityNodeProviderImpl;->performAction(IILandroid/os/Bundle;)Z
    ...
    .line 1108
    invoke-virtual {v1, p1, v3}, Landroid/widget/NumberPicker$AccessibilityNodeProviderImpl;->sendAccessibilityEventForVirtualView(II)V
...
.method public whitelist onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v4, p0, Landroid/widget/NumberPicker;->mMinimumFlingVelocity:I
    ...
    iget v4, p0, Landroid/widget/NumberPicker;->mLastDownEventY:F
    ...
    iget-wide v8, p0, Landroid/widget/NumberPicker;->mLastDownEventTime:J
    ...
    invoke-virtual {p1, v5}, Landroid/widget/NumberPicker$PressedStateHelper;->buttonTapped(I)V
