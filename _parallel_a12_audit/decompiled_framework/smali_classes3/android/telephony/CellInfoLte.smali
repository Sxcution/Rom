...
.method public constructor blacklist <init>(Landroid/hardware/radio/V1_0/CellInfo;)V
    ...
    .line 61
    iget-object p1, p1, Landroid/hardware/radio/V1_0/CellInfo;->lte:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Landroid/hardware/radio/V1_0/CellInfoLte;->cellIdentityLte:Landroid/hardware/radio/V1_0/CellIdentityLte;
    ...
    invoke-direct {v0, p1}, Landroid/telephony/CellSignalStrengthLte;-><init>(Landroid/hardware/radio/V1_0/LteSignalStrength;)V

    iput-object v0, p0, Landroid/telephony/CellInfoLte;->mCellSignalStrengthLte:Landroid/telephony/CellSignalStrengthLte;

    .line 64
    new-instance p1, Landroid/telephony/CellConfigLte;

    invoke-direct {p1}, Landroid/telephony/CellConfigLte;-><init>()V
...
.method public constructor blacklist <init>(Landroid/hardware/radio/V1_2/CellInfo;)V
    ...
    .line 70
    iget-object p1, p1, Landroid/hardware/radio/V1_2/CellInfo;->lte:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Landroid/hardware/radio/V1_2/CellInfoLte;->cellIdentityLte:Landroid/hardware/radio/V1_2/CellIdentityLte;
...
.method public constructor blacklist <init>(Landroid/hardware/radio/V1_4/CellInfo;J)V
    ...
    invoke-virtual {p1}, Landroid/hardware/radio/V1_4/CellInfo$Info;->lte()Landroid/hardware/radio/V1_4/CellInfoLte;

    move-result-object p1

    .line 80
    new-instance p2, Landroid/telephony/CellIdentityLte;

    iget-object p3, p1, Landroid/hardware/radio/V1_4/CellInfoLte;->base:Landroid/hardware/radio/V1_2/CellInfoLte;

    iget-object p3, p3, Landroid/hardware/radio/V1_2/CellInfoLte;->cellIdentityLte:Landroid/hardware/radio/V1_2/CellIdentityLte;

    invoke-direct {p2, p3}, Landroid/telephony/CellIdentityLte;-><init>(Landroid/hardware/radio/V1_2/CellIdentityLte;)V

    iput-object p2, p0, Landroid/telephony/CellInfoLte;->mCellIdentityLte:Landroid/telephony/CellIdentityLte;

    .line 81
    new-instance p2, Landroid/telephony/CellSignalStrengthLte;

    iget-object p3, p1, Landroid/hardware/radio/V1_4/CellInfoLte;->base:Landroid/hardware/radio/V1_2/CellInfoLte;

    iget-object p3, p3, Landroid/hardware/radio/V1_2/CellInfoLte;->signalStrengthLte:Landroid/hardware/radio/V1_0/LteSignalStrength;

    invoke-direct {p2, p3}, Landroid/telephony/CellSignalStrengthLte;-><init>(Landroid/hardware/radio/V1_0/LteSignalStrength;)V

    iput-object p2, p0, Landroid/telephony/CellInfoLte;->mCellSignalStrengthLte:Landroid/telephony/CellSignalStrengthLte;

    .line 82
    new-instance p2, Landroid/telephony/CellConfigLte;

    iget-object p1, p1, Landroid/hardware/radio/V1_4/CellInfoLte;->cellConfig:Landroid/hardware/radio/V1_4/CellConfigLte;

    invoke-direct {p2, p1}, Landroid/telephony/CellConfigLte;-><init>(Landroid/hardware/radio/V1_4/CellConfigLte;)V

    iput-object p2, p0, Landroid/telephony/CellInfoLte;->mCellConfig:Landroid/telephony/CellConfigLte;
...
.method public constructor blacklist <init>(Landroid/hardware/radio/V1_5/CellInfo;J)V
    ...
    invoke-virtual {p1}, Landroid/hardware/radio/V1_5/CellInfo$CellInfoRatSpecificInfo;->lte()Landroid/hardware/radio/V1_5/CellInfoLte;
    ...
    iget-object p3, p1, Landroid/hardware/radio/V1_5/CellInfoLte;->cellIdentityLte:Landroid/hardware/radio/V1_5/CellIdentityLte;

    invoke-direct {p2, p3}, Landroid/telephony/CellIdentityLte;-><init>(Landroid/hardware/radio/V1_5/CellIdentityLte;)V
    ...
    invoke-direct {p2, p1}, Landroid/telephony/CellSignalStrengthLte;-><init>(Landroid/hardware/radio/V1_0/LteSignalStrength;)V
...
.method public constructor blacklist <init>(Landroid/hardware/radio/V1_6/CellInfo;J)V
    ...
    invoke-virtual {p1}, Landroid/hardware/radio/V1_6/CellInfo$CellInfoRatSpecificInfo;->lte()Landroid/hardware/radio/V1_6/CellInfoLte;
    ...
    iget-object p3, p1, Landroid/hardware/radio/V1_6/CellInfoLte;->cellIdentityLte:Landroid/hardware/radio/V1_5/CellIdentityLte;
    ...
    iget-object p1, p1, Landroid/hardware/radio/V1_6/CellInfoLte;->signalStrengthLte:Landroid/hardware/radio/V1_6/LteSignalStrength;

    invoke-direct {p2, p1}, Landroid/telephony/CellSignalStrengthLte;-><init>(Landroid/hardware/radio/V1_6/LteSignalStrength;)V
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 173
    invoke-virtual {v0, p1}, Landroid/telephony/CellConfigLte;->equals(Ljava/lang/Object;)Z
