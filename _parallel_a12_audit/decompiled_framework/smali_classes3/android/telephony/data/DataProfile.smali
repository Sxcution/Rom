...
.method private constructor blacklist <init>(ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;IIIIZIIIIIZZ)V
    ...
    iput-object v1, v0, Landroid/telephony/data/DataProfile;->mApn:Ljava/lang/String;

    .line 116
    move v1, p3

    iput v1, v0, Landroid/telephony/data/DataProfile;->mProtocolType:I
    ...
    .line 121
    :goto_1
    iput v1, v0, Landroid/telephony/data/DataProfile;->mAuthType:I

    .line 122
    move-object v1, p5

    iput-object v1, v0, Landroid/telephony/data/DataProfile;->mUserName:Ljava/lang/String;

    .line 123
    move-object v1, p6

    iput-object v1, v0, Landroid/telephony/data/DataProfile;->mPassword:Ljava/lang/String;

    .line 124
    move v1, p7

    iput v1, v0, Landroid/telephony/data/DataProfile;->mType:I

    .line 125
    move v1, p8

    iput v1, v0, Landroid/telephony/data/DataProfile;->mMaxConnectionsTime:I

    .line 126
    move v1, p9

    iput v1, v0, Landroid/telephony/data/DataProfile;->mMaxConnections:I

    .line 127
    move v1, p10

    iput v1, v0, Landroid/telephony/data/DataProfile;->mWaitTime:I

    .line 128
    move v1, p11

    iput-boolean v1, v0, Landroid/telephony/data/DataProfile;->mEnabled:Z

    .line 129
    move v1, p12

    iput v1, v0, Landroid/telephony/data/DataProfile;->mSupportedApnTypesBitmask:I

    .line 130
    move/from16 v1, p13

    iput v1, v0, Landroid/telephony/data/DataProfile;->mRoamingProtocolType:I

    .line 131
    move/from16 v1, p14

    iput v1, v0, Landroid/telephony/data/DataProfile;->mBearerBitmask:I

    .line 132
    move/from16 v1, p15

    iput v1, v0, Landroid/telephony/data/DataProfile;->mMtuV4:I
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 328
    iget v2, p0, Landroid/telephony/data/DataProfile;->mProfileId:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mProfileId:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mProtocolType:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mProtocolType:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mAuthType:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mAuthType:I
    ...
    iget v3, p1, Landroid/telephony/data/DataProfile;->mMaxConnectionsTime:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mMaxConnections:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mMaxConnections:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mWaitTime:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mWaitTime:I

    if-ne v2, v3, :cond_2

    iget-boolean v2, p0, Landroid/telephony/data/DataProfile;->mEnabled:Z

    iget-boolean v3, p1, Landroid/telephony/data/DataProfile;->mEnabled:Z

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mSupportedApnTypesBitmask:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mSupportedApnTypesBitmask:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mRoamingProtocolType:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mRoamingProtocolType:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mBearerBitmask:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mBearerBitmask:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mMtuV4:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mMtuV4:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Landroid/telephony/data/DataProfile;->mMtuV6:I

    iget v3, p1, Landroid/telephony/data/DataProfile;->mMtuV6:I

    if-ne v2, v3, :cond_2

    iget-boolean v2, p0, Landroid/telephony/data/DataProfile;->mPersistent:Z

    iget-boolean v3, p1, Landroid/telephony/data/DataProfile;->mPersistent:Z

    if-ne v2, v3, :cond_2

    iget-boolean v2, p0, Landroid/telephony/data/DataProfile;->mPreferred:Z

    iget-boolean v3, p1, Landroid/telephony/data/DataProfile;->mPreferred:Z

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Landroid/telephony/data/DataProfile;->mApn:Ljava/lang/String;

    iget-object v3, p1, Landroid/telephony/data/DataProfile;->mApn:Ljava/lang/String;
    ...
    iget-object v3, p1, Landroid/telephony/data/DataProfile;->mUserName:Ljava/lang/String;
    ...
    iget-object p1, p1, Landroid/telephony/data/DataProfile;->mPassword:Ljava/lang/String;
...
.method public whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 290
    iget p2, p0, Landroid/telephony/data/DataProfile;->mProfileId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 291
    iget-object p2, p0, Landroid/telephony/data/DataProfile;->mApn:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 292
    iget p2, p0, Landroid/telephony/data/DataProfile;->mProtocolType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 293
    iget p2, p0, Landroid/telephony/data/DataProfile;->mAuthType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 294
    iget-object p2, p0, Landroid/telephony/data/DataProfile;->mUserName:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 295
    iget-object p2, p0, Landroid/telephony/data/DataProfile;->mPassword:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 296
    iget p2, p0, Landroid/telephony/data/DataProfile;->mType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 297
    iget p2, p0, Landroid/telephony/data/DataProfile;->mMaxConnectionsTime:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 298
    iget p2, p0, Landroid/telephony/data/DataProfile;->mMaxConnections:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 299
    iget p2, p0, Landroid/telephony/data/DataProfile;->mWaitTime:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 300
    iget-boolean p2, p0, Landroid/telephony/data/DataProfile;->mEnabled:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 301
    iget p2, p0, Landroid/telephony/data/DataProfile;->mSupportedApnTypesBitmask:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 302
    iget p2, p0, Landroid/telephony/data/DataProfile;->mRoamingProtocolType:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 303
    iget p2, p0, Landroid/telephony/data/DataProfile;->mBearerBitmask:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 304
    iget p2, p0, Landroid/telephony/data/DataProfile;->mMtuV4:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 305
    iget p2, p0, Landroid/telephony/data/DataProfile;->mMtuV6:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 306
    iget-boolean p2, p0, Landroid/telephony/data/DataProfile;->mPersistent:Z
