...
.method public synthetic blacklist lambda$onProgress$0$BugreportManager$DumpstateListener(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/os/BugreportManager$BugreportCallback;->onProgress(F)V
...
.method public synthetic blacklist lambda$onScreenshotTaken$3$BugreportManager$DumpstateListener(Z)V
    ...
    .line 365
    :goto_0
    iget-object v0, p0, Landroid/os/BugreportManager$DumpstateListener;->this$0:Landroid/os/BugreportManager;

    invoke-static {v0}, Landroid/os/BugreportManager;->access$000(Landroid/os/BugreportManager;)Landroid/content/Context;
...
.method public synthetic blacklist lambda$onUiIntensiveBugreportDumpsFinished$4$BugreportManager$DumpstateListener()V
    .locals 1
...
.method public blacklist onError(I)V
    ...
    invoke-direct {v3, p0, p1}, Landroid/os/BugreportManager$DumpstateListener$$ExternalSyntheticLambda2;-><init>(Landroid/os/BugreportManager$DumpstateListener;I)V
...
.method public blacklist onFinished()V
    ...
    invoke-direct {v3, p0}, Landroid/os/BugreportManager$DumpstateListener$$ExternalSyntheticLambda0;-><init>(Landroid/os/BugreportManager$DumpstateListener;)V
...
.method public blacklist onScreenshotTaken(Z)V
    ...
    .line 359
    new-instance v1, Landroid/os/BugreportManager$DumpstateListener$$ExternalSyntheticLambda4;

    invoke-direct {v1, p0, p1}, Landroid/os/BugreportManager$DumpstateListener$$ExternalSyntheticLambda4;-><init>(Landroid/os/BugreportManager$DumpstateListener;Z)V
...
.method public blacklist onUiIntensiveBugreportDumpsFinished()V
    ...
    invoke-direct {v3, p0}, Landroid/os/BugreportManager$DumpstateListener$$ExternalSyntheticLambda1;-><init>(Landroid/os/BugreportManager$DumpstateListener;)V
