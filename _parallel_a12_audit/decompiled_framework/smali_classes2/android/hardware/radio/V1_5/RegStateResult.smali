...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 617
    new-instance v4, Landroid/hardware/radio/V1_5/RegStateResult;

    invoke-direct {v4}, Landroid/hardware/radio/V1_5/RegStateResult;-><init>()V
    ...
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/radio/V1_5/RegStateResult;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/radio/V1_5/RegStateResult;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    .line 547
    :cond_2
    check-cast p1, Landroid/hardware/radio/V1_5/RegStateResult;

    .line 548
    iget v2, p0, Landroid/hardware/radio/V1_5/RegStateResult;->regState:I

    iget v3, p1, Landroid/hardware/radio/V1_5/RegStateResult;->regState:I
    ...
    iget v3, p1, Landroid/hardware/radio/V1_5/RegStateResult;->rat:I
    ...
    iget v3, p1, Landroid/hardware/radio/V1_5/RegStateResult;->reasonForDenial:I
    ...
    .line 557
    :cond_5
    iget-object v2, p0, Landroid/hardware/radio/V1_5/RegStateResult;->cellIdentity:Landroid/hardware/radio/V1_5/CellIdentity;

    iget-object v3, p1, Landroid/hardware/radio/V1_5/RegStateResult;->cellIdentity:Landroid/hardware/radio/V1_5/CellIdentity;
    ...
    iget-object v3, p1, Landroid/hardware/radio/V1_5/RegStateResult;->registeredPlmn:Ljava/lang/String;
    ...
    .line 563
    :cond_7
    iget-object v2, p0, Landroid/hardware/radio/V1_5/RegStateResult;->accessTechnologySpecificInfo:Landroid/hardware/radio/V1_5/RegStateResult$AccessTechnologySpecificInfo;

    iget-object p1, p1, Landroid/hardware/radio/V1_5/RegStateResult;->accessTechnologySpecificInfo:Landroid/hardware/radio/V1_5/RegStateResult$AccessTechnologySpecificInfo;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 639
    iget-object v0, v0, Landroid/hardware/radio/V1_5/RegStateResult;->accessTechnologySpecificInfo:Landroid/hardware/radio/V1_5/RegStateResult$AccessTechnologySpecificInfo;

    const-wide/16 v1, 0xc8

    add-long v1, p3, v1

    invoke-virtual {v0, p1, v10, v1, v2}, Landroid/hardware/radio/V1_5/RegStateResult$AccessTechnologySpecificInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/hardware/radio/V1_5/RegStateResult$AccessTechnologySpecificInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
