...
.method public static whitelist canCurrentUserBlockNumbers(Landroid/content/Context;)Z
    ...
    const-string v2, "canCurrentUserBlockNumbers: provider not ready."
...
.method public static whitelist isBlocked(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 332
    :goto_0
    sget-object v3, Landroid/provider/BlockedNumberContract;->LOG_TAG:Ljava/lang/String;

    const-string v4, "isBlocked: phoneNumber=%s, isBlocked=%b"
    ...
    const-string p1, "isBlocked: provider not ready."

    invoke-static {v0, p1, p0}, Landroid/telecom/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
