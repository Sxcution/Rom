...
.method public constructor whitelist <init>(Landroid/location/provider/ProviderProperties;)V
    ...
    .line 319
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$100(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 320
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$200(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 321
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$300(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 322
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$400(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 323
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$500(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 324
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$600(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 325
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$700(Landroid/location/provider/ProviderProperties;)Z
    ...
    .line 326
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$800(Landroid/location/provider/ProviderProperties;)I
    ...
    .line 327
    invoke-static {p1}, Landroid/location/provider/ProviderProperties;->access$900(Landroid/location/provider/ProviderProperties;)I

    move-result p1

    iput p1, p0, Landroid/location/provider/ProviderProperties$Builder;->mAccuracy:I
...
.method public whitelist build()Landroid/location/provider/ProviderProperties;
    ...
    invoke-direct/range {v0 .. v10}, Landroid/location/provider/ProviderProperties;-><init>(ZZZZZZZIILandroid/location/provider/ProviderProperties$1;)V
...
.method public whitelist setPowerUsage(I)Landroid/location/provider/ProviderProperties$Builder;
    ...
    const-string/jumbo v2, "powerUsage"

    invoke-static {p1, v0, v1, v2}, Lcom/android/internal/util/Preconditions;->checkArgumentInRange(IIILjava/lang/String;)I

    move-result p1

    iput p1, p0, Landroid/location/provider/ProviderProperties$Builder;->mPowerUsage:I
