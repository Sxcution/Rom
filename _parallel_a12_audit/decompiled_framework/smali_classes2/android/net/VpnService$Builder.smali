...
.method public constructor whitelist <init>(Landroid/net/VpnService;)V
    ...
    iput-object p1, v0, Lcom/android/internal/net/VpnConfig;->user:Ljava/lang/String;
...
.method public whitelist addAddress(Ljava/net/InetAddress;I)Landroid/net/VpnService$Builder;
    ...
    .line 558
    iget-object p2, p0, Landroid/net/VpnService$Builder;->mConfig:Lcom/android/internal/net/VpnConfig;

    invoke-virtual {p2, p1}, Lcom/android/internal/net/VpnConfig;->updateAllowedFamilies(Ljava/net/InetAddress;)V
...
.method public whitelist addAllowedApplication(Ljava/lang/String;)Landroid/net/VpnService$Builder;
    ...
    const-string v0, "addDisallowedApplication already called"
...
.method public whitelist addDisallowedApplication(Ljava/lang/String;)Landroid/net/VpnService$Builder;
    ...
    const-string v0, "addAllowedApplication already called"
...
.method public whitelist addRoute(Ljava/net/InetAddress;I)Landroid/net/VpnService$Builder;
    ...
    invoke-direct {v1, v2, p2, p2, v3}, Landroid/net/RouteInfo;-><init>(Landroid/net/IpPrefix;Ljava/net/InetAddress;Ljava/lang/String;I)V
...
.method public whitelist establish()Landroid/os/ParcelFileDescriptor;
    ...
    .line 898
    :try_start_0
    invoke-static {}, Landroid/net/VpnService;->access$200()Landroid/net/IVpnManager;
